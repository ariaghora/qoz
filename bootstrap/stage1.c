...
bool qoz_parse_is_kw(qoz_Token t, qoz_string kw) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_TokenKind* _qoz_ms_14 = t.kind; bool _qoz_mv_14 = false; switch (_qoz_ms_14->tag) { case qoz_TokenKind_TokKeyword: { _qoz_mv_14 = (qoz_strings_eq_raw(t.text, kw));  break; } default: { _qoz_mv_14 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_14;
}

bool qoz_parse_is_punct(qoz_Token t, qoz_string sym) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_TokenKind* _qoz_ms_15 = t.kind; bool _qoz_mv_15 = false; switch (_qoz_ms_15->tag) { case qoz_TokenKind_TokPunct: { _qoz_mv_15 = (qoz_strings_eq_raw(t.text, sym));  break; } default: { _qoz_mv_15 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_15;
}
...
qoz_string qoz_parse_c_escape_bytes(qoz_string src) {
    ...
    {
        qoz_Strbuf _qoz_sb_643_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_643_36); qoz_strings_sb_append(&_qoz_sb_643_36, QOZ_STR_LIT("\\x")); qoz_strings_sb_append(&_qoz_sb_643_36, qoz_parse_hex2(b)); _qoz_bv_20 = qoz_strings_sb_finish(&_qoz_sb_643_36);
    }
...
qoz_string qoz_parse_hex_digit(int64_t n) {
    ...
    {
        qoz_Strbuf _qoz_sb_654_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_654_24); qoz_strings_sb_append_i64(&_qoz_sb_654_24, n); _qoz_bv_21 = qoz_strings_sb_finish(&_qoz_sb_654_24);
    }
...
qoz_string qoz_parse_interp_var_name(qoz_Span span) {
    ...
    {
        qoz_Strbuf _qoz_sb_813_41 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_813_41); qoz_strings_sb_append_i64(&_qoz_sb_813_41, span.line); _qoz_bv_22 = qoz_strings_sb_finish(&_qoz_sb_813_41);
    }
    qoz_string _qoz_bv_23;
    {
        qoz_Strbuf _qoz_sb_813_73 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_813_73); qoz_strings_sb_append_i64(&_qoz_sb_813_73, span.col); _qoz_bv_23 = qoz_strings_sb_finish(&_qoz_sb_813_73);
    }
...
qoz_Expr* qoz_parse_parse_atom(qoz_Parser* p) {
    ...
    {
        qoz_Strbuf _qoz_sb_918_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_918_29); qoz_strings_sb_append(&_qoz_sb_918_29, QOZ_STR_LIT("expected directive name after `#`, got `")); qoz_strings_sb_append(&_qoz_sb_918_29, name_tok.text); qoz_strings_sb_append(&_qoz_sb_918_29, QOZ_STR_LIT("`")); _qoz_bv_24 = qoz_strings_sb_finish(&_qoz_sb_918_29);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_925_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_925_29); qoz_strings_sb_append(&_qoz_sb_925_29, QOZ_STR_LIT("#")); qoz_strings_sb_append(&_qoz_sb_925_29, name_tok.text); qoz_strings_sb_append(&_qoz_sb_925_29, QOZ_STR_LIT(" expects a string literal path")); _qoz_bv_25 = qoz_strings_sb_finish(&_qoz_sb_925_29);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_921_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_921_29); qoz_strings_sb_append(&_qoz_sb_921_29, QOZ_STR_LIT("unknown directive `#")); qoz_strings_sb_append(&_qoz_sb_921_29, name_tok.text); qoz_strings_sb_append(&_qoz_sb_921_29, QOZ_STR_LIT("` in expression position; supported: #load_string")); _qoz_bv_26 = qoz_strings_sb_finish(&_qoz_sb_921_29);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_942_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_942_29); qoz_strings_sb_append(&_qoz_sb_942_29, QOZ_STR_LIT("#load_string: cannot read `")); qoz_strings_sb_append(&_qoz_sb_942_29, raw_path); qoz_strings_sb_append(&_qoz_sb_942_29, QOZ_STR_LIT("`")); _qoz_bv_27 = qoz_strings_sb_finish(&_qoz_sb_942_29);
    }
...
qoz_Expr* qoz_parse_parse_block(qoz_Parser* p) {
    ...
    {
        qoz_Strbuf _qoz_sb_1270_27 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1270_27); qoz_strings_sb_append(&_qoz_sb_1270_27, QOZ_STR_LIT("_qoz_tup_")); qoz_strings_sb_append_i64(&_qoz_sb_1270_27, n); _qoz_bv_28 = qoz_strings_sb_finish(&_qoz_sb_1270_27);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_1275_37 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1275_37); qoz_strings_sb_append(&_qoz_sb_1275_37, QOZ_STR_LIT("_")); qoz_strings_sb_append_i64(&_qoz_sb_1275_37, bi); _qoz_bv_29 = qoz_strings_sb_finish(&_qoz_sb_1275_37);
    }
...
qoz_Ty* qoz_check_synth_inner(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* e) {
    ...
    {
        if (qoz_strings_eq_raw(name, QOZ_STR_LIT("Result")) && ((args.len) >= 1)) { return args.data[0];} _qoz_bv_42 = t;
    }
...
qoz_Ty* qoz_check_field_type_of(qoz_TyContext* tc, qoz_Ty* bt, qoz_string name) {
    ...
    {
        if (((name).len >= 2) && (qoz_strings_byte_at(name, 0) == 95)) { int64_t idx = qoz_strings_parse_int(qoz_strings_slice(name, 1, (name).len)); if ((idx >= 0) && (idx < (elems.len))) { return elems.data[idx];} } _qoz_bv_50 = qoz_ty_ty_error_();
    }
...
qoz_Ty* qoz_check_apply_subst(qoz_Ty* t, qoz_Vec__qoz_string params, qoz_Vec__qoz_Ty args) {
    ...
    {
        int64_t i = 0; { qoz_Vec__qoz_string __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string p = __col.data[__i]; (void)p; if (qoz_strings_eq_raw(p, name)) { if (i < (args.len)) { return args.data[i];} return t;} i = i + 1; } }_qoz_bv_52 = t;
    }
...
qoz_Ty* qoz_check_synth_index(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* base, qoz_Expr* idx) {
    ...
    {
        if (qoz_strings_eq_raw(name, QOZ_STR_LIT("Vec")) && ((args.len) >= 1)) { return args.data[0];} _qoz_bv_56 = qoz_ty_ty_error_();
    }
...
bool qoz_check_is_strings_callee(qoz_Expr* callee, qoz_string method) {
    ...
    {
        if (!qoz_strings_eq_raw(m, method)) { return false;} qoz_Expr* _qoz_ms_38 = base; bool _qoz_mv_38 = false; switch (_qoz_ms_38->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_38->payload.EIdent.f1; _qoz_mv_38 = (qoz_strings_eq_raw(name, QOZ_STR_LIT("strings")));  break; } default: { _qoz_mv_38 = (false);  break; } } _qoz_bv_57 = _qoz_mv_38;
    }
...
qoz_string qoz_check_resolve_callee_fn(qoz_TyContext* tc, qoz_Expr* callee) {
    ...
    {
        if (qoz_map_contains__qoz_string__bool(&tc->packages, pkg)) { return qoz_strings_cat(qoz_strings_cat(pkg, QOZ_STR_LIT("_")), method);} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->enums, pkg)) { if (qoz_map_contains__qoz_string__qoz_string(&tc->variant_of, method)) { return method;} } _qoz_bv_58 = QOZ_STR_LIT("");
    }
...
qoz_Ty* qoz_check_synth_record(qoz_TyContext* tc, qoz_Env* env, qoz_TypeExpr* te, qoz_Vec__qoz_RecordFieldLit fields) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&te);
    qoz_Ty* bare_resolved = qoz_check_resolve_type(tc, te); qoz_gc_push_root(&bare_resolved); qoz_string struct_name = qoz_check_record_name_of(bare_resolved); if (qoz_strings_eq_raw(struct_name, QOZ_STR_LIT(""))) { return bare_resolved;} qoz_Vec__qoz_string tparams = qoz_check_struct_tparams(tc, struct_name); if ((tparams.len) == 0) { return bare_resolved;} if (qoz_check_annotation_pins_type_args(te, tparams)) { return bare_resolved;} qoz_Map__qoz_string__qoz_Ty bindings = qoz_map_make__qoz_string__qoz_Ty(); qoz_Map__qoz_string__bool saved = tc->type_params; qoz_check_set_type_params(tc, tparams); int64_t i = 0; while (i < (fields.len)) { qoz_RecordFieldLit f = fields.data[i]; if (!qoz_strings_eq_raw(f.name, QOZ_STR_LIT(".."))) { qoz_Option__qoz_TypeExpr* _qoz_ms_44 = qoz_check_struct_field_typeexpr(tc, struct_name, f.name); switch (_qoz_ms_44->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* dte = _qoz_ms_44->payload.Some.f0; void* _qoz_bv_59;
    {
...
void qoz_check_check_binding_compat(qoz_TyContext* tc, qoz_Span sp, qoz_TypeExpr* te, qoz_Ty* bound, qoz_Ty* vt) {
    ...
    {
        qoz_Strbuf _qoz_sb_585_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_585_30); qoz_strings_sb_append(&_qoz_sb_585_30, QOZ_STR_LIT("binding type ")); qoz_strings_sb_append(&_qoz_sb_585_30, want); qoz_strings_sb_append(&_qoz_sb_585_30, QOZ_STR_LIT(" cannot accept value of type ")); qoz_strings_sb_append(&_qoz_sb_585_30, got); _qoz_bv_60 = qoz_strings_sb_finish(&_qoz_sb_585_30);
    }
...
qoz_Option__qoz_TypeExpr* qoz_check_struct_field_typeexpr(qoz_TyContext* tc, qoz_string name, qoz_string field) {
    ...
    {
        int64_t i = 0; while (i < (fields.len)) { if (qoz_strings_eq_raw(fields.data[i].name, field)) { return qoz_make_Option__qoz_TypeExpr_Some(fields.data[i].ty);} i = i + 1; } _qoz_bv_61 = qoz_make_Option__qoz_TypeExpr_None();
    }
...
qoz_Vec__qoz_TypeExpr qoz_check_variant_positional_types(qoz_TyContext* tc, qoz_string enum_name, qoz_string variant) {
    ...
    {
        qoz_Vec__qoz_TypeExpr out = qoz_vec_make__qoz_TypeExpr(); bool found = false; int64_t i = 0; while (i < (variants.len)) { qoz_VariantDecl v = variants.data[i]; if (!found) { if (qoz_strings_eq_raw(v.name, variant)) { out = v.pos; found = true; } } i = i + 1; } _qoz_bv_62 = out;
    }
...
qoz_Ty* qoz_check_synth_call_with_decl(qoz_TyContext* tc, qoz_Span sp, qoz_Decl* d, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Ty arg_tys) {
    ...
    {
        qoz_Strbuf _qoz_sb_730_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_730_34); qoz_strings_sb_append(&_qoz_sb_730_34, QOZ_STR_LIT("function expects ")); qoz_strings_sb_append_i64(&_qoz_sb_730_34, (params.len)); qoz_strings_sb_append(&_qoz_sb_730_34, QOZ_STR_LIT(" argument(s), got ")); qoz_strings_sb_append_i64(&_qoz_sb_730_34, (arg_tys.len)); _qoz_bv_64 = qoz_strings_sb_finish(&_qoz_sb_730_34);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_744_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_744_42); qoz_strings_sb_append(&_qoz_sb_744_42, QOZ_STR_LIT("expected ")); qoz_strings_sb_append(&_qoz_sb_744_42, want); qoz_strings_sb_append(&_qoz_sb_744_42, QOZ_STR_LIT(", got ")); qoz_strings_sb_append(&_qoz_sb_744_42, got); _qoz_bv_65 = qoz_strings_sb_finish(&_qoz_sb_744_42);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_779_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_779_42); qoz_strings_sb_append(&_qoz_sb_779_42, QOZ_STR_LIT("type parameter `")); qoz_strings_sb_append(&_qoz_sb_779_42, tp); qoz_strings_sb_append(&_qoz_sb_779_42, QOZ_STR_LIT("` is not constrained by any argument; add an explicit annotation")); _qoz_bv_66 = qoz_strings_sb_finish(&_qoz_sb_779_42);
    }
...
qoz_Ty* qoz_check_synth_ident(qoz_TyContext* tc, qoz_Env* env, qoz_Span span, qoz_string name) {
    ...
    {
        qoz_Strbuf _qoz_sb_912_28 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_912_28); qoz_strings_sb_append(&_qoz_sb_912_28, QOZ_STR_LIT("undefined name `")); qoz_strings_sb_append(&_qoz_sb_912_28, name); qoz_strings_sb_append(&_qoz_sb_912_28, QOZ_STR_LIT("`")); _qoz_bv_70 = qoz_strings_sb_finish(&_qoz_sb_912_28);
    }
...
void qoz_check_collect_arg_hints(qoz_TyContext* tc, qoz_Expr* callee, int64_t n, qoz_Vec__qoz_Ty* out) {
    ...
    qoz_string name = qoz_check_resolve_callee_fn(tc, callee); if (!qoz_strings_eq_raw(name, QOZ_STR_LIT(""))) { qoz_Option__qoz_Decl* _qoz_ms_101 = qoz_map_get__qoz_string__qoz_Decl(&tc->fns, name); switch (_qoz_ms_101->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_101->payload.Some.f0; {
...
void qoz_emit_walk_let_value_for_array_hint(qoz_Emitter* e, qoz_TypeExpr* ty, qoz_Expr* val) {
    ...
    if (qoz_emit_is_unit_typeexpr(ty)) { return;} qoz_TypeExpr* _qoz_ms_134 = ty; switch (_qoz_ms_134->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_134->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_134->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_134->payload.TENamed.f2; {
        if ((path.len) < 1) { return;} if (!qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return;} if ((args.len) < 1) { return;} qoz_Expr* _qoz_ms_135 = val; switch (_qoz_ms_135->tag) { case qoz_Expr_EArrayLit: { {
...
void qoz_emit_walk_expr_for_types(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    0;  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_136->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_136->payload.ECall.f1; qoz_Vec__qoz_TypeExpr type_args = _qoz_ms_136->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_136->payload.ECall.f3; {
        qoz_emit_walk_expr_for_types(e, callee); { qoz_Vec__qoz_TypeExpr __col = type_args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* ta = __col.data[__i]; (void)ta; qoz_emit_walk_typeexpr(e, ta); } }{ qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; qoz_emit_walk_expr_for_types(e, a); } }qoz_emit_register_fn_instantiation(e, callee, type_args); if ((type_args.len) == 0) { qoz_string vname = qoz_emit_variant_callee_name(e, callee); if (!qoz_strings_eq_raw(vname, QOZ_STR_LIT(""))) { qoz_Option__qoz_string* _qoz_ms_138 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, vname); switch (_qoz_ms_138->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_138->payload.Some.f0; {
...
qoz_string qoz_emit_mangle_type(qoz_Emitter* e, qoz_TypeExpr* t) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&t);
    qoz_TypeExpr* _qoz_ms_140 = t; qoz_string _qoz_mv_140 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_140->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_140 = (QOZ_STR_LIT("void"));  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_140->payload.TEPtr.f1; _qoz_mv_140 = (qoz_strings_cat(qoz_emit_mangle_type(e, inner), QOZ_STR_LIT("_ptr")));  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_140->payload.TETuple.f1; qoz_string _qoz_bv_97;
    {
        qoz_string acc = QOZ_STR_LIT("tuple"); { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; acc = qoz_strings_cat(acc, QOZ_STR_LIT("__")); acc = qoz_strings_cat(acc, qoz_emit_mangle_type(e, el)); } }_qoz_bv_97 = acc;
    }
...
qoz_string qoz_emit_strip_numeric_underscores(qoz_string s) {
    ...
    {
        qoz_Strbuf _qoz_sb_807_20 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_807_20); qoz_strings_sb_append_i64(&_qoz_sb_807_20, v); _qoz_bv_110 = qoz_strings_sb_finish(&_qoz_sb_807_20);
    }
...
qoz_string qoz_emit_result_mangle_for(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    {
        if ((path.len) == 0) { return QOZ_STR_LIT("");} qoz_string last = path.data[(path.len) - 1]; if (!qoz_strings_eq_raw(last, QOZ_STR_LIT("Result"))) { return QOZ_STR_LIT("");} if ((args.len) != 2) { return QOZ_STR_LIT("");} _qoz_bv_111 = qoz_emit_mangle_inst(e, QOZ_STR_LIT("Result"), args);
    }
...
void qoz_emit_emit_try(qoz_Emitter* e, qoz_Span sp, qoz_Expr* value) {
    ...
    {
        qoz_Strbuf _qoz_sb_1032_40 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1032_40); qoz_strings_sb_append_i64(&_qoz_sb_1032_40, e->closure_counter); _qoz_bv_112 = qoz_strings_sb_finish(&_qoz_sb_1032_40);
    }
    qoz_string tmp = qoz_strings_cat(QOZ_STR_LIT("_qoz_try_"), _qoz_bv_112); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_113;
    {
        qoz_Strbuf _qoz_sb_1048_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1048_13); qoz_strings_sb_append(&_qoz_sb_1048_13, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_1048_13, inner_mangle); qoz_strings_sb_append(&_qoz_sb_1048_13, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_1048_13, tmp); qoz_strings_sb_append(&_qoz_sb_1048_13, QOZ_STR_LIT(" = ")); _qoz_bv_113 = qoz_strings_sb_finish(&_qoz_sb_1048_13);
    }
    qoz_emit_push(e, _qoz_bv_113); qoz_emit_emit_expr(e, value); qoz_string crr = e->current_return_restore; qoz_string _qoz_bv_114;
    {
        qoz_Strbuf _qoz_sb_1041_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1041_13); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("; if (")); qoz_strings_sb_append(&_qoz_sb_1041_13, tmp); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("->tag == qoz_")); qoz_strings_sb_append(&_qoz_sb_1041_13, inner_mangle); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("_Err) { ")); qoz_strings_sb_append(&_qoz_sb_1041_13, crr); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("return qoz_make_")); qoz_strings_sb_append(&_qoz_sb_1041_13, outer_mangle); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("_Err(")); qoz_strings_sb_append(&_qoz_sb_1041_13, tmp); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("->payload.Err.f0); } ")); _qoz_bv_114 = qoz_strings_sb_finish(&_qoz_sb_1041_13);
    }
    qoz_emit_push(e, _qoz_bv_114); qoz_emit_hoist_to_prologue(e, start); qoz_string _qoz_bv_115;
    {
        qoz_Strbuf _qoz_sb_1044_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1044_13); qoz_strings_sb_append(&_qoz_sb_1044_13, tmp); qoz_strings_sb_append(&_qoz_sb_1044_13, QOZ_STR_LIT("->payload.Ok.f0")); _qoz_bv_115 = qoz_strings_sb_finish(&_qoz_sb_1044_13);
    }
...
void qoz_emit_emit_tuple_lit(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_Expr elems) {
    ...
    {
        qoz_Strbuf _qoz_sb_1051_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1051_13); qoz_strings_sb_append(&_qoz_sb_1051_13, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_1051_13, tname); qoz_strings_sb_append(&_qoz_sb_1051_13, QOZ_STR_LIT("){ ")); _qoz_bv_116 = qoz_strings_sb_finish(&_qoz_sb_1051_13);
    }
...
void qoz_emit_emit_array_lit_using(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_Expr elems, qoz_TypeExpr* hint) {
    ...
    {
        qoz_Strbuf _qoz_sb_1101_40 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1101_40); qoz_strings_sb_append_i64(&_qoz_sb_1101_40, e->closure_counter); _qoz_bv_117 = qoz_strings_sb_finish(&_qoz_sb_1101_40);
    }
    qoz_string tmp = qoz_strings_cat(QOZ_STR_LIT("_qoz_arr_"), _qoz_bv_117); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_118;
    {
        qoz_Strbuf _qoz_sb_1103_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1103_13); qoz_strings_sb_append(&_qoz_sb_1103_13, vec_c); qoz_strings_sb_append(&_qoz_sb_1103_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_1103_13, tmp); qoz_strings_sb_append(&_qoz_sb_1103_13, QOZ_STR_LIT(" = qoz_")); qoz_strings_sb_append(&_qoz_sb_1103_13, make_mangled); qoz_strings_sb_append(&_qoz_sb_1103_13, QOZ_STR_LIT("(); ")); _qoz_bv_118 = qoz_strings_sb_finish(&_qoz_sb_1103_13);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_1105_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1105_17); qoz_strings_sb_append(&_qoz_sb_1105_17, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_1105_17, push_mangled); qoz_strings_sb_append(&_qoz_sb_1105_17, QOZ_STR_LIT("(&")); qoz_strings_sb_append(&_qoz_sb_1105_17, tmp); qoz_strings_sb_append(&_qoz_sb_1105_17, QOZ_STR_LIT(", ")); _qoz_bv_119 = qoz_strings_sb_finish(&_qoz_sb_1105_17);
    }
...
void qoz_emit_emit_closure_lifted(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_ClosureParam cps, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    {
        qoz_Strbuf _qoz_sb_1247_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1247_21); qoz_strings_sb_append(&_qoz_sb_1247_21, env_local); qoz_strings_sb_append(&_qoz_sb_1247_21, QOZ_STR_LIT("->")); qoz_strings_sb_append(&_qoz_sb_1247_21, c); qoz_strings_sb_append(&_qoz_sb_1247_21, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_1247_21, c); qoz_strings_sb_append(&_qoz_sb_1247_21, QOZ_STR_LIT("; ")); _qoz_bv_129 = qoz_strings_sb_finish(&_qoz_sb_1247_21);
    }
    qoz_emit_push(e, _qoz_bv_129); } }qoz_emit_hoist_to_prologue(e, start); qoz_string _qoz_bv_130;
    {
        qoz_Strbuf _qoz_sb_1240_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1240_17); qoz_strings_sb_append(&_qoz_sb_1240_17, QOZ_STR_LIT("(void *)")); qoz_strings_sb_append(&_qoz_sb_1240_17, env_local); _qoz_bv_130 = qoz_strings_sb_finish(&_qoz_sb_1240_17);
    }
    qoz_emit_push(e, _qoz_bv_130); } qoz_string _qoz_bv_131;
    {
        qoz_Strbuf _qoz_sb_1242_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1242_13); qoz_strings_sb_append(&_qoz_sb_1242_13, QOZ_STR_LIT(", .fn = ")); qoz_strings_sb_append(&_qoz_sb_1242_13, cname); qoz_strings_sb_append(&_qoz_sb_1242_13, QOZ_STR_LIT(" })")); _qoz_bv_131 = qoz_strings_sb_finish(&_qoz_sb_1242_13);
    }
...
void qoz_emit_emit_expr(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    {
        qoz_Strbuf _qoz_sb_1269_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1269_36); qoz_strings_sb_append(&_qoz_sb_1269_36, QOZ_STR_LIT("QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_1269_36, text); qoz_strings_sb_append(&_qoz_sb_1269_36, QOZ_STR_LIT(")")); _qoz_bv_133 = qoz_strings_sb_finish(&_qoz_sb_1269_36);
    }
    ...
    qoz_string tmp_res = qoz_strings_cat(QOZ_STR_LIT("_qoz_bv_"), _qoz_bv_137); qoz_string result_c = qoz_emit_c_type_for(e, tail_te); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_138;
    {
...
qoz_TypeExpr* qoz_emit_infer_base_typeexpr(qoz_Emitter* e, qoz_Expr* base) {
    ...
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("indexing into non-Vec/non-pointer base"))); _qoz_bv_154 = qoz_make_TypeExpr_TEUnit(sp);
    }
...
qoz_TypeExpr* qoz_emit_field_typeexpr_for(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    {
        qoz_Strbuf _qoz_sb_1565_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1565_34); qoz_strings_sb_append(&_qoz_sb_1565_34, QOZ_STR_LIT("field access `.")); qoz_strings_sb_append(&_qoz_sb_1565_34, field); qoz_strings_sb_append(&_qoz_sb_1565_34, QOZ_STR_LIT("` on TypeExpr with empty path")); _qoz_bv_158 = qoz_strings_sb_finish(&_qoz_sb_1565_34);
    }
    ...
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_strings_eq_raw(f.name, field)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }qoz_string _qoz_bv_160;
    {
        qoz_Strbuf _qoz_sb_1585_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1585_38); qoz_strings_sb_append(&_qoz_sb_1585_38, QOZ_STR_LIT("struct `")); qoz_strings_sb_append(&_qoz_sb_1585_38, lookup); qoz_strings_sb_append(&_qoz_sb_1585_38, QOZ_STR_LIT("` has no field `")); qoz_strings_sb_append(&_qoz_sb_1585_38, field); qoz_strings_sb_append(&_qoz_sb_1585_38, QOZ_STR_LIT("`")); _qoz_bv_160 = qoz_strings_sb_finish(&_qoz_sb_1585_38);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_1589_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1589_38); qoz_strings_sb_append(&_qoz_sb_1589_38, QOZ_STR_LIT("decl `")); qoz_strings_sb_append(&_qoz_sb_1589_38, lookup); qoz_strings_sb_append(&_qoz_sb_1589_38, QOZ_STR_LIT("` is not a struct")); _qoz_bv_162 = qoz_strings_sb_finish(&_qoz_sb_1589_38);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_1595_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1595_34); qoz_strings_sb_append(&_qoz_sb_1595_34, QOZ_STR_LIT("unknown struct `")); qoz_strings_sb_append(&_qoz_sb_1595_34, lookup); qoz_strings_sb_append(&_qoz_sb_1595_34, QOZ_STR_LIT("` for field `.")); qoz_strings_sb_append(&_qoz_sb_1595_34, field); qoz_strings_sb_append(&_qoz_sb_1595_34, QOZ_STR_LIT("`")); _qoz_bv_164 = qoz_strings_sb_finish(&_qoz_sb_1595_34);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_1593_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1593_30); qoz_strings_sb_append(&_qoz_sb_1593_30, QOZ_STR_LIT("tuple has no field `.")); qoz_strings_sb_append(&_qoz_sb_1593_30, field); qoz_strings_sb_append(&_qoz_sb_1593_30, QOZ_STR_LIT("`")); _qoz_bv_166 = qoz_strings_sb_finish(&_qoz_sb_1593_30);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_1607_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1607_30); qoz_strings_sb_append(&_qoz_sb_1607_30, QOZ_STR_LIT("field access `.")); qoz_strings_sb_append(&_qoz_sb_1607_30, field); qoz_strings_sb_append(&_qoz_sb_1607_30, QOZ_STR_LIT("` on a non-named base")); _qoz_bv_168 = qoz_strings_sb_finish(&_qoz_sb_1607_30);
    }
...
qoz_TypeExpr* qoz_emit_infer_value_te(qoz_Emitter* e, qoz_Expr* v) {
    ...
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("let-binding value indexed into non-Vec base; cannot determine binding type"))); _qoz_bv_171 = qoz_make_TypeExpr_TEUnit(sp);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_1710_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1710_34); qoz_strings_sb_append(&_qoz_sb_1710_34, QOZ_STR_LIT("let-binding value references unknown name `")); qoz_strings_sb_append(&_qoz_sb_1710_34, name); qoz_strings_sb_append(&_qoz_sb_1710_34, QOZ_STR_LIT("`")); _qoz_bv_174 = qoz_strings_sb_finish(&_qoz_sb_1710_34);
    }
    ...
    {
        if ((arms.len) == 0) { (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("match expression with no arms"))); return qoz_make_TypeExpr_TEUnit(sp);} qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); qoz_string enum_name = ((qoz_strings_eq_raw(bare_enum, QOZ_STR_LIT(""))) ? bare_enum : qoz_emit_enum_lookup_name(e, scrut, bare_enum)); qoz_emit_bind_arm_locals(e, enum_name, arms.data[0].pat); _qoz_bv_178 = qoz_emit_infer_value_te(e, arms.data[0].body);
    }
    ...
    {
        if ((args.len) == 2) { if ((path.len) > 0) { qoz_string last = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(last, QOZ_STR_LIT("Result"))) { return args.data[0];} } } _qoz_bv_182 = inner;
    }
...
qoz_TypeExpr* qoz_emit_call_return_te(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_Span sp) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_string name = qoz_emit_generic_callee_name(e, callee); if (qoz_strings_eq_raw(name, QOZ_STR_LIT(""))) { (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("could not derive return type: callee has no recognisable name"))); return qoz_make_TypeExpr_TEUnit(sp);} if (qoz_strings_eq_raw(name, QOZ_STR_LIT("len"))) { return qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64"));} if (qoz_strings_eq_raw(name, QOZ_STR_LIT("size_of"))) { return qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64"));} if (qoz_strings_eq_raw(name, QOZ_STR_LIT("hash"))) { return qoz_emit_single_named_te(sp, QOZ_STR_LIT("u64"));} qoz_Option__qoz_string* _qoz_ms_201 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_201->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_201->payload.Some.f0; {
    ...
    {
        qoz_Strbuf _qoz_sb_1994_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1994_34); qoz_strings_sb_append(&_qoz_sb_1994_34, QOZ_STR_LIT("`")); qoz_strings_sb_append(&_qoz_sb_1994_34, name); qoz_strings_sb_append(&_qoz_sb_1994_34, QOZ_STR_LIT("` is in generic_fn_decls but not a DFn")); _qoz_bv_190 = qoz_strings_sb_finish(&_qoz_sb_1994_34);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_2003_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2003_34); qoz_strings_sb_append(&_qoz_sb_2003_34, QOZ_STR_LIT("call to unknown function `")); qoz_strings_sb_append(&_qoz_sb_2003_34, name); qoz_strings_sb_append(&_qoz_sb_2003_34, QOZ_STR_LIT("` (no DFn, DExternal, or builtin matched)")); _qoz_bv_192 = qoz_strings_sb_finish(&_qoz_sb_2003_34);
    }
...
void qoz_emit_emit_stmt_inner(qoz_Emitter* e, qoz_Stmt* s) {
    ...
    {
        qoz_Strbuf _qoz_sb_2076_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2076_17); qoz_strings_sb_append(&_qoz_sb_2076_17, ct); qoz_strings_sb_append(&_qoz_sb_2076_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_2076_17, name); qoz_strings_sb_append(&_qoz_sb_2076_17, QOZ_STR_LIT(" = ")); _qoz_bv_193 = qoz_strings_sb_finish(&_qoz_sb_2076_17);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_2070_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2070_21); qoz_strings_sb_append(&_qoz_sb_2070_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_2070_21, name); qoz_strings_sb_append(&_qoz_sb_2070_21, QOZ_STR_LIT("); ")); _qoz_bv_194 = qoz_strings_sb_finish(&_qoz_sb_2070_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_2093_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2093_17); qoz_strings_sb_append(&_qoz_sb_2093_17, ct); qoz_strings_sb_append(&_qoz_sb_2093_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_2093_17, name); qoz_strings_sb_append(&_qoz_sb_2093_17, QOZ_STR_LIT(" = ")); _qoz_bv_195 = qoz_strings_sb_finish(&_qoz_sb_2093_17);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_2097_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2097_21); qoz_strings_sb_append(&_qoz_sb_2097_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_2097_21, name); qoz_strings_sb_append(&_qoz_sb_2097_21, QOZ_STR_LIT("); ")); _qoz_bv_196 = qoz_strings_sb_finish(&_qoz_sb_2097_21);
    }
...
bool qoz_emit_path_is(qoz_Expr* callee, qoz_string a, qoz_string b) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_212 = callee; bool _qoz_mv_212 = false; switch (_qoz_ms_212->tag) { case qoz_Expr_EPath: { qoz_Vec__qoz_string segs = _qoz_ms_212->payload.EPath.f1; _qoz_mv_212 = ((((segs.len) == 2) && qoz_strings_eq_raw(segs.data[0], a)) && qoz_strings_eq_raw(segs.data[1], b));  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_212->payload.EField.f1; qoz_string name = _qoz_ms_212->payload.EField.f2; _qoz_mv_212 = (qoz_strings_eq_raw(name, b) && qoz_emit_ident_is(base, a));  break; } default: { _qoz_mv_212 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_212;
}

bool qoz_emit_ident_is(qoz_Expr* ex, qoz_string name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_213 = ex; bool _qoz_mv_213 = false; switch (_qoz_ms_213->tag) { case qoz_Expr_EIdent: { qoz_string n = _qoz_ms_213->payload.EIdent.f1; _qoz_mv_213 = (qoz_strings_eq_raw(n, name));  break; } default: { _qoz_mv_213 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_213;
}
...
qoz_string qoz_emit_qualified_call_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    {
        if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_strings_cat(qoz_strings_cat(pkg, QOZ_STR_LIT("_")), method);} _qoz_bv_197 = QOZ_STR_LIT("");
    }
...
qoz_string qoz_emit_arm_body_ctype(qoz_Emitter* e, qoz_string enum_name, qoz_Expr* body) {
    ...
    {
        if (qoz_emit_same_enum_base(e, en, enum_name)) { return qoz_strings_cat(qoz_strings_cat(QOZ_STR_LIT("qoz_"), enum_name), QOZ_STR_LIT("*"));} _qoz_bv_198 = qoz_strings_cat(qoz_strings_cat(QOZ_STR_LIT("qoz_"), en), QOZ_STR_LIT("*"));
    }
    ...
    {
        if (qoz_emit_same_enum_base(e, en, enum_name)) { return qoz_strings_cat(qoz_strings_cat(QOZ_STR_LIT("qoz_"), enum_name), QOZ_STR_LIT("*"));} _qoz_bv_199 = qoz_strings_cat(qoz_strings_cat(QOZ_STR_LIT("qoz_"), en), QOZ_STR_LIT("*"));
    }
...
void qoz_emit_emit_field(qoz_Emitter* e, qoz_Expr* base, qoz_string name) {
    ...
    {
        qoz_Strbuf _qoz_sb_2353_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2353_25); qoz_strings_sb_append(&_qoz_sb_2353_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_2353_25, enum_name); qoz_strings_sb_append(&_qoz_sb_2353_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_2353_25, name); qoz_strings_sb_append(&_qoz_sb_2353_25, QOZ_STR_LIT("()")); _qoz_bv_200 = qoz_strings_sb_finish(&_qoz_sb_2353_25);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_2364_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2364_13); qoz_strings_sb_append(&_qoz_sb_2364_13, op); qoz_strings_sb_append(&_qoz_sb_2364_13, name); _qoz_bv_201 = qoz_strings_sb_finish(&_qoz_sb_2364_13);
    }
...
qoz_TypeExpr* qoz_emit_field_typeexpr_for_no_die(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_strings_eq_raw(f.name, field)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }_qoz_bv_205 = qoz_make_TypeExpr_TEUnit(sp);
    }
...
void qoz_emit_emit_assign(qoz_Emitter* e, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    qoz_Expr* _qoz_ms_241 = lhs; switch (_qoz_ms_241->tag) { case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_241->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_241->payload.EIndex.f2; {
        qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_242 = te; switch (_qoz_ms_242->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_242->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_242->payload.TENamed.f2; if ((((path.len) >= 1) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) && ((args.len) == 2)) { qoz_emit_register_map_helper(e, QOZ_STR_LIT("map_set"), args); qoz_string k_m = qoz_emit_mangle_type(e, args.data[0]); qoz_string v_m = qoz_emit_mangle_type(e, args.data[1]); qoz_string _qoz_bv_206;
    {
        qoz_Strbuf _qoz_sb_2505_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2505_25); qoz_strings_sb_append(&_qoz_sb_2505_25, QOZ_STR_LIT("qoz_map_set__")); qoz_strings_sb_append(&_qoz_sb_2505_25, k_m); qoz_strings_sb_append(&_qoz_sb_2505_25, QOZ_STR_LIT("__")); qoz_strings_sb_append(&_qoz_sb_2505_25, v_m); qoz_strings_sb_append(&_qoz_sb_2505_25, QOZ_STR_LIT("(&")); _qoz_bv_206 = qoz_strings_sb_finish(&_qoz_sb_2505_25);
    }
...
qoz_TypeExpr* qoz_emit_lvalue_hint(qoz_Emitter* e, qoz_Expr* lhs) {
    ...
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_209 = qoz_make_TypeExpr_TEUnit(sp);
    }
...
void qoz_emit_emit_index(qoz_Emitter* e, qoz_Expr* base, qoz_Expr* idx) {
    ...
    qoz_gc_push_root(&base);
    qoz_gc_push_root(&idx);
    qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_246 = te; switch (_qoz_ms_246->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_246->payload.TENamed.f1; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(n, QOZ_STR_LIT("Vec"))) { qoz_string op = qoz_emit_field_access_op(e, base); qoz_emit_emit_expr(e, base); qoz_string _qoz_bv_210;
    {
        qoz_Strbuf _qoz_sb_2509_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2509_25); qoz_strings_sb_append(&_qoz_sb_2509_25, op); qoz_strings_sb_append(&_qoz_sb_2509_25, QOZ_STR_LIT("data[")); _qoz_bv_210 = qoz_strings_sb_finish(&_qoz_sb_2509_25);
    }
...
void qoz_emit_emit_hash_builtin(qoz_Emitter* e, qoz_Expr* arg) {
    ...
    qoz_string ct = qoz_emit_infer_expr_ctype(e, arg); if (qoz_strings_eq_raw(ct, QOZ_STR_LIT("qoz_string"))) { qoz_emit_push(e, QOZ_STR_LIT("qoz_string_hash(")); qoz_emit_emit_expr(e, arg); qoz_emit_push(e, QOZ_STR_LIT(")")); return;} qoz_string record_name = qoz_emit_record_struct_name_of_ctype(e, ct); if (!qoz_strings_eq_raw(record_name, QOZ_STR_LIT(""))) { qoz_string _qoz_bv_211;
    {
        qoz_Strbuf _qoz_sb_2533_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2533_17); qoz_strings_sb_append(&_qoz_sb_2533_17, QOZ_STR_LIT("qoz_hash_")); qoz_strings_sb_append(&_qoz_sb_2533_17, record_name); qoz_strings_sb_append(&_qoz_sb_2533_17, QOZ_STR_LIT("(")); _qoz_bv_211 = qoz_strings_sb_finish(&_qoz_sb_2533_17);
    }
...
void qoz_emit_emit_call(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_string qualified = qoz_emit_qualified_call_name(e, callee); if (!qoz_strings_eq_raw(qualified, QOZ_STR_LIT(""))) { if (((type_args.len) > 0) && qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, qualified)) { qoz_string mi = qoz_emit_mangle_inst(e, qualified, type_args); qoz_string _qoz_bv_212;
    {
        qoz_Strbuf _qoz_sb_2668_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2668_21); qoz_strings_sb_append(&_qoz_sb_2668_21, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_2668_21, mi); qoz_strings_sb_append(&_qoz_sb_2668_21, QOZ_STR_LIT("(")); _qoz_bv_212 = qoz_strings_sb_finish(&_qoz_sb_2668_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_2682_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2682_17); qoz_strings_sb_append(&_qoz_sb_2682_17, dispatch_name); qoz_strings_sb_append(&_qoz_sb_2682_17, QOZ_STR_LIT("(")); _qoz_bv_213 = qoz_strings_sb_finish(&_qoz_sb_2682_17);
    }
    ...
    0;  break; } default: { NULL;  break; } } 0; qoz_string variant_name = qoz_emit_variant_callee_name(e, callee); if (!qoz_strings_eq_raw(variant_name, QOZ_STR_LIT(""))) { qoz_Option__qoz_string* _qoz_ms_250 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, variant_name); switch (_qoz_ms_250->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_250->payload.Some.f0; {
        qoz_string _qoz_bv_214;
    {
        qoz_Strbuf _qoz_sb_2626_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2626_21); qoz_strings_sb_append(&_qoz_sb_2626_21, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_2626_21, enum_name); qoz_strings_sb_append(&_qoz_sb_2626_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_2626_21, variant_name); qoz_strings_sb_append(&_qoz_sb_2626_21, QOZ_STR_LIT("(")); _qoz_bv_214 = qoz_strings_sb_finish(&_qoz_sb_2626_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_2745_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2745_25); qoz_strings_sb_append(&_qoz_sb_2745_25, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_2745_25, mi); qoz_strings_sb_append(&_qoz_sb_2745_25, QOZ_STR_LIT("(")); _qoz_bv_215 = qoz_strings_sb_finish(&_qoz_sb_2745_25);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_2767_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2767_21); qoz_strings_sb_append(&_qoz_sb_2767_21, sym); qoz_strings_sb_append(&_qoz_sb_2767_21, QOZ_STR_LIT("(")); _qoz_bv_216 = qoz_strings_sb_finish(&_qoz_sb_2767_21);
    }
...
qoz_TypeExpr* qoz_emit_callee_value_typeexpr(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_253 = callee; qoz_TypeExpr* _qoz_mv_253 = NULL; switch (_qoz_ms_253->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_253->payload.EIdent.f0; qoz_string name = _qoz_ms_253->payload.EIdent.f1; qoz_TypeExpr* _qoz_bv_217;
    {
        qoz_Option__qoz_TypeExpr* _qoz_ms_264 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); switch (_qoz_ms_264->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_264->payload.Some.f0; return te;  break; } default: { NULL;  break; } } 0; _qoz_bv_217 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_253 = (_qoz_bv_217);  break; } default: { _qoz_mv_253 = (qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(callee)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_253;
}
...
qoz_string qoz_emit_unary_op_text(qoz_UnaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_UnaryOp* _qoz_ms_265 = op; qoz_string _qoz_mv_265 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_265->tag) { case qoz_UnaryOp_UOpNeg: { _qoz_mv_265 = (QOZ_STR_LIT("unary-"));  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_265 = (QOZ_STR_LIT("unary!"));  break; } case qoz_UnaryOp_UOpDeref: { _qoz_mv_265 = (QOZ_STR_LIT(""));  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_265 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_265;
}
...
qoz_string qoz_emit_binary_op_text(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_266 = op; qoz_string _qoz_mv_266 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_266->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_266 = (QOZ_STR_LIT("=="));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_266 = (QOZ_STR_LIT("!="));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_266 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_266 = (QOZ_STR_LIT(">"));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_266 = (QOZ_STR_LIT("<="));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_266 = (QOZ_STR_LIT(">="));  break; } case qoz_BinaryOp_BOpAdd: { _qoz_mv_266 = (QOZ_STR_LIT("+"));  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_266 = (QOZ_STR_LIT("-"));  break; } case qoz_BinaryOp_BOpMul: { _qoz_mv_266 = (QOZ_STR_LIT("*"));  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_266 = (QOZ_STR_LIT("/"));  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_266 = (QOZ_STR_LIT("%"));  break; } default: { _qoz_mv_266 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_266;
}
...
void qoz_emit_emit_binary(qoz_Emitter* e, qoz_BinaryOp* op, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    qoz_gc_push_root(&lhs);
    qoz_gc_push_root(&rhs);
    qoz_string lct = qoz_emit_infer_expr_ctype(e, lhs); if (qoz_strings_eq_raw(lct, QOZ_STR_LIT("qoz_string"))) { qoz_BinaryOp* _qoz_ms_267 = op; switch (_qoz_ms_267->tag) { case qoz_BinaryOp_BOpEq: { {
    ...
    0;  break; } default: { NULL;  break; } } 0; } qoz_string op_text = qoz_emit_binary_op_text(op); if (!qoz_strings_eq_raw(op_text, QOZ_STR_LIT(""))) { qoz_TypeExpr* lhs_te = qoz_emit_infer_value_te(e, lhs); qoz_gc_push_root(&lhs_te); qoz_string tname = qoz_emit_operator_first_param_type_name(lhs_te); if (!qoz_strings_eq_raw(tname, QOZ_STR_LIT(""))) { qoz_string key = qoz_strings_cat(qoz_strings_cat(op_text, QOZ_STR_LIT("::")), tname); qoz_Option__qoz_string* _qoz_ms_268 = qoz_map_get__qoz_string__qoz_string(&e->op_dispatch, key); switch (_qoz_ms_268->tag) { case qoz_Option__qoz_string_Some: { qoz_string fn_name = _qoz_ms_268->payload.Some.f0; {
        qoz_string ct = qoz_emit_c_type_for(e, lhs_te); qoz_Option__qoz_TypeExpr* _qoz_ms_269 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->fn_returns, fn_name); qoz_TypeExpr* _qoz_mv_269 = NULL; switch (_qoz_ms_269->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_269->payload.Some.f0; _qoz_mv_269 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_218;
    {
        qoz_string _qoz_bv_219;
    {
        qoz_Strbuf _qoz_sb_2901_57 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2901_57); qoz_strings_sb_append(&_qoz_sb_2901_57, QOZ_STR_LIT("operator `")); qoz_strings_sb_append(&_qoz_sb_2901_57, op_text); qoz_strings_sb_append(&_qoz_sb_2901_57, QOZ_STR_LIT("` for `")); qoz_strings_sb_append(&_qoz_sb_2901_57, tname); qoz_strings_sb_append(&_qoz_sb_2901_57, QOZ_STR_LIT("` has no recorded return type")); _qoz_bv_219 = qoz_strings_sb_finish(&_qoz_sb_2901_57);
    }
    ...
    _qoz_mv_269 = (_qoz_bv_218);  break; } } qoz_TypeExpr* ret_te = _qoz_mv_269; qoz_gc_push_root(&ret_te); qoz_string ret_ct = qoz_emit_c_type_for(e, ret_te); qoz_emit_ensure_byval_dispatch_helper(e, fn_name, ct, ret_ct); qoz_string _qoz_bv_220;
    {
        qoz_Strbuf _qoz_sb_2911_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2911_25); qoz_strings_sb_append(&_qoz_sb_2911_25, QOZ_STR_LIT("_qoz_byval_")); qoz_strings_sb_append(&_qoz_sb_2911_25, fn_name); qoz_strings_sb_append(&_qoz_sb_2911_25, QOZ_STR_LIT("(")); _qoz_bv_220 = qoz_strings_sb_finish(&_qoz_sb_2911_25);
    }
    ...
    0;  break; } default: { NULL;  break; } } 0; } } qoz_string record_name = qoz_emit_record_struct_name_of_ctype(e, lct); if (!qoz_strings_eq_raw(record_name, QOZ_STR_LIT(""))) { qoz_BinaryOp* _qoz_ms_260 = op; switch (_qoz_ms_260->tag) { case qoz_BinaryOp_BOpEq: { {
        qoz_string _qoz_bv_221;
    {
        qoz_Strbuf _qoz_sb_2934_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2934_21); qoz_strings_sb_append(&_qoz_sb_2934_21, QOZ_STR_LIT("qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_2934_21, record_name); qoz_strings_sb_append(&_qoz_sb_2934_21, QOZ_STR_LIT("(")); _qoz_bv_221 = qoz_strings_sb_finish(&_qoz_sb_2934_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_2932_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2932_21); qoz_strings_sb_append(&_qoz_sb_2932_21, QOZ_STR_LIT("!qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_2932_21, record_name); qoz_strings_sb_append(&_qoz_sb_2932_21, QOZ_STR_LIT("(")); _qoz_bv_222 = qoz_strings_sb_finish(&_qoz_sb_2932_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3056_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3056_13); qoz_strings_sb_append(&_qoz_sb_3056_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3056_13, bop); qoz_strings_sb_append(&_qoz_sb_3056_13, QOZ_STR_LIT(" ")); _qoz_bv_223 = qoz_strings_sb_finish(&_qoz_sb_3056_13);
    }
...
bool qoz_emit_is_logical_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_261 = op; bool _qoz_mv_261 = false; switch (_qoz_ms_261->tag) { case qoz_BinaryOp_BOpAnd: { _qoz_mv_261 = (true);  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_261 = (true);  break; } default: { _qoz_mv_261 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_261;
}
...
void qoz_emit_emit_binary_child(qoz_Emitter* e, qoz_Expr* ex, int64_t min_prec, bool force_paren_if_binary) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_262 = ex; switch (_qoz_ms_262->tag) { case qoz_Expr_EBinary: { if (force_paren_if_binary) { qoz_emit_push(e, QOZ_STR_LIT("(")); qoz_emit_emit_expr(e, ex); qoz_emit_push(e, QOZ_STR_LIT(")")); }  else { qoz_emit_emit_with_prec(e, ex, min_prec); } 0;  break; } default: { qoz_emit_emit_with_prec(e, ex, min_prec);  break; } } 0; 
    return;
}
...
int64_t qoz_emit_binary_prec(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_263 = op; int64_t _qoz_mv_263 = 0; switch (_qoz_ms_263->tag) { case qoz_BinaryOp_BOpMul: { _qoz_mv_263 = (12);  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_263 = (12);  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_263 = (12);  break; } case qoz_BinaryOp_BOpAdd: { _qoz_mv_263 = (11);  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_263 = (11);  break; } case qoz_BinaryOp_BOpShl: { _qoz_mv_263 = (10);  break; } case qoz_BinaryOp_BOpShr: { _qoz_mv_263 = (10);  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_263 = (8);  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_263 = (8);  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_263 = (8);  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_263 = (8);  break; } case qoz_BinaryOp_BOpRange: { _qoz_mv_263 = (8);  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_263 = (8);  break; } case qoz_BinaryOp_BOpEq: { _qoz_mv_263 = (7);  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_263 = (7);  break; } case qoz_BinaryOp_BOpBitAnd: { _qoz_mv_263 = (6);  break; } case qoz_BinaryOp_BOpBitXor: { _qoz_mv_263 = (5);  break; } case qoz_BinaryOp_BOpBitOr: { _qoz_mv_263 = (4);  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_263 = (3);  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_263 = (2);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_263;
}
...
void qoz_emit_emit_with_prec(qoz_Emitter* e, qoz_Expr* ex, int64_t min_prec) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_274 = ex; switch (_qoz_ms_274->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_274->payload.EBinary.f1; {
...
qoz_string qoz_emit_binary_c_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_275 = op; qoz_string _qoz_mv_275 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_275->tag) { case qoz_BinaryOp_BOpAdd: { _qoz_mv_275 = (QOZ_STR_LIT("+"));  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_275 = (QOZ_STR_LIT("-"));  break; } case qoz_BinaryOp_BOpMul: { _qoz_mv_275 = (QOZ_STR_LIT("*"));  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_275 = (QOZ_STR_LIT("/"));  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_275 = (QOZ_STR_LIT("%"));  break; } case qoz_BinaryOp_BOpEq: { _qoz_mv_275 = (QOZ_STR_LIT("=="));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_275 = (QOZ_STR_LIT("!="));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_275 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_275 = (QOZ_STR_LIT(">"));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_275 = (QOZ_STR_LIT("<="));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_275 = (QOZ_STR_LIT(">="));  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_275 = (QOZ_STR_LIT("&&"));  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_275 = (QOZ_STR_LIT("||"));  break; } case qoz_BinaryOp_BOpBitAnd: { _qoz_mv_275 = (QOZ_STR_LIT("&"));  break; } case qoz_BinaryOp_BOpBitOr: { _qoz_mv_275 = (QOZ_STR_LIT("|"));  break; } case qoz_BinaryOp_BOpBitXor: { _qoz_mv_275 = (QOZ_STR_LIT("^"));  break; } case qoz_BinaryOp_BOpShl: { _qoz_mv_275 = (QOZ_STR_LIT("<<"));  break; } case qoz_BinaryOp_BOpShr: { _qoz_mv_275 = (QOZ_STR_LIT(">>"));  break; } case qoz_BinaryOp_BOpRange: { _qoz_mv_275 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_275 = (QOZ_STR_LIT("<="));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_275;
}

qoz_string qoz_emit_unary_c_op(qoz_UnaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_UnaryOp* _qoz_ms_276 = op; qoz_string _qoz_mv_276 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_276->tag) { case qoz_UnaryOp_UOpNeg: { _qoz_mv_276 = (QOZ_STR_LIT("-"));  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_276 = (QOZ_STR_LIT("!"));  break; } case qoz_UnaryOp_UOpDeref: { _qoz_mv_276 = (QOZ_STR_LIT("*"));  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_276 = (QOZ_STR_LIT("&"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_276;
}

bool qoz_emit_is_block(qoz_Expr* ex) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_277 = ex; bool _qoz_mv_277 = false; switch (_qoz_ms_277->tag) { case qoz_Expr_EBlock: { _qoz_mv_277 = (true);  break; } default: { _qoz_mv_277 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_277;
}

bool qoz_emit_is_nil_expr(qoz_Expr* ex) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_278 = ex; bool _qoz_mv_278 = false; switch (_qoz_ms_278->tag) { case qoz_Expr_ENil: { _qoz_mv_278 = (true);  break; } default: { _qoz_mv_278 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_278;
}
...
void qoz_emit_emit_fn_body_block(qoz_Emitter* e, qoz_Expr* body, qoz_TypeExpr* ret_hint) {
    ...
    {
        qoz_Strbuf _qoz_sb_3112_48 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3112_48); qoz_strings_sb_append_i64(&_qoz_sb_3112_48, e->closure_counter); _qoz_bv_224 = qoz_strings_sb_finish(&_qoz_sb_3112_48);
    }
    qoz_string tmp = qoz_strings_cat(QOZ_STR_LIT("_qoz_ret_"), _qoz_bv_224); qoz_string rt = qoz_emit_c_type_for(e, ret_hint); qoz_string _qoz_bv_225;
    {
        qoz_Strbuf _qoz_sb_3114_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3114_21); qoz_strings_sb_append(&_qoz_sb_3114_21, rt); qoz_strings_sb_append(&_qoz_sb_3114_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3114_21, tmp); qoz_strings_sb_append(&_qoz_sb_3114_21, QOZ_STR_LIT(" = ")); _qoz_bv_225 = qoz_strings_sb_finish(&_qoz_sb_3114_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3128_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3128_21); qoz_strings_sb_append(&_qoz_sb_3128_21, QOZ_STR_LIT("\n    return ")); qoz_strings_sb_append(&_qoz_sb_3128_21, tmp); qoz_strings_sb_append(&_qoz_sb_3128_21, QOZ_STR_LIT(";\n")); _qoz_bv_226 = qoz_strings_sb_finish(&_qoz_sb_3128_21);
    }
...
bool qoz_emit_is_unit_typeexpr(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_272 = te; bool _qoz_mv_272 = false; switch (_qoz_ms_272->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_272 = (true);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_272->payload.TENamed.f1; bool _qoz_bv_227;
    {
        if ((path.len) != 1) { return false;} qoz_string n = path.data[0]; _qoz_bv_227 = qoz_strings_eq_raw(n, QOZ_STR_LIT("unit")) || qoz_strings_eq_raw(n, QOZ_STR_LIT("void"));
    }
    _qoz_mv_272 = (_qoz_bv_227);  break; } default: { _qoz_mv_272 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_272;
}
...
void qoz_emit_emit_fn(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    {
        qoz_Strbuf _qoz_sb_3259_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3259_13); qoz_strings_sb_append(&_qoz_sb_3259_13, ret_c); qoz_strings_sb_append(&_qoz_sb_3259_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3259_13, c_name); _qoz_bv_228 = qoz_strings_sb_finish(&_qoz_sb_3259_13);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3269_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3269_21); qoz_strings_sb_append(&_qoz_sb_3269_21, pc); qoz_strings_sb_append(&_qoz_sb_3269_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3269_21, pn); _qoz_bv_229 = qoz_strings_sb_finish(&_qoz_sb_3269_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3272_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3272_21); qoz_strings_sb_append(&_qoz_sb_3272_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_3272_21, pn); qoz_strings_sb_append(&_qoz_sb_3272_21, QOZ_STR_LIT(");\n    ")); _qoz_bv_230 = qoz_strings_sb_finish(&_qoz_sb_3272_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3284_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3284_21); qoz_strings_sb_append(&_qoz_sb_3284_21, QOZ_STR_LIT(";\n    ")); qoz_strings_sb_append(&_qoz_sb_3284_21, crr); qoz_strings_sb_append(&_qoz_sb_3284_21, QOZ_STR_LIT("return;\n")); _qoz_bv_231 = qoz_strings_sb_finish(&_qoz_sb_3284_21);
    }
    qoz_emit_push(e, _qoz_bv_231); }  else { qoz_string _qoz_bv_232;
    {
        qoz_Strbuf _qoz_sb_3286_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3286_21); qoz_strings_sb_append(&_qoz_sb_3286_21, crr); qoz_strings_sb_append(&_qoz_sb_3286_21, QOZ_STR_LIT("return ")); _qoz_bv_232 = qoz_strings_sb_finish(&_qoz_sb_3286_21);
    }
...
void qoz_emit_emit_records_topological(qoz_Emitter* e, qoz_File f) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_string names = qoz_vec_make__qoz_string(); qoz_Vec__qoz_Vec__qoz_StructField field_lists = qoz_vec_make__qoz_Vec__qoz_StructField(); { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_273 = d; switch (_qoz_ms_273->tag) { case qoz_Decl_DStruct: { qoz_string name = _qoz_ms_273->payload.DStruct.f1; qoz_Vec__qoz_string params = _qoz_ms_273->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_273->payload.DStruct.f3; if ((params.len) == 0) { qoz_vec_push__qoz_string(&names, name); qoz_vec_push__qoz_Vec__qoz_StructField(&field_lists, fields); } 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e->record_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_284 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, inst.name); switch (_qoz_ms_284->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_284->payload.Some.f0; qoz_Decl* _qoz_ms_285 = decl; switch (_qoz_ms_285->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_285->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_285->payload.DStruct.f3; {
...
qoz_Option__qoz_string* qoz_emit_value_field_dep(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_287 = te; qoz_Option__qoz_string* _qoz_mv_287 = NULL; switch (_qoz_ms_287->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_287->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_287->payload.TENamed.f2; qoz_Option__qoz_string* _qoz_bv_233;
    {
    ...
    _qoz_mv_287 = (_qoz_bv_233);  break; } default: { _qoz_mv_287 = (qoz_make_Option__qoz_string_None());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_287;
}
...
qoz_string qoz_emit_emit_program(qoz_File f, qoz_Map__int64_t__qoz_TypeExpr expr_types) {
    ...
    0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_282 = d; switch (_qoz_ms_282->tag) { case qoz_Decl_DEnum: { qoz_string name = _qoz_ms_282->payload.DEnum.f1; qoz_Vec__qoz_string params = _qoz_ms_282->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_282->payload.DEnum.f3; if ((params.len) == 0) { { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_emit_emit_variant_ctor(&e, name, v); } }} 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_283 = d; switch (_qoz_ms_283->tag) { case qoz_Decl_DFn: { qoz_string name = _qoz_ms_283->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_283->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_283->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_283->payload.DFn.f4; if (!qoz_emit_is_main(name) && ((tparams.len) == 0)) { qoz_emit_emit_fn_proto(&e, name, params, ret); } 0;  break; } case qoz_Decl_DExternal: { qoz_string symbol = _qoz_ms_283->payload.DExternal.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_283->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_283->payload.DExternal.f4; qoz_emit_emit_extern_proto(&e, symbol, params, ret);  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e.fn_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_294 = qoz_map_get__qoz_string__qoz_Decl(&e.generic_fn_decls, inst.name); switch (_qoz_ms_294->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_294->payload.Some.f0; qoz_Decl* _qoz_ms_295 = decl; switch (_qoz_ms_295->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_295->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_295->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_295->payload.DFn.f4; {
    ...
    0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } }qoz_emit_push(&e, QOZ_STR_LIT("\n")); { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_296 = d; switch (_qoz_ms_296->tag) { case qoz_Decl_DFn: { qoz_string name = _qoz_ms_296->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_296->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_296->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_296->payload.DFn.f4; qoz_Expr* body = _qoz_ms_296->payload.DFn.f5; if (qoz_emit_is_main(name)) { qoz_emit_emit_main(&e, ret, body); }  else if ((tparams.len) == 0) { qoz_emit_emit_fn(&e, name, params, ret, body); } 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e.fn_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_297 = qoz_map_get__qoz_string__qoz_Decl(&e.generic_fn_decls, inst.name); switch (_qoz_ms_297->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_297->payload.Some.f0; qoz_Decl* _qoz_ms_298 = decl; switch (_qoz_ms_298->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_298->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_298->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_298->payload.DFn.f4; qoz_Expr* body = _qoz_ms_298->payload.DFn.f5; {
...
void qoz_emit_emit_enum(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_VariantDecl variants) {
    ...
    {
        qoz_Strbuf _qoz_sb_3501_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3501_17); qoz_strings_sb_append(&_qoz_sb_3501_17, QOZ_STR_LIT("    qoz_")); qoz_strings_sb_append(&_qoz_sb_3501_17, name); qoz_strings_sb_append(&_qoz_sb_3501_17, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3501_17, vn); qoz_strings_sb_append(&_qoz_sb_3501_17, QOZ_STR_LIT(",\n")); _qoz_bv_234 = qoz_strings_sb_finish(&_qoz_sb_3501_17);
    }
    qoz_emit_push(e, _qoz_bv_234); i = i + 1; } }qoz_string _qoz_bv_235;
    {
        qoz_Strbuf _qoz_sb_3514_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3514_13); qoz_strings_sb_append(&_qoz_sb_3514_13, QOZ_STR_LIT("} qoz_")); qoz_strings_sb_append(&_qoz_sb_3514_13, name); qoz_strings_sb_append(&_qoz_sb_3514_13, QOZ_STR_LIT("_tag;\n\n")); _qoz_bv_235 = qoz_strings_sb_finish(&_qoz_sb_3514_13);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3523_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3523_25); qoz_strings_sb_append(&_qoz_sb_3523_25, QOZ_STR_LIT("    ")); qoz_strings_sb_append(&_qoz_sb_3523_25, pc); qoz_strings_sb_append(&_qoz_sb_3523_25, QOZ_STR_LIT(" f")); qoz_strings_sb_append(&_qoz_sb_3523_25, ks); qoz_strings_sb_append(&_qoz_sb_3523_25, QOZ_STR_LIT(";\n")); _qoz_bv_236 = qoz_strings_sb_finish(&_qoz_sb_3523_25);
    }
    qoz_emit_push(e, _qoz_bv_236); k = k + 1; } }qoz_string _qoz_bv_237;
    {
        qoz_Strbuf _qoz_sb_3520_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3520_21); qoz_strings_sb_append(&_qoz_sb_3520_21, QOZ_STR_LIT("} qoz_")); qoz_strings_sb_append(&_qoz_sb_3520_21, name); qoz_strings_sb_append(&_qoz_sb_3520_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3520_21, vn); qoz_strings_sb_append(&_qoz_sb_3520_21, QOZ_STR_LIT("_payload;\n\n")); _qoz_bv_237 = qoz_strings_sb_finish(&_qoz_sb_3520_21);
    }
    qoz_emit_push(e, _qoz_bv_237); } } }qoz_string _qoz_bv_238;
    {
        qoz_Strbuf _qoz_sb_3523_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3523_13); qoz_strings_sb_append(&_qoz_sb_3523_13, QOZ_STR_LIT("struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3523_13, name); qoz_strings_sb_append(&_qoz_sb_3523_13, QOZ_STR_LIT(" {\n    qoz_")); qoz_strings_sb_append(&_qoz_sb_3523_13, name); qoz_strings_sb_append(&_qoz_sb_3523_13, QOZ_STR_LIT("_tag tag;\n")); _qoz_bv_238 = qoz_strings_sb_finish(&_qoz_sb_3523_13);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3533_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3533_25); qoz_strings_sb_append(&_qoz_sb_3533_25, QOZ_STR_LIT("        qoz_")); qoz_strings_sb_append(&_qoz_sb_3533_25, name); qoz_strings_sb_append(&_qoz_sb_3533_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3533_25, vn); qoz_strings_sb_append(&_qoz_sb_3533_25, QOZ_STR_LIT("_payload ")); qoz_strings_sb_append(&_qoz_sb_3533_25, vn); qoz_strings_sb_append(&_qoz_sb_3533_25, QOZ_STR_LIT(";\n")); _qoz_bv_239 = qoz_strings_sb_finish(&_qoz_sb_3533_25);
    }
...
qoz_string qoz_emit_int_to_string(int64_t n) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_Strbuf _qoz_sb_3644_37 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3644_37); qoz_strings_sb_append_i64(&_qoz_sb_3644_37, n); qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_strings_sb_finish(&_qoz_sb_3644_37);
}
...
void qoz_emit_emit_variant_ctor(qoz_Emitter* e, qoz_string enum_name, qoz_VariantDecl v) {
    ...
    {
        qoz_Strbuf _qoz_sb_3658_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3658_13); qoz_strings_sb_append(&_qoz_sb_3658_13, QOZ_STR_LIT("static qoz_")); qoz_strings_sb_append(&_qoz_sb_3658_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3658_13, QOZ_STR_LIT(" *qoz_make_")); qoz_strings_sb_append(&_qoz_sb_3658_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3658_13, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3658_13, vn); _qoz_bv_240 = qoz_strings_sb_finish(&_qoz_sb_3658_13);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3668_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3668_21); qoz_strings_sb_append(&_qoz_sb_3668_21, pc); qoz_strings_sb_append(&_qoz_sb_3668_21, QOZ_STR_LIT(" f")); qoz_strings_sb_append(&_qoz_sb_3668_21, ks); _qoz_bv_241 = qoz_strings_sb_finish(&_qoz_sb_3668_21);
    }
    qoz_emit_push(e, _qoz_bv_241); k = k + 1; } }qoz_emit_push(e, QOZ_STR_LIT(") {\n")); } qoz_string _qoz_bv_242;
    {
        qoz_Strbuf _qoz_sb_3663_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3663_13); qoz_strings_sb_append(&_qoz_sb_3663_13, QOZ_STR_LIT("    qoz_")); qoz_strings_sb_append(&_qoz_sb_3663_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3663_13, QOZ_STR_LIT(" *p = qoz_gc_alloc(sizeof(qoz_")); qoz_strings_sb_append(&_qoz_sb_3663_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3663_13, QOZ_STR_LIT("), &qoz_")); qoz_strings_sb_append(&_qoz_sb_3663_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3663_13, QOZ_STR_LIT("_desc);\n")); _qoz_bv_242 = qoz_strings_sb_finish(&_qoz_sb_3663_13);
    }
    qoz_emit_push(e, _qoz_bv_242); qoz_string _qoz_bv_243;
    {
        qoz_Strbuf _qoz_sb_3664_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3664_13); qoz_strings_sb_append(&_qoz_sb_3664_13, QOZ_STR_LIT("    p->tag = qoz_")); qoz_strings_sb_append(&_qoz_sb_3664_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3664_13, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3664_13, vn); qoz_strings_sb_append(&_qoz_sb_3664_13, QOZ_STR_LIT(";\n")); _qoz_bv_243 = qoz_strings_sb_finish(&_qoz_sb_3664_13);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3679_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3679_21); qoz_strings_sb_append(&_qoz_sb_3679_21, QOZ_STR_LIT("    p->payload.")); qoz_strings_sb_append(&_qoz_sb_3679_21, vn); qoz_strings_sb_append(&_qoz_sb_3679_21, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_3679_21, js); qoz_strings_sb_append(&_qoz_sb_3679_21, QOZ_STR_LIT(" = f")); qoz_strings_sb_append(&_qoz_sb_3679_21, js); qoz_strings_sb_append(&_qoz_sb_3679_21, QOZ_STR_LIT(";\n")); _qoz_bv_244 = qoz_strings_sb_finish(&_qoz_sb_3679_21);
    }
...
void qoz_emit_collect_field_ptr_offsets(qoz_Emitter* e, qoz_string parent, qoz_string field, qoz_TypeExpr* te, qoz_Vec__qoz_string* out) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&out);
    qoz_string base = qoz_strings_cat(QOZ_STR_LIT("offsetof("), qoz_strings_cat(parent, qoz_strings_cat(QOZ_STR_LIT(", "), qoz_strings_cat(field, QOZ_STR_LIT(")"))))); qoz_TypeExpr* _qoz_ms_299 = te; switch (_qoz_ms_299->tag) { case qoz_TypeExpr_TEPtr: { qoz_vec_push__qoz_string(out, qoz_strings_cat(QOZ_STR_LIT("(int32_t)"), base));  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_299->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_299->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_vec_push__qoz_string(out, qoz_strings_cat(QOZ_STR_LIT("(int32_t)"), base)); return;} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("string"))) { qoz_vec_push__qoz_string(out, qoz_strings_cat(QOZ_STR_LIT("(int32_t)("), qoz_strings_cat(base, QOZ_STR_LIT(" + offsetof(qoz_string, data))")))); qoz_vec_push__qoz_string(out, qoz_strings_cat(QOZ_STR_LIT("(int32_t)("), qoz_strings_cat(base, QOZ_STR_LIT(" + offsetof(qoz_string, root))")))); return;} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("Vec")) || qoz_strings_eq_raw(n, QOZ_STR_LIT("Map"))) { qoz_vec_push__qoz_string(out, qoz_strings_cat(QOZ_STR_LIT("(int32_t)"), base)); return;} if ((args.len) == 0) { qoz_Option__qoz_Decl* _qoz_ms_290 = qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, n); switch (_qoz_ms_290->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_290->payload.Some.f0; qoz_Decl* _qoz_ms_291 = d; switch (_qoz_ms_291->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_291->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_291->payload.DStruct.f3; if ((params.len) == 0) { qoz_string inner_parent = qoz_strings_cat(QOZ_STR_LIT("struct qoz_"), n); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField sf = __col.data[__i]; (void)sf; qoz_string composed_parent = inner_parent; qoz_string composed_field = sf.name; qoz_Vec__qoz_string inner_offsets = qoz_vec_make__qoz_string(); qoz_emit_collect_field_ptr_offsets(e, composed_parent, composed_field, sf.ty, &inner_offsets); { qoz_Vec__qoz_string __col = inner_offsets; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string inner = __col.data[__i]; (void)inner; qoz_string stripped = qoz_strings_slice(inner, 9, (inner).len); qoz_vec_push__qoz_string(out, qoz_strings_cat(QOZ_STR_LIT("(int32_t)("), qoz_strings_cat(base, qoz_strings_cat(QOZ_STR_LIT(" + "), qoz_strings_cat(stripped, QOZ_STR_LIT(")")))))); } }} }return;} 0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } } 0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
void qoz_emit_emit_record_desc(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    ...
    {
        qoz_Strbuf _qoz_sb_3768_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3768_17); qoz_strings_sb_append(&_qoz_sb_3768_17, QOZ_STR_LIT("static const int32_t qoz_")); qoz_strings_sb_append(&_qoz_sb_3768_17, name); qoz_strings_sb_append(&_qoz_sb_3768_17, QOZ_STR_LIT("_offsets[] = { ")); _qoz_bv_245 = qoz_strings_sb_finish(&_qoz_sb_3768_17);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3778_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3778_17); qoz_strings_sb_append(&_qoz_sb_3778_17, QOZ_STR_LIT("static const qoz_type_desc qoz_")); qoz_strings_sb_append(&_qoz_sb_3778_17, name); qoz_strings_sb_append(&_qoz_sb_3778_17, QOZ_STR_LIT("_desc = { QOZ_DESC_LEAF, (int32_t)sizeof(struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3778_17, name); qoz_strings_sb_append(&_qoz_sb_3778_17, QOZ_STR_LIT("), 0, NULL, 0, 0, 0, NULL, \"")); qoz_strings_sb_append(&_qoz_sb_3778_17, name); qoz_strings_sb_append(&_qoz_sb_3778_17, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_246 = qoz_strings_sb_finish(&_qoz_sb_3778_17);
    }
    qoz_emit_push(e, _qoz_bv_246); }  else { qoz_string np = qoz_emit_int_to_string(nptrs); qoz_string _qoz_bv_247;
    {
        qoz_Strbuf _qoz_sb_3771_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3771_17); qoz_strings_sb_append(&_qoz_sb_3771_17, QOZ_STR_LIT("static const qoz_type_desc qoz_")); qoz_strings_sb_append(&_qoz_sb_3771_17, name); qoz_strings_sb_append(&_qoz_sb_3771_17, QOZ_STR_LIT("_desc = { QOZ_DESC_OFFSETS, (int32_t)sizeof(struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3771_17, name); qoz_strings_sb_append(&_qoz_sb_3771_17, QOZ_STR_LIT("), ")); qoz_strings_sb_append(&_qoz_sb_3771_17, np); qoz_strings_sb_append(&_qoz_sb_3771_17, QOZ_STR_LIT(", qoz_")); qoz_strings_sb_append(&_qoz_sb_3771_17, name); qoz_strings_sb_append(&_qoz_sb_3771_17, QOZ_STR_LIT("_offsets, 0, 0, 0, NULL, \"")); qoz_strings_sb_append(&_qoz_sb_3771_17, name); qoz_strings_sb_append(&_qoz_sb_3771_17, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_247 = qoz_strings_sb_finish(&_qoz_sb_3771_17);
    }
...
void qoz_emit_emit_adt_desc(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_VariantDecl variants) {
    ...
    {
        qoz_Strbuf _qoz_sb_3718_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3718_21); qoz_strings_sb_append(&_qoz_sb_3718_21, QOZ_STR_LIT("static const int32_t qoz_")); qoz_strings_sb_append(&_qoz_sb_3718_21, name); qoz_strings_sb_append(&_qoz_sb_3718_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3718_21, vn); qoz_strings_sb_append(&_qoz_sb_3718_21, QOZ_STR_LIT("_offsets[] = { ")); _qoz_bv_248 = qoz_strings_sb_finish(&_qoz_sb_3718_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3728_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3728_13); qoz_strings_sb_append(&_qoz_sb_3728_13, QOZ_STR_LIT("static const qoz_variant_desc qoz_")); qoz_strings_sb_append(&_qoz_sb_3728_13, name); qoz_strings_sb_append(&_qoz_sb_3728_13, QOZ_STR_LIT("_variants[] = {\n")); _qoz_bv_249 = qoz_strings_sb_finish(&_qoz_sb_3728_13);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3725_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3725_21); qoz_strings_sb_append(&_qoz_sb_3725_21, QOZ_STR_LIT("    { qoz_")); qoz_strings_sb_append(&_qoz_sb_3725_21, name); qoz_strings_sb_append(&_qoz_sb_3725_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3725_21, vn); qoz_strings_sb_append(&_qoz_sb_3725_21, QOZ_STR_LIT(", ")); qoz_strings_sb_append(&_qoz_sb_3725_21, np); qoz_strings_sb_append(&_qoz_sb_3725_21, QOZ_STR_LIT(", qoz_")); qoz_strings_sb_append(&_qoz_sb_3725_21, name); qoz_strings_sb_append(&_qoz_sb_3725_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3725_21, vn); qoz_strings_sb_append(&_qoz_sb_3725_21, QOZ_STR_LIT("_offsets },\n")); _qoz_bv_250 = qoz_strings_sb_finish(&_qoz_sb_3725_21);
    }
    qoz_emit_push(e, _qoz_bv_250); }  else { qoz_string _qoz_bv_251;
    {
        qoz_Strbuf _qoz_sb_3737_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3737_21); qoz_strings_sb_append(&_qoz_sb_3737_21, QOZ_STR_LIT("    { qoz_")); qoz_strings_sb_append(&_qoz_sb_3737_21, name); qoz_strings_sb_append(&_qoz_sb_3737_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3737_21, vn); qoz_strings_sb_append(&_qoz_sb_3737_21, QOZ_STR_LIT(", ")); qoz_strings_sb_append(&_qoz_sb_3737_21, np); qoz_strings_sb_append(&_qoz_sb_3737_21, QOZ_STR_LIT(", NULL },\n")); _qoz_bv_251 = qoz_strings_sb_finish(&_qoz_sb_3737_21);
    }
    qoz_emit_push(e, _qoz_bv_251); } } }qoz_emit_push(e, QOZ_STR_LIT("};\n")); bool any_payload2 = false; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_emit_variant_has_positional(v)) { any_payload2 = true; } } }qoz_string payload_off_expr = ((any_payload2) ? qoz_strings_cat(QOZ_STR_LIT("(int32_t)offsetof(struct qoz_"), qoz_strings_cat(name, QOZ_STR_LIT(", payload)"))) : QOZ_STR_LIT("0")); qoz_string nvar = qoz_emit_int_to_string((variants.len)); qoz_string _qoz_bv_252;
    {
        qoz_Strbuf _qoz_sb_3841_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3841_13); qoz_strings_sb_append(&_qoz_sb_3841_13, QOZ_STR_LIT("static const qoz_type_desc qoz_")); qoz_strings_sb_append(&_qoz_sb_3841_13, name); qoz_strings_sb_append(&_qoz_sb_3841_13, QOZ_STR_LIT("_desc = { QOZ_DESC_ADT, (int32_t)sizeof(struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3841_13, name); qoz_strings_sb_append(&_qoz_sb_3841_13, QOZ_STR_LIT("), 0, NULL, (int32_t)offsetof(struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3841_13, name); qoz_strings_sb_append(&_qoz_sb_3841_13, QOZ_STR_LIT(", tag), ")); qoz_strings_sb_append(&_qoz_sb_3841_13, payload_off_expr); qoz_strings_sb_append(&_qoz_sb_3841_13, QOZ_STR_LIT(", ")); qoz_strings_sb_append(&_qoz_sb_3841_13, nvar); qoz_strings_sb_append(&_qoz_sb_3841_13, QOZ_STR_LIT(", qoz_")); qoz_strings_sb_append(&_qoz_sb_3841_13, name); qoz_strings_sb_append(&_qoz_sb_3841_13, QOZ_STR_LIT("_variants, \"")); qoz_strings_sb_append(&_qoz_sb_3841_13, name); qoz_strings_sb_append(&_qoz_sb_3841_13, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_252 = qoz_strings_sb_finish(&_qoz_sb_3841_13);
    }
...
void qoz_emit_emit_struct(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    ...
    {
        qoz_Strbuf _qoz_sb_3845_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3845_13); qoz_strings_sb_append(&_qoz_sb_3845_13, QOZ_STR_LIT("struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3845_13, name); qoz_strings_sb_append(&_qoz_sb_3845_13, QOZ_STR_LIT(" {\n")); _qoz_bv_253 = qoz_strings_sb_finish(&_qoz_sb_3845_13);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3859_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3859_17); qoz_strings_sb_append(&_qoz_sb_3859_17, QOZ_STR_LIT("    ")); qoz_strings_sb_append(&_qoz_sb_3859_17, ct); qoz_strings_sb_append(&_qoz_sb_3859_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3859_17, fname); qoz_strings_sb_append(&_qoz_sb_3859_17, QOZ_STR_LIT(";\n")); _qoz_bv_254 = qoz_strings_sb_finish(&_qoz_sb_3859_17);
    }
...
void qoz_emit_emit_record_eq(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    ...
    {
        qoz_Strbuf _qoz_sb_3867_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3867_13); qoz_strings_sb_append(&_qoz_sb_3867_13, QOZ_STR_LIT("static bool qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_3867_13, name); qoz_strings_sb_append(&_qoz_sb_3867_13, QOZ_STR_LIT("(qoz_")); qoz_strings_sb_append(&_qoz_sb_3867_13, name); qoz_strings_sb_append(&_qoz_sb_3867_13, QOZ_STR_LIT(" a, qoz_")); qoz_strings_sb_append(&_qoz_sb_3867_13, name); qoz_strings_sb_append(&_qoz_sb_3867_13, QOZ_STR_LIT(" b) {\n    return ")); _qoz_bv_255 = qoz_strings_sb_finish(&_qoz_sb_3867_13);
    }
...
void qoz_emit_emit_record_hash(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string _qoz_bv_250;
    {
        qoz_Strbuf _qoz_sb_3873_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3873_13); qoz_strings_sb_append(&_qoz_sb_3873_13, QOZ_STR_LIT("static uint64_t qoz_hash_")); qoz_strings_sb_append(&_qoz_sb_3873_13, name); qoz_strings_sb_append(&_qoz_sb_3873_13, QOZ_STR_LIT("(qoz_")); qoz_strings_sb_append(&_qoz_sb_3873_13, name); qoz_strings_sb_append(&_qoz_sb_3873_13, QOZ_STR_LIT(" v) {\n    uint64_t h = 0;\n")); _qoz_bv_250 = qoz_strings_sb_finish(&_qoz_sb_3873_13);
    }
    qoz_emit_push(e, _qoz_bv_250); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; qoz_emit_push(e, QOZ_STR_LIT("    h = h * 31 + (uint64_t)(")); qoz_emit_emit_field_hash_expr(e, f.ty, f.name); qoz_emit_push(e, QOZ_STR_LIT(");\n")); } }qoz_emit_push(e, QOZ_STR_LIT("    return h;\n}\n\n")); 
    return;
}
...
void qoz_emit_emit_field_hash_expr(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string fname) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_string ct = qoz_emit_c_type_for(e, te); if (qoz_strings_eq_raw(ct, QOZ_STR_LIT("qoz_string"))) { qoz_string _qoz_bv_251;
    {
        qoz_Strbuf _qoz_sb_3889_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3889_17); qoz_strings_sb_append(&_qoz_sb_3889_17, QOZ_STR_LIT("qoz_string_hash(v.")); qoz_strings_sb_append(&_qoz_sb_3889_17, fname); qoz_strings_sb_append(&_qoz_sb_3889_17, QOZ_STR_LIT(")")); _qoz_bv_251 = qoz_strings_sb_finish(&_qoz_sb_3889_17);
    }
    qoz_emit_push(e, _qoz_bv_251); return;} qoz_TypeExpr* _qoz_ms_292 = te; switch (_qoz_ms_292->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_292->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_292->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(qoz_emit_primitive_c_name(n), QOZ_STR_LIT(""))) { if (!qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_string mangled = (((args.len) > 0) ? qoz_emit_mangle_inst(e, n, args) : n); qoz_string _qoz_bv_252;
    {
        qoz_Strbuf _qoz_sb_3899_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3899_29); qoz_strings_sb_append(&_qoz_sb_3899_29, QOZ_STR_LIT("qoz_hash_")); qoz_strings_sb_append(&_qoz_sb_3899_29, mangled); qoz_strings_sb_append(&_qoz_sb_3899_29, QOZ_STR_LIT("(v.")); qoz_strings_sb_append(&_qoz_sb_3899_29, fname); qoz_strings_sb_append(&_qoz_sb_3899_29, QOZ_STR_LIT(")")); _qoz_bv_252 = qoz_strings_sb_finish(&_qoz_sb_3899_29);
    }
    qoz_emit_push(e, _qoz_bv_252); return;} } } 0;  break; } default: { NULL;  break; } } 0; qoz_string _qoz_bv_253;
    {
        qoz_Strbuf _qoz_sb_3807_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3807_13); qoz_strings_sb_append(&_qoz_sb_3807_13, QOZ_STR_LIT("v.")); qoz_strings_sb_append(&_qoz_sb_3807_13, fname); _qoz_bv_253 = qoz_strings_sb_finish(&_qoz_sb_3807_13);
    }
    qoz_emit_push(e, _qoz_bv_253); 
    return;
}
...
void qoz_emit_emit_field_eq_expr(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string fname) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_string ct = qoz_emit_c_type_for(e, te); if (qoz_strings_eq_raw(ct, QOZ_STR_LIT("qoz_string"))) { qoz_string _qoz_bv_264;
    {
        qoz_Strbuf _qoz_sb_3813_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3813_17); qoz_strings_sb_append(&_qoz_sb_3813_17, QOZ_STR_LIT("qoz_string_eq(a.")); qoz_strings_sb_append(&_qoz_sb_3813_17, fname); qoz_strings_sb_append(&_qoz_sb_3813_17, QOZ_STR_LIT(", b.")); qoz_strings_sb_append(&_qoz_sb_3813_17, fname); qoz_strings_sb_append(&_qoz_sb_3813_17, QOZ_STR_LIT(")")); _qoz_bv_264 = qoz_strings_sb_finish(&_qoz_sb_3813_17);
    }
    qoz_emit_push(e, _qoz_bv_264); return;} qoz_TypeExpr* _qoz_ms_293 = te; switch (_qoz_ms_293->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_293->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_293->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(qoz_emit_primitive_c_name(n), QOZ_STR_LIT(""))) { if (!qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_string mangled = (((args.len) > 0) ? qoz_emit_mangle_inst(e, n, args) : n); qoz_string _qoz_bv_265;
    {
        qoz_Strbuf _qoz_sb_3823_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3823_29); qoz_strings_sb_append(&_qoz_sb_3823_29, QOZ_STR_LIT("qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_3823_29, mangled); qoz_strings_sb_append(&_qoz_sb_3823_29, QOZ_STR_LIT("(a.")); qoz_strings_sb_append(&_qoz_sb_3823_29, fname); qoz_strings_sb_append(&_qoz_sb_3823_29, QOZ_STR_LIT(", b.")); qoz_strings_sb_append(&_qoz_sb_3823_29, fname); qoz_strings_sb_append(&_qoz_sb_3823_29, QOZ_STR_LIT(")")); _qoz_bv_265 = qoz_strings_sb_finish(&_qoz_sb_3823_29);
    }
    qoz_emit_push(e, _qoz_bv_265); return;} } } 0;  break; } default: { NULL;  break; } } 0; qoz_string _qoz_bv_266;
    {
        qoz_Strbuf _qoz_sb_3831_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3831_13); qoz_strings_sb_append(&_qoz_sb_3831_13, QOZ_STR_LIT("a.")); qoz_strings_sb_append(&_qoz_sb_3831_13, fname); qoz_strings_sb_append(&_qoz_sb_3831_13, QOZ_STR_LIT(" == b.")); qoz_strings_sb_append(&_qoz_sb_3831_13, fname); _qoz_bv_266 = qoz_strings_sb_finish(&_qoz_sb_3831_13);
    }
    qoz_emit_push(e, _qoz_bv_266); 
    return;
}
...
void qoz_emit_emit_fn_proto(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ret);
    qoz_string rc = qoz_emit_c_type_for(e, ret); qoz_string c_name = qoz_emit_user_fn_c_name(name); qoz_string _qoz_bv_267;
    {
        qoz_Strbuf _qoz_sb_3837_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3837_13); qoz_strings_sb_append(&_qoz_sb_3837_13, rc); qoz_strings_sb_append(&_qoz_sb_3837_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3837_13, c_name); _qoz_bv_267 = qoz_strings_sb_finish(&_qoz_sb_3837_13);
    }
    qoz_emit_push(e, _qoz_bv_267); if ((params.len) == 0) { qoz_emit_push(e, QOZ_STR_LIT("(void);\n")); return;} qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = qoz_emit_c_type_for(e, p.ty); qoz_string pn = p.name; qoz_string _qoz_bv_268;
    {
        qoz_Strbuf _qoz_sb_3948_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3948_17); qoz_strings_sb_append(&_qoz_sb_3948_17, pc); qoz_strings_sb_append(&_qoz_sb_3948_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3948_17, pn); _qoz_bv_268 = qoz_strings_sb_finish(&_qoz_sb_3948_17);
    }
    qoz_emit_push(e, _qoz_bv_268); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(");\n")); 
    return;
}
...
void qoz_emit_emit_extern_proto(qoz_Emitter* e, qoz_string symbol, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ret);
    qoz_string rc = qoz_emit_c_type_for(e, ret); qoz_string _qoz_bv_269;
    {
        qoz_Strbuf _qoz_sb_3956_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3956_13); qoz_strings_sb_append(&_qoz_sb_3956_13, QOZ_STR_LIT("extern ")); qoz_strings_sb_append(&_qoz_sb_3956_13, rc); qoz_strings_sb_append(&_qoz_sb_3956_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3956_13, symbol); _qoz_bv_269 = qoz_strings_sb_finish(&_qoz_sb_3956_13);
    }
    qoz_emit_push(e, _qoz_bv_269); if ((params.len) == 0) { qoz_emit_push(e, QOZ_STR_LIT("(void);\n")); return;} qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_push(e, qoz_emit_c_type_for(e, p.ty)); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(");\n")); 
    return;
}
...
bool qoz_emit_is_range_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_304 = op; bool _qoz_mv_304 = false; switch (_qoz_ms_304->tag) { case qoz_BinaryOp_BOpRange: { _qoz_mv_304 = (true);  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_304 = (true);  break; } default: { _qoz_mv_304 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_304;
}

qoz_string qoz_emit_range_cmp_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_305 = op; qoz_string _qoz_mv_305 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_305->tag) { case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_305 = (QOZ_STR_LIT("<="));  break; } default: { _qoz_mv_305 = (QOZ_STR_LIT("<"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_305;
}
...
void qoz_emit_emit_block_tail_as_value(qoz_Emitter* e, qoz_Expr* tail) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&tail);
    qoz_Expr* _qoz_ms_306 = tail; switch (_qoz_ms_306->tag) { case qoz_Expr_EAssign: { qoz_Expr* lhs = _qoz_ms_306->payload.EAssign.f2; qoz_Expr* rhs = _qoz_ms_306->payload.EAssign.f3; {
    ...
    0;  break; } case qoz_Expr_EIf: { qoz_Expr* f = _qoz_ms_306->payload.EIf.f3; {
...
bool qoz_emit_hint_is_unsigned_int(qoz_TypeExpr* hint) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_307 = hint; bool _qoz_mv_307 = false; switch (_qoz_ms_307->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_307->payload.TENamed.f1; bool _qoz_bv_260;
    {
        if ((path.len) != 1) { return false;} qoz_string n = path.data[0]; _qoz_bv_260 = ((qoz_strings_eq_raw(n, QOZ_STR_LIT("u8")) || qoz_strings_eq_raw(n, QOZ_STR_LIT("u16"))) || qoz_strings_eq_raw(n, QOZ_STR_LIT("u32"))) || qoz_strings_eq_raw(n, QOZ_STR_LIT("u64"));
    }
    _qoz_mv_307 = (_qoz_bv_260);  break; } default: { _qoz_mv_307 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_307;
}

bool qoz_emit_hint_is_cstring(qoz_TypeExpr* hint) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_308 = hint; bool _qoz_mv_308 = false; switch (_qoz_ms_308->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_308->payload.TENamed.f1; _qoz_mv_308 = (((path.len) == 1) && qoz_strings_eq_raw(path.data[0], QOZ_STR_LIT("cstring")));  break; } default: { _qoz_mv_308 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_308;
}
...
void qoz_emit_emit_value_with_hint(qoz_Emitter* e, qoz_Expr* value, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&value);
    qoz_gc_push_root(&hint);
    qoz_Expr* _qoz_ms_309 = value; switch (_qoz_ms_309->tag) { case qoz_Expr_EString: { qoz_string raw = _qoz_ms_309->payload.EString.f1; {
        if (qoz_emit_hint_is_cstring(hint)) { qoz_emit_push(e, raw); }  else { qoz_string _qoz_bv_261;
    {
        qoz_Strbuf _qoz_sb_4050_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4050_21); qoz_strings_sb_append(&_qoz_sb_4050_21, QOZ_STR_LIT("QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_4050_21, raw); qoz_strings_sb_append(&_qoz_sb_4050_21, QOZ_STR_LIT(")")); _qoz_bv_261 = qoz_strings_sb_finish(&_qoz_sb_4050_21);
    }
    qoz_emit_push(e, _qoz_bv_261); } return;
    }
    0;  break; } case qoz_Expr_EInt: { qoz_string text = _qoz_ms_309->payload.EInt.f1; {
    ...
    0;  break; } default: { NULL;  break; } } 0; qoz_Expr* _qoz_ms_300 = value; switch (_qoz_ms_300->tag) { case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_300->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_300->payload.ERecord.f2; qoz_emit_emit_record_lit_with_hint(e, te, fields, hint);  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_300->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_300->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_300->payload.ECall.f3; qoz_emit_emit_call_with_hint(e, callee, ta, args, hint);  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_300->payload.EIdent.f1; qoz_emit_emit_ident_with_hint(e, name, hint);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_300->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_300->payload.EArrayLit.f1; qoz_emit_emit_array_lit_with_hint(e, sp, elems, hint);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_300->payload.EField.f1; qoz_string name = _qoz_ms_300->payload.EField.f2; {
        bool did_emit = qoz_emit_emit_qualified_variant_with_hint(e, base, name, hint); if (!did_emit) { qoz_emit_emit_field(e, base, name); } 
    }
    0;  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_300->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_300->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_300->payload.EBlock.f2; {
        if ((stmts.len) == 0) { qoz_Expr* _qoz_ms_301 = tail; switch (_qoz_ms_301->tag) { case qoz_Expr_EWhile: { {
    ...
    0;  break; } default: { qoz_emit_emit_value_with_hint(e, tail, hint);  break; } } 0; return;} e->closure_counter = e->closure_counter + 1; int64_t counter = e->closure_counter; qoz_string _qoz_bv_262;
    {
        qoz_Strbuf _qoz_sb_4002_47 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4002_47); qoz_strings_sb_append_i64(&_qoz_sb_4002_47, counter); _qoz_bv_262 = qoz_strings_sb_finish(&_qoz_sb_4002_47);
    }
    qoz_string tmp_res = qoz_strings_cat(QOZ_STR_LIT("_qoz_bv_"), _qoz_bv_262); qoz_string result_c = qoz_emit_c_type_for(e, hint); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_263;
    {
        qoz_Strbuf _qoz_sb_4005_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4005_17); qoz_strings_sb_append(&_qoz_sb_4005_17, result_c); qoz_strings_sb_append(&_qoz_sb_4005_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4005_17, tmp_res); qoz_strings_sb_append(&_qoz_sb_4005_17, QOZ_STR_LIT(";\n    {\n        ")); _qoz_bv_263 = qoz_strings_sb_finish(&_qoz_sb_4005_17);
    }
    qoz_emit_push(e, _qoz_bv_263); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_emit_stmt(e, s); } }qoz_Expr* _qoz_ms_302 = tail; switch (_qoz_ms_302->tag) { case qoz_Expr_EWhile: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved); qoz_string _qoz_bv_274;
    {
        qoz_Strbuf _qoz_sb_4012_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4012_21); qoz_strings_sb_append(&_qoz_sb_4012_21, QOZ_STR_LIT("\n        ")); qoz_strings_sb_append(&_qoz_sb_4012_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4012_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_274 = qoz_strings_sb_finish(&_qoz_sb_4012_21);
    }
    qoz_emit_push(e, _qoz_bv_274); 
    }
    0;  break; } case qoz_Expr_EFor: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved); qoz_string _qoz_bv_275;
    {
        qoz_Strbuf _qoz_sb_4012_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4012_21); qoz_strings_sb_append(&_qoz_sb_4012_21, QOZ_STR_LIT("\n        ")); qoz_strings_sb_append(&_qoz_sb_4012_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4012_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_275 = qoz_strings_sb_finish(&_qoz_sb_4012_21);
    }
    qoz_emit_push(e, _qoz_bv_275); 
    }
    0;  break; } case qoz_Expr_EAssign: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved); qoz_string _qoz_bv_276;
    {
        qoz_Strbuf _qoz_sb_4012_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4012_21); qoz_strings_sb_append(&_qoz_sb_4012_21, QOZ_STR_LIT("\n        ")); qoz_strings_sb_append(&_qoz_sb_4012_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4012_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_276 = qoz_strings_sb_finish(&_qoz_sb_4012_21);
    }
    qoz_emit_push(e, _qoz_bv_276); 
    }
    0;  break; } default: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_string _qoz_bv_277;
    {
        qoz_Strbuf _qoz_sb_4016_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4016_21); qoz_strings_sb_append(&_qoz_sb_4016_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4016_21, QOZ_STR_LIT(" = ")); _qoz_bv_277 = qoz_strings_sb_finish(&_qoz_sb_4016_21);
    }
    qoz_emit_push(e, _qoz_bv_277); qoz_emit_emit_value_with_hint(e, tail, hint); qoz_emit_push(e, QOZ_STR_LIT(";\n    ")); qoz_emit_close_statement_scope(e, saved); 
    }
    0;  break; } } 0; qoz_emit_push(e, QOZ_STR_LIT("}\n    ")); qoz_emit_hoist_to_prologue(e, start); qoz_emit_push(e, tmp_res); 
    }
    0;  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_300->payload.EIf.f0; qoz_Expr* c = _qoz_ms_300->payload.EIf.f1; qoz_Expr* t = _qoz_ms_300->payload.EIf.f2; qoz_Expr* f = _qoz_ms_300->payload.EIf.f3; {
    ...
    0;  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_300->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_300->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_300->payload.EMatch.f2; qoz_emit_emit_match_as_expr_with_hint(e, sp, scrut, arms, hint);  break; } default: { qoz_emit_emit_expr(e, value);  break; } } 0; 
    return;
}
...
bool qoz_emit_emit_qualified_variant_with_hint(qoz_Emitter* e, qoz_Expr* base, qoz_string name, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&base);
    qoz_gc_push_root(&hint);
    qoz_Expr* _qoz_ms_303 = base; bool _qoz_mv_303 = false; switch (_qoz_ms_303->tag) { case qoz_Expr_EIdent: { qoz_string enum_name = _qoz_ms_303->payload.EIdent.f1; bool _qoz_bv_278;
    {
        if (!qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, enum_name)) { return false;} qoz_Option__qoz_string* _qoz_ms_314 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); bool _qoz_mv_314 = false; switch (_qoz_ms_314->tag) { case qoz_Option__qoz_string_Some: { bool _qoz_bv_279;
    {
        qoz_Vec__qoz_TypeExpr hint_args = qoz_emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = qoz_emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_270;
    {
        qoz_Strbuf _qoz_sb_4164_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4164_25); qoz_strings_sb_append(&_qoz_sb_4164_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4164_25, mangled); qoz_strings_sb_append(&_qoz_sb_4164_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4164_25, name); qoz_strings_sb_append(&_qoz_sb_4164_25, QOZ_STR_LIT("()")); _qoz_bv_270 = qoz_strings_sb_finish(&_qoz_sb_4164_25);
    }
    qoz_emit_push(e, _qoz_bv_270); }  else { qoz_string _qoz_bv_271;
    {
        qoz_Strbuf _qoz_sb_4166_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4166_25); qoz_strings_sb_append(&_qoz_sb_4166_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4166_25, enum_name); qoz_strings_sb_append(&_qoz_sb_4166_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4166_25, name); qoz_strings_sb_append(&_qoz_sb_4166_25, QOZ_STR_LIT("()")); _qoz_bv_271 = qoz_strings_sb_finish(&_qoz_sb_4166_25);
    }
    qoz_emit_push(e, _qoz_bv_271); } _qoz_bv_279 = true;
    }
    _qoz_mv_314 = (_qoz_bv_279);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_314 = (false);  break; } } _qoz_bv_278 = _qoz_mv_314;
    }
    _qoz_mv_303 = (_qoz_bv_278);  break; } default: { _qoz_mv_303 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_303;
}
...
void qoz_emit_emit_ident_with_hint(qoz_Emitter* e, qoz_string name, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&hint);
    qoz_Option__qoz_string* _qoz_ms_315 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_315->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_315->payload.Some.f0; {
        qoz_Vec__qoz_TypeExpr hint_args = qoz_emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = qoz_emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_272;
    {
        qoz_Strbuf _qoz_sb_4173_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4173_21); qoz_strings_sb_append(&_qoz_sb_4173_21, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4173_21, mangled); qoz_strings_sb_append(&_qoz_sb_4173_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4173_21, name); qoz_strings_sb_append(&_qoz_sb_4173_21, QOZ_STR_LIT("()")); _qoz_bv_272 = qoz_strings_sb_finish(&_qoz_sb_4173_21);
    }
    qoz_emit_push(e, _qoz_bv_272); return;} qoz_string _qoz_bv_273;
    {
        qoz_Strbuf _qoz_sb_4186_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4186_17); qoz_strings_sb_append(&_qoz_sb_4186_17, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4186_17, enum_name); qoz_strings_sb_append(&_qoz_sb_4186_17, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4186_17, name); qoz_strings_sb_append(&_qoz_sb_4186_17, QOZ_STR_LIT("()")); _qoz_bv_273 = qoz_strings_sb_finish(&_qoz_sb_4186_17);
    }
    qoz_emit_push(e, _qoz_bv_273); 
    }
    0;  break; } case qoz_Option__qoz_string_None: { {
        qoz_TypeExpr* _qoz_ms_316 = hint; switch (_qoz_ms_316->tag) { case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr fn_ps = _qoz_ms_316->payload.TEFn.f1; qoz_TypeExpr* fn_ret = _qoz_ms_316->payload.TEFn.f2; if (qoz_map_contains__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, name)) { if (!qoz_map_contains__qoz_string__qoz_TypeExpr(&e->locals, name)) { qoz_string thunk = qoz_emit_register_fn_thunk(e, name, fn_ps, fn_ret); qoz_string clo_t = qoz_emit_c_type_for(e, hint); qoz_string _qoz_bv_284;
    {
        qoz_Strbuf _qoz_sb_4197_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4197_29); qoz_strings_sb_append(&_qoz_sb_4197_29, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_4197_29, clo_t); qoz_strings_sb_append(&_qoz_sb_4197_29, QOZ_STR_LIT("){ .env = NULL, .fn = ")); qoz_strings_sb_append(&_qoz_sb_4197_29, thunk); qoz_strings_sb_append(&_qoz_sb_4197_29, QOZ_STR_LIT(" })")); _qoz_bv_284 = qoz_strings_sb_finish(&_qoz_sb_4197_29);
    }
    qoz_emit_push(e, _qoz_bv_284); return;} } 0;  break; } default: { NULL;  break; } } 0; qoz_emit_push(e, name); 
    }
    0;  break; } } 0; 
    return;
}
...
void qoz_emit_emit_call_with_hint(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&callee);
    qoz_gc_push_root(&hint);
    if ((type_args.len) > 0) { qoz_emit_emit_call(e, callee, type_args, args); return;} qoz_string variant_name = qoz_emit_variant_callee_name(e, callee); if (!qoz_strings_eq_raw(variant_name, QOZ_STR_LIT(""))) { qoz_Option__qoz_string* _qoz_ms_317 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, variant_name); switch (_qoz_ms_317->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_317->payload.Some.f0; {
        qoz_Vec__qoz_TypeExpr hint_args = qoz_emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = qoz_emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_285;
    {
        qoz_Strbuf _qoz_sb_4288_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4288_25); qoz_strings_sb_append(&_qoz_sb_4288_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4288_25, mangled); qoz_strings_sb_append(&_qoz_sb_4288_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4288_25, variant_name); qoz_strings_sb_append(&_qoz_sb_4288_25, QOZ_STR_LIT("(")); _qoz_bv_285 = qoz_strings_sb_finish(&_qoz_sb_4288_25);
    }
    qoz_emit_push(e, _qoz_bv_285); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;} 
    }
...
qoz_Vec__qoz_TypeExpr qoz_emit_hint_args_for_enum(qoz_TypeExpr* hint, qoz_string enum_name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_318 = hint; qoz_Vec__qoz_TypeExpr _qoz_mv_318 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_318->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_318->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_318->payload.TENamed.f2; qoz_Vec__qoz_TypeExpr _qoz_bv_286;
    {
        if ((path.len) >= 1) { qoz_string last = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(last, enum_name)) { return args;} } _qoz_bv_286 = qoz_vec_make__qoz_TypeExpr();
    }
    _qoz_mv_318 = (_qoz_bv_286);  break; } default: { _qoz_mv_318 = (qoz_vec_make__qoz_TypeExpr());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_318;
}
...
void qoz_emit_emit_record_lit_with_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_Vec__qoz_RecordFieldLit fields, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* effective = qoz_emit_pick_type_with_args(te, hint); qoz_gc_push_root(&effective); qoz_Vec__qoz_RecordFieldLit expanded = qoz_emit_expand_record_spread_fields(e, effective, fields); qoz_string ec = qoz_emit_c_type_for(e, effective); qoz_string _qoz_bv_287;
    {
        qoz_Strbuf _qoz_sb_4212_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4212_13); qoz_strings_sb_append(&_qoz_sb_4212_13, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_4212_13, ec); qoz_strings_sb_append(&_qoz_sb_4212_13, QOZ_STR_LIT("){ ")); _qoz_bv_287 = qoz_strings_sb_finish(&_qoz_sb_4212_13);
    }
    qoz_emit_push(e, _qoz_bv_287); int64_t i = 0; { qoz_Vec__qoz_RecordFieldLit __col = expanded; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string fn = f.name; qoz_string _qoz_bv_288;
    {
        qoz_Strbuf _qoz_sb_4227_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4227_17); qoz_strings_sb_append(&_qoz_sb_4227_17, QOZ_STR_LIT(".")); qoz_strings_sb_append(&_qoz_sb_4227_17, fn); qoz_strings_sb_append(&_qoz_sb_4227_17, QOZ_STR_LIT(" = ")); _qoz_bv_288 = qoz_strings_sb_finish(&_qoz_sb_4227_17);
    }
    qoz_emit_push(e, _qoz_bv_288); qoz_TypeExpr* field_hint = qoz_emit_field_type_hint(e, effective, f.name); qoz_gc_push_root(&field_hint); qoz_emit_emit_value_with_hint(e, f.value, field_hint); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(" })")); 
    return;
}
...
qoz_Vec__qoz_string qoz_emit_struct_field_names_from_te(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_Vec__qoz_string empty = qoz_vec_make__qoz_string(); qoz_Vec__qoz_string path_segments = qoz_vec_make__qoz_string(); qoz_TypeExpr* _qoz_ms_319 = te; switch (_qoz_ms_319->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_319->payload.TENamed.f1; path_segments = path;  break; } default: { return empty;  break; } } 0; if ((path_segments.len) < 1) { return empty;} qoz_string key = qoz_emit_type_lookup_key(e, path_segments); qoz_Option__qoz_Decl* _qoz_ms_310 = qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, key); qoz_Vec__qoz_string _qoz_mv_310 = ((qoz_Vec__qoz_string){0}); switch (_qoz_ms_310->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_310->payload.Some.f0; qoz_Decl* _qoz_ms_311 = decl; qoz_Vec__qoz_string _qoz_mv_311 = ((qoz_Vec__qoz_string){0}); switch (_qoz_ms_311->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_StructField fs = _qoz_ms_311->payload.DStruct.f3; _qoz_mv_311 = (qoz_emit_struct_decl_field_names(fs));  break; } default: { _qoz_mv_311 = (empty);  break; } } _qoz_mv_310 = (_qoz_mv_311);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_310 = (empty);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_310;
}
...
qoz_TypeExpr* qoz_emit_field_type_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string field_name) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_312 = te; qoz_TypeExpr* _qoz_mv_312 = NULL; switch (_qoz_ms_312->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_312->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_312->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_312->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_289;
    {
        if ((path.len) < 1) { return te;} qoz_string name = qoz_emit_type_lookup_key(e, path); if (!qoz_map_contains__qoz_string__qoz_Decl(&e->generic_decls, name)) { return te;} qoz_Option__qoz_Decl* _qoz_ms_313 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, name); qoz_TypeExpr* _qoz_mv_313 = NULL; switch (_qoz_ms_313->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_313->payload.Some.f0; qoz_Decl* _qoz_ms_324 = decl; qoz_TypeExpr* _qoz_mv_324 = NULL; switch (_qoz_ms_324->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_324->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_324->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_280;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField sf = __col.data[__i]; (void)sf; if (qoz_strings_eq_raw(sf.name, field_name)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, sf.ty, params, args);} return sf.ty;} } }_qoz_bv_280 = te;
    }
    _qoz_mv_324 = (_qoz_bv_280);  break; } default: { _qoz_mv_324 = (te);  break; } } _qoz_mv_313 = (_qoz_mv_324);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_313 = (te);  break; } } _qoz_bv_289 = _qoz_mv_313;
    }
    _qoz_mv_312 = (_qoz_bv_289);  break; } default: { _qoz_mv_312 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_312;
}
...
qoz_TypeExpr* qoz_emit_pick_type_with_args(qoz_TypeExpr* te, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_325 = te; qoz_TypeExpr* _qoz_mv_325 = NULL; switch (_qoz_ms_325->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string te_path = _qoz_ms_325->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr te_args = _qoz_ms_325->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_281;
    {
        if ((te_args.len) > 0) { return te;} qoz_TypeExpr* _qoz_ms_326 = hint; qoz_TypeExpr* _qoz_mv_326 = NULL; switch (_qoz_ms_326->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string h_path = _qoz_ms_326->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr h_args = _qoz_ms_326->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_282;
    {
        if ((h_args.len) == 0) { return te;} if ((((h_path.len) == 1) && ((te_path.len) == 1)) && qoz_strings_eq_raw(h_path.data[0], te_path.data[0])) { return hint;} _qoz_bv_282 = te;
    }
    _qoz_mv_326 = (_qoz_bv_282);  break; } default: { _qoz_mv_326 = (te);  break; } } _qoz_bv_281 = _qoz_mv_326;
    }
    _qoz_mv_325 = (_qoz_bv_281);  break; } default: { _qoz_mv_325 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_325;
}
...
void qoz_emit_emit_for_loop_one(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_327 = iter; switch (_qoz_ms_327->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_327->payload.EBinary.f1; qoz_Expr* lo = _qoz_ms_327->payload.EBinary.f2; qoz_Expr* hi = _qoz_ms_327->payload.EBinary.f3; if (qoz_emit_is_range_op(op)) { qoz_string _qoz_bv_283;
    {
        qoz_Strbuf _qoz_sb_4482_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4482_21); qoz_strings_sb_append(&_qoz_sb_4482_21, QOZ_STR_LIT("for (int64_t ")); qoz_strings_sb_append(&_qoz_sb_4482_21, binding); qoz_strings_sb_append(&_qoz_sb_4482_21, QOZ_STR_LIT(" = ")); _qoz_bv_283 = qoz_strings_sb_finish(&_qoz_sb_4482_21);
    }
    qoz_emit_push(e, _qoz_bv_283); qoz_emit_emit_expr(e, lo); qoz_string cmp = qoz_emit_range_cmp_op(op); qoz_string _qoz_bv_294;
    {
        qoz_Strbuf _qoz_sb_4485_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4485_21); qoz_strings_sb_append(&_qoz_sb_4485_21, QOZ_STR_LIT("; ")); qoz_strings_sb_append(&_qoz_sb_4485_21, binding); qoz_strings_sb_append(&_qoz_sb_4485_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4485_21, cmp); qoz_strings_sb_append(&_qoz_sb_4485_21, QOZ_STR_LIT(" ")); _qoz_bv_294 = qoz_strings_sb_finish(&_qoz_sb_4485_21);
    }
    qoz_emit_push(e, _qoz_bv_294); qoz_emit_emit_expr(e, hi); qoz_string _qoz_bv_295;
    {
        qoz_Strbuf _qoz_sb_4487_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4487_21); qoz_strings_sb_append(&_qoz_sb_4487_21, QOZ_STR_LIT("; ")); qoz_strings_sb_append(&_qoz_sb_4487_21, binding); qoz_strings_sb_append(&_qoz_sb_4487_21, QOZ_STR_LIT("++) ")); _qoz_bv_295 = qoz_strings_sb_finish(&_qoz_sb_4487_21);
    }
    qoz_emit_push(e, _qoz_bv_295); qoz_emit_emit_branch_as_statement(e, body); return;} 0;  break; } default: { NULL;  break; } } 0; if (qoz_strings_eq_raw(binding2, QOZ_STR_LIT(""))) { qoz_emit_emit_vec_for(e, binding, iter, body); }  else { qoz_emit_emit_map_for(e, binding, binding2, iter, body); } 
    return;
}
...
void qoz_emit_emit_vec_for(qoz_Emitter* e, qoz_string binding, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* elem_te = qoz_emit_vec_element_typeexpr(e, iter); qoz_gc_push_root(&elem_te); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, binding, elem_te); qoz_string col_ct = qoz_emit_c_type_for(e, qoz_emit_infer_base_typeexpr(e, iter)); qoz_string elem_ct = qoz_emit_c_type_for(e, elem_te); qoz_string _qoz_bv_296;
    {
        qoz_Strbuf _qoz_sb_4407_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4407_13); qoz_strings_sb_append(&_qoz_sb_4407_13, QOZ_STR_LIT("{ ")); qoz_strings_sb_append(&_qoz_sb_4407_13, col_ct); qoz_strings_sb_append(&_qoz_sb_4407_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_296 = qoz_strings_sb_finish(&_qoz_sb_4407_13);
    }
    qoz_emit_push(e, _qoz_bv_296); qoz_emit_emit_expr(e, iter); qoz_string _qoz_bv_297;
    {
        qoz_Strbuf _qoz_sb_4419_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4419_13); qoz_strings_sb_append(&_qoz_sb_4419_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.len; __i++) { ")); qoz_strings_sb_append(&_qoz_sb_4419_13, elem_ct); qoz_strings_sb_append(&_qoz_sb_4419_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4419_13, binding); qoz_strings_sb_append(&_qoz_sb_4419_13, QOZ_STR_LIT(" = __col.data[__i]; (void)")); qoz_strings_sb_append(&_qoz_sb_4419_13, binding); qoz_strings_sb_append(&_qoz_sb_4419_13, QOZ_STR_LIT("; ")); _qoz_bv_297 = qoz_strings_sb_finish(&_qoz_sb_4419_13);
    }
    qoz_emit_push(e, _qoz_bv_297); qoz_emit_emit_branch_body_inline(e, body); qoz_emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* qoz_emit_vec_element_typeexpr(qoz_Emitter* e, qoz_Expr* iter) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&iter);
    qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_328 = te; qoz_TypeExpr* _qoz_mv_328 = NULL; switch (_qoz_ms_328->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_328->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_328->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_328->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_298;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_298 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_328 = (_qoz_bv_298);  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_328->payload.TEPtr.f1; _qoz_mv_328 = (inner);  break; } default: { _qoz_mv_328 = (qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(iter)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_328;
}
...
void qoz_emit_emit_map_for(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* iter_te = qoz_emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&iter_te); qoz_string col_ct = qoz_emit_c_type_for(e, iter_te); qoz_TypeExpr* key_te = qoz_emit_map_key_typeexpr(e, iter_te); qoz_gc_push_root(&key_te); qoz_TypeExpr* val_te = qoz_emit_map_val_typeexpr(e, iter_te); qoz_gc_push_root(&val_te); qoz_string key_ct = qoz_emit_c_type_for(e, key_te); qoz_string val_ct = qoz_emit_c_type_for(e, val_te); qoz_string _qoz_bv_299;
    {
        qoz_Strbuf _qoz_sb_4433_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4433_13); qoz_strings_sb_append(&_qoz_sb_4433_13, QOZ_STR_LIT("{ ")); qoz_strings_sb_append(&_qoz_sb_4433_13, col_ct); qoz_strings_sb_append(&_qoz_sb_4433_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_299 = qoz_strings_sb_finish(&_qoz_sb_4433_13);
    }
    qoz_emit_push(e, _qoz_bv_299); qoz_emit_emit_expr(e, iter); qoz_string _qoz_bv_290;
    {
        qoz_Strbuf _qoz_sb_4435_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4435_13); qoz_strings_sb_append(&_qoz_sb_4435_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.cap; __i++) { if (!__col.slots[__i].occupied || __col.slots[__i].deleted) continue; ")); qoz_strings_sb_append(&_qoz_sb_4435_13, key_ct); qoz_strings_sb_append(&_qoz_sb_4435_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4435_13, binding); qoz_strings_sb_append(&_qoz_sb_4435_13, QOZ_STR_LIT(" = __col.slots[__i].key; ")); qoz_strings_sb_append(&_qoz_sb_4435_13, val_ct); qoz_strings_sb_append(&_qoz_sb_4435_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4435_13, binding2); qoz_strings_sb_append(&_qoz_sb_4435_13, QOZ_STR_LIT(" = __col.slots[__i].value; (void)")); qoz_strings_sb_append(&_qoz_sb_4435_13, binding); qoz_strings_sb_append(&_qoz_sb_4435_13, QOZ_STR_LIT("; (void)")); qoz_strings_sb_append(&_qoz_sb_4435_13, binding2); qoz_strings_sb_append(&_qoz_sb_4435_13, QOZ_STR_LIT("; ")); _qoz_bv_290 = qoz_strings_sb_finish(&_qoz_sb_4435_13);
    }
    qoz_emit_push(e, _qoz_bv_290); qoz_emit_emit_branch_body_inline(e, body); qoz_emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* qoz_emit_map_key_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_329 = te; qoz_TypeExpr* _qoz_mv_329 = NULL; switch (_qoz_ms_329->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_329->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_329->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_329->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_291;
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[0];} _qoz_bv_291 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_329 = (_qoz_bv_291);  break; } default: { _qoz_mv_329 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_329;
}
...
qoz_TypeExpr* qoz_emit_map_val_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_320 = te; qoz_TypeExpr* _qoz_mv_320 = NULL; switch (_qoz_ms_320->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_320->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_320->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_320->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_292;
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[1];} _qoz_bv_292 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_320 = (_qoz_bv_292);  break; } default: { _qoz_mv_320 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_320;
}
...
void qoz_emit_emit_branch_body_inline(qoz_Emitter* e, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_321 = body; switch (_qoz_ms_321->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_321->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_321->payload.EBlock.f2; {
...
bool qoz_emit_any_arm_is_literal(qoz_Vec__qoz_MatchArm arms) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm a = __col.data[__i]; (void)a; qoz_Pattern* _qoz_ms_322 = a.pat; switch (_qoz_ms_322->tag) { case qoz_Pattern_PatLitInt: { return true; break; } case qoz_Pattern_PatLitString: { return true; break; } case qoz_Pattern_PatLitBool: { return true; break; } default: { NULL;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return false;
}
...
void qoz_emit_emit_match_as_expr(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    if (qoz_emit_any_arm_has_guard(arms)) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} if (qoz_emit_any_arm_is_literal(arms)) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); if (qoz_strings_eq_raw(bare_enum, QOZ_STR_LIT(""))) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string enum_name = qoz_emit_enum_lookup_name(e, scrut, bare_enum); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_293;
    {
        qoz_Strbuf _qoz_sb_4521_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4521_21); qoz_strings_sb_append(&_qoz_sb_4521_21, QOZ_STR_LIT("_qoz_ms_")); qoz_strings_sb_append_i64(&_qoz_sb_4521_21, e->match_counter); _qoz_bv_293 = qoz_strings_sb_finish(&_qoz_sb_4521_21);
    }
    qoz_string scrut_tmp = _qoz_bv_293; qoz_string _qoz_bv_304;
    {
        qoz_Strbuf _qoz_sb_4522_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4522_21); qoz_strings_sb_append(&_qoz_sb_4522_21, QOZ_STR_LIT("_qoz_mv_")); qoz_strings_sb_append_i64(&_qoz_sb_4522_21, e->match_counter); _qoz_bv_304 = qoz_strings_sb_finish(&_qoz_sb_4522_21);
    }
    qoz_string res_tmp = _qoz_bv_304; qoz_string res_ctype = qoz_emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_strings_eq_raw(res_ctype, QOZ_STR_LIT("void")); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_305;
    {
        qoz_Strbuf _qoz_sb_4531_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4531_13); qoz_strings_sb_append(&_qoz_sb_4531_13, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_4531_13, enum_name); qoz_strings_sb_append(&_qoz_sb_4531_13, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4531_13, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4531_13, QOZ_STR_LIT(" = ")); _qoz_bv_305 = qoz_strings_sb_finish(&_qoz_sb_4531_13);
    }
    qoz_emit_push(e, _qoz_bv_305); qoz_emit_emit_expr(e, scrut); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (!is_void) { qoz_string dv = qoz_emit_default_value_for(res_ctype); qoz_string _qoz_bv_306;
    {
        qoz_Strbuf _qoz_sb_4536_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4536_17); qoz_strings_sb_append(&_qoz_sb_4536_17, res_ctype); qoz_strings_sb_append(&_qoz_sb_4536_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4536_17, res_tmp); qoz_strings_sb_append(&_qoz_sb_4536_17, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4536_17, dv); qoz_strings_sb_append(&_qoz_sb_4536_17, QOZ_STR_LIT("; ")); _qoz_bv_306 = qoz_strings_sb_finish(&_qoz_sb_4536_17);
    }
    qoz_emit_push(e, _qoz_bv_306); } qoz_string _qoz_bv_307;
    {
        qoz_Strbuf _qoz_sb_4648_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4648_13); qoz_strings_sb_append(&_qoz_sb_4648_13, QOZ_STR_LIT("switch (")); qoz_strings_sb_append(&_qoz_sb_4648_13, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4648_13, QOZ_STR_LIT("->tag) { ")); _qoz_bv_307 = qoz_strings_sb_finish(&_qoz_sb_4648_13);
    }
    qoz_emit_push(e, _qoz_bv_307); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; qoz_emit_emit_match_arm_with_kind(e, enum_name, scrut_tmp, res_tmp, arm, is_void); } }qoz_emit_push(e, QOZ_STR_LIT("} ")); qoz_emit_hoist_to_prologue(e, start); if (is_void) { qoz_emit_push(e, QOZ_STR_LIT("0")); }  else { qoz_emit_push(e, res_tmp); } 
    return;
}
...
void qoz_emit_emit_match_as_if_chain(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); bool is_enum_match = !qoz_strings_eq_raw(bare_enum, QOZ_STR_LIT("")); qoz_string enum_name = QOZ_STR_LIT(""); if (is_enum_match) { enum_name = qoz_emit_enum_lookup_name(e, scrut, bare_enum); } qoz_string scrut_ctype = qoz_emit_infer_expr_ctype(e, scrut); qoz_TypeExpr* scrut_te = qoz_emit_infer_value_te(e, scrut); qoz_gc_push_root(&scrut_te); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_308;
    {
        qoz_Strbuf _qoz_sb_4663_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4663_21); qoz_strings_sb_append(&_qoz_sb_4663_21, QOZ_STR_LIT("_qoz_ms_")); qoz_strings_sb_append_i64(&_qoz_sb_4663_21, e->match_counter); _qoz_bv_308 = qoz_strings_sb_finish(&_qoz_sb_4663_21);
    }
    qoz_string scrut_tmp = _qoz_bv_308; qoz_string _qoz_bv_309;
    {
        qoz_Strbuf _qoz_sb_4664_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4664_21); qoz_strings_sb_append(&_qoz_sb_4664_21, QOZ_STR_LIT("_qoz_mv_")); qoz_strings_sb_append_i64(&_qoz_sb_4664_21, e->match_counter); _qoz_bv_309 = qoz_strings_sb_finish(&_qoz_sb_4664_21);
    }
    qoz_string res_tmp = _qoz_bv_309; qoz_string _qoz_bv_300;
    {
        qoz_Strbuf _qoz_sb_4665_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4665_21); qoz_strings_sb_append(&_qoz_sb_4665_21, QOZ_STR_LIT("_qoz_mm_")); qoz_strings_sb_append_i64(&_qoz_sb_4665_21, e->match_counter); _qoz_bv_300 = qoz_strings_sb_finish(&_qoz_sb_4665_21);
    }
    qoz_string mflag = _qoz_bv_300; qoz_string res_ctype = qoz_emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_strings_eq_raw(res_ctype, QOZ_STR_LIT("void")); int64_t start = qoz_strings_sb_len(&e->out); if (is_enum_match) { qoz_string _qoz_bv_301;
    {
        qoz_Strbuf _qoz_sb_4660_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4660_17); qoz_strings_sb_append(&_qoz_sb_4660_17, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_4660_17, enum_name); qoz_strings_sb_append(&_qoz_sb_4660_17, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4660_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4660_17, QOZ_STR_LIT(" = ")); _qoz_bv_301 = qoz_strings_sb_finish(&_qoz_sb_4660_17);
    }
    qoz_emit_push(e, _qoz_bv_301); }  else { qoz_string _qoz_bv_302;
    {
        qoz_Strbuf _qoz_sb_4672_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4672_17); qoz_strings_sb_append(&_qoz_sb_4672_17, scrut_ctype); qoz_strings_sb_append(&_qoz_sb_4672_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4672_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4672_17, QOZ_STR_LIT(" = ")); _qoz_bv_302 = qoz_strings_sb_finish(&_qoz_sb_4672_17);
    }
    qoz_emit_push(e, _qoz_bv_302); } qoz_emit_emit_expr(e, scrut); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (!is_void) { qoz_string dv = qoz_emit_default_value_for(res_ctype); qoz_string _qoz_bv_303;
    {
        qoz_Strbuf _qoz_sb_4678_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4678_17); qoz_strings_sb_append(&_qoz_sb_4678_17, res_ctype); qoz_strings_sb_append(&_qoz_sb_4678_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4678_17, res_tmp); qoz_strings_sb_append(&_qoz_sb_4678_17, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4678_17, dv); qoz_strings_sb_append(&_qoz_sb_4678_17, QOZ_STR_LIT("; ")); _qoz_bv_303 = qoz_strings_sb_finish(&_qoz_sb_4678_17);
    }
    qoz_emit_push(e, _qoz_bv_303); } qoz_string _qoz_bv_314;
    {
        qoz_Strbuf _qoz_sb_4670_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4670_13); qoz_strings_sb_append(&_qoz_sb_4670_13, QOZ_STR_LIT("bool ")); qoz_strings_sb_append(&_qoz_sb_4670_13, mflag); qoz_strings_sb_append(&_qoz_sb_4670_13, QOZ_STR_LIT(" = false; ")); _qoz_bv_314 = qoz_strings_sb_finish(&_qoz_sb_4670_13);
    }
    qoz_emit_push(e, _qoz_bv_314); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; qoz_emit_emit_arm_in_chain_with_te(e, enum_name, scrut_tmp, scrut_te, res_tmp, mflag, arm, is_void); } }qoz_emit_hoist_to_prologue(e, start); if (is_void) { qoz_emit_push(e, QOZ_STR_LIT("0")); }  else { qoz_emit_push(e, res_tmp); } 
    return;
}
...
void qoz_emit_emit_arm_in_chain_with_te(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_TypeExpr* scrut_te, qoz_string res_tmp, qoz_string mflag, qoz_MatchArm arm, bool is_void) {
    ...
    qoz_TypeExpr* body_hint = qoz_emit_match_body_hint(e, enum_name, arm.body); qoz_gc_push_root(&body_hint); bool is_enum_match = !qoz_strings_eq_raw(enum_name, QOZ_STR_LIT("")); qoz_emit_push(e, QOZ_STR_LIT("if (!")); qoz_emit_push(e, mflag); qoz_Pattern* _qoz_ms_323 = arm.pat; switch (_qoz_ms_323->tag) { case qoz_Pattern_PatWild: { qoz_emit_push(e, QOZ_STR_LIT(") { "));  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_323->payload.PatBind.f1; if (is_enum_match) { qoz_Option__qoz_string* _qoz_ms_334 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_334->tag) { case qoz_Option__qoz_string_Some: { qoz_string _qoz_bv_315;
    {
        qoz_Strbuf _qoz_sb_4602_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4602_25); qoz_strings_sb_append(&_qoz_sb_4602_25, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4602_25, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4602_25, QOZ_STR_LIT("->tag == qoz_")); qoz_strings_sb_append(&_qoz_sb_4602_25, enum_name); qoz_strings_sb_append(&_qoz_sb_4602_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4602_25, name); qoz_strings_sb_append(&_qoz_sb_4602_25, QOZ_STR_LIT(") { ")); _qoz_bv_315 = qoz_strings_sb_finish(&_qoz_sb_4602_25);
    }
    qoz_emit_push(e, _qoz_bv_315);  break; } default: { qoz_string _qoz_bv_316;
    {
        qoz_Strbuf _qoz_sb_4604_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4604_25); qoz_strings_sb_append(&_qoz_sb_4604_25, QOZ_STR_LIT(") { int64_t ")); qoz_strings_sb_append(&_qoz_sb_4604_25, name); qoz_strings_sb_append(&_qoz_sb_4604_25, QOZ_STR_LIT(" = 0; (void)")); qoz_strings_sb_append(&_qoz_sb_4604_25, name); qoz_strings_sb_append(&_qoz_sb_4604_25, QOZ_STR_LIT("; ")); _qoz_bv_316 = qoz_strings_sb_finish(&_qoz_sb_4604_25);
    }
    qoz_emit_push(e, _qoz_bv_316);  break; } } 0; }  else { qoz_string sc = qoz_emit_c_type_for(e, scrut_te); qoz_string _qoz_bv_317;
    {
        qoz_Strbuf _qoz_sb_4608_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4608_21); qoz_strings_sb_append(&_qoz_sb_4608_21, QOZ_STR_LIT(") { ")); qoz_strings_sb_append(&_qoz_sb_4608_21, sc); qoz_strings_sb_append(&_qoz_sb_4608_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4608_21, name); qoz_strings_sb_append(&_qoz_sb_4608_21, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4608_21, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4608_21, QOZ_STR_LIT("; (void)")); qoz_strings_sb_append(&_qoz_sb_4608_21, name); qoz_strings_sb_append(&_qoz_sb_4608_21, QOZ_STR_LIT("; ")); _qoz_bv_317 = qoz_strings_sb_finish(&_qoz_sb_4608_21);
    }
    qoz_emit_push(e, _qoz_bv_317); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, scrut_te); } 0;  break; } case qoz_Pattern_PatLitInt: { qoz_string text = _qoz_ms_323->payload.PatLitInt.f1; {
        qoz_string tn = qoz_emit_strip_numeric_underscores(text); qoz_string _qoz_bv_318;
    {
        qoz_Strbuf _qoz_sb_4614_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4614_17); qoz_strings_sb_append(&_qoz_sb_4614_17, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4614_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4614_17, QOZ_STR_LIT(" == ")); qoz_strings_sb_append(&_qoz_sb_4614_17, tn); qoz_strings_sb_append(&_qoz_sb_4614_17, QOZ_STR_LIT(") { ")); _qoz_bv_318 = qoz_strings_sb_finish(&_qoz_sb_4614_17);
    }
    qoz_emit_push(e, _qoz_bv_318); 
    }
    0;  break; } case qoz_Pattern_PatLitBool: { bool b = _qoz_ms_323->payload.PatLitBool.f1; if (b) { qoz_string _qoz_bv_319;
    {
        qoz_Strbuf _qoz_sb_4617_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4617_24); qoz_strings_sb_append(&_qoz_sb_4617_24, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4617_24, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4617_24, QOZ_STR_LIT(" == true) { ")); _qoz_bv_319 = qoz_strings_sb_finish(&_qoz_sb_4617_24);
    }
    qoz_emit_push(e, _qoz_bv_319); }  else { qoz_string _qoz_bv_310;
    {
        qoz_Strbuf _qoz_sb_4618_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4618_24); qoz_strings_sb_append(&_qoz_sb_4618_24, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4618_24, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4618_24, QOZ_STR_LIT(" == false) { ")); _qoz_bv_310 = qoz_strings_sb_finish(&_qoz_sb_4618_24);
    }
    qoz_emit_push(e, _qoz_bv_310); } 0;  break; } case qoz_Pattern_PatLitString: { qoz_string text = _qoz_ms_323->payload.PatLitString.f1; qoz_string _qoz_bv_311;
    {
        qoz_Strbuf _qoz_sb_4611_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4611_17); qoz_strings_sb_append(&_qoz_sb_4611_17, QOZ_STR_LIT(" && qoz_string_eq(")); qoz_strings_sb_append(&_qoz_sb_4611_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4611_17, QOZ_STR_LIT(", QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_4611_17, text); qoz_strings_sb_append(&_qoz_sb_4611_17, QOZ_STR_LIT("))) { ")); _qoz_bv_311 = qoz_strings_sb_finish(&_qoz_sb_4611_17);
    }
    qoz_emit_push(e, _qoz_bv_311);  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_323->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_323->payload.PatVariant.f2; if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_312;
    {
        qoz_Strbuf _qoz_sb_4626_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4626_21); qoz_strings_sb_append(&_qoz_sb_4626_21, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4626_21, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4626_21, QOZ_STR_LIT("->tag == qoz_")); qoz_strings_sb_append(&_qoz_sb_4626_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4626_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4626_21, vname); qoz_strings_sb_append(&_qoz_sb_4626_21, QOZ_STR_LIT(") { ")); _qoz_bv_312 = qoz_strings_sb_finish(&_qoz_sb_4626_21);
    }
    qoz_emit_push(e, _qoz_bv_312); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_335 = sp; switch (_qoz_ms_335->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_335->payload.PatBind.f1; {
        qoz_string pc = qoz_emit_variant_payload_ctype(e, enum_name, vname, i); qoz_string is = qoz_emit_int_to_string(i); qoz_string _qoz_bv_313;
    {
        qoz_Strbuf _qoz_sb_4633_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4633_29); qoz_strings_sb_append(&_qoz_sb_4633_29, pc); qoz_strings_sb_append(&_qoz_sb_4633_29, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4633_29, bname); qoz_strings_sb_append(&_qoz_sb_4633_29, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4633_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4633_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4633_29, vname); qoz_strings_sb_append(&_qoz_sb_4633_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4633_29, is); qoz_strings_sb_append(&_qoz_sb_4633_29, QOZ_STR_LIT("; ")); _qoz_bv_313 = qoz_strings_sb_finish(&_qoz_sb_4633_29);
    }
    qoz_emit_push(e, _qoz_bv_313); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, qoz_emit_variant_payload_typeexpr(e, enum_name, vname, i)); 
    }
...
void qoz_emit_emit_match_arm_with_kind(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_string res_tmp, qoz_MatchArm arm, bool is_void) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_TypeExpr* body_hint = qoz_emit_match_body_hint(e, enum_name, arm.body); qoz_gc_push_root(&body_hint); qoz_Pattern* _qoz_ms_336 = arm.pat; switch (_qoz_ms_336->tag) { case qoz_Pattern_PatWild: { {
    ...
    0;  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_336->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_337 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_337->tag) { case qoz_Option__qoz_string_Some: { {
        qoz_string _qoz_bv_324;
    {
        qoz_Strbuf _qoz_sb_4796_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4796_21); qoz_strings_sb_append(&_qoz_sb_4796_21, QOZ_STR_LIT("case qoz_")); qoz_strings_sb_append(&_qoz_sb_4796_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4796_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4796_21, name); qoz_strings_sb_append(&_qoz_sb_4796_21, QOZ_STR_LIT(": { ")); _qoz_bv_324 = qoz_strings_sb_finish(&_qoz_sb_4796_21);
    }
    qoz_emit_push(e, _qoz_bv_324); if (arm.has_guard) { qoz_emit_push(e, QOZ_STR_LIT("if (")); qoz_emit_emit_expr(e, arm.guard); qoz_emit_push(e, QOZ_STR_LIT(") { ")); qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); qoz_emit_push(e, QOZ_STR_LIT("} ")); }  else { qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); } qoz_emit_push(e, QOZ_STR_LIT(" break; } ")); 
    }
    0;  break; } case qoz_Option__qoz_string_None: { {
        if (is_void) { qoz_emit_push(e, QOZ_STR_LIT("default: { ")); }  else { qoz_string _qoz_bv_325;
    {
        qoz_Strbuf _qoz_sb_4712_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4712_25); qoz_strings_sb_append(&_qoz_sb_4712_25, QOZ_STR_LIT("default: { int64_t ")); qoz_strings_sb_append(&_qoz_sb_4712_25, name); qoz_strings_sb_append(&_qoz_sb_4712_25, QOZ_STR_LIT(" = 0; (void)")); qoz_strings_sb_append(&_qoz_sb_4712_25, name); qoz_strings_sb_append(&_qoz_sb_4712_25, QOZ_STR_LIT("; ")); _qoz_bv_325 = qoz_strings_sb_finish(&_qoz_sb_4712_25);
    }
    qoz_emit_push(e, _qoz_bv_325); } if (arm.has_guard) { qoz_emit_push(e, QOZ_STR_LIT("if (")); qoz_emit_emit_expr(e, arm.guard); qoz_emit_push(e, QOZ_STR_LIT(") { ")); qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); qoz_emit_push(e, QOZ_STR_LIT("} ")); }  else { qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); } qoz_emit_push(e, QOZ_STR_LIT(" break; } ")); 
    }
    0;  break; } } 0;  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_336->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_336->payload.PatVariant.f2; if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_326;
    {
        qoz_Strbuf _qoz_sb_4720_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4720_21); qoz_strings_sb_append(&_qoz_sb_4720_21, QOZ_STR_LIT("case qoz_")); qoz_strings_sb_append(&_qoz_sb_4720_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4720_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4720_21, vname); qoz_strings_sb_append(&_qoz_sb_4720_21, QOZ_STR_LIT(": { ")); _qoz_bv_326 = qoz_strings_sb_finish(&_qoz_sb_4720_21);
    }
    qoz_emit_push(e, _qoz_bv_326); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_338 = sp; switch (_qoz_ms_338->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_338->payload.PatBind.f1; {
        qoz_string pc = qoz_emit_variant_payload_ctype(e, enum_name, vname, i); qoz_string is = qoz_emit_int_to_string(i); qoz_string _qoz_bv_327;
    {
        qoz_Strbuf _qoz_sb_4737_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4737_29); qoz_strings_sb_append(&_qoz_sb_4737_29, pc); qoz_strings_sb_append(&_qoz_sb_4737_29, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4737_29, bname); qoz_strings_sb_append(&_qoz_sb_4737_29, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4737_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4737_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4737_29, vname); qoz_strings_sb_append(&_qoz_sb_4737_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4737_29, is); qoz_strings_sb_append(&_qoz_sb_4737_29, QOZ_STR_LIT("; ")); _qoz_bv_327 = qoz_strings_sb_finish(&_qoz_sb_4737_29);
    }
    qoz_emit_push(e, _qoz_bv_327); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, qoz_emit_variant_payload_typeexpr(e, enum_name, vname, i)); 
    }
...
qoz_string qoz_emit_enum_name_from_type(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string bare_enum) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_339 = te; qoz_string _qoz_mv_339 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_339->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_339->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_339->payload.TENamed.f2; qoz_string _qoz_bv_328;
    {
        if (((args.len) > 0) && ((path.len) >= 1)) { qoz_string last = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(last, bare_enum)) { return qoz_emit_mangle_inst(e, bare_enum, args);} } _qoz_bv_328 = bare_enum;
    }
    _qoz_mv_339 = (_qoz_bv_328);  break; } default: { _qoz_mv_339 = (bare_enum);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_339;
}
...
qoz_TypeExpr* qoz_emit_variant_payload_typeexpr(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, int64_t pos) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string bare = qoz_emit_strip_mangled(enum_name); qoz_Span unit_sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_Option__qoz_Decl* _qoz_ms_330 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, bare); qoz_TypeExpr* _qoz_mv_330 = NULL; switch (_qoz_ms_330->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_330 = (qoz_make_TypeExpr_TEUnit(unit_sp));  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_330->payload.Some.f0; qoz_Decl* _qoz_ms_331 = d; qoz_TypeExpr* _qoz_mv_331 = NULL; switch (_qoz_ms_331->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_331->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_331->payload.DEnum.f3; qoz_TypeExpr* _qoz_bv_329;
    {
        qoz_Vec__qoz_TypeExpr inst_args = qoz_emit_variant_inst_args(e, enum_name, bare); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_strings_eq_raw(v.name, variant)) { if ((pos >= 0) && (pos < (v.pos.len))) { if (((tparams.len) > 0) && ((inst_args.len) == (tparams.len))) { return qoz_emit_substitute_type(e, v.pos.data[pos], tparams, inst_args);} return v.pos.data[pos];} } } }_qoz_bv_329 = qoz_make_TypeExpr_TEUnit(unit_sp);
    }
    _qoz_mv_331 = (_qoz_bv_329);  break; } default: { _qoz_mv_331 = (qoz_make_TypeExpr_TEUnit(unit_sp));  break; } } _qoz_mv_330 = (_qoz_mv_331);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_330;
}

qoz_string qoz_emit_variant_payload_ctype(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, int64_t pos) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string bare = qoz_emit_strip_mangled(enum_name); qoz_Option__qoz_Decl* _qoz_ms_332 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, bare); qoz_string _qoz_mv_332 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_332->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_332 = (QOZ_STR_LIT("int64_t"));  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_332->payload.Some.f0; qoz_Decl* _qoz_ms_333 = d; qoz_string _qoz_mv_333 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_333->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_333->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_333->payload.DEnum.f3; qoz_string _qoz_bv_320;
    {
        qoz_Vec__qoz_TypeExpr inst_args = qoz_emit_variant_inst_args(e, enum_name, bare); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_strings_eq_raw(v.name, variant)) { if ((pos >= 0) && (pos < (v.pos.len))) { qoz_TypeExpr* subst = ((((tparams.len) > 0) && ((inst_args.len) == (tparams.len))) ? qoz_emit_substitute_type(e, v.pos.data[pos], tparams, inst_args) : v.pos.data[pos]); qoz_gc_push_root(&subst); return qoz_emit_c_type_for(e, subst);} } } }_qoz_bv_320 = QOZ_STR_LIT("int64_t");
    }
    _qoz_mv_333 = (_qoz_bv_320);  break; } default: { _qoz_mv_333 = (QOZ_STR_LIT("int64_t"));  break; } } _qoz_mv_332 = (_qoz_mv_333);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_332;
}
...
void qoz_emit_emit_main(qoz_Emitter* e, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&ret);
    qoz_gc_push_root(&body);
    qoz_MainRetKind* kind = qoz_emit_main_return_kind(ret); qoz_gc_push_root(&kind); qoz_emit_push(e, QOZ_STR_LIT("int main(int argc, char **argv) {\n    qoz_set_argv(argc, argv);\n    int qoz_stack_anchor;\n    qoz_init(&qoz_stack_anchor);\n    ")); qoz_Expr* _qoz_ms_345 = body; switch (_qoz_ms_345->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_345->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_345->payload.EBlock.f2; {
...
qoz_MainRetKind* qoz_emit_main_return_kind(qoz_TypeExpr* ret) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ret);
    qoz_TypeExpr* _qoz_ms_346 = ret; qoz_MainRetKind* _qoz_mv_346 = NULL; switch (_qoz_ms_346->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_346 = (qoz_make_MainRetKind_MainRetUnit());  break; } case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_346->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_346->payload.TENamed.f1; qoz_MainRetKind* _qoz_bv_321;
    {
        if ((path.len) != 1) { qoz_string _qoz_bv_322;
    {
        qoz_Strbuf _qoz_sb_5074_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_5074_25); qoz_strings_sb_append(&_qoz_sb_5074_25, sp.file); qoz_strings_sb_append(&_qoz_sb_5074_25, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5074_25, sp.line); qoz_strings_sb_append(&_qoz_sb_5074_25, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5074_25, sp.col); qoz_strings_sb_append(&_qoz_sb_5074_25, QOZ_STR_LIT(": main return type must be a primitive integer or unit")); _qoz_bv_322 = qoz_strings_sb_finish(&_qoz_sb_5074_25);
    }
    qoz_fmt_println(_qoz_bv_322); return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));} qoz_string n = path.data[0]; if (qoz_strings_eq_raw(n, QOZ_STR_LIT("i8"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int8_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("i16"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int16_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("i32"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int32_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("i64"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("u8"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint8_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("u16"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint16_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("u32"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint32_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("u64"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint64_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("unit"))) { return qoz_make_MainRetKind_MainRetUnit();} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("void"))) { return qoz_make_MainRetKind_MainRetUnit();} qoz_string _qoz_bv_323;
    {
        qoz_Strbuf _qoz_sb_5098_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_5098_21); qoz_strings_sb_append(&_qoz_sb_5098_21, sp.file); qoz_strings_sb_append(&_qoz_sb_5098_21, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5098_21, sp.line); qoz_strings_sb_append(&_qoz_sb_5098_21, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5098_21, sp.col); qoz_strings_sb_append(&_qoz_sb_5098_21, QOZ_STR_LIT(": main may return only integer types or unit, got `")); qoz_strings_sb_append(&_qoz_sb_5098_21, n); qoz_strings_sb_append(&_qoz_sb_5098_21, QOZ_STR_LIT("`")); _qoz_bv_323 = qoz_strings_sb_finish(&_qoz_sb_5098_21);
    }
    qoz_fmt_println(_qoz_bv_323); _qoz_bv_321 = qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));
    }
    _qoz_mv_346 = (_qoz_bv_321);  break; } default: { qoz_MainRetKind* _qoz_bv_334;
    {
        qoz_fmt_println(QOZ_STR_LIT("main return type must be a primitive integer or unit")); _qoz_bv_334 = qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));
    }
    _qoz_mv_346 = (_qoz_bv_334);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_346;
}
...
void qoz_emit_emit_main_tail(qoz_Emitter* e, qoz_MainRetKind* kind, qoz_Expr* tail) {
    ...
    qoz_gc_push_root(&tail);
    qoz_MainRetKind* _qoz_ms_347 = kind; switch (_qoz_ms_347->tag) { case qoz_MainRetKind_MainRetUnit: { {
        qoz_Expr* _qoz_ms_348 = tail; bool _qoz_mv_348 = false; switch (_qoz_ms_348->tag) { case qoz_Expr_EIf: { qoz_Expr* f = _qoz_ms_348->payload.EIf.f3; _qoz_mv_348 = (qoz_emit_is_nil_expr(f) || qoz_emit_is_unit_typeexpr(qoz_emit_infer_value_te(e, tail)));  break; } default: { _qoz_mv_348 = (false);  break; } } bool is_unit_if = _qoz_mv_348; qoz_Expr* _qoz_ms_349 = tail; switch (_qoz_ms_349->tag) { case qoz_Expr_EFor: { {
    ...
    0;  break; } case qoz_MainRetKind_MainRetInt: { qoz_string ctype = _qoz_ms_347->payload.MainRetInt.f0; {
...
bool qoz_ty_ty_eq(qoz_Ty* a, qoz_Ty* b) {
    ...
    qoz_gc_push_root(&a);
    qoz_gc_push_root(&b);
    qoz_Ty* _qoz_ms_340 = a; bool _qoz_mv_340 = false; switch (_qoz_ms_340->tag) { case qoz_Ty_TyInt: { qoz_IntInfo ai = _qoz_ms_340->payload.TyInt.f0; qoz_Ty* _qoz_ms_341 = b; bool _qoz_mv_341 = false; switch (_qoz_ms_341->tag) { case qoz_Ty_TyInt: { qoz_IntInfo bi = _qoz_ms_341->payload.TyInt.f0; _qoz_mv_341 = (((ai.width == bi.width) && (ai.is_signed == bi.is_signed)) && (ai.untyped == bi.untyped));  break; } default: { _qoz_mv_341 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_341);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo af = _qoz_ms_340->payload.TyFloat.f0; qoz_Ty* _qoz_ms_342 = b; bool _qoz_mv_342 = false; switch (_qoz_ms_342->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo bf = _qoz_ms_342->payload.TyFloat.f0; _qoz_mv_342 = ((af.width == bf.width) && (af.untyped == bf.untyped));  break; } default: { _qoz_mv_342 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_342);  break; } case qoz_Ty_TyBool: { qoz_Ty* _qoz_ms_343 = b; bool _qoz_mv_343 = false; switch (_qoz_ms_343->tag) { case qoz_Ty_TyBool: { _qoz_mv_343 = (true);  break; } default: { _qoz_mv_343 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_343);  break; } case qoz_Ty_TyChar: { qoz_Ty* _qoz_ms_354 = b; bool _qoz_mv_354 = false; switch (_qoz_ms_354->tag) { case qoz_Ty_TyChar: { _qoz_mv_354 = (true);  break; } default: { _qoz_mv_354 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_354);  break; } case qoz_Ty_TyString: { qoz_Ty* _qoz_ms_355 = b; bool _qoz_mv_355 = false; switch (_qoz_ms_355->tag) { case qoz_Ty_TyString: { _qoz_mv_355 = (true);  break; } default: { _qoz_mv_355 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_355);  break; } case qoz_Ty_TyCstring: { qoz_Ty* _qoz_ms_356 = b; bool _qoz_mv_356 = false; switch (_qoz_ms_356->tag) { case qoz_Ty_TyCstring: { _qoz_mv_356 = (true);  break; } default: { _qoz_mv_356 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_356);  break; } case qoz_Ty_TyUnit: { qoz_Ty* _qoz_ms_357 = b; bool _qoz_mv_357 = false; switch (_qoz_ms_357->tag) { case qoz_Ty_TyUnit: { _qoz_mv_357 = (true);  break; } default: { _qoz_mv_357 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_357);  break; } case qoz_Ty_TyNil: { qoz_Ty* _qoz_ms_358 = b; bool _qoz_mv_358 = false; switch (_qoz_ms_358->tag) { case qoz_Ty_TyNil: { _qoz_mv_358 = (true);  break; } default: { _qoz_mv_358 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_358);  break; } case qoz_Ty_TyError: { qoz_Ty* _qoz_ms_359 = b; bool _qoz_mv_359 = false; switch (_qoz_ms_359->tag) { case qoz_Ty_TyError: { _qoz_mv_359 = (true);  break; } default: { _qoz_mv_359 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_359);  break; } case qoz_Ty_TyPtr: { qoz_Ty* ai = _qoz_ms_340->payload.TyPtr.f0; qoz_Ty* _qoz_ms_350 = b; bool _qoz_mv_350 = false; switch (_qoz_ms_350->tag) { case qoz_Ty_TyPtr: { qoz_Ty* bi = _qoz_ms_350->payload.TyPtr.f0; _qoz_mv_350 = (qoz_ty_ty_eq(ai, bi));  break; } default: { _qoz_mv_350 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_350);  break; } case qoz_Ty_TyAdt: { qoz_string an = _qoz_ms_340->payload.TyAdt.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_340->payload.TyAdt.f1; qoz_Ty* _qoz_ms_351 = b; bool _qoz_mv_351 = false; switch (_qoz_ms_351->tag) { case qoz_Ty_TyAdt: { qoz_string bn = _qoz_ms_351->payload.TyAdt.f0; qoz_Vec__qoz_Ty ba = _qoz_ms_351->payload.TyAdt.f1; _qoz_mv_351 = (qoz_strings_eq_raw(an, bn) && qoz_ty_ty_args_eq(aa, ba));  break; } default: { _qoz_mv_351 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_351);  break; } case qoz_Ty_TyRecord: { qoz_string an = _qoz_ms_340->payload.TyRecord.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_340->payload.TyRecord.f1; qoz_Ty* _qoz_ms_352 = b; bool _qoz_mv_352 = false; switch (_qoz_ms_352->tag) { case qoz_Ty_TyRecord: { qoz_string bn = _qoz_ms_352->payload.TyRecord.f0; qoz_Vec__qoz_Ty ba = _qoz_ms_352->payload.TyRecord.f1; _qoz_mv_352 = (qoz_strings_eq_raw(an, bn) && qoz_ty_ty_args_eq(aa, ba));  break; } default: { _qoz_mv_352 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_352);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty ap = _qoz_ms_340->payload.TyFn.f0; qoz_Ty* ar = _qoz_ms_340->payload.TyFn.f1; qoz_Ty* _qoz_ms_353 = b; bool _qoz_mv_353 = false; switch (_qoz_ms_353->tag) { case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty bp = _qoz_ms_353->payload.TyFn.f0; qoz_Ty* br = _qoz_ms_353->payload.TyFn.f1; _qoz_mv_353 = (qoz_ty_ty_args_eq(ap, bp) && qoz_ty_ty_eq(ar, br));  break; } default: { _qoz_mv_353 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_353);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty ae = _qoz_ms_340->payload.TyTuple.f0; qoz_Ty* _qoz_ms_364 = b; bool _qoz_mv_364 = false; switch (_qoz_ms_364->tag) { case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty be = _qoz_ms_364->payload.TyTuple.f0; _qoz_mv_364 = (qoz_ty_ty_args_eq(ae, be));  break; } default: { _qoz_mv_364 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_364);  break; } case qoz_Ty_TyVar: { qoz_string an = _qoz_ms_340->payload.TyVar.f1; qoz_Ty* _qoz_ms_365 = b; bool _qoz_mv_365 = false; switch (_qoz_ms_365->tag) { case qoz_Ty_TyVar: { qoz_string bn = _qoz_ms_365->payload.TyVar.f1; _qoz_mv_365 = (qoz_strings_eq_raw(an, bn));  break; } default: { _qoz_mv_365 = (false);  break; } } _qoz_mv_340 = (_qoz_mv_365);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_340;
}

qoz_TypeExpr* qoz_ty_ty_to_type_expr_at(qoz_Ty* t, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_366 = t; qoz_TypeExpr* _qoz_mv_366 = NULL; switch (_qoz_ms_366->tag) { case qoz_Ty_TyInt: { qoz_IntInfo info = _qoz_ms_366->payload.TyInt.f0; _qoz_mv_366 = (qoz_make_TypeExpr_TENamed(sp, qoz_ty_ints_to_path(info.width, info.is_signed), qoz_vec_make__qoz_TypeExpr()));  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo info = _qoz_ms_366->payload.TyFloat.f0; qoz_TypeExpr* _qoz_bv_335;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); if (info.width == 32) { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f32")); }  else { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f64")); } _qoz_bv_335 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_366 = (_qoz_bv_335);  break; } case qoz_Ty_TyBool: { _qoz_mv_366 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Ty_TyChar: { _qoz_mv_366 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Ty_TyString: { _qoz_mv_366 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Ty_TyCstring: { _qoz_mv_366 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("cstring")));  break; } case qoz_Ty_TyUnit: { _qoz_mv_366 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Ty_TyNil: { _qoz_mv_366 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("nil")));  break; } case qoz_Ty_TyError: { _qoz_mv_366 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("?")));  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_366->payload.TyPtr.f0; _qoz_mv_366 = (qoz_make_TypeExpr_TEPtr(sp, qoz_ty_ty_to_type_expr_at(inner, sp)));  break; } case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_366->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_366->payload.TyAdt.f1; _qoz_mv_366 = (qoz_ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_366->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_366->payload.TyRecord.f1; _qoz_mv_366 = (qoz_ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty fparams = _qoz_ms_366->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_366->payload.TyFn.f1; qoz_TypeExpr* _qoz_bv_336;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; qoz_vec_push__qoz_TypeExpr(&pte, qoz_ty_ty_to_type_expr_at(p, sp)); } }_qoz_bv_336 = qoz_make_TypeExpr_TEFn(sp, pte, qoz_ty_ty_to_type_expr_at(ret, sp));
    }
    _qoz_mv_366 = (_qoz_bv_336);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_366->payload.TyTuple.f0; qoz_TypeExpr* _qoz_bv_337;
    {
        qoz_Vec__qoz_TypeExpr ete = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ete, qoz_ty_ty_to_type_expr_at(el, sp)); } }_qoz_bv_337 = qoz_make_TypeExpr_TETuple(sp, ete);
    }
    _qoz_mv_366 = (_qoz_bv_337);  break; } case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_366->payload.TyVar.f1; _qoz_mv_366 = (qoz_ty_single_path_te(sp, name));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_366;
}
...
qoz_string qoz_ty_ty_show(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_367 = t; qoz_string _qoz_mv_367 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_367->tag) { case qoz_Ty_TyInt: { qoz_IntInfo i = _qoz_ms_367->payload.TyInt.f0; qoz_string _qoz_bv_338;
    {
        qoz_string prefix = ((i.is_signed) ? QOZ_STR_LIT("i") : QOZ_STR_LIT("u")); qoz_string w = ((i.width == 8) ? QOZ_STR_LIT("8") : ((i.width == 16) ? QOZ_STR_LIT("16") : ((i.width == 32) ? QOZ_STR_LIT("32") : QOZ_STR_LIT("64")))); _qoz_bv_338 = qoz_strings_cat(prefix, w);
    }
    _qoz_mv_367 = (_qoz_bv_338);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo f = _qoz_ms_367->payload.TyFloat.f0; _qoz_mv_367 = (((f.width == 32) ? QOZ_STR_LIT("f32") : QOZ_STR_LIT("f64")));  break; } case qoz_Ty_TyBool: { _qoz_mv_367 = (QOZ_STR_LIT("bool"));  break; } case qoz_Ty_TyChar: { _qoz_mv_367 = (QOZ_STR_LIT("char"));  break; } case qoz_Ty_TyString: { _qoz_mv_367 = (QOZ_STR_LIT("string"));  break; } case qoz_Ty_TyCstring: { _qoz_mv_367 = (QOZ_STR_LIT("cstring"));  break; } case qoz_Ty_TyUnit: { _qoz_mv_367 = (QOZ_STR_LIT("unit"));  break; } case qoz_Ty_TyNil: { _qoz_mv_367 = (QOZ_STR_LIT("nil"));  break; } case qoz_Ty_TyError: { _qoz_mv_367 = (QOZ_STR_LIT("<error>"));  break; } case qoz_Ty_TyVar: { qoz_string n = _qoz_ms_367->payload.TyVar.f1; _qoz_mv_367 = (n);  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_367->payload.TyPtr.f0; _qoz_mv_367 = (qoz_strings_cat(QOZ_STR_LIT("*"), qoz_ty_ty_show(inner)));  break; } case qoz_Ty_TyAdt: { qoz_string n = _qoz_ms_367->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_367->payload.TyAdt.f1; qoz_string _qoz_bv_339;
    {
        if ((args.len) == 0) { return n;} qoz_string out = qoz_strings_cat(n, QOZ_STR_LIT("<")); int64_t i = 0; { qoz_Vec__qoz_Ty __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(a)); i = i + 1; } }_qoz_bv_339 = qoz_strings_cat(out, QOZ_STR_LIT(">"));
    }
    _qoz_mv_367 = (_qoz_bv_339);  break; } case qoz_Ty_TyRecord: { qoz_string n = _qoz_ms_367->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_367->payload.TyRecord.f1; qoz_string _qoz_bv_330;
    {
        if ((args.len) == 0) { return n;} qoz_string out = qoz_strings_cat(n, QOZ_STR_LIT("<")); int64_t i = 0; { qoz_Vec__qoz_Ty __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(a)); i = i + 1; } }_qoz_bv_330 = qoz_strings_cat(out, QOZ_STR_LIT(">"));
    }
    _qoz_mv_367 = (_qoz_bv_330);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty params = _qoz_ms_367->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_367->payload.TyFn.f1; qoz_string _qoz_bv_331;
    {
        qoz_string out = QOZ_STR_LIT("fn("); int64_t i = 0; { qoz_Vec__qoz_Ty __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(p)); i = i + 1; } }out = qoz_strings_cat(out, QOZ_STR_LIT(") -> ")); _qoz_bv_331 = qoz_strings_cat(out, qoz_ty_ty_show(ret));
    }
    _qoz_mv_367 = (_qoz_bv_331);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_367->payload.TyTuple.f0; qoz_string _qoz_bv_332;
    {
        qoz_string out = QOZ_STR_LIT("("); int64_t i = 0; { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* e = __col.data[__i]; (void)e; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(e)); i = i + 1; } }_qoz_bv_332 = qoz_strings_cat(out, QOZ_STR_LIT(")"));
    }
    _qoz_mv_367 = (_qoz_bv_332);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_367;
}

bool qoz_ty_arg_is_nil_accepted_by(qoz_Ty* param) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&param);
    qoz_Ty* _qoz_ms_368 = param; bool _qoz_mv_368 = false; switch (_qoz_ms_368->tag) { case qoz_Ty_TyPtr: { _qoz_mv_368 = (true);  break; } default: { _qoz_mv_368 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_368;
}

bool qoz_ty_untyped_int_fits(qoz_Ty* param) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&param);
    qoz_Ty* _qoz_ms_369 = param; bool _qoz_mv_369 = false; switch (_qoz_ms_369->tag) { case qoz_Ty_TyInt: { _qoz_mv_369 = (true);  break; } default: { _qoz_mv_369 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_369;
}

bool qoz_ty_untyped_float_fits(qoz_Ty* param) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&param);
    qoz_Ty* _qoz_ms_360 = param; bool _qoz_mv_360 = false; switch (_qoz_ms_360->tag) { case qoz_Ty_TyFloat: { _qoz_mv_360 = (true);  break; } default: { _qoz_mv_360 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_360;
}
...
bool qoz_ty_arg_passes_to_param(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    qoz_Ty* _qoz_ms_361 = arg; bool _qoz_mv_361 = false; switch (_qoz_ms_361->tag) { case qoz_Ty_TyError: { _qoz_mv_361 = (true);  break; } case qoz_Ty_TyNil: { _qoz_mv_361 = (qoz_ty_arg_is_nil_accepted_by(param));  break; } case qoz_Ty_TyInt: { qoz_IntInfo ai = _qoz_ms_361->payload.TyInt.f0; bool _qoz_bv_333;
    {
        if (ai.untyped && qoz_ty_untyped_int_fits(param)) { return true;} qoz_Ty* _qoz_ms_362 = param; bool _qoz_mv_362 = false; switch (_qoz_ms_362->tag) { case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_362->payload.TyInt.f0; _qoz_mv_362 = (qoz_ty_int_widens_to(pi, ai));  break; } default: { _qoz_mv_362 = (false);  break; } } _qoz_bv_333 = _qoz_mv_362;
    }
    _qoz_mv_361 = (_qoz_bv_333);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo af = _qoz_ms_361->payload.TyFloat.f0; bool _qoz_bv_344;
    {
        if (af.untyped && qoz_ty_untyped_float_fits(param)) { return true;} qoz_Ty* _qoz_ms_363 = param; bool _qoz_mv_363 = false; switch (_qoz_ms_363->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_363->payload.TyFloat.f0; _qoz_mv_363 = (pf.width >= af.width);  break; } default: { _qoz_mv_363 = (false);  break; } } _qoz_bv_344 = _qoz_mv_363;
    }
    _qoz_mv_361 = (_qoz_bv_344);  break; } default: { _qoz_mv_361 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_361;
}
...
bool qoz_ty_same_constructor_assignable(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    qoz_Ty* _qoz_ms_374 = param; bool _qoz_mv_374 = false; switch (_qoz_ms_374->tag) { case qoz_Ty_TyAdt: { qoz_string pn = _qoz_ms_374->payload.TyAdt.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_374->payload.TyAdt.f1; qoz_Ty* _qoz_ms_375 = arg; bool _qoz_mv_375 = false; switch (_qoz_ms_375->tag) { case qoz_Ty_TyAdt: { qoz_string an = _qoz_ms_375->payload.TyAdt.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_375->payload.TyAdt.f1; bool _qoz_bv_345;
    {
        if (!qoz_strings_eq_raw(pn, an)) { return false;} if ((pa.len) != (aa.len)) { return false;} int64_t i = 0; while (i < (pa.len)) { if (!qoz_ty_ty_assignable(pa.data[i], aa.data[i])) { return false;} i = i + 1; } _qoz_bv_345 = true;
    }
    _qoz_mv_375 = (_qoz_bv_345);  break; } default: { _qoz_mv_375 = (false);  break; } } _qoz_mv_374 = (_qoz_mv_375);  break; } case qoz_Ty_TyRecord: { qoz_string pn = _qoz_ms_374->payload.TyRecord.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_374->payload.TyRecord.f1; qoz_Ty* _qoz_ms_376 = arg; bool _qoz_mv_376 = false; switch (_qoz_ms_376->tag) { case qoz_Ty_TyRecord: { qoz_string an = _qoz_ms_376->payload.TyRecord.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_376->payload.TyRecord.f1; bool _qoz_bv_346;
    {
        if (!qoz_strings_eq_raw(pn, an)) { return false;} if ((pa.len) != (aa.len)) { return false;} int64_t i = 0; while (i < (pa.len)) { if (!qoz_ty_ty_assignable(pa.data[i], aa.data[i])) { return false;} i = i + 1; } _qoz_bv_346 = true;
    }
    _qoz_mv_376 = (_qoz_bv_346);  break; } default: { _qoz_mv_376 = (false);  break; } } _qoz_mv_374 = (_qoz_mv_376);  break; } case qoz_Ty_TyPtr: { qoz_Ty* pi = _qoz_ms_374->payload.TyPtr.f0; qoz_Ty* _qoz_ms_377 = arg; bool _qoz_mv_377 = false; switch (_qoz_ms_377->tag) { case qoz_Ty_TyPtr: { qoz_Ty* ai = _qoz_ms_377->payload.TyPtr.f0; _qoz_mv_377 = (qoz_ty_ty_assignable(pi, ai));  break; } default: { _qoz_mv_377 = (false);  break; } } _qoz_mv_374 = (_qoz_mv_377);  break; } default: { _qoz_mv_374 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_374;
}
...
bool qoz_ty_ty_assignable(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    if (qoz_ty_ty_eq(param, arg)) { return true;} if (qoz_ty_arg_passes_to_param(param, arg)) { return true;} qoz_Ty* _qoz_ms_378 = arg; switch (_qoz_ms_378->tag) { case qoz_Ty_TyVar: { return true; break; } default: { NULL;  break; } } 0; qoz_Ty* _qoz_ms_379 = param; switch (_qoz_ms_379->tag) { case qoz_Ty_TyVar: { return true; break; } default: { NULL;  break; } } 0; if (qoz_ty_same_constructor_assignable(param, arg)) { return true;} qoz_Ty* _qoz_ms_370 = param; bool _qoz_mv_370 = false; switch (_qoz_ms_370->tag) { case qoz_Ty_TyError: { _qoz_mv_370 = (true);  break; } case qoz_Ty_TyVar: { _qoz_mv_370 = (true);  break; } default: { _qoz_mv_370 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_370;
}
