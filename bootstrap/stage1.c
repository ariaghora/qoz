...
int main(int argc, char **argv) {
    ...
    qoz_Vec__qoz_string args = os_args(); if ((args.len) < 2) { fmt_println(QOZ_STR_LIT("usage: compiler <path>")); qoz_os_exit(1); } qoz_string path = args.data[1]; qoz_string qoz_root = qoz_os_getenv(QOZ_STR_LIT("QOZ_ROOT")); qoz_Loaded loaded = load_all(path, qoz_root); qoz_File file = loaded.file; qoz_string _qoz_bv_11;
    {
        qoz_Strbuf _qoz_sb_297_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_297_17); strings_sb_append_i64(&_qoz_sb_297_17, (file.decls.len)); strings_sb_append(&_qoz_sb_297_17, QOZ_STR_LIT(" decls (after import resolution)")); _qoz_bv_11 = strings_sb_finish(&_qoz_sb_297_17);
    }
    fmt_println(_qoz_bv_11); qoz_TyContext tc = check_make_ctx(); check_register_file(&tc, file); check_validate_signatures(&tc, file); qoz_File inferred = check_infer_calls(&tc, file); check_check_fn_bodies(&tc, inferred); check_report(&tc); if ((tc.errors.len) > 0) { qoz_os_exit(1); } qoz_string c_source = emit_emit_program(inferred, tc.expr_types); qoz_Vec__qoz_string _keep_alive = loaded.sources; qoz_string out_path = qoz_string_cat(path, QOZ_STR_LIT(".c")); bool ok = qoz_fs_write_file(out_path, c_source); if (ok) { qoz_string _qoz_bv_12;
    {
        qoz_Strbuf _qoz_sb_312_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_312_21); strings_sb_append(&_qoz_sb_312_21, QOZ_STR_LIT("wrote ")); strings_sb_append(&_qoz_sb_312_21, out_path); _qoz_bv_12 = strings_sb_finish(&_qoz_sb_312_21);
    }
    fmt_println(_qoz_bv_12); } 
    qoz_shutdown();
    return 0;
}
void fmt_println(qoz_string s) {
...
bool tokenize_is_stmt_ender(qoz_Token t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_TokenKind* _qoz_ms_9 = t.kind; bool _qoz_mv_9 = false; switch (_qoz_ms_9->tag) { case qoz_TokenKind_TokIdent: { _qoz_mv_9 = (true);  break; } case qoz_TokenKind_TokInt: { _qoz_mv_9 = (true);  break; } case qoz_TokenKind_TokFloat: { _qoz_mv_9 = (true);  break; } case qoz_TokenKind_TokString: { _qoz_mv_9 = (true);  break; } case qoz_TokenKind_TokChar: { _qoz_mv_9 = (true);  break; } case qoz_TokenKind_TokKeyword: { bool _qoz_bv_13;
    {
        if (qoz_string_eq(t.text, QOZ_STR_LIT("true"))) { return true;} if (qoz_string_eq(t.text, QOZ_STR_LIT("false"))) { return true;} if (qoz_string_eq(t.text, QOZ_STR_LIT("nil"))) { return true;} if (qoz_string_eq(t.text, QOZ_STR_LIT("return"))) { return true;} _qoz_bv_13 = false;
    }
    _qoz_mv_9 = (_qoz_bv_13);  break; } case qoz_TokenKind_TokPunct: { bool _qoz_bv_14;
    {
        if (qoz_string_eq(t.text, QOZ_STR_LIT(")"))) { return true;} if (qoz_string_eq(t.text, QOZ_STR_LIT("]"))) { return true;} if (qoz_string_eq(t.text, QOZ_STR_LIT("}"))) { return true;} _qoz_bv_14 = false;
    }
    _qoz_mv_9 = (_qoz_bv_14);  break; } default: { _qoz_mv_9 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_9;
}

bool tokenize_is_line_continuation(qoz_Token t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_TokenKind* _qoz_ms_10 = t.kind; bool _qoz_mv_10 = false; switch (_qoz_ms_10->tag) { case qoz_TokenKind_TokKeyword: { bool _qoz_bv_15;
    {
        if (qoz_string_eq(t.text, QOZ_STR_LIT("else"))) { return true;} if (qoz_string_eq(t.text, QOZ_STR_LIT("as"))) { return true;} if (qoz_string_eq(t.text, QOZ_STR_LIT("in"))) { return true;} _qoz_bv_15 = false;
    }
    _qoz_mv_10 = (_qoz_bv_15);  break; } case qoz_TokenKind_TokPunct: { bool _qoz_bv_16;
    {
        qoz_string s = t.text; if (qoz_string_eq(s, QOZ_STR_LIT("|"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("||"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("&"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("&&"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("+"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("-"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("*"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("/"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("%"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("^"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("<"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT(">"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("<="))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT(">="))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("<<"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("=="))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("!="))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("="))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("+="))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("-="))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("*="))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("/="))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("%="))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("->"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("."))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT(","))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT(":"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("?"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT(")"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("]"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("}"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT(".."))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("..<"))) { return true;} if (qoz_string_eq(s, QOZ_STR_LIT("..="))) { return true;} _qoz_bv_16 = false;
    }
    _qoz_mv_10 = (_qoz_bv_16);  break; } default: { _qoz_mv_10 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_10;
}
...
void parse_expect_punct(qoz_Parser* p, qoz_string sym) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&p);
    qoz_Token t = parse_peek(p); if (parse_is_punct(t, sym)) { parse_advance(p); }  else { qoz_string _qoz_bv_18;
    {
        qoz_Strbuf _qoz_sb_107_27 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_107_27); strings_sb_append(&_qoz_sb_107_27, QOZ_STR_LIT("`")); strings_sb_append(&_qoz_sb_107_27, sym); strings_sb_append(&_qoz_sb_107_27, QOZ_STR_LIT("`")); _qoz_bv_18 = strings_sb_finish(&_qoz_sb_107_27);
    }
    parse_err_unexpected(p, _qoz_bv_18, t); if (!parse_at_eof(p)) { parse_advance(p); } } 
    return;
}
...
qoz_string parse_c_escape_bytes(qoz_string src) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_string out = QOZ_STR_LIT("\""); int64_t i = 0; int64_t n = (src).len; while (i < n) { int64_t b = qoz_string_byte_at(src, i); if (b == 92) { out = qoz_string_cat(out, QOZ_STR_LIT("\\\\")); }  else if (b == 34) { out = qoz_string_cat(out, QOZ_STR_LIT("\\\"")); }  else if (b == 10) { out = qoz_string_cat(out, QOZ_STR_LIT("\\n")); }  else if (b == 13) { out = qoz_string_cat(out, QOZ_STR_LIT("\\r")); }  else if (b == 9) { out = qoz_string_cat(out, QOZ_STR_LIT("\\t")); }  else if ((b < 32) || (b == 127)) { qoz_string _qoz_bv_19;
    {
        qoz_Strbuf _qoz_sb_625_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_625_36); strings_sb_append(&_qoz_sb_625_36, QOZ_STR_LIT("\\x")); strings_sb_append(&_qoz_sb_625_36, parse_hex2(b)); _qoz_bv_19 = strings_sb_finish(&_qoz_sb_625_36);
    }
    out = qoz_string_cat(out, _qoz_bv_19); }  else { out = qoz_string_cat(out, qoz_string_slice(src, i, i + 1)); } i = i + 1; } out = qoz_string_cat(out, QOZ_STR_LIT("\"")); qoz_gc_shadow_set_top(_qoz_shadow_guard); return out;
}

qoz_string parse_hex_digit(int64_t n) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    if (n < 10) { qoz_string _qoz_bv_20;
    {
        qoz_Strbuf _qoz_sb_636_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_636_24); strings_sb_append_i64(&_qoz_sb_636_24, n); _qoz_bv_20 = strings_sb_finish(&_qoz_sb_636_24);
    }
    return _qoz_bv_20;} qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_string_slice(QOZ_STR_LIT("abcdef"), n - 10, n - 9);
}
...
qoz_string parse_interp_var_name(qoz_Span span) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_string _qoz_bv_21;
    {
        qoz_Strbuf _qoz_sb_791_41 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_791_41); strings_sb_append_i64(&_qoz_sb_791_41, span.line); _qoz_bv_21 = strings_sb_finish(&_qoz_sb_791_41);
    }
    qoz_string _qoz_bv_22;
    {
        qoz_Strbuf _qoz_sb_791_73 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_791_73); strings_sb_append_i64(&_qoz_sb_791_73, span.col); _qoz_bv_22 = strings_sb_finish(&_qoz_sb_791_73);
    }
    qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_string_cat(QOZ_STR_LIT("_qoz_sb_"), qoz_string_cat(_qoz_bv_21, qoz_string_cat(QOZ_STR_LIT("_"), _qoz_bv_22)));
}
...
void check_summary(qoz_TyContext* tc) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_string _qoz_bv_30;
    {
        qoz_Strbuf _qoz_sb_92_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_92_17); strings_sb_append(&_qoz_sb_92_17, QOZ_STR_LIT("enums:    ")); strings_sb_append_i64(&_qoz_sb_92_17, (tc->enums.len)); _qoz_bv_30 = strings_sb_finish(&_qoz_sb_92_17);
    }
    fmt_println(_qoz_bv_30); qoz_string _qoz_bv_31;
    {
        qoz_Strbuf _qoz_sb_93_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_93_17); strings_sb_append(&_qoz_sb_93_17, QOZ_STR_LIT("structs:  ")); strings_sb_append_i64(&_qoz_sb_93_17, (tc->structs.len)); _qoz_bv_31 = strings_sb_finish(&_qoz_sb_93_17);
    }
    fmt_println(_qoz_bv_31); qoz_string _qoz_bv_32;
    {
        qoz_Strbuf _qoz_sb_94_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_94_17); strings_sb_append(&_qoz_sb_94_17, QOZ_STR_LIT("aliases:  ")); strings_sb_append_i64(&_qoz_sb_94_17, (tc->aliases.len)); _qoz_bv_32 = strings_sb_finish(&_qoz_sb_94_17);
    }
    fmt_println(_qoz_bv_32); qoz_string _qoz_bv_33;
    {
        qoz_Strbuf _qoz_sb_95_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_95_17); strings_sb_append(&_qoz_sb_95_17, QOZ_STR_LIT("fns:      ")); strings_sb_append_i64(&_qoz_sb_95_17, (tc->fns.len)); _qoz_bv_33 = strings_sb_finish(&_qoz_sb_95_17);
    }
    fmt_println(_qoz_bv_33); qoz_string _qoz_bv_34;
    {
        qoz_Strbuf _qoz_sb_96_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_96_17); strings_sb_append(&_qoz_sb_96_17, QOZ_STR_LIT("externs:  ")); strings_sb_append_i64(&_qoz_sb_96_17, (tc->externs.len)); _qoz_bv_34 = strings_sb_finish(&_qoz_sb_96_17);
    }
    fmt_println(_qoz_bv_34); qoz_string _qoz_bv_35;
    {
        qoz_Strbuf _qoz_sb_97_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_97_17); strings_sb_append(&_qoz_sb_97_17, QOZ_STR_LIT("packages: ")); strings_sb_append_i64(&_qoz_sb_97_17, (tc->packages.len)); _qoz_bv_35 = strings_sb_finish(&_qoz_sb_97_17);
    }
    fmt_println(_qoz_bv_35); qoz_string _qoz_bv_36;
    {
        qoz_Strbuf _qoz_sb_98_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_98_17); strings_sb_append(&_qoz_sb_98_17, QOZ_STR_LIT("errors:   ")); strings_sb_append_i64(&_qoz_sb_98_17, (tc->errors.len)); _qoz_bv_36 = strings_sb_finish(&_qoz_sb_98_17);
    }
    fmt_println(_qoz_bv_36); 
    return;
}
...
qoz_Ty* check_synth_inner(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* e) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&e);
    qoz_Expr* _qoz_ms_27 = e; qoz_Ty* _qoz_mv_27 = NULL; switch (_qoz_ms_27->tag) { case qoz_Expr_EInt: { _qoz_mv_27 = (ty_ty_int_untyped());  break; } case qoz_Expr_EFloat: { _qoz_mv_27 = (ty_ty_float_untyped());  break; } case qoz_Expr_EString: { _qoz_mv_27 = (ty_ty_string_());  break; } case qoz_Expr_EChar: { _qoz_mv_27 = (ty_ty_char_());  break; } case qoz_Expr_EBool: { _qoz_mv_27 = (ty_ty_bool_());  break; } case qoz_Expr_ENil: { _qoz_mv_27 = (ty_ty_nil_());  break; } case qoz_Expr_EIdent: { qoz_Span span = _qoz_ms_27->payload.EIdent.f0; qoz_string name = _qoz_ms_27->payload.EIdent.f1; _qoz_mv_27 = (check_synth_ident(tc, env, span, name));  break; } case qoz_Expr_EPath: { _qoz_mv_27 = (ty_ty_error_());  break; } case qoz_Expr_EUnary: { qoz_UnaryOp* op = _qoz_ms_27->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_27->payload.EUnary.f2; _qoz_mv_27 = (check_synth_unary(tc, env, op, rhs));  break; } case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_27->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_27->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_27->payload.EBinary.f3; _qoz_mv_27 = (check_synth_binary(tc, env, op, l, r));  break; } case qoz_Expr_EAssign: { qoz_Expr* v = _qoz_ms_27->payload.EAssign.f3; qoz_Ty* _qoz_bv_39;
    {
        (void)(check_synth(tc, env, v)); _qoz_bv_39 = ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_39);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_27->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_27->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_27->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_27->payload.ECall.f3; _qoz_mv_27 = (check_synth_call_full(tc, env, sp, callee, ta, args));  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_27->payload.EField.f0; qoz_Expr* base = _qoz_ms_27->payload.EField.f1; qoz_string name = _qoz_ms_27->payload.EField.f2; _qoz_mv_27 = (check_synth_field(tc, env, sp, base, name));  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_27->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_27->payload.EIndex.f2; _qoz_mv_27 = (check_synth_index(tc, env, base, idx));  break; } case qoz_Expr_ECast: { qoz_TypeExpr* te = _qoz_ms_27->payload.ECast.f2; _qoz_mv_27 = (check_resolve_type(tc, te));  break; } case qoz_Expr_ETry: { qoz_Expr* v = _qoz_ms_27->payload.ETry.f1; _qoz_mv_27 = (check_synth(tc, env, v));  break; } case qoz_Expr_ETuple: { qoz_Vec__qoz_Expr elems = _qoz_ms_27->payload.ETuple.f1; qoz_Ty* _qoz_bv_40;
    {
        qoz_Vec__qoz_Ty elem_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Ty(&elem_tys, check_synth(tc, env, el)); } }_qoz_bv_40 = ty_ty_tuple_(elem_tys);
    }
    _qoz_mv_27 = (_qoz_bv_40);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_27->payload.ERecord.f1; _qoz_mv_27 = (check_resolve_type(tc, te));  break; } case qoz_Expr_EClosure: { qoz_Vec__qoz_ClosureParam cps = _qoz_ms_27->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_27->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_27->payload.EClosure.f3; qoz_Ty* _qoz_bv_41;
    {
        qoz_Vec__qoz_Ty pty = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_Ty* t = check_resolve_type(tc, cp.ty); qoz_gc_push_root(&t); qoz_vec_push__qoz_Ty(&pty, t); check_env_define(env, cp.name, t); } }(void)(check_synth(tc, env, body)); _qoz_bv_41 = ty_ty_fn_(pty, check_resolve_type(tc, ret));
    }
    _qoz_mv_27 = (_qoz_bv_41);  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_27->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_27->payload.EBlock.f2; _qoz_mv_27 = (check_synth_block(tc, env, stmts, tail));  break; } case qoz_Expr_EIf: { qoz_Expr* c = _qoz_ms_27->payload.EIf.f1; qoz_Expr* t = _qoz_ms_27->payload.EIf.f2; qoz_Expr* f = _qoz_ms_27->payload.EIf.f3; _qoz_mv_27 = (check_synth_if(tc, env, c, t, f));  break; } case qoz_Expr_EMatch: { qoz_Expr* scrut = _qoz_ms_27->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_27->payload.EMatch.f2; _qoz_mv_27 = (check_synth_match(tc, env, scrut, arms));  break; } case qoz_Expr_EWhile: { qoz_Expr* c = _qoz_ms_27->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_27->payload.EWhile.f2; qoz_Ty* _qoz_bv_42;
    {
        (void)(check_synth(tc, env, c)); (void)(check_synth(tc, env, b)); _qoz_bv_42 = ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_42);  break; } case qoz_Expr_EFor: { qoz_string b1 = _qoz_ms_27->payload.EFor.f1; qoz_string b2 = _qoz_ms_27->payload.EFor.f2; qoz_Expr* it = _qoz_ms_27->payload.EFor.f3; qoz_Expr* b = _qoz_ms_27->payload.EFor.f4; qoz_Ty* _qoz_bv_43;
    {
        qoz_Ty* it_ty = check_synth(tc, env, it); qoz_gc_push_root(&it_ty); int64_t saved_len = (env->bindings.len); check_bind_for_loop(env, b1, b2, it_ty); (void)(check_synth(tc, env, b)); check_env_truncate(env, saved_len); _qoz_bv_43 = ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_43);  break; } case qoz_Expr_EReturn: { qoz_Expr* v = _qoz_ms_27->payload.EReturn.f1; qoz_Ty* _qoz_bv_44;
    {
        (void)(check_synth(tc, env, v)); _qoz_bv_44 = ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_44);  break; } case qoz_Expr_EDefer: { qoz_Expr* b = _qoz_ms_27->payload.EDefer.f1; qoz_Ty* _qoz_bv_45;
    {
        (void)(check_synth(tc, env, b)); _qoz_bv_45 = ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_45);  break; } case qoz_Expr_ESizeOf: { _qoz_mv_27 = (ty_ty_int_(64, true));  break; } case qoz_Expr_EArrayLit: { qoz_Vec__qoz_Expr elems = _qoz_ms_27->payload.EArrayLit.f1; qoz_Ty* _qoz_bv_46;
    {
        if ((elems.len) == 0) { return ty_ty_error_();} qoz_Ty* elem_ty = check_synth(tc, env, elems.data[0]); qoz_gc_push_root(&elem_ty); int64_t i = 1; while (i < (elems.len)) { (void)(check_synth(tc, env, elems.data[i])); i = i + 1; } qoz_Vec__qoz_Ty args = qoz_vec_make__qoz_Ty(); qoz_vec_push__qoz_Ty(&args, elem_ty); _qoz_bv_46 = ty_ty_record_(QOZ_STR_LIT("Vec"), args);
    }
    _qoz_mv_27 = (_qoz_bv_46);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_27;
}
...
qoz_Ty* check_synth_unary(qoz_TyContext* tc, qoz_Env* env, qoz_UnaryOp* op, qoz_Expr* rhs) {
    ...
    qoz_Ty* t = check_synth(tc, env, rhs); qoz_gc_push_root(&t); qoz_UnaryOp* _qoz_ms_28 = op; qoz_Ty* _qoz_mv_28 = NULL; switch (_qoz_ms_28->tag) { case qoz_UnaryOp_UOpNeg: { _qoz_mv_28 = (t);  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_28 = (ty_ty_bool_());  break; } case qoz_UnaryOp_UOpDeref: { qoz_Ty* _qoz_ms_29 = t; qoz_Ty* _qoz_mv_29 = NULL; switch (_qoz_ms_29->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_29->payload.TyPtr.f0; _qoz_mv_29 = (inner);  break; } default: { _qoz_mv_29 = (ty_ty_error_());  break; } } _qoz_mv_28 = (_qoz_mv_29);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_28 = (ty_ty_ptr_(t));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_28;
}
...
qoz_Ty* check_field_type_of(qoz_TyContext* tc, qoz_Ty* bt, qoz_string name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&bt);
    qoz_Ty* _qoz_ms_30 = bt; qoz_Ty* _qoz_mv_30 = NULL; switch (_qoz_ms_30->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_30->payload.TyPtr.f0; _qoz_mv_30 = (check_field_type_of(tc, inner, name));  break; } case qoz_Ty_TyRecord: { qoz_string struct_name = _qoz_ms_30->payload.TyRecord.f0; qoz_Vec__qoz_Ty tyargs = _qoz_ms_30->payload.TyRecord.f1; _qoz_mv_30 = (check_lookup_field(tc, struct_name, tyargs, name));  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_30->payload.TyTuple.f0; qoz_Ty* _qoz_bv_47;
    {
        if (((name).len >= 2) && (qoz_string_byte_at(name, 0) == 95)) { int64_t idx = qoz_string_parse_int(qoz_string_slice(name, 1, (name).len)); if ((idx >= 0) && (idx < (elems.len))) { return elems.data[idx];} } _qoz_bv_47 = ty_ty_error_();
    }
    _qoz_mv_30 = (_qoz_bv_47);  break; } default: { _qoz_mv_30 = (ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_30;
}

qoz_Ty* check_lookup_field(qoz_TyContext* tc, qoz_string struct_name, qoz_Vec__qoz_Ty tyargs, qoz_string field) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_Option__qoz_Decl* _qoz_ms_31 = qoz_map_get__qoz_string__qoz_Decl(&tc->structs, struct_name); qoz_Ty* _qoz_mv_31 = NULL; switch (_qoz_ms_31->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_31->payload.Some.f0; qoz_Decl* _qoz_ms_32 = d; qoz_Ty* _qoz_mv_32 = NULL; switch (_qoz_ms_32->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_32->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_32->payload.DStruct.f3; qoz_Ty* _qoz_bv_48;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_string_eq(f.name, field)) { if ((params.len) == (tyargs.len)) { return check_resolve_type_with_subst(tc, f.ty, params, tyargs);} return check_resolve_type(tc, f.ty);} } }_qoz_bv_48 = ty_ty_error_();
    }
    _qoz_mv_32 = (_qoz_bv_48);  break; } default: { _qoz_mv_32 = (ty_ty_error_());  break; } } _qoz_mv_31 = (_qoz_mv_32);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_31 = (ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_31;
}
...
qoz_Ty* check_apply_subst(qoz_Ty* t, qoz_Vec__qoz_string params, qoz_Vec__qoz_Ty args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_33 = t; qoz_Ty* _qoz_mv_33 = NULL; switch (_qoz_ms_33->tag) { case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_33->payload.TyVar.f1; qoz_Ty* _qoz_bv_49;
    {
        int64_t i = 0; { qoz_Vec__qoz_string __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string p = __col.data[__i]; (void)p; if (qoz_string_eq(p, name)) { if (i < (args.len)) { return args.data[i];} return t;} i = i + 1; } }_qoz_bv_49 = t;
    }
    _qoz_mv_33 = (_qoz_bv_49);  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_33->payload.TyPtr.f0; _qoz_mv_33 = (ty_ty_ptr_(check_apply_subst(inner, params, args)));  break; } case qoz_Ty_TyAdt: { qoz_string n = _qoz_ms_33->payload.TyAdt.f0; qoz_Vec__qoz_Ty a = _qoz_ms_33->payload.TyAdt.f1; qoz_Ty* _qoz_bv_50;
    {
        qoz_Vec__qoz_Ty na = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = a; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&na, check_apply_subst(x, params, args)); } }_qoz_bv_50 = ty_ty_adt_(n, na);
    }
    _qoz_mv_33 = (_qoz_bv_50);  break; } case qoz_Ty_TyRecord: { qoz_string n = _qoz_ms_33->payload.TyRecord.f0; qoz_Vec__qoz_Ty a = _qoz_ms_33->payload.TyRecord.f1; qoz_Ty* _qoz_bv_51;
    {
        qoz_Vec__qoz_Ty na = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = a; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&na, check_apply_subst(x, params, args)); } }_qoz_bv_51 = ty_ty_record_(n, na);
    }
    _qoz_mv_33 = (_qoz_bv_51);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty p = _qoz_ms_33->payload.TyFn.f0; qoz_Ty* r = _qoz_ms_33->payload.TyFn.f1; qoz_Ty* _qoz_bv_52;
    {
        qoz_Vec__qoz_Ty np = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = p; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&np, check_apply_subst(x, params, args)); } }_qoz_bv_52 = ty_ty_fn_(np, check_apply_subst(r, params, args));
    }
    _qoz_mv_33 = (_qoz_bv_52);  break; } default: { _qoz_mv_33 = (t);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_33;
}
...
qoz_Ty* check_synth_index(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* base, qoz_Expr* idx) {
    ...
    qoz_Ty* bt = check_synth(tc, env, base); qoz_gc_push_root(&bt); (void)(check_synth(tc, env, idx)); qoz_Ty* _qoz_ms_34 = bt; qoz_Ty* _qoz_mv_34 = NULL; switch (_qoz_ms_34->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_34->payload.TyPtr.f0; _qoz_mv_34 = (inner);  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_34->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_34->payload.TyRecord.f1; qoz_Ty* _qoz_bv_53;
    {
        if (qoz_string_eq(name, QOZ_STR_LIT("Vec")) && ((args.len) >= 1)) { return args.data[0];} _qoz_bv_53 = ty_ty_error_();
    }
    _qoz_mv_34 = (_qoz_bv_53);  break; } default: { _qoz_mv_34 = (ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_34;
}

bool check_is_strings_callee(qoz_Expr* callee, qoz_string method) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_35 = callee; bool _qoz_mv_35 = false; switch (_qoz_ms_35->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_35->payload.EField.f1; qoz_string m = _qoz_ms_35->payload.EField.f2; bool _qoz_bv_54;
    {
        if (!qoz_string_eq(m, method)) { return false;} qoz_Expr* _qoz_ms_36 = base; bool _qoz_mv_36 = false; switch (_qoz_ms_36->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_36->payload.EIdent.f1; _qoz_mv_36 = (qoz_string_eq(name, QOZ_STR_LIT("strings")));  break; } default: { _qoz_mv_36 = (false);  break; } } _qoz_bv_54 = _qoz_mv_36;
    }
    _qoz_mv_35 = (_qoz_bv_54);  break; } default: { _qoz_mv_35 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_35;
}

qoz_string check_sb_append_method_for(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_37 = t; qoz_string _qoz_mv_37 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_37->tag) { case qoz_Ty_TyString: { _qoz_mv_37 = (QOZ_STR_LIT("sb_append"));  break; } case qoz_Ty_TyBool: { _qoz_mv_37 = (QOZ_STR_LIT("sb_append_bool"));  break; } case qoz_Ty_TyFloat: { _qoz_mv_37 = (QOZ_STR_LIT("sb_append_f64"));  break; } case qoz_Ty_TyInt: { _qoz_mv_37 = (QOZ_STR_LIT("sb_append_i64"));  break; } case qoz_Ty_TyChar: { _qoz_mv_37 = (QOZ_STR_LIT("sb_append_i64"));  break; } default: { _qoz_mv_37 = (QOZ_STR_LIT("sb_append"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_37;
}
...
qoz_string check_resolve_callee_fn(qoz_TyContext* tc, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_38 = callee; qoz_string _qoz_mv_38 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_38->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_38->payload.EIdent.f1; _qoz_mv_38 = (name);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_38->payload.EField.f1; qoz_string method = _qoz_ms_38->payload.EField.f2; qoz_Expr* _qoz_ms_39 = base; qoz_string _qoz_mv_39 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_39->tag) { case qoz_Expr_EIdent: { qoz_string pkg = _qoz_ms_39->payload.EIdent.f1; qoz_string _qoz_bv_55;
    {
        if (qoz_map_contains__qoz_string__bool(&tc->packages, pkg)) { return qoz_string_cat(qoz_string_cat(pkg, QOZ_STR_LIT("_")), method);} _qoz_bv_55 = QOZ_STR_LIT("");
    }
    _qoz_mv_39 = (_qoz_bv_55);  break; } default: { _qoz_mv_39 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_38 = (_qoz_mv_39);  break; } default: { _qoz_mv_38 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_38;
}
...
qoz_Ty* check_synth_call_full(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&callee);
    qoz_string fn_name = check_resolve_callee_fn(tc, callee); if (qoz_string_eq(fn_name, QOZ_STR_LIT("len")) || qoz_string_eq(fn_name, QOZ_STR_LIT("size_of"))) { { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; (void)(check_synth(tc, env, a)); } }return ty_ty_int_(64, true);} if (qoz_string_eq(fn_name, QOZ_STR_LIT("hash"))) { { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; (void)(check_synth(tc, env, a)); } }return ty_ty_int_(64, false);} qoz_Vec__qoz_Ty arg_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_Ty(&arg_tys, check_synth(tc, env, a)); } }if (qoz_string_eq(fn_name, QOZ_STR_LIT(""))) { return ty_ty_error_();} qoz_Option__qoz_Decl* _qoz_ms_40 = qoz_map_get__qoz_string__qoz_Decl(&tc->fns, fn_name); qoz_Ty* _qoz_mv_40 = NULL; switch (_qoz_ms_40->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_40->payload.Some.f0; _qoz_mv_40 = (check_synth_call_with_decl(tc, sp, d, type_args, arg_tys));  break; } case qoz_Option__qoz_Decl_None: { qoz_Option__qoz_Decl* _qoz_ms_41 = qoz_map_get__qoz_string__qoz_Decl(&tc->externs, fn_name); qoz_Ty* _qoz_mv_41 = NULL; switch (_qoz_ms_41->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_41->payload.Some.f0; _qoz_mv_41 = (check_synth_call_with_decl(tc, sp, d, type_args, arg_tys));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_41 = (check_synth_variant_ctor(tc, fn_name));  break; } } _qoz_mv_40 = (_qoz_mv_41);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_40;
}

qoz_Ty* check_synth_variant_ctor(qoz_TyContext* tc, qoz_string name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_Option__qoz_string* _qoz_ms_42 = qoz_map_get__qoz_string__qoz_string(&tc->variant_of, name); qoz_Ty* _qoz_mv_42 = NULL; switch (_qoz_ms_42->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_42->payload.Some.f0; qoz_Option__qoz_Decl* _qoz_ms_43 = qoz_map_get__qoz_string__qoz_Decl(&tc->enums, enum_name); qoz_Ty* _qoz_mv_43 = NULL; switch (_qoz_ms_43->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_43->payload.Some.f0; qoz_Decl* _qoz_ms_44 = d; qoz_Ty* _qoz_mv_44 = NULL; switch (_qoz_ms_44->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_44->payload.DEnum.f2; qoz_Ty* _qoz_bv_56;
    {
        qoz_Vec__qoz_Ty args = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_string __col = tparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string p = __col.data[__i]; (void)p; qoz_vec_push__qoz_Ty(&args, ty_ty_var_(p)); } }_qoz_bv_56 = ty_ty_adt_(enum_name, args);
    }
    _qoz_mv_44 = (_qoz_bv_56);  break; } default: { _qoz_mv_44 = (ty_ty_error_());  break; } } _qoz_mv_43 = (_qoz_mv_44);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_43 = (ty_ty_error_());  break; } } _qoz_mv_42 = (_qoz_mv_43);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_42 = (ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_42;
}
...
qoz_Ty* check_synth_call_with_decl(qoz_TyContext* tc, qoz_Span sp, qoz_Decl* d, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Ty arg_tys) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_45 = d; qoz_Ty* _qoz_mv_45 = NULL; switch (_qoz_ms_45->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_45->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_45->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_45->payload.DFn.f4; qoz_Ty* _qoz_bv_57;
    {
        if ((tparams.len) == 0) { check_set_type_params(tc, tparams); qoz_Ty* r = check_resolve_type(tc, ret); qoz_gc_push_root(&r); check_clear_type_params(tc); return r;} qoz_Vec__qoz_Ty tyarg_tys = qoz_vec_make__qoz_Ty(); if ((type_args.len) == (tparams.len)) { { qoz_Vec__qoz_TypeExpr __col = type_args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* ta = __col.data[__i]; (void)ta; qoz_vec_push__qoz_Ty(&tyarg_tys, check_resolve_type(tc, ta)); } }}  else { qoz_Map__qoz_string__bool saved_a = tc->type_params; check_set_type_params(tc, tparams); qoz_Vec__qoz_Ty param_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_vec_push__qoz_Ty(&param_tys, check_resolve_type(tc, pp.ty)); } }tc->type_params = saved_a; qoz_Map__qoz_string__qoz_Ty subst_env = qoz_map_make__qoz_string__qoz_Ty(); bool ok = true; int64_t i = 0; while ((i < (arg_tys.len)) && (i < (param_tys.len))) { if (!check_unify(param_tys.data[i], arg_tys.data[i], &subst_env)) { ok = false; } i = i + 1; } if (!ok) { check_record_error(tc, sp, QOZ_STR_LIT("could not infer generic type arguments at call site")); } { qoz_Vec__qoz_string __col = tparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string tp = __col.data[__i]; (void)tp; qoz_Option__qoz_Ty* _qoz_ms_46 = qoz_map_get__qoz_string__qoz_Ty(&subst_env, tp); switch (_qoz_ms_46->tag) { case qoz_Option__qoz_Ty_Some: { qoz_Ty* t = _qoz_ms_46->payload.Some.f0; qoz_vec_push__qoz_Ty(&tyarg_tys, t);  break; } case qoz_Option__qoz_Ty_None: { {
        qoz_string _qoz_bv_58;
    {
        qoz_Strbuf _qoz_sb_508_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_508_42); strings_sb_append(&_qoz_sb_508_42, QOZ_STR_LIT("type parameter `")); strings_sb_append(&_qoz_sb_508_42, tp); strings_sb_append(&_qoz_sb_508_42, QOZ_STR_LIT("` is not constrained by any argument; add an explicit annotation")); _qoz_bv_58 = strings_sb_finish(&_qoz_sb_508_42);
    }
    check_record_error(tc, sp, _qoz_bv_58); qoz_vec_push__qoz_Ty(&tyarg_tys, ty_ty_error_()); 
    }
    0;  break; } } 0; } }} qoz_Map__qoz_string__bool saved_b = tc->type_params; check_set_type_params(tc, tparams); qoz_Ty* raw_ret = check_resolve_type(tc, ret); qoz_gc_push_root(&raw_ret); tc->type_params = saved_b; _qoz_bv_57 = check_apply_subst(raw_ret, tparams, tyarg_tys);
    }
    _qoz_mv_45 = (_qoz_bv_57);  break; } case qoz_Decl_DExternal: { qoz_TypeExpr* ret = _qoz_ms_45->payload.DExternal.f4; _qoz_mv_45 = (check_resolve_type(tc, ret));  break; } default: { _qoz_mv_45 = (ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_45;
}
...
bool check_unify(qoz_Ty* pattern, qoz_Ty* concrete, qoz_Map__qoz_string__qoz_Ty* env) {
    ...
    qoz_gc_push_root(&env);
    qoz_Ty* _qoz_ms_47 = pattern; bool _qoz_mv_47 = false; switch (_qoz_ms_47->tag) { case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_47->payload.TyVar.f1; qoz_Option__qoz_Ty* _qoz_ms_48 = qoz_map_get__qoz_string__qoz_Ty(env, name); bool _qoz_mv_48 = false; switch (_qoz_ms_48->tag) { case qoz_Option__qoz_Ty_Some: { qoz_Ty* prior = _qoz_ms_48->payload.Some.f0; _qoz_mv_48 = (check_compatible_or_refine(env, name, prior, concrete));  break; } case qoz_Option__qoz_Ty_None: { bool _qoz_bv_59;
    {
        qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); _qoz_bv_59 = true;
    }
    _qoz_mv_48 = (_qoz_bv_59);  break; } } _qoz_mv_47 = (_qoz_mv_48);  break; } case qoz_Ty_TyPtr: { qoz_Ty* pi = _qoz_ms_47->payload.TyPtr.f0; qoz_Ty* _qoz_ms_49 = concrete; bool _qoz_mv_49 = false; switch (_qoz_ms_49->tag) { case qoz_Ty_TyPtr: { qoz_Ty* ci = _qoz_ms_49->payload.TyPtr.f0; _qoz_mv_49 = (check_unify(pi, ci, env));  break; } case qoz_Ty_TyNil: { _qoz_mv_49 = (true);  break; } default: { _qoz_mv_49 = (false);  break; } } _qoz_mv_47 = (_qoz_mv_49);  break; } case qoz_Ty_TyAdt: { qoz_string pn = _qoz_ms_47->payload.TyAdt.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_47->payload.TyAdt.f1; qoz_Ty* _qoz_ms_50 = concrete; bool _qoz_mv_50 = false; switch (_qoz_ms_50->tag) { case qoz_Ty_TyAdt: { qoz_string cn = _qoz_ms_50->payload.TyAdt.f0; qoz_Vec__qoz_Ty ca = _qoz_ms_50->payload.TyAdt.f1; _qoz_mv_50 = (qoz_string_eq(pn, cn) && check_unify_args(pa, ca, env));  break; } default: { _qoz_mv_50 = (false);  break; } } _qoz_mv_47 = (_qoz_mv_50);  break; } case qoz_Ty_TyRecord: { qoz_string pn = _qoz_ms_47->payload.TyRecord.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_47->payload.TyRecord.f1; qoz_Ty* _qoz_ms_51 = concrete; bool _qoz_mv_51 = false; switch (_qoz_ms_51->tag) { case qoz_Ty_TyRecord: { qoz_string cn = _qoz_ms_51->payload.TyRecord.f0; qoz_Vec__qoz_Ty ca = _qoz_ms_51->payload.TyRecord.f1; _qoz_mv_51 = (qoz_string_eq(pn, cn) && check_unify_args(pa, ca, env));  break; } default: { _qoz_mv_51 = (false);  break; } } _qoz_mv_47 = (_qoz_mv_51);  break; } case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_47->payload.TyInt.f0; qoz_Ty* _qoz_ms_52 = concrete; bool _qoz_mv_52 = false; switch (_qoz_ms_52->tag) { case qoz_Ty_TyInt: { qoz_IntInfo ci = _qoz_ms_52->payload.TyInt.f0; _qoz_mv_52 = (ci.untyped || ((pi.width == ci.width) && (pi.is_signed == ci.is_signed)));  break; } default: { _qoz_mv_52 = (false);  break; } } _qoz_mv_47 = (_qoz_mv_52);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_47->payload.TyFloat.f0; qoz_Ty* _qoz_ms_53 = concrete; bool _qoz_mv_53 = false; switch (_qoz_ms_53->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo cf = _qoz_ms_53->payload.TyFloat.f0; _qoz_mv_53 = (cf.untyped || (pf.width == cf.width));  break; } default: { _qoz_mv_53 = (false);  break; } } _qoz_mv_47 = (_qoz_mv_53);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty pp = _qoz_ms_47->payload.TyFn.f0; qoz_Ty* pr = _qoz_ms_47->payload.TyFn.f1; qoz_Ty* _qoz_ms_54 = concrete; bool _qoz_mv_54 = false; switch (_qoz_ms_54->tag) { case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty cp = _qoz_ms_54->payload.TyFn.f0; qoz_Ty* cr = _qoz_ms_54->payload.TyFn.f1; _qoz_mv_54 = (check_unify_args(pp, cp, env) && check_unify(pr, cr, env));  break; } default: { _qoz_mv_54 = (false);  break; } } _qoz_mv_47 = (_qoz_mv_54);  break; } default: { _qoz_mv_47 = (ty_ty_eq(pattern, concrete));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_47;
}
...
bool check_compatible_or_refine(qoz_Map__qoz_string__qoz_Ty* env, qoz_string name, qoz_Ty* prior, qoz_Ty* concrete) {
    ...
    qoz_gc_push_root(&concrete);
    if (ty_ty_eq(prior, concrete)) { return true;} qoz_Ty* _qoz_ms_55 = prior; bool _qoz_mv_55 = false; switch (_qoz_ms_55->tag) { case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_55->payload.TyInt.f0; qoz_Ty* _qoz_ms_56 = concrete; bool _qoz_mv_56 = false; switch (_qoz_ms_56->tag) { case qoz_Ty_TyInt: { qoz_IntInfo ci = _qoz_ms_56->payload.TyInt.f0; bool _qoz_bv_60;
    {
        if (ci.untyped) { return true;} if (pi.untyped) { qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); return true;} _qoz_bv_60 = false;
    }
    _qoz_mv_56 = (_qoz_bv_60);  break; } default: { _qoz_mv_56 = (false);  break; } } _qoz_mv_55 = (_qoz_mv_56);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_55->payload.TyFloat.f0; qoz_Ty* _qoz_ms_57 = concrete; bool _qoz_mv_57 = false; switch (_qoz_ms_57->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo cf = _qoz_ms_57->payload.TyFloat.f0; bool _qoz_bv_61;
    {
        if (cf.untyped) { return true;} if (pf.untyped) { qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); return true;} _qoz_bv_61 = false;
    }
    _qoz_mv_57 = (_qoz_bv_61);  break; } default: { _qoz_mv_57 = (false);  break; } } _qoz_mv_55 = (_qoz_mv_57);  break; } default: { _qoz_mv_55 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_55;
}
...
bool check_is_ty_error(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_58 = t; bool _qoz_mv_58 = false; switch (_qoz_ms_58->tag) { case qoz_Ty_TyError: { _qoz_mv_58 = (true);  break; } default: { _qoz_mv_58 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_58;
}
...
qoz_Ty* check_synth_ident(qoz_TyContext* tc, qoz_Env* env, qoz_Span span, qoz_string name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&env);
    if (check_env_has(env, name)) { return check_env_lookup(env, name);} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->fns, name)) { return ty_ty_error_();} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->externs, name)) { return ty_ty_error_();} qoz_Option__qoz_string* _qoz_ms_59 = qoz_map_get__qoz_string__qoz_string(&tc->variant_of, name); switch (_qoz_ms_59->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_59->payload.Some.f0; return check_synth_variant_ctor(tc, name); break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; qoz_string _qoz_bv_62;
    {
        qoz_Strbuf _qoz_sb_641_28 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_641_28); strings_sb_append(&_qoz_sb_641_28, QOZ_STR_LIT("undefined name `")); strings_sb_append(&_qoz_sb_641_28, name); strings_sb_append(&_qoz_sb_641_28, QOZ_STR_LIT("`")); _qoz_bv_62 = strings_sb_finish(&_qoz_sb_641_28);
    }
    check_record_error(tc, span, _qoz_bv_62); qoz_gc_shadow_set_top(_qoz_shadow_guard); return ty_ty_error_();
}
...
qoz_Ty* check_synth_binary(qoz_TyContext* tc, qoz_Env* env, qoz_BinaryOp* op, qoz_Expr* l, qoz_Expr* r) {
    ...
    qoz_gc_push_root(&l);
    qoz_gc_push_root(&r);
    qoz_Ty* lt = check_synth(tc, env, l); qoz_gc_push_root(&lt); (void)(check_synth(tc, env, r)); qoz_BinaryOp* _qoz_ms_60 = op; qoz_Ty* _qoz_mv_60 = NULL; switch (_qoz_ms_60->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_60 = (ty_ty_bool_());  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_60 = (ty_ty_bool_());  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_60 = (ty_ty_bool_());  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_60 = (ty_ty_bool_());  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_60 = (ty_ty_bool_());  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_60 = (ty_ty_bool_());  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_60 = (ty_ty_bool_());  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_60 = (ty_ty_bool_());  break; } case qoz_BinaryOp_BOpAdd: { _qoz_mv_60 = (lt);  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_60 = (lt);  break; } case qoz_BinaryOp_BOpMul: { _qoz_mv_60 = (lt);  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_60 = (lt);  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_60 = (lt);  break; } case qoz_BinaryOp_BOpBitAnd: { _qoz_mv_60 = (lt);  break; } case qoz_BinaryOp_BOpBitOr: { _qoz_mv_60 = (lt);  break; } case qoz_BinaryOp_BOpBitXor: { _qoz_mv_60 = (lt);  break; } case qoz_BinaryOp_BOpShl: { _qoz_mv_60 = (lt);  break; } case qoz_BinaryOp_BOpShr: { _qoz_mv_60 = (lt);  break; } case qoz_BinaryOp_BOpRange: { _qoz_mv_60 = (lt);  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_60 = (lt);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_60;
}
...
qoz_Ty* check_synth_block(qoz_TyContext* tc, qoz_Env* env, qoz_Vec__qoz_Stmt stmts, qoz_Expr* tail) {
    ...
    { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_Stmt* _qoz_ms_61 = s; switch (_qoz_ms_61->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_61->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_61->payload.SLet.f2; qoz_Expr* val = _qoz_ms_61->payload.SLet.f3; {
        qoz_Ty* vt = check_synth(tc, env, val); qoz_gc_push_root(&vt); qoz_TypeExpr* _qoz_ms_62 = te; qoz_Ty* _qoz_mv_62 = NULL; switch (_qoz_ms_62->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_62 = (vt);  break; } default: { _qoz_mv_62 = (check_resolve_type(tc, te));  break; } } qoz_Ty* bound = _qoz_mv_62; qoz_gc_push_root(&bound); check_env_define(env, name, bound); 
    }
    0;  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_61->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_61->payload.SVar.f2; qoz_Expr* val = _qoz_ms_61->payload.SVar.f3; {
    ...
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* ex = _qoz_ms_61->payload.SExpr.f1; void* _qoz_bv_63;
    {
        (void)(check_synth(tc, env, ex)); _qoz_bv_63 = NULL;
    }
    _qoz_bv_63;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return check_synth(tc, env, tail);
}
...
void check_check_match_exhaustiveness(qoz_TyContext* tc, qoz_Expr* scrut, qoz_Ty* scrut_ty, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_string enum_name = check_enum_name_of_ty(scrut_ty); if (qoz_string_eq(enum_name, QOZ_STR_LIT(""))) { return;} qoz_Option__qoz_Decl* _qoz_ms_64 = qoz_map_get__qoz_string__qoz_Decl(&tc->enums, enum_name); switch (_qoz_ms_64->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_64->payload.Some.f0; qoz_Decl* _qoz_ms_65 = decl; switch (_qoz_ms_65->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_VariantDecl variants = _qoz_ms_65->payload.DEnum.f3; {
...
qoz_Span check_scrut_span(qoz_Expr* scrut) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&scrut);
    qoz_Expr* _qoz_ms_66 = scrut; qoz_Span _qoz_mv_66 = ((qoz_Span){0}); switch (_qoz_ms_66->tag) { case qoz_Expr_ENil: { qoz_Span sp = _qoz_ms_66->payload.ENil.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_66->payload.EInt.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_66->payload.EFloat.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_66->payload.EString.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_66->payload.EChar.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_66->payload.EBool.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_66->payload.EIdent.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_66->payload.EPath.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_66->payload.EReturn.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_66->payload.EDefer.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_66->payload.ESizeOf.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_66->payload.EArrayLit.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_66->payload.ETry.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_66->payload.ETuple.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_66->payload.EUnary.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_66->payload.EField.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_66->payload.EIndex.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_ECast: { qoz_Span sp = _qoz_ms_66->payload.ECast.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_66->payload.ERecord.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_66->payload.EBlock.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_66->payload.EWhile.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_66->payload.EMatch.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_66->payload.EBinary.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_66->payload.EAssign.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_66->payload.ECall.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_66->payload.EIf.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_66->payload.EClosure.f0; _qoz_mv_66 = (sp);  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_66->payload.EFor.f0; _qoz_mv_66 = (sp);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_66;
}

qoz_string check_enum_name_of_ty(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_67 = t; qoz_string _qoz_mv_67 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_67->tag) { case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_67->payload.TyAdt.f0; _qoz_mv_67 = (name);  break; } default: { _qoz_mv_67 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_67;
}

bool check_has_catch_all_with_variants(qoz_Vec__qoz_MatchArm arms, qoz_CoverSet* variants) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&variants);
    { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; if (!arm.has_guard) { qoz_Pattern* _qoz_ms_68 = arm.pat; switch (_qoz_ms_68->tag) { case qoz_Pattern_PatWild: { return true; break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_68->payload.PatBind.f1; if (!qoz_map_contains__qoz_string__bool(&variants->bound, name)) { return true;} 0;  break; } default: { NULL;  break; } } 0; } } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return false;
}

void check_collect_covered_variants(qoz_Vec__qoz_MatchArm arms, qoz_CoverSet* cs) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&cs);
    { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; if (!arm.has_guard) { qoz_Pattern* _qoz_ms_69 = arm.pat; switch (_qoz_ms_69->tag) { case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_69->payload.PatVariant.f1; if ((path.len) > 0) { qoz_string last = path.data[(path.len) - 1]; qoz_map_set__qoz_string__bool(&cs->bound, last, true); } 0;  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_69->payload.PatBind.f1; (qoz_map_set__qoz_string__bool(&cs->bound, name, true), 0);  break; } default: { NULL;  break; } } 0; } } }
    return;
}
...
void check_bind_pattern(qoz_TyContext* tc, qoz_Env* env, qoz_Pattern* pat, qoz_Ty* scrut) {
    ...
    qoz_gc_push_root(&scrut);
    qoz_Pattern* _qoz_ms_72 = pat; switch (_qoz_ms_72->tag) { case qoz_Pattern_PatWild: { NULL;  break; } case qoz_Pattern_PatLitInt: { NULL;  break; } case qoz_Pattern_PatLitString: { NULL;  break; } case qoz_Pattern_PatLitBool: { NULL;  break; } case qoz_Pattern_PatTuple: { NULL;  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_72->payload.PatBind.f1; check_env_define(env, name, scrut);  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_72->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_72->payload.PatVariant.f2; check_bind_variant_pattern(tc, env, path, sub_pats, scrut);  break; } } 0; 
    return;
}
...
void check_bind_variant_pattern(qoz_TyContext* tc, qoz_Env* env, qoz_Vec__qoz_string path, qoz_Vec__qoz_Pattern sub_pats, qoz_Ty* scrut) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&scrut);
    if ((path.len) < 1) { return;} qoz_string variant = path.data[(path.len) - 1]; qoz_Option__qoz_string* _qoz_ms_73 = qoz_map_get__qoz_string__qoz_string(&tc->variant_of, variant); switch (_qoz_ms_73->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_73->payload.Some.f0; qoz_Option__qoz_Decl* _qoz_ms_74 = qoz_map_get__qoz_string__qoz_Decl(&tc->enums, enum_name); switch (_qoz_ms_74->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_74->payload.Some.f0; qoz_Decl* _qoz_ms_75 = d; switch (_qoz_ms_75->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_75->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_75->payload.DEnum.f3; {
        qoz_Vec__qoz_Ty tyargs = qoz_vec_make__qoz_Ty(); qoz_Ty* _qoz_ms_76 = scrut; switch (_qoz_ms_76->tag) { case qoz_Ty_TyAdt: { qoz_Vec__qoz_Ty args = _qoz_ms_76->payload.TyAdt.f1; tyargs = args;  break; } default: { NULL;  break; } } 0; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_string_eq(v.name, variant)) { int64_t i = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pos_te = __col.data[__i]; (void)pos_te; if (i < (sub_pats.len)) { qoz_Ty* pos_ty = check_resolve_type_with_subst(tc, pos_te, tparams, tyargs); qoz_gc_push_root(&pos_ty); check_bind_pattern(tc, env, sub_pats.data[i], pos_ty); } i = i + 1; } }} } }
    }
...
qoz_Decl* check_infer_calls_decl(qoz_TyContext* tc, qoz_Decl* d) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_77 = d; qoz_Decl* _qoz_mv_77 = NULL; switch (_qoz_ms_77->tag) { case qoz_Decl_DFn: { qoz_Span sp = _qoz_ms_77->payload.DFn.f0; qoz_string name = _qoz_ms_77->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_77->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_77->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_77->payload.DFn.f4; qoz_Expr* body = _qoz_ms_77->payload.DFn.f5; qoz_string attr = _qoz_ms_77->payload.DFn.f6; qoz_Decl* _qoz_bv_64;
    {
        check_set_type_params(tc, tparams); qoz_Env env = check_env_make(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; check_env_define(&env, pp.name, check_resolve_type(tc, pp.ty)); } }qoz_Ty* ret_ty = check_resolve_type(tc, ret); qoz_gc_push_root(&ret_ty); qoz_Expr* new_body = check_infer_calls_expr(tc, &env, body, ret_ty); qoz_gc_push_root(&new_body); check_clear_type_params(tc); _qoz_bv_64 = qoz_make_Decl_DFn(sp, name, tparams, params, ret, new_body, attr);
    }
    _qoz_mv_77 = (_qoz_bv_64);  break; } case qoz_Decl_DConst: { qoz_Span sp = _qoz_ms_77->payload.DConst.f0; qoz_string name = _qoz_ms_77->payload.DConst.f1; qoz_TypeExpr* t = _qoz_ms_77->payload.DConst.f2; qoz_Expr* val = _qoz_ms_77->payload.DConst.f3; qoz_Decl* _qoz_bv_65;
    {
        qoz_Env env = check_env_make(); qoz_Ty* expected = check_resolve_type(tc, t); qoz_gc_push_root(&expected); qoz_Expr* new_val = check_infer_calls_expr(tc, &env, val, expected); qoz_gc_push_root(&new_val); _qoz_bv_65 = qoz_make_Decl_DConst(sp, name, t, new_val);
    }
    _qoz_mv_77 = (_qoz_bv_65);  break; } default: { _qoz_mv_77 = (d);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_77;
}
...
qoz_Expr* check_infer_calls_expr(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* e, qoz_Ty* expected) {
    ...
    qoz_Expr* _qoz_ms_78 = e; qoz_Expr* _qoz_mv_78 = NULL; switch (_qoz_ms_78->tag) { case qoz_Expr_EInt: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EFloat: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EString: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EChar: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EBool: { _qoz_mv_78 = (e);  break; } case qoz_Expr_ENil: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EIdent: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EPath: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_78->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_78->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_78->payload.EUnary.f2; _qoz_mv_78 = (qoz_make_Expr_EUnary(sp, op, check_infer_calls_expr(tc, env, rhs, ty_ty_error_())));  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_78->payload.EBinary.f0; qoz_BinaryOp* op = _qoz_ms_78->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_78->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_78->payload.EBinary.f3; _qoz_mv_78 = (qoz_make_Expr_EBinary(sp, op, check_infer_calls_expr(tc, env, l, ty_ty_error_()), check_infer_calls_expr(tc, env, r, ty_ty_error_())));  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_78->payload.EAssign.f0; qoz_AssignOp* op = _qoz_ms_78->payload.EAssign.f1; qoz_Expr* l = _qoz_ms_78->payload.EAssign.f2; qoz_Expr* r = _qoz_ms_78->payload.EAssign.f3; qoz_Expr* _qoz_bv_66;
    {
        qoz_Expr* new_l = check_infer_calls_expr(tc, env, l, ty_ty_error_()); qoz_gc_push_root(&new_l); qoz_Ty* lhs_ty = check_synth(tc, env, l); qoz_gc_push_root(&lhs_ty); _qoz_bv_66 = qoz_make_Expr_EAssign(sp, op, new_l, check_infer_calls_expr(tc, env, r, lhs_ty));
    }
    _qoz_mv_78 = (_qoz_bv_66);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_78->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_78->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_78->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_78->payload.ECall.f3; _qoz_mv_78 = (check_rewrite_call(tc, env, sp, callee, ta, args, expected));  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_78->payload.EField.f0; qoz_Expr* base = _qoz_ms_78->payload.EField.f1; qoz_string name = _qoz_ms_78->payload.EField.f2; _qoz_mv_78 = (qoz_make_Expr_EField(sp, check_infer_calls_expr(tc, env, base, ty_ty_error_()), name));  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_78->payload.EIndex.f0; qoz_Expr* base = _qoz_ms_78->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_78->payload.EIndex.f2; _qoz_mv_78 = (qoz_make_Expr_EIndex(sp, check_infer_calls_expr(tc, env, base, ty_ty_error_()), check_infer_calls_expr(tc, env, idx, ty_ty_error_())));  break; } case qoz_Expr_ECast: { qoz_Span sp = _qoz_ms_78->payload.ECast.f0; qoz_Expr* value = _qoz_ms_78->payload.ECast.f1; qoz_TypeExpr* t = _qoz_ms_78->payload.ECast.f2; _qoz_mv_78 = (qoz_make_Expr_ECast(sp, check_infer_calls_expr(tc, env, value, ty_ty_error_()), t));  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_78->payload.ETry.f0; qoz_Expr* v = _qoz_ms_78->payload.ETry.f1; _qoz_mv_78 = (qoz_make_Expr_ETry(sp, check_infer_calls_expr(tc, env, v, expected)));  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_78->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_78->payload.ETuple.f1; qoz_Expr* _qoz_bv_67;
    {
        qoz_Vec__qoz_Expr ne = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&ne, check_infer_calls_expr(tc, env, el, ty_ty_error_())); } }_qoz_bv_67 = qoz_make_Expr_ETuple(sp, ne);
    }
    _qoz_mv_78 = (_qoz_bv_67);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_78->payload.ERecord.f0; qoz_TypeExpr* te = _qoz_ms_78->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_78->payload.ERecord.f2; qoz_Expr* _qoz_bv_68;
    {
        qoz_TypeExpr* effective_te = check_pick_record_type(te, expected); qoz_gc_push_root(&effective_te); qoz_Vec__qoz_RecordFieldLit nf = qoz_vec_make__qoz_RecordFieldLit(); { qoz_Vec__qoz_RecordFieldLit __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; qoz_Ty* field_hint = check_record_field_hint(tc, effective_te, f.name); qoz_gc_push_root(&field_hint); qoz_vec_push__qoz_RecordFieldLit(&nf, ((qoz_RecordFieldLit){ .name = f.name, .value = check_infer_calls_expr(tc, env, f.value, field_hint) })); } }_qoz_bv_68 = qoz_make_Expr_ERecord(sp, te, nf);
    }
    _qoz_mv_78 = (_qoz_bv_68);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_78->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_78->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_78->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_78->payload.EClosure.f3; _qoz_mv_78 = (qoz_make_Expr_EClosure(sp, cps, ret, check_infer_calls_expr(tc, env, body, ty_ty_error_())));  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_78->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_78->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_78->payload.EBlock.f2; qoz_Expr* _qoz_bv_69;
    {
        qoz_Vec__qoz_Stmt ns = qoz_vec_make__qoz_Stmt(); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_vec_push__qoz_Stmt(&ns, check_infer_calls_stmt(tc, env, s)); } }_qoz_bv_69 = qoz_make_Expr_EBlock(sp, ns, check_infer_calls_expr(tc, env, tail, expected));
    }
    _qoz_mv_78 = (_qoz_bv_69);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_78->payload.EIf.f0; qoz_Expr* c = _qoz_ms_78->payload.EIf.f1; qoz_Expr* t = _qoz_ms_78->payload.EIf.f2; qoz_Expr* f = _qoz_ms_78->payload.EIf.f3; _qoz_mv_78 = (qoz_make_Expr_EIf(sp, check_infer_calls_expr(tc, env, c, ty_ty_error_()), check_infer_calls_expr(tc, env, t, expected), check_infer_calls_expr(tc, env, f, expected)));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_78->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_78->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_78->payload.EMatch.f2; qoz_Expr* _qoz_bv_70;
    {
        qoz_Expr* new_scrut = check_infer_calls_expr(tc, env, scrut, ty_ty_error_()); qoz_gc_push_root(&new_scrut); qoz_Ty* scrut_ty = check_synth(tc, env, scrut); qoz_gc_push_root(&scrut_ty); qoz_Vec__qoz_MatchArm na = qoz_vec_make__qoz_MatchArm(); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm a = __col.data[__i]; (void)a; int64_t saved_len = (env->bindings.len); check_bind_pattern(tc, env, a.pat, scrut_ty); qoz_vec_push__qoz_MatchArm(&na, ((qoz_MatchArm){ .pat = a.pat, .body = check_infer_calls_expr(tc, env, a.body, expected), .has_guard = a.has_guard, .guard = a.guard })); check_env_truncate(env, saved_len); } }_qoz_bv_70 = qoz_make_Expr_EMatch(sp, new_scrut, na);
    }
    _qoz_mv_78 = (_qoz_bv_70);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_78->payload.EWhile.f0; qoz_Expr* c = _qoz_ms_78->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_78->payload.EWhile.f2; _qoz_mv_78 = (qoz_make_Expr_EWhile(sp, check_infer_calls_expr(tc, env, c, ty_ty_error_()), check_infer_calls_expr(tc, env, b, ty_ty_error_())));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_78->payload.EFor.f0; qoz_string b1 = _qoz_ms_78->payload.EFor.f1; qoz_string b2 = _qoz_ms_78->payload.EFor.f2; qoz_Expr* it = _qoz_ms_78->payload.EFor.f3; qoz_Expr* body = _qoz_ms_78->payload.EFor.f4; qoz_Expr* _qoz_bv_71;
    {
        qoz_Expr* new_it = check_infer_calls_expr(tc, env, it, ty_ty_error_()); qoz_gc_push_root(&new_it); qoz_Ty* it_ty = check_synth(tc, env, it); qoz_gc_push_root(&it_ty); int64_t saved_len = (env->bindings.len); check_bind_for_loop(env, b1, b2, it_ty); qoz_Expr* new_body = check_infer_calls_expr(tc, env, body, ty_ty_error_()); qoz_gc_push_root(&new_body); check_env_truncate(env, saved_len); _qoz_bv_71 = qoz_make_Expr_EFor(sp, b1, b2, new_it, new_body);
    }
    _qoz_mv_78 = (_qoz_bv_71);  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_78->payload.EReturn.f0; qoz_Expr* v = _qoz_ms_78->payload.EReturn.f1; _qoz_mv_78 = (qoz_make_Expr_EReturn(sp, check_infer_calls_expr(tc, env, v, expected)));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_78->payload.EDefer.f0; qoz_Expr* v = _qoz_ms_78->payload.EDefer.f1; _qoz_mv_78 = (qoz_make_Expr_EDefer(sp, check_infer_calls_expr(tc, env, v, ty_ty_error_())));  break; } case qoz_Expr_ESizeOf: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_78->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_78->payload.EArrayLit.f1; qoz_Expr* _qoz_bv_72;
    {
        qoz_Vec__qoz_Expr ne = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&ne, check_infer_calls_expr(tc, env, el, ty_ty_error_())); } }_qoz_bv_72 = qoz_make_Expr_EArrayLit(sp, ne);
    }
    _qoz_mv_78 = (_qoz_bv_72);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_78;
}
...
qoz_Stmt* check_infer_calls_stmt(qoz_TyContext* tc, qoz_Env* env, qoz_Stmt* s) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_79 = s; qoz_Stmt* _qoz_mv_79 = NULL; switch (_qoz_ms_79->tag) { case qoz_Stmt_SLet: { qoz_Span sp = _qoz_ms_79->payload.SLet.f0; qoz_string name = _qoz_ms_79->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_79->payload.SLet.f2; qoz_Expr* val = _qoz_ms_79->payload.SLet.f3; qoz_Stmt* _qoz_bv_73;
    {
        qoz_Ty* annotated = check_resolve_type(tc, te); qoz_gc_push_root(&annotated); qoz_Expr* new_val = check_infer_calls_expr(tc, env, val, annotated); qoz_gc_push_root(&new_val); qoz_Ty* binding_ty = ((check_is_ty_unit_or_error(annotated)) ? check_synth(tc, env, new_val) : annotated); qoz_gc_push_root(&binding_ty); check_env_define(env, name, binding_ty); _qoz_bv_73 = qoz_make_Stmt_SLet(sp, name, te, new_val);
    }
    _qoz_mv_79 = (_qoz_bv_73);  break; } case qoz_Stmt_SVar: { qoz_Span sp = _qoz_ms_79->payload.SVar.f0; qoz_string name = _qoz_ms_79->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_79->payload.SVar.f2; qoz_Expr* val = _qoz_ms_79->payload.SVar.f3; qoz_Stmt* _qoz_bv_74;
    {
        qoz_Ty* annotated = check_resolve_type(tc, te); qoz_gc_push_root(&annotated); qoz_Expr* new_val = check_infer_calls_expr(tc, env, val, annotated); qoz_gc_push_root(&new_val); qoz_Ty* binding_ty = ((check_is_ty_unit_or_error(annotated)) ? check_synth(tc, env, new_val) : annotated); qoz_gc_push_root(&binding_ty); check_env_define(env, name, binding_ty); _qoz_bv_74 = qoz_make_Stmt_SVar(sp, name, te, new_val);
    }
    _qoz_mv_79 = (_qoz_bv_74);  break; } case qoz_Stmt_SExpr: { qoz_Span sp = _qoz_ms_79->payload.SExpr.f0; qoz_Expr* x = _qoz_ms_79->payload.SExpr.f1; _qoz_mv_79 = (qoz_make_Stmt_SExpr(sp, check_infer_calls_expr(tc, env, x, ty_ty_error_())));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_79;
}
...
qoz_TypeExpr* check_pick_record_type(qoz_TypeExpr* te, qoz_Ty* expected) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&expected);
    qoz_TypeExpr* _qoz_ms_80 = te; qoz_TypeExpr* _qoz_mv_80 = NULL; switch (_qoz_ms_80->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_80->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_80->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_80->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_75;
    {
        if ((args.len) > 0) { return te;} if ((path.len) != 1) { return te;} qoz_Ty* _qoz_ms_81 = expected; qoz_TypeExpr* _qoz_mv_81 = NULL; switch (_qoz_ms_81->tag) { case qoz_Ty_TyRecord: { qoz_string en = _qoz_ms_81->payload.TyRecord.f0; qoz_Vec__qoz_Ty eargs = _qoz_ms_81->payload.TyRecord.f1; qoz_TypeExpr* _qoz_bv_76;
    {
        if (qoz_string_eq(path.data[0], en) && ((eargs.len) > 0)) { qoz_Vec__qoz_TypeExpr ta = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = eargs; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_TypeExpr(&ta, ty_ty_to_type_expr_at(a, sp)); } }return qoz_make_TypeExpr_TENamed(sp, path, ta);} _qoz_bv_76 = te;
    }
    _qoz_mv_81 = (_qoz_bv_76);  break; } default: { _qoz_mv_81 = (te);  break; } } _qoz_bv_75 = _qoz_mv_81;
    }
    _qoz_mv_80 = (_qoz_bv_75);  break; } default: { _qoz_mv_80 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_80;
}
...
qoz_Ty* check_record_field_hint(qoz_TyContext* tc, qoz_TypeExpr* te, qoz_string field_name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_82 = te; qoz_Ty* _qoz_mv_82 = NULL; switch (_qoz_ms_82->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_82->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_82->payload.TENamed.f2; qoz_Ty* _qoz_bv_77;
    {
        if ((path.len) < 1) { return ty_ty_error_();} qoz_string name = path.data[(path.len) - 1]; qoz_Option__qoz_Decl* _qoz_ms_83 = qoz_map_get__qoz_string__qoz_Decl(&tc->structs, name); qoz_Ty* _qoz_mv_83 = NULL; switch (_qoz_ms_83->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_83 = (ty_ty_error_());  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_83->payload.Some.f0; qoz_Decl* _qoz_ms_84 = d; qoz_Ty* _qoz_mv_84 = NULL; switch (_qoz_ms_84->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_84->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_84->payload.DStruct.f3; qoz_Ty* _qoz_bv_78;
    {
        qoz_Map__qoz_string__bool saved = tc->type_params; check_set_type_params(tc, params); qoz_Vec__qoz_Ty arg_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_TypeExpr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_Ty(&arg_tys, check_resolve_type(tc, a)); } }qoz_Ty* result = ty_ty_error_(); qoz_gc_push_root(&result); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_string_eq(f.name, field_name)) { qoz_Ty* raw = check_resolve_type(tc, f.ty); qoz_gc_push_root(&raw); result = ((((arg_tys.len) == (params.len)) && ((params.len) > 0)) ? check_apply_subst(raw, params, arg_tys) : raw); } } }tc->type_params = saved; _qoz_bv_78 = result;
    }
    _qoz_mv_84 = (_qoz_bv_78);  break; } default: { _qoz_mv_84 = (ty_ty_error_());  break; } } _qoz_mv_83 = (_qoz_mv_84);  break; } } _qoz_bv_77 = _qoz_mv_83;
    }
    _qoz_mv_82 = (_qoz_bv_77);  break; } default: { _qoz_mv_82 = (ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_82;
}
...
void check_collect_arg_hints(qoz_TyContext* tc, qoz_Expr* callee, int64_t n, qoz_Vec__qoz_Ty* out) {
    ...
    qoz_string name = check_resolve_callee_fn(tc, callee); if (!qoz_string_eq(name, QOZ_STR_LIT(""))) { qoz_Option__qoz_Decl* _qoz_ms_85 = qoz_map_get__qoz_string__qoz_Decl(&tc->fns, name); switch (_qoz_ms_85->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_85->payload.Some.f0; {
        check_fill_fn_param_hints(tc, d, out); return;
    }
    0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; qoz_Option__qoz_Decl* _qoz_ms_86 = qoz_map_get__qoz_string__qoz_Decl(&tc->externs, name); switch (_qoz_ms_86->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_86->payload.Some.f0; {
        check_fill_fn_param_hints(tc, d, out); return;
    }
    0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } qoz_Expr* _qoz_ms_87 = callee; switch (_qoz_ms_87->tag) { case qoz_Expr_EIdent: { qoz_string vname = _qoz_ms_87->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_88 = qoz_map_get__qoz_string__qoz_string(&tc->variant_of, vname); switch (_qoz_ms_88->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_88->payload.Some.f0; qoz_Option__qoz_Decl* _qoz_ms_89 = qoz_map_get__qoz_string__qoz_Decl(&tc->enums, enum_name); switch (_qoz_ms_89->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_89->payload.Some.f0; qoz_Decl* _qoz_ms_90 = d; switch (_qoz_ms_90->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_90->payload.DEnum.f2; if ((tparams.len) == 0) { check_fill_variant_pos_hints(tc, d, vname, out); } 0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
void check_fill_fn_param_hints(qoz_TyContext* tc, qoz_Decl* d, qoz_Vec__qoz_Ty* out) {
    ...
    qoz_gc_push_root(&d);
    qoz_gc_push_root(&out);
    qoz_Decl* _qoz_ms_91 = d; switch (_qoz_ms_91->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_91->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_91->payload.DFn.f3; {
    ...
    0;  break; } case qoz_Decl_DExternal: { qoz_Vec__qoz_FnParam params = _qoz_ms_91->payload.DExternal.f3; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_vec_push__qoz_Ty(out, check_resolve_type(tc, pp.ty)); } }0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
void check_fill_variant_pos_hints(qoz_TyContext* tc, qoz_Decl* d, qoz_string variant_name, qoz_Vec__qoz_Ty* out) {
    ...
    qoz_gc_push_root(&d);
    qoz_gc_push_root(&out);
    qoz_Decl* _qoz_ms_92 = d; switch (_qoz_ms_92->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_92->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_92->payload.DEnum.f3; {
...
bool check_is_ty_unit_or_error(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_93 = t; bool _qoz_mv_93 = false; switch (_qoz_ms_93->tag) { case qoz_Ty_TyUnit: { _qoz_mv_93 = (true);  break; } case qoz_Ty_TyError: { _qoz_mv_93 = (true);  break; } default: { _qoz_mv_93 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_93;
}
...
qoz_Expr* check_rewrite_call(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_Ty* expected) {
    ...
    qoz_gc_push_root(&callee);
    qoz_gc_push_root(&expected);
    if (check_is_strings_callee(callee, QOZ_STR_LIT("sb_append")) && ((args.len) == 2)) { qoz_Ty* val_ty = check_synth(tc, env, args.data[1]); qoz_gc_push_root(&val_ty); qoz_string method = check_sb_append_method_for(val_ty); if (!qoz_string_eq(method, QOZ_STR_LIT("sb_append"))) { qoz_Expr* new_callee2 = qoz_make_Expr_EField(sp, qoz_make_Expr_EIdent(sp, QOZ_STR_LIT("strings")), method); qoz_gc_push_root(&new_callee2); qoz_Vec__qoz_Expr new_args = qoz_vec_make__qoz_Expr(); qoz_vec_push__qoz_Expr(&new_args, check_infer_calls_expr(tc, env, args.data[0], ty_ty_error_())); qoz_vec_push__qoz_Expr(&new_args, check_infer_calls_expr(tc, env, args.data[1], val_ty)); return qoz_make_Expr_ECall(sp, new_callee2, type_args, new_args);} } qoz_Expr* new_callee = check_infer_calls_expr(tc, env, callee, ty_ty_error_()); qoz_gc_push_root(&new_callee); qoz_Vec__qoz_Expr new_args = qoz_vec_make__qoz_Expr(); qoz_Vec__qoz_Ty arg_hints = qoz_vec_make__qoz_Ty(); check_collect_arg_hints(tc, callee, (args.len), &arg_hints); int64_t ai = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; qoz_Ty* hint = ((ai < (arg_hints.len)) ? arg_hints.data[ai] : ty_ty_error_()); qoz_gc_push_root(&hint); qoz_vec_push__qoz_Expr(&new_args, check_infer_calls_expr(tc, env, a, hint)); ai = ai + 1; } }if ((type_args.len) > 0) { return qoz_make_Expr_ECall(sp, new_callee, type_args, new_args);} qoz_string fn_name = check_resolve_callee_fn(tc, callee); if (qoz_string_eq(fn_name, QOZ_STR_LIT(""))) { return qoz_make_Expr_ECall(sp, new_callee, type_args, new_args);} qoz_Option__qoz_Decl* _qoz_ms_94 = qoz_map_get__qoz_string__qoz_Decl(&tc->fns, fn_name); qoz_Expr* _qoz_mv_94 = NULL; switch (_qoz_ms_94->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_94->payload.Some.f0; qoz_Decl* _qoz_ms_95 = d; qoz_Expr* _qoz_mv_95 = NULL; switch (_qoz_ms_95->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_95->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_95->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_95->payload.DFn.f4; qoz_Expr* _qoz_bv_79;
    {
        if ((tparams.len) == 0) { return qoz_make_Expr_ECall(sp, new_callee, type_args, new_args);} qoz_Vec__qoz_Ty arg_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_Ty(&arg_tys, check_synth(tc, env, a)); } }qoz_Map__qoz_string__bool saved_c = tc->type_params; check_set_type_params(tc, tparams); qoz_Vec__qoz_Ty param_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_vec_push__qoz_Ty(&param_tys, check_resolve_type(tc, pp.ty)); } }qoz_Ty* ret_pattern = check_resolve_type(tc, ret); qoz_gc_push_root(&ret_pattern); tc->type_params = saved_c; qoz_Map__qoz_string__qoz_Ty subst_env = qoz_map_make__qoz_string__qoz_Ty(); int64_t i = 0; bool ok = true; while ((i < (arg_tys.len)) && (i < (param_tys.len))) { if (!check_unify(param_tys.data[i], arg_tys.data[i], &subst_env)) { ok = false; } i = i + 1; } if (!check_is_ty_error(expected)) { (void)(check_unify(ret_pattern, expected, &subst_env)); } if (!ok) { qoz_string _qoz_bv_80;
    {
        qoz_Strbuf _qoz_sb_1214_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1214_38); strings_sb_append(&_qoz_sb_1214_38, QOZ_STR_LIT("could not unify argument types with generic parameters of `")); strings_sb_append(&_qoz_sb_1214_38, fn_name); strings_sb_append(&_qoz_sb_1214_38, QOZ_STR_LIT("`")); _qoz_bv_80 = strings_sb_finish(&_qoz_sb_1214_38);
    }
    check_record_error(tc, sp, _qoz_bv_80); return qoz_make_Expr_ECall(sp, new_callee, type_args, new_args);} qoz_Vec__qoz_TypeExpr inferred = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_string __col = tparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string tp = __col.data[__i]; (void)tp; qoz_Option__qoz_Ty* _qoz_ms_96 = qoz_map_get__qoz_string__qoz_Ty(&subst_env, tp); switch (_qoz_ms_96->tag) { case qoz_Option__qoz_Ty_Some: { qoz_Ty* t = _qoz_ms_96->payload.Some.f0; qoz_vec_push__qoz_TypeExpr(&inferred, ty_ty_to_type_expr_at(t, sp));  break; } case qoz_Option__qoz_Ty_None: { {
        qoz_string _qoz_bv_81;
    {
        qoz_Strbuf _qoz_sb_1222_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1222_42); strings_sb_append(&_qoz_sb_1222_42, QOZ_STR_LIT("type parameter `")); strings_sb_append(&_qoz_sb_1222_42, tp); strings_sb_append(&_qoz_sb_1222_42, QOZ_STR_LIT("` of `")); strings_sb_append(&_qoz_sb_1222_42, fn_name); strings_sb_append(&_qoz_sb_1222_42, QOZ_STR_LIT("` is not constrained; add an explicit annotation")); _qoz_bv_81 = strings_sb_finish(&_qoz_sb_1222_42);
    }
    check_record_error(tc, sp, _qoz_bv_81); qoz_vec_push__qoz_TypeExpr(&inferred, ty_ty_to_type_expr_at(ty_ty_error_(), sp)); 
    }
    0;  break; } } 0; } }_qoz_bv_79 = qoz_make_Expr_ECall(sp, new_callee, inferred, new_args);
    }
    _qoz_mv_95 = (_qoz_bv_79);  break; } default: { _qoz_mv_95 = (qoz_make_Expr_ECall(sp, new_callee, type_args, new_args));  break; } } _qoz_mv_94 = (_qoz_mv_95);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_94 = (qoz_make_Expr_ECall(sp, new_callee, type_args, new_args));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_94;
}

void check_check_fn_bodies(qoz_TyContext* tc, qoz_File f) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_97 = d; switch (_qoz_ms_97->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_97->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_97->payload.DFn.f3; qoz_Expr* body = _qoz_ms_97->payload.DFn.f5; {
    ...
    0;  break; } case qoz_Decl_DImport: { NULL;  break; } case qoz_Decl_DStruct: { NULL;  break; } case qoz_Decl_DEnum: { NULL;  break; } case qoz_Decl_DTypeAlias: { NULL;  break; } case qoz_Decl_DConst: { qoz_Expr* val = _qoz_ms_97->payload.DConst.f3; void* _qoz_bv_82;
    {
        qoz_Env env = check_env_make(); (void)(check_synth(tc, &env, val)); _qoz_bv_82 = NULL;
    }
    _qoz_bv_82;  break; } case qoz_Decl_DExternal: { NULL;  break; } case qoz_Decl_DLink: { NULL;  break; } } 0; } }
    return;
}
...
void check_validate_signatures(qoz_TyContext* tc, qoz_File f) {
    ...
    0;  break; } case qoz_Decl_DExternal: { qoz_Vec__qoz_FnParam params = _qoz_ms_98->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_98->payload.DExternal.f4; void* _qoz_bv_83;
    {
        { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; (void)(check_resolve_type(tc, pp.ty)); } }(void)(check_resolve_type(tc, ret)); _qoz_bv_83 = NULL;
    }
    _qoz_bv_83;  break; } case qoz_Decl_DStruct: { qoz_Vec__qoz_string tparams = _qoz_ms_98->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_98->payload.DStruct.f3; {
    ...
    0;  break; } case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_98->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_98->payload.DEnum.f3; {
    ...
    0;  break; } case qoz_Decl_DTypeAlias: { qoz_Vec__qoz_string tparams = _qoz_ms_98->payload.DTypeAlias.f2; qoz_TypeExpr* target = _qoz_ms_98->payload.DTypeAlias.f3; {
        check_set_type_params(tc, tparams); (void)(check_resolve_type(tc, target)); check_clear_type_params(tc); 
    }
    0;  break; } case qoz_Decl_DConst: { qoz_TypeExpr* ty = _qoz_ms_98->payload.DConst.f2; void* _qoz_bv_84;
    {
        (void)(check_resolve_type(tc, ty)); _qoz_bv_84 = NULL;
    }
    _qoz_bv_84;  break; } case qoz_Decl_DImport: { NULL;  break; } case qoz_Decl_DLink: { NULL;  break; } } 0; } }
    return;
}
...
void emit_register_generics(qoz_Emitter* e, qoz_File file) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    { qoz_Vec__qoz_Decl __col = file.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_99 = d; switch (_qoz_ms_99->tag) { case qoz_Decl_DStruct: { qoz_string name = _qoz_ms_99->payload.DStruct.f1; qoz_Vec__qoz_string params = _qoz_ms_99->payload.DStruct.f2; if ((params.len) > 0) { qoz_map_set__qoz_string__qoz_Decl(&e->generic_decls, name, d); } 0;  break; } case qoz_Decl_DEnum: { qoz_string name = _qoz_ms_99->payload.DEnum.f1; qoz_Vec__qoz_string params = _qoz_ms_99->payload.DEnum.f2; if ((params.len) > 0) { qoz_map_set__qoz_string__qoz_Decl(&e->generic_decls, name, d); } 0;  break; } case qoz_Decl_DFn: { qoz_string name = _qoz_ms_99->payload.DFn.f1; qoz_Vec__qoz_string params = _qoz_ms_99->payload.DFn.f2; if ((params.len) > 0) { qoz_map_set__qoz_string__qoz_Decl(&e->generic_fn_decls, name, d); } 0;  break; } default: { NULL;  break; } } 0; } }
    return;
}
...
qoz_string emit_generic_callee_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_100 = callee; qoz_string _qoz_mv_100 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_100->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_100->payload.EIdent.f1; _qoz_mv_100 = (name);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_100->payload.EField.f1; qoz_string method = _qoz_ms_100->payload.EField.f2; qoz_Expr* _qoz_ms_101 = base; qoz_string _qoz_mv_101 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_101->tag) { case qoz_Expr_EIdent: { qoz_string pkg = _qoz_ms_101->payload.EIdent.f1; qoz_string _qoz_bv_85;
    {
        if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_string_cat(qoz_string_cat(pkg, QOZ_STR_LIT("_")), method);} _qoz_bv_85 = QOZ_STR_LIT("");
    }
    _qoz_mv_101 = (_qoz_bv_85);  break; } default: { _qoz_mv_101 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_100 = (_qoz_mv_101);  break; } default: { _qoz_mv_100 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_100;
}

void emit_collect_type_instantiations(qoz_Emitter* e, qoz_File file) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    { qoz_Vec__qoz_Decl __col = file.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; emit_walk_decl_for_types(e, d); } }bool stable = false; int64_t iters = 0; while (!stable) { if (iters > 32) { stable = true; } iters = iters + 1; int64_t before_r = (e->record_insts.len); int64_t before_e = (e->enum_insts.len); int64_t before_f = (e->fn_insts.len); int64_t i = 0; while (i < (e->record_insts.len)) { qoz_Instantiation inst = e->record_insts.data[i]; qoz_Option__qoz_Decl* _qoz_ms_102 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, inst.name); switch (_qoz_ms_102->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_102->payload.Some.f0; emit_walk_struct_fields_with_subst(e, decl, inst.args);  break; } default: { NULL;  break; } } 0; i = i + 1; } int64_t j = 0; while (j < (e->enum_insts.len)) { qoz_Instantiation inst = e->enum_insts.data[j]; qoz_Option__qoz_Decl* _qoz_ms_103 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, inst.name); switch (_qoz_ms_103->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_103->payload.Some.f0; emit_walk_enum_variants_with_subst(e, decl, inst.args);  break; } default: { NULL;  break; } } 0; j = j + 1; } int64_t k = 0; while (k < (e->fn_insts.len)) { qoz_Instantiation inst = e->fn_insts.data[k]; qoz_Option__qoz_Decl* _qoz_ms_104 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_fn_decls, inst.name); switch (_qoz_ms_104->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_104->payload.Some.f0; emit_walk_fn_body_with_subst(e, decl, inst.args);  break; } default: { NULL;  break; } } 0; k = k + 1; } if ((((e->record_insts.len) == before_r) && ((e->enum_insts.len) == before_e)) && ((e->fn_insts.len) == before_f)) { stable = true; } } 
    return;
}
...
void emit_walk_fn_body_with_subst(qoz_Emitter* e, qoz_Decl* d, qoz_Vec__qoz_TypeExpr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_105 = d; switch (_qoz_ms_105->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string params = _qoz_ms_105->payload.DFn.f2; qoz_Vec__qoz_FnParam fn_params = _qoz_ms_105->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_105->payload.DFn.f4; qoz_Expr* body = _qoz_ms_105->payload.DFn.f5; {
...
void emit_walk_struct_fields_with_subst(qoz_Emitter* e, qoz_Decl* d, qoz_Vec__qoz_TypeExpr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_106 = d; switch (_qoz_ms_106->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_106->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_106->payload.DStruct.f3; { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; qoz_TypeExpr* substituted = emit_substitute_type(e, f.ty, params, args); qoz_gc_push_root(&substituted); emit_walk_typeexpr(e, substituted); } }0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
void emit_walk_decl_for_types(qoz_Emitter* e, qoz_Decl* d) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_108 = d; switch (_qoz_ms_108->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_108->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_108->payload.DStruct.f3; if ((params.len) == 0) { { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; emit_walk_typeexpr(e, f.ty); } }} 0;  break; } case qoz_Decl_DEnum: { qoz_Vec__qoz_string params = _qoz_ms_108->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_108->payload.DEnum.f3; if ((params.len) == 0) { { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pt = __col.data[__i]; (void)pt; emit_walk_typeexpr(e, pt); } }{ qoz_Vec__qoz_StructField __col = v.named; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField nf = __col.data[__i]; (void)nf; emit_walk_typeexpr(e, nf.ty); } }} }} 0;  break; } case qoz_Decl_DFn: { qoz_Vec__qoz_string params = _qoz_ms_108->payload.DFn.f2; qoz_Vec__qoz_FnParam fn_params = _qoz_ms_108->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_108->payload.DFn.f4; qoz_Expr* body = _qoz_ms_108->payload.DFn.f5; if ((params.len) == 0) { { qoz_Vec__qoz_FnParam __col = fn_params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; emit_walk_typeexpr(e, fp.ty); } }emit_walk_typeexpr(e, ret); e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_FnParam __col = fn_params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, fp.name, fp.ty); } }emit_walk_expr_for_types(e, body); } 0;  break; } case qoz_Decl_DExternal: { qoz_Vec__qoz_FnParam fn_params = _qoz_ms_108->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_108->payload.DExternal.f4; {
    ...
    0;  break; } case qoz_Decl_DConst: { qoz_TypeExpr* ty = _qoz_ms_108->payload.DConst.f2; qoz_Expr* value = _qoz_ms_108->payload.DConst.f3; {
...
void emit_walk_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_109 = te; switch (_qoz_ms_109->tag) { case qoz_TypeExpr_TEUnit: { NULL;  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_109->payload.TEPtr.f1; emit_walk_typeexpr(e, inner);  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_109->payload.TETuple.f1; { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; emit_walk_typeexpr(e, el); } }0;  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_109->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_109->payload.TENamed.f2; {
    ...
    0;  break; } case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr params = _qoz_ms_109->payload.TEFn.f1; qoz_TypeExpr* ret = _qoz_ms_109->payload.TEFn.f2; {
...
qoz_Option__qoz_TypeExpr* emit_literal_typeexpr(qoz_Expr* ex) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_110 = ex; qoz_Option__qoz_TypeExpr* _qoz_mv_110 = NULL; switch (_qoz_ms_110->tag) { case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_110->payload.EInt.f0; _qoz_mv_110 = (qoz_make_Option__qoz_TypeExpr_Some(emit_single_named_te(sp, QOZ_STR_LIT("i64"))));  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_110->payload.EFloat.f0; _qoz_mv_110 = (qoz_make_Option__qoz_TypeExpr_Some(emit_single_named_te(sp, QOZ_STR_LIT("f64"))));  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_110->payload.EString.f0; _qoz_mv_110 = (qoz_make_Option__qoz_TypeExpr_Some(emit_single_named_te(sp, QOZ_STR_LIT("string"))));  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_110->payload.EBool.f0; _qoz_mv_110 = (qoz_make_Option__qoz_TypeExpr_Some(emit_single_named_te(sp, QOZ_STR_LIT("bool"))));  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_110->payload.EChar.f0; _qoz_mv_110 = (qoz_make_Option__qoz_TypeExpr_Some(emit_single_named_te(sp, QOZ_STR_LIT("char"))));  break; } case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_110->payload.ECast.f2; _qoz_mv_110 = (qoz_make_Option__qoz_TypeExpr_Some(t));  break; } default: { _qoz_mv_110 = (qoz_make_Option__qoz_TypeExpr_None());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_110;
}
...
void emit_walk_expr_for_types(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_111 = ex; switch (_qoz_ms_111->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_111->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_111->payload.EBlock.f2; {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_Stmt* _qoz_ms_112 = s; switch (_qoz_ms_112->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_112->payload.SLet.f1; qoz_TypeExpr* ty = _qoz_ms_112->payload.SLet.f2; qoz_Expr* val = _qoz_ms_112->payload.SLet.f3; {
        emit_walk_typeexpr(e, ty); emit_walk_expr_for_types(e, val); if (!emit_is_unit_typeexpr(ty)) { qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, ty); } 
    }
    0;  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_112->payload.SVar.f1; qoz_TypeExpr* ty = _qoz_ms_112->payload.SVar.f2; qoz_Expr* val = _qoz_ms_112->payload.SVar.f3; {
        emit_walk_typeexpr(e, ty); emit_walk_expr_for_types(e, val); if (!emit_is_unit_typeexpr(ty)) { qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, ty); } 
    }
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* ex2 = _qoz_ms_112->payload.SExpr.f1; emit_walk_expr_for_types(e, ex2);  break; } } 0; } }emit_walk_expr_for_types(e, tail); 
    }
    0;  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_111->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_111->payload.ERecord.f2; {
    ...
    0;  break; } case qoz_Expr_ECast: { qoz_Expr* val = _qoz_ms_111->payload.ECast.f1; qoz_TypeExpr* te = _qoz_ms_111->payload.ECast.f2; {
        emit_walk_typeexpr(e, te); emit_walk_expr_for_types(e, val); 
    }
    0;  break; } case qoz_Expr_ESizeOf: { qoz_TypeExpr* te = _qoz_ms_111->payload.ESizeOf.f1; emit_walk_typeexpr(e, te);  break; } case qoz_Expr_EBinary: { qoz_Expr* l = _qoz_ms_111->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_111->payload.EBinary.f3; {
        emit_walk_expr_for_types(e, l); emit_walk_expr_for_types(e, r); 
    }
    0;  break; } case qoz_Expr_EUnary: { qoz_Expr* rhs = _qoz_ms_111->payload.EUnary.f2; emit_walk_expr_for_types(e, rhs);  break; } case qoz_Expr_EAssign: { qoz_Expr* l = _qoz_ms_111->payload.EAssign.f2; qoz_Expr* r = _qoz_ms_111->payload.EAssign.f3; {
        emit_walk_expr_for_types(e, l); emit_walk_expr_for_types(e, r); emit_walk_assign_for_map_helpers(e, l); 
    }
    0;  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_111->payload.ECall.f1; qoz_Vec__qoz_TypeExpr type_args = _qoz_ms_111->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_111->payload.ECall.f3; {
    ...
    0;  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_111->payload.EField.f1; emit_walk_expr_for_types(e, base);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_111->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_111->payload.EIndex.f2; {
        emit_walk_expr_for_types(e, base); emit_walk_expr_for_types(e, idx); 
    }
    0;  break; } case qoz_Expr_ETry: { qoz_Expr* val = _qoz_ms_111->payload.ETry.f1; emit_walk_expr_for_types(e, val);  break; } case qoz_Expr_EIf: { qoz_Expr* c = _qoz_ms_111->payload.EIf.f1; qoz_Expr* t = _qoz_ms_111->payload.EIf.f2; qoz_Expr* f = _qoz_ms_111->payload.EIf.f3; {
        emit_walk_expr_for_types(e, c); emit_walk_expr_for_types(e, t); emit_walk_expr_for_types(e, f); 
    }
    0;  break; } case qoz_Expr_EMatch: { qoz_Expr* scrut = _qoz_ms_111->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_111->payload.EMatch.f2; {
    ...
    0;  break; } case qoz_Expr_EWhile: { qoz_Expr* c = _qoz_ms_111->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_111->payload.EWhile.f2; {
        emit_walk_expr_for_types(e, c); emit_walk_expr_for_types(e, b); 
    }
    0;  break; } case qoz_Expr_EFor: { qoz_Expr* it = _qoz_ms_111->payload.EFor.f3; qoz_Expr* b = _qoz_ms_111->payload.EFor.f4; {
        emit_walk_expr_for_types(e, it); emit_walk_expr_for_types(e, b); 
    }
    0;  break; } case qoz_Expr_EReturn: { qoz_Expr* v = _qoz_ms_111->payload.EReturn.f1; emit_walk_expr_for_types(e, v);  break; } case qoz_Expr_EDefer: { qoz_Expr* b = _qoz_ms_111->payload.EDefer.f1; emit_walk_expr_for_types(e, b);  break; } case qoz_Expr_ETuple: { qoz_Vec__qoz_Expr elems = _qoz_ms_111->payload.ETuple.f1; { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; emit_walk_expr_for_types(e, el); } }0;  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_111->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_111->payload.EArrayLit.f1; {
        { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; emit_walk_expr_for_types(e, el); } }if ((elems.len) > 0) { qoz_Option__qoz_TypeExpr* elem_te = emit_literal_typeexpr(elems.data[0]); qoz_gc_push_root(&elem_te); qoz_Option__qoz_TypeExpr* _qoz_ms_113 = elem_te; switch (_qoz_ms_113->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* et = _qoz_ms_113->payload.Some.f0; {
    ...
    0;  break; } case qoz_Expr_EClosure: { qoz_Expr* body = _qoz_ms_111->payload.EClosure.f3; emit_walk_expr_for_types(e, body);  break; } default: { NULL;  break; } } 0; 
    return;
}
...
qoz_string emit_mangle_type(qoz_Emitter* e, qoz_TypeExpr* t) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&t);
    qoz_TypeExpr* _qoz_ms_114 = t; qoz_string _qoz_mv_114 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_114->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_114 = (QOZ_STR_LIT("void"));  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_114->payload.TEPtr.f1; _qoz_mv_114 = (qoz_string_cat(emit_mangle_type(e, inner), QOZ_STR_LIT("_ptr")));  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_114->payload.TETuple.f1; qoz_string _qoz_bv_86;
    {
        qoz_string acc = QOZ_STR_LIT("tuple"); { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; acc = qoz_string_cat(acc, QOZ_STR_LIT("__")); acc = qoz_string_cat(acc, emit_mangle_type(e, el)); } }_qoz_bv_86 = acc;
    }
    _qoz_mv_114 = (_qoz_bv_86);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_114->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_114->payload.TENamed.f2; _qoz_mv_114 = (emit_mangle_named(e, path, args));  break; } case qoz_TypeExpr_TEFn: { _qoz_mv_114 = (QOZ_STR_LIT("fn"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_114;
}
...
qoz_TypeExpr* emit_substitute_type(qoz_Emitter* e, qoz_TypeExpr* t, qoz_Vec__qoz_string params, qoz_Vec__qoz_TypeExpr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&t);
    qoz_TypeExpr* _qoz_ms_115 = t; qoz_TypeExpr* _qoz_mv_115 = NULL; switch (_qoz_ms_115->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_115 = (t);  break; } case qoz_TypeExpr_TEPtr: { qoz_Span span = _qoz_ms_115->payload.TEPtr.f0; qoz_TypeExpr* inner = _qoz_ms_115->payload.TEPtr.f1; _qoz_mv_115 = (qoz_make_TypeExpr_TEPtr(span, emit_substitute_type(e, inner, params, args)));  break; } case qoz_TypeExpr_TETuple: { qoz_Span span = _qoz_ms_115->payload.TETuple.f0; qoz_Vec__qoz_TypeExpr elems = _qoz_ms_115->payload.TETuple.f1; qoz_TypeExpr* _qoz_bv_87;
    {
        qoz_Vec__qoz_TypeExpr new_elems = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&new_elems, emit_substitute_type(e, el, params, args)); } }_qoz_bv_87 = qoz_make_TypeExpr_TETuple(span, new_elems);
    }
    _qoz_mv_115 = (_qoz_bv_87);  break; } case qoz_TypeExpr_TENamed: { qoz_Span span = _qoz_ms_115->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_115->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr t_args = _qoz_ms_115->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_88;
    {
        if (((path.len) == 1) && ((t_args.len) == 0)) { qoz_string n = path.data[0]; int64_t i = 0; { qoz_Vec__qoz_string __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string p = __col.data[__i]; (void)p; if (qoz_string_eq(p, n)) { return args.data[i];} i = i + 1; } }} qoz_Vec__qoz_TypeExpr new_args = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = t_args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_TypeExpr(&new_args, emit_substitute_type(e, a, params, args)); } }_qoz_bv_88 = qoz_make_TypeExpr_TENamed(span, path, new_args);
    }
    _qoz_mv_115 = (_qoz_bv_88);  break; } case qoz_TypeExpr_TEFn: { qoz_Span span = _qoz_ms_115->payload.TEFn.f0; qoz_Vec__qoz_TypeExpr fparams = _qoz_ms_115->payload.TEFn.f1; qoz_TypeExpr* ret = _qoz_ms_115->payload.TEFn.f2; qoz_TypeExpr* _qoz_bv_89;
    {
        qoz_Vec__qoz_TypeExpr new_fparams = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* fp = __col.data[__i]; (void)fp; qoz_vec_push__qoz_TypeExpr(&new_fparams, emit_substitute_type(e, fp, params, args)); } }_qoz_bv_89 = qoz_make_TypeExpr_TEFn(span, new_fparams, emit_substitute_type(e, ret, params, args));
    }
    _qoz_mv_115 = (_qoz_bv_89);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_115;
}
...
qoz_Expr* emit_substitute_expr(qoz_Emitter* e, qoz_Expr* x, qoz_Vec__qoz_string params, qoz_Vec__qoz_TypeExpr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&x);
    qoz_Expr* _qoz_ms_116 = x; qoz_Expr* _qoz_mv_116 = NULL; switch (_qoz_ms_116->tag) { case qoz_Expr_EInt: { _qoz_mv_116 = (x);  break; } case qoz_Expr_EFloat: { _qoz_mv_116 = (x);  break; } case qoz_Expr_EString: { _qoz_mv_116 = (x);  break; } case qoz_Expr_EChar: { _qoz_mv_116 = (x);  break; } case qoz_Expr_EBool: { _qoz_mv_116 = (x);  break; } case qoz_Expr_ENil: { _qoz_mv_116 = (x);  break; } case qoz_Expr_EIdent: { _qoz_mv_116 = (x);  break; } case qoz_Expr_EPath: { _qoz_mv_116 = (x);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_116->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_116->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_116->payload.EUnary.f2; _qoz_mv_116 = (qoz_make_Expr_EUnary(sp, op, emit_substitute_expr(e, rhs, params, args)));  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_116->payload.EBinary.f0; qoz_BinaryOp* op = _qoz_ms_116->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_116->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_116->payload.EBinary.f3; _qoz_mv_116 = (qoz_make_Expr_EBinary(sp, op, emit_substitute_expr(e, l, params, args), emit_substitute_expr(e, r, params, args)));  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_116->payload.EAssign.f0; qoz_AssignOp* op = _qoz_ms_116->payload.EAssign.f1; qoz_Expr* l = _qoz_ms_116->payload.EAssign.f2; qoz_Expr* r = _qoz_ms_116->payload.EAssign.f3; _qoz_mv_116 = (qoz_make_Expr_EAssign(sp, op, emit_substitute_expr(e, l, params, args), emit_substitute_expr(e, r, params, args)));  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_116->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_116->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_116->payload.ECall.f2; qoz_Vec__qoz_Expr ax = _qoz_ms_116->payload.ECall.f3; qoz_Expr* _qoz_bv_90;
    {
        qoz_Vec__qoz_TypeExpr new_ta = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = ta; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* t = __col.data[__i]; (void)t; qoz_vec_push__qoz_TypeExpr(&new_ta, emit_substitute_type(e, t, params, args)); } }qoz_Vec__qoz_Expr new_args = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = ax; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_Expr(&new_args, emit_substitute_expr(e, a, params, args)); } }_qoz_bv_90 = qoz_make_Expr_ECall(sp, emit_substitute_expr(e, callee, params, args), new_ta, new_args);
    }
    _qoz_mv_116 = (_qoz_bv_90);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_116->payload.EField.f0; qoz_Expr* base = _qoz_ms_116->payload.EField.f1; qoz_string name = _qoz_ms_116->payload.EField.f2; _qoz_mv_116 = (qoz_make_Expr_EField(sp, emit_substitute_expr(e, base, params, args), name));  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_116->payload.EIndex.f0; qoz_Expr* base = _qoz_ms_116->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_116->payload.EIndex.f2; _qoz_mv_116 = (qoz_make_Expr_EIndex(sp, emit_substitute_expr(e, base, params, args), emit_substitute_expr(e, idx, params, args)));  break; } case qoz_Expr_ECast: { qoz_Span sp = _qoz_ms_116->payload.ECast.f0; qoz_Expr* value = _qoz_ms_116->payload.ECast.f1; qoz_TypeExpr* t = _qoz_ms_116->payload.ECast.f2; _qoz_mv_116 = (qoz_make_Expr_ECast(sp, emit_substitute_expr(e, value, params, args), emit_substitute_type(e, t, params, args)));  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_116->payload.ETry.f0; qoz_Expr* value = _qoz_ms_116->payload.ETry.f1; _qoz_mv_116 = (qoz_make_Expr_ETry(sp, emit_substitute_expr(e, value, params, args)));  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_116->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_116->payload.ETuple.f1; qoz_Expr* _qoz_bv_91;
    {
        qoz_Vec__qoz_Expr new_e = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&new_e, emit_substitute_expr(e, el, params, args)); } }_qoz_bv_91 = qoz_make_Expr_ETuple(sp, new_e);
    }
    _qoz_mv_116 = (_qoz_bv_91);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_116->payload.ERecord.f0; qoz_TypeExpr* te = _qoz_ms_116->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_116->payload.ERecord.f2; qoz_Expr* _qoz_bv_92;
    {
        qoz_Vec__qoz_RecordFieldLit new_fields = qoz_vec_make__qoz_RecordFieldLit(); { qoz_Vec__qoz_RecordFieldLit __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; qoz_vec_push__qoz_RecordFieldLit(&new_fields, ((qoz_RecordFieldLit){ .name = f.name, .value = emit_substitute_expr(e, f.value, params, args) })); } }_qoz_bv_92 = qoz_make_Expr_ERecord(sp, emit_substitute_type(e, te, params, args), new_fields);
    }
    _qoz_mv_116 = (_qoz_bv_92);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_116->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_116->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_116->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_116->payload.EClosure.f3; qoz_Expr* _qoz_bv_93;
    {
        qoz_Vec__qoz_ClosureParam new_cps = qoz_vec_make__qoz_ClosureParam(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_ClosureParam(&new_cps, ((qoz_ClosureParam){ .name = cp.name, .ty = emit_substitute_type(e, cp.ty, params, args) })); } }_qoz_bv_93 = qoz_make_Expr_EClosure(sp, new_cps, emit_substitute_type(e, ret, params, args), emit_substitute_expr(e, body, params, args));
    }
    _qoz_mv_116 = (_qoz_bv_93);  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_116->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_116->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_116->payload.EBlock.f2; qoz_Expr* _qoz_bv_94;
    {
        qoz_Vec__qoz_Stmt new_stmts = qoz_vec_make__qoz_Stmt(); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_vec_push__qoz_Stmt(&new_stmts, emit_substitute_stmt(e, s, params, args)); } }_qoz_bv_94 = qoz_make_Expr_EBlock(sp, new_stmts, emit_substitute_expr(e, tail, params, args));
    }
    _qoz_mv_116 = (_qoz_bv_94);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_116->payload.EIf.f0; qoz_Expr* c = _qoz_ms_116->payload.EIf.f1; qoz_Expr* t = _qoz_ms_116->payload.EIf.f2; qoz_Expr* f = _qoz_ms_116->payload.EIf.f3; _qoz_mv_116 = (qoz_make_Expr_EIf(sp, emit_substitute_expr(e, c, params, args), emit_substitute_expr(e, t, params, args), emit_substitute_expr(e, f, params, args)));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_116->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_116->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_116->payload.EMatch.f2; qoz_Expr* _qoz_bv_95;
    {
        qoz_Vec__qoz_MatchArm new_arms = qoz_vec_make__qoz_MatchArm(); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm a = __col.data[__i]; (void)a; qoz_vec_push__qoz_MatchArm(&new_arms, ((qoz_MatchArm){ .pat = a.pat, .body = emit_substitute_expr(e, a.body, params, args), .has_guard = a.has_guard, .guard = ((a.has_guard) ? emit_substitute_expr(e, a.guard, params, args) : a.guard) })); } }_qoz_bv_95 = qoz_make_Expr_EMatch(sp, emit_substitute_expr(e, scrut, params, args), new_arms);
    }
    _qoz_mv_116 = (_qoz_bv_95);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_116->payload.EWhile.f0; qoz_Expr* c = _qoz_ms_116->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_116->payload.EWhile.f2; _qoz_mv_116 = (qoz_make_Expr_EWhile(sp, emit_substitute_expr(e, c, params, args), emit_substitute_expr(e, b, params, args)));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_116->payload.EFor.f0; qoz_string b1 = _qoz_ms_116->payload.EFor.f1; qoz_string b2 = _qoz_ms_116->payload.EFor.f2; qoz_Expr* it = _qoz_ms_116->payload.EFor.f3; qoz_Expr* body = _qoz_ms_116->payload.EFor.f4; _qoz_mv_116 = (qoz_make_Expr_EFor(sp, b1, b2, emit_substitute_expr(e, it, params, args), emit_substitute_expr(e, body, params, args)));  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_116->payload.EReturn.f0; qoz_Expr* v = _qoz_ms_116->payload.EReturn.f1; _qoz_mv_116 = (qoz_make_Expr_EReturn(sp, emit_substitute_expr(e, v, params, args)));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_116->payload.EDefer.f0; qoz_Expr* v = _qoz_ms_116->payload.EDefer.f1; _qoz_mv_116 = (qoz_make_Expr_EDefer(sp, emit_substitute_expr(e, v, params, args)));  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_116->payload.ESizeOf.f0; qoz_TypeExpr* t = _qoz_ms_116->payload.ESizeOf.f1; _qoz_mv_116 = (qoz_make_Expr_ESizeOf(sp, emit_substitute_type(e, t, params, args)));  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_116->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_116->payload.EArrayLit.f1; qoz_Expr* _qoz_bv_96;
    {
        qoz_Vec__qoz_Expr new_e = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&new_e, emit_substitute_expr(e, el, params, args)); } }_qoz_bv_96 = qoz_make_Expr_EArrayLit(sp, new_e);
    }
    _qoz_mv_116 = (_qoz_bv_96);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_116;
}
...
qoz_Stmt* emit_substitute_stmt(qoz_Emitter* e, qoz_Stmt* s, qoz_Vec__qoz_string params, qoz_Vec__qoz_TypeExpr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_117 = s; qoz_Stmt* _qoz_mv_117 = NULL; switch (_qoz_ms_117->tag) { case qoz_Stmt_SLet: { qoz_Span sp = _qoz_ms_117->payload.SLet.f0; qoz_string name = _qoz_ms_117->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_117->payload.SLet.f2; qoz_Expr* val = _qoz_ms_117->payload.SLet.f3; _qoz_mv_117 = (qoz_make_Stmt_SLet(sp, name, emit_substitute_type(e, te, params, args), emit_substitute_expr(e, val, params, args)));  break; } case qoz_Stmt_SVar: { qoz_Span sp = _qoz_ms_117->payload.SVar.f0; qoz_string name = _qoz_ms_117->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_117->payload.SVar.f2; qoz_Expr* val = _qoz_ms_117->payload.SVar.f3; _qoz_mv_117 = (qoz_make_Stmt_SVar(sp, name, emit_substitute_type(e, te, params, args), emit_substitute_expr(e, val, params, args)));  break; } case qoz_Stmt_SExpr: { qoz_Span sp = _qoz_ms_117->payload.SExpr.f0; qoz_Expr* x = _qoz_ms_117->payload.SExpr.f1; _qoz_mv_117 = (qoz_make_Stmt_SExpr(sp, emit_substitute_expr(e, x, params, args)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_117;
}

qoz_string emit_operator_first_param_type_name(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_118 = te; qoz_string _qoz_mv_118 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_118->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_118->payload.TEPtr.f1; qoz_TypeExpr* _qoz_ms_119 = inner; qoz_string _qoz_mv_119 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_119->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_119->payload.TENamed.f1; qoz_string _qoz_bv_97;
    {
        if ((path.len) > 0) { return path.data[(path.len) - 1];} _qoz_bv_97 = QOZ_STR_LIT("");
    }
    _qoz_mv_119 = (_qoz_bv_97);  break; } default: { _qoz_mv_119 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_118 = (_qoz_mv_119);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_118->payload.TENamed.f1; qoz_string _qoz_bv_98;
    {
        if ((path.len) > 0) { return path.data[(path.len) - 1];} _qoz_bv_98 = QOZ_STR_LIT("");
    }
    _qoz_mv_118 = (_qoz_bv_98);  break; } default: { _qoz_mv_118 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_118;
}

void emit_register_variants(qoz_Emitter* e, qoz_File file) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    { qoz_Vec__qoz_Decl __col = file.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_120 = d; switch (_qoz_ms_120->tag) { case qoz_Decl_DEnum: { qoz_string name = _qoz_ms_120->payload.DEnum.f1; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_120->payload.DEnum.f3; {
    ...
    0;  break; } case qoz_Decl_DStruct: { qoz_string name = _qoz_ms_120->payload.DStruct.f1; (qoz_map_set__qoz_string__qoz_Decl(&e->struct_decls, name, d), 0);  break; } case qoz_Decl_DExternal: { qoz_string name = _qoz_ms_120->payload.DExternal.f1; qoz_string symbol = _qoz_ms_120->payload.DExternal.f2; qoz_Vec__qoz_FnParam fps = _qoz_ms_120->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_120->payload.DExternal.f4; {
    ...
    0;  break; } case qoz_Decl_DFn: { qoz_string name = _qoz_ms_120->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_120->payload.DFn.f2; qoz_Vec__qoz_FnParam fps = _qoz_ms_120->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_120->payload.DFn.f4; qoz_string attr = _qoz_ms_120->payload.DFn.f6; {
    ...
    0;  break; } case qoz_Decl_DImport: { qoz_Vec__qoz_string ipath = _qoz_ms_120->payload.DImport.f1; qoz_string alias = _qoz_ms_120->payload.DImport.f2; {
...
qoz_string emit_c_type_for(qoz_Emitter* e, qoz_TypeExpr* t) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&t);
    qoz_TypeExpr* _qoz_ms_123 = t; qoz_string _qoz_mv_123 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_123->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_123 = (QOZ_STR_LIT("void"));  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_123->payload.TEPtr.f1; _qoz_mv_123 = (qoz_string_cat(emit_c_type_for(e, inner), QOZ_STR_LIT("*")));  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_123->payload.TETuple.f1; _qoz_mv_123 = (emit_register_tuple_typedef(e, elems));  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_123->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_123->payload.TENamed.f2; _qoz_mv_123 = (emit_c_type_for_named_with_args(e, path, args));  break; } case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr params = _qoz_ms_123->payload.TEFn.f1; qoz_TypeExpr* ret = _qoz_ms_123->payload.TEFn.f2; _qoz_mv_123 = (emit_register_fn_typedef(e, params, ret));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_123;
}
...
void emit_collect_closure_captures(qoz_Emitter* e, qoz_Expr* ex, qoz_CaptureScope* sc, qoz_Vec__qoz_string* out) {
    ...
    qoz_gc_push_root(&sc);
    qoz_gc_push_root(&out);
    qoz_Expr* _qoz_ms_124 = ex; switch (_qoz_ms_124->tag) { case qoz_Expr_EInt: { NULL;  break; } case qoz_Expr_EFloat: { NULL;  break; } case qoz_Expr_EString: { NULL;  break; } case qoz_Expr_EChar: { NULL;  break; } case qoz_Expr_EBool: { NULL;  break; } case qoz_Expr_ENil: { NULL;  break; } case qoz_Expr_EPath: { NULL;  break; } case qoz_Expr_ESizeOf: { NULL;  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_124->payload.EIdent.f1; if (!qoz_map_contains__qoz_string__bool(&sc->bound, name)) { if (qoz_map_contains__qoz_string__qoz_TypeExpr(&e->locals, name)) { qoz_vec_push__qoz_string(out, name); } } 0;  break; } case qoz_Expr_EUnary: { qoz_Expr* sub = _qoz_ms_124->payload.EUnary.f2; emit_collect_closure_captures(e, sub, sc, out);  break; } case qoz_Expr_EBinary: { qoz_Expr* l = _qoz_ms_124->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_124->payload.EBinary.f3; {
        emit_collect_closure_captures(e, l, sc, out); emit_collect_closure_captures(e, r, sc, out); 
    }
    0;  break; } case qoz_Expr_EAssign: { qoz_Expr* l = _qoz_ms_124->payload.EAssign.f2; qoz_Expr* r = _qoz_ms_124->payload.EAssign.f3; {
        emit_collect_closure_captures(e, l, sc, out); emit_collect_closure_captures(e, r, sc, out); 
    }
    0;  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_124->payload.ECall.f1; qoz_Vec__qoz_Expr args = _qoz_ms_124->payload.ECall.f3; {
    ...
    0;  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_124->payload.EField.f1; emit_collect_closure_captures(e, base, sc, out);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_124->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_124->payload.EIndex.f2; {
        emit_collect_closure_captures(e, base, sc, out); emit_collect_closure_captures(e, idx, sc, out); 
    }
    0;  break; } case qoz_Expr_ECast: { qoz_Expr* v = _qoz_ms_124->payload.ECast.f1; emit_collect_closure_captures(e, v, sc, out);  break; } case qoz_Expr_ETry: { qoz_Expr* v = _qoz_ms_124->payload.ETry.f1; emit_collect_closure_captures(e, v, sc, out);  break; } case qoz_Expr_EReturn: { qoz_Expr* v = _qoz_ms_124->payload.EReturn.f1; emit_collect_closure_captures(e, v, sc, out);  break; } case qoz_Expr_EDefer: { qoz_Expr* v = _qoz_ms_124->payload.EDefer.f1; emit_collect_closure_captures(e, v, sc, out);  break; } case qoz_Expr_ETuple: { qoz_Vec__qoz_Expr elems = _qoz_ms_124->payload.ETuple.f1; { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; emit_collect_closure_captures(e, el, sc, out); } }0;  break; } case qoz_Expr_ERecord: { qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_124->payload.ERecord.f2; { qoz_Vec__qoz_RecordFieldLit __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit fl = __col.data[__i]; (void)fl; emit_collect_closure_captures(e, fl.value, sc, out); } }0;  break; } case qoz_Expr_EArrayLit: { qoz_Vec__qoz_Expr elems = _qoz_ms_124->payload.EArrayLit.f1; { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; emit_collect_closure_captures(e, el, sc, out); } }0;  break; } case qoz_Expr_EClosure: { NULL;  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_124->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_124->payload.EBlock.f2; {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* st = __col.data[__i]; (void)st; qoz_Stmt* _qoz_ms_125 = st; switch (_qoz_ms_125->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_125->payload.SLet.f1; qoz_Expr* value = _qoz_ms_125->payload.SLet.f3; {
        emit_collect_closure_captures(e, value, sc, out); qoz_map_set__qoz_string__bool(&sc->bound, name, true); 
    }
    0;  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_125->payload.SVar.f1; qoz_Expr* value = _qoz_ms_125->payload.SVar.f3; {
        emit_collect_closure_captures(e, value, sc, out); qoz_map_set__qoz_string__bool(&sc->bound, name, true); 
    }
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* expr = _qoz_ms_125->payload.SExpr.f1; emit_collect_closure_captures(e, expr, sc, out);  break; } } 0; } }emit_collect_closure_captures(e, tail, sc, out); 
    }
    0;  break; } case qoz_Expr_EIf: { qoz_Expr* c = _qoz_ms_124->payload.EIf.f1; qoz_Expr* t = _qoz_ms_124->payload.EIf.f2; qoz_Expr* f = _qoz_ms_124->payload.EIf.f3; {
    ...
    0;  break; } case qoz_Expr_EMatch: { qoz_Expr* scrut = _qoz_ms_124->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_124->payload.EMatch.f2; {
    ...
    0;  break; } case qoz_Expr_EWhile: { qoz_Expr* c = _qoz_ms_124->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_124->payload.EWhile.f2; {
        emit_collect_closure_captures(e, c, sc, out); emit_collect_closure_captures(e, b, sc, out); 
    }
    0;  break; } case qoz_Expr_EFor: { qoz_string bn = _qoz_ms_124->payload.EFor.f1; qoz_string bn2 = _qoz_ms_124->payload.EFor.f2; qoz_Expr* it = _qoz_ms_124->payload.EFor.f3; qoz_Expr* b = _qoz_ms_124->payload.EFor.f4; {
...
qoz_string emit_result_mangle_for(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_126 = te; qoz_string _qoz_mv_126 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_126->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_126->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_126->payload.TENamed.f2; qoz_string _qoz_bv_100;
    {
        if ((path.len) == 0) { return QOZ_STR_LIT("");} qoz_string last = path.data[(path.len) - 1]; if (!qoz_string_eq(last, QOZ_STR_LIT("Result"))) { return QOZ_STR_LIT("");} if ((args.len) != 2) { return QOZ_STR_LIT("");} _qoz_bv_100 = emit_mangle_inst(e, QOZ_STR_LIT("Result"), args);
    }
    _qoz_mv_126 = (_qoz_bv_100);  break; } default: { _qoz_mv_126 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_126;
}
...
void emit_emit_try(qoz_Emitter* e, qoz_Span sp, qoz_Expr* value) {
    ...
    qoz_TypeExpr* inner_te = emit_infer_value_te(e, value); qoz_gc_push_root(&inner_te); qoz_TypeExpr* outer_te = e->current_ret_te; qoz_gc_push_root(&outer_te); qoz_string inner_mangle = emit_result_mangle_for(e, inner_te); qoz_string outer_mangle = emit_result_mangle_for(e, outer_te); if (qoz_string_eq(inner_mangle, QOZ_STR_LIT(""))) { emit_emit_die(sp, QOZ_STR_LIT("try operator: operand is not Result<T, E>")); return;} if (qoz_string_eq(outer_mangle, QOZ_STR_LIT(""))) { emit_emit_die(sp, QOZ_STR_LIT("try operator: enclosing function does not return Result<T, E>")); return;} e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_101;
    {
        qoz_Strbuf _qoz_sb_928_40 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_928_40); strings_sb_append_i64(&_qoz_sb_928_40, e->closure_counter); _qoz_bv_101 = strings_sb_finish(&_qoz_sb_928_40);
    }
    qoz_string tmp = qoz_string_cat(QOZ_STR_LIT("_qoz_try_"), _qoz_bv_101); int64_t start = strings_sb_len(&e->out); qoz_string _qoz_bv_102;
    {
        qoz_Strbuf _qoz_sb_934_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_934_13); strings_sb_append(&_qoz_sb_934_13, QOZ_STR_LIT("qoz_")); strings_sb_append(&_qoz_sb_934_13, inner_mangle); strings_sb_append(&_qoz_sb_934_13, QOZ_STR_LIT("* ")); strings_sb_append(&_qoz_sb_934_13, tmp); strings_sb_append(&_qoz_sb_934_13, QOZ_STR_LIT(" = ")); _qoz_bv_102 = strings_sb_finish(&_qoz_sb_934_13);
    }
    emit_push(e, _qoz_bv_102); emit_emit_expr(e, value); qoz_string crr = e->current_return_restore; qoz_string _qoz_bv_103;
    {
        qoz_Strbuf _qoz_sb_937_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_937_13); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("; if (")); strings_sb_append(&_qoz_sb_937_13, tmp); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("->tag == qoz_")); strings_sb_append(&_qoz_sb_937_13, inner_mangle); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("_Err) { ")); strings_sb_append(&_qoz_sb_937_13, crr); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("return qoz_make_")); strings_sb_append(&_qoz_sb_937_13, outer_mangle); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("_Err(")); strings_sb_append(&_qoz_sb_937_13, tmp); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("->payload.Err.f0); } ")); _qoz_bv_103 = strings_sb_finish(&_qoz_sb_937_13);
    }
    emit_push(e, _qoz_bv_103); emit_hoist_to_prologue(e, start); qoz_string _qoz_bv_104;
    {
        qoz_Strbuf _qoz_sb_940_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_940_13); strings_sb_append(&_qoz_sb_940_13, tmp); strings_sb_append(&_qoz_sb_940_13, QOZ_STR_LIT("->payload.Ok.f0")); _qoz_bv_104 = strings_sb_finish(&_qoz_sb_940_13);
    }
    emit_push(e, _qoz_bv_104); 
    return;
}
...
void emit_emit_tuple_lit(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_Expr elems) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_TypeExpr elem_tes = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&elem_tes, emit_infer_value_te(e, el)); } }qoz_string tname = emit_register_tuple_typedef(e, elem_tes); qoz_string _qoz_bv_105;
    {
        qoz_Strbuf _qoz_sb_947_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_947_13); strings_sb_append(&_qoz_sb_947_13, QOZ_STR_LIT("((")); strings_sb_append(&_qoz_sb_947_13, tname); strings_sb_append(&_qoz_sb_947_13, QOZ_STR_LIT("){ ")); _qoz_bv_105 = strings_sb_finish(&_qoz_sb_947_13);
    }
    emit_push(e, _qoz_bv_105); int64_t i = 0; { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, el); i = i + 1; } }emit_push(e, QOZ_STR_LIT(" })")); 
    return;
}
...
void emit_emit_array_lit_with_hint(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_Expr elems, qoz_TypeExpr* hint) {
    ...
    qoz_TypeExpr* elem_hint = qoz_make_TypeExpr_TEUnit(sp); qoz_gc_push_root(&elem_hint); qoz_TypeExpr* _qoz_ms_127 = hint; switch (_qoz_ms_127->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_127->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_127->payload.TENamed.f2; if (((path.len) > 0) && ((args.len) >= 1)) { qoz_string last = path.data[(path.len) - 1]; if (qoz_string_eq(last, QOZ_STR_LIT("Vec"))) { elem_hint = args.data[0]; } } 0;  break; } default: { NULL;  break; } } 0; emit_emit_array_lit_using(e, sp, elems, elem_hint); 
    return;
}
...
void emit_emit_array_lit_using(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_Expr elems, qoz_TypeExpr* hint) {
    ...
    {
        qoz_Strbuf _qoz_sb_997_40 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_997_40); strings_sb_append_i64(&_qoz_sb_997_40, e->closure_counter); _qoz_bv_106 = strings_sb_finish(&_qoz_sb_997_40);
    }
    qoz_string tmp = qoz_string_cat(QOZ_STR_LIT("_qoz_arr_"), _qoz_bv_106); int64_t start = strings_sb_len(&e->out); qoz_string _qoz_bv_107;
    {
        qoz_Strbuf _qoz_sb_999_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_999_13); strings_sb_append(&_qoz_sb_999_13, vec_c); strings_sb_append(&_qoz_sb_999_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_999_13, tmp); strings_sb_append(&_qoz_sb_999_13, QOZ_STR_LIT(" = qoz_")); strings_sb_append(&_qoz_sb_999_13, make_mangled); strings_sb_append(&_qoz_sb_999_13, QOZ_STR_LIT("(); ")); _qoz_bv_107 = strings_sb_finish(&_qoz_sb_999_13);
    }
    emit_push(e, _qoz_bv_107); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_string _qoz_bv_108;
    {
        qoz_Strbuf _qoz_sb_1001_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1001_17); strings_sb_append(&_qoz_sb_1001_17, QOZ_STR_LIT("qoz_")); strings_sb_append(&_qoz_sb_1001_17, push_mangled); strings_sb_append(&_qoz_sb_1001_17, QOZ_STR_LIT("(&")); strings_sb_append(&_qoz_sb_1001_17, tmp); strings_sb_append(&_qoz_sb_1001_17, QOZ_STR_LIT(", ")); _qoz_bv_108 = strings_sb_finish(&_qoz_sb_1001_17);
    }
    emit_push(e, _qoz_bv_108); emit_emit_expr(e, el); emit_push(e, QOZ_STR_LIT("); ")); } }emit_hoist_to_prologue(e, start); emit_push(e, tmp); 
    return;
}
...
void emit_emit_closure_lifted(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_ClosureParam cps, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_CaptureScope sc = ((qoz_CaptureScope){ .bound = qoz_map_make__qoz_string__bool() }); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_map_set__qoz_string__bool(&sc.bound, cp.name, true); } }qoz_Vec__qoz_string captures = qoz_vec_make__qoz_string(); emit_collect_closure_captures(e, body, &sc, &captures); int64_t counter = e->closure_counter; e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_109;
    {
        qoz_Strbuf _qoz_sb_1017_41 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1017_41); strings_sb_append_i64(&_qoz_sb_1017_41, counter); _qoz_bv_109 = strings_sb_finish(&_qoz_sb_1017_41);
    }
    qoz_string cname = qoz_string_cat(QOZ_STR_LIT("qoz_clo_"), _qoz_bv_109); qoz_string _qoz_bv_110;
    {
        qoz_Strbuf _qoz_sb_1018_50 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1018_50); strings_sb_append_i64(&_qoz_sb_1018_50, counter); _qoz_bv_110 = strings_sb_finish(&_qoz_sb_1018_50);
    }
    qoz_string env_struct = qoz_string_cat(QOZ_STR_LIT("qoz_clo_env_"), _qoz_bv_110); qoz_Vec__qoz_TypeExpr capture_tes = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; qoz_Option__qoz_TypeExpr* _qoz_ms_128 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, c); switch (_qoz_ms_128->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_128->payload.Some.f0; qoz_vec_push__qoz_TypeExpr(&capture_tes, te);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_vec_push__qoz_TypeExpr(&capture_tes, qoz_make_TypeExpr_TEUnit(sp));  break; } } 0; } }qoz_Vec__qoz_TypeExpr ptes = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_TypeExpr(&ptes, cp.ty); } }qoz_string clo_type = emit_register_fn_typedef(e, ptes, ret); qoz_Vec__qoz_FnParam fparams = qoz_vec_make__qoz_FnParam(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_FnParam(&fparams, ((qoz_FnParam){ .name = cp.name, .ty = cp.ty })); } }qoz_string sig = QOZ_STR_LIT("static "); sig = qoz_string_cat(sig, emit_c_type_for(e, ret)); sig = qoz_string_cat(sig, QOZ_STR_LIT(" ")); sig = qoz_string_cat(sig, cname); sig = qoz_string_cat(sig, QOZ_STR_LIT("(void *_qoz_env")); { qoz_Vec__qoz_FnParam __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; sig = qoz_string_cat(sig, QOZ_STR_LIT(", ")); sig = qoz_string_cat(sig, emit_c_type_for(e, fp.ty)); sig = qoz_string_cat(sig, QOZ_STR_LIT(" ")); sig = qoz_string_cat(sig, fp.name); } }sig = qoz_string_cat(sig, QOZ_STR_LIT(");\n")); qoz_vec_push__qoz_string(&e->synth_fn_decls, sig); if ((captures.len) > 0) { qoz_string env_decl = QOZ_STR_LIT("struct "); env_decl = qoz_string_cat(env_decl, env_struct); env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT(" { ")); int64_t ci = 0; { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; env_decl = qoz_string_cat(env_decl, emit_c_type_for(e, capture_tes.data[ci])); env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT(" ")); env_decl = qoz_string_cat(env_decl, c); env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT("; ")); ci = ci + 1; } }env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT("};\n")); qoz_vec_push__qoz_string(&e->synth_fn_decls, env_decl); } int64_t saved_start = strings_sb_len(&e->out); qoz_Map__qoz_string__qoz_TypeExpr saved_locals = e->locals; qoz_TypeExpr* saved_ret = e->current_ret_te; qoz_gc_push_root(&saved_ret); qoz_TypeExpr* saved_hint = e->match_hint; qoz_gc_push_root(&saved_hint); qoz_string ret_c = emit_c_type_for(e, ret); qoz_string _qoz_bv_111;
    {
        qoz_Strbuf _qoz_sb_1077_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1077_13); strings_sb_append(&_qoz_sb_1077_13, QOZ_STR_LIT("static ")); strings_sb_append(&_qoz_sb_1077_13, ret_c); strings_sb_append(&_qoz_sb_1077_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1077_13, cname); strings_sb_append(&_qoz_sb_1077_13, QOZ_STR_LIT("(void *_qoz_env")); _qoz_bv_111 = strings_sb_finish(&_qoz_sb_1077_13);
    }
    emit_push(e, _qoz_bv_111); { qoz_Vec__qoz_FnParam __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; qoz_string fp_c = emit_c_type_for(e, fp.ty); qoz_string fp_n = fp.name; qoz_string _qoz_bv_112;
    {
        qoz_Strbuf _qoz_sb_1081_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1081_17); strings_sb_append(&_qoz_sb_1081_17, QOZ_STR_LIT(", ")); strings_sb_append(&_qoz_sb_1081_17, fp_c); strings_sb_append(&_qoz_sb_1081_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1081_17, fp_n); _qoz_bv_112 = strings_sb_finish(&_qoz_sb_1081_17);
    }
    emit_push(e, _qoz_bv_112); } }emit_push(e, QOZ_STR_LIT(") {\n    ")); e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_FnParam __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, fp.name, fp.ty); } }if ((captures.len) > 0) { qoz_string _qoz_bv_113;
    {
        qoz_Strbuf _qoz_sb_1087_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1087_17); strings_sb_append(&_qoz_sb_1087_17, QOZ_STR_LIT("struct ")); strings_sb_append(&_qoz_sb_1087_17, env_struct); strings_sb_append(&_qoz_sb_1087_17, QOZ_STR_LIT(" *_env = (struct ")); strings_sb_append(&_qoz_sb_1087_17, env_struct); strings_sb_append(&_qoz_sb_1087_17, QOZ_STR_LIT(" *)_qoz_env;\n    ")); _qoz_bv_113 = strings_sb_finish(&_qoz_sb_1087_17);
    }
    emit_push(e, _qoz_bv_113); int64_t ci2 = 0; { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; qoz_string c_c = emit_c_type_for(e, capture_tes.data[ci2]); qoz_string _qoz_bv_114;
    {
        qoz_Strbuf _qoz_sb_1091_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1091_21); strings_sb_append(&_qoz_sb_1091_21, c_c); strings_sb_append(&_qoz_sb_1091_21, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1091_21, c); strings_sb_append(&_qoz_sb_1091_21, QOZ_STR_LIT(" = _env->")); strings_sb_append(&_qoz_sb_1091_21, c); strings_sb_append(&_qoz_sb_1091_21, QOZ_STR_LIT(";\n    ")); _qoz_bv_114 = strings_sb_finish(&_qoz_sb_1091_21);
    }
    emit_push(e, _qoz_bv_114); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, c, capture_tes.data[ci2]); ci2 = ci2 + 1; } }} e->current_ret_te = ret; if (emit_is_block(body)) { emit_emit_fn_body_block(e, body, ret); }  else { qoz_StmtScope saved = emit_open_statement_scope(e); if (emit_is_unit_typeexpr(ret)) { emit_emit_expr(e, body); emit_push(e, QOZ_STR_LIT(";\n    return;\n")); }  else { emit_push(e, QOZ_STR_LIT("return ")); emit_emit_value_with_hint(e, body, ret); emit_push(e, QOZ_STR_LIT(";\n")); } emit_close_statement_scope(e, saved); } emit_push(e, QOZ_STR_LIT("}\n\n")); qoz_string def = strings_sb_slice_copy(&e->out, saved_start, strings_sb_len(&e->out)); strings_sb_truncate(&e->out, saved_start); e->locals = saved_locals; e->current_ret_te = saved_ret; e->match_hint = saved_hint; qoz_vec_push__qoz_string(&e->synth_fn_defs, def); qoz_string _qoz_bv_115;
    {
        qoz_Strbuf _qoz_sb_1123_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1123_13); strings_sb_append(&_qoz_sb_1123_13, QOZ_STR_LIT("((")); strings_sb_append(&_qoz_sb_1123_13, clo_type); strings_sb_append(&_qoz_sb_1123_13, QOZ_STR_LIT("){ .env = ")); _qoz_bv_115 = strings_sb_finish(&_qoz_sb_1123_13);
    }
    emit_push(e, _qoz_bv_115); if ((captures.len) == 0) { emit_push(e, QOZ_STR_LIT("NULL")); }  else { qoz_string _qoz_bv_116;
    {
        qoz_Strbuf _qoz_sb_1129_50 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1129_50); strings_sb_append_i64(&_qoz_sb_1129_50, counter); _qoz_bv_116 = strings_sb_finish(&_qoz_sb_1129_50);
    }
    qoz_string env_local = qoz_string_cat(QOZ_STR_LIT("_qoz_env_"), _qoz_bv_116); int64_t start = strings_sb_len(&e->out); qoz_string _qoz_bv_117;
    {
        qoz_Strbuf _qoz_sb_1131_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1131_17); strings_sb_append(&_qoz_sb_1131_17, QOZ_STR_LIT("struct ")); strings_sb_append(&_qoz_sb_1131_17, env_struct); strings_sb_append(&_qoz_sb_1131_17, QOZ_STR_LIT(" *")); strings_sb_append(&_qoz_sb_1131_17, env_local); strings_sb_append(&_qoz_sb_1131_17, QOZ_STR_LIT(" = qoz_alloc(sizeof(struct ")); strings_sb_append(&_qoz_sb_1131_17, env_struct); strings_sb_append(&_qoz_sb_1131_17, QOZ_STR_LIT(")); ")); _qoz_bv_117 = strings_sb_finish(&_qoz_sb_1131_17);
    }
    emit_push(e, _qoz_bv_117); { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; qoz_string _qoz_bv_118;
    {
        qoz_Strbuf _qoz_sb_1133_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1133_21); strings_sb_append(&_qoz_sb_1133_21, env_local); strings_sb_append(&_qoz_sb_1133_21, QOZ_STR_LIT("->")); strings_sb_append(&_qoz_sb_1133_21, c); strings_sb_append(&_qoz_sb_1133_21, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_1133_21, c); strings_sb_append(&_qoz_sb_1133_21, QOZ_STR_LIT("; ")); _qoz_bv_118 = strings_sb_finish(&_qoz_sb_1133_21);
    }
    emit_push(e, _qoz_bv_118); } }emit_hoist_to_prologue(e, start); qoz_string _qoz_bv_119;
    {
        qoz_Strbuf _qoz_sb_1136_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1136_17); strings_sb_append(&_qoz_sb_1136_17, QOZ_STR_LIT("(void *)")); strings_sb_append(&_qoz_sb_1136_17, env_local); _qoz_bv_119 = strings_sb_finish(&_qoz_sb_1136_17);
    }
    emit_push(e, _qoz_bv_119); } qoz_string _qoz_bv_120;
    {
        qoz_Strbuf _qoz_sb_1138_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1138_13); strings_sb_append(&_qoz_sb_1138_13, QOZ_STR_LIT(", .fn = ")); strings_sb_append(&_qoz_sb_1138_13, cname); strings_sb_append(&_qoz_sb_1138_13, QOZ_STR_LIT(" })")); _qoz_bv_120 = strings_sb_finish(&_qoz_sb_1138_13);
    }
    emit_push(e, _qoz_bv_120); 
    return;
}
...
void emit_emit_expr(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_129 = ex; switch (_qoz_ms_129->tag) { case qoz_Expr_EInt: { qoz_string text = _qoz_ms_129->payload.EInt.f1; emit_push(e, emit_strip_numeric_underscores(text));  break; } case qoz_Expr_EFloat: { qoz_string text = _qoz_ms_129->payload.EFloat.f1; emit_push(e, emit_strip_numeric_underscores(text));  break; } case qoz_Expr_EBool: { bool v = _qoz_ms_129->payload.EBool.f1; emit_push(e, ((v) ? QOZ_STR_LIT("true") : QOZ_STR_LIT("false")));  break; } case qoz_Expr_ENil: { emit_push(e, QOZ_STR_LIT("NULL"));  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_129->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_130 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_130->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_130->payload.Some.f0; qoz_string _qoz_bv_121;
    {
        qoz_Strbuf _qoz_sb_1150_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1150_21); strings_sb_append(&_qoz_sb_1150_21, QOZ_STR_LIT("qoz_make_")); strings_sb_append(&_qoz_sb_1150_21, enum_name); strings_sb_append(&_qoz_sb_1150_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_1150_21, name); strings_sb_append(&_qoz_sb_1150_21, QOZ_STR_LIT("()")); _qoz_bv_121 = strings_sb_finish(&_qoz_sb_1150_21);
    }
    emit_push(e, _qoz_bv_121);  break; } case qoz_Option__qoz_string_None: { emit_push(e, name);  break; } } 0;  break; } case qoz_Expr_EString: { qoz_string text = _qoz_ms_129->payload.EString.f1; qoz_string _qoz_bv_122;
    {
        qoz_Strbuf _qoz_sb_1155_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1155_36); strings_sb_append(&_qoz_sb_1155_36, QOZ_STR_LIT("QOZ_STR_LIT(")); strings_sb_append(&_qoz_sb_1155_36, text); strings_sb_append(&_qoz_sb_1155_36, QOZ_STR_LIT(")")); _qoz_bv_122 = strings_sb_finish(&_qoz_sb_1155_36);
    }
    emit_push(e, _qoz_bv_122);  break; } case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_129->payload.EBinary.f1; qoz_Expr* lhs = _qoz_ms_129->payload.EBinary.f2; qoz_Expr* rhs = _qoz_ms_129->payload.EBinary.f3; emit_emit_binary(e, op, lhs, rhs);  break; } case qoz_Expr_EUnary: { qoz_UnaryOp* op = _qoz_ms_129->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_129->payload.EUnary.f2; {
        emit_push(e, emit_unary_c_op(op)); emit_emit_expr(e, rhs); 
    }
    0;  break; } case qoz_Expr_EReturn: { qoz_Expr* value = _qoz_ms_129->payload.EReturn.f1; if (emit_is_nil_expr(value)) { emit_push(e, QOZ_STR_LIT("return")); }  else { emit_push(e, QOZ_STR_LIT("return ")); emit_emit_value_with_hint(e, value, e->current_ret_te); } 0;  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_129->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_129->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_129->payload.EBlock.f2; {
        if ((stmts.len) == 0) { emit_emit_block_tail_as_value(e, tail); return;} qoz_Expr* _qoz_ms_131 = tail; switch (_qoz_ms_131->tag) { case qoz_Expr_EWhile: { {
    ...
    0;  break; } default: { NULL;  break; } } 0; qoz_TypeExpr* tail_te = emit_infer_value_te(e, tail); qoz_gc_push_root(&tail_te); if (emit_is_unit_typeexpr(tail_te)) { int64_t start_u = strings_sb_len(&e->out); emit_push(e, QOZ_STR_LIT("{\n        ")); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_emit_stmt(e, s); } }qoz_StmtScope saved_tail = emit_open_statement_scope(e); emit_emit_stmt_expr(e, tail); emit_close_statement_scope(e, saved_tail); emit_push(e, QOZ_STR_LIT("\n    }\n    ")); emit_hoist_to_prologue(e, start_u); emit_push(e, QOZ_STR_LIT("0")); return;} e->closure_counter = e->closure_counter + 1; int64_t counter = e->closure_counter; qoz_string _qoz_bv_123;
    {
        qoz_Strbuf _qoz_sb_1214_47 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1214_47); strings_sb_append_i64(&_qoz_sb_1214_47, counter); _qoz_bv_123 = strings_sb_finish(&_qoz_sb_1214_47);
    }
    qoz_string tmp_res = qoz_string_cat(QOZ_STR_LIT("_qoz_bv_"), _qoz_bv_123); qoz_string result_c = emit_c_type_for(e, tail_te); int64_t start = strings_sb_len(&e->out); qoz_string _qoz_bv_124;
    {
        qoz_Strbuf _qoz_sb_1217_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1217_17); strings_sb_append(&_qoz_sb_1217_17, result_c); strings_sb_append(&_qoz_sb_1217_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1217_17, tmp_res); strings_sb_append(&_qoz_sb_1217_17, QOZ_STR_LIT(";\n    {\n        ")); _qoz_bv_124 = strings_sb_finish(&_qoz_sb_1217_17);
    }
    emit_push(e, _qoz_bv_124); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_emit_stmt(e, s); } }qoz_StmtScope saved_inner = emit_open_statement_scope(e); qoz_string _qoz_bv_125;
    {
        qoz_Strbuf _qoz_sb_1220_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1220_17); strings_sb_append(&_qoz_sb_1220_17, tmp_res); strings_sb_append(&_qoz_sb_1220_17, QOZ_STR_LIT(" = ")); _qoz_bv_125 = strings_sb_finish(&_qoz_sb_1220_17);
    }
    emit_push(e, _qoz_bv_125); emit_emit_expr(e, tail); emit_push(e, QOZ_STR_LIT(";\n    ")); emit_close_statement_scope(e, saved_inner); emit_push(e, QOZ_STR_LIT("}\n    ")); emit_hoist_to_prologue(e, start); emit_push(e, tmp_res); 
    }
    0;  break; } case qoz_Expr_EChar: { qoz_string text = _qoz_ms_129->payload.EChar.f1; emit_push(e, text);  break; } case qoz_Expr_EPath: { emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_EAssign: { qoz_Expr* lhs = _qoz_ms_129->payload.EAssign.f2; qoz_Expr* rhs = _qoz_ms_129->payload.EAssign.f3; emit_emit_assign(e, lhs, rhs);  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_129->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_129->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_129->payload.ECall.f3; emit_emit_call(e, callee, ta, args);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_129->payload.EField.f1; qoz_string name = _qoz_ms_129->payload.EField.f2; emit_emit_field(e, base, name);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_129->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_129->payload.EIndex.f2; emit_emit_index(e, base, idx);  break; } case qoz_Expr_ECast: { qoz_Expr* value = _qoz_ms_129->payload.ECast.f1; qoz_TypeExpr* t = _qoz_ms_129->payload.ECast.f2; {
        qoz_string tc = emit_c_type_for(e, t); qoz_string _qoz_bv_126;
    {
        qoz_Strbuf _qoz_sb_1236_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1236_17); strings_sb_append(&_qoz_sb_1236_17, QOZ_STR_LIT("((")); strings_sb_append(&_qoz_sb_1236_17, tc); strings_sb_append(&_qoz_sb_1236_17, QOZ_STR_LIT(")")); _qoz_bv_126 = strings_sb_finish(&_qoz_sb_1236_17);
    }
    emit_push(e, _qoz_bv_126); emit_emit_expr(e, value); emit_push(e, QOZ_STR_LIT(")")); 
    }
    0;  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_129->payload.ETry.f0; qoz_Expr* value = _qoz_ms_129->payload.ETry.f1; emit_emit_try(e, sp, value);  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_129->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_129->payload.ETuple.f1; emit_emit_tuple_lit(e, sp, elems);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_129->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_129->payload.ERecord.f2; emit_emit_record_lit_with_hint(e, te, fields, te);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_129->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_129->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_129->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_129->payload.EClosure.f3; emit_emit_closure_lifted(e, sp, cps, ret, body);  break; } case qoz_Expr_EIf: { qoz_Expr* c = _qoz_ms_129->payload.EIf.f1; qoz_Expr* t = _qoz_ms_129->payload.EIf.f2; qoz_Expr* f = _qoz_ms_129->payload.EIf.f3; {
    ...
    0;  break; } case qoz_Expr_EMatch: { qoz_Span span = _qoz_ms_129->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_129->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_129->payload.EMatch.f2; {
    ...
    0;  break; } case qoz_Expr_EWhile: { emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_EFor: { emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_EDefer: { emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_ESizeOf: { qoz_TypeExpr* te = _qoz_ms_129->payload.ESizeOf.f1; {
        qoz_string tc = emit_c_type_for(e, te); qoz_string _qoz_bv_127;
    {
        qoz_Strbuf _qoz_sb_1254_77 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1254_77); strings_sb_append(&_qoz_sb_1254_77, QOZ_STR_LIT("(int64_t)sizeof(")); strings_sb_append(&_qoz_sb_1254_77, tc); strings_sb_append(&_qoz_sb_1254_77, QOZ_STR_LIT(")")); _qoz_bv_127 = strings_sb_finish(&_qoz_sb_1254_77);
    }
    emit_push(e, _qoz_bv_127); 
    }
    0;  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_129->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_129->payload.EArrayLit.f1; emit_emit_array_lit_using(e, sp, elems, qoz_make_TypeExpr_TEUnit(sp));  break; } } 0; 
    return;
}
...
qoz_string emit_infer_value_ctype(qoz_Emitter* e, qoz_TypeExpr* ty, qoz_Expr* value) {
    ...
    qoz_gc_push_root(&ty);
    qoz_gc_push_root(&value);
    qoz_TypeExpr* _qoz_ms_132 = ty; qoz_string _qoz_mv_132 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_132->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_132 = (emit_c_type_for(e, emit_binding_te(e, ty, value)));  break; } default: { _qoz_mv_132 = (emit_c_type_for(e, ty));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_132;
}
...
qoz_string emit_infer_expr_ctype(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_133 = ex; qoz_string _qoz_mv_133 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_133->tag) { case qoz_Expr_EAssign: { _qoz_mv_133 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EReturn: { _qoz_mv_133 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EWhile: { _qoz_mv_133 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EFor: { _qoz_mv_133 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EDefer: { _qoz_mv_133 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_133->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_133->payload.EBlock.f2; qoz_string _qoz_bv_128;
    {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_ingest_stmt_locals(e, s); } }if (emit_is_nil_expr(tail)) { return QOZ_STR_LIT("void");} _qoz_bv_128 = emit_infer_expr_ctype(e, tail);
    }
    _qoz_mv_133 = (_qoz_bv_128);  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_133->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_133->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_133->payload.EMatch.f2; qoz_string _qoz_bv_129;
    {
        if ((arms.len) == 0) { emit_emit_die(sp, QOZ_STR_LIT("match expression with no arms")); } qoz_string bare_enum = emit_bare_enum_for_pat(e, arms.data[0].pat); qoz_string enum_name = ((qoz_string_eq(bare_enum, QOZ_STR_LIT(""))) ? bare_enum : emit_enum_lookup_name(e, scrut, bare_enum)); emit_bind_arm_locals(e, enum_name, arms.data[0].pat); _qoz_bv_129 = emit_infer_expr_ctype(e, arms.data[0].body);
    }
    _qoz_mv_133 = (_qoz_bv_129);  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_133->payload.EPath.f0; _qoz_mv_133 = (emit_emit_die(sp, QOZ_STR_LIT("EPath in value position is not supported")));  break; } default: { _qoz_mv_133 = (emit_c_type_for(e, emit_infer_value_te(e, ex)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_133;
}
...
void emit_ingest_stmt_locals(qoz_Emitter* e, qoz_Stmt* s) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_134 = s; switch (_qoz_ms_134->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_134->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_134->payload.SLet.f2; qoz_Expr* val = _qoz_ms_134->payload.SLet.f3; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, emit_binding_te(e, te, val));  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_134->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_134->payload.SVar.f2; qoz_Expr* val = _qoz_ms_134->payload.SVar.f3; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, emit_binding_te(e, te, val));  break; } case qoz_Stmt_SExpr: { NULL;  break; } } 0; 
    return;
}
...
qoz_string emit_bare_enum_for_pat(qoz_Emitter* e, qoz_Pattern* pat) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&pat);
    qoz_Pattern* _qoz_ms_135 = pat; qoz_string _qoz_mv_135 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_135->tag) { case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_135->payload.PatVariant.f1; qoz_string _qoz_bv_130;
    {
        if ((path.len) == 0) { return QOZ_STR_LIT("");} qoz_Option__qoz_string* _qoz_ms_136 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, path.data[(path.len) - 1]); qoz_string _qoz_mv_136 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_136->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_136->payload.Some.f0; _qoz_mv_136 = (en);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_136 = (QOZ_STR_LIT(""));  break; } } _qoz_bv_130 = _qoz_mv_136;
    }
    _qoz_mv_135 = (_qoz_bv_130);  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_135->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_137 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_137 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_137->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_137->payload.Some.f0; _qoz_mv_137 = (en);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_137 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_135 = (_qoz_mv_137);  break; } default: { _qoz_mv_135 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_135;
}

qoz_string emit_emit_die(qoz_Span sp, qoz_string msg) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_string _qoz_bv_131;
    {
        qoz_Strbuf _qoz_sb_1320_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1320_17); strings_sb_append(&_qoz_sb_1320_17, sp.file); strings_sb_append(&_qoz_sb_1320_17, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_1320_17, sp.line); strings_sb_append(&_qoz_sb_1320_17, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_1320_17, sp.col); strings_sb_append(&_qoz_sb_1320_17, QOZ_STR_LIT(": emit error: ")); strings_sb_append(&_qoz_sb_1320_17, msg); _qoz_bv_131 = strings_sb_finish(&_qoz_sb_1320_17);
    }
    fmt_println(_qoz_bv_131); qoz_os_exit(1); qoz_gc_shadow_set_top(_qoz_shadow_guard); return QOZ_STR_LIT("");
}
...
qoz_TypeExpr* emit_infer_base_typeexpr(qoz_Emitter* e, qoz_Expr* base) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_138 = base; qoz_TypeExpr* _qoz_mv_138 = NULL; switch (_qoz_ms_138->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_138->payload.EIdent.f0; qoz_string ident = _qoz_ms_138->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_139 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, ident); qoz_TypeExpr* _qoz_mv_139 = NULL; switch (_qoz_ms_139->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_139->payload.Some.f0; _qoz_mv_139 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_Option__qoz_string* _qoz_ms_140 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, ident); qoz_TypeExpr* _qoz_mv_140 = NULL; switch (_qoz_ms_140->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_140->payload.Some.f0; qoz_TypeExpr* _qoz_bv_132;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&path, en); _qoz_bv_132 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_140 = (_qoz_bv_132);  break; } case qoz_Option__qoz_string_None: { qoz_TypeExpr* _qoz_bv_133;
    {
        qoz_string _qoz_bv_134;
    {
        qoz_Strbuf _qoz_sb_1338_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1338_38); strings_sb_append(&_qoz_sb_1338_38, QOZ_STR_LIT("identifier `")); strings_sb_append(&_qoz_sb_1338_38, ident); strings_sb_append(&_qoz_sb_1338_38, QOZ_STR_LIT("` has no known TypeExpr (not a local, parameter, or variant)")); _qoz_bv_134 = strings_sb_finish(&_qoz_sb_1338_38);
    }
    (void)(emit_emit_die(sp, _qoz_bv_134)); _qoz_bv_133 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_140 = (_qoz_bv_133);  break; } } _qoz_mv_139 = (_qoz_mv_140);  break; } } _qoz_mv_138 = (_qoz_mv_139);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_138->payload.EField.f0; qoz_Expr* b = _qoz_ms_138->payload.EField.f1; qoz_string n = _qoz_ms_138->payload.EField.f2; qoz_TypeExpr* _qoz_bv_135;
    {
        qoz_TypeExpr* bte = emit_infer_base_typeexpr(e, b); qoz_gc_push_root(&bte); _qoz_bv_135 = emit_field_typeexpr_for(e, bte, n, sp);
    }
    _qoz_mv_138 = (_qoz_bv_135);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_138->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_138->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_138->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_141 = op; qoz_TypeExpr* _qoz_mv_141 = NULL; switch (_qoz_ms_141->tag) { case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_136;
    {
        qoz_TypeExpr* inner = emit_infer_base_typeexpr(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_142 = inner; qoz_TypeExpr* _qoz_mv_142 = NULL; switch (_qoz_ms_142->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_142->payload.TEPtr.f1; _qoz_mv_142 = (t);  break; } default: { qoz_TypeExpr* _qoz_bv_137;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("dereference of non-pointer base in EField/EIndex"))); _qoz_bv_137 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_142 = (_qoz_bv_137);  break; } } _qoz_bv_136 = _qoz_mv_142;
    }
    _qoz_mv_141 = (_qoz_bv_136);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_141 = (qoz_make_TypeExpr_TEPtr(sp, emit_infer_base_typeexpr(e, rhs)));  break; } default: { qoz_TypeExpr* _qoz_bv_138;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("unary operator does not yield a base TypeExpr"))); _qoz_bv_138 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_141 = (_qoz_bv_138);  break; } } _qoz_mv_138 = (_qoz_mv_141);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_138->payload.ECall.f0; qoz_Expr* c = _qoz_ms_138->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_138->payload.ECall.f2; qoz_Vec__qoz_Expr va = _qoz_ms_138->payload.ECall.f3; _qoz_mv_138 = (emit_call_return_te(e, c, ta, va, sp));  break; } case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_138->payload.ECast.f2; _qoz_mv_138 = (t);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* t = _qoz_ms_138->payload.ERecord.f1; _qoz_mv_138 = (t);  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_138->payload.EIndex.f0; qoz_Expr* b = _qoz_ms_138->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_139;
    {
        qoz_TypeExpr* bte = emit_infer_base_typeexpr(e, b); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_143 = bte; qoz_TypeExpr* _qoz_mv_143 = NULL; switch (_qoz_ms_143->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_143->payload.TEPtr.f1; _qoz_mv_143 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_143->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_143->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_140;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(emit_emit_die(sp, QOZ_STR_LIT("indexing into non-Vec/non-pointer base"))); _qoz_bv_140 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_143 = (_qoz_bv_140);  break; } default: { qoz_TypeExpr* _qoz_bv_141;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("indexing into unrecognised base"))); _qoz_bv_141 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_143 = (_qoz_bv_141);  break; } } _qoz_bv_139 = _qoz_mv_143;
    }
    _qoz_mv_138 = (_qoz_bv_139);  break; } default: { qoz_TypeExpr* _qoz_bv_142;
    {
        (void)(emit_emit_die(emit_span_of_expr(base), QOZ_STR_LIT("base expression has no resolvable TypeExpr"))); _qoz_bv_142 = qoz_make_TypeExpr_TEUnit(emit_span_of_expr(base));
    }
    _qoz_mv_138 = (_qoz_bv_142);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_138;
}

qoz_Span emit_span_of_expr(qoz_Expr* e) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Expr* _qoz_ms_144 = e; qoz_Span _qoz_mv_144 = ((qoz_Span){0}); switch (_qoz_ms_144->tag) { case qoz_Expr_ENil: { qoz_Span sp = _qoz_ms_144->payload.ENil.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_144->payload.EInt.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_144->payload.EFloat.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_144->payload.EString.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_144->payload.EChar.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_144->payload.EBool.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_144->payload.EIdent.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_144->payload.EPath.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_144->payload.EReturn.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_144->payload.EDefer.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_144->payload.ESizeOf.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_144->payload.EArrayLit.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_144->payload.ETry.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_144->payload.ETuple.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_144->payload.EUnary.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_144->payload.EField.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_144->payload.EIndex.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_ECast: { qoz_Span sp = _qoz_ms_144->payload.ECast.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_144->payload.ERecord.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_144->payload.EBlock.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_144->payload.EWhile.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_144->payload.EMatch.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_144->payload.EBinary.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_144->payload.EAssign.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_144->payload.ECall.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_144->payload.EIf.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_144->payload.EClosure.f0; _qoz_mv_144 = (sp);  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_144->payload.EFor.f0; _qoz_mv_144 = (sp);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_144;
}
...
qoz_TypeExpr* emit_field_typeexpr_for(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    qoz_TypeExpr* _qoz_ms_145 = base_te; qoz_TypeExpr* _qoz_mv_145 = NULL; switch (_qoz_ms_145->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_145->payload.TEPtr.f1; _qoz_mv_145 = (inner);  break; } default: { _qoz_mv_145 = (base_te);  break; } } qoz_TypeExpr* unwrapped = _qoz_mv_145; qoz_gc_push_root(&unwrapped); qoz_TypeExpr* _qoz_ms_146 = unwrapped; qoz_TypeExpr* _qoz_mv_146 = NULL; switch (_qoz_ms_146->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_146->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_146->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_143;
    {
        if ((path.len) < 1) { qoz_string _qoz_bv_144;
    {
        qoz_Strbuf _qoz_sb_1415_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1415_34); strings_sb_append(&_qoz_sb_1415_34, QOZ_STR_LIT("field access `.")); strings_sb_append(&_qoz_sb_1415_34, field); strings_sb_append(&_qoz_sb_1415_34, QOZ_STR_LIT("` on TypeExpr with empty path")); _qoz_bv_144 = strings_sb_finish(&_qoz_sb_1415_34);
    }
    (void)(emit_emit_die(sp, _qoz_bv_144)); return qoz_make_TypeExpr_TEUnit(sp);} qoz_string lookup = emit_type_lookup_key(e, path); qoz_Option__qoz_Decl* _qoz_ms_147 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, lookup); qoz_Option__qoz_Decl* _qoz_mv_147 = NULL; switch (_qoz_ms_147->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_147->payload.Some.f0; _qoz_mv_147 = (qoz_make_Option__qoz_Decl_Some(d));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_147 = (qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, lookup));  break; } } qoz_Option__qoz_Decl* decl_opt = _qoz_mv_147; qoz_gc_push_root(&decl_opt); qoz_Option__qoz_Decl* _qoz_ms_148 = decl_opt; qoz_TypeExpr* _qoz_mv_148 = NULL; switch (_qoz_ms_148->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_148->payload.Some.f0; qoz_Decl* _qoz_ms_149 = decl; qoz_TypeExpr* _qoz_mv_149 = NULL; switch (_qoz_ms_149->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_149->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_149->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_145;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_string_eq(f.name, field)) { if ((args.len) == (params.len)) { return emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }qoz_string _qoz_bv_146;
    {
        qoz_Strbuf _qoz_sb_1435_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1435_38); strings_sb_append(&_qoz_sb_1435_38, QOZ_STR_LIT("struct `")); strings_sb_append(&_qoz_sb_1435_38, lookup); strings_sb_append(&_qoz_sb_1435_38, QOZ_STR_LIT("` has no field `")); strings_sb_append(&_qoz_sb_1435_38, field); strings_sb_append(&_qoz_sb_1435_38, QOZ_STR_LIT("`")); _qoz_bv_146 = strings_sb_finish(&_qoz_sb_1435_38);
    }
    (void)(emit_emit_die(sp, _qoz_bv_146)); _qoz_bv_145 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_149 = (_qoz_bv_145);  break; } default: { qoz_TypeExpr* _qoz_bv_147;
    {
        qoz_string _qoz_bv_148;
    {
        qoz_Strbuf _qoz_sb_1439_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1439_38); strings_sb_append(&_qoz_sb_1439_38, QOZ_STR_LIT("decl `")); strings_sb_append(&_qoz_sb_1439_38, lookup); strings_sb_append(&_qoz_sb_1439_38, QOZ_STR_LIT("` is not a struct")); _qoz_bv_148 = strings_sb_finish(&_qoz_sb_1439_38);
    }
    (void)(emit_emit_die(sp, _qoz_bv_148)); _qoz_bv_147 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_149 = (_qoz_bv_147);  break; } } _qoz_mv_148 = (_qoz_mv_149);  break; } case qoz_Option__qoz_Decl_None: { qoz_TypeExpr* _qoz_bv_149;
    {
        qoz_string _qoz_bv_150;
    {
        qoz_Strbuf _qoz_sb_1445_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1445_34); strings_sb_append(&_qoz_sb_1445_34, QOZ_STR_LIT("unknown struct `")); strings_sb_append(&_qoz_sb_1445_34, lookup); strings_sb_append(&_qoz_sb_1445_34, QOZ_STR_LIT("` for field `.")); strings_sb_append(&_qoz_sb_1445_34, field); strings_sb_append(&_qoz_sb_1445_34, QOZ_STR_LIT("`")); _qoz_bv_150 = strings_sb_finish(&_qoz_sb_1445_34);
    }
    (void)(emit_emit_die(sp, _qoz_bv_150)); _qoz_bv_149 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_148 = (_qoz_bv_149);  break; } } _qoz_bv_143 = _qoz_mv_148;
    }
    _qoz_mv_146 = (_qoz_bv_143);  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_146->payload.TETuple.f1; qoz_TypeExpr* _qoz_bv_151;
    {
        int64_t idx = emit_tuple_field_index(field); if ((idx >= 0) && (idx < (elems.len))) { return elems.data[idx];} qoz_string _qoz_bv_152;
    {
        qoz_Strbuf _qoz_sb_1453_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1453_30); strings_sb_append(&_qoz_sb_1453_30, QOZ_STR_LIT("tuple has no field `.")); strings_sb_append(&_qoz_sb_1453_30, field); strings_sb_append(&_qoz_sb_1453_30, QOZ_STR_LIT("`")); _qoz_bv_152 = strings_sb_finish(&_qoz_sb_1453_30);
    }
    (void)(emit_emit_die(sp, _qoz_bv_152)); _qoz_bv_151 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_146 = (_qoz_bv_151);  break; } default: { qoz_TypeExpr* _qoz_bv_153;
    {
        qoz_string _qoz_bv_154;
    {
        qoz_Strbuf _qoz_sb_1457_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1457_30); strings_sb_append(&_qoz_sb_1457_30, QOZ_STR_LIT("field access `.")); strings_sb_append(&_qoz_sb_1457_30, field); strings_sb_append(&_qoz_sb_1457_30, QOZ_STR_LIT("` on a non-named base")); _qoz_bv_154 = strings_sb_finish(&_qoz_sb_1457_30);
    }
    (void)(emit_emit_die(sp, _qoz_bv_154)); _qoz_bv_153 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_146 = (_qoz_bv_153);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_146;
}
...
qoz_Span emit_span_of_te(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_150 = te; qoz_Span _qoz_mv_150 = ((qoz_Span){0}); switch (_qoz_ms_150->tag) { case qoz_TypeExpr_TEUnit: { qoz_Span sp = _qoz_ms_150->payload.TEUnit.f0; _qoz_mv_150 = (sp);  break; } case qoz_TypeExpr_TEPtr: { qoz_Span sp = _qoz_ms_150->payload.TEPtr.f0; _qoz_mv_150 = (sp);  break; } case qoz_TypeExpr_TETuple: { qoz_Span sp = _qoz_ms_150->payload.TETuple.f0; _qoz_mv_150 = (sp);  break; } case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_150->payload.TENamed.f0; _qoz_mv_150 = (sp);  break; } case qoz_TypeExpr_TEFn: { qoz_Span sp = _qoz_ms_150->payload.TEFn.f0; _qoz_mv_150 = (sp);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_150;
}
...
qoz_TypeExpr* emit_binding_te(qoz_Emitter* e, qoz_TypeExpr* declared, qoz_Expr* value) {
    ...
    qoz_gc_push_root(&value);
    qoz_TypeExpr* _qoz_ms_151 = declared; qoz_TypeExpr* _qoz_mv_151 = NULL; switch (_qoz_ms_151->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_151 = (emit_infer_value_te(e, value));  break; } default: { _qoz_mv_151 = (declared);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_151;
}
...
qoz_TypeExpr* emit_infer_value_te_cached(qoz_Emitter* e, qoz_Expr* v) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&v);
    qoz_Option__qoz_TypeExpr* _qoz_ms_152 = qoz_map_get__int64_t__qoz_TypeExpr(&e->expr_types, emit_expr_id(v)); qoz_TypeExpr* _qoz_mv_152 = NULL; switch (_qoz_ms_152->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_152->payload.Some.f0; _qoz_mv_152 = ((((e->current_tparams.len) > 0) ? emit_substitute_type(e, te, e->current_tparams, e->current_targs) : te));  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_152 = (emit_infer_value_te(e, v));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_152;
}
...
qoz_TypeExpr* emit_infer_value_te(qoz_Emitter* e, qoz_Expr* v) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&v);
    qoz_Expr* _qoz_ms_153 = v; qoz_TypeExpr* _qoz_mv_153 = NULL; switch (_qoz_ms_153->tag) { case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_153->payload.ECast.f2; _qoz_mv_153 = (t);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* t = _qoz_ms_153->payload.ERecord.f1; _qoz_mv_153 = (t);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_153->payload.EField.f0; qoz_Expr* base = _qoz_ms_153->payload.EField.f1; qoz_string name = _qoz_ms_153->payload.EField.f2; _qoz_mv_153 = (emit_field_typeexpr_for(e, emit_infer_base_typeexpr(e, base), name, sp));  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_153->payload.EIndex.f0; qoz_Expr* base = _qoz_ms_153->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_155;
    {
        qoz_TypeExpr* bte = emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_154 = bte; qoz_TypeExpr* _qoz_mv_154 = NULL; switch (_qoz_ms_154->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_154->payload.TEPtr.f1; _qoz_mv_154 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_154->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_154->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_156;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(emit_emit_die(sp, QOZ_STR_LIT("let-binding value indexed into non-Vec base; cannot determine binding type"))); _qoz_bv_156 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_154 = (_qoz_bv_156);  break; } default: { qoz_TypeExpr* _qoz_bv_157;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("let-binding value indexed into unrecognised base"))); _qoz_bv_157 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_154 = (_qoz_bv_157);  break; } } _qoz_bv_155 = _qoz_mv_154;
    }
    _qoz_mv_153 = (_qoz_bv_155);  break; } case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_153->payload.EIdent.f0; qoz_string name = _qoz_ms_153->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_155 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_155 = NULL; switch (_qoz_ms_155->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_155->payload.Some.f0; _qoz_mv_155 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_158;
    {
        qoz_string _qoz_bv_159;
    {
        qoz_Strbuf _qoz_sb_1541_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1541_34); strings_sb_append(&_qoz_sb_1541_34, QOZ_STR_LIT("let-binding value references unknown name `")); strings_sb_append(&_qoz_sb_1541_34, name); strings_sb_append(&_qoz_sb_1541_34, QOZ_STR_LIT("`")); _qoz_bv_159 = strings_sb_finish(&_qoz_sb_1541_34);
    }
    (void)(emit_emit_die(sp, _qoz_bv_159)); _qoz_bv_158 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_155 = (_qoz_bv_158);  break; } } _qoz_mv_153 = (_qoz_mv_155);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_153->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_153->payload.ECall.f1; qoz_Vec__qoz_TypeExpr type_args = _qoz_ms_153->payload.ECall.f2; qoz_Vec__qoz_Expr vargs = _qoz_ms_153->payload.ECall.f3; _qoz_mv_153 = (emit_call_return_te(e, callee, type_args, vargs, sp));  break; } case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_153->payload.EInt.f0; _qoz_mv_153 = (emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_153->payload.EFloat.f0; _qoz_mv_153 = (emit_single_named_te(sp, QOZ_STR_LIT("f64")));  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_153->payload.EString.f0; _qoz_mv_153 = (emit_single_named_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_153->payload.EBool.f0; _qoz_mv_153 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_153->payload.EChar.f0; _qoz_mv_153 = (emit_single_named_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Expr_ENil: { qoz_Span sp = _qoz_ms_153->payload.ENil.f0; _qoz_mv_153 = (qoz_make_TypeExpr_TEPtr(sp, emit_single_named_te(sp, QOZ_STR_LIT("void"))));  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_153->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_153->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_153->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_156 = op; qoz_TypeExpr* _qoz_mv_156 = NULL; switch (_qoz_ms_156->tag) { case qoz_UnaryOp_UOpAddr: { _qoz_mv_156 = (qoz_make_TypeExpr_TEPtr(sp, emit_infer_value_te(e, rhs)));  break; } case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_160;
    {
        qoz_TypeExpr* inner = emit_infer_value_te(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_157 = inner; qoz_TypeExpr* _qoz_mv_157 = NULL; switch (_qoz_ms_157->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_157->payload.TEPtr.f1; _qoz_mv_157 = (t);  break; } default: { qoz_TypeExpr* _qoz_bv_161;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("let-binding dereferences a non-pointer"))); _qoz_bv_161 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_157 = (_qoz_bv_161);  break; } } _qoz_bv_160 = _qoz_mv_157;
    }
    _qoz_mv_156 = (_qoz_bv_160);  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_156 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_UnaryOp_UOpNeg: { _qoz_mv_156 = (emit_infer_value_te(e, rhs));  break; } } _qoz_mv_153 = (_qoz_mv_156);  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_153->payload.EBinary.f0; qoz_BinaryOp* op = _qoz_ms_153->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_153->payload.EBinary.f2; qoz_BinaryOp* _qoz_ms_158 = op; qoz_TypeExpr* _qoz_mv_158 = NULL; switch (_qoz_ms_158->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_158 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_158 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_158 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_158 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_158 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_158 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_158 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_158 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } default: { _qoz_mv_158 = (emit_infer_value_te(e, l));  break; } } _qoz_mv_153 = (_qoz_mv_158);  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_153->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_153->payload.EBlock.f2; qoz_TypeExpr* _qoz_bv_162;
    {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_ingest_stmt_locals(e, s); } }_qoz_bv_162 = emit_infer_value_te(e, tail);
    }
    _qoz_mv_153 = (_qoz_bv_162);  break; } case qoz_Expr_EIf: { qoz_Expr* t = _qoz_ms_153->payload.EIf.f2; _qoz_mv_153 = (emit_infer_value_te(e, t));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_153->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_153->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_153->payload.EMatch.f2; qoz_TypeExpr* _qoz_bv_163;
    {
        if ((arms.len) == 0) { (void)(emit_emit_die(sp, QOZ_STR_LIT("match expression with no arms"))); return qoz_make_TypeExpr_TEUnit(sp);} qoz_string bare_enum = emit_find_enum_from_arms(e, arms); qoz_string enum_name = ((qoz_string_eq(bare_enum, QOZ_STR_LIT(""))) ? bare_enum : emit_enum_lookup_name(e, scrut, bare_enum)); emit_bind_arm_locals(e, enum_name, arms.data[0].pat); _qoz_bv_163 = emit_infer_value_te(e, arms.data[0].body);
    }
    _qoz_mv_153 = (_qoz_bv_163);  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_153->payload.ESizeOf.f0; _qoz_mv_153 = (emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_153->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_153->payload.ETuple.f1; qoz_TypeExpr* _qoz_bv_164;
    {
        qoz_Vec__qoz_TypeExpr ets = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ets, emit_infer_value_te(e, el)); } }_qoz_bv_164 = qoz_make_TypeExpr_TETuple(sp, ets);
    }
    _qoz_mv_153 = (_qoz_bv_164);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_153->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_153->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_153->payload.EClosure.f2; qoz_TypeExpr* _qoz_bv_165;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_TypeExpr(&pte, cp.ty); } }_qoz_bv_165 = qoz_make_TypeExpr_TEFn(sp, pte, ret);
    }
    _qoz_mv_153 = (_qoz_bv_165);  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_153->payload.ETry.f0; qoz_Expr* value = _qoz_ms_153->payload.ETry.f1; qoz_TypeExpr* _qoz_bv_166;
    {
        qoz_TypeExpr* inner = emit_infer_value_te(e, value); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_159 = inner; qoz_TypeExpr* _qoz_mv_159 = NULL; switch (_qoz_ms_159->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_159->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_159->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_167;
    {
        if ((args.len) == 2) { if ((path.len) > 0) { qoz_string last = path.data[(path.len) - 1]; if (qoz_string_eq(last, QOZ_STR_LIT("Result"))) { return args.data[0];} } } _qoz_bv_167 = inner;
    }
    _qoz_mv_159 = (_qoz_bv_167);  break; } default: { _qoz_mv_159 = (inner);  break; } } _qoz_bv_166 = _qoz_mv_159;
    }
    _qoz_mv_153 = (_qoz_bv_166);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_153->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_153->payload.EArrayLit.f1; qoz_TypeExpr* _qoz_bv_168;
    {
        if ((elems.len) == 0) { (void)(emit_emit_die(sp, QOZ_STR_LIT("empty array literal: element type cannot be inferred"))); return qoz_make_TypeExpr_TEUnit(sp);} qoz_TypeExpr* elem_te = emit_infer_value_te(e, elems.data[0]); qoz_gc_push_root(&elem_te); qoz_Vec__qoz_TypeExpr args = qoz_vec_make__qoz_TypeExpr(); qoz_vec_push__qoz_TypeExpr(&args, elem_te); qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("Vec")); _qoz_bv_168 = qoz_make_TypeExpr_TENamed(sp, path, args);
    }
    _qoz_mv_153 = (_qoz_bv_168);  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_153->payload.EAssign.f0; _qoz_mv_153 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_153->payload.EWhile.f0; _qoz_mv_153 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_153->payload.EFor.f0; _qoz_mv_153 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_153->payload.EReturn.f0; _qoz_mv_153 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_153->payload.EDefer.f0; _qoz_mv_153 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_153->payload.EPath.f0; qoz_TypeExpr* _qoz_bv_169;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("EPath in value position is not supported (expected pkg.fn or a record name)"))); _qoz_bv_169 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_153 = (_qoz_bv_169);  break; } default: { qoz_TypeExpr* _qoz_bv_170;
    {
        (void)(emit_emit_die(emit_span_of_expr(v), QOZ_STR_LIT("let-binding value shape not handled by inference"))); _qoz_bv_170 = qoz_make_TypeExpr_TEUnit(emit_span_of_expr(v));
    }
    _qoz_mv_153 = (_qoz_bv_170);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_153;
}
...
qoz_Vec__qoz_TypeExpr emit_infer_variant_type_args(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, qoz_Vec__qoz_Expr args, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_TypeExpr out = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Decl* _qoz_ms_160 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, enum_name); qoz_Vec__qoz_TypeExpr _qoz_mv_160 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_160->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_160 = (out);  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_160->payload.Some.f0; qoz_Decl* _qoz_ms_161 = d; qoz_Vec__qoz_TypeExpr _qoz_mv_161 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_161->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_161->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_161->payload.DEnum.f3; qoz_Vec__qoz_TypeExpr _qoz_bv_171;
    {
        if ((tparams.len) == 0) { return out;} qoz_Map__qoz_string__qoz_TypeExpr bindings = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_string_eq(v.name, variant)) { int64_t i = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pos_te = __col.data[__i]; (void)pos_te; if (i < (args.len)) { qoz_TypeExpr* arg_te = emit_infer_value_te(e, args.data[i]); qoz_gc_push_root(&arg_te); emit_unify_te(pos_te, arg_te, &bindings); } i = i + 1; } }} } }{ qoz_Vec__qoz_string __col = tparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string tp = __col.data[__i]; (void)tp; qoz_Option__qoz_TypeExpr* _qoz_ms_162 = qoz_map_get__qoz_string__qoz_TypeExpr(&bindings, tp); switch (_qoz_ms_162->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_162->payload.Some.f0; qoz_vec_push__qoz_TypeExpr(&out, t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_vec_push__qoz_TypeExpr(&out, emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } } 0; } }_qoz_bv_171 = out;
    }
    _qoz_mv_161 = (_qoz_bv_171);  break; } default: { _qoz_mv_161 = (out);  break; } } _qoz_mv_160 = (_qoz_mv_161);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_160;
}
...
void emit_unify_te(qoz_TypeExpr* pattern, qoz_TypeExpr* concrete, qoz_Map__qoz_string__qoz_TypeExpr* env) {
    ...
    qoz_gc_push_root(&concrete);
    qoz_gc_push_root(&env);
    qoz_TypeExpr* _qoz_ms_163 = pattern; switch (_qoz_ms_163->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_163->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr p_args = _qoz_ms_163->payload.TENamed.f2; {
        if (((path.len) == 1) && ((p_args.len) == 0)) { qoz_string n = path.data[0]; if (emit_is_type_var_name(n)) { if (!qoz_map_contains__qoz_string__qoz_TypeExpr(env, n)) { qoz_map_set__qoz_string__qoz_TypeExpr(env, n, concrete); } return;} } qoz_TypeExpr* _qoz_ms_164 = concrete; switch (_qoz_ms_164->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string c_path = _qoz_ms_164->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr c_args = _qoz_ms_164->payload.TENamed.f2; if ((p_args.len) == (c_args.len)) { int64_t i = 0; while (i < (p_args.len)) { emit_unify_te(p_args.data[i], c_args.data[i], env); i = i + 1; } } 0;  break; } default: { NULL;  break; } } 0; 
    }
    0;  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* p_inner = _qoz_ms_163->payload.TEPtr.f1; qoz_TypeExpr* _qoz_ms_165 = concrete; switch (_qoz_ms_165->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* c_inner = _qoz_ms_165->payload.TEPtr.f1; emit_unify_te(p_inner, c_inner, env);  break; } default: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
qoz_TypeExpr* emit_call_return_te(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_Span sp) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_string name = emit_generic_callee_name(e, callee); if (qoz_string_eq(name, QOZ_STR_LIT(""))) { (void)(emit_emit_die(sp, QOZ_STR_LIT("could not derive return type: callee has no recognisable name"))); return qoz_make_TypeExpr_TEUnit(sp);} if (qoz_string_eq(name, QOZ_STR_LIT("len"))) { return emit_single_named_te(sp, QOZ_STR_LIT("i64"));} if (qoz_string_eq(name, QOZ_STR_LIT("size_of"))) { return emit_single_named_te(sp, QOZ_STR_LIT("i64"));} if (qoz_string_eq(name, QOZ_STR_LIT("hash"))) { return emit_single_named_te(sp, QOZ_STR_LIT("u64"));} qoz_Option__qoz_string* _qoz_ms_166 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_166->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_166->payload.Some.f0; {
    ...
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; qoz_Option__qoz_Decl* _qoz_ms_167 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_fn_decls, name); qoz_TypeExpr* _qoz_mv_167 = NULL; switch (_qoz_ms_167->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_167->payload.Some.f0; qoz_Decl* _qoz_ms_168 = d; qoz_TypeExpr* _qoz_mv_168 = NULL; switch (_qoz_ms_168->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_168->payload.DFn.f2; qoz_TypeExpr* ret = _qoz_ms_168->payload.DFn.f4; qoz_TypeExpr* _qoz_bv_172;
    {
        if (((type_args.len) == (tparams.len)) && ((tparams.len) > 0)) { return emit_substitute_type(e, ret, tparams, type_args);} _qoz_bv_172 = ret;
    }
    _qoz_mv_168 = (_qoz_bv_172);  break; } default: { qoz_TypeExpr* _qoz_bv_173;
    {
        qoz_string _qoz_bv_174;
    {
        qoz_Strbuf _qoz_sb_1776_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1776_34); strings_sb_append(&_qoz_sb_1776_34, QOZ_STR_LIT("`")); strings_sb_append(&_qoz_sb_1776_34, name); strings_sb_append(&_qoz_sb_1776_34, QOZ_STR_LIT("` is in generic_fn_decls but not a DFn")); _qoz_bv_174 = strings_sb_finish(&_qoz_sb_1776_34);
    }
    (void)(emit_emit_die(sp, _qoz_bv_174)); _qoz_bv_173 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_168 = (_qoz_bv_173);  break; } } _qoz_mv_167 = (_qoz_mv_168);  break; } case qoz_Option__qoz_Decl_None: { qoz_Option__qoz_TypeExpr* _qoz_ms_169 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->fn_returns, name); qoz_TypeExpr* _qoz_mv_169 = NULL; switch (_qoz_ms_169->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_169->payload.Some.f0; _qoz_mv_169 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_175;
    {
        qoz_string _qoz_bv_176;
    {
        qoz_Strbuf _qoz_sb_1785_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1785_34); strings_sb_append(&_qoz_sb_1785_34, QOZ_STR_LIT("call to unknown function `")); strings_sb_append(&_qoz_sb_1785_34, name); strings_sb_append(&_qoz_sb_1785_34, QOZ_STR_LIT("` (no DFn, DExternal, or builtin matched)")); _qoz_bv_176 = strings_sb_finish(&_qoz_sb_1785_34);
    }
    (void)(emit_emit_die(sp, _qoz_bv_176)); _qoz_bv_175 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_169 = (_qoz_bv_175);  break; } } _qoz_mv_167 = (_qoz_mv_169);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_167;
}
...
void emit_emit_stmt_inner(qoz_Emitter* e, qoz_Stmt* s) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_170 = s; switch (_qoz_ms_170->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_170->payload.SLet.f1; qoz_TypeExpr* ty = _qoz_ms_170->payload.SLet.f2; qoz_Expr* value = _qoz_ms_170->payload.SLet.f3; {
        qoz_TypeExpr* bind_te = emit_binding_te(e, ty, value); qoz_gc_push_root(&bind_te); if (qoz_string_eq(name, QOZ_STR_LIT("_"))) { emit_push(e, QOZ_STR_LIT("(void)(")); emit_emit_value_with_hint(e, value, bind_te); emit_push(e, QOZ_STR_LIT("); ")); return;} qoz_string ct = emit_infer_value_ctype(e, ty, value); qoz_string _qoz_bv_177;
    {
        qoz_Strbuf _qoz_sb_1854_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1854_17); strings_sb_append(&_qoz_sb_1854_17, ct); strings_sb_append(&_qoz_sb_1854_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1854_17, name); strings_sb_append(&_qoz_sb_1854_17, QOZ_STR_LIT(" = ")); _qoz_bv_177 = strings_sb_finish(&_qoz_sb_1854_17);
    }
    emit_push(e, _qoz_bv_177); emit_emit_value_with_hint(e, value, bind_te); emit_push(e, QOZ_STR_LIT("; ")); if (emit_c_type_is_pointer(ct)) { qoz_string _qoz_bv_178;
    {
        qoz_Strbuf _qoz_sb_1858_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1858_21); strings_sb_append(&_qoz_sb_1858_21, QOZ_STR_LIT("qoz_gc_push_root(&")); strings_sb_append(&_qoz_sb_1858_21, name); strings_sb_append(&_qoz_sb_1858_21, QOZ_STR_LIT("); ")); _qoz_bv_178 = strings_sb_finish(&_qoz_sb_1858_21);
    }
    emit_push(e, _qoz_bv_178); } qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, bind_te); 
    }
    0;  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_170->payload.SVar.f1; qoz_TypeExpr* ty = _qoz_ms_170->payload.SVar.f2; qoz_Expr* value = _qoz_ms_170->payload.SVar.f3; {
        qoz_TypeExpr* bind_te = emit_binding_te(e, ty, value); qoz_gc_push_root(&bind_te); if (qoz_string_eq(name, QOZ_STR_LIT("_"))) { emit_push(e, QOZ_STR_LIT("(void)(")); emit_emit_value_with_hint(e, value, bind_te); emit_push(e, QOZ_STR_LIT("); ")); return;} qoz_string ct = emit_infer_value_ctype(e, ty, value); qoz_string _qoz_bv_179;
    {
        qoz_Strbuf _qoz_sb_1871_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1871_17); strings_sb_append(&_qoz_sb_1871_17, ct); strings_sb_append(&_qoz_sb_1871_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1871_17, name); strings_sb_append(&_qoz_sb_1871_17, QOZ_STR_LIT(" = ")); _qoz_bv_179 = strings_sb_finish(&_qoz_sb_1871_17);
    }
    emit_push(e, _qoz_bv_179); emit_emit_value_with_hint(e, value, bind_te); emit_push(e, QOZ_STR_LIT("; ")); if (emit_c_type_is_pointer(ct)) { qoz_string _qoz_bv_180;
    {
        qoz_Strbuf _qoz_sb_1875_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1875_21); strings_sb_append(&_qoz_sb_1875_21, QOZ_STR_LIT("qoz_gc_push_root(&")); strings_sb_append(&_qoz_sb_1875_21, name); strings_sb_append(&_qoz_sb_1875_21, QOZ_STR_LIT("); ")); _qoz_bv_180 = strings_sb_finish(&_qoz_sb_1875_21);
    }
    emit_push(e, _qoz_bv_180); } qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, bind_te); 
    }
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* expr = _qoz_ms_170->payload.SExpr.f1; qoz_Expr* _qoz_ms_171 = expr; switch (_qoz_ms_171->tag) { case qoz_Expr_EDefer: { NULL;  break; } default: { emit_emit_stmt_expr(e, expr);  break; } } 0;  break; } } 0; 
    return;
}

qoz_Vec__qoz_Expr emit_collect_defers_in_stmts(qoz_Vec__qoz_Stmt stmts) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_Vec__qoz_Expr defers = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_Stmt* _qoz_ms_172 = s; switch (_qoz_ms_172->tag) { case qoz_Stmt_SExpr: { qoz_Expr* expr = _qoz_ms_172->payload.SExpr.f1; qoz_Expr* _qoz_ms_173 = expr; switch (_qoz_ms_173->tag) { case qoz_Expr_EDefer: { qoz_Expr* body = _qoz_ms_173->payload.EDefer.f1; qoz_vec_push__qoz_Expr(&defers, body);  break; } default: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return defers;
}
...
void emit_emit_cond(qoz_Emitter* e, qoz_Expr* cond) {
    ...
    emit_push(e, QOZ_STR_LIT("(")); qoz_Expr* _qoz_ms_174 = cond; switch (_qoz_ms_174->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_174->payload.EBinary.f1; qoz_Expr* lhs = _qoz_ms_174->payload.EBinary.f2; qoz_Expr* rhs = _qoz_ms_174->payload.EBinary.f3; emit_emit_binary(e, op, lhs, rhs);  break; } default: { emit_emit_expr(e, cond);  break; } } 0; emit_push(e, QOZ_STR_LIT(")")); 
    return;
}
...
void emit_emit_stmt_expr(qoz_Emitter* e, qoz_Expr* expr) {
    ...
    qoz_Expr* _qoz_ms_175 = expr; switch (_qoz_ms_175->tag) { case qoz_Expr_EIf: { qoz_Expr* cond = _qoz_ms_175->payload.EIf.f1; qoz_Expr* then_b = _qoz_ms_175->payload.EIf.f2; qoz_Expr* else_b = _qoz_ms_175->payload.EIf.f3; {
    ...
    0;  break; } case qoz_Expr_EWhile: { qoz_Expr* cond = _qoz_ms_175->payload.EWhile.f1; qoz_Expr* body = _qoz_ms_175->payload.EWhile.f2; {
        emit_push(e, QOZ_STR_LIT("while (")); emit_emit_expr(e, cond); emit_push(e, QOZ_STR_LIT(") ")); emit_emit_branch_as_statement(e, body); 
    }
    0;  break; } case qoz_Expr_EFor: { qoz_string binding = _qoz_ms_175->payload.EFor.f1; qoz_string binding2 = _qoz_ms_175->payload.EFor.f2; qoz_Expr* iter = _qoz_ms_175->payload.EFor.f3; qoz_Expr* body = _qoz_ms_175->payload.EFor.f4; emit_emit_for_loop_one(e, binding, binding2, iter, body);  break; } case qoz_Expr_EReturn: { qoz_Expr* value = _qoz_ms_175->payload.EReturn.f1; if (emit_is_nil_expr(value)) { emit_push(e, QOZ_STR_LIT("return;")); }  else { emit_push(e, QOZ_STR_LIT("return ")); emit_emit_value_with_hint(e, value, e->current_ret_te); emit_push(e, QOZ_STR_LIT(";")); } 0;  break; } default: { {
...
void emit_emit_branch_as_statement(qoz_Emitter* e, qoz_Expr* br) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&br);
    qoz_Expr* _qoz_ms_176 = br; switch (_qoz_ms_176->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_176->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_176->payload.EBlock.f2; {
...
bool emit_path_is(qoz_Expr* callee, qoz_string a, qoz_string b) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_177 = callee; bool _qoz_mv_177 = false; switch (_qoz_ms_177->tag) { case qoz_Expr_EPath: { qoz_Vec__qoz_string segs = _qoz_ms_177->payload.EPath.f1; _qoz_mv_177 = ((((segs.len) == 2) && qoz_string_eq(segs.data[0], a)) && qoz_string_eq(segs.data[1], b));  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_177->payload.EField.f1; qoz_string name = _qoz_ms_177->payload.EField.f2; _qoz_mv_177 = (qoz_string_eq(name, b) && emit_ident_is(base, a));  break; } default: { _qoz_mv_177 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_177;
}

bool emit_ident_is(qoz_Expr* ex, qoz_string name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_178 = ex; bool _qoz_mv_178 = false; switch (_qoz_ms_178->tag) { case qoz_Expr_EIdent: { qoz_string n = _qoz_ms_178->payload.EIdent.f1; _qoz_mv_178 = (qoz_string_eq(n, name));  break; } default: { _qoz_mv_178 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_178;
}
...
qoz_string emit_qualified_call_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_179 = callee; qoz_string _qoz_mv_179 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_179->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_179->payload.EField.f1; qoz_string method = _qoz_ms_179->payload.EField.f2; qoz_Expr* _qoz_ms_180 = base; qoz_string _qoz_mv_180 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_180->tag) { case qoz_Expr_EIdent: { qoz_string pkg = _qoz_ms_180->payload.EIdent.f1; qoz_string _qoz_bv_181;
    {
        if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_string_cat(qoz_string_cat(pkg, QOZ_STR_LIT("_")), method);} _qoz_bv_181 = QOZ_STR_LIT("");
    }
    _qoz_mv_180 = (_qoz_bv_181);  break; } default: { _qoz_mv_180 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_179 = (_qoz_mv_180);  break; } default: { _qoz_mv_179 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_179;
}
...
qoz_string emit_arm_body_ctype(qoz_Emitter* e, qoz_string enum_name, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_181 = body; qoz_string _qoz_mv_181 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_181->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_181->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_182 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_182 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_182->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_182->payload.Some.f0; qoz_string _qoz_bv_182;
    {
        if (emit_same_enum_base(e, en, enum_name)) { return qoz_string_cat(qoz_string_cat(QOZ_STR_LIT("qoz_"), enum_name), QOZ_STR_LIT("*"));} _qoz_bv_182 = qoz_string_cat(qoz_string_cat(QOZ_STR_LIT("qoz_"), en), QOZ_STR_LIT("*"));
    }
    _qoz_mv_182 = (_qoz_bv_182);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_182 = (emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_181 = (_qoz_mv_182);  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_181->payload.ECall.f1; qoz_Expr* _qoz_ms_183 = callee; qoz_string _qoz_mv_183 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_183->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_183->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_184 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_184 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_184->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_184->payload.Some.f0; qoz_string _qoz_bv_183;
    {
        if (emit_same_enum_base(e, en, enum_name)) { return qoz_string_cat(qoz_string_cat(QOZ_STR_LIT("qoz_"), enum_name), QOZ_STR_LIT("*"));} _qoz_bv_183 = qoz_string_cat(qoz_string_cat(QOZ_STR_LIT("qoz_"), en), QOZ_STR_LIT("*"));
    }
    _qoz_mv_184 = (_qoz_bv_183);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_184 = (emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_183 = (_qoz_mv_184);  break; } default: { _qoz_mv_183 = (emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_181 = (_qoz_mv_183);  break; } default: { _qoz_mv_181 = (emit_infer_expr_ctype(e, body));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_181;
}
...
void emit_bind_arm_locals(qoz_Emitter* e, qoz_string enum_name, qoz_Pattern* pat) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&pat);
    qoz_Pattern* _qoz_ms_185 = pat; switch (_qoz_ms_185->tag) { case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_185->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_185->payload.PatVariant.f2; {
        if ((path.len) < 1) { return;} qoz_string vname = path.data[(path.len) - 1]; int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_186 = sp; switch (_qoz_ms_186->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_186->payload.PatBind.f1; (qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, emit_variant_payload_typeexpr(e, enum_name, vname, i)), 0);  break; } default: { NULL;  break; } } 0; i = i + 1; } }
    }
    0;  break; } case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_185->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_187 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, bname); switch (_qoz_ms_187->tag) { case qoz_Option__qoz_string_Some: { NULL;  break; } case qoz_Option__qoz_string_None: { {
...
void emit_emit_field(qoz_Emitter* e, qoz_Expr* base, qoz_string name) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base);
    qoz_string op = emit_field_access_op(e, base); emit_emit_expr(e, base); qoz_string _qoz_bv_184;
    {
        qoz_Strbuf _qoz_sb_2129_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2129_13); strings_sb_append(&_qoz_sb_2129_13, op); strings_sb_append(&_qoz_sb_2129_13, name); _qoz_bv_184 = strings_sb_finish(&_qoz_sb_2129_13);
    }
    emit_push(e, _qoz_bv_184); 
    return;
}
...
qoz_string emit_field_access_op(qoz_Emitter* e, qoz_Expr* base) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_188 = base; qoz_string _qoz_mv_188 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_188->tag) { case qoz_Expr_EIdent: { qoz_string ident = _qoz_ms_188->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_189 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, ident); qoz_string _qoz_mv_189 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_189->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_189->payload.Some.f0; qoz_TypeExpr* _qoz_ms_190 = te; qoz_string _qoz_mv_190 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_190->tag) { case qoz_TypeExpr_TEPtr: { _qoz_mv_190 = (QOZ_STR_LIT("->"));  break; } default: { _qoz_mv_190 = (QOZ_STR_LIT("."));  break; } } _qoz_mv_189 = (_qoz_mv_190);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_189 = (QOZ_STR_LIT("."));  break; } } _qoz_mv_188 = (_qoz_mv_189);  break; } case qoz_Expr_EUnary: { qoz_UnaryOp* op = _qoz_ms_188->payload.EUnary.f1; qoz_UnaryOp* _qoz_ms_191 = op; qoz_string _qoz_mv_191 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_191->tag) { case qoz_UnaryOp_UOpAddr: { _qoz_mv_191 = (QOZ_STR_LIT("->"));  break; } default: { _qoz_mv_191 = (QOZ_STR_LIT("."));  break; } } _qoz_mv_188 = (_qoz_mv_191);  break; } default: { _qoz_mv_188 = (QOZ_STR_LIT("."));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_188;
}
...
void emit_walk_assign_for_map_helpers(qoz_Emitter* e, qoz_Expr* lhs) {
    ...
    qoz_Expr* _qoz_ms_192 = lhs; switch (_qoz_ms_192->tag) { case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_192->payload.EIndex.f1; {
        qoz_TypeExpr* bte = emit_base_type_for_walk(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_193 = bte; switch (_qoz_ms_193->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_193->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_193->payload.TENamed.f2; if ((((path.len) >= 1) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) && ((args.len) == 2)) { emit_register_map_helper(e, QOZ_STR_LIT("map_set"), args); } 0;  break; } default: { NULL;  break; } } 0; 
    }
    0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
qoz_TypeExpr* emit_base_type_for_walk(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_194 = ex; qoz_TypeExpr* _qoz_mv_194 = NULL; switch (_qoz_ms_194->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_194->payload.EIdent.f0; qoz_string name = _qoz_ms_194->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_195 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_195 = NULL; switch (_qoz_ms_195->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_195->payload.Some.f0; _qoz_mv_195 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_195 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_194 = (_qoz_mv_195);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_194->payload.EField.f0; qoz_Expr* b = _qoz_ms_194->payload.EField.f1; qoz_string name = _qoz_ms_194->payload.EField.f2; qoz_TypeExpr* _qoz_bv_185;
    {
        qoz_TypeExpr* bte = emit_base_type_for_walk(e, b); qoz_gc_push_root(&bte); _qoz_bv_185 = emit_field_typeexpr_for_no_die(e, bte, name, sp);
    }
    _qoz_mv_194 = (_qoz_bv_185);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_194->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_194->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_194->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_196 = op; qoz_TypeExpr* _qoz_mv_196 = NULL; switch (_qoz_ms_196->tag) { case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_186;
    {
        qoz_TypeExpr* inner = emit_base_type_for_walk(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_197 = inner; qoz_TypeExpr* _qoz_mv_197 = NULL; switch (_qoz_ms_197->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_197->payload.TEPtr.f1; _qoz_mv_197 = (t);  break; } default: { _qoz_mv_197 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_186 = _qoz_mv_197;
    }
    _qoz_mv_196 = (_qoz_bv_186);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_196 = (qoz_make_TypeExpr_TEPtr(sp, emit_base_type_for_walk(e, rhs)));  break; } default: { _qoz_mv_196 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_194 = (_qoz_mv_196);  break; } default: { _qoz_mv_194 = (qoz_make_TypeExpr_TEUnit(emit_span_of_expr(ex)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_194;
}
...
qoz_TypeExpr* emit_field_typeexpr_for_no_die(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base_te);
    qoz_TypeExpr* _qoz_ms_198 = base_te; qoz_TypeExpr* _qoz_mv_198 = NULL; switch (_qoz_ms_198->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_198->payload.TEPtr.f1; _qoz_mv_198 = (inner);  break; } default: { _qoz_mv_198 = (base_te);  break; } } qoz_TypeExpr* unwrapped = _qoz_mv_198; qoz_gc_push_root(&unwrapped); qoz_TypeExpr* _qoz_ms_199 = unwrapped; qoz_TypeExpr* _qoz_mv_199 = NULL; switch (_qoz_ms_199->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_199->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_199->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_187;
    {
        if ((path.len) < 1) { return qoz_make_TypeExpr_TEUnit(sp);} qoz_string lookup = emit_type_lookup_key(e, path); qoz_Option__qoz_Decl* _qoz_ms_200 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, lookup); qoz_Option__qoz_Decl* _qoz_mv_200 = NULL; switch (_qoz_ms_200->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_200->payload.Some.f0; _qoz_mv_200 = (qoz_make_Option__qoz_Decl_Some(d));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_200 = (qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, lookup));  break; } } qoz_Option__qoz_Decl* decl_opt = _qoz_mv_200; qoz_gc_push_root(&decl_opt); qoz_Option__qoz_Decl* _qoz_ms_201 = decl_opt; qoz_TypeExpr* _qoz_mv_201 = NULL; switch (_qoz_ms_201->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_201->payload.Some.f0; qoz_Decl* _qoz_ms_202 = decl; qoz_TypeExpr* _qoz_mv_202 = NULL; switch (_qoz_ms_202->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_202->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_202->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_188;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_string_eq(f.name, field)) { if ((args.len) == (params.len)) { return emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }_qoz_bv_188 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_202 = (_qoz_bv_188);  break; } default: { _qoz_mv_202 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_201 = (_qoz_mv_202);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_201 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_187 = _qoz_mv_201;
    }
    _qoz_mv_199 = (_qoz_bv_187);  break; } default: { _qoz_mv_199 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_199;
}

void emit_register_map_helper(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_TypeExpr args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    if (!qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, name)) { return;} qoz_string mangled = emit_mangle_inst(e, name, args); if (qoz_map_contains__qoz_string__bool(&e->fn_seen, mangled)) { return;} qoz_map_set__qoz_string__bool(&e->fn_seen, mangled, true); qoz_vec_push__qoz_Instantiation(&e->fn_insts, ((qoz_Instantiation){ .name = name, .args = args, .mangled = mangled })); qoz_Option__qoz_Decl* _qoz_ms_203 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_fn_decls, name); switch (_qoz_ms_203->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_203->payload.Some.f0; emit_walk_fn_body_with_subst(e, d, args);  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; 
    return;
}
...
void emit_emit_assign(qoz_Emitter* e, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    qoz_gc_push_root(&lhs);
    qoz_gc_push_root(&rhs);
    qoz_Expr* _qoz_ms_204 = lhs; switch (_qoz_ms_204->tag) { case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_204->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_204->payload.EIndex.f2; {
        qoz_TypeExpr* te = emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_205 = te; switch (_qoz_ms_205->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_205->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_205->payload.TENamed.f2; if ((((path.len) >= 1) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) && ((args.len) == 2)) { emit_register_map_helper(e, QOZ_STR_LIT("map_set"), args); qoz_string k_m = emit_mangle_type(e, args.data[0]); qoz_string v_m = emit_mangle_type(e, args.data[1]); qoz_string _qoz_bv_189;
    {
        qoz_Strbuf _qoz_sb_2270_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2270_25); strings_sb_append(&_qoz_sb_2270_25, QOZ_STR_LIT("qoz_map_set__")); strings_sb_append(&_qoz_sb_2270_25, k_m); strings_sb_append(&_qoz_sb_2270_25, QOZ_STR_LIT("__")); strings_sb_append(&_qoz_sb_2270_25, v_m); strings_sb_append(&_qoz_sb_2270_25, QOZ_STR_LIT("(&")); _qoz_bv_189 = strings_sb_finish(&_qoz_sb_2270_25);
    }
    emit_push(e, _qoz_bv_189); emit_emit_expr(e, base); emit_push(e, QOZ_STR_LIT(", ")); emit_emit_expr(e, idx); emit_push(e, QOZ_STR_LIT(", ")); emit_emit_expr(e, rhs); emit_push(e, QOZ_STR_LIT(")")); return;} 0;  break; } default: { NULL;  break; } } 0; 
    }
...
qoz_TypeExpr* emit_lvalue_hint(qoz_Emitter* e, qoz_Expr* lhs) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&lhs);
    qoz_Span sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_Expr* _qoz_ms_206 = lhs; qoz_TypeExpr* _qoz_mv_206 = NULL; switch (_qoz_ms_206->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_206->payload.EField.f1; qoz_string name = _qoz_ms_206->payload.EField.f2; qoz_TypeExpr* _qoz_bv_190;
    {
        qoz_TypeExpr* bte = emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); _qoz_bv_190 = emit_field_typeexpr_for_no_die(e, bte, name, sp);
    }
    _qoz_mv_206 = (_qoz_bv_190);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_206->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_191;
    {
        qoz_TypeExpr* bte = emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_207 = bte; qoz_TypeExpr* _qoz_mv_207 = NULL; switch (_qoz_ms_207->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_207->payload.TEPtr.f1; _qoz_mv_207 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_207->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_207->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_192;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_192 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_207 = (_qoz_bv_192);  break; } default: { _qoz_mv_207 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_191 = _qoz_mv_207;
    }
    _qoz_mv_206 = (_qoz_bv_191);  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_206->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_208 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_208 = NULL; switch (_qoz_ms_208->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_208->payload.Some.f0; _qoz_mv_208 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_208 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_206 = (_qoz_mv_208);  break; } default: { _qoz_mv_206 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_206;
}
...
void emit_emit_index(qoz_Emitter* e, qoz_Expr* base, qoz_Expr* idx) {
    ...
    qoz_gc_push_root(&base);
    qoz_gc_push_root(&idx);
    qoz_TypeExpr* te = emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_209 = te; switch (_qoz_ms_209->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_209->payload.TENamed.f1; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_string_eq(n, QOZ_STR_LIT("Vec"))) { qoz_string op = emit_field_access_op(e, base); emit_emit_expr(e, base); qoz_string _qoz_bv_193;
    {
        qoz_Strbuf _qoz_sb_2330_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2330_25); strings_sb_append(&_qoz_sb_2330_25, op); strings_sb_append(&_qoz_sb_2330_25, QOZ_STR_LIT("data[")); _qoz_bv_193 = strings_sb_finish(&_qoz_sb_2330_25);
    }
    emit_push(e, _qoz_bv_193); emit_emit_expr(e, idx); emit_push(e, QOZ_STR_LIT("]")); return;} } 0;  break; } default: { NULL;  break; } } 0; emit_emit_expr(e, base); emit_push(e, QOZ_STR_LIT("[")); emit_emit_expr(e, idx); emit_push(e, QOZ_STR_LIT("]")); 
    return;
}
...
void emit_emit_hash_builtin(qoz_Emitter* e, qoz_Expr* arg) {
    ...
    qoz_string ct = emit_infer_expr_ctype(e, arg); if (qoz_string_eq(ct, QOZ_STR_LIT("qoz_string"))) { emit_push(e, QOZ_STR_LIT("qoz_string_hash(")); emit_emit_expr(e, arg); emit_push(e, QOZ_STR_LIT(")")); return;} qoz_string record_name = emit_record_struct_name_of_ctype(e, ct); if (!qoz_string_eq(record_name, QOZ_STR_LIT(""))) { qoz_string _qoz_bv_194;
    {
        qoz_Strbuf _qoz_sb_2354_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2354_17); strings_sb_append(&_qoz_sb_2354_17, QOZ_STR_LIT("qoz_hash_")); strings_sb_append(&_qoz_sb_2354_17, record_name); strings_sb_append(&_qoz_sb_2354_17, QOZ_STR_LIT("(")); _qoz_bv_194 = strings_sb_finish(&_qoz_sb_2354_17);
    }
    emit_push(e, _qoz_bv_194); emit_emit_expr(e, arg); emit_push(e, QOZ_STR_LIT(")")); return;} emit_push(e, QOZ_STR_LIT("(uint64_t)(")); emit_emit_expr(e, arg); emit_push(e, QOZ_STR_LIT(")")); 
    return;
}
...
void emit_emit_call(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_string qualified = emit_qualified_call_name(e, callee); if (!qoz_string_eq(qualified, QOZ_STR_LIT(""))) { if (((type_args.len) > 0) && qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, qualified)) { qoz_string mi = emit_mangle_inst(e, qualified, type_args); qoz_string _qoz_bv_195;
    {
        qoz_Strbuf _qoz_sb_2389_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2389_21); strings_sb_append(&_qoz_sb_2389_21, QOZ_STR_LIT("qoz_")); strings_sb_append(&_qoz_sb_2389_21, mi); strings_sb_append(&_qoz_sb_2389_21, QOZ_STR_LIT("(")); _qoz_bv_195 = strings_sb_finish(&_qoz_sb_2389_21);
    }
    emit_push(e, _qoz_bv_195); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, a); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;} qoz_Option__qoz_string* _qoz_ms_210 = qoz_map_get__qoz_string__qoz_string(&e->externs, qualified); qoz_string _qoz_mv_210 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_210->tag) { case qoz_Option__qoz_string_Some: { qoz_string sym = _qoz_ms_210->payload.Some.f0; _qoz_mv_210 = (sym);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_210 = (qualified);  break; } } qoz_string dispatch_name = _qoz_mv_210; qoz_string _qoz_bv_196;
    {
        qoz_Strbuf _qoz_sb_2403_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2403_17); strings_sb_append(&_qoz_sb_2403_17, dispatch_name); strings_sb_append(&_qoz_sb_2403_17, QOZ_STR_LIT("(")); _qoz_bv_196 = strings_sb_finish(&_qoz_sb_2403_17);
    }
    emit_push(e, _qoz_bv_196); qoz_Vec__qoz_TypeExpr hints = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Vec__qoz_TypeExpr* _qoz_ms_211 = qoz_map_get__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, qualified); switch (_qoz_ms_211->tag) { case qoz_Option__qoz_Vec__qoz_TypeExpr_Some: { qoz_Vec__qoz_TypeExpr pts = _qoz_ms_211->payload.Some.f0; hints = pts;  break; } case qoz_Option__qoz_Vec__qoz_TypeExpr_None: { NULL;  break; } } 0; int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } if (i < (hints.len)) { emit_emit_value_with_hint(e, a, hints.data[i]); }  else { emit_emit_expr(e, a); } i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;} qoz_Expr* _qoz_ms_212 = callee; switch (_qoz_ms_212->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_212->payload.EIdent.f1; {
    ...
    0;  break; } default: { NULL;  break; } } 0; qoz_Expr* _qoz_ms_213 = callee; switch (_qoz_ms_213->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_213->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_214 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_214->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_214->payload.Some.f0; {
        qoz_string _qoz_bv_197;
    {
        qoz_Strbuf _qoz_sb_2444_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2444_21); strings_sb_append(&_qoz_sb_2444_21, QOZ_STR_LIT("qoz_make_")); strings_sb_append(&_qoz_sb_2444_21, enum_name); strings_sb_append(&_qoz_sb_2444_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_2444_21, name); strings_sb_append(&_qoz_sb_2444_21, QOZ_STR_LIT("(")); _qoz_bv_197 = strings_sb_finish(&_qoz_sb_2444_21);
    }
    emit_push(e, _qoz_bv_197); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, a); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; if ((type_args.len) > 0) { qoz_Expr* _qoz_ms_215 = callee; switch (_qoz_ms_215->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_215->payload.EIdent.f1; if (qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, name)) { qoz_string mi = emit_mangle_inst(e, name, type_args); qoz_string _qoz_bv_198;
    {
        qoz_Strbuf _qoz_sb_2465_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2465_25); strings_sb_append(&_qoz_sb_2465_25, QOZ_STR_LIT("qoz_")); strings_sb_append(&_qoz_sb_2465_25, mi); strings_sb_append(&_qoz_sb_2465_25, QOZ_STR_LIT("(")); _qoz_bv_198 = strings_sb_finish(&_qoz_sb_2465_25);
    }
    emit_push(e, _qoz_bv_198); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, a); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;} 0;  break; } default: { NULL;  break; } } 0; } qoz_Expr* _qoz_ms_216 = callee; switch (_qoz_ms_216->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_216->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_217 = qoz_map_get__qoz_string__qoz_string(&e->externs, name); switch (_qoz_ms_217->tag) { case qoz_Option__qoz_string_Some: { qoz_string sym = _qoz_ms_217->payload.Some.f0; {
        qoz_string _qoz_bv_199;
    {
        qoz_Strbuf _qoz_sb_2484_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2484_21); strings_sb_append(&_qoz_sb_2484_21, sym); strings_sb_append(&_qoz_sb_2484_21, QOZ_STR_LIT("(")); _qoz_bv_199 = strings_sb_finish(&_qoz_sb_2484_21);
    }
    emit_push(e, _qoz_bv_199); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, a); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; qoz_TypeExpr* callee_te = emit_callee_value_typeexpr(e, callee); qoz_gc_push_root(&callee_te); qoz_TypeExpr* _qoz_ms_218 = callee_te; switch (_qoz_ms_218->tag) { case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr fn_params_te = _qoz_ms_218->payload.TEFn.f1; {
    ...
    0;  break; } default: { NULL;  break; } } 0; emit_emit_expr(e, callee); emit_push(e, QOZ_STR_LIT("(")); qoz_Vec__qoz_TypeExpr fallback_hints = qoz_vec_make__qoz_TypeExpr(); qoz_Expr* _qoz_ms_219 = callee; switch (_qoz_ms_219->tag) { case qoz_Expr_EIdent: { qoz_string cname = _qoz_ms_219->payload.EIdent.f1; qoz_Option__qoz_Vec__qoz_TypeExpr* _qoz_ms_220 = qoz_map_get__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, cname); switch (_qoz_ms_220->tag) { case qoz_Option__qoz_Vec__qoz_TypeExpr_Some: { qoz_Vec__qoz_TypeExpr pts = _qoz_ms_220->payload.Some.f0; fallback_hints = pts;  break; } case qoz_Option__qoz_Vec__qoz_TypeExpr_None: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } if (i < (fallback_hints.len)) { emit_emit_value_with_hint(e, a, fallback_hints.data[i]); }  else { emit_emit_expr(e, a); } i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); 
    return;
}
...
qoz_TypeExpr* emit_callee_value_typeexpr(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_221 = callee; qoz_TypeExpr* _qoz_mv_221 = NULL; switch (_qoz_ms_221->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_221->payload.EIdent.f0; qoz_string name = _qoz_ms_221->payload.EIdent.f1; qoz_TypeExpr* _qoz_bv_200;
    {
        qoz_Option__qoz_TypeExpr* _qoz_ms_222 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); switch (_qoz_ms_222->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_222->payload.Some.f0; return te;  break; } default: { NULL;  break; } } 0; _qoz_bv_200 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_221 = (_qoz_bv_200);  break; } default: { _qoz_mv_221 = (qoz_make_TypeExpr_TEUnit(emit_span_of_expr(callee)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_221;
}
...
qoz_string emit_binary_op_text(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_223 = op; qoz_string _qoz_mv_223 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_223->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_223 = (QOZ_STR_LIT("=="));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_223 = (QOZ_STR_LIT("!="));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_223 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_223 = (QOZ_STR_LIT(">"));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_223 = (QOZ_STR_LIT("<="));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_223 = (QOZ_STR_LIT(">="));  break; } case qoz_BinaryOp_BOpAdd: { _qoz_mv_223 = (QOZ_STR_LIT("+"));  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_223 = (QOZ_STR_LIT("-"));  break; } case qoz_BinaryOp_BOpMul: { _qoz_mv_223 = (QOZ_STR_LIT("*"));  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_223 = (QOZ_STR_LIT("/"));  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_223 = (QOZ_STR_LIT("%"));  break; } default: { _qoz_mv_223 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_223;
}
...
void emit_emit_binary(qoz_Emitter* e, qoz_BinaryOp* op, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    qoz_gc_push_root(&lhs);
    qoz_gc_push_root(&rhs);
    qoz_string lct = emit_infer_expr_ctype(e, lhs); if (qoz_string_eq(lct, QOZ_STR_LIT("qoz_string"))) { qoz_BinaryOp* _qoz_ms_224 = op; switch (_qoz_ms_224->tag) { case qoz_BinaryOp_BOpEq: { {
    ...
    0;  break; } default: { NULL;  break; } } 0; } qoz_string op_text = emit_binary_op_text(op); if (!qoz_string_eq(op_text, QOZ_STR_LIT(""))) { qoz_TypeExpr* lhs_te = emit_infer_value_te(e, lhs); qoz_gc_push_root(&lhs_te); qoz_string tname = emit_operator_first_param_type_name(lhs_te); if (!qoz_string_eq(tname, QOZ_STR_LIT(""))) { qoz_string key = qoz_string_cat(qoz_string_cat(op_text, QOZ_STR_LIT("::")), tname); qoz_Option__qoz_string* _qoz_ms_225 = qoz_map_get__qoz_string__qoz_string(&e->op_dispatch, key); switch (_qoz_ms_225->tag) { case qoz_Option__qoz_string_Some: { qoz_string fn_name = _qoz_ms_225->payload.Some.f0; {
        qoz_string ct = emit_c_type_for(e, lhs_te); qoz_Option__qoz_TypeExpr* _qoz_ms_226 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->fn_returns, fn_name); qoz_TypeExpr* _qoz_mv_226 = NULL; switch (_qoz_ms_226->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_226->payload.Some.f0; _qoz_mv_226 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_226 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_TypeExpr* ret_te = _qoz_mv_226; qoz_gc_push_root(&ret_te); qoz_string ret_ct = emit_c_type_for(e, ret_te); emit_ensure_byval_dispatch_helper(e, fn_name, ct, ret_ct); qoz_string _qoz_bv_201;
    {
        qoz_Strbuf _qoz_sb_2667_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2667_25); strings_sb_append(&_qoz_sb_2667_25, QOZ_STR_LIT("_qoz_byval_")); strings_sb_append(&_qoz_sb_2667_25, fn_name); strings_sb_append(&_qoz_sb_2667_25, QOZ_STR_LIT("(")); _qoz_bv_201 = strings_sb_finish(&_qoz_sb_2667_25);
    }
    emit_push(e, _qoz_bv_201); emit_emit_expr(e, lhs); emit_push(e, QOZ_STR_LIT(", ")); emit_emit_expr(e, rhs); emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; } } qoz_string record_name = emit_record_struct_name_of_ctype(e, lct); if (!qoz_string_eq(record_name, QOZ_STR_LIT(""))) { qoz_BinaryOp* _qoz_ms_227 = op; switch (_qoz_ms_227->tag) { case qoz_BinaryOp_BOpEq: { {
        qoz_string _qoz_bv_202;
    {
        qoz_Strbuf _qoz_sb_2680_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2680_21); strings_sb_append(&_qoz_sb_2680_21, QOZ_STR_LIT("qoz_eq_")); strings_sb_append(&_qoz_sb_2680_21, record_name); strings_sb_append(&_qoz_sb_2680_21, QOZ_STR_LIT("(")); _qoz_bv_202 = strings_sb_finish(&_qoz_sb_2680_21);
    }
    emit_push(e, _qoz_bv_202); emit_emit_expr(e, lhs); emit_push(e, QOZ_STR_LIT(", ")); emit_emit_expr(e, rhs); emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_BinaryOp_BOpNe: { {
        qoz_string _qoz_bv_203;
    {
        qoz_Strbuf _qoz_sb_2688_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2688_21); strings_sb_append(&_qoz_sb_2688_21, QOZ_STR_LIT("!qoz_eq_")); strings_sb_append(&_qoz_sb_2688_21, record_name); strings_sb_append(&_qoz_sb_2688_21, QOZ_STR_LIT("(")); _qoz_bv_203 = strings_sb_finish(&_qoz_sb_2688_21);
    }
    emit_push(e, _qoz_bv_203); emit_emit_expr(e, lhs); emit_push(e, QOZ_STR_LIT(", ")); emit_emit_expr(e, rhs); emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; } int64_t p = emit_binary_prec(op); bool needs_paren_child = emit_is_logical_op(op); emit_emit_binary_child(e, lhs, p, needs_paren_child); qoz_string bop = emit_binary_c_op(op); qoz_string _qoz_bv_204;
    {
        qoz_Strbuf _qoz_sb_2702_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2702_13); strings_sb_append(&_qoz_sb_2702_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_2702_13, bop); strings_sb_append(&_qoz_sb_2702_13, QOZ_STR_LIT(" ")); _qoz_bv_204 = strings_sb_finish(&_qoz_sb_2702_13);
    }
    emit_push(e, _qoz_bv_204); emit_emit_binary_child(e, rhs, p + 1, needs_paren_child); 
    return;
}
...
bool emit_is_logical_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_228 = op; bool _qoz_mv_228 = false; switch (_qoz_ms_228->tag) { case qoz_BinaryOp_BOpAnd: { _qoz_mv_228 = (true);  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_228 = (true);  break; } default: { _qoz_mv_228 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_228;
}
...
void emit_emit_binary_child(qoz_Emitter* e, qoz_Expr* ex, int64_t min_prec, bool force_paren_if_binary) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_229 = ex; switch (_qoz_ms_229->tag) { case qoz_Expr_EBinary: { if (force_paren_if_binary) { emit_push(e, QOZ_STR_LIT("(")); emit_emit_expr(e, ex); emit_push(e, QOZ_STR_LIT(")")); }  else { emit_emit_with_prec(e, ex, min_prec); } 0;  break; } default: { emit_emit_with_prec(e, ex, min_prec);  break; } } 0; 
    return;
}
...
int64_t emit_binary_prec(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_230 = op; int64_t _qoz_mv_230 = 0; switch (_qoz_ms_230->tag) { case qoz_BinaryOp_BOpMul: { _qoz_mv_230 = (12);  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_230 = (12);  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_230 = (12);  break; } case qoz_BinaryOp_BOpAdd: { _qoz_mv_230 = (11);  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_230 = (11);  break; } case qoz_BinaryOp_BOpShl: { _qoz_mv_230 = (10);  break; } case qoz_BinaryOp_BOpShr: { _qoz_mv_230 = (10);  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_230 = (8);  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_230 = (8);  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_230 = (8);  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_230 = (8);  break; } case qoz_BinaryOp_BOpRange: { _qoz_mv_230 = (8);  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_230 = (8);  break; } case qoz_BinaryOp_BOpEq: { _qoz_mv_230 = (7);  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_230 = (7);  break; } case qoz_BinaryOp_BOpBitAnd: { _qoz_mv_230 = (6);  break; } case qoz_BinaryOp_BOpBitXor: { _qoz_mv_230 = (5);  break; } case qoz_BinaryOp_BOpBitOr: { _qoz_mv_230 = (4);  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_230 = (3);  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_230 = (2);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_230;
}
...
void emit_emit_with_prec(qoz_Emitter* e, qoz_Expr* ex, int64_t min_prec) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_231 = ex; switch (_qoz_ms_231->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_231->payload.EBinary.f1; {
...
qoz_string emit_binary_c_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_232 = op; qoz_string _qoz_mv_232 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_232->tag) { case qoz_BinaryOp_BOpAdd: { _qoz_mv_232 = (QOZ_STR_LIT("+"));  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_232 = (QOZ_STR_LIT("-"));  break; } case qoz_BinaryOp_BOpMul: { _qoz_mv_232 = (QOZ_STR_LIT("*"));  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_232 = (QOZ_STR_LIT("/"));  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_232 = (QOZ_STR_LIT("%"));  break; } case qoz_BinaryOp_BOpEq: { _qoz_mv_232 = (QOZ_STR_LIT("=="));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_232 = (QOZ_STR_LIT("!="));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_232 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_232 = (QOZ_STR_LIT(">"));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_232 = (QOZ_STR_LIT("<="));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_232 = (QOZ_STR_LIT(">="));  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_232 = (QOZ_STR_LIT("&&"));  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_232 = (QOZ_STR_LIT("||"));  break; } case qoz_BinaryOp_BOpBitAnd: { _qoz_mv_232 = (QOZ_STR_LIT("&"));  break; } case qoz_BinaryOp_BOpBitOr: { _qoz_mv_232 = (QOZ_STR_LIT("|"));  break; } case qoz_BinaryOp_BOpBitXor: { _qoz_mv_232 = (QOZ_STR_LIT("^"));  break; } case qoz_BinaryOp_BOpShl: { _qoz_mv_232 = (QOZ_STR_LIT("<<"));  break; } case qoz_BinaryOp_BOpShr: { _qoz_mv_232 = (QOZ_STR_LIT(">>"));  break; } case qoz_BinaryOp_BOpRange: { _qoz_mv_232 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_232 = (QOZ_STR_LIT("<="));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_232;
}

qoz_string emit_unary_c_op(qoz_UnaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_UnaryOp* _qoz_ms_233 = op; qoz_string _qoz_mv_233 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_233->tag) { case qoz_UnaryOp_UOpNeg: { _qoz_mv_233 = (QOZ_STR_LIT("-"));  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_233 = (QOZ_STR_LIT("!"));  break; } case qoz_UnaryOp_UOpDeref: { _qoz_mv_233 = (QOZ_STR_LIT("*"));  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_233 = (QOZ_STR_LIT("&"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_233;
}

bool emit_is_block(qoz_Expr* ex) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_234 = ex; bool _qoz_mv_234 = false; switch (_qoz_ms_234->tag) { case qoz_Expr_EBlock: { _qoz_mv_234 = (true);  break; } default: { _qoz_mv_234 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_234;
}

bool emit_is_nil_expr(qoz_Expr* ex) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_235 = ex; bool _qoz_mv_235 = false; switch (_qoz_ms_235->tag) { case qoz_Expr_ENil: { _qoz_mv_235 = (true);  break; } default: { _qoz_mv_235 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_235;
}
...
void emit_emit_fn_body_block(qoz_Emitter* e, qoz_Expr* body, qoz_TypeExpr* ret_hint) {
    ...
    qoz_Expr* _qoz_ms_236 = body; switch (_qoz_ms_236->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_236->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_236->payload.EBlock.f2; {
        qoz_Vec__qoz_Expr defers = emit_collect_defers_in_stmts(stmts); qoz_Expr* effective_tail = tail; qoz_gc_push_root(&effective_tail); qoz_Expr* _qoz_ms_237 = tail; switch (_qoz_ms_237->tag) { case qoz_Expr_EDefer: { qoz_Expr* dbody = _qoz_ms_237->payload.EDefer.f1; {
        qoz_vec_push__qoz_Expr(&defers, dbody); effective_tail = qoz_make_Expr_ENil(emit_span_of_expr(tail)); 
    }
    0;  break; } default: { NULL;  break; } } 0; { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_emit_stmt(e, s); } }if (emit_is_nil_expr(effective_tail)) { emit_emit_defers_reverse(e, defers); emit_push(e, QOZ_STR_LIT("return;\n")); return;} if (emit_is_unit_typeexpr(ret_hint)) { qoz_StmtScope saved = emit_open_statement_scope(e); emit_emit_stmt_expr(e, effective_tail); emit_close_statement_scope(e, saved); emit_emit_defers_reverse(e, defers); emit_push(e, QOZ_STR_LIT("\n    return;\n")); return;} qoz_Expr* _qoz_ms_238 = effective_tail; switch (_qoz_ms_238->tag) { case qoz_Expr_EReturn: { {
        emit_emit_expr(e, effective_tail); emit_push(e, QOZ_STR_LIT(";\n")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; if ((defers.len) == 0) { qoz_StmtScope saved = emit_open_statement_scope(e); emit_push(e, e->current_return_restore); emit_push(e, QOZ_STR_LIT("return ")); emit_emit_value_with_hint(e, effective_tail, ret_hint); emit_push(e, QOZ_STR_LIT(";\n")); emit_close_statement_scope(e, saved); }  else { e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_205;
    {
        qoz_Strbuf _qoz_sb_2864_48 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2864_48); strings_sb_append_i64(&_qoz_sb_2864_48, e->closure_counter); _qoz_bv_205 = strings_sb_finish(&_qoz_sb_2864_48);
    }
    qoz_string tmp = qoz_string_cat(QOZ_STR_LIT("_qoz_ret_"), _qoz_bv_205); qoz_string rt = emit_c_type_for(e, ret_hint); qoz_string _qoz_bv_206;
    {
        qoz_Strbuf _qoz_sb_2866_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2866_21); strings_sb_append(&_qoz_sb_2866_21, rt); strings_sb_append(&_qoz_sb_2866_21, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_2866_21, tmp); strings_sb_append(&_qoz_sb_2866_21, QOZ_STR_LIT(" = ")); _qoz_bv_206 = strings_sb_finish(&_qoz_sb_2866_21);
    }
    emit_push(e, _qoz_bv_206); emit_emit_value_with_hint(e, effective_tail, ret_hint); emit_push(e, QOZ_STR_LIT(";\n    ")); emit_emit_defers_reverse(e, defers); qoz_string _qoz_bv_207;
    {
        qoz_Strbuf _qoz_sb_2870_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2870_21); strings_sb_append(&_qoz_sb_2870_21, QOZ_STR_LIT("\n    return ")); strings_sb_append(&_qoz_sb_2870_21, tmp); strings_sb_append(&_qoz_sb_2870_21, QOZ_STR_LIT(";\n")); _qoz_bv_207 = strings_sb_finish(&_qoz_sb_2870_21);
    }
    emit_push(e, _qoz_bv_207); } 
    }
    0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
bool emit_is_unit_typeexpr(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_239 = te; bool _qoz_mv_239 = false; switch (_qoz_ms_239->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_239 = (true);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_239->payload.TENamed.f1; bool _qoz_bv_208;
    {
        if ((path.len) != 1) { return false;} qoz_string n = path.data[0]; _qoz_bv_208 = qoz_string_eq(n, QOZ_STR_LIT("unit")) || qoz_string_eq(n, QOZ_STR_LIT("void"));
    }
    _qoz_mv_239 = (_qoz_bv_208);  break; } default: { _qoz_mv_239 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_239;
}
...
void emit_emit_fn(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&ret);
    qoz_gc_push_root(&body);
    qoz_string ret_c = emit_c_type_for(e, ret); qoz_string _qoz_bv_209;
    {
        qoz_Strbuf _qoz_sb_2891_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2891_13); strings_sb_append(&_qoz_sb_2891_13, ret_c); strings_sb_append(&_qoz_sb_2891_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_2891_13, name); _qoz_bv_209 = strings_sb_finish(&_qoz_sb_2891_13);
    }
    emit_push(e, _qoz_bv_209); if ((params.len) == 0) { emit_push(e, QOZ_STR_LIT("(void)")); }  else { emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = emit_c_type_for(e, p.ty); qoz_string pn = p.name; qoz_string _qoz_bv_210;
    {
        qoz_Strbuf _qoz_sb_2901_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2901_21); strings_sb_append(&_qoz_sb_2901_21, pc); strings_sb_append(&_qoz_sb_2901_21, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_2901_21, pn); _qoz_bv_210 = strings_sb_finish(&_qoz_sb_2901_21);
    }
    emit_push(e, _qoz_bv_210); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); } emit_push(e, QOZ_STR_LIT(" {\n    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();\n    ")); qoz_string saved_ret = e->current_return_restore; e->current_return_restore = QOZ_STR_LIT("qoz_gc_shadow_set_top(_qoz_shadow_guard); "); e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, p.name, p.ty); if (emit_c_type_is_pointer(emit_c_type_for(e, p.ty))) { qoz_string pn = p.name; qoz_string _qoz_bv_211;
    {
        qoz_Strbuf _qoz_sb_2914_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2914_21); strings_sb_append(&_qoz_sb_2914_21, QOZ_STR_LIT("qoz_gc_push_root(&")); strings_sb_append(&_qoz_sb_2914_21, pn); strings_sb_append(&_qoz_sb_2914_21, QOZ_STR_LIT(");\n    ")); _qoz_bv_211 = strings_sb_finish(&_qoz_sb_2914_21);
    }
    emit_push(e, _qoz_bv_211); } } }e->current_ret_te = ret; bool is_b = emit_is_block(body); if (is_b) { emit_emit_fn_body_block(e, body, ret); }  else { qoz_StmtScope saved = emit_open_statement_scope(e); qoz_string crr = e->current_return_restore; if (emit_is_unit_typeexpr(ret)) { emit_emit_expr(e, body); qoz_string _qoz_bv_212;
    {
        qoz_Strbuf _qoz_sb_2926_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2926_21); strings_sb_append(&_qoz_sb_2926_21, QOZ_STR_LIT(";\n    ")); strings_sb_append(&_qoz_sb_2926_21, crr); strings_sb_append(&_qoz_sb_2926_21, QOZ_STR_LIT("return;\n")); _qoz_bv_212 = strings_sb_finish(&_qoz_sb_2926_21);
    }
    emit_push(e, _qoz_bv_212); }  else { qoz_string _qoz_bv_213;
    {
        qoz_Strbuf _qoz_sb_2928_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2928_21); strings_sb_append(&_qoz_sb_2928_21, crr); strings_sb_append(&_qoz_sb_2928_21, QOZ_STR_LIT("return ")); _qoz_bv_213 = strings_sb_finish(&_qoz_sb_2928_21);
    }
    emit_push(e, _qoz_bv_213); emit_emit_value_with_hint(e, body, ret); emit_push(e, QOZ_STR_LIT(";\n")); } emit_close_statement_scope(e, saved); } e->current_return_restore = saved_ret; e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); emit_push(e, QOZ_STR_LIT("}\n\n")); 
    return;
}
...
void emit_emit_records_topological(qoz_Emitter* e, qoz_File f) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_string names = qoz_vec_make__qoz_string(); qoz_Vec__qoz_Vec__qoz_StructField field_lists = qoz_vec_make__qoz_Vec__qoz_StructField(); { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_240 = d; switch (_qoz_ms_240->tag) { case qoz_Decl_DStruct: { qoz_string name = _qoz_ms_240->payload.DStruct.f1; qoz_Vec__qoz_string params = _qoz_ms_240->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_240->payload.DStruct.f3; if ((params.len) == 0) { qoz_vec_push__qoz_string(&names, name); qoz_vec_push__qoz_Vec__qoz_StructField(&field_lists, fields); } 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e->record_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_241 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, inst.name); switch (_qoz_ms_241->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_241->payload.Some.f0; qoz_Decl* _qoz_ms_242 = decl; switch (_qoz_ms_242->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_242->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_242->payload.DStruct.f3; {
...
qoz_Option__qoz_string* emit_value_field_dep(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_244 = te; qoz_Option__qoz_string* _qoz_mv_244 = NULL; switch (_qoz_ms_244->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_244->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_244->payload.TENamed.f2; qoz_Option__qoz_string* _qoz_bv_214;
    {
        if ((path.len) < 1) { return qoz_make_Option__qoz_string_None();} qoz_string n = path.data[(path.len) - 1]; if (!qoz_string_eq(emit_primitive_c_name(n), QOZ_STR_LIT(""))) { return qoz_make_Option__qoz_string_None();} if (qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { return qoz_make_Option__qoz_string_None();} if ((args.len) > 0) { return qoz_make_Option__qoz_string_Some(emit_mangle_inst(e, n, args));} _qoz_bv_214 = qoz_make_Option__qoz_string_Some(n);
    }
    _qoz_mv_244 = (_qoz_bv_214);  break; } default: { _qoz_mv_244 = (qoz_make_Option__qoz_string_None());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_244;
}
...
qoz_string emit_emit_program(qoz_File f, qoz_Map__int64_t__qoz_TypeExpr expr_types) {
    ...
    0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_249 = d; switch (_qoz_ms_249->tag) { case qoz_Decl_DEnum: { qoz_string name = _qoz_ms_249->payload.DEnum.f1; qoz_Vec__qoz_string params = _qoz_ms_249->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_249->payload.DEnum.f3; if ((params.len) == 0) { { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; emit_emit_variant_ctor(&e, name, v); } }} 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_250 = d; switch (_qoz_ms_250->tag) { case qoz_Decl_DFn: { qoz_string name = _qoz_ms_250->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_250->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_250->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_250->payload.DFn.f4; if (!emit_is_main(name) && ((tparams.len) == 0)) { emit_emit_fn_proto(&e, name, params, ret); } 0;  break; } case qoz_Decl_DExternal: { qoz_string symbol = _qoz_ms_250->payload.DExternal.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_250->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_250->payload.DExternal.f4; emit_emit_extern_proto(&e, symbol, params, ret);  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e.fn_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_251 = qoz_map_get__qoz_string__qoz_Decl(&e.generic_fn_decls, inst.name); switch (_qoz_ms_251->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_251->payload.Some.f0; qoz_Decl* _qoz_ms_252 = decl; switch (_qoz_ms_252->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_252->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_252->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_252->payload.DFn.f4; {
    ...
    0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } }emit_push(&e, QOZ_STR_LIT("\n")); { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_253 = d; switch (_qoz_ms_253->tag) { case qoz_Decl_DFn: { qoz_string name = _qoz_ms_253->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_253->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_253->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_253->payload.DFn.f4; qoz_Expr* body = _qoz_ms_253->payload.DFn.f5; if (emit_is_main(name)) { emit_emit_main(&e, ret, body); }  else if ((tparams.len) == 0) { emit_emit_fn(&e, name, params, ret, body); } 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e.fn_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_254 = qoz_map_get__qoz_string__qoz_Decl(&e.generic_fn_decls, inst.name); switch (_qoz_ms_254->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_254->payload.Some.f0; qoz_Decl* _qoz_ms_255 = decl; switch (_qoz_ms_255->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_255->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_255->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_255->payload.DFn.f4; qoz_Expr* body = _qoz_ms_255->payload.DFn.f5; {
...
void emit_emit_enum(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_VariantDecl variants) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    emit_push(e, QOZ_STR_LIT("typedef enum {\n")); int64_t i = 0; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_string vn = v.name; qoz_string _qoz_bv_215;
    {
        qoz_Strbuf _qoz_sb_3249_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3249_17); strings_sb_append(&_qoz_sb_3249_17, QOZ_STR_LIT("    qoz_")); strings_sb_append(&_qoz_sb_3249_17, name); strings_sb_append(&_qoz_sb_3249_17, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3249_17, vn); strings_sb_append(&_qoz_sb_3249_17, QOZ_STR_LIT(",\n")); _qoz_bv_215 = strings_sb_finish(&_qoz_sb_3249_17);
    }
    emit_push(e, _qoz_bv_215); i = i + 1; } }qoz_string _qoz_bv_216;
    {
        qoz_Strbuf _qoz_sb_3252_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3252_13); strings_sb_append(&_qoz_sb_3252_13, QOZ_STR_LIT("} qoz_")); strings_sb_append(&_qoz_sb_3252_13, name); strings_sb_append(&_qoz_sb_3252_13, QOZ_STR_LIT("_tag;\n\n")); _qoz_bv_216 = strings_sb_finish(&_qoz_sb_3252_13);
    }
    emit_push(e, _qoz_bv_216); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (emit_variant_has_positional(v)) { qoz_string vn = v.name; emit_push(e, QOZ_STR_LIT("typedef struct {\n")); int64_t k = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pt = __col.data[__i]; (void)pt; qoz_string pc = emit_c_type_for(e, pt); qoz_string ks = emit_int_to_string(k); qoz_string _qoz_bv_217;
    {
        qoz_Strbuf _qoz_sb_3261_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3261_25); strings_sb_append(&_qoz_sb_3261_25, QOZ_STR_LIT("    ")); strings_sb_append(&_qoz_sb_3261_25, pc); strings_sb_append(&_qoz_sb_3261_25, QOZ_STR_LIT(" f")); strings_sb_append(&_qoz_sb_3261_25, ks); strings_sb_append(&_qoz_sb_3261_25, QOZ_STR_LIT(";\n")); _qoz_bv_217 = strings_sb_finish(&_qoz_sb_3261_25);
    }
    emit_push(e, _qoz_bv_217); k = k + 1; } }qoz_string _qoz_bv_218;
    {
        qoz_Strbuf _qoz_sb_3264_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3264_21); strings_sb_append(&_qoz_sb_3264_21, QOZ_STR_LIT("} qoz_")); strings_sb_append(&_qoz_sb_3264_21, name); strings_sb_append(&_qoz_sb_3264_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3264_21, vn); strings_sb_append(&_qoz_sb_3264_21, QOZ_STR_LIT("_payload;\n\n")); _qoz_bv_218 = strings_sb_finish(&_qoz_sb_3264_21);
    }
    emit_push(e, _qoz_bv_218); } } }qoz_string _qoz_bv_219;
    {
        qoz_Strbuf _qoz_sb_3267_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3267_13); strings_sb_append(&_qoz_sb_3267_13, QOZ_STR_LIT("struct qoz_")); strings_sb_append(&_qoz_sb_3267_13, name); strings_sb_append(&_qoz_sb_3267_13, QOZ_STR_LIT(" {\n    qoz_")); strings_sb_append(&_qoz_sb_3267_13, name); strings_sb_append(&_qoz_sb_3267_13, QOZ_STR_LIT("_tag tag;\n")); _qoz_bv_219 = strings_sb_finish(&_qoz_sb_3267_13);
    }
    emit_push(e, _qoz_bv_219); bool any_payload = false; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (emit_variant_has_positional(v)) { any_payload = true; } } }if (any_payload) { emit_push(e, QOZ_STR_LIT("    union {\n")); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (emit_variant_has_positional(v)) { qoz_string vn = v.name; qoz_string _qoz_bv_220;
    {
        qoz_Strbuf _qoz_sb_3277_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3277_25); strings_sb_append(&_qoz_sb_3277_25, QOZ_STR_LIT("        qoz_")); strings_sb_append(&_qoz_sb_3277_25, name); strings_sb_append(&_qoz_sb_3277_25, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3277_25, vn); strings_sb_append(&_qoz_sb_3277_25, QOZ_STR_LIT("_payload ")); strings_sb_append(&_qoz_sb_3277_25, vn); strings_sb_append(&_qoz_sb_3277_25, QOZ_STR_LIT(";\n")); _qoz_bv_220 = strings_sb_finish(&_qoz_sb_3277_25);
    }
    emit_push(e, _qoz_bv_220); } } }emit_push(e, QOZ_STR_LIT("    } payload;\n")); } emit_push(e, QOZ_STR_LIT("};\n\n")); emit_emit_adt_desc(e, name, variants); 
    return;
}
...
qoz_string emit_int_to_string(int64_t n) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_Strbuf _qoz_sb_3288_37 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3288_37); strings_sb_append_i64(&_qoz_sb_3288_37, n); qoz_gc_shadow_set_top(_qoz_shadow_guard); return strings_sb_finish(&_qoz_sb_3288_37);
}

void emit_emit_variant_ctor(qoz_Emitter* e, qoz_string enum_name, qoz_VariantDecl v) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string vn = v.name; qoz_string _qoz_bv_221;
    {
        qoz_Strbuf _qoz_sb_3292_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3292_13); strings_sb_append(&_qoz_sb_3292_13, QOZ_STR_LIT("static qoz_")); strings_sb_append(&_qoz_sb_3292_13, enum_name); strings_sb_append(&_qoz_sb_3292_13, QOZ_STR_LIT(" *qoz_make_")); strings_sb_append(&_qoz_sb_3292_13, enum_name); strings_sb_append(&_qoz_sb_3292_13, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3292_13, vn); _qoz_bv_221 = strings_sb_finish(&_qoz_sb_3292_13);
    }
    emit_push(e, _qoz_bv_221); if (!emit_variant_has_positional(v)) { emit_push(e, QOZ_STR_LIT("(void) {\n")); }  else { emit_push(e, QOZ_STR_LIT("(")); int64_t k = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pt = __col.data[__i]; (void)pt; if (k > 0) { emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = emit_c_type_for(e, pt); qoz_string ks = emit_int_to_string(k); qoz_string _qoz_bv_222;
    {
        qoz_Strbuf _qoz_sb_3302_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3302_21); strings_sb_append(&_qoz_sb_3302_21, pc); strings_sb_append(&_qoz_sb_3302_21, QOZ_STR_LIT(" f")); strings_sb_append(&_qoz_sb_3302_21, ks); _qoz_bv_222 = strings_sb_finish(&_qoz_sb_3302_21);
    }
    emit_push(e, _qoz_bv_222); k = k + 1; } }emit_push(e, QOZ_STR_LIT(") {\n")); } qoz_string _qoz_bv_223;
    {
        qoz_Strbuf _qoz_sb_3307_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3307_13); strings_sb_append(&_qoz_sb_3307_13, QOZ_STR_LIT("    qoz_")); strings_sb_append(&_qoz_sb_3307_13, enum_name); strings_sb_append(&_qoz_sb_3307_13, QOZ_STR_LIT(" *p = qoz_gc_alloc(sizeof(qoz_")); strings_sb_append(&_qoz_sb_3307_13, enum_name); strings_sb_append(&_qoz_sb_3307_13, QOZ_STR_LIT("), &qoz_")); strings_sb_append(&_qoz_sb_3307_13, enum_name); strings_sb_append(&_qoz_sb_3307_13, QOZ_STR_LIT("_desc);\n")); _qoz_bv_223 = strings_sb_finish(&_qoz_sb_3307_13);
    }
    emit_push(e, _qoz_bv_223); qoz_string _qoz_bv_224;
    {
        qoz_Strbuf _qoz_sb_3308_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3308_13); strings_sb_append(&_qoz_sb_3308_13, QOZ_STR_LIT("    p->tag = qoz_")); strings_sb_append(&_qoz_sb_3308_13, enum_name); strings_sb_append(&_qoz_sb_3308_13, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3308_13, vn); strings_sb_append(&_qoz_sb_3308_13, QOZ_STR_LIT(";\n")); _qoz_bv_224 = strings_sb_finish(&_qoz_sb_3308_13);
    }
    emit_push(e, _qoz_bv_224); if (emit_variant_has_positional(v)) { int64_t j = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* _ = __col.data[__i]; (void)_; qoz_string js = emit_int_to_string(j); qoz_string _qoz_bv_225;
    {
        qoz_Strbuf _qoz_sb_3313_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3313_21); strings_sb_append(&_qoz_sb_3313_21, QOZ_STR_LIT("    p->payload.")); strings_sb_append(&_qoz_sb_3313_21, vn); strings_sb_append(&_qoz_sb_3313_21, QOZ_STR_LIT(".f")); strings_sb_append(&_qoz_sb_3313_21, js); strings_sb_append(&_qoz_sb_3313_21, QOZ_STR_LIT(" = f")); strings_sb_append(&_qoz_sb_3313_21, js); strings_sb_append(&_qoz_sb_3313_21, QOZ_STR_LIT(";\n")); _qoz_bv_225 = strings_sb_finish(&_qoz_sb_3313_21);
    }
    emit_push(e, _qoz_bv_225); j = j + 1; } }} emit_push(e, QOZ_STR_LIT("    return p;\n}\n\n")); 
    return;
}
...
void emit_collect_field_ptr_offsets(qoz_Emitter* e, qoz_string parent, qoz_string field, qoz_TypeExpr* te, qoz_Vec__qoz_string* out) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&out);
    qoz_string base = qoz_string_cat(QOZ_STR_LIT("offsetof("), qoz_string_cat(parent, qoz_string_cat(QOZ_STR_LIT(", "), qoz_string_cat(field, QOZ_STR_LIT(")"))))); qoz_TypeExpr* _qoz_ms_256 = te; switch (_qoz_ms_256->tag) { case qoz_TypeExpr_TEPtr: { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)"), base));  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_256->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_256->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)"), base)); return;} if (qoz_string_eq(n, QOZ_STR_LIT("string"))) { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)("), qoz_string_cat(base, QOZ_STR_LIT(" + offsetof(qoz_string, data))")))); qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)("), qoz_string_cat(base, QOZ_STR_LIT(" + offsetof(qoz_string, root))")))); return;} if (qoz_string_eq(n, QOZ_STR_LIT("Vec")) || qoz_string_eq(n, QOZ_STR_LIT("Map"))) { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)"), base)); return;} if ((args.len) == 0) { qoz_Option__qoz_Decl* _qoz_ms_257 = qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, n); switch (_qoz_ms_257->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_257->payload.Some.f0; qoz_Decl* _qoz_ms_258 = d; switch (_qoz_ms_258->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_258->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_258->payload.DStruct.f3; if ((params.len) == 0) { qoz_string inner_parent = qoz_string_cat(QOZ_STR_LIT("struct qoz_"), n); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField sf = __col.data[__i]; (void)sf; qoz_string composed_parent = inner_parent; qoz_string composed_field = sf.name; qoz_Vec__qoz_string inner_offsets = qoz_vec_make__qoz_string(); emit_collect_field_ptr_offsets(e, composed_parent, composed_field, sf.ty, &inner_offsets); { qoz_Vec__qoz_string __col = inner_offsets; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string inner = __col.data[__i]; (void)inner; qoz_string stripped = qoz_string_slice(inner, 9, (inner).len); qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)("), qoz_string_cat(base, qoz_string_cat(QOZ_STR_LIT(" + "), qoz_string_cat(stripped, QOZ_STR_LIT(")")))))); } }} }return;} 0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } } 0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
void emit_emit_record_desc(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string parent = qoz_string_cat(QOZ_STR_LIT("struct qoz_"), name); qoz_Vec__qoz_string offsets = qoz_vec_make__qoz_string(); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; emit_collect_field_ptr_offsets(e, parent, f.name, f.ty, &offsets); } }int64_t nptrs = (offsets.len); if (nptrs > 0) { qoz_string _qoz_bv_226;
    {
        qoz_Strbuf _qoz_sb_3402_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3402_17); strings_sb_append(&_qoz_sb_3402_17, QOZ_STR_LIT("static const int32_t qoz_")); strings_sb_append(&_qoz_sb_3402_17, name); strings_sb_append(&_qoz_sb_3402_17, QOZ_STR_LIT("_offsets[] = { ")); _qoz_bv_226 = strings_sb_finish(&_qoz_sb_3402_17);
    }
    emit_push(e, _qoz_bv_226); int64_t i = 0; { qoz_Vec__qoz_string __col = offsets; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string expr = __col.data[__i]; (void)expr; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_push(e, expr); i = i + 1; } }emit_push(e, QOZ_STR_LIT(" };\n")); } if (nptrs == 0) { qoz_string _qoz_bv_227;
    {
        qoz_Strbuf _qoz_sb_3412_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3412_17); strings_sb_append(&_qoz_sb_3412_17, QOZ_STR_LIT("static const qoz_type_desc qoz_")); strings_sb_append(&_qoz_sb_3412_17, name); strings_sb_append(&_qoz_sb_3412_17, QOZ_STR_LIT("_desc = { QOZ_DESC_LEAF, (int32_t)sizeof(struct qoz_")); strings_sb_append(&_qoz_sb_3412_17, name); strings_sb_append(&_qoz_sb_3412_17, QOZ_STR_LIT("), 0, NULL, 0, 0, 0, NULL, \"")); strings_sb_append(&_qoz_sb_3412_17, name); strings_sb_append(&_qoz_sb_3412_17, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_227 = strings_sb_finish(&_qoz_sb_3412_17);
    }
    emit_push(e, _qoz_bv_227); }  else { qoz_string np = emit_int_to_string(nptrs); qoz_string _qoz_bv_228;
    {
        qoz_Strbuf _qoz_sb_3415_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3415_17); strings_sb_append(&_qoz_sb_3415_17, QOZ_STR_LIT("static const qoz_type_desc qoz_")); strings_sb_append(&_qoz_sb_3415_17, name); strings_sb_append(&_qoz_sb_3415_17, QOZ_STR_LIT("_desc = { QOZ_DESC_OFFSETS, (int32_t)sizeof(struct qoz_")); strings_sb_append(&_qoz_sb_3415_17, name); strings_sb_append(&_qoz_sb_3415_17, QOZ_STR_LIT("), ")); strings_sb_append(&_qoz_sb_3415_17, np); strings_sb_append(&_qoz_sb_3415_17, QOZ_STR_LIT(", qoz_")); strings_sb_append(&_qoz_sb_3415_17, name); strings_sb_append(&_qoz_sb_3415_17, QOZ_STR_LIT("_offsets, 0, 0, 0, NULL, \"")); strings_sb_append(&_qoz_sb_3415_17, name); strings_sb_append(&_qoz_sb_3415_17, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_228 = strings_sb_finish(&_qoz_sb_3415_17);
    }
    emit_push(e, _qoz_bv_228); } 
    return;
}
...
void emit_emit_adt_desc(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_VariantDecl variants) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_Vec__qoz_string voffs = emit_collect_variant_ptr_offsets(e, name, v); if ((voffs.len) > 0) { qoz_string vn = v.name; qoz_string _qoz_bv_229;
    {
        qoz_Strbuf _qoz_sb_3452_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3452_21); strings_sb_append(&_qoz_sb_3452_21, QOZ_STR_LIT("static const int32_t qoz_")); strings_sb_append(&_qoz_sb_3452_21, name); strings_sb_append(&_qoz_sb_3452_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3452_21, vn); strings_sb_append(&_qoz_sb_3452_21, QOZ_STR_LIT("_offsets[] = { ")); _qoz_bv_229 = strings_sb_finish(&_qoz_sb_3452_21);
    }
    emit_push(e, _qoz_bv_229); int64_t j = 0; { qoz_Vec__qoz_string __col = voffs; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string expr = __col.data[__i]; (void)expr; if (j > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_push(e, expr); j = j + 1; } }emit_push(e, QOZ_STR_LIT(" };\n")); } } }qoz_string _qoz_bv_230;
    {
        qoz_Strbuf _qoz_sb_3462_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3462_13); strings_sb_append(&_qoz_sb_3462_13, QOZ_STR_LIT("static const qoz_variant_desc qoz_")); strings_sb_append(&_qoz_sb_3462_13, name); strings_sb_append(&_qoz_sb_3462_13, QOZ_STR_LIT("_variants[] = {\n")); _qoz_bv_230 = strings_sb_finish(&_qoz_sb_3462_13);
    }
    emit_push(e, _qoz_bv_230); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_Vec__qoz_string voffs = emit_collect_variant_ptr_offsets(e, name, v); int64_t nptrs = (voffs.len); qoz_string vn = v.name; qoz_string np = emit_int_to_string(nptrs); if (nptrs > 0) { qoz_string _qoz_bv_231;
    {
        qoz_Strbuf _qoz_sb_3469_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3469_21); strings_sb_append(&_qoz_sb_3469_21, QOZ_STR_LIT("    { qoz_")); strings_sb_append(&_qoz_sb_3469_21, name); strings_sb_append(&_qoz_sb_3469_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3469_21, vn); strings_sb_append(&_qoz_sb_3469_21, QOZ_STR_LIT(", ")); strings_sb_append(&_qoz_sb_3469_21, np); strings_sb_append(&_qoz_sb_3469_21, QOZ_STR_LIT(", qoz_")); strings_sb_append(&_qoz_sb_3469_21, name); strings_sb_append(&_qoz_sb_3469_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3469_21, vn); strings_sb_append(&_qoz_sb_3469_21, QOZ_STR_LIT("_offsets },\n")); _qoz_bv_231 = strings_sb_finish(&_qoz_sb_3469_21);
    }
    emit_push(e, _qoz_bv_231); }  else { qoz_string _qoz_bv_232;
    {
        qoz_Strbuf _qoz_sb_3471_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3471_21); strings_sb_append(&_qoz_sb_3471_21, QOZ_STR_LIT("    { qoz_")); strings_sb_append(&_qoz_sb_3471_21, name); strings_sb_append(&_qoz_sb_3471_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3471_21, vn); strings_sb_append(&_qoz_sb_3471_21, QOZ_STR_LIT(", ")); strings_sb_append(&_qoz_sb_3471_21, np); strings_sb_append(&_qoz_sb_3471_21, QOZ_STR_LIT(", NULL },\n")); _qoz_bv_232 = strings_sb_finish(&_qoz_sb_3471_21);
    }
    emit_push(e, _qoz_bv_232); } } }emit_push(e, QOZ_STR_LIT("};\n")); bool any_payload2 = false; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (emit_variant_has_positional(v)) { any_payload2 = true; } } }qoz_string payload_off_expr = ((any_payload2) ? qoz_string_cat(QOZ_STR_LIT("(int32_t)offsetof(struct qoz_"), qoz_string_cat(name, QOZ_STR_LIT(", payload)"))) : QOZ_STR_LIT("0")); qoz_string nvar = emit_int_to_string((variants.len)); qoz_string _qoz_bv_233;
    {
        qoz_Strbuf _qoz_sb_3485_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3485_13); strings_sb_append(&_qoz_sb_3485_13, QOZ_STR_LIT("static const qoz_type_desc qoz_")); strings_sb_append(&_qoz_sb_3485_13, name); strings_sb_append(&_qoz_sb_3485_13, QOZ_STR_LIT("_desc = { QOZ_DESC_ADT, (int32_t)sizeof(struct qoz_")); strings_sb_append(&_qoz_sb_3485_13, name); strings_sb_append(&_qoz_sb_3485_13, QOZ_STR_LIT("), 0, NULL, (int32_t)offsetof(struct qoz_")); strings_sb_append(&_qoz_sb_3485_13, name); strings_sb_append(&_qoz_sb_3485_13, QOZ_STR_LIT(", tag), ")); strings_sb_append(&_qoz_sb_3485_13, payload_off_expr); strings_sb_append(&_qoz_sb_3485_13, QOZ_STR_LIT(", ")); strings_sb_append(&_qoz_sb_3485_13, nvar); strings_sb_append(&_qoz_sb_3485_13, QOZ_STR_LIT(", qoz_")); strings_sb_append(&_qoz_sb_3485_13, name); strings_sb_append(&_qoz_sb_3485_13, QOZ_STR_LIT("_variants, \"")); strings_sb_append(&_qoz_sb_3485_13, name); strings_sb_append(&_qoz_sb_3485_13, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_233 = strings_sb_finish(&_qoz_sb_3485_13);
    }
    emit_push(e, _qoz_bv_233); 
    return;
}
...
void emit_emit_struct(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string _qoz_bv_234;
    {
        qoz_Strbuf _qoz_sb_3489_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3489_13); strings_sb_append(&_qoz_sb_3489_13, QOZ_STR_LIT("struct qoz_")); strings_sb_append(&_qoz_sb_3489_13, name); strings_sb_append(&_qoz_sb_3489_13, QOZ_STR_LIT(" {\n")); _qoz_bv_234 = strings_sb_finish(&_qoz_sb_3489_13);
    }
    emit_push(e, _qoz_bv_234); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; qoz_string ct = emit_c_type_for(e, f.ty); qoz_string fname = f.name; qoz_string _qoz_bv_235;
    {
        qoz_Strbuf _qoz_sb_3493_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3493_17); strings_sb_append(&_qoz_sb_3493_17, QOZ_STR_LIT("    ")); strings_sb_append(&_qoz_sb_3493_17, ct); strings_sb_append(&_qoz_sb_3493_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3493_17, fname); strings_sb_append(&_qoz_sb_3493_17, QOZ_STR_LIT(";\n")); _qoz_bv_235 = strings_sb_finish(&_qoz_sb_3493_17);
    }
    emit_push(e, _qoz_bv_235); } }emit_push(e, QOZ_STR_LIT("};\n\n")); emit_emit_record_eq(e, name, fields); emit_emit_record_desc(e, name, fields); 
    return;
}
...
void emit_emit_record_eq(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    ...
    {
        qoz_Strbuf _qoz_sb_3501_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3501_13); strings_sb_append(&_qoz_sb_3501_13, QOZ_STR_LIT("static bool qoz_eq_")); strings_sb_append(&_qoz_sb_3501_13, name); strings_sb_append(&_qoz_sb_3501_13, QOZ_STR_LIT("(qoz_")); strings_sb_append(&_qoz_sb_3501_13, name); strings_sb_append(&_qoz_sb_3501_13, QOZ_STR_LIT(" a, qoz_")); strings_sb_append(&_qoz_sb_3501_13, name); strings_sb_append(&_qoz_sb_3501_13, QOZ_STR_LIT(" b) {\n    return ")); _qoz_bv_236 = strings_sb_finish(&_qoz_sb_3501_13);
    }
    emit_push(e, _qoz_bv_236); if ((fields.len) == 0) { emit_push(e, QOZ_STR_LIT("true")); }  else { int64_t i = 0; { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (i > 0) { emit_push(e, QOZ_STR_LIT(" && ")); } emit_emit_field_eq_expr(e, f.ty, f.name); i = i + 1; } }} emit_push(e, QOZ_STR_LIT(";\n}\n\n")); emit_emit_record_hash(e, name, fields); 
    return;
}
...
void emit_emit_record_hash(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string _qoz_bv_237;
    {
        qoz_Strbuf _qoz_sb_3517_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3517_13); strings_sb_append(&_qoz_sb_3517_13, QOZ_STR_LIT("static uint64_t qoz_hash_")); strings_sb_append(&_qoz_sb_3517_13, name); strings_sb_append(&_qoz_sb_3517_13, QOZ_STR_LIT("(qoz_")); strings_sb_append(&_qoz_sb_3517_13, name); strings_sb_append(&_qoz_sb_3517_13, QOZ_STR_LIT(" v) {\n    uint64_t h = 0;\n")); _qoz_bv_237 = strings_sb_finish(&_qoz_sb_3517_13);
    }
    emit_push(e, _qoz_bv_237); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; emit_push(e, QOZ_STR_LIT("    h = h * 31 + (uint64_t)(")); emit_emit_field_hash_expr(e, f.ty, f.name); emit_push(e, QOZ_STR_LIT(");\n")); } }emit_push(e, QOZ_STR_LIT("    return h;\n}\n\n")); 
    return;
}
...
void emit_emit_field_hash_expr(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string fname) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_string ct = emit_c_type_for(e, te); if (qoz_string_eq(ct, QOZ_STR_LIT("qoz_string"))) { qoz_string _qoz_bv_238;
    {
        qoz_Strbuf _qoz_sb_3529_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3529_17); strings_sb_append(&_qoz_sb_3529_17, QOZ_STR_LIT("qoz_string_hash(v.")); strings_sb_append(&_qoz_sb_3529_17, fname); strings_sb_append(&_qoz_sb_3529_17, QOZ_STR_LIT(")")); _qoz_bv_238 = strings_sb_finish(&_qoz_sb_3529_17);
    }
    emit_push(e, _qoz_bv_238); return;} qoz_TypeExpr* _qoz_ms_259 = te; switch (_qoz_ms_259->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_259->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_259->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_string_eq(emit_primitive_c_name(n), QOZ_STR_LIT(""))) { if (!qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_string mangled = (((args.len) > 0) ? emit_mangle_inst(e, n, args) : n); qoz_string _qoz_bv_239;
    {
        qoz_Strbuf _qoz_sb_3539_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3539_29); strings_sb_append(&_qoz_sb_3539_29, QOZ_STR_LIT("qoz_hash_")); strings_sb_append(&_qoz_sb_3539_29, mangled); strings_sb_append(&_qoz_sb_3539_29, QOZ_STR_LIT("(v.")); strings_sb_append(&_qoz_sb_3539_29, fname); strings_sb_append(&_qoz_sb_3539_29, QOZ_STR_LIT(")")); _qoz_bv_239 = strings_sb_finish(&_qoz_sb_3539_29);
    }
    emit_push(e, _qoz_bv_239); return;} } } 0;  break; } default: { NULL;  break; } } 0; qoz_string _qoz_bv_240;
    {
        qoz_Strbuf _qoz_sb_3547_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3547_13); strings_sb_append(&_qoz_sb_3547_13, QOZ_STR_LIT("v.")); strings_sb_append(&_qoz_sb_3547_13, fname); _qoz_bv_240 = strings_sb_finish(&_qoz_sb_3547_13);
    }
    emit_push(e, _qoz_bv_240); 
    return;
}
...
void emit_emit_field_eq_expr(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string fname) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_string ct = emit_c_type_for(e, te); if (qoz_string_eq(ct, QOZ_STR_LIT("qoz_string"))) { qoz_string _qoz_bv_241;
    {
        qoz_Strbuf _qoz_sb_3553_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3553_17); strings_sb_append(&_qoz_sb_3553_17, QOZ_STR_LIT("qoz_string_eq(a.")); strings_sb_append(&_qoz_sb_3553_17, fname); strings_sb_append(&_qoz_sb_3553_17, QOZ_STR_LIT(", b.")); strings_sb_append(&_qoz_sb_3553_17, fname); strings_sb_append(&_qoz_sb_3553_17, QOZ_STR_LIT(")")); _qoz_bv_241 = strings_sb_finish(&_qoz_sb_3553_17);
    }
    emit_push(e, _qoz_bv_241); return;} qoz_TypeExpr* _qoz_ms_260 = te; switch (_qoz_ms_260->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_260->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_260->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_string_eq(emit_primitive_c_name(n), QOZ_STR_LIT(""))) { if (!qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_string mangled = (((args.len) > 0) ? emit_mangle_inst(e, n, args) : n); qoz_string _qoz_bv_242;
    {
        qoz_Strbuf _qoz_sb_3563_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3563_29); strings_sb_append(&_qoz_sb_3563_29, QOZ_STR_LIT("qoz_eq_")); strings_sb_append(&_qoz_sb_3563_29, mangled); strings_sb_append(&_qoz_sb_3563_29, QOZ_STR_LIT("(a.")); strings_sb_append(&_qoz_sb_3563_29, fname); strings_sb_append(&_qoz_sb_3563_29, QOZ_STR_LIT(", b.")); strings_sb_append(&_qoz_sb_3563_29, fname); strings_sb_append(&_qoz_sb_3563_29, QOZ_STR_LIT(")")); _qoz_bv_242 = strings_sb_finish(&_qoz_sb_3563_29);
    }
    emit_push(e, _qoz_bv_242); return;} } } 0;  break; } default: { NULL;  break; } } 0; qoz_string _qoz_bv_243;
    {
        qoz_Strbuf _qoz_sb_3571_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3571_13); strings_sb_append(&_qoz_sb_3571_13, QOZ_STR_LIT("a.")); strings_sb_append(&_qoz_sb_3571_13, fname); strings_sb_append(&_qoz_sb_3571_13, QOZ_STR_LIT(" == b.")); strings_sb_append(&_qoz_sb_3571_13, fname); _qoz_bv_243 = strings_sb_finish(&_qoz_sb_3571_13);
    }
    emit_push(e, _qoz_bv_243); 
    return;
}
...
void emit_emit_fn_proto(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ret);
    qoz_string rc = emit_c_type_for(e, ret); qoz_string _qoz_bv_244;
    {
        qoz_Strbuf _qoz_sb_3576_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3576_13); strings_sb_append(&_qoz_sb_3576_13, rc); strings_sb_append(&_qoz_sb_3576_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3576_13, name); _qoz_bv_244 = strings_sb_finish(&_qoz_sb_3576_13);
    }
    emit_push(e, _qoz_bv_244); if ((params.len) == 0) { emit_push(e, QOZ_STR_LIT("(void);\n")); return;} emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = emit_c_type_for(e, p.ty); qoz_string pn = p.name; qoz_string _qoz_bv_245;
    {
        qoz_Strbuf _qoz_sb_3587_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3587_17); strings_sb_append(&_qoz_sb_3587_17, pc); strings_sb_append(&_qoz_sb_3587_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3587_17, pn); _qoz_bv_245 = strings_sb_finish(&_qoz_sb_3587_17);
    }
    emit_push(e, _qoz_bv_245); i = i + 1; } }emit_push(e, QOZ_STR_LIT(");\n")); 
    return;
}
...
void emit_emit_extern_proto(qoz_Emitter* e, qoz_string symbol, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ret);
    qoz_string rc = emit_c_type_for(e, ret); qoz_string _qoz_bv_246;
    {
        qoz_Strbuf _qoz_sb_3595_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3595_13); strings_sb_append(&_qoz_sb_3595_13, QOZ_STR_LIT("extern ")); strings_sb_append(&_qoz_sb_3595_13, rc); strings_sb_append(&_qoz_sb_3595_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3595_13, symbol); _qoz_bv_246 = strings_sb_finish(&_qoz_sb_3595_13);
    }
    emit_push(e, _qoz_bv_246); if ((params.len) == 0) { emit_push(e, QOZ_STR_LIT("(void);\n")); return;} emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_push(e, emit_c_type_for(e, p.ty)); i = i + 1; } }emit_push(e, QOZ_STR_LIT(");\n")); 
    return;
}
...
bool emit_is_range_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_261 = op; bool _qoz_mv_261 = false; switch (_qoz_ms_261->tag) { case qoz_BinaryOp_BOpRange: { _qoz_mv_261 = (true);  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_261 = (true);  break; } default: { _qoz_mv_261 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_261;
}

qoz_string emit_range_cmp_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_262 = op; qoz_string _qoz_mv_262 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_262->tag) { case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_262 = (QOZ_STR_LIT("<="));  break; } default: { _qoz_mv_262 = (QOZ_STR_LIT("<"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_262;
}
...
void emit_emit_block_tail_as_value(qoz_Emitter* e, qoz_Expr* tail) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&tail);
    qoz_Expr* _qoz_ms_263 = tail; switch (_qoz_ms_263->tag) { case qoz_Expr_EAssign: { qoz_Expr* lhs = _qoz_ms_263->payload.EAssign.f2; qoz_Expr* rhs = _qoz_ms_263->payload.EAssign.f3; {
    ...
    0;  break; } case qoz_Expr_EIf: { qoz_Expr* f = _qoz_ms_263->payload.EIf.f3; {
...
void emit_emit_value_with_hint(qoz_Emitter* e, qoz_Expr* value, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&value);
    qoz_gc_push_root(&hint);
    qoz_Expr* _qoz_ms_264 = value; switch (_qoz_ms_264->tag) { case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_264->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_264->payload.ERecord.f2; emit_emit_record_lit_with_hint(e, te, fields, hint);  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_264->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_264->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_264->payload.ECall.f3; emit_emit_call_with_hint(e, callee, ta, args, hint);  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_264->payload.EIdent.f1; emit_emit_ident_with_hint(e, name, hint);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_264->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_264->payload.EArrayLit.f1; emit_emit_array_lit_with_hint(e, sp, elems, hint);  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_264->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_264->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_264->payload.EBlock.f2; {
        if ((stmts.len) == 0) { qoz_Expr* _qoz_ms_265 = tail; switch (_qoz_ms_265->tag) { case qoz_Expr_EWhile: { {
    ...
    0;  break; } default: { emit_emit_value_with_hint(e, tail, hint);  break; } } 0; return;} e->closure_counter = e->closure_counter + 1; int64_t counter = e->closure_counter; qoz_string _qoz_bv_247;
    {
        qoz_Strbuf _qoz_sb_3688_47 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3688_47); strings_sb_append_i64(&_qoz_sb_3688_47, counter); _qoz_bv_247 = strings_sb_finish(&_qoz_sb_3688_47);
    }
    qoz_string tmp_res = qoz_string_cat(QOZ_STR_LIT("_qoz_bv_"), _qoz_bv_247); qoz_string result_c = emit_c_type_for(e, hint); int64_t start = strings_sb_len(&e->out); qoz_string _qoz_bv_248;
    {
        qoz_Strbuf _qoz_sb_3691_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3691_17); strings_sb_append(&_qoz_sb_3691_17, result_c); strings_sb_append(&_qoz_sb_3691_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3691_17, tmp_res); strings_sb_append(&_qoz_sb_3691_17, QOZ_STR_LIT(";\n    {\n        ")); _qoz_bv_248 = strings_sb_finish(&_qoz_sb_3691_17);
    }
    emit_push(e, _qoz_bv_248); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_emit_stmt(e, s); } }qoz_Expr* _qoz_ms_266 = tail; switch (_qoz_ms_266->tag) { case qoz_Expr_EWhile: { {
        qoz_StmtScope saved = emit_open_statement_scope(e); emit_emit_stmt_expr(e, tail); emit_close_statement_scope(e, saved); qoz_string _qoz_bv_249;
    {
        qoz_Strbuf _qoz_sb_3698_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3698_21); strings_sb_append(&_qoz_sb_3698_21, QOZ_STR_LIT("\n        ")); strings_sb_append(&_qoz_sb_3698_21, tmp_res); strings_sb_append(&_qoz_sb_3698_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_249 = strings_sb_finish(&_qoz_sb_3698_21);
    }
    emit_push(e, _qoz_bv_249); 
    }
    0;  break; } case qoz_Expr_EFor: { {
        qoz_StmtScope saved = emit_open_statement_scope(e); emit_emit_stmt_expr(e, tail); emit_close_statement_scope(e, saved); qoz_string _qoz_bv_250;
    {
        qoz_Strbuf _qoz_sb_3698_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3698_21); strings_sb_append(&_qoz_sb_3698_21, QOZ_STR_LIT("\n        ")); strings_sb_append(&_qoz_sb_3698_21, tmp_res); strings_sb_append(&_qoz_sb_3698_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_250 = strings_sb_finish(&_qoz_sb_3698_21);
    }
    emit_push(e, _qoz_bv_250); 
    }
    0;  break; } case qoz_Expr_EAssign: { {
        qoz_StmtScope saved = emit_open_statement_scope(e); emit_emit_stmt_expr(e, tail); emit_close_statement_scope(e, saved); qoz_string _qoz_bv_251;
    {
        qoz_Strbuf _qoz_sb_3698_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3698_21); strings_sb_append(&_qoz_sb_3698_21, QOZ_STR_LIT("\n        ")); strings_sb_append(&_qoz_sb_3698_21, tmp_res); strings_sb_append(&_qoz_sb_3698_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_251 = strings_sb_finish(&_qoz_sb_3698_21);
    }
    emit_push(e, _qoz_bv_251); 
    }
    0;  break; } default: { {
        qoz_StmtScope saved = emit_open_statement_scope(e); qoz_string _qoz_bv_252;
    {
        qoz_Strbuf _qoz_sb_3702_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3702_21); strings_sb_append(&_qoz_sb_3702_21, tmp_res); strings_sb_append(&_qoz_sb_3702_21, QOZ_STR_LIT(" = ")); _qoz_bv_252 = strings_sb_finish(&_qoz_sb_3702_21);
    }
    emit_push(e, _qoz_bv_252); emit_emit_value_with_hint(e, tail, hint); emit_push(e, QOZ_STR_LIT(";\n    ")); emit_close_statement_scope(e, saved); 
    }
    0;  break; } } 0; emit_push(e, QOZ_STR_LIT("}\n    ")); emit_hoist_to_prologue(e, start); emit_push(e, tmp_res); 
    }
    0;  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_264->payload.EIf.f0; qoz_Expr* c = _qoz_ms_264->payload.EIf.f1; qoz_Expr* t = _qoz_ms_264->payload.EIf.f2; qoz_Expr* f = _qoz_ms_264->payload.EIf.f3; {
    ...
    0;  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_264->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_264->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_264->payload.EMatch.f2; emit_emit_match_as_expr_with_hint(e, sp, scrut, arms, hint);  break; } default: { emit_emit_expr(e, value);  break; } } 0; 
    return;
}
...
void emit_emit_ident_with_hint(qoz_Emitter* e, qoz_string name, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&hint);
    qoz_Option__qoz_string* _qoz_ms_267 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_267->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_267->payload.Some.f0; {
        qoz_Vec__qoz_TypeExpr hint_args = emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_253;
    {
        qoz_Strbuf _qoz_sb_3739_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3739_21); strings_sb_append(&_qoz_sb_3739_21, QOZ_STR_LIT("qoz_make_")); strings_sb_append(&_qoz_sb_3739_21, mangled); strings_sb_append(&_qoz_sb_3739_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3739_21, name); strings_sb_append(&_qoz_sb_3739_21, QOZ_STR_LIT("()")); _qoz_bv_253 = strings_sb_finish(&_qoz_sb_3739_21);
    }
    emit_push(e, _qoz_bv_253); return;} qoz_string _qoz_bv_254;
    {
        qoz_Strbuf _qoz_sb_3742_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3742_17); strings_sb_append(&_qoz_sb_3742_17, QOZ_STR_LIT("qoz_make_")); strings_sb_append(&_qoz_sb_3742_17, enum_name); strings_sb_append(&_qoz_sb_3742_17, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3742_17, name); strings_sb_append(&_qoz_sb_3742_17, QOZ_STR_LIT("()")); _qoz_bv_254 = strings_sb_finish(&_qoz_sb_3742_17);
    }
    emit_push(e, _qoz_bv_254); 
    }
    0;  break; } case qoz_Option__qoz_string_None: { {
        qoz_TypeExpr* _qoz_ms_268 = hint; switch (_qoz_ms_268->tag) { case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr fn_ps = _qoz_ms_268->payload.TEFn.f1; qoz_TypeExpr* fn_ret = _qoz_ms_268->payload.TEFn.f2; if (qoz_map_contains__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, name)) { if (!qoz_map_contains__qoz_string__qoz_TypeExpr(&e->locals, name)) { qoz_string thunk = emit_register_fn_thunk(e, name, fn_ps, fn_ret); qoz_string clo_t = emit_c_type_for(e, hint); qoz_string _qoz_bv_255;
    {
        qoz_Strbuf _qoz_sb_3753_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3753_29); strings_sb_append(&_qoz_sb_3753_29, QOZ_STR_LIT("((")); strings_sb_append(&_qoz_sb_3753_29, clo_t); strings_sb_append(&_qoz_sb_3753_29, QOZ_STR_LIT("){ .env = NULL, .fn = ")); strings_sb_append(&_qoz_sb_3753_29, thunk); strings_sb_append(&_qoz_sb_3753_29, QOZ_STR_LIT(" })")); _qoz_bv_255 = strings_sb_finish(&_qoz_sb_3753_29);
    }
    emit_push(e, _qoz_bv_255); return;} } 0;  break; } default: { NULL;  break; } } 0; emit_push(e, name); 
    }
    0;  break; } } 0; 
    return;
}
...
void emit_emit_call_with_hint(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&callee);
    qoz_gc_push_root(&hint);
    if ((type_args.len) > 0) { emit_emit_call(e, callee, type_args, args); return;} qoz_Expr* _qoz_ms_269 = callee; switch (_qoz_ms_269->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_269->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_270 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_270->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_270->payload.Some.f0; {
        qoz_Vec__qoz_TypeExpr hint_args = emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_256;
    {
        qoz_Strbuf _qoz_sb_3838_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3838_25); strings_sb_append(&_qoz_sb_3838_25, QOZ_STR_LIT("qoz_make_")); strings_sb_append(&_qoz_sb_3838_25, mangled); strings_sb_append(&_qoz_sb_3838_25, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3838_25, name); strings_sb_append(&_qoz_sb_3838_25, QOZ_STR_LIT("(")); _qoz_bv_256 = strings_sb_finish(&_qoz_sb_3838_25);
    }
    emit_push(e, _qoz_bv_256); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, a); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;} 
    }
...
qoz_Vec__qoz_TypeExpr emit_hint_args_for_enum(qoz_TypeExpr* hint, qoz_string enum_name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_271 = hint; qoz_Vec__qoz_TypeExpr _qoz_mv_271 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_271->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_271->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_271->payload.TENamed.f2; qoz_Vec__qoz_TypeExpr _qoz_bv_257;
    {
        if ((path.len) >= 1) { qoz_string last = path.data[(path.len) - 1]; if (qoz_string_eq(last, enum_name)) { return args;} } _qoz_bv_257 = qoz_vec_make__qoz_TypeExpr();
    }
    _qoz_mv_271 = (_qoz_bv_257);  break; } default: { _qoz_mv_271 = (qoz_vec_make__qoz_TypeExpr());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_271;
}
...
void emit_emit_record_lit_with_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_Vec__qoz_RecordFieldLit fields, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* effective = emit_pick_type_with_args(te, hint); qoz_gc_push_root(&effective); qoz_string ec = emit_c_type_for(e, effective); qoz_string _qoz_bv_258;
    {
        qoz_Strbuf _qoz_sb_3873_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3873_13); strings_sb_append(&_qoz_sb_3873_13, QOZ_STR_LIT("((")); strings_sb_append(&_qoz_sb_3873_13, ec); strings_sb_append(&_qoz_sb_3873_13, QOZ_STR_LIT("){ ")); _qoz_bv_258 = strings_sb_finish(&_qoz_sb_3873_13);
    }
    emit_push(e, _qoz_bv_258); int64_t i = 0; { qoz_Vec__qoz_RecordFieldLit __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } qoz_string fn = f.name; qoz_string _qoz_bv_259;
    {
        qoz_Strbuf _qoz_sb_3878_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3878_17); strings_sb_append(&_qoz_sb_3878_17, QOZ_STR_LIT(".")); strings_sb_append(&_qoz_sb_3878_17, fn); strings_sb_append(&_qoz_sb_3878_17, QOZ_STR_LIT(" = ")); _qoz_bv_259 = strings_sb_finish(&_qoz_sb_3878_17);
    }
    emit_push(e, _qoz_bv_259); qoz_TypeExpr* field_hint = emit_field_type_hint(e, effective, f.name); qoz_gc_push_root(&field_hint); emit_emit_value_with_hint(e, f.value, field_hint); i = i + 1; } }emit_push(e, QOZ_STR_LIT(" })")); 
    return;
}
...
qoz_TypeExpr* emit_field_type_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string field_name) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_272 = te; qoz_TypeExpr* _qoz_mv_272 = NULL; switch (_qoz_ms_272->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_272->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_272->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_272->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_260;
    {
        if ((path.len) < 1) { return te;} qoz_string name = emit_type_lookup_key(e, path); if (!qoz_map_contains__qoz_string__qoz_Decl(&e->generic_decls, name)) { return te;} qoz_Option__qoz_Decl* _qoz_ms_273 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, name); qoz_TypeExpr* _qoz_mv_273 = NULL; switch (_qoz_ms_273->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_273->payload.Some.f0; qoz_Decl* _qoz_ms_274 = decl; qoz_TypeExpr* _qoz_mv_274 = NULL; switch (_qoz_ms_274->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_274->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_274->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_261;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField sf = __col.data[__i]; (void)sf; if (qoz_string_eq(sf.name, field_name)) { if ((args.len) == (params.len)) { return emit_substitute_type(e, sf.ty, params, args);} return sf.ty;} } }_qoz_bv_261 = te;
    }
    _qoz_mv_274 = (_qoz_bv_261);  break; } default: { _qoz_mv_274 = (te);  break; } } _qoz_mv_273 = (_qoz_mv_274);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_273 = (te);  break; } } _qoz_bv_260 = _qoz_mv_273;
    }
    _qoz_mv_272 = (_qoz_bv_260);  break; } default: { _qoz_mv_272 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_272;
}
...
qoz_TypeExpr* emit_pick_type_with_args(qoz_TypeExpr* te, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_275 = te; qoz_TypeExpr* _qoz_mv_275 = NULL; switch (_qoz_ms_275->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string te_path = _qoz_ms_275->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr te_args = _qoz_ms_275->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_262;
    {
        if ((te_args.len) > 0) { return te;} qoz_TypeExpr* _qoz_ms_276 = hint; qoz_TypeExpr* _qoz_mv_276 = NULL; switch (_qoz_ms_276->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string h_path = _qoz_ms_276->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr h_args = _qoz_ms_276->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_263;
    {
        if ((h_args.len) == 0) { return te;} if ((((h_path.len) == 1) && ((te_path.len) == 1)) && qoz_string_eq(h_path.data[0], te_path.data[0])) { return hint;} _qoz_bv_263 = te;
    }
    _qoz_mv_276 = (_qoz_bv_263);  break; } default: { _qoz_mv_276 = (te);  break; } } _qoz_bv_262 = _qoz_mv_276;
    }
    _qoz_mv_275 = (_qoz_bv_262);  break; } default: { _qoz_mv_275 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_275;
}
...
void emit_emit_for_loop_one(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_277 = iter; switch (_qoz_ms_277->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_277->payload.EBinary.f1; qoz_Expr* lo = _qoz_ms_277->payload.EBinary.f2; qoz_Expr* hi = _qoz_ms_277->payload.EBinary.f3; if (emit_is_range_op(op)) { qoz_string _qoz_bv_264;
    {
        qoz_Strbuf _qoz_sb_3954_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3954_21); strings_sb_append(&_qoz_sb_3954_21, QOZ_STR_LIT("for (int64_t ")); strings_sb_append(&_qoz_sb_3954_21, binding); strings_sb_append(&_qoz_sb_3954_21, QOZ_STR_LIT(" = ")); _qoz_bv_264 = strings_sb_finish(&_qoz_sb_3954_21);
    }
    emit_push(e, _qoz_bv_264); emit_emit_expr(e, lo); qoz_string cmp = emit_range_cmp_op(op); qoz_string _qoz_bv_265;
    {
        qoz_Strbuf _qoz_sb_3957_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3957_21); strings_sb_append(&_qoz_sb_3957_21, QOZ_STR_LIT("; ")); strings_sb_append(&_qoz_sb_3957_21, binding); strings_sb_append(&_qoz_sb_3957_21, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3957_21, cmp); strings_sb_append(&_qoz_sb_3957_21, QOZ_STR_LIT(" ")); _qoz_bv_265 = strings_sb_finish(&_qoz_sb_3957_21);
    }
    emit_push(e, _qoz_bv_265); emit_emit_expr(e, hi); qoz_string _qoz_bv_266;
    {
        qoz_Strbuf _qoz_sb_3959_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3959_21); strings_sb_append(&_qoz_sb_3959_21, QOZ_STR_LIT("; ")); strings_sb_append(&_qoz_sb_3959_21, binding); strings_sb_append(&_qoz_sb_3959_21, QOZ_STR_LIT("++) ")); _qoz_bv_266 = strings_sb_finish(&_qoz_sb_3959_21);
    }
    emit_push(e, _qoz_bv_266); emit_emit_branch_as_statement(e, body); return;} 0;  break; } default: { NULL;  break; } } 0; if (qoz_string_eq(binding2, QOZ_STR_LIT(""))) { emit_emit_vec_for(e, binding, iter, body); }  else { emit_emit_map_for(e, binding, binding2, iter, body); } 
    return;
}
...
void emit_emit_vec_for(qoz_Emitter* e, qoz_string binding, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* elem_te = emit_vec_element_typeexpr(e, iter); qoz_gc_push_root(&elem_te); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, binding, elem_te); qoz_string col_ct = emit_c_type_for(e, emit_infer_base_typeexpr(e, iter)); qoz_string elem_ct = emit_c_type_for(e, elem_te); qoz_string _qoz_bv_267;
    {
        qoz_Strbuf _qoz_sb_3979_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3979_13); strings_sb_append(&_qoz_sb_3979_13, QOZ_STR_LIT("{ ")); strings_sb_append(&_qoz_sb_3979_13, col_ct); strings_sb_append(&_qoz_sb_3979_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_267 = strings_sb_finish(&_qoz_sb_3979_13);
    }
    emit_push(e, _qoz_bv_267); emit_emit_expr(e, iter); qoz_string _qoz_bv_268;
    {
        qoz_Strbuf _qoz_sb_3981_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3981_13); strings_sb_append(&_qoz_sb_3981_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.len; __i++) { ")); strings_sb_append(&_qoz_sb_3981_13, elem_ct); strings_sb_append(&_qoz_sb_3981_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3981_13, binding); strings_sb_append(&_qoz_sb_3981_13, QOZ_STR_LIT(" = __col.data[__i]; (void)")); strings_sb_append(&_qoz_sb_3981_13, binding); strings_sb_append(&_qoz_sb_3981_13, QOZ_STR_LIT("; ")); _qoz_bv_268 = strings_sb_finish(&_qoz_sb_3981_13);
    }
    emit_push(e, _qoz_bv_268); emit_emit_branch_body_inline(e, body); emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* emit_vec_element_typeexpr(qoz_Emitter* e, qoz_Expr* iter) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&iter);
    qoz_TypeExpr* te = emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_278 = te; qoz_TypeExpr* _qoz_mv_278 = NULL; switch (_qoz_ms_278->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_278->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_278->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_278->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_269;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_269 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_278 = (_qoz_bv_269);  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_278->payload.TEPtr.f1; _qoz_mv_278 = (inner);  break; } default: { _qoz_mv_278 = (qoz_make_TypeExpr_TEUnit(emit_span_of_expr(iter)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_278;
}
...
void emit_emit_map_for(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* iter_te = emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&iter_te); qoz_string col_ct = emit_c_type_for(e, iter_te); qoz_TypeExpr* key_te = emit_map_key_typeexpr(e, iter_te); qoz_gc_push_root(&key_te); qoz_TypeExpr* val_te = emit_map_val_typeexpr(e, iter_te); qoz_gc_push_root(&val_te); qoz_string key_ct = emit_c_type_for(e, key_te); qoz_string val_ct = emit_c_type_for(e, val_te); qoz_string _qoz_bv_270;
    {
        qoz_Strbuf _qoz_sb_4005_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4005_13); strings_sb_append(&_qoz_sb_4005_13, QOZ_STR_LIT("{ ")); strings_sb_append(&_qoz_sb_4005_13, col_ct); strings_sb_append(&_qoz_sb_4005_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_270 = strings_sb_finish(&_qoz_sb_4005_13);
    }
    emit_push(e, _qoz_bv_270); emit_emit_expr(e, iter); qoz_string _qoz_bv_271;
    {
        qoz_Strbuf _qoz_sb_4007_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4007_13); strings_sb_append(&_qoz_sb_4007_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.cap; __i++) { if (!__col.slots[__i].occupied || __col.slots[__i].deleted) continue; ")); strings_sb_append(&_qoz_sb_4007_13, key_ct); strings_sb_append(&_qoz_sb_4007_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4007_13, binding); strings_sb_append(&_qoz_sb_4007_13, QOZ_STR_LIT(" = __col.slots[__i].key; ")); strings_sb_append(&_qoz_sb_4007_13, val_ct); strings_sb_append(&_qoz_sb_4007_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4007_13, binding2); strings_sb_append(&_qoz_sb_4007_13, QOZ_STR_LIT(" = __col.slots[__i].value; (void)")); strings_sb_append(&_qoz_sb_4007_13, binding); strings_sb_append(&_qoz_sb_4007_13, QOZ_STR_LIT("; (void)")); strings_sb_append(&_qoz_sb_4007_13, binding2); strings_sb_append(&_qoz_sb_4007_13, QOZ_STR_LIT("; ")); _qoz_bv_271 = strings_sb_finish(&_qoz_sb_4007_13);
    }
    emit_push(e, _qoz_bv_271); emit_emit_branch_body_inline(e, body); emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* emit_map_key_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_279 = te; qoz_TypeExpr* _qoz_mv_279 = NULL; switch (_qoz_ms_279->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_279->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_279->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_279->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_272;
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[0];} _qoz_bv_272 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_279 = (_qoz_bv_272);  break; } default: { _qoz_mv_279 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_279;
}
...
qoz_TypeExpr* emit_map_val_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_280 = te; qoz_TypeExpr* _qoz_mv_280 = NULL; switch (_qoz_ms_280->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_280->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_280->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_280->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_273;
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[1];} _qoz_bv_273 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_280 = (_qoz_bv_273);  break; } default: { _qoz_mv_280 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_280;
}
...
void emit_emit_branch_body_inline(qoz_Emitter* e, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_281 = body; switch (_qoz_ms_281->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_281->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_281->payload.EBlock.f2; {
...
bool emit_any_arm_is_literal(qoz_Vec__qoz_MatchArm arms) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm a = __col.data[__i]; (void)a; qoz_Pattern* _qoz_ms_282 = a.pat; switch (_qoz_ms_282->tag) { case qoz_Pattern_PatLitInt: { return true; break; } case qoz_Pattern_PatLitString: { return true; break; } case qoz_Pattern_PatLitBool: { return true; break; } default: { NULL;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return false;
}
...
void emit_emit_match_as_expr(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    if (emit_any_arm_has_guard(arms)) { emit_emit_match_as_if_chain(e, span, scrut, arms); return;} if (emit_any_arm_is_literal(arms)) { emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string bare_enum = emit_find_enum_from_arms(e, arms); if (qoz_string_eq(bare_enum, QOZ_STR_LIT(""))) { emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string enum_name = emit_enum_lookup_name(e, scrut, bare_enum); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_274;
    {
        qoz_Strbuf _qoz_sb_4093_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4093_21); strings_sb_append(&_qoz_sb_4093_21, QOZ_STR_LIT("_qoz_ms_")); strings_sb_append_i64(&_qoz_sb_4093_21, e->match_counter); _qoz_bv_274 = strings_sb_finish(&_qoz_sb_4093_21);
    }
    qoz_string scrut_tmp = _qoz_bv_274; qoz_string _qoz_bv_275;
    {
        qoz_Strbuf _qoz_sb_4094_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4094_21); strings_sb_append(&_qoz_sb_4094_21, QOZ_STR_LIT("_qoz_mv_")); strings_sb_append_i64(&_qoz_sb_4094_21, e->match_counter); _qoz_bv_275 = strings_sb_finish(&_qoz_sb_4094_21);
    }
    qoz_string res_tmp = _qoz_bv_275; qoz_string res_ctype = emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_string_eq(res_ctype, QOZ_STR_LIT("void")); int64_t start = strings_sb_len(&e->out); qoz_string _qoz_bv_276;
    {
        qoz_Strbuf _qoz_sb_4103_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4103_13); strings_sb_append(&_qoz_sb_4103_13, QOZ_STR_LIT("qoz_")); strings_sb_append(&_qoz_sb_4103_13, enum_name); strings_sb_append(&_qoz_sb_4103_13, QOZ_STR_LIT("* ")); strings_sb_append(&_qoz_sb_4103_13, scrut_tmp); strings_sb_append(&_qoz_sb_4103_13, QOZ_STR_LIT(" = ")); _qoz_bv_276 = strings_sb_finish(&_qoz_sb_4103_13);
    }
    emit_push(e, _qoz_bv_276); emit_emit_expr(e, scrut); emit_push(e, QOZ_STR_LIT("; ")); if (!is_void) { qoz_string dv = emit_default_value_for(res_ctype); qoz_string _qoz_bv_277;
    {
        qoz_Strbuf _qoz_sb_4108_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4108_17); strings_sb_append(&_qoz_sb_4108_17, res_ctype); strings_sb_append(&_qoz_sb_4108_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4108_17, res_tmp); strings_sb_append(&_qoz_sb_4108_17, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_4108_17, dv); strings_sb_append(&_qoz_sb_4108_17, QOZ_STR_LIT("; ")); _qoz_bv_277 = strings_sb_finish(&_qoz_sb_4108_17);
    }
    emit_push(e, _qoz_bv_277); } qoz_string _qoz_bv_278;
    {
        qoz_Strbuf _qoz_sb_4110_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4110_13); strings_sb_append(&_qoz_sb_4110_13, QOZ_STR_LIT("switch (")); strings_sb_append(&_qoz_sb_4110_13, scrut_tmp); strings_sb_append(&_qoz_sb_4110_13, QOZ_STR_LIT("->tag) { ")); _qoz_bv_278 = strings_sb_finish(&_qoz_sb_4110_13);
    }
    emit_push(e, _qoz_bv_278); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; emit_emit_match_arm_with_kind(e, enum_name, scrut_tmp, res_tmp, arm, is_void); } }emit_push(e, QOZ_STR_LIT("} ")); emit_hoist_to_prologue(e, start); if (is_void) { emit_push(e, QOZ_STR_LIT("0")); }  else { emit_push(e, res_tmp); } 
    return;
}
...
void emit_emit_match_as_if_chain(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    qoz_string bare_enum = emit_find_enum_from_arms(e, arms); bool is_enum_match = !qoz_string_eq(bare_enum, QOZ_STR_LIT("")); qoz_string enum_name = QOZ_STR_LIT(""); if (is_enum_match) { enum_name = emit_enum_lookup_name(e, scrut, bare_enum); } qoz_string scrut_ctype = emit_infer_expr_ctype(e, scrut); qoz_TypeExpr* scrut_te = emit_infer_value_te(e, scrut); qoz_gc_push_root(&scrut_te); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_279;
    {
        qoz_Strbuf _qoz_sb_4131_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4131_21); strings_sb_append(&_qoz_sb_4131_21, QOZ_STR_LIT("_qoz_ms_")); strings_sb_append_i64(&_qoz_sb_4131_21, e->match_counter); _qoz_bv_279 = strings_sb_finish(&_qoz_sb_4131_21);
    }
    qoz_string scrut_tmp = _qoz_bv_279; qoz_string _qoz_bv_280;
    {
        qoz_Strbuf _qoz_sb_4132_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4132_21); strings_sb_append(&_qoz_sb_4132_21, QOZ_STR_LIT("_qoz_mv_")); strings_sb_append_i64(&_qoz_sb_4132_21, e->match_counter); _qoz_bv_280 = strings_sb_finish(&_qoz_sb_4132_21);
    }
    qoz_string res_tmp = _qoz_bv_280; qoz_string _qoz_bv_281;
    {
        qoz_Strbuf _qoz_sb_4133_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4133_21); strings_sb_append(&_qoz_sb_4133_21, QOZ_STR_LIT("_qoz_mm_")); strings_sb_append_i64(&_qoz_sb_4133_21, e->match_counter); _qoz_bv_281 = strings_sb_finish(&_qoz_sb_4133_21);
    }
    qoz_string mflag = _qoz_bv_281; qoz_string res_ctype = emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_string_eq(res_ctype, QOZ_STR_LIT("void")); int64_t start = strings_sb_len(&e->out); if (is_enum_match) { qoz_string _qoz_bv_282;
    {
        qoz_Strbuf _qoz_sb_4138_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4138_17); strings_sb_append(&_qoz_sb_4138_17, QOZ_STR_LIT("qoz_")); strings_sb_append(&_qoz_sb_4138_17, enum_name); strings_sb_append(&_qoz_sb_4138_17, QOZ_STR_LIT("* ")); strings_sb_append(&_qoz_sb_4138_17, scrut_tmp); strings_sb_append(&_qoz_sb_4138_17, QOZ_STR_LIT(" = ")); _qoz_bv_282 = strings_sb_finish(&_qoz_sb_4138_17);
    }
    emit_push(e, _qoz_bv_282); }  else { qoz_string _qoz_bv_283;
    {
        qoz_Strbuf _qoz_sb_4140_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4140_17); strings_sb_append(&_qoz_sb_4140_17, scrut_ctype); strings_sb_append(&_qoz_sb_4140_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4140_17, scrut_tmp); strings_sb_append(&_qoz_sb_4140_17, QOZ_STR_LIT(" = ")); _qoz_bv_283 = strings_sb_finish(&_qoz_sb_4140_17);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_4146_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4146_17); strings_sb_append(&_qoz_sb_4146_17, res_ctype); strings_sb_append(&_qoz_sb_4146_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4146_17, res_tmp); strings_sb_append(&_qoz_sb_4146_17, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_4146_17, dv); strings_sb_append(&_qoz_sb_4146_17, QOZ_STR_LIT("; ")); _qoz_bv_284 = strings_sb_finish(&_qoz_sb_4146_17);
    }
    emit_push(e, _qoz_bv_284); } qoz_string _qoz_bv_285;
    {
        qoz_Strbuf _qoz_sb_4148_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4148_13); strings_sb_append(&_qoz_sb_4148_13, QOZ_STR_LIT("bool ")); strings_sb_append(&_qoz_sb_4148_13, mflag); strings_sb_append(&_qoz_sb_4148_13, QOZ_STR_LIT(" = false; ")); _qoz_bv_285 = strings_sb_finish(&_qoz_sb_4148_13);
    }
...
void emit_emit_arm_in_chain_with_te(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_TypeExpr* scrut_te, qoz_string res_tmp, qoz_string mflag, qoz_MatchArm arm, bool is_void) {
    ...
    qoz_TypeExpr* body_hint = emit_match_body_hint(e, enum_name, arm.body); qoz_gc_push_root(&body_hint); bool is_enum_match = !qoz_string_eq(enum_name, QOZ_STR_LIT("")); emit_push(e, QOZ_STR_LIT("if (!")); emit_push(e, mflag); qoz_Pattern* _qoz_ms_283 = arm.pat; switch (_qoz_ms_283->tag) { case qoz_Pattern_PatWild: { emit_push(e, QOZ_STR_LIT(") { "));  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_283->payload.PatBind.f1; if (is_enum_match) { qoz_Option__qoz_string* _qoz_ms_284 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_284->tag) { case qoz_Option__qoz_string_Some: { qoz_string _qoz_bv_286;
    {
        qoz_Strbuf _qoz_sb_4170_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4170_25); strings_sb_append(&_qoz_sb_4170_25, QOZ_STR_LIT(" && ")); strings_sb_append(&_qoz_sb_4170_25, scrut_tmp); strings_sb_append(&_qoz_sb_4170_25, QOZ_STR_LIT("->tag == qoz_")); strings_sb_append(&_qoz_sb_4170_25, enum_name); strings_sb_append(&_qoz_sb_4170_25, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_4170_25, name); strings_sb_append(&_qoz_sb_4170_25, QOZ_STR_LIT(") { ")); _qoz_bv_286 = strings_sb_finish(&_qoz_sb_4170_25);
    }
    emit_push(e, _qoz_bv_286);  break; } default: { qoz_string _qoz_bv_287;
    {
        qoz_Strbuf _qoz_sb_4172_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4172_25); strings_sb_append(&_qoz_sb_4172_25, QOZ_STR_LIT(") { int64_t ")); strings_sb_append(&_qoz_sb_4172_25, name); strings_sb_append(&_qoz_sb_4172_25, QOZ_STR_LIT(" = 0; (void)")); strings_sb_append(&_qoz_sb_4172_25, name); strings_sb_append(&_qoz_sb_4172_25, QOZ_STR_LIT("; ")); _qoz_bv_287 = strings_sb_finish(&_qoz_sb_4172_25);
    }
    emit_push(e, _qoz_bv_287);  break; } } 0; }  else { qoz_string sc = emit_c_type_for(e, scrut_te); qoz_string _qoz_bv_288;
    {
        qoz_Strbuf _qoz_sb_4176_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4176_21); strings_sb_append(&_qoz_sb_4176_21, QOZ_STR_LIT(") { ")); strings_sb_append(&_qoz_sb_4176_21, sc); strings_sb_append(&_qoz_sb_4176_21, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4176_21, name); strings_sb_append(&_qoz_sb_4176_21, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_4176_21, scrut_tmp); strings_sb_append(&_qoz_sb_4176_21, QOZ_STR_LIT("; (void)")); strings_sb_append(&_qoz_sb_4176_21, name); strings_sb_append(&_qoz_sb_4176_21, QOZ_STR_LIT("; ")); _qoz_bv_288 = strings_sb_finish(&_qoz_sb_4176_21);
    }
    emit_push(e, _qoz_bv_288); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, scrut_te); } 0;  break; } case qoz_Pattern_PatLitInt: { qoz_string text = _qoz_ms_283->payload.PatLitInt.f1; {
        qoz_string tn = emit_strip_numeric_underscores(text); qoz_string _qoz_bv_289;
    {
        qoz_Strbuf _qoz_sb_4182_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4182_17); strings_sb_append(&_qoz_sb_4182_17, QOZ_STR_LIT(" && ")); strings_sb_append(&_qoz_sb_4182_17, scrut_tmp); strings_sb_append(&_qoz_sb_4182_17, QOZ_STR_LIT(" == ")); strings_sb_append(&_qoz_sb_4182_17, tn); strings_sb_append(&_qoz_sb_4182_17, QOZ_STR_LIT(") { ")); _qoz_bv_289 = strings_sb_finish(&_qoz_sb_4182_17);
    }
    emit_push(e, _qoz_bv_289); 
    }
    0;  break; } case qoz_Pattern_PatLitBool: { bool b = _qoz_ms_283->payload.PatLitBool.f1; if (b) { qoz_string _qoz_bv_290;
    {
        qoz_Strbuf _qoz_sb_4185_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4185_24); strings_sb_append(&_qoz_sb_4185_24, QOZ_STR_LIT(" && ")); strings_sb_append(&_qoz_sb_4185_24, scrut_tmp); strings_sb_append(&_qoz_sb_4185_24, QOZ_STR_LIT(" == true) { ")); _qoz_bv_290 = strings_sb_finish(&_qoz_sb_4185_24);
    }
    emit_push(e, _qoz_bv_290); }  else { qoz_string _qoz_bv_291;
    {
        qoz_Strbuf _qoz_sb_4186_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4186_24); strings_sb_append(&_qoz_sb_4186_24, QOZ_STR_LIT(" && ")); strings_sb_append(&_qoz_sb_4186_24, scrut_tmp); strings_sb_append(&_qoz_sb_4186_24, QOZ_STR_LIT(" == false) { ")); _qoz_bv_291 = strings_sb_finish(&_qoz_sb_4186_24);
    }
    emit_push(e, _qoz_bv_291); } 0;  break; } case qoz_Pattern_PatLitString: { qoz_string text = _qoz_ms_283->payload.PatLitString.f1; qoz_string _qoz_bv_292;
    {
        qoz_Strbuf _qoz_sb_4189_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4189_17); strings_sb_append(&_qoz_sb_4189_17, QOZ_STR_LIT(" && qoz_string_eq(")); strings_sb_append(&_qoz_sb_4189_17, scrut_tmp); strings_sb_append(&_qoz_sb_4189_17, QOZ_STR_LIT(", QOZ_STR_LIT(")); strings_sb_append(&_qoz_sb_4189_17, text); strings_sb_append(&_qoz_sb_4189_17, QOZ_STR_LIT("))) { ")); _qoz_bv_292 = strings_sb_finish(&_qoz_sb_4189_17);
    }
    emit_push(e, _qoz_bv_292);  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_283->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_283->payload.PatVariant.f2; if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_293;
    {
        qoz_Strbuf _qoz_sb_4194_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4194_21); strings_sb_append(&_qoz_sb_4194_21, QOZ_STR_LIT(" && ")); strings_sb_append(&_qoz_sb_4194_21, scrut_tmp); strings_sb_append(&_qoz_sb_4194_21, QOZ_STR_LIT("->tag == qoz_")); strings_sb_append(&_qoz_sb_4194_21, enum_name); strings_sb_append(&_qoz_sb_4194_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_4194_21, vname); strings_sb_append(&_qoz_sb_4194_21, QOZ_STR_LIT(") { ")); _qoz_bv_293 = strings_sb_finish(&_qoz_sb_4194_21);
    }
    emit_push(e, _qoz_bv_293); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_285 = sp; switch (_qoz_ms_285->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_285->payload.PatBind.f1; {
        qoz_string pc = emit_variant_payload_ctype(e, enum_name, vname, i); qoz_string is = emit_int_to_string(i); qoz_string _qoz_bv_294;
    {
        qoz_Strbuf _qoz_sb_4201_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4201_29); strings_sb_append(&_qoz_sb_4201_29, pc); strings_sb_append(&_qoz_sb_4201_29, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4201_29, bname); strings_sb_append(&_qoz_sb_4201_29, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_4201_29, scrut_tmp); strings_sb_append(&_qoz_sb_4201_29, QOZ_STR_LIT("->payload.")); strings_sb_append(&_qoz_sb_4201_29, vname); strings_sb_append(&_qoz_sb_4201_29, QOZ_STR_LIT(".f")); strings_sb_append(&_qoz_sb_4201_29, is); strings_sb_append(&_qoz_sb_4201_29, QOZ_STR_LIT("; ")); _qoz_bv_294 = strings_sb_finish(&_qoz_sb_4201_29);
    }
    emit_push(e, _qoz_bv_294); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, emit_variant_payload_typeexpr(e, enum_name, vname, i)); 
    }
...
void emit_emit_match_arm_with_kind(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_string res_tmp, qoz_MatchArm arm, bool is_void) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_TypeExpr* body_hint = emit_match_body_hint(e, enum_name, arm.body); qoz_gc_push_root(&body_hint); qoz_Pattern* _qoz_ms_286 = arm.pat; switch (_qoz_ms_286->tag) { case qoz_Pattern_PatWild: { {
    ...
    0;  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_286->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_287 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_287->tag) { case qoz_Option__qoz_string_Some: { {
        qoz_string _qoz_bv_295;
    {
        qoz_Strbuf _qoz_sb_4264_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4264_21); strings_sb_append(&_qoz_sb_4264_21, QOZ_STR_LIT("case qoz_")); strings_sb_append(&_qoz_sb_4264_21, enum_name); strings_sb_append(&_qoz_sb_4264_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_4264_21, name); strings_sb_append(&_qoz_sb_4264_21, QOZ_STR_LIT(": { ")); _qoz_bv_295 = strings_sb_finish(&_qoz_sb_4264_21);
    }
    emit_push(e, _qoz_bv_295); if (arm.has_guard) { emit_push(e, QOZ_STR_LIT("if (")); emit_emit_expr(e, arm.guard); emit_push(e, QOZ_STR_LIT(") { ")); emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); emit_push(e, QOZ_STR_LIT("} ")); }  else { emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); } emit_push(e, QOZ_STR_LIT(" break; } ")); 
    }
    0;  break; } case qoz_Option__qoz_string_None: { {
        if (is_void) { emit_push(e, QOZ_STR_LIT("default: { ")); }  else { qoz_string _qoz_bv_296;
    {
        qoz_Strbuf _qoz_sb_4280_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4280_25); strings_sb_append(&_qoz_sb_4280_25, QOZ_STR_LIT("default: { int64_t ")); strings_sb_append(&_qoz_sb_4280_25, name); strings_sb_append(&_qoz_sb_4280_25, QOZ_STR_LIT(" = 0; (void)")); strings_sb_append(&_qoz_sb_4280_25, name); strings_sb_append(&_qoz_sb_4280_25, QOZ_STR_LIT("; ")); _qoz_bv_296 = strings_sb_finish(&_qoz_sb_4280_25);
    }
    emit_push(e, _qoz_bv_296); } if (arm.has_guard) { emit_push(e, QOZ_STR_LIT("if (")); emit_emit_expr(e, arm.guard); emit_push(e, QOZ_STR_LIT(") { ")); emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); emit_push(e, QOZ_STR_LIT("} ")); }  else { emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); } emit_push(e, QOZ_STR_LIT(" break; } ")); 
    }
    0;  break; } } 0;  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_286->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_286->payload.PatVariant.f2; if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_297;
    {
        qoz_Strbuf _qoz_sb_4298_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4298_21); strings_sb_append(&_qoz_sb_4298_21, QOZ_STR_LIT("case qoz_")); strings_sb_append(&_qoz_sb_4298_21, enum_name); strings_sb_append(&_qoz_sb_4298_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_4298_21, vname); strings_sb_append(&_qoz_sb_4298_21, QOZ_STR_LIT(": { ")); _qoz_bv_297 = strings_sb_finish(&_qoz_sb_4298_21);
    }
    emit_push(e, _qoz_bv_297); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_288 = sp; switch (_qoz_ms_288->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_288->payload.PatBind.f1; {
        qoz_string pc = emit_variant_payload_ctype(e, enum_name, vname, i); qoz_string is = emit_int_to_string(i); qoz_string _qoz_bv_298;
    {
        qoz_Strbuf _qoz_sb_4305_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4305_29); strings_sb_append(&_qoz_sb_4305_29, pc); strings_sb_append(&_qoz_sb_4305_29, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4305_29, bname); strings_sb_append(&_qoz_sb_4305_29, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_4305_29, scrut_tmp); strings_sb_append(&_qoz_sb_4305_29, QOZ_STR_LIT("->payload.")); strings_sb_append(&_qoz_sb_4305_29, vname); strings_sb_append(&_qoz_sb_4305_29, QOZ_STR_LIT(".f")); strings_sb_append(&_qoz_sb_4305_29, is); strings_sb_append(&_qoz_sb_4305_29, QOZ_STR_LIT("; ")); _qoz_bv_298 = strings_sb_finish(&_qoz_sb_4305_29);
    }
    emit_push(e, _qoz_bv_298); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, emit_variant_payload_typeexpr(e, enum_name, vname, i)); 
    }
...
qoz_string emit_enum_name_from_type(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string bare_enum) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_289 = te; qoz_string _qoz_mv_289 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_289->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_289->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_289->payload.TENamed.f2; qoz_string _qoz_bv_299;
    {
        if (((args.len) > 0) && ((path.len) >= 1)) { qoz_string last = path.data[(path.len) - 1]; if (qoz_string_eq(last, bare_enum)) { return emit_mangle_inst(e, bare_enum, args);} } _qoz_bv_299 = bare_enum;
    }
    _qoz_mv_289 = (_qoz_bv_299);  break; } default: { _qoz_mv_289 = (bare_enum);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_289;
}
...
qoz_TypeExpr* emit_variant_payload_typeexpr(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, int64_t pos) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string bare = emit_strip_mangled(enum_name); qoz_Span unit_sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_Option__qoz_Decl* _qoz_ms_290 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, bare); qoz_TypeExpr* _qoz_mv_290 = NULL; switch (_qoz_ms_290->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_290 = (qoz_make_TypeExpr_TEUnit(unit_sp));  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_290->payload.Some.f0; qoz_Decl* _qoz_ms_291 = d; qoz_TypeExpr* _qoz_mv_291 = NULL; switch (_qoz_ms_291->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_291->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_291->payload.DEnum.f3; qoz_TypeExpr* _qoz_bv_300;
    {
        qoz_Vec__qoz_TypeExpr inst_args = emit_variant_inst_args(e, enum_name, bare); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_string_eq(v.name, variant)) { if ((pos >= 0) && (pos < (v.pos.len))) { if (((tparams.len) > 0) && ((inst_args.len) == (tparams.len))) { return emit_substitute_type(e, v.pos.data[pos], tparams, inst_args);} return v.pos.data[pos];} } } }_qoz_bv_300 = qoz_make_TypeExpr_TEUnit(unit_sp);
    }
    _qoz_mv_291 = (_qoz_bv_300);  break; } default: { _qoz_mv_291 = (qoz_make_TypeExpr_TEUnit(unit_sp));  break; } } _qoz_mv_290 = (_qoz_mv_291);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_290;
}

qoz_string emit_variant_payload_ctype(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, int64_t pos) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string bare = emit_strip_mangled(enum_name); qoz_Option__qoz_Decl* _qoz_ms_292 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, bare); qoz_string _qoz_mv_292 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_292->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_292 = (QOZ_STR_LIT("int64_t"));  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_292->payload.Some.f0; qoz_Decl* _qoz_ms_293 = d; qoz_string _qoz_mv_293 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_293->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_293->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_293->payload.DEnum.f3; qoz_string _qoz_bv_301;
    {
        qoz_Vec__qoz_TypeExpr inst_args = emit_variant_inst_args(e, enum_name, bare); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_string_eq(v.name, variant)) { if ((pos >= 0) && (pos < (v.pos.len))) { qoz_TypeExpr* subst = ((((tparams.len) > 0) && ((inst_args.len) == (tparams.len))) ? emit_substitute_type(e, v.pos.data[pos], tparams, inst_args) : v.pos.data[pos]); qoz_gc_push_root(&subst); return emit_c_type_for(e, subst);} } } }_qoz_bv_301 = QOZ_STR_LIT("int64_t");
    }
    _qoz_mv_293 = (_qoz_bv_301);  break; } default: { _qoz_mv_293 = (QOZ_STR_LIT("int64_t"));  break; } } _qoz_mv_292 = (_qoz_mv_293);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_292;
}
...
void emit_emit_arm_body_with_hint(qoz_Emitter* e, qoz_string res_tmp, qoz_Expr* body, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&body);
    qoz_gc_push_root(&hint);
    qoz_Expr* _qoz_ms_294 = body; switch (_qoz_ms_294->tag) { case qoz_Expr_EReturn: { qoz_Expr* v = _qoz_ms_294->payload.EReturn.f1; if (emit_is_nil_expr(v)) { emit_push(e, QOZ_STR_LIT("return; ")); }  else { emit_push(e, QOZ_STR_LIT("return ")); emit_emit_value_with_hint(e, v, e->current_ret_te); emit_push(e, QOZ_STR_LIT("; ")); } 0;  break; } default: { {
...
void emit_emit_main(qoz_Emitter* e, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&ret);
    qoz_gc_push_root(&body);
    qoz_MainRetKind* kind = emit_main_return_kind(ret); qoz_gc_push_root(&kind); emit_push(e, QOZ_STR_LIT("int main(int argc, char **argv) {\n    qoz_set_argv(argc, argv);\n    int qoz_stack_anchor;\n    qoz_init(&qoz_stack_anchor);\n    ")); qoz_Expr* _qoz_ms_295 = body; switch (_qoz_ms_295->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_295->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_295->payload.EBlock.f2; {
...
qoz_MainRetKind* emit_main_return_kind(qoz_TypeExpr* ret) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ret);
    qoz_TypeExpr* _qoz_ms_296 = ret; qoz_MainRetKind* _qoz_mv_296 = NULL; switch (_qoz_ms_296->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_296 = (qoz_make_MainRetKind_MainRetUnit());  break; } case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_296->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_296->payload.TENamed.f1; qoz_MainRetKind* _qoz_bv_302;
    {
        if ((path.len) != 1) { qoz_string _qoz_bv_303;
    {
        qoz_Strbuf _qoz_sb_4548_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4548_25); strings_sb_append(&_qoz_sb_4548_25, sp.file); strings_sb_append(&_qoz_sb_4548_25, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_4548_25, sp.line); strings_sb_append(&_qoz_sb_4548_25, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_4548_25, sp.col); strings_sb_append(&_qoz_sb_4548_25, QOZ_STR_LIT(": main return type must be a primitive integer or unit")); _qoz_bv_303 = strings_sb_finish(&_qoz_sb_4548_25);
    }
    fmt_println(_qoz_bv_303); return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));} qoz_string n = path.data[0]; if (qoz_string_eq(n, QOZ_STR_LIT("i8"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int8_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("i16"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int16_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("i32"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int32_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("i64"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u8"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint8_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u16"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint16_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u32"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint32_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u64"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint64_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("unit"))) { return qoz_make_MainRetKind_MainRetUnit();} if (qoz_string_eq(n, QOZ_STR_LIT("void"))) { return qoz_make_MainRetKind_MainRetUnit();} qoz_string _qoz_bv_304;
    {
        qoz_Strbuf _qoz_sb_4562_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4562_21); strings_sb_append(&_qoz_sb_4562_21, sp.file); strings_sb_append(&_qoz_sb_4562_21, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_4562_21, sp.line); strings_sb_append(&_qoz_sb_4562_21, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_4562_21, sp.col); strings_sb_append(&_qoz_sb_4562_21, QOZ_STR_LIT(": main may return only integer types or unit, got `")); strings_sb_append(&_qoz_sb_4562_21, n); strings_sb_append(&_qoz_sb_4562_21, QOZ_STR_LIT("`")); _qoz_bv_304 = strings_sb_finish(&_qoz_sb_4562_21);
    }
    fmt_println(_qoz_bv_304); _qoz_bv_302 = qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));
    }
    _qoz_mv_296 = (_qoz_bv_302);  break; } default: { qoz_MainRetKind* _qoz_bv_305;
    {
        fmt_println(QOZ_STR_LIT("main return type must be a primitive integer or unit")); _qoz_bv_305 = qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));
    }
    _qoz_mv_296 = (_qoz_bv_305);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_296;
}
...
void emit_emit_main_tail(qoz_Emitter* e, qoz_MainRetKind* kind, qoz_Expr* tail) {
    ...
    qoz_gc_push_root(&tail);
    qoz_MainRetKind* _qoz_ms_297 = kind; switch (_qoz_ms_297->tag) { case qoz_MainRetKind_MainRetUnit: { {
        qoz_Expr* _qoz_ms_298 = tail; bool _qoz_mv_298 = false; switch (_qoz_ms_298->tag) { case qoz_Expr_EIf: { qoz_Expr* f = _qoz_ms_298->payload.EIf.f3; _qoz_mv_298 = (emit_is_nil_expr(f));  break; } default: { _qoz_mv_298 = (false);  break; } } bool is_unit_if = _qoz_mv_298; qoz_Expr* _qoz_ms_299 = tail; switch (_qoz_ms_299->tag) { case qoz_Expr_EFor: { {
    ...
    0;  break; } case qoz_MainRetKind_MainRetInt: { qoz_string ctype = _qoz_ms_297->payload.MainRetInt.f0; {
...
bool ty_ty_eq(qoz_Ty* a, qoz_Ty* b) {
    ...
    qoz_gc_push_root(&a);
    qoz_gc_push_root(&b);
    qoz_Ty* _qoz_ms_300 = a; bool _qoz_mv_300 = false; switch (_qoz_ms_300->tag) { case qoz_Ty_TyInt: { qoz_IntInfo ai = _qoz_ms_300->payload.TyInt.f0; qoz_Ty* _qoz_ms_301 = b; bool _qoz_mv_301 = false; switch (_qoz_ms_301->tag) { case qoz_Ty_TyInt: { qoz_IntInfo bi = _qoz_ms_301->payload.TyInt.f0; _qoz_mv_301 = (((ai.width == bi.width) && (ai.is_signed == bi.is_signed)) && (ai.untyped == bi.untyped));  break; } default: { _qoz_mv_301 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_301);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo af = _qoz_ms_300->payload.TyFloat.f0; qoz_Ty* _qoz_ms_302 = b; bool _qoz_mv_302 = false; switch (_qoz_ms_302->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo bf = _qoz_ms_302->payload.TyFloat.f0; _qoz_mv_302 = ((af.width == bf.width) && (af.untyped == bf.untyped));  break; } default: { _qoz_mv_302 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_302);  break; } case qoz_Ty_TyBool: { qoz_Ty* _qoz_ms_303 = b; bool _qoz_mv_303 = false; switch (_qoz_ms_303->tag) { case qoz_Ty_TyBool: { _qoz_mv_303 = (true);  break; } default: { _qoz_mv_303 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_303);  break; } case qoz_Ty_TyChar: { qoz_Ty* _qoz_ms_304 = b; bool _qoz_mv_304 = false; switch (_qoz_ms_304->tag) { case qoz_Ty_TyChar: { _qoz_mv_304 = (true);  break; } default: { _qoz_mv_304 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_304);  break; } case qoz_Ty_TyString: { qoz_Ty* _qoz_ms_305 = b; bool _qoz_mv_305 = false; switch (_qoz_ms_305->tag) { case qoz_Ty_TyString: { _qoz_mv_305 = (true);  break; } default: { _qoz_mv_305 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_305);  break; } case qoz_Ty_TyCstring: { qoz_Ty* _qoz_ms_306 = b; bool _qoz_mv_306 = false; switch (_qoz_ms_306->tag) { case qoz_Ty_TyCstring: { _qoz_mv_306 = (true);  break; } default: { _qoz_mv_306 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_306);  break; } case qoz_Ty_TyUnit: { qoz_Ty* _qoz_ms_307 = b; bool _qoz_mv_307 = false; switch (_qoz_ms_307->tag) { case qoz_Ty_TyUnit: { _qoz_mv_307 = (true);  break; } default: { _qoz_mv_307 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_307);  break; } case qoz_Ty_TyNil: { qoz_Ty* _qoz_ms_308 = b; bool _qoz_mv_308 = false; switch (_qoz_ms_308->tag) { case qoz_Ty_TyNil: { _qoz_mv_308 = (true);  break; } default: { _qoz_mv_308 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_308);  break; } case qoz_Ty_TyError: { qoz_Ty* _qoz_ms_309 = b; bool _qoz_mv_309 = false; switch (_qoz_ms_309->tag) { case qoz_Ty_TyError: { _qoz_mv_309 = (true);  break; } default: { _qoz_mv_309 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_309);  break; } case qoz_Ty_TyPtr: { qoz_Ty* ai = _qoz_ms_300->payload.TyPtr.f0; qoz_Ty* _qoz_ms_310 = b; bool _qoz_mv_310 = false; switch (_qoz_ms_310->tag) { case qoz_Ty_TyPtr: { qoz_Ty* bi = _qoz_ms_310->payload.TyPtr.f0; _qoz_mv_310 = (ty_ty_eq(ai, bi));  break; } default: { _qoz_mv_310 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_310);  break; } case qoz_Ty_TyAdt: { qoz_string an = _qoz_ms_300->payload.TyAdt.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_300->payload.TyAdt.f1; qoz_Ty* _qoz_ms_311 = b; bool _qoz_mv_311 = false; switch (_qoz_ms_311->tag) { case qoz_Ty_TyAdt: { qoz_string bn = _qoz_ms_311->payload.TyAdt.f0; qoz_Vec__qoz_Ty ba = _qoz_ms_311->payload.TyAdt.f1; _qoz_mv_311 = (qoz_string_eq(an, bn) && ty_ty_args_eq(aa, ba));  break; } default: { _qoz_mv_311 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_311);  break; } case qoz_Ty_TyRecord: { qoz_string an = _qoz_ms_300->payload.TyRecord.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_300->payload.TyRecord.f1; qoz_Ty* _qoz_ms_312 = b; bool _qoz_mv_312 = false; switch (_qoz_ms_312->tag) { case qoz_Ty_TyRecord: { qoz_string bn = _qoz_ms_312->payload.TyRecord.f0; qoz_Vec__qoz_Ty ba = _qoz_ms_312->payload.TyRecord.f1; _qoz_mv_312 = (qoz_string_eq(an, bn) && ty_ty_args_eq(aa, ba));  break; } default: { _qoz_mv_312 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_312);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty ap = _qoz_ms_300->payload.TyFn.f0; qoz_Ty* ar = _qoz_ms_300->payload.TyFn.f1; qoz_Ty* _qoz_ms_313 = b; bool _qoz_mv_313 = false; switch (_qoz_ms_313->tag) { case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty bp = _qoz_ms_313->payload.TyFn.f0; qoz_Ty* br = _qoz_ms_313->payload.TyFn.f1; _qoz_mv_313 = (ty_ty_args_eq(ap, bp) && ty_ty_eq(ar, br));  break; } default: { _qoz_mv_313 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_313);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty ae = _qoz_ms_300->payload.TyTuple.f0; qoz_Ty* _qoz_ms_314 = b; bool _qoz_mv_314 = false; switch (_qoz_ms_314->tag) { case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty be = _qoz_ms_314->payload.TyTuple.f0; _qoz_mv_314 = (ty_ty_args_eq(ae, be));  break; } default: { _qoz_mv_314 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_314);  break; } case qoz_Ty_TyVar: { qoz_string an = _qoz_ms_300->payload.TyVar.f1; qoz_Ty* _qoz_ms_315 = b; bool _qoz_mv_315 = false; switch (_qoz_ms_315->tag) { case qoz_Ty_TyVar: { qoz_string bn = _qoz_ms_315->payload.TyVar.f1; _qoz_mv_315 = (qoz_string_eq(an, bn));  break; } default: { _qoz_mv_315 = (false);  break; } } _qoz_mv_300 = (_qoz_mv_315);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_300;
}

qoz_TypeExpr* ty_ty_to_type_expr_at(qoz_Ty* t, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_316 = t; qoz_TypeExpr* _qoz_mv_316 = NULL; switch (_qoz_ms_316->tag) { case qoz_Ty_TyInt: { qoz_IntInfo info = _qoz_ms_316->payload.TyInt.f0; _qoz_mv_316 = (qoz_make_TypeExpr_TENamed(sp, ty_ints_to_path(info.width, info.is_signed), qoz_vec_make__qoz_TypeExpr()));  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo info = _qoz_ms_316->payload.TyFloat.f0; qoz_TypeExpr* _qoz_bv_306;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); if (info.width == 32) { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f32")); }  else { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f64")); } _qoz_bv_306 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_316 = (_qoz_bv_306);  break; } case qoz_Ty_TyBool: { _qoz_mv_316 = (ty_single_path_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Ty_TyChar: { _qoz_mv_316 = (ty_single_path_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Ty_TyString: { _qoz_mv_316 = (ty_single_path_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Ty_TyCstring: { _qoz_mv_316 = (ty_single_path_te(sp, QOZ_STR_LIT("cstring")));  break; } case qoz_Ty_TyUnit: { _qoz_mv_316 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Ty_TyNil: { _qoz_mv_316 = (ty_single_path_te(sp, QOZ_STR_LIT("nil")));  break; } case qoz_Ty_TyError: { _qoz_mv_316 = (ty_single_path_te(sp, QOZ_STR_LIT("?")));  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_316->payload.TyPtr.f0; _qoz_mv_316 = (qoz_make_TypeExpr_TEPtr(sp, ty_ty_to_type_expr_at(inner, sp)));  break; } case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_316->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_316->payload.TyAdt.f1; _qoz_mv_316 = (ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_316->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_316->payload.TyRecord.f1; _qoz_mv_316 = (ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty fparams = _qoz_ms_316->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_316->payload.TyFn.f1; qoz_TypeExpr* _qoz_bv_307;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; qoz_vec_push__qoz_TypeExpr(&pte, ty_ty_to_type_expr_at(p, sp)); } }_qoz_bv_307 = qoz_make_TypeExpr_TEFn(sp, pte, ty_ty_to_type_expr_at(ret, sp));
    }
    _qoz_mv_316 = (_qoz_bv_307);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_316->payload.TyTuple.f0; qoz_TypeExpr* _qoz_bv_308;
    {
        qoz_Vec__qoz_TypeExpr ete = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ete, ty_ty_to_type_expr_at(el, sp)); } }_qoz_bv_308 = qoz_make_TypeExpr_TETuple(sp, ete);
    }
    _qoz_mv_316 = (_qoz_bv_308);  break; } case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_316->payload.TyVar.f1; _qoz_mv_316 = (ty_single_path_te(sp, name));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_316;
}
