...
bool qoz_is_error_placeholder(qoz_Decl* d);
...
void qoz_tokenize_lex_die(qoz_Lexer* l, qoz_string msg);
...
void qoz_process_one(qoz_Pending cur, qoz_Vec__qoz_Pending* queue, qoz_Map__qoz_string__bool* visited, qoz_Vec__qoz_Decl* aggregated_decls, qoz_Vec__qoz_string* sources, qoz_string qoz_root) {
    ...
    0;  break; } default: { NULL;  break; } } 0; if (!qoz_is_error_placeholder(d)) { qoz_vec_push__qoz_Decl(aggregated_decls, qoz_rename_with_pkg(d, cur.pkg, local_fns)); } } }
    return;
}
...
bool qoz_is_error_placeholder(qoz_Decl* d) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_1 = d; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Decl_DConst: { qoz_string name = _qoz_ms_1->payload.DConst.f1; _qoz_mv_1 = (qoz_strings_eq_raw(name, QOZ_STR_LIT("<error>")));  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_cmd_build(qoz_string path, qoz_string qoz_root) {
    ...
    {
        qoz_Strbuf _qoz_sb_332_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_332_21); qoz_strings_sb_append(&_qoz_sb_332_21, QOZ_STR_LIT("could not write ")); qoz_strings_sb_append(&_qoz_sb_332_21, out_path); _qoz_bv_11 = qoz_strings_sb_finish(&_qoz_sb_332_21);
    }
...
int main(int argc, char **argv) {
    ...
    {
        qoz_Strbuf _qoz_sb_421_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_421_21); qoz_strings_sb_append(&_qoz_sb_421_21, QOZ_STR_LIT("wrote ")); qoz_strings_sb_append(&_qoz_sb_421_21, out); _qoz_bv_12 = qoz_strings_sb_finish(&_qoz_sb_421_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_465_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_465_21); qoz_strings_sb_append(&_qoz_sb_465_21, QOZ_STR_LIT("wrote ")); qoz_strings_sb_append(&_qoz_sb_465_21, out); _qoz_bv_13 = qoz_strings_sb_finish(&_qoz_sb_465_21);
    }
...
void qoz_tokenize_lex_die(qoz_Lexer* l, qoz_string msg) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&l);
    qoz_string _qoz_bv_14;
    {
        qoz_Strbuf _qoz_sb_41_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_41_17); qoz_strings_sb_append(&_qoz_sb_41_17, QOZ_STR_LIT("tokenize error at line ")); qoz_strings_sb_append_i64(&_qoz_sb_41_17, l->line); qoz_strings_sb_append(&_qoz_sb_41_17, QOZ_STR_LIT(" col ")); qoz_strings_sb_append_i64(&_qoz_sb_41_17, l->col); qoz_strings_sb_append(&_qoz_sb_41_17, QOZ_STR_LIT(": ")); qoz_strings_sb_append(&_qoz_sb_41_17, msg); _qoz_bv_14 = qoz_strings_sb_finish(&_qoz_sb_41_17);
    }
    qoz_fmt_println(_qoz_bv_14); qoz_os_exit(1); 
    return;
}
...
qoz_Token qoz_tokenize_lex_one(qoz_Lexer* l, qoz_Map__qoz_string__bool* kw) {
    ...
    qoz_gc_push_root(&l);
    qoz_gc_push_root(&kw);
    qoz_tokenize_skip_whitespace_and_comments(l); if (l->pos >= (l->src).len) { return ((qoz_Token){ .kind = qoz_make_TokenKind_TokEOF(), .text = QOZ_STR_LIT(""), .line = l->line, .col = l->col });} int64_t start_pos = l->pos; int64_t start_line = l->line; int64_t start_col = l->col; int64_t c = qoz_tokenize_lex_at(l); if (qoz_tokenize_is_digit(c)) { if ((c == 48) && (l->pos + 1 < (l->src).len)) { int64_t n = qoz_strings_byte_at(l->src, l->pos + 1); if ((n == 120) || (n == 88)) { qoz_tokenize_lex_advance(l); qoz_tokenize_lex_advance(l); int64_t body_start = l->pos; while ((l->pos < (l->src).len) && (qoz_tokenize_is_hex_digit(qoz_tokenize_lex_at(l)) || (qoz_tokenize_lex_at(l) == 95))) { qoz_tokenize_lex_advance(l); } if (l->pos == body_start) { qoz_tokenize_lex_die(l, QOZ_STR_LIT("hex literal `0x` has no digits")); } return ((qoz_Token){ .kind = qoz_make_TokenKind_TokInt(), .text = qoz_strings_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} if ((n == 98) || (n == 66)) { qoz_tokenize_lex_advance(l); qoz_tokenize_lex_advance(l); int64_t body_start = l->pos; while ((l->pos < (l->src).len) && (qoz_tokenize_is_bin_digit(qoz_tokenize_lex_at(l)) || (qoz_tokenize_lex_at(l) == 95))) { qoz_tokenize_lex_advance(l); } if (l->pos == body_start) { qoz_tokenize_lex_die(l, QOZ_STR_LIT("binary literal `0b` has no digits")); } return ((qoz_Token){ .kind = qoz_make_TokenKind_TokInt(), .text = qoz_strings_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} if ((n == 111) || (n == 79)) { qoz_tokenize_lex_advance(l); qoz_tokenize_lex_advance(l); int64_t body_start = l->pos; while ((l->pos < (l->src).len) && (qoz_tokenize_is_oct_digit(qoz_tokenize_lex_at(l)) || (qoz_tokenize_lex_at(l) == 95))) { qoz_tokenize_lex_advance(l); } if (l->pos == body_start) { qoz_tokenize_lex_die(l, QOZ_STR_LIT("octal literal `0o` has no digits")); } return ((qoz_Token){ .kind = qoz_make_TokenKind_TokInt(), .text = qoz_strings_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} } bool is_float = false; while ((l->pos < (l->src).len) && (qoz_tokenize_is_digit(qoz_tokenize_lex_at(l)) || (qoz_tokenize_lex_at(l) == 95))) { qoz_tokenize_lex_advance(l); } if (((l->pos + 1 < (l->src).len) && (qoz_tokenize_lex_at(l) == 46)) && qoz_tokenize_is_digit(qoz_strings_byte_at(l->src, l->pos + 1))) { is_float = true; qoz_tokenize_lex_advance(l); while ((l->pos < (l->src).len) && (qoz_tokenize_is_digit(qoz_tokenize_lex_at(l)) || (qoz_tokenize_lex_at(l) == 95))) { qoz_tokenize_lex_advance(l); } } if ((l->pos < (l->src).len) && ((qoz_tokenize_lex_at(l) == 101) || (qoz_tokenize_lex_at(l) == 69))) { is_float = true; qoz_tokenize_lex_advance(l); if ((l->pos < (l->src).len) && ((qoz_tokenize_lex_at(l) == 43) || (qoz_tokenize_lex_at(l) == 45))) { qoz_tokenize_lex_advance(l); } int64_t exp_start = l->pos; while ((l->pos < (l->src).len) && qoz_tokenize_is_digit(qoz_tokenize_lex_at(l))) { qoz_tokenize_lex_advance(l); } if (l->pos == exp_start) { qoz_tokenize_lex_die(l, QOZ_STR_LIT("float exponent has no digits")); } } qoz_TokenKind* kind = ((is_float) ? qoz_make_TokenKind_TokFloat() : qoz_make_TokenKind_TokInt()); qoz_gc_push_root(&kind); return ((qoz_Token){ .kind = kind, .text = qoz_strings_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} if (c == 39) { qoz_tokenize_lex_advance(l); if ((l->pos < (l->src).len) && (qoz_tokenize_lex_at(l) == 92)) { qoz_tokenize_lex_advance(l); } if (l->pos < (l->src).len) { qoz_tokenize_lex_advance(l); } if ((l->pos < (l->src).len) && (qoz_tokenize_lex_at(l) == 39)) { qoz_tokenize_lex_advance(l); } return ((qoz_Token){ .kind = qoz_make_TokenKind_TokChar(), .text = qoz_strings_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} if (qoz_tokenize_is_alpha(c)) { while ((l->pos < (l->src).len) && qoz_tokenize_is_alnum(qoz_tokenize_lex_at(l))) { qoz_tokenize_lex_advance(l); } qoz_string word = qoz_strings_slice(l->src, start_pos, l->pos); qoz_TokenKind* k = qoz_make_TokenKind_TokIdent(); qoz_gc_push_root(&k); if (qoz_tokenize_is_keyword(kw, word)) { k = qoz_make_TokenKind_TokKeyword(); } return ((qoz_Token){ .kind = k, .text = word, .line = start_line, .col = start_col });} if (c == 34) { qoz_tokenize_lex_advance(l); while ((l->pos < (l->src).len) && (qoz_tokenize_lex_at(l) != 34)) { if ((qoz_tokenize_lex_at(l) == 92) && (l->pos + 1 < (l->src).len)) { qoz_tokenize_lex_advance(l); } qoz_tokenize_lex_advance(l); } if (l->pos >= (l->src).len) { qoz_tokenize_lex_die(l, QOZ_STR_LIT("unterminated string literal")); } qoz_tokenize_lex_advance(l); return ((qoz_Token){ .kind = qoz_make_TokenKind_TokString(), .text = qoz_strings_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} if (qoz_tokenize_is_punct(c)) { qoz_tokenize_lex_advance(l); if (l->pos < (l->src).len) { int64_t n = qoz_tokenize_lex_at(l); bool two_char = (((((((((((((((c == 61) && (n == 61)) || ((c == 33) && (n == 61))) || ((c == 60) && (n == 61))) || ((c == 62) && (n == 61))) || ((c == 60) && (n == 60))) || ((c == 45) && (n == 62))) || ((c == 38) && (n == 38))) || ((c == 124) && (n == 124))) || ((c == 46) && (n == 46))) || ((c == 58) && (n == 58))) || ((c == 43) && (n == 61))) || ((c == 45) && (n == 61))) || ((c == 42) && (n == 61))) || ((c == 47) && (n == 61))) || ((c == 37) && (n == 61)); if (two_char) { qoz_tokenize_lex_advance(l); int64_t m = qoz_tokenize_lex_at(l); if (((c == 46) && (n == 46)) && ((m == 60) || (m == 61))) { qoz_tokenize_lex_advance(l); } } } return ((qoz_Token){ .kind = qoz_make_TokenKind_TokPunct(), .text = qoz_strings_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} qoz_tokenize_lex_advance(l); return ((qoz_Token){ .kind = qoz_make_TokenKind_TokPunct(), .text = qoz_strings_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });
}

bool qoz_tokenize_is_stmt_ender(qoz_Token t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_TokenKind* _qoz_ms_1 = t.kind; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_TokenKind_TokIdent: { _qoz_mv_1 = (true);  break; } case qoz_TokenKind_TokInt: { _qoz_mv_1 = (true);  break; } case qoz_TokenKind_TokFloat: { _qoz_mv_1 = (true);  break; } case qoz_TokenKind_TokString: { _qoz_mv_1 = (true);  break; } case qoz_TokenKind_TokChar: { _qoz_mv_1 = (true);  break; } case qoz_TokenKind_TokKeyword: { bool _qoz_bv_15;
    {
        if (qoz_strings_eq_raw(t.text, QOZ_STR_LIT("true"))) { return true;} if (qoz_strings_eq_raw(t.text, QOZ_STR_LIT("false"))) { return true;} if (qoz_strings_eq_raw(t.text, QOZ_STR_LIT("nil"))) { return true;} if (qoz_strings_eq_raw(t.text, QOZ_STR_LIT("return"))) { return true;} _qoz_bv_15 = false;
    }
    _qoz_mv_1 = (_qoz_bv_15);  break; } case qoz_TokenKind_TokPunct: { bool _qoz_bv_16;
    {
        if (qoz_strings_eq_raw(t.text, QOZ_STR_LIT(")"))) { return true;} if (qoz_strings_eq_raw(t.text, QOZ_STR_LIT("]"))) { return true;} if (qoz_strings_eq_raw(t.text, QOZ_STR_LIT("}"))) { return true;} _qoz_bv_16 = false;
    }
    _qoz_mv_1 = (_qoz_bv_16);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}

bool qoz_tokenize_is_line_continuation(qoz_Token t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_TokenKind* _qoz_ms_1 = t.kind; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_TokenKind_TokKeyword: { bool _qoz_bv_17;
    {
        if (qoz_strings_eq_raw(t.text, QOZ_STR_LIT("else"))) { return true;} if (qoz_strings_eq_raw(t.text, QOZ_STR_LIT("as"))) { return true;} if (qoz_strings_eq_raw(t.text, QOZ_STR_LIT("in"))) { return true;} _qoz_bv_17 = false;
    }
    _qoz_mv_1 = (_qoz_bv_17);  break; } case qoz_TokenKind_TokPunct: { bool _qoz_bv_18;
    {
        qoz_string s = t.text; if (qoz_strings_eq_raw(s, QOZ_STR_LIT("|"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("||"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("&"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("&&"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("+"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("-"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("*"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("/"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("%"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("^"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("<"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT(">"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("<="))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT(">="))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("<<"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("=="))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("!="))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("="))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("+="))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("-="))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("*="))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("/="))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("%="))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("->"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("."))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT(","))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT(":"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("?"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT(")"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("]"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("}"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT(".."))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("..<"))) { return true;} if (qoz_strings_eq_raw(s, QOZ_STR_LIT("..="))) { return true;} _qoz_bv_18 = false;
    }
    _qoz_mv_1 = (_qoz_bv_18);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_parse_expect_punct(qoz_Parser* p, qoz_string sym) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&p);
    qoz_Token t = qoz_parse_peek(p); if (qoz_parse_is_punct(t, sym)) { qoz_parse_advance(p); }  else { qoz_string _qoz_bv_20;
    {
        qoz_Strbuf _qoz_sb_107_27 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_107_27); qoz_strings_sb_append(&_qoz_sb_107_27, QOZ_STR_LIT("`")); qoz_strings_sb_append(&_qoz_sb_107_27, sym); qoz_strings_sb_append(&_qoz_sb_107_27, QOZ_STR_LIT("`")); _qoz_bv_20 = qoz_strings_sb_finish(&_qoz_sb_107_27);
    }
    qoz_parse_err_unexpected(p, _qoz_bv_20, t); if (!qoz_parse_at_eof(p)) { qoz_parse_advance(p); } } 
    return;
}
...
qoz_string qoz_parse_c_escape_bytes(qoz_string src) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_string out = QOZ_STR_LIT("\""); int64_t i = 0; int64_t n = (src).len; while (i < n) { int64_t b = qoz_strings_byte_at(src, i); if (b == 92) { out = qoz_strings_cat(out, QOZ_STR_LIT("\\\\")); }  else if (b == 34) { out = qoz_strings_cat(out, QOZ_STR_LIT("\\\"")); }  else if (b == 10) { out = qoz_strings_cat(out, QOZ_STR_LIT("\\n")); }  else if (b == 13) { out = qoz_strings_cat(out, QOZ_STR_LIT("\\r")); }  else if (b == 9) { out = qoz_strings_cat(out, QOZ_STR_LIT("\\t")); }  else if ((b < 32) || (b == 127)) { qoz_string _qoz_bv_21;
    {
        qoz_Strbuf _qoz_sb_668_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_668_36); qoz_strings_sb_append(&_qoz_sb_668_36, QOZ_STR_LIT("\\x")); qoz_strings_sb_append(&_qoz_sb_668_36, qoz_parse_hex2(b)); _qoz_bv_21 = qoz_strings_sb_finish(&_qoz_sb_668_36);
    }
    out = qoz_strings_cat(out, _qoz_bv_21); }  else { out = qoz_strings_cat(out, qoz_strings_slice(src, i, i + 1)); } i = i + 1; } out = qoz_strings_cat(out, QOZ_STR_LIT("\"")); qoz_gc_shadow_set_top(_qoz_shadow_guard); return out;
}

qoz_string qoz_parse_hex_digit(int64_t n) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    if (n < 10) { qoz_string _qoz_bv_22;
    {
        qoz_Strbuf _qoz_sb_679_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_679_24); qoz_strings_sb_append_i64(&_qoz_sb_679_24, n); _qoz_bv_22 = qoz_strings_sb_finish(&_qoz_sb_679_24);
    }
    return _qoz_bv_22;} qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_strings_slice(QOZ_STR_LIT("abcdef"), n - 10, n - 9);
}
...
qoz_string qoz_parse_interp_var_name(qoz_Span span) {
    ...
    {
        qoz_Strbuf _qoz_sb_828_41 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_828_41); qoz_strings_sb_append_i64(&_qoz_sb_828_41, span.line); _qoz_bv_23 = qoz_strings_sb_finish(&_qoz_sb_828_41);
    }
    qoz_string _qoz_bv_24;
    {
        qoz_Strbuf _qoz_sb_828_73 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_828_73); qoz_strings_sb_append_i64(&_qoz_sb_828_73, span.col); _qoz_bv_24 = qoz_strings_sb_finish(&_qoz_sb_828_73);
    }
    qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_strings_cat(QOZ_STR_LIT("_qoz_sb_"), qoz_strings_cat(_qoz_bv_23, qoz_strings_cat(QOZ_STR_LIT("_"), _qoz_bv_24)));
}
...
qoz_string qoz_check_src_cache_get(qoz_SrcCache* c, qoz_string path) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&c);
    qoz_Option__qoz_string* _qoz_ms_1 = qoz_map_get__qoz_string__qoz_string(&c->files, path); qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_Option__qoz_string_Some: { qoz_string text = _qoz_ms_1->payload.Some.f0; _qoz_mv_1 = (text);  break; } case qoz_Option__qoz_string_None: { qoz_string _qoz_bv_31;
    {
        qoz_string text = qoz_fs_read_file(path); qoz_map_set__qoz_string__qoz_string(&c->files, path, text); _qoz_bv_31 = text;
    }
    _qoz_mv_1 = (_qoz_bv_31);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_check_report(qoz_TyContext* tc) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_SrcCache cache = qoz_check_src_cache_make(); qoz_Map__qoz_string__bool seen = qoz_map_make__qoz_string__bool(); { qoz_Vec__qoz_TypeError __col = tc->errors; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeError e = __col.data[__i]; (void)e; qoz_string key = qoz_strings_cat(qoz_strings_cat(qoz_strings_cat(e.span.file, QOZ_STR_LIT(":")), qoz_strings_cat(qoz_check_i64_to_string_local(e.span.line), QOZ_STR_LIT(":"))), qoz_strings_cat(qoz_strings_cat(qoz_check_i64_to_string_local(e.span.col), QOZ_STR_LIT(":")), e.message)); if (qoz_map_contains__qoz_string__bool(&seen, key)) { }  else { qoz_map_set__qoz_string__bool(&seen, key, true); qoz_string _qoz_bv_32;
    {
        qoz_Strbuf _qoz_sb_153_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_153_25); qoz_strings_sb_append(&_qoz_sb_153_25, e.span.file); qoz_strings_sb_append(&_qoz_sb_153_25, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_153_25, e.span.line); qoz_strings_sb_append(&_qoz_sb_153_25, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_153_25, e.span.col); qoz_strings_sb_append(&_qoz_sb_153_25, QOZ_STR_LIT(": ")); qoz_strings_sb_append(&_qoz_sb_153_25, e.message); _qoz_bv_32 = qoz_strings_sb_finish(&_qoz_sb_153_25);
    }
    qoz_fmt_println(_qoz_bv_32); qoz_string src = qoz_check_src_cache_get(&cache, e.span.file); if ((src).len > 0) { qoz_string line = qoz_check_nth_line(src, e.span.line); if ((line).len > 0) { qoz_string _qoz_bv_33;
    {
        qoz_Strbuf _qoz_sb_158_33 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_158_33); qoz_strings_sb_append(&_qoz_sb_158_33, QOZ_STR_LIT("    ")); qoz_strings_sb_append(&_qoz_sb_158_33, line); _qoz_bv_33 = qoz_strings_sb_finish(&_qoz_sb_158_33);
    }
    qoz_fmt_println(_qoz_bv_33); qoz_string _qoz_bv_34;
    {
        qoz_Strbuf _qoz_sb_159_33 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_159_33); qoz_strings_sb_append(&_qoz_sb_159_33, QOZ_STR_LIT("    ")); qoz_strings_sb_append(&_qoz_sb_159_33, qoz_check_caret_pad(e.span.col)); _qoz_bv_34 = qoz_strings_sb_finish(&_qoz_sb_159_33);
    }
    qoz_fmt_println(_qoz_bv_34); } } } } }
    return;
}
...
void qoz_check_summary(qoz_TyContext* tc) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_string _qoz_bv_35;
    {
        qoz_Strbuf _qoz_sb_183_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_183_17); qoz_strings_sb_append(&_qoz_sb_183_17, QOZ_STR_LIT("enums:    ")); qoz_strings_sb_append_i64(&_qoz_sb_183_17, (tc->enums.len)); _qoz_bv_35 = qoz_strings_sb_finish(&_qoz_sb_183_17);
    }
    qoz_fmt_println(_qoz_bv_35); qoz_string _qoz_bv_36;
    {
        qoz_Strbuf _qoz_sb_184_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_184_17); qoz_strings_sb_append(&_qoz_sb_184_17, QOZ_STR_LIT("structs:  ")); qoz_strings_sb_append_i64(&_qoz_sb_184_17, (tc->structs.len)); _qoz_bv_36 = qoz_strings_sb_finish(&_qoz_sb_184_17);
    }
    qoz_fmt_println(_qoz_bv_36); qoz_string _qoz_bv_37;
    {
        qoz_Strbuf _qoz_sb_185_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_185_17); qoz_strings_sb_append(&_qoz_sb_185_17, QOZ_STR_LIT("aliases:  ")); qoz_strings_sb_append_i64(&_qoz_sb_185_17, (tc->aliases.len)); _qoz_bv_37 = qoz_strings_sb_finish(&_qoz_sb_185_17);
    }
    qoz_fmt_println(_qoz_bv_37); qoz_string _qoz_bv_38;
    {
        qoz_Strbuf _qoz_sb_186_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_186_17); qoz_strings_sb_append(&_qoz_sb_186_17, QOZ_STR_LIT("fns:      ")); qoz_strings_sb_append_i64(&_qoz_sb_186_17, (tc->fns.len)); _qoz_bv_38 = qoz_strings_sb_finish(&_qoz_sb_186_17);
    }
    qoz_fmt_println(_qoz_bv_38); qoz_string _qoz_bv_39;
    {
        qoz_Strbuf _qoz_sb_187_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_187_17); qoz_strings_sb_append(&_qoz_sb_187_17, QOZ_STR_LIT("externs:  ")); qoz_strings_sb_append_i64(&_qoz_sb_187_17, (tc->externs.len)); _qoz_bv_39 = qoz_strings_sb_finish(&_qoz_sb_187_17);
    }
    qoz_fmt_println(_qoz_bv_39); qoz_string _qoz_bv_40;
    {
        qoz_Strbuf _qoz_sb_188_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_188_17); qoz_strings_sb_append(&_qoz_sb_188_17, QOZ_STR_LIT("packages: ")); qoz_strings_sb_append_i64(&_qoz_sb_188_17, (tc->packages.len)); _qoz_bv_40 = qoz_strings_sb_finish(&_qoz_sb_188_17);
    }
    qoz_fmt_println(_qoz_bv_40); qoz_string _qoz_bv_41;
    {
        qoz_Strbuf _qoz_sb_189_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_189_17); qoz_strings_sb_append(&_qoz_sb_189_17, QOZ_STR_LIT("errors:   ")); qoz_strings_sb_append_i64(&_qoz_sb_189_17, (tc->errors.len)); _qoz_bv_41 = qoz_strings_sb_finish(&_qoz_sb_189_17);
    }
    qoz_fmt_println(_qoz_bv_41); 
    return;
}
...
qoz_Ty* qoz_check_synth_inner(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* e) {
    ...
    _qoz_mv_2 = (_qoz_bv_47);  break; } default: { qoz_Ty* _qoz_bv_49;
    {
        qoz_string _qoz_bv_50;
    {
        qoz_Strbuf _qoz_sb_351_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_351_34); qoz_strings_sb_append(&_qoz_sb_351_34, QOZ_STR_LIT("the `?` operator requires a Result<T, E>, got ")); qoz_strings_sb_append(&_qoz_sb_351_34, qoz_ty_ty_show(t)); _qoz_bv_50 = qoz_strings_sb_finish(&_qoz_sb_351_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_50); _qoz_bv_49 = qoz_ty_ty_error_();
    }
    _qoz_mv_2 = (_qoz_bv_49);  break; } } _qoz_bv_46 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_46);  break; } case qoz_Expr_ETuple: { qoz_Vec__qoz_Expr elems = _qoz_ms_1->payload.ETuple.f1; qoz_Ty* _qoz_bv_51;
    {
        qoz_Vec__qoz_Ty elem_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Ty(&elem_tys, qoz_check_synth(tc, env, el)); } }_qoz_bv_51 = qoz_ty_ty_tuple_(elem_tys);
    }
    _qoz_mv_1 = (_qoz_bv_51);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_1->payload.ERecord.f0; qoz_TypeExpr* te = _qoz_ms_1->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_1->payload.ERecord.f2; _qoz_mv_1 = (qoz_check_synth_record(tc, env, sp, te, fields));  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_1->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_1->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_1->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_1->payload.EClosure.f3; qoz_Ty* _qoz_bv_52;
    {
        qoz_Vec__qoz_Ty pty = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_Ty* t = qoz_check_resolve_type(tc, cp.ty); qoz_gc_push_root(&t); qoz_vec_push__qoz_Ty(&pty, t); qoz_check_env_define(env, cp.name, t); } }qoz_Ty* ret_ty = qoz_check_resolve_type(tc, ret); qoz_gc_push_root(&ret_ty); qoz_Ty* saved_ret = tc->current_ret_ty; qoz_gc_push_root(&saved_ret); tc->current_ret_ty = ret_ty; qoz_Ty* body_ty = qoz_check_synth(tc, env, body); qoz_gc_push_root(&body_ty); tc->current_ret_ty = saved_ret; if ((!qoz_ty_ty_is_unit(ret_ty) && !qoz_ty_ty_is_error(ret_ty)) && !qoz_ty_ty_is_error(body_ty)) { if (!qoz_ty_ty_is_nil(body_ty) && !qoz_ty_ty_assignable(ret_ty, body_ty)) { qoz_string _qoz_bv_53;
    {
        qoz_Strbuf _qoz_sb_380_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_380_38); qoz_strings_sb_append(&_qoz_sb_380_38, QOZ_STR_LIT("closure body produces ")); qoz_strings_sb_append(&_qoz_sb_380_38, qoz_ty_ty_show(body_ty)); qoz_strings_sb_append(&_qoz_sb_380_38, QOZ_STR_LIT(" but declared return type is ")); qoz_strings_sb_append(&_qoz_sb_380_38, qoz_ty_ty_show(ret_ty)); _qoz_bv_53 = qoz_strings_sb_finish(&_qoz_sb_380_38);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_53); } } _qoz_bv_52 = qoz_ty_ty_fn_(pty, ret_ty);
    }
    _qoz_mv_1 = (_qoz_bv_52);  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_1->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_1->payload.EBlock.f2; _qoz_mv_1 = (qoz_check_synth_block(tc, env, stmts, tail));  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_1->payload.EIf.f0; qoz_Expr* c = _qoz_ms_1->payload.EIf.f1; qoz_Expr* t = _qoz_ms_1->payload.EIf.f2; qoz_Expr* f = _qoz_ms_1->payload.EIf.f3; _qoz_mv_1 = (qoz_check_synth_if(tc, env, sp, c, t, f));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_1->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_1->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_1->payload.EMatch.f2; _qoz_mv_1 = (qoz_check_synth_match(tc, env, sp, scrut, arms));  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_1->payload.EWhile.f0; qoz_Expr* c = _qoz_ms_1->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_1->payload.EWhile.f2; qoz_Ty* _qoz_bv_54;
    {
        qoz_Ty* ct = qoz_check_synth(tc, env, c); qoz_gc_push_root(&ct); if (!qoz_ty_ty_is_error(ct) && !qoz_ty_ty_is_bool(ct)) { qoz_string _qoz_bv_55;
    {
        qoz_Strbuf _qoz_sb_391_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_391_34); qoz_strings_sb_append(&_qoz_sb_391_34, QOZ_STR_LIT("while condition must be bool, got ")); qoz_strings_sb_append(&_qoz_sb_391_34, qoz_ty_ty_show(ct)); _qoz_bv_55 = qoz_strings_sb_finish(&_qoz_sb_391_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_55); } (void)(qoz_check_synth(tc, env, b)); _qoz_bv_54 = qoz_ty_ty_unit_();
    }
    _qoz_mv_1 = (_qoz_bv_54);  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_1->payload.EFor.f0; qoz_string b1 = _qoz_ms_1->payload.EFor.f1; qoz_string b2 = _qoz_ms_1->payload.EFor.f2; qoz_Expr* it = _qoz_ms_1->payload.EFor.f3; qoz_Expr* b = _qoz_ms_1->payload.EFor.f4; qoz_Ty* _qoz_bv_56;
    {
        qoz_Ty* it_ty = qoz_check_synth(tc, env, it); qoz_gc_push_root(&it_ty); if (!qoz_ty_ty_is_error(it_ty) && !qoz_check_iterable_ty(it_ty, !qoz_strings_eq_raw(b2, QOZ_STR_LIT("")))) { qoz_string kind = ((qoz_strings_eq_raw(b2, QOZ_STR_LIT(""))) ? QOZ_STR_LIT("iterable") : QOZ_STR_LIT("Map-like iterable producing key, value pairs")); qoz_string _qoz_bv_57;
    {
        qoz_Strbuf _qoz_sb_400_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_400_34); qoz_strings_sb_append(&_qoz_sb_400_34, QOZ_STR_LIT("for loop expects ")); qoz_strings_sb_append(&_qoz_sb_400_34, kind); qoz_strings_sb_append(&_qoz_sb_400_34, QOZ_STR_LIT(", got ")); qoz_strings_sb_append(&_qoz_sb_400_34, qoz_ty_ty_show(it_ty)); _qoz_bv_57 = qoz_strings_sb_finish(&_qoz_sb_400_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_57); } int64_t saved_len = (env->bindings.len); qoz_check_bind_for_loop(env, b1, b2, it_ty); (void)(qoz_check_synth(tc, env, b)); qoz_check_env_truncate(env, saved_len); _qoz_bv_56 = qoz_ty_ty_unit_();
    }
    _qoz_mv_1 = (_qoz_bv_56);  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_1->payload.EReturn.f0; qoz_Expr* v = _qoz_ms_1->payload.EReturn.f1; qoz_Ty* _qoz_bv_58;
    {
        qoz_Ty* vt = qoz_check_synth(tc, env, v); qoz_gc_push_root(&vt); qoz_Ty* rt = tc->current_ret_ty; qoz_gc_push_root(&rt); bool skip = (qoz_ty_ty_is_error(vt) || qoz_ty_ty_is_error(rt)) || qoz_ty_ty_is_unit(rt); if (!skip && !qoz_ty_ty_assignable(rt, vt)) { qoz_string _qoz_bv_59;
    {
        qoz_Strbuf _qoz_sb_421_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_421_34); qoz_strings_sb_append(&_qoz_sb_421_34, QOZ_STR_LIT("return value of type ")); qoz_strings_sb_append(&_qoz_sb_421_34, qoz_ty_ty_show(vt)); qoz_strings_sb_append(&_qoz_sb_421_34, QOZ_STR_LIT(" does not match function's declared return type ")); qoz_strings_sb_append(&_qoz_sb_421_34, qoz_ty_ty_show(rt)); _qoz_bv_59 = qoz_strings_sb_finish(&_qoz_sb_421_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_59); } _qoz_bv_58 = qoz_ty_ty_unit_();
    }
    _qoz_mv_1 = (_qoz_bv_58);  break; } case qoz_Expr_EDefer: { qoz_Expr* b = _qoz_ms_1->payload.EDefer.f1; qoz_Ty* _qoz_bv_60;
    {
        (void)(qoz_check_synth(tc, env, b)); _qoz_bv_60 = qoz_ty_ty_unit_();
    }
    _qoz_mv_1 = (_qoz_bv_60);  break; } case qoz_Expr_ESizeOf: { _qoz_mv_1 = (qoz_ty_ty_int_(64, true));  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_1->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_1->payload.EArrayLit.f1; qoz_Ty* _qoz_bv_61;
    {
        if ((elems.len) == 0) { return qoz_ty_ty_error_();} qoz_Ty* elem_ty = qoz_check_synth(tc, env, elems.data[0]); qoz_gc_push_root(&elem_ty); int64_t i = 1; while (i < (elems.len)) { qoz_Ty* et = qoz_check_synth(tc, env, elems.data[i]); qoz_gc_push_root(&et); if (!qoz_ty_ty_is_error(elem_ty) && !qoz_ty_ty_is_error(et)) { if (!qoz_ty_ty_assignable(elem_ty, et) && !qoz_ty_ty_assignable(et, elem_ty)) { qoz_string _qoz_bv_62;
    {
        qoz_Strbuf _qoz_sb_445_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_445_42); qoz_strings_sb_append(&_qoz_sb_445_42, QOZ_STR_LIT("array literal element ")); qoz_strings_sb_append_i64(&_qoz_sb_445_42, i); qoz_strings_sb_append(&_qoz_sb_445_42, QOZ_STR_LIT(" has type ")); qoz_strings_sb_append(&_qoz_sb_445_42, qoz_ty_ty_show(et)); qoz_strings_sb_append(&_qoz_sb_445_42, QOZ_STR_LIT("; earlier elements have type ")); qoz_strings_sb_append(&_qoz_sb_445_42, qoz_ty_ty_show(elem_ty)); _qoz_bv_62 = qoz_strings_sb_finish(&_qoz_sb_445_42);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_62); } } i = i + 1; } qoz_Vec__qoz_Ty args = qoz_vec_make__qoz_Ty(); qoz_vec_push__qoz_Ty(&args, elem_ty); _qoz_bv_61 = qoz_ty_ty_record_(QOZ_STR_LIT("Vec"), args);
    }
    _qoz_mv_1 = (_qoz_bv_61);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_check_assign(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    if (!qoz_check_is_lvalue_shape(lhs)) { qoz_check_record_error(tc, sp, QOZ_STR_LIT("left-hand side of `=` is not assignable")); } qoz_Expr* _qoz_ms_1 = lhs; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_1->payload.EIdent.f1; if (qoz_check_env_has(env, name) && !qoz_check_env_is_var(env, name)) { qoz_string _qoz_bv_63;
    {
        qoz_Strbuf _qoz_sb_487_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_487_34); qoz_strings_sb_append(&_qoz_sb_487_34, QOZ_STR_LIT("cannot assign to `let`-bound `")); qoz_strings_sb_append(&_qoz_sb_487_34, name); qoz_strings_sb_append(&_qoz_sb_487_34, QOZ_STR_LIT("`; use `var` to declare a mutable binding")); _qoz_bv_63 = qoz_strings_sb_finish(&_qoz_sb_487_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_63); } 0;  break; } default: { NULL;  break; } } 0; qoz_Ty* lt = qoz_check_synth(tc, env, lhs); qoz_gc_push_root(&lt); qoz_Ty* rt = qoz_check_synth(tc, env, rhs); qoz_gc_push_root(&rt); qoz_Ty* _qoz_ms_2 = lt; switch (_qoz_ms_2->tag) { case qoz_Ty_TyError: { return qoz_ty_ty_unit_(); break; } default: { NULL;  break; } } 0; qoz_Ty* _qoz_ms_3 = rt; switch (_qoz_ms_3->tag) { case qoz_Ty_TyError: { return qoz_ty_ty_unit_(); break; } default: { NULL;  break; } } 0; if (!qoz_ty_ty_assignable(lt, rt)) { qoz_string want = qoz_ty_ty_show(lt); qoz_string got = qoz_ty_ty_show(rt); qoz_string _qoz_bv_64;
    {
        qoz_Strbuf _qoz_sb_499_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_499_30); qoz_strings_sb_append(&_qoz_sb_499_30, QOZ_STR_LIT("cannot assign value of type ")); qoz_strings_sb_append(&_qoz_sb_499_30, got); qoz_strings_sb_append(&_qoz_sb_499_30, QOZ_STR_LIT(" to lhs of type ")); qoz_strings_sb_append(&_qoz_sb_499_30, want); _qoz_bv_64 = qoz_strings_sb_finish(&_qoz_sb_499_30);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_64); } qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_ty_ty_unit_();
}
...
qoz_Ty* qoz_check_synth_unary(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_UnaryOp* op, qoz_Expr* rhs) {
    ...
    qoz_gc_push_root(&op);
    qoz_gc_push_root(&rhs);
    qoz_Ty* t = qoz_check_synth(tc, env, rhs); qoz_gc_push_root(&t); if (qoz_ty_ty_is_error(t)) { return qoz_ty_ty_error_();} qoz_UnaryOp* _qoz_ms_1 = op; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_UnaryOp_UOpNeg: { qoz_Ty* _qoz_bv_65;
    {
        if (!qoz_ty_ty_is_numeric(t)) { qoz_string _qoz_bv_66;
    {
        qoz_Strbuf _qoz_sb_500_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_500_34); qoz_strings_sb_append(&_qoz_sb_500_34, QOZ_STR_LIT("unary `-` requires a numeric operand, got ")); qoz_strings_sb_append(&_qoz_sb_500_34, qoz_ty_ty_show(t)); _qoz_bv_66 = qoz_strings_sb_finish(&_qoz_sb_500_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_66); return qoz_ty_ty_error_();} _qoz_bv_65 = t;
    }
    _qoz_mv_1 = (_qoz_bv_65);  break; } case qoz_UnaryOp_UOpNot: { qoz_Ty* _qoz_bv_67;
    {
        if (!qoz_ty_ty_is_bool(t)) { qoz_string _qoz_bv_68;
    {
        qoz_Strbuf _qoz_sb_511_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_511_34); qoz_strings_sb_append(&_qoz_sb_511_34, QOZ_STR_LIT("unary `!` requires a bool operand, got ")); qoz_strings_sb_append(&_qoz_sb_511_34, qoz_ty_ty_show(t)); _qoz_bv_68 = qoz_strings_sb_finish(&_qoz_sb_511_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_68); return qoz_ty_ty_error_();} _qoz_bv_67 = qoz_ty_ty_bool_();
    }
    _qoz_mv_1 = (_qoz_bv_67);  break; } case qoz_UnaryOp_UOpDeref: { qoz_Ty* _qoz_ms_2 = t; qoz_Ty* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_2->payload.TyPtr.f0; _qoz_mv_2 = (inner);  break; } default: { qoz_Ty* _qoz_bv_69;
    {
        qoz_string _qoz_bv_70;
    {
        qoz_Strbuf _qoz_sb_520_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_520_34); qoz_strings_sb_append(&_qoz_sb_520_34, QOZ_STR_LIT("cannot dereference value of type ")); qoz_strings_sb_append(&_qoz_sb_520_34, qoz_ty_ty_show(t)); _qoz_bv_70 = qoz_strings_sb_finish(&_qoz_sb_520_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_70); _qoz_bv_69 = qoz_ty_ty_error_();
    }
    _qoz_mv_2 = (_qoz_bv_69);  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_1 = (qoz_ty_ty_ptr_(t));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_synth_field(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* base, qoz_string name) {
    ...
    if (qoz_check_is_qualified_variant_field(tc, base, name)) { return qoz_check_synth_variant_ctor(tc, name);} qoz_Ty* bt = qoz_check_synth(tc, env, base); qoz_gc_push_root(&bt); if (qoz_ty_ty_is_error(bt)) { return qoz_ty_ty_error_();} qoz_Expr* _qoz_ms_1 = base; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_string base_name = _qoz_ms_1->payload.EIdent.f1; if (qoz_map_contains__qoz_string__bool(&tc->packages, base_name)) { return qoz_ty_ty_error_();} 0;  break; } default: { NULL;  break; } } 0; qoz_Ty* ft = qoz_check_field_type_of(tc, bt, name); qoz_gc_push_root(&ft); if (qoz_ty_ty_is_error(ft)) { qoz_string _qoz_bv_71;
    {
        qoz_Strbuf _qoz_sb_547_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_547_30); qoz_strings_sb_append(&_qoz_sb_547_30, QOZ_STR_LIT("type ")); qoz_strings_sb_append(&_qoz_sb_547_30, qoz_ty_ty_show(bt)); qoz_strings_sb_append(&_qoz_sb_547_30, QOZ_STR_LIT(" has no field `")); qoz_strings_sb_append(&_qoz_sb_547_30, name); qoz_strings_sb_append(&_qoz_sb_547_30, QOZ_STR_LIT("`")); _qoz_bv_71 = qoz_strings_sb_finish(&_qoz_sb_547_30);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_71); } qoz_gc_shadow_set_top(_qoz_shadow_guard); return ft;
}
...
bool qoz_check_is_qualified_variant_field(qoz_TyContext* tc, qoz_Expr* base, qoz_string name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_1 = base; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_string base_name = _qoz_ms_1->payload.EIdent.f1; bool _qoz_bv_72;
    {
        if (!qoz_map_contains__qoz_string__qoz_Decl(&tc->enums, base_name)) { return false;} qoz_Option__qoz_string* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_string(&tc->variant_of, name); bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_string_Some: { qoz_string declared_enum = _qoz_ms_2->payload.Some.f0; _qoz_mv_2 = (qoz_strings_eq_raw(declared_enum, base_name));  break; } case qoz_Option__qoz_string_None: { _qoz_mv_2 = (false);  break; } } _qoz_bv_72 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_72);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_apply_subst(qoz_Ty* t, qoz_Vec__qoz_string params, qoz_Vec__qoz_Ty args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_1 = t; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_1->payload.TyVar.f1; qoz_Ty* _qoz_bv_75;
    {
        int64_t i = 0; { qoz_Vec__qoz_string __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string p = __col.data[__i]; (void)p; if (qoz_strings_eq_raw(p, name)) { if (i < (args.len)) { return args.data[i];} return t;} i = i + 1; } }_qoz_bv_75 = t;
    }
    _qoz_mv_1 = (_qoz_bv_75);  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_1->payload.TyPtr.f0; _qoz_mv_1 = (qoz_ty_ty_ptr_(qoz_check_apply_subst(inner, params, args)));  break; } case qoz_Ty_TyAdt: { qoz_string n = _qoz_ms_1->payload.TyAdt.f0; qoz_Vec__qoz_Ty a = _qoz_ms_1->payload.TyAdt.f1; qoz_Ty* _qoz_bv_76;
    {
        qoz_Vec__qoz_Ty na = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = a; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&na, qoz_check_apply_subst(x, params, args)); } }_qoz_bv_76 = qoz_ty_ty_adt_(n, na);
    }
    _qoz_mv_1 = (_qoz_bv_76);  break; } case qoz_Ty_TyRecord: { qoz_string n = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty a = _qoz_ms_1->payload.TyRecord.f1; qoz_Ty* _qoz_bv_77;
    {
        qoz_Vec__qoz_Ty na = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = a; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&na, qoz_check_apply_subst(x, params, args)); } }_qoz_bv_77 = qoz_ty_ty_record_(n, na);
    }
    _qoz_mv_1 = (_qoz_bv_77);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty p = _qoz_ms_1->payload.TyFn.f0; qoz_Ty* r = _qoz_ms_1->payload.TyFn.f1; qoz_Ty* _qoz_bv_78;
    {
        qoz_Vec__qoz_Ty np = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = p; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&np, qoz_check_apply_subst(x, params, args)); } }_qoz_bv_78 = qoz_ty_ty_fn_(np, qoz_check_apply_subst(r, params, args));
    }
    _qoz_mv_1 = (_qoz_bv_78);  break; } default: { _qoz_mv_1 = (t);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_synth_index(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* base, qoz_Expr* idx) {
    ...
    qoz_Ty* bt = qoz_check_synth(tc, env, base); qoz_gc_push_root(&bt); qoz_Ty* it = qoz_check_synth(tc, env, idx); qoz_gc_push_root(&it); if (qoz_ty_ty_is_error(bt) || qoz_ty_ty_is_error(it)) { return qoz_ty_ty_error_();} qoz_Ty* _qoz_ms_1 = bt; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_1->payload.TyPtr.f0; qoz_Ty* _qoz_bv_79;
    {
        if (!qoz_ty_ty_is_int(it)) { qoz_string _qoz_bv_80;
    {
        qoz_Strbuf _qoz_sb_669_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_669_34); qoz_strings_sb_append(&_qoz_sb_669_34, QOZ_STR_LIT("pointer index must be an integer, got ")); qoz_strings_sb_append(&_qoz_sb_669_34, qoz_ty_ty_show(it)); _qoz_bv_80 = qoz_strings_sb_finish(&_qoz_sb_669_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_80); } _qoz_bv_79 = inner;
    }
    _qoz_mv_1 = (_qoz_bv_79);  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyRecord.f1; qoz_Ty* _qoz_bv_81;
    {
        if (qoz_strings_eq_raw(name, QOZ_STR_LIT("Vec")) && ((args.len) >= 1)) { if (!qoz_ty_ty_is_int(it)) { qoz_string _qoz_bv_82;
    {
        qoz_Strbuf _qoz_sb_666_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_666_38); qoz_strings_sb_append(&_qoz_sb_666_38, QOZ_STR_LIT("Vec index must be an integer, got ")); qoz_strings_sb_append(&_qoz_sb_666_38, qoz_ty_ty_show(it)); _qoz_bv_82 = qoz_strings_sb_finish(&_qoz_sb_666_38);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_82); } return args.data[0];} if (qoz_strings_eq_raw(name, QOZ_STR_LIT("Map")) && ((args.len) >= 2)) { if (!qoz_ty_ty_assignable(args.data[0], it)) { qoz_string _qoz_bv_83;
    {
        qoz_Strbuf _qoz_sb_672_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_672_38); qoz_strings_sb_append(&_qoz_sb_672_38, QOZ_STR_LIT("Map key has type ")); qoz_strings_sb_append(&_qoz_sb_672_38, qoz_ty_ty_show(args.data[0])); qoz_strings_sb_append(&_qoz_sb_672_38, QOZ_STR_LIT("; cannot use index of type ")); qoz_strings_sb_append(&_qoz_sb_672_38, qoz_ty_ty_show(it)); _qoz_bv_83 = qoz_strings_sb_finish(&_qoz_sb_672_38);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_83); } return args.data[1];} qoz_string _qoz_bv_84;
    {
    ...
    qoz_check_record_error(tc, sp, _qoz_bv_84); _qoz_bv_81 = qoz_ty_ty_error_();
    }
    _qoz_mv_1 = (_qoz_bv_81);  break; } default: { qoz_Ty* _qoz_bv_85;
    {
        qoz_string _qoz_bv_86;
    {
        qoz_Strbuf _qoz_sb_680_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_680_30); qoz_strings_sb_append(&_qoz_sb_680_30, QOZ_STR_LIT("cannot index value of type ")); qoz_strings_sb_append(&_qoz_sb_680_30, qoz_ty_ty_show(bt)); _qoz_bv_86 = qoz_strings_sb_finish(&_qoz_sb_680_30);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_86); _qoz_bv_85 = qoz_ty_ty_error_();
    }
    _qoz_mv_1 = (_qoz_bv_85);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}

bool qoz_check_is_strings_callee(qoz_Expr* callee, qoz_string method) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_1 = callee; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_1->payload.EField.f1; qoz_string m = _qoz_ms_1->payload.EField.f2; bool _qoz_bv_87;
    {
        if (!qoz_strings_eq_raw(m, method)) { return false;} qoz_Expr* _qoz_ms_2 = base; bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_2->payload.EIdent.f1; _qoz_mv_2 = (qoz_strings_eq_raw(name, QOZ_STR_LIT("strings")));  break; } default: { _qoz_mv_2 = (false);  break; } } _qoz_bv_87 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_87);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_check_resolve_callee_fn(qoz_TyContext* tc, qoz_Expr* callee) {
    ...
    {
        if (qoz_map_contains__qoz_string__bool(&tc->packages, pkg)) { return qoz_strings_cat(qoz_strings_cat(pkg, QOZ_STR_LIT("_")), method);} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->enums, pkg)) { if (qoz_map_contains__qoz_string__qoz_string(&tc->variant_of, method)) { return method;} } _qoz_bv_88 = QOZ_STR_LIT("");
    }
    _qoz_mv_2 = (_qoz_bv_88);  break; } default: { _qoz_mv_2 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_check_check_binding_compat(qoz_TyContext* tc, qoz_Span sp, qoz_TypeExpr* te, qoz_Ty* bound, qoz_Ty* vt) {
    ...
    qoz_gc_push_root(&vt);
    qoz_TypeExpr* _qoz_ms_1 = te; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TEUnit: { return;  break; } default: { NULL;  break; } } 0; if (!qoz_ty_ty_assignable(bound, vt)) { qoz_string want = qoz_ty_ty_show(bound); qoz_string got = qoz_ty_ty_show(vt); qoz_string _qoz_bv_93;
    {
        qoz_Strbuf _qoz_sb_912_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_912_30); qoz_strings_sb_append(&_qoz_sb_912_30, QOZ_STR_LIT("binding type ")); qoz_strings_sb_append(&_qoz_sb_912_30, want); qoz_strings_sb_append(&_qoz_sb_912_30, QOZ_STR_LIT(" cannot accept value of type ")); qoz_strings_sb_append(&_qoz_sb_912_30, got); _qoz_bv_93 = qoz_strings_sb_finish(&_qoz_sb_912_30);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_93); } 
    return;
}
...
qoz_Option__qoz_TypeExpr* qoz_check_struct_field_typeexpr(qoz_TyContext* tc, qoz_string name, qoz_string field) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_Option__qoz_Decl* _qoz_ms_1 = qoz_map_get__qoz_string__qoz_Decl(&tc->structs, name); qoz_Option__qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_1->payload.Some.f0; qoz_Decl* _qoz_ms_2 = d; qoz_Option__qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_StructField fields = _qoz_ms_2->payload.DStruct.f3; qoz_Option__qoz_TypeExpr* _qoz_bv_94;
    {
        int64_t i = 0; while (i < (fields.len)) { if (qoz_strings_eq_raw(fields.data[i].name, field)) { return qoz_make_Option__qoz_TypeExpr_Some(fields.data[i].ty);} i = i + 1; } _qoz_bv_94 = qoz_make_Option__qoz_TypeExpr_None();
    }
    _qoz_mv_2 = (_qoz_bv_94);  break; } default: { _qoz_mv_2 = (qoz_make_Option__qoz_TypeExpr_None());  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_1 = (qoz_make_Option__qoz_TypeExpr_None());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}

qoz_Ty* qoz_check_synth_path(qoz_TyContext* tc, qoz_Span sp, qoz_Vec__qoz_string segs) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    if ((segs.len) != 2) { qoz_check_record_error(tc, sp, QOZ_STR_LIT("path expression must have exactly two segments (Enum::Variant)")); return qoz_ty_ty_error_();} qoz_string enum_name = segs.data[0]; qoz_string variant = segs.data[1]; if (!qoz_map_contains__qoz_string__qoz_Decl(&tc->enums, enum_name)) { qoz_string _qoz_bv_95;
    {
        qoz_Strbuf _qoz_sb_968_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_968_30); qoz_strings_sb_append(&_qoz_sb_968_30, QOZ_STR_LIT("unknown enum `")); qoz_strings_sb_append(&_qoz_sb_968_30, enum_name); qoz_strings_sb_append(&_qoz_sb_968_30, QOZ_STR_LIT("`")); _qoz_bv_95 = qoz_strings_sb_finish(&_qoz_sb_968_30);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_95); return qoz_ty_ty_error_();} qoz_Option__qoz_string* _qoz_ms_1 = qoz_map_get__qoz_string__qoz_string(&tc->variant_of, variant); qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Option__qoz_string_Some: { qoz_string declared_enum = _qoz_ms_1->payload.Some.f0; qoz_Ty* _qoz_bv_96;
    {
        if (!qoz_strings_eq_raw(declared_enum, enum_name)) { qoz_string _qoz_bv_97;
    {
        qoz_Strbuf _qoz_sb_974_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_974_34); qoz_strings_sb_append(&_qoz_sb_974_34, QOZ_STR_LIT("`")); qoz_strings_sb_append(&_qoz_sb_974_34, variant); qoz_strings_sb_append(&_qoz_sb_974_34, QOZ_STR_LIT("` is not a variant of enum `")); qoz_strings_sb_append(&_qoz_sb_974_34, enum_name); qoz_strings_sb_append(&_qoz_sb_974_34, QOZ_STR_LIT("`")); _qoz_bv_97 = qoz_strings_sb_finish(&_qoz_sb_974_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_97); return qoz_ty_ty_error_();} _qoz_bv_96 = qoz_check_synth_variant_ctor(tc, variant);
    }
    _qoz_mv_1 = (_qoz_bv_96);  break; } case qoz_Option__qoz_string_None: { qoz_Ty* _qoz_bv_98;
    {
        qoz_string _qoz_bv_99;
    {
        qoz_Strbuf _qoz_sb_970_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_970_30); qoz_strings_sb_append(&_qoz_sb_970_30, QOZ_STR_LIT("unknown variant `")); qoz_strings_sb_append(&_qoz_sb_970_30, enum_name); qoz_strings_sb_append(&_qoz_sb_970_30, QOZ_STR_LIT("::")); qoz_strings_sb_append(&_qoz_sb_970_30, variant); qoz_strings_sb_append(&_qoz_sb_970_30, QOZ_STR_LIT("`")); _qoz_bv_99 = qoz_strings_sb_finish(&_qoz_sb_970_30);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_99); _qoz_bv_98 = qoz_ty_ty_error_();
    }
    _qoz_mv_1 = (_qoz_bv_98);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Vec__qoz_TypeExpr qoz_check_variant_positional_types(qoz_TyContext* tc, qoz_string enum_name, qoz_string variant) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_Vec__qoz_TypeExpr empty = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Decl* _qoz_ms_1 = qoz_map_get__qoz_string__qoz_Decl(&tc->enums, enum_name); qoz_Vec__qoz_TypeExpr _qoz_mv_1 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_1->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_1->payload.Some.f0; qoz_Decl* _qoz_ms_2 = d; qoz_Vec__qoz_TypeExpr _qoz_mv_2 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_2->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_VariantDecl variants = _qoz_ms_2->payload.DEnum.f3; qoz_Vec__qoz_TypeExpr _qoz_bv_100;
    {
        qoz_Vec__qoz_TypeExpr out = qoz_vec_make__qoz_TypeExpr(); bool found = false; int64_t i = 0; while (i < (variants.len)) { qoz_VariantDecl v = variants.data[i]; if (!found) { if (qoz_strings_eq_raw(v.name, variant)) { out = v.pos; found = true; } } i = i + 1; } _qoz_bv_100 = out;
    }
    _qoz_mv_2 = (_qoz_bv_100);  break; } default: { _qoz_mv_2 = (empty);  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_1 = (empty);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_synth_call_with_decl(qoz_TyContext* tc, qoz_Span sp, qoz_Decl* d, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Ty arg_tys) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_1 = d; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_1->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_1->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_1->payload.DFn.f4; qoz_Ty* _qoz_bv_101;
    {
        if ((arg_tys.len) != (params.len)) { qoz_string _qoz_bv_102;
    {
        qoz_Strbuf _qoz_sb_1080_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1080_34); qoz_strings_sb_append(&_qoz_sb_1080_34, QOZ_STR_LIT("function expects ")); qoz_strings_sb_append_i64(&_qoz_sb_1080_34, (params.len)); qoz_strings_sb_append(&_qoz_sb_1080_34, QOZ_STR_LIT(" argument(s), got ")); qoz_strings_sb_append_i64(&_qoz_sb_1080_34, (arg_tys.len)); _qoz_bv_102 = qoz_strings_sb_finish(&_qoz_sb_1080_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_102); } if ((tparams.len) == 0) { qoz_Map__qoz_string__bool saved = tc->type_params; qoz_check_set_type_params(tc, tparams); int64_t i = 0; while ((i < (params.len)) && (i < (arg_tys.len))) { qoz_Ty* p_ty = qoz_check_resolve_type(tc, params.data[i].ty); qoz_gc_push_root(&p_ty); if (!qoz_ty_ty_assignable(p_ty, arg_tys.data[i])) { qoz_string want = qoz_ty_ty_show(p_ty); qoz_string got = qoz_ty_ty_show(arg_tys.data[i]); qoz_string _qoz_bv_103;
    {
        qoz_Strbuf _qoz_sb_1094_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1094_42); qoz_strings_sb_append(&_qoz_sb_1094_42, QOZ_STR_LIT("expected ")); qoz_strings_sb_append(&_qoz_sb_1094_42, want); qoz_strings_sb_append(&_qoz_sb_1094_42, QOZ_STR_LIT(", got ")); qoz_strings_sb_append(&_qoz_sb_1094_42, got); _qoz_bv_103 = qoz_strings_sb_finish(&_qoz_sb_1094_42);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_103); } i = i + 1; } qoz_Ty* r = qoz_check_resolve_type(tc, ret); qoz_gc_push_root(&r); tc->type_params = saved; return r;} qoz_Vec__qoz_Ty tyarg_tys = qoz_vec_make__qoz_Ty(); if ((type_args.len) == (tparams.len)) { { qoz_Vec__qoz_TypeExpr __col = type_args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* ta = __col.data[__i]; (void)ta; qoz_vec_push__qoz_Ty(&tyarg_tys, qoz_check_resolve_type(tc, ta)); } }}  else { qoz_Map__qoz_string__bool saved_a = tc->type_params; qoz_check_set_type_params(tc, tparams); qoz_Vec__qoz_Ty param_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_vec_push__qoz_Ty(&param_tys, qoz_check_resolve_type(tc, pp.ty)); } }tc->type_params = saved_a; qoz_Map__qoz_string__qoz_Ty subst_env = qoz_map_make__qoz_string__qoz_Ty(); bool ok = true; int64_t i = 0; while ((i < (arg_tys.len)) && (i < (param_tys.len))) { if (!qoz_check_unify(param_tys.data[i], arg_tys.data[i], &subst_env)) { ok = false; } i = i + 1; } if (!ok) { qoz_check_record_error(tc, sp, QOZ_STR_LIT("could not infer generic type arguments at call site")); } { qoz_Vec__qoz_string __col = tparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string tp = __col.data[__i]; (void)tp; qoz_Option__qoz_Ty* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_Ty(&subst_env, tp); switch (_qoz_ms_2->tag) { case qoz_Option__qoz_Ty_Some: { qoz_Ty* t = _qoz_ms_2->payload.Some.f0; qoz_vec_push__qoz_Ty(&tyarg_tys, t);  break; } case qoz_Option__qoz_Ty_None: { {
        qoz_string _qoz_bv_104;
    {
        qoz_Strbuf _qoz_sb_1125_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1125_42); qoz_strings_sb_append(&_qoz_sb_1125_42, QOZ_STR_LIT("type parameter `")); qoz_strings_sb_append(&_qoz_sb_1125_42, tp); qoz_strings_sb_append(&_qoz_sb_1125_42, QOZ_STR_LIT("` is not constrained by any argument; add an explicit annotation")); _qoz_bv_104 = qoz_strings_sb_finish(&_qoz_sb_1125_42);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_104); qoz_vec_push__qoz_Ty(&tyarg_tys, qoz_ty_ty_error_()); 
    }
    0;  break; } } 0; } }} qoz_Map__qoz_string__bool saved_b = tc->type_params; qoz_check_set_type_params(tc, tparams); qoz_Ty* raw_ret = qoz_check_resolve_type(tc, ret); qoz_gc_push_root(&raw_ret); tc->type_params = saved_b; _qoz_bv_101 = qoz_check_apply_subst(raw_ret, tparams, tyarg_tys);
    }
    _qoz_mv_1 = (_qoz_bv_101);  break; } case qoz_Decl_DExternal: { qoz_TypeExpr* ret = _qoz_ms_1->payload.DExternal.f4; _qoz_mv_1 = (qoz_check_resolve_type(tc, ret));  break; } default: { _qoz_mv_1 = (qoz_ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
bool qoz_check_compatible_or_refine(qoz_Map__qoz_string__qoz_Ty* env, qoz_string name, qoz_Ty* prior, qoz_Ty* concrete) {
    ...
    qoz_gc_push_root(&concrete);
    if (qoz_ty_ty_eq(prior, concrete)) { return true;} qoz_Ty* _qoz_ms_1 = prior; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_1->payload.TyInt.f0; qoz_Ty* _qoz_ms_2 = concrete; bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Ty_TyInt: { qoz_IntInfo ci = _qoz_ms_2->payload.TyInt.f0; bool _qoz_bv_106;
    {
        if (ci.untyped) { return true;} if (pi.untyped) { qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); return true;} _qoz_bv_106 = false;
    }
    _qoz_mv_2 = (_qoz_bv_106);  break; } default: { _qoz_mv_2 = (false);  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_1->payload.TyFloat.f0; qoz_Ty* _qoz_ms_3 = concrete; bool _qoz_mv_3 = false; switch (_qoz_ms_3->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo cf = _qoz_ms_3->payload.TyFloat.f0; bool _qoz_bv_107;
    {
        if (cf.untyped) { return true;} if (pf.untyped) { qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); return true;} _qoz_bv_107 = false;
    }
    _qoz_mv_3 = (_qoz_bv_107);  break; } default: { _qoz_mv_3 = (false);  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_fn_decl_value_type(qoz_TyContext* tc, qoz_Decl* d) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_1 = d; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_FnParam params = _qoz_ms_1->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_1->payload.DFn.f4; qoz_Ty* _qoz_bv_109;
    {
        qoz_Vec__qoz_Ty pts = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; qoz_vec_push__qoz_Ty(&pts, qoz_check_resolve_type(tc, p.ty)); } }_qoz_bv_109 = qoz_ty_ty_fn_(pts, qoz_check_resolve_type(tc, ret));
    }
    _qoz_mv_1 = (_qoz_bv_109);  break; } case qoz_Decl_DExternal: { qoz_Vec__qoz_FnParam params = _qoz_ms_1->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_1->payload.DExternal.f4; qoz_Ty* _qoz_bv_110;
    {
        qoz_Vec__qoz_Ty pts = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; qoz_vec_push__qoz_Ty(&pts, qoz_check_resolve_type(tc, p.ty)); } }_qoz_bv_110 = qoz_ty_ty_fn_(pts, qoz_check_resolve_type(tc, ret));
    }
    _qoz_mv_1 = (_qoz_bv_110);  break; } default: { _qoz_mv_1 = (qoz_ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_synth_binary(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_BinaryOp* op, qoz_Expr* l, qoz_Expr* r) {
    ...
    qoz_gc_push_root(&l);
    qoz_gc_push_root(&r);
    qoz_Ty* lt = qoz_check_synth(tc, env, l); qoz_gc_push_root(&lt); qoz_Ty* rt = qoz_check_synth(tc, env, r); qoz_gc_push_root(&rt); if (qoz_ty_ty_is_error(lt) || qoz_ty_ty_is_error(rt)) { return qoz_check_binary_result_default(op);} qoz_BinaryOp* _qoz_ms_1 = op; qoz_Ty* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_BinaryOp_BOpEq: { qoz_Ty* _qoz_bv_111;
    {
        if (!qoz_ty_ty_assignable(lt, rt) && !qoz_ty_ty_assignable(rt, lt)) { qoz_string _qoz_bv_112;
    {
        qoz_Strbuf _qoz_sb_1297_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1297_34); qoz_strings_sb_append(&_qoz_sb_1297_34, QOZ_STR_LIT("operands of `==` / `!=` have incompatible types: ")); qoz_strings_sb_append(&_qoz_sb_1297_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1297_34, QOZ_STR_LIT(" vs ")); qoz_strings_sb_append(&_qoz_sb_1297_34, qoz_ty_ty_show(rt)); _qoz_bv_112 = qoz_strings_sb_finish(&_qoz_sb_1297_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_112); } _qoz_bv_111 = qoz_ty_ty_bool_();
    }
    _qoz_mv_1 = (_qoz_bv_111);  break; } case qoz_BinaryOp_BOpNe: { qoz_Ty* _qoz_bv_113;
    {
        if (!qoz_ty_ty_assignable(lt, rt) && !qoz_ty_ty_assignable(rt, lt)) { qoz_string _qoz_bv_114;
    {
        qoz_Strbuf _qoz_sb_1297_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1297_34); qoz_strings_sb_append(&_qoz_sb_1297_34, QOZ_STR_LIT("operands of `==` / `!=` have incompatible types: ")); qoz_strings_sb_append(&_qoz_sb_1297_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1297_34, QOZ_STR_LIT(" vs ")); qoz_strings_sb_append(&_qoz_sb_1297_34, qoz_ty_ty_show(rt)); _qoz_bv_114 = qoz_strings_sb_finish(&_qoz_sb_1297_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_114); } _qoz_bv_113 = qoz_ty_ty_bool_();
    }
    _qoz_mv_1 = (_qoz_bv_113);  break; } case qoz_BinaryOp_BOpLt: { qoz_Ty* _qoz_bv_115;
    {
        if (!qoz_ty_ty_is_numeric(lt) || !qoz_ty_ty_is_numeric(rt)) { qoz_string _qoz_bv_116;
    {
        qoz_Strbuf _qoz_sb_1303_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1303_34); qoz_strings_sb_append(&_qoz_sb_1303_34, QOZ_STR_LIT("ordering comparison requires numeric operands, got ")); qoz_strings_sb_append(&_qoz_sb_1303_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1303_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1303_34, qoz_ty_ty_show(rt)); _qoz_bv_116 = qoz_strings_sb_finish(&_qoz_sb_1303_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_116); } _qoz_bv_115 = qoz_ty_ty_bool_();
    }
    _qoz_mv_1 = (_qoz_bv_115);  break; } case qoz_BinaryOp_BOpGt: { qoz_Ty* _qoz_bv_117;
    {
        if (!qoz_ty_ty_is_numeric(lt) || !qoz_ty_ty_is_numeric(rt)) { qoz_string _qoz_bv_118;
    {
        qoz_Strbuf _qoz_sb_1303_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1303_34); qoz_strings_sb_append(&_qoz_sb_1303_34, QOZ_STR_LIT("ordering comparison requires numeric operands, got ")); qoz_strings_sb_append(&_qoz_sb_1303_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1303_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1303_34, qoz_ty_ty_show(rt)); _qoz_bv_118 = qoz_strings_sb_finish(&_qoz_sb_1303_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_118); } _qoz_bv_117 = qoz_ty_ty_bool_();
    }
    _qoz_mv_1 = (_qoz_bv_117);  break; } case qoz_BinaryOp_BOpLe: { qoz_Ty* _qoz_bv_119;
    {
        if (!qoz_ty_ty_is_numeric(lt) || !qoz_ty_ty_is_numeric(rt)) { qoz_string _qoz_bv_120;
    {
        qoz_Strbuf _qoz_sb_1303_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1303_34); qoz_strings_sb_append(&_qoz_sb_1303_34, QOZ_STR_LIT("ordering comparison requires numeric operands, got ")); qoz_strings_sb_append(&_qoz_sb_1303_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1303_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1303_34, qoz_ty_ty_show(rt)); _qoz_bv_120 = qoz_strings_sb_finish(&_qoz_sb_1303_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_120); } _qoz_bv_119 = qoz_ty_ty_bool_();
    }
    _qoz_mv_1 = (_qoz_bv_119);  break; } case qoz_BinaryOp_BOpGe: { qoz_Ty* _qoz_bv_121;
    {
        if (!qoz_ty_ty_is_numeric(lt) || !qoz_ty_ty_is_numeric(rt)) { qoz_string _qoz_bv_122;
    {
        qoz_Strbuf _qoz_sb_1303_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1303_34); qoz_strings_sb_append(&_qoz_sb_1303_34, QOZ_STR_LIT("ordering comparison requires numeric operands, got ")); qoz_strings_sb_append(&_qoz_sb_1303_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1303_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1303_34, qoz_ty_ty_show(rt)); _qoz_bv_122 = qoz_strings_sb_finish(&_qoz_sb_1303_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_122); } _qoz_bv_121 = qoz_ty_ty_bool_();
    }
    _qoz_mv_1 = (_qoz_bv_121);  break; } case qoz_BinaryOp_BOpAnd: { qoz_Ty* _qoz_bv_123;
    {
        if (!qoz_ty_ty_is_bool(lt) || !qoz_ty_ty_is_bool(rt)) { qoz_string _qoz_bv_124;
    {
        qoz_Strbuf _qoz_sb_1309_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1309_34); qoz_strings_sb_append(&_qoz_sb_1309_34, QOZ_STR_LIT("logical operator requires bool operands, got ")); qoz_strings_sb_append(&_qoz_sb_1309_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1309_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1309_34, qoz_ty_ty_show(rt)); _qoz_bv_124 = qoz_strings_sb_finish(&_qoz_sb_1309_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_124); } _qoz_bv_123 = qoz_ty_ty_bool_();
    }
    _qoz_mv_1 = (_qoz_bv_123);  break; } case qoz_BinaryOp_BOpOr: { qoz_Ty* _qoz_bv_125;
    {
        if (!qoz_ty_ty_is_bool(lt) || !qoz_ty_ty_is_bool(rt)) { qoz_string _qoz_bv_126;
    {
        qoz_Strbuf _qoz_sb_1309_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1309_34); qoz_strings_sb_append(&_qoz_sb_1309_34, QOZ_STR_LIT("logical operator requires bool operands, got ")); qoz_strings_sb_append(&_qoz_sb_1309_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1309_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1309_34, qoz_ty_ty_show(rt)); _qoz_bv_126 = qoz_strings_sb_finish(&_qoz_sb_1309_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_126); } _qoz_bv_125 = qoz_ty_ty_bool_();
    }
    _qoz_mv_1 = (_qoz_bv_125);  break; } case qoz_BinaryOp_BOpAdd: { qoz_Ty* _qoz_bv_127;
    {
        if (!qoz_ty_ty_is_numeric(lt) || !qoz_ty_ty_is_numeric(rt)) { qoz_string _qoz_bv_128;
    {
        qoz_Strbuf _qoz_sb_1315_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1315_34); qoz_strings_sb_append(&_qoz_sb_1315_34, QOZ_STR_LIT("arithmetic operator requires numeric operands, got ")); qoz_strings_sb_append(&_qoz_sb_1315_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1315_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1315_34, qoz_ty_ty_show(rt)); _qoz_bv_128 = qoz_strings_sb_finish(&_qoz_sb_1315_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_128); return qoz_ty_ty_error_();} if (!qoz_ty_ty_assignable(lt, rt) && !qoz_ty_ty_assignable(rt, lt)) { qoz_string _qoz_bv_129;
    {
        qoz_Strbuf _qoz_sb_1319_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1319_34); qoz_strings_sb_append(&_qoz_sb_1319_34, QOZ_STR_LIT("arithmetic operands have incompatible numeric types: ")); qoz_strings_sb_append(&_qoz_sb_1319_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1319_34, QOZ_STR_LIT(" vs ")); qoz_strings_sb_append(&_qoz_sb_1319_34, qoz_ty_ty_show(rt)); _qoz_bv_129 = qoz_strings_sb_finish(&_qoz_sb_1319_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_129); } _qoz_bv_127 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_127);  break; } case qoz_BinaryOp_BOpSub: { qoz_Ty* _qoz_bv_130;
    {
        if (!qoz_ty_ty_is_numeric(lt) || !qoz_ty_ty_is_numeric(rt)) { qoz_string _qoz_bv_131;
    {
        qoz_Strbuf _qoz_sb_1315_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1315_34); qoz_strings_sb_append(&_qoz_sb_1315_34, QOZ_STR_LIT("arithmetic operator requires numeric operands, got ")); qoz_strings_sb_append(&_qoz_sb_1315_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1315_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1315_34, qoz_ty_ty_show(rt)); _qoz_bv_131 = qoz_strings_sb_finish(&_qoz_sb_1315_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_131); return qoz_ty_ty_error_();} if (!qoz_ty_ty_assignable(lt, rt) && !qoz_ty_ty_assignable(rt, lt)) { qoz_string _qoz_bv_132;
    {
        qoz_Strbuf _qoz_sb_1319_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1319_34); qoz_strings_sb_append(&_qoz_sb_1319_34, QOZ_STR_LIT("arithmetic operands have incompatible numeric types: ")); qoz_strings_sb_append(&_qoz_sb_1319_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1319_34, QOZ_STR_LIT(" vs ")); qoz_strings_sb_append(&_qoz_sb_1319_34, qoz_ty_ty_show(rt)); _qoz_bv_132 = qoz_strings_sb_finish(&_qoz_sb_1319_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_132); } _qoz_bv_130 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_130);  break; } case qoz_BinaryOp_BOpMul: { qoz_Ty* _qoz_bv_133;
    {
        if (!qoz_ty_ty_is_numeric(lt) || !qoz_ty_ty_is_numeric(rt)) { qoz_string _qoz_bv_134;
    {
        qoz_Strbuf _qoz_sb_1315_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1315_34); qoz_strings_sb_append(&_qoz_sb_1315_34, QOZ_STR_LIT("arithmetic operator requires numeric operands, got ")); qoz_strings_sb_append(&_qoz_sb_1315_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1315_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1315_34, qoz_ty_ty_show(rt)); _qoz_bv_134 = qoz_strings_sb_finish(&_qoz_sb_1315_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_134); return qoz_ty_ty_error_();} if (!qoz_ty_ty_assignable(lt, rt) && !qoz_ty_ty_assignable(rt, lt)) { qoz_string _qoz_bv_135;
    {
        qoz_Strbuf _qoz_sb_1319_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1319_34); qoz_strings_sb_append(&_qoz_sb_1319_34, QOZ_STR_LIT("arithmetic operands have incompatible numeric types: ")); qoz_strings_sb_append(&_qoz_sb_1319_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1319_34, QOZ_STR_LIT(" vs ")); qoz_strings_sb_append(&_qoz_sb_1319_34, qoz_ty_ty_show(rt)); _qoz_bv_135 = qoz_strings_sb_finish(&_qoz_sb_1319_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_135); } _qoz_bv_133 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_133);  break; } case qoz_BinaryOp_BOpDiv: { qoz_Ty* _qoz_bv_136;
    {
        if (!qoz_ty_ty_is_numeric(lt) || !qoz_ty_ty_is_numeric(rt)) { qoz_string _qoz_bv_137;
    {
        qoz_Strbuf _qoz_sb_1315_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1315_34); qoz_strings_sb_append(&_qoz_sb_1315_34, QOZ_STR_LIT("arithmetic operator requires numeric operands, got ")); qoz_strings_sb_append(&_qoz_sb_1315_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1315_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1315_34, qoz_ty_ty_show(rt)); _qoz_bv_137 = qoz_strings_sb_finish(&_qoz_sb_1315_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_137); return qoz_ty_ty_error_();} if (!qoz_ty_ty_assignable(lt, rt) && !qoz_ty_ty_assignable(rt, lt)) { qoz_string _qoz_bv_138;
    {
        qoz_Strbuf _qoz_sb_1319_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1319_34); qoz_strings_sb_append(&_qoz_sb_1319_34, QOZ_STR_LIT("arithmetic operands have incompatible numeric types: ")); qoz_strings_sb_append(&_qoz_sb_1319_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1319_34, QOZ_STR_LIT(" vs ")); qoz_strings_sb_append(&_qoz_sb_1319_34, qoz_ty_ty_show(rt)); _qoz_bv_138 = qoz_strings_sb_finish(&_qoz_sb_1319_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_138); } _qoz_bv_136 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_136);  break; } case qoz_BinaryOp_BOpMod: { qoz_Ty* _qoz_bv_139;
    {
        if (!qoz_ty_ty_is_numeric(lt) || !qoz_ty_ty_is_numeric(rt)) { qoz_string _qoz_bv_140;
    {
        qoz_Strbuf _qoz_sb_1315_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1315_34); qoz_strings_sb_append(&_qoz_sb_1315_34, QOZ_STR_LIT("arithmetic operator requires numeric operands, got ")); qoz_strings_sb_append(&_qoz_sb_1315_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1315_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1315_34, qoz_ty_ty_show(rt)); _qoz_bv_140 = qoz_strings_sb_finish(&_qoz_sb_1315_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_140); return qoz_ty_ty_error_();} if (!qoz_ty_ty_assignable(lt, rt) && !qoz_ty_ty_assignable(rt, lt)) { qoz_string _qoz_bv_141;
    {
        qoz_Strbuf _qoz_sb_1319_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1319_34); qoz_strings_sb_append(&_qoz_sb_1319_34, QOZ_STR_LIT("arithmetic operands have incompatible numeric types: ")); qoz_strings_sb_append(&_qoz_sb_1319_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1319_34, QOZ_STR_LIT(" vs ")); qoz_strings_sb_append(&_qoz_sb_1319_34, qoz_ty_ty_show(rt)); _qoz_bv_141 = qoz_strings_sb_finish(&_qoz_sb_1319_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_141); } _qoz_bv_139 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_139);  break; } case qoz_BinaryOp_BOpBitAnd: { qoz_Ty* _qoz_bv_142;
    {
        if (!qoz_ty_ty_is_int(lt) || !qoz_ty_ty_is_int(rt)) { qoz_string _qoz_bv_143;
    {
        qoz_Strbuf _qoz_sb_1325_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1325_34); qoz_strings_sb_append(&_qoz_sb_1325_34, QOZ_STR_LIT("bitwise / shift operator requires integer operands, got ")); qoz_strings_sb_append(&_qoz_sb_1325_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1325_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1325_34, qoz_ty_ty_show(rt)); _qoz_bv_143 = qoz_strings_sb_finish(&_qoz_sb_1325_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_143); return qoz_ty_ty_error_();} _qoz_bv_142 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_142);  break; } case qoz_BinaryOp_BOpBitOr: { qoz_Ty* _qoz_bv_144;
    {
        if (!qoz_ty_ty_is_int(lt) || !qoz_ty_ty_is_int(rt)) { qoz_string _qoz_bv_145;
    {
        qoz_Strbuf _qoz_sb_1325_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1325_34); qoz_strings_sb_append(&_qoz_sb_1325_34, QOZ_STR_LIT("bitwise / shift operator requires integer operands, got ")); qoz_strings_sb_append(&_qoz_sb_1325_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1325_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1325_34, qoz_ty_ty_show(rt)); _qoz_bv_145 = qoz_strings_sb_finish(&_qoz_sb_1325_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_145); return qoz_ty_ty_error_();} _qoz_bv_144 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_144);  break; } case qoz_BinaryOp_BOpBitXor: { qoz_Ty* _qoz_bv_146;
    {
        if (!qoz_ty_ty_is_int(lt) || !qoz_ty_ty_is_int(rt)) { qoz_string _qoz_bv_147;
    {
        qoz_Strbuf _qoz_sb_1325_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1325_34); qoz_strings_sb_append(&_qoz_sb_1325_34, QOZ_STR_LIT("bitwise / shift operator requires integer operands, got ")); qoz_strings_sb_append(&_qoz_sb_1325_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1325_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1325_34, qoz_ty_ty_show(rt)); _qoz_bv_147 = qoz_strings_sb_finish(&_qoz_sb_1325_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_147); return qoz_ty_ty_error_();} _qoz_bv_146 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_146);  break; } case qoz_BinaryOp_BOpShl: { qoz_Ty* _qoz_bv_148;
    {
        if (!qoz_ty_ty_is_int(lt) || !qoz_ty_ty_is_int(rt)) { qoz_string _qoz_bv_149;
    {
        qoz_Strbuf _qoz_sb_1325_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1325_34); qoz_strings_sb_append(&_qoz_sb_1325_34, QOZ_STR_LIT("bitwise / shift operator requires integer operands, got ")); qoz_strings_sb_append(&_qoz_sb_1325_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1325_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1325_34, qoz_ty_ty_show(rt)); _qoz_bv_149 = qoz_strings_sb_finish(&_qoz_sb_1325_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_149); return qoz_ty_ty_error_();} _qoz_bv_148 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_148);  break; } case qoz_BinaryOp_BOpShr: { qoz_Ty* _qoz_bv_150;
    {
        if (!qoz_ty_ty_is_int(lt) || !qoz_ty_ty_is_int(rt)) { qoz_string _qoz_bv_151;
    {
        qoz_Strbuf _qoz_sb_1325_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1325_34); qoz_strings_sb_append(&_qoz_sb_1325_34, QOZ_STR_LIT("bitwise / shift operator requires integer operands, got ")); qoz_strings_sb_append(&_qoz_sb_1325_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1325_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1325_34, qoz_ty_ty_show(rt)); _qoz_bv_151 = qoz_strings_sb_finish(&_qoz_sb_1325_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_151); return qoz_ty_ty_error_();} _qoz_bv_150 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_150);  break; } case qoz_BinaryOp_BOpRange: { qoz_Ty* _qoz_bv_152;
    {
        if (!qoz_ty_ty_is_int(lt) || !qoz_ty_ty_is_int(rt)) { qoz_string _qoz_bv_153;
    {
        qoz_Strbuf _qoz_sb_1332_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1332_34); qoz_strings_sb_append(&_qoz_sb_1332_34, QOZ_STR_LIT("range bounds must be integers, got ")); qoz_strings_sb_append(&_qoz_sb_1332_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1332_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1332_34, qoz_ty_ty_show(rt)); _qoz_bv_153 = qoz_strings_sb_finish(&_qoz_sb_1332_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_153); } _qoz_bv_152 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_152);  break; } case qoz_BinaryOp_BOpRangeInclusive: { qoz_Ty* _qoz_bv_154;
    {
        if (!qoz_ty_ty_is_int(lt) || !qoz_ty_ty_is_int(rt)) { qoz_string _qoz_bv_155;
    {
        qoz_Strbuf _qoz_sb_1332_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1332_34); qoz_strings_sb_append(&_qoz_sb_1332_34, QOZ_STR_LIT("range bounds must be integers, got ")); qoz_strings_sb_append(&_qoz_sb_1332_34, qoz_ty_ty_show(lt)); qoz_strings_sb_append(&_qoz_sb_1332_34, QOZ_STR_LIT(" and ")); qoz_strings_sb_append(&_qoz_sb_1332_34, qoz_ty_ty_show(rt)); _qoz_bv_155 = qoz_strings_sb_finish(&_qoz_sb_1332_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_155); } _qoz_bv_154 = lt;
    }
    _qoz_mv_1 = (_qoz_bv_154);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Ty* qoz_check_synth_block(qoz_TyContext* tc, qoz_Env* env, qoz_Vec__qoz_Stmt stmts, qoz_Expr* tail) {
    ...
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* ex = _qoz_ms_1->payload.SExpr.f1; void* _qoz_bv_156;
    {
        (void)(qoz_check_synth(tc, env, ex)); _qoz_bv_156 = NULL;
    }
    _qoz_bv_156;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_check_synth(tc, env, tail);
}
...
qoz_Ty* qoz_check_synth_if(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* c, qoz_Expr* t, qoz_Expr* f) {
    ...
    qoz_gc_push_root(&t);
    qoz_gc_push_root(&f);
    qoz_Ty* ct = qoz_check_synth(tc, env, c); qoz_gc_push_root(&ct); if (!qoz_ty_ty_is_error(ct) && !qoz_ty_ty_is_bool(ct)) { qoz_string _qoz_bv_157;
    {
        qoz_Strbuf _qoz_sb_1377_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1377_30); qoz_strings_sb_append(&_qoz_sb_1377_30, QOZ_STR_LIT("if condition must be bool, got ")); qoz_strings_sb_append(&_qoz_sb_1377_30, qoz_ty_ty_show(ct)); _qoz_bv_157 = qoz_strings_sb_finish(&_qoz_sb_1377_30);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_157); } qoz_Ty* tt = qoz_check_synth(tc, env, t); qoz_gc_push_root(&tt); qoz_Ty* ft = qoz_check_synth(tc, env, f); qoz_gc_push_root(&ft); if (qoz_ty_ty_is_error(tt) || qoz_ty_ty_is_error(ft)) { return tt;} if (!qoz_ty_ty_is_nil(tt) && !qoz_ty_ty_is_nil(ft)) { if (!qoz_ty_ty_assignable(tt, ft) && !qoz_ty_ty_assignable(ft, tt)) { qoz_string _qoz_bv_158;
    {
        qoz_Strbuf _qoz_sb_1387_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1387_34); qoz_strings_sb_append(&_qoz_sb_1387_34, QOZ_STR_LIT("if branches have incompatible types: then is ")); qoz_strings_sb_append(&_qoz_sb_1387_34, qoz_ty_ty_show(tt)); qoz_strings_sb_append(&_qoz_sb_1387_34, QOZ_STR_LIT(", else is ")); qoz_strings_sb_append(&_qoz_sb_1387_34, qoz_ty_ty_show(ft)); _qoz_bv_158 = qoz_strings_sb_finish(&_qoz_sb_1387_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_158); } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return tt;
}
...
qoz_Ty* qoz_check_synth_match(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_Ty* scrut_ty = qoz_check_synth(tc, env, scrut); qoz_gc_push_root(&scrut_ty); qoz_Ty* result = qoz_ty_ty_unit_(); qoz_gc_push_root(&result); bool first = true; { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; int64_t saved_len = (env->bindings.len); qoz_check_bind_pattern(tc, env, arm.pat, scrut_ty); qoz_Ty* armt = qoz_check_synth(tc, env, arm.body); qoz_gc_push_root(&armt); qoz_check_env_truncate(env, saved_len); if (first) { result = armt; first = false; }  else { if (!qoz_ty_ty_is_error(result) && !qoz_ty_ty_is_error(armt)) { if (!qoz_ty_ty_is_nil(armt) && !qoz_ty_ty_is_nil(result)) { if (!qoz_ty_ty_assignable(result, armt) && !qoz_ty_ty_assignable(armt, result)) { qoz_string _qoz_bv_159;
    {
        qoz_Strbuf _qoz_sb_1409_46 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1409_46); qoz_strings_sb_append(&_qoz_sb_1409_46, QOZ_STR_LIT("match arms have incompatible types: earlier arm is ")); qoz_strings_sb_append(&_qoz_sb_1409_46, qoz_ty_ty_show(result)); qoz_strings_sb_append(&_qoz_sb_1409_46, QOZ_STR_LIT(", this arm is ")); qoz_strings_sb_append(&_qoz_sb_1409_46, qoz_ty_ty_show(armt)); _qoz_bv_159 = qoz_strings_sb_finish(&_qoz_sb_1409_46);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_159); } } } } } }qoz_check_check_match_exhaustiveness(tc, scrut, scrut_ty, arms); qoz_gc_shadow_set_top(_qoz_shadow_guard); return result;
}
...
bool qoz_check_iterable_ty(qoz_Ty* t, bool paired) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_1 = t; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyRecord.f1; bool _qoz_bv_160;
    {
        if (paired) { return ((args.len) == 2) && qoz_strings_eq_raw(name, QOZ_STR_LIT("Map"));} _qoz_bv_160 = (qoz_strings_eq_raw(name, QOZ_STR_LIT("Vec")) || qoz_strings_eq_raw(name, QOZ_STR_LIT("Map"))) || qoz_strings_eq_raw(name, QOZ_STR_LIT("Range"));
    }
    _qoz_mv_1 = (_qoz_bv_160);  break; } case qoz_Ty_TyInt: { _qoz_mv_1 = (!paired);  break; } case qoz_Ty_TyPtr: { _qoz_mv_1 = (!paired);  break; } case qoz_Ty_TyVar: { _qoz_mv_1 = (true);  break; } case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_1->payload.TyAdt.f0; _qoz_mv_1 = (qoz_strings_eq_raw(name, QOZ_STR_LIT("Range")));  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_check_bind_pattern(qoz_TyContext* tc, qoz_Env* env, qoz_Pattern* pat, qoz_Ty* scrut) {
    ...
    qoz_Pattern* _qoz_ms_1 = pat; switch (_qoz_ms_1->tag) { case qoz_Pattern_PatWild: { NULL;  break; } case qoz_Pattern_PatLitInt: { qoz_Span sp = _qoz_ms_1->payload.PatLitInt.f0; {
        bool bad = (!qoz_ty_ty_is_error(scrut) && !qoz_ty_ty_is_int(scrut)) && !qoz_ty_ty_is_numeric(scrut); if (bad) { qoz_string _qoz_bv_161;
    {
        qoz_Strbuf _qoz_sb_1607_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1607_34); qoz_strings_sb_append(&_qoz_sb_1607_34, QOZ_STR_LIT("integer literal pattern cannot match scrutinee of type ")); qoz_strings_sb_append(&_qoz_sb_1607_34, qoz_ty_ty_show(scrut)); _qoz_bv_161 = qoz_strings_sb_finish(&_qoz_sb_1607_34);
    }
    ...
    0;  break; } case qoz_Pattern_PatLitString: { qoz_Span sp = _qoz_ms_1->payload.PatLitString.f0; {
        qoz_Ty* _qoz_ms_2 = scrut; bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Ty_TyString: { _qoz_mv_2 = (false);  break; } case qoz_Ty_TyCstring: { _qoz_mv_2 = (false);  break; } case qoz_Ty_TyVar: { _qoz_mv_2 = (false);  break; } case qoz_Ty_TyError: { _qoz_mv_2 = (false);  break; } default: { _qoz_mv_2 = (true);  break; } } bool bad = _qoz_mv_2; if (bad) { qoz_string _qoz_bv_162;
    {
        qoz_Strbuf _qoz_sb_1616_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1616_34); qoz_strings_sb_append(&_qoz_sb_1616_34, QOZ_STR_LIT("string literal pattern cannot match scrutinee of type ")); qoz_strings_sb_append(&_qoz_sb_1616_34, qoz_ty_ty_show(scrut)); _qoz_bv_162 = qoz_strings_sb_finish(&_qoz_sb_1616_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_162); }  else { } 
    }
    0;  break; } case qoz_Pattern_PatLitBool: { qoz_Span sp = _qoz_ms_1->payload.PatLitBool.f0; {
        bool bad = !qoz_ty_ty_is_error(scrut) && !qoz_ty_ty_is_bool(scrut); if (bad) { qoz_string _qoz_bv_163;
    {
        qoz_Strbuf _qoz_sb_1612_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1612_34); qoz_strings_sb_append(&_qoz_sb_1612_34, QOZ_STR_LIT("bool literal pattern cannot match scrutinee of type ")); qoz_strings_sb_append(&_qoz_sb_1612_34, qoz_ty_ty_show(scrut)); _qoz_bv_163 = qoz_strings_sb_finish(&_qoz_sb_1612_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_163); }  else { } 
    }
...
void qoz_check_bind_variant_pattern(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Vec__qoz_string path, qoz_Vec__qoz_Pattern sub_pats, qoz_Ty* scrut) {
    ...
    {
        qoz_Strbuf _qoz_sb_1638_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1638_30); qoz_strings_sb_append(&_qoz_sb_1638_30, QOZ_STR_LIT("unknown variant `")); qoz_strings_sb_append(&_qoz_sb_1638_30, variant); qoz_strings_sb_append(&_qoz_sb_1638_30, QOZ_STR_LIT("` in pattern")); _qoz_bv_164 = qoz_strings_sb_finish(&_qoz_sb_1638_30);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_164); return;
    }
    0;  break; } case qoz_Option__qoz_string_Some: { qoz_string declared_enum = _qoz_ms_1->payload.Some.f0; {
        qoz_string scrut_enum = qoz_check_enum_name_of_ty(scrut); if (!qoz_strings_eq_raw(scrut_enum, QOZ_STR_LIT("")) && !qoz_strings_eq_raw(scrut_enum, declared_enum)) { qoz_string _qoz_bv_165;
    {
        qoz_Strbuf _qoz_sb_1645_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1645_34); qoz_strings_sb_append(&_qoz_sb_1645_34, QOZ_STR_LIT("variant `")); qoz_strings_sb_append(&_qoz_sb_1645_34, declared_enum); qoz_strings_sb_append(&_qoz_sb_1645_34, QOZ_STR_LIT("::")); qoz_strings_sb_append(&_qoz_sb_1645_34, variant); qoz_strings_sb_append(&_qoz_sb_1645_34, QOZ_STR_LIT("` cannot match scrutinee of enum `")); qoz_strings_sb_append(&_qoz_sb_1645_34, scrut_enum); qoz_strings_sb_append(&_qoz_sb_1645_34, QOZ_STR_LIT("`")); _qoz_bv_165 = qoz_strings_sb_finish(&_qoz_sb_1645_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_165); return;} qoz_Option__qoz_Decl* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_Decl(&tc->enums, declared_enum); switch (_qoz_ms_2->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_2->payload.Some.f0; qoz_Decl* _qoz_ms_3 = d; switch (_qoz_ms_3->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_3->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_3->payload.DEnum.f3; {
        qoz_Vec__qoz_Ty tyargs = qoz_vec_make__qoz_Ty(); qoz_Ty* _qoz_ms_4 = scrut; switch (_qoz_ms_4->tag) { case qoz_Ty_TyAdt: { qoz_Vec__qoz_Ty args = _qoz_ms_4->payload.TyAdt.f1; tyargs = args;  break; } default: { NULL;  break; } } 0; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_strings_eq_raw(v.name, variant)) { if ((sub_pats.len) != (v.pos.len)) { qoz_string _qoz_bv_166;
    {
        qoz_Strbuf _qoz_sb_1650_50 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1650_50); qoz_strings_sb_append(&_qoz_sb_1650_50, QOZ_STR_LIT("variant `")); qoz_strings_sb_append(&_qoz_sb_1650_50, variant); qoz_strings_sb_append(&_qoz_sb_1650_50, QOZ_STR_LIT("` takes ")); qoz_strings_sb_append_i64(&_qoz_sb_1650_50, (v.pos.len)); qoz_strings_sb_append(&_qoz_sb_1650_50, QOZ_STR_LIT(" arguments but pattern provides ")); qoz_strings_sb_append_i64(&_qoz_sb_1650_50, (sub_pats.len)); _qoz_bv_166 = qoz_strings_sb_finish(&_qoz_sb_1650_50);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_166); } int64_t i = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pos_te = __col.data[__i]; (void)pos_te; if (i < (sub_pats.len)) { qoz_Ty* pos_ty = qoz_check_resolve_type_with_subst(tc, pos_te, tparams, tyargs); qoz_gc_push_root(&pos_ty); qoz_check_bind_pattern(tc, env, sub_pats.data[i], pos_ty); } i = i + 1; } }} } }
    }
    0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; 
    }
    0;  break; } } 0; 
...
qoz_Decl* qoz_check_infer_calls_decl(qoz_TyContext* tc, qoz_Decl* d) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_1 = d; qoz_Decl* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Decl_DFn: { qoz_Span sp = _qoz_ms_1->payload.DFn.f0; qoz_string name = _qoz_ms_1->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_1->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_1->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_1->payload.DFn.f4; qoz_Expr* body = _qoz_ms_1->payload.DFn.f5; qoz_string attr = _qoz_ms_1->payload.DFn.f6; qoz_Decl* _qoz_bv_167;
    {
        qoz_check_set_type_params(tc, tparams); qoz_Env env = qoz_check_env_make(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_check_env_define(&env, pp.name, qoz_check_resolve_type(tc, pp.ty)); } }qoz_Ty* ret_ty = qoz_check_resolve_type(tc, ret); qoz_gc_push_root(&ret_ty); qoz_Expr* new_body = qoz_check_infer_calls_expr(tc, &env, body, ret_ty); qoz_gc_push_root(&new_body); qoz_check_clear_type_params(tc); _qoz_bv_167 = qoz_make_Decl_DFn(sp, name, tparams, params, ret, new_body, attr);
    }
    _qoz_mv_1 = (_qoz_bv_167);  break; } case qoz_Decl_DConst: { qoz_Span sp = _qoz_ms_1->payload.DConst.f0; qoz_string name = _qoz_ms_1->payload.DConst.f1; qoz_TypeExpr* t = _qoz_ms_1->payload.DConst.f2; qoz_Expr* val = _qoz_ms_1->payload.DConst.f3; qoz_Decl* _qoz_bv_168;
    {
        qoz_Env env = qoz_check_env_make(); qoz_Ty* expected = qoz_check_resolve_type(tc, t); qoz_gc_push_root(&expected); qoz_Expr* new_val = qoz_check_infer_calls_expr(tc, &env, val, expected); qoz_gc_push_root(&new_val); _qoz_bv_168 = qoz_make_Decl_DConst(sp, name, t, new_val);
    }
    _qoz_mv_1 = (_qoz_bv_168);  break; } default: { _qoz_mv_1 = (d);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Expr* qoz_check_infer_calls_expr(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* e, qoz_Ty* expected) {
    ...
    qoz_Expr* _qoz_ms_1 = e; qoz_Expr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Expr_EInt: { _qoz_mv_1 = (e);  break; } case qoz_Expr_EFloat: { _qoz_mv_1 = (e);  break; } case qoz_Expr_EString: { _qoz_mv_1 = (e);  break; } case qoz_Expr_EChar: { _qoz_mv_1 = (e);  break; } case qoz_Expr_EBool: { _qoz_mv_1 = (e);  break; } case qoz_Expr_ENil: { _qoz_mv_1 = (e);  break; } case qoz_Expr_EIdent: { _qoz_mv_1 = (e);  break; } case qoz_Expr_EPath: { _qoz_mv_1 = (e);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_1->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_1->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_1->payload.EUnary.f2; _qoz_mv_1 = (qoz_make_Expr_EUnary(sp, op, qoz_check_infer_calls_expr(tc, env, rhs, qoz_ty_ty_error_())));  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_1->payload.EBinary.f0; qoz_BinaryOp* op = _qoz_ms_1->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_1->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_1->payload.EBinary.f3; _qoz_mv_1 = (qoz_make_Expr_EBinary(sp, op, qoz_check_infer_calls_expr(tc, env, l, qoz_ty_ty_error_()), qoz_check_infer_calls_expr(tc, env, r, qoz_ty_ty_error_())));  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_1->payload.EAssign.f0; qoz_AssignOp* op = _qoz_ms_1->payload.EAssign.f1; qoz_Expr* l = _qoz_ms_1->payload.EAssign.f2; qoz_Expr* r = _qoz_ms_1->payload.EAssign.f3; qoz_Expr* _qoz_bv_169;
    {
        qoz_Expr* new_l = qoz_check_infer_calls_expr(tc, env, l, qoz_ty_ty_error_()); qoz_gc_push_root(&new_l); qoz_Ty* lhs_ty = qoz_check_synth(tc, env, l); qoz_gc_push_root(&lhs_ty); _qoz_bv_169 = qoz_make_Expr_EAssign(sp, op, new_l, qoz_check_infer_calls_expr(tc, env, r, lhs_ty));
    }
    _qoz_mv_1 = (_qoz_bv_169);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_1->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_1->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_1->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_1->payload.ECall.f3; _qoz_mv_1 = (qoz_check_rewrite_call(tc, env, sp, callee, ta, args, expected));  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_1->payload.EField.f0; qoz_Expr* base = _qoz_ms_1->payload.EField.f1; qoz_string name = _qoz_ms_1->payload.EField.f2; _qoz_mv_1 = (qoz_make_Expr_EField(sp, qoz_check_infer_calls_expr(tc, env, base, qoz_ty_ty_error_()), name));  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_1->payload.EIndex.f0; qoz_Expr* base = _qoz_ms_1->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_1->payload.EIndex.f2; _qoz_mv_1 = (qoz_make_Expr_EIndex(sp, qoz_check_infer_calls_expr(tc, env, base, qoz_ty_ty_error_()), qoz_check_infer_calls_expr(tc, env, idx, qoz_ty_ty_error_())));  break; } case qoz_Expr_ECast: { qoz_Span sp = _qoz_ms_1->payload.ECast.f0; qoz_Expr* value = _qoz_ms_1->payload.ECast.f1; qoz_TypeExpr* t = _qoz_ms_1->payload.ECast.f2; _qoz_mv_1 = (qoz_make_Expr_ECast(sp, qoz_check_infer_calls_expr(tc, env, value, qoz_ty_ty_error_()), t));  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_1->payload.ETry.f0; qoz_Expr* v = _qoz_ms_1->payload.ETry.f1; _qoz_mv_1 = (qoz_make_Expr_ETry(sp, qoz_check_infer_calls_expr(tc, env, v, expected)));  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_1->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_1->payload.ETuple.f1; qoz_Expr* _qoz_bv_170;
    {
        qoz_Vec__qoz_Expr ne = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&ne, qoz_check_infer_calls_expr(tc, env, el, qoz_ty_ty_error_())); } }_qoz_bv_170 = qoz_make_Expr_ETuple(sp, ne);
    }
    _qoz_mv_1 = (_qoz_bv_170);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_1->payload.ERecord.f0; qoz_TypeExpr* te = _qoz_ms_1->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_1->payload.ERecord.f2; qoz_Expr* _qoz_bv_171;
    {
        qoz_TypeExpr* effective_te = qoz_check_pick_record_type(te, expected); qoz_gc_push_root(&effective_te); qoz_Vec__qoz_RecordFieldLit nf = qoz_vec_make__qoz_RecordFieldLit(); { qoz_Vec__qoz_RecordFieldLit __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; qoz_Ty* field_hint = qoz_check_record_field_hint(tc, effective_te, f.name); qoz_gc_push_root(&field_hint); qoz_vec_push__qoz_RecordFieldLit(&nf, ((qoz_RecordFieldLit){ .name = f.name, .value = qoz_check_infer_calls_expr(tc, env, f.value, field_hint) })); } }qoz_TypeExpr* inferred_te = qoz_check_inferred_record_te(tc, env, sp, effective_te, nf); qoz_gc_push_root(&inferred_te); _qoz_bv_171 = qoz_make_Expr_ERecord(sp, inferred_te, nf);
    }
    _qoz_mv_1 = (_qoz_bv_171);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_1->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_1->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_1->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_1->payload.EClosure.f3; _qoz_mv_1 = (qoz_make_Expr_EClosure(sp, cps, ret, qoz_check_infer_calls_expr(tc, env, body, qoz_ty_ty_error_())));  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_1->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_1->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_1->payload.EBlock.f2; qoz_Expr* _qoz_bv_172;
    {
        qoz_Vec__qoz_Stmt ns = qoz_vec_make__qoz_Stmt(); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_vec_push__qoz_Stmt(&ns, qoz_check_infer_calls_stmt(tc, env, s)); } }_qoz_bv_172 = qoz_make_Expr_EBlock(sp, ns, qoz_check_infer_calls_expr(tc, env, tail, expected));
    }
    _qoz_mv_1 = (_qoz_bv_172);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_1->payload.EIf.f0; qoz_Expr* c = _qoz_ms_1->payload.EIf.f1; qoz_Expr* t = _qoz_ms_1->payload.EIf.f2; qoz_Expr* f = _qoz_ms_1->payload.EIf.f3; _qoz_mv_1 = (qoz_make_Expr_EIf(sp, qoz_check_infer_calls_expr(tc, env, c, qoz_ty_ty_error_()), qoz_check_infer_calls_expr(tc, env, t, expected), qoz_check_infer_calls_expr(tc, env, f, expected)));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_1->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_1->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_1->payload.EMatch.f2; qoz_Expr* _qoz_bv_173;
    {
        qoz_Expr* new_scrut = qoz_check_infer_calls_expr(tc, env, scrut, qoz_ty_ty_error_()); qoz_gc_push_root(&new_scrut); qoz_Ty* scrut_ty = qoz_check_synth(tc, env, scrut); qoz_gc_push_root(&scrut_ty); qoz_Vec__qoz_MatchArm na = qoz_vec_make__qoz_MatchArm(); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm a = __col.data[__i]; (void)a; int64_t saved_len = (env->bindings.len); qoz_check_bind_pattern(tc, env, a.pat, scrut_ty); qoz_vec_push__qoz_MatchArm(&na, ((qoz_MatchArm){ .pat = a.pat, .body = qoz_check_infer_calls_expr(tc, env, a.body, expected), .has_guard = a.has_guard, .guard = a.guard })); qoz_check_env_truncate(env, saved_len); } }_qoz_bv_173 = qoz_make_Expr_EMatch(sp, new_scrut, na);
    }
    _qoz_mv_1 = (_qoz_bv_173);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_1->payload.EWhile.f0; qoz_Expr* c = _qoz_ms_1->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_1->payload.EWhile.f2; _qoz_mv_1 = (qoz_make_Expr_EWhile(sp, qoz_check_infer_calls_expr(tc, env, c, qoz_ty_ty_error_()), qoz_check_infer_calls_expr(tc, env, b, qoz_ty_ty_error_())));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_1->payload.EFor.f0; qoz_string b1 = _qoz_ms_1->payload.EFor.f1; qoz_string b2 = _qoz_ms_1->payload.EFor.f2; qoz_Expr* it = _qoz_ms_1->payload.EFor.f3; qoz_Expr* body = _qoz_ms_1->payload.EFor.f4; qoz_Expr* _qoz_bv_174;
    {
        qoz_Expr* new_it = qoz_check_infer_calls_expr(tc, env, it, qoz_ty_ty_error_()); qoz_gc_push_root(&new_it); qoz_Ty* it_ty = qoz_check_synth(tc, env, it); qoz_gc_push_root(&it_ty); int64_t saved_len = (env->bindings.len); qoz_check_bind_for_loop(env, b1, b2, it_ty); qoz_Expr* new_body = qoz_check_infer_calls_expr(tc, env, body, qoz_ty_ty_error_()); qoz_gc_push_root(&new_body); qoz_check_env_truncate(env, saved_len); _qoz_bv_174 = qoz_make_Expr_EFor(sp, b1, b2, new_it, new_body);
    }
    _qoz_mv_1 = (_qoz_bv_174);  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_1->payload.EReturn.f0; qoz_Expr* v = _qoz_ms_1->payload.EReturn.f1; _qoz_mv_1 = (qoz_make_Expr_EReturn(sp, qoz_check_infer_calls_expr(tc, env, v, expected)));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_1->payload.EDefer.f0; qoz_Expr* v = _qoz_ms_1->payload.EDefer.f1; _qoz_mv_1 = (qoz_make_Expr_EDefer(sp, qoz_check_infer_calls_expr(tc, env, v, qoz_ty_ty_error_())));  break; } case qoz_Expr_ESizeOf: { _qoz_mv_1 = (e);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_1->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_1->payload.EArrayLit.f1; qoz_Expr* _qoz_bv_175;
    {
        qoz_Vec__qoz_Expr ne = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&ne, qoz_check_infer_calls_expr(tc, env, el, qoz_ty_ty_error_())); } }_qoz_bv_175 = qoz_make_Expr_EArrayLit(sp, ne);
    }
    _qoz_mv_1 = (_qoz_bv_175);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_Stmt* qoz_check_infer_calls_stmt(qoz_TyContext* tc, qoz_Env* env, qoz_Stmt* s) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_1 = s; qoz_Stmt* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Stmt_SLet: { qoz_Span sp = _qoz_ms_1->payload.SLet.f0; qoz_string name = _qoz_ms_1->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_1->payload.SLet.f2; qoz_Expr* val = _qoz_ms_1->payload.SLet.f3; qoz_Stmt* _qoz_bv_176;
    {
        qoz_Ty* annotated = qoz_check_resolve_type(tc, te); qoz_gc_push_root(&annotated); qoz_Expr* new_val = qoz_check_infer_calls_expr(tc, env, val, annotated); qoz_gc_push_root(&new_val); qoz_Ty* binding_ty = ((qoz_check_is_ty_unit_or_error(annotated)) ? qoz_check_synth(tc, env, new_val) : annotated); qoz_gc_push_root(&binding_ty); qoz_check_env_define(env, name, binding_ty); _qoz_bv_176 = qoz_make_Stmt_SLet(sp, name, te, new_val);
    }
    _qoz_mv_1 = (_qoz_bv_176);  break; } case qoz_Stmt_SVar: { qoz_Span sp = _qoz_ms_1->payload.SVar.f0; qoz_string name = _qoz_ms_1->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_1->payload.SVar.f2; qoz_Expr* val = _qoz_ms_1->payload.SVar.f3; qoz_Stmt* _qoz_bv_177;
    {
        qoz_Ty* annotated = qoz_check_resolve_type(tc, te); qoz_gc_push_root(&annotated); qoz_Expr* new_val = qoz_check_infer_calls_expr(tc, env, val, annotated); qoz_gc_push_root(&new_val); qoz_Ty* binding_ty = ((qoz_check_is_ty_unit_or_error(annotated)) ? qoz_check_synth(tc, env, new_val) : annotated); qoz_gc_push_root(&binding_ty); qoz_check_env_define(env, name, binding_ty); _qoz_bv_177 = qoz_make_Stmt_SVar(sp, name, te, new_val);
    }
    _qoz_mv_1 = (_qoz_bv_177);  break; } case qoz_Stmt_SExpr: { qoz_Span sp = _qoz_ms_1->payload.SExpr.f0; qoz_Expr* x = _qoz_ms_1->payload.SExpr.f1; _qoz_mv_1 = (qoz_make_Stmt_SExpr(sp, qoz_check_infer_calls_expr(tc, env, x, qoz_ty_ty_error_())));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_check_pick_record_type(qoz_TypeExpr* te, qoz_Ty* expected) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&expected);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_178;
    {
        if ((args.len) > 0) { return te;} if ((path.len) != 1) { return te;} qoz_Ty* _qoz_ms_2 = expected; qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Ty_TyRecord: { qoz_string en = _qoz_ms_2->payload.TyRecord.f0; qoz_Vec__qoz_Ty eargs = _qoz_ms_2->payload.TyRecord.f1; qoz_TypeExpr* _qoz_bv_179;
    {
        if (qoz_strings_eq_raw(path.data[0], en) && ((eargs.len) > 0)) { qoz_Vec__qoz_TypeExpr ta = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = eargs; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_TypeExpr(&ta, qoz_ty_ty_to_type_expr_at(a, sp)); } }return qoz_make_TypeExpr_TENamed(sp, path, ta);} _qoz_bv_179 = te;
    }
    _qoz_mv_2 = (_qoz_bv_179);  break; } default: { _qoz_mv_2 = (te);  break; } } _qoz_bv_178 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_178);  break; } default: { _qoz_mv_1 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_check_check_fn_bodies(qoz_TyContext* tc, qoz_File f) {
    ...
    0;  break; } case qoz_Decl_DImport: { NULL;  break; } case qoz_Decl_DStruct: { NULL;  break; } case qoz_Decl_DEnum: { NULL;  break; } case qoz_Decl_DTypeAlias: { NULL;  break; } case qoz_Decl_DConst: { qoz_Expr* val = _qoz_ms_1->payload.DConst.f3; void* _qoz_bv_185;
    {
        qoz_Env env = qoz_check_env_make(); (void)(qoz_check_synth(tc, &env, val)); _qoz_bv_185 = NULL;
    }
    _qoz_bv_185;  break; } case qoz_Decl_DExternal: { NULL;  break; } case qoz_Decl_DLink: { NULL;  break; } } 0; } }
    return;
}
...
void qoz_check_validate_signatures(qoz_TyContext* tc, qoz_File f) {
    ...
    0;  break; } case qoz_Decl_DExternal: { qoz_Vec__qoz_FnParam params = _qoz_ms_1->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_1->payload.DExternal.f4; void* _qoz_bv_186;
    {
        { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; (void)(qoz_check_resolve_type(tc, pp.ty)); } }(void)(qoz_check_resolve_type(tc, ret)); _qoz_bv_186 = NULL;
    }
    _qoz_bv_186;  break; } case qoz_Decl_DStruct: { qoz_Vec__qoz_string tparams = _qoz_ms_1->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_1->payload.DStruct.f3; {
    ...
    0;  break; } case qoz_Decl_DConst: { qoz_TypeExpr* ty = _qoz_ms_1->payload.DConst.f2; void* _qoz_bv_187;
    {
        (void)(qoz_check_resolve_type(tc, ty)); _qoz_bv_187 = NULL;
    }
    _qoz_bv_187;  break; } case qoz_Decl_DImport: { NULL;  break; } case qoz_Decl_DLink: { NULL;  break; } } 0; } }
    return;
}
...
qoz_string qoz_emit_variant_callee_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    {
        if (!qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, enum_name)) { return QOZ_STR_LIT("");} qoz_Option__qoz_string* _qoz_ms_4 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, method); qoz_string _qoz_mv_4 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_4->tag) { case qoz_Option__qoz_string_Some: { _qoz_mv_4 = (method);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_4 = (QOZ_STR_LIT(""));  break; } } _qoz_bv_188 = _qoz_mv_4;
    }
    _qoz_mv_3 = (_qoz_bv_188);  break; } default: { _qoz_mv_3 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } case qoz_Expr_EPath: { qoz_Vec__qoz_string segs = _qoz_ms_1->payload.EPath.f1; qoz_string _qoz_bv_189;
    {
        if ((segs.len) != 2) { return QOZ_STR_LIT("");} if (!qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, segs.data[0])) { return QOZ_STR_LIT("");} qoz_Option__qoz_string* _qoz_ms_5 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, segs.data[1]); qoz_string _qoz_mv_5 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_5->tag) { case qoz_Option__qoz_string_Some: { _qoz_mv_5 = (segs.data[1]);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_5 = (QOZ_STR_LIT(""));  break; } } _qoz_bv_189 = _qoz_mv_5;
    }
...
qoz_string qoz_emit_generic_callee_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_Expr* _qoz_ms_1 = callee; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_1->payload.EIdent.f1; _qoz_mv_1 = (name);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_1->payload.EField.f1; qoz_string method = _qoz_ms_1->payload.EField.f2; qoz_Expr* _qoz_ms_2 = base; qoz_string _qoz_mv_2 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_2->tag) { case qoz_Expr_EIdent: { qoz_string pkg = _qoz_ms_2->payload.EIdent.f1; qoz_string _qoz_bv_190;
    {
        if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_strings_cat(qoz_strings_cat(pkg, QOZ_STR_LIT("_")), method);} if (qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, pkg)) { qoz_Option__qoz_string* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, method); switch (_qoz_ms_3->tag) { case qoz_Option__qoz_string_Some: { return method; break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } _qoz_bv_190 = QOZ_STR_LIT("");
    }
    _qoz_mv_2 = (_qoz_bv_190);  break; } default: { _qoz_mv_2 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Expr_EPath: { qoz_Vec__qoz_string segs = _qoz_ms_1->payload.EPath.f1; qoz_string _qoz_bv_191;
    {
        if ((segs.len) == 2) { qoz_string pkg = segs.data[0]; qoz_string method = segs.data[1]; if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_strings_cat(qoz_strings_cat(pkg, QOZ_STR_LIT("_")), method);} if (qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, pkg)) { qoz_Option__qoz_string* _qoz_ms_4 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, method); switch (_qoz_ms_4->tag) { case qoz_Option__qoz_string_Some: { return method; break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } } _qoz_bv_191 = QOZ_STR_LIT("");
    }
    _qoz_mv_1 = (_qoz_bv_191);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_emit_mangle_type(qoz_Emitter* e, qoz_TypeExpr* t) {
    ...
    {
        qoz_string acc = QOZ_STR_LIT("tuple"); { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; acc = qoz_strings_cat(acc, QOZ_STR_LIT("__")); acc = qoz_strings_cat(acc, qoz_emit_mangle_type(e, el)); } }_qoz_bv_192 = acc;
    }
    _qoz_mv_1 = (_qoz_bv_192);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; _qoz_mv_1 = (qoz_emit_mangle_named(e, path, args));  break; } case qoz_TypeExpr_TEFn: { _qoz_mv_1 = (QOZ_STR_LIT("fn"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_emit_substitute_type(qoz_Emitter* e, qoz_TypeExpr* t, qoz_Vec__qoz_string params, qoz_Vec__qoz_TypeExpr args) {
    ...
    {
        qoz_Vec__qoz_TypeExpr new_elems = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&new_elems, qoz_emit_substitute_type(e, el, params, args)); } }_qoz_bv_193 = qoz_make_TypeExpr_TETuple(span, new_elems);
    }
    _qoz_mv_1 = (_qoz_bv_193);  break; } case qoz_TypeExpr_TENamed: { qoz_Span span = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr t_args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_194;
    {
        if (((path.len) == 1) && ((t_args.len) == 0)) { qoz_string n = path.data[0]; int64_t i = 0; { qoz_Vec__qoz_string __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string p = __col.data[__i]; (void)p; if (qoz_strings_eq_raw(p, n)) { return args.data[i];} i = i + 1; } }} qoz_Vec__qoz_TypeExpr new_args = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = t_args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_TypeExpr(&new_args, qoz_emit_substitute_type(e, a, params, args)); } }_qoz_bv_194 = qoz_make_TypeExpr_TENamed(span, path, new_args);
    }
    _qoz_mv_1 = (_qoz_bv_194);  break; } case qoz_TypeExpr_TEFn: { qoz_Span span = _qoz_ms_1->payload.TEFn.f0; qoz_Vec__qoz_TypeExpr fparams = _qoz_ms_1->payload.TEFn.f1; qoz_TypeExpr* ret = _qoz_ms_1->payload.TEFn.f2; qoz_TypeExpr* _qoz_bv_195;
    {
        qoz_Vec__qoz_TypeExpr new_fparams = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* fp = __col.data[__i]; (void)fp; qoz_vec_push__qoz_TypeExpr(&new_fparams, qoz_emit_substitute_type(e, fp, params, args)); } }_qoz_bv_195 = qoz_make_TypeExpr_TEFn(span, new_fparams, qoz_emit_substitute_type(e, ret, params, args));
    }
    _qoz_mv_1 = (_qoz_bv_195);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_emit_operator_first_param_type_name(qoz_TypeExpr* te) {
    ...
    {
        if ((path.len) > 0) { return path.data[(path.len) - 1];} _qoz_bv_203 = QOZ_STR_LIT("");
    }
    _qoz_mv_2 = (_qoz_bv_203);  break; } default: { _qoz_mv_2 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_string _qoz_bv_204;
    {
        if ((path.len) > 0) { return path.data[(path.len) - 1];} _qoz_bv_204 = QOZ_STR_LIT("");
    }
...
qoz_string qoz_emit_result_mangle_for(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_string _qoz_bv_206;
    {
        if ((path.len) == 0) { return QOZ_STR_LIT("");} qoz_string last = path.data[(path.len) - 1]; if (!qoz_strings_eq_raw(last, QOZ_STR_LIT("Result"))) { return QOZ_STR_LIT("");} if ((args.len) != 2) { return QOZ_STR_LIT("");} _qoz_bv_206 = qoz_emit_mangle_inst(e, QOZ_STR_LIT("Result"), args);
    }
    _qoz_mv_1 = (_qoz_bv_206);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_try(qoz_Emitter* e, qoz_Span sp, qoz_Expr* value) {
    ...
    qoz_TypeExpr* inner_te = qoz_emit_infer_value_te(e, value); qoz_gc_push_root(&inner_te); qoz_TypeExpr* outer_te = e->current_ret_te; qoz_gc_push_root(&outer_te); qoz_string inner_mangle = qoz_emit_result_mangle_for(e, inner_te); qoz_string outer_mangle = qoz_emit_result_mangle_for(e, outer_te); if (qoz_strings_eq_raw(inner_mangle, QOZ_STR_LIT(""))) { qoz_emit_emit_die(sp, QOZ_STR_LIT("try operator: operand is not Result<T, E>")); return;} if (qoz_strings_eq_raw(outer_mangle, QOZ_STR_LIT(""))) { qoz_emit_emit_die(sp, QOZ_STR_LIT("try operator: enclosing function does not return Result<T, E>")); return;} e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_207;
    {
        qoz_Strbuf _qoz_sb_1032_40 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1032_40); qoz_strings_sb_append_i64(&_qoz_sb_1032_40, e->closure_counter); _qoz_bv_207 = qoz_strings_sb_finish(&_qoz_sb_1032_40);
    }
    qoz_string tmp = qoz_strings_cat(QOZ_STR_LIT("_qoz_try_"), _qoz_bv_207); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_208;
    {
        qoz_Strbuf _qoz_sb_1048_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1048_13); qoz_strings_sb_append(&_qoz_sb_1048_13, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_1048_13, inner_mangle); qoz_strings_sb_append(&_qoz_sb_1048_13, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_1048_13, tmp); qoz_strings_sb_append(&_qoz_sb_1048_13, QOZ_STR_LIT(" = ")); _qoz_bv_208 = qoz_strings_sb_finish(&_qoz_sb_1048_13);
    }
    qoz_emit_push(e, _qoz_bv_208); qoz_emit_emit_expr(e, value); qoz_string crr = e->current_return_restore; qoz_string _qoz_bv_209;
    {
        qoz_Strbuf _qoz_sb_1041_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1041_13); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("; if (")); qoz_strings_sb_append(&_qoz_sb_1041_13, tmp); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("->tag == qoz_")); qoz_strings_sb_append(&_qoz_sb_1041_13, inner_mangle); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("_Err) { ")); qoz_strings_sb_append(&_qoz_sb_1041_13, crr); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("return qoz_make_")); qoz_strings_sb_append(&_qoz_sb_1041_13, outer_mangle); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("_Err(")); qoz_strings_sb_append(&_qoz_sb_1041_13, tmp); qoz_strings_sb_append(&_qoz_sb_1041_13, QOZ_STR_LIT("->payload.Err.f0); } ")); _qoz_bv_209 = qoz_strings_sb_finish(&_qoz_sb_1041_13);
    }
    qoz_emit_push(e, _qoz_bv_209); qoz_emit_hoist_to_prologue(e, start); qoz_string _qoz_bv_210;
    {
        qoz_Strbuf _qoz_sb_1044_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1044_13); qoz_strings_sb_append(&_qoz_sb_1044_13, tmp); qoz_strings_sb_append(&_qoz_sb_1044_13, QOZ_STR_LIT("->payload.Ok.f0")); _qoz_bv_210 = qoz_strings_sb_finish(&_qoz_sb_1044_13);
    }
    qoz_emit_push(e, _qoz_bv_210); 
    return;
}
...
void qoz_emit_emit_tuple_lit(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_Expr elems) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_TypeExpr elem_tes = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&elem_tes, qoz_emit_infer_value_te(e, el)); } }qoz_string tname = qoz_emit_register_tuple_typedef(e, elem_tes); qoz_string _qoz_bv_211;
    {
        qoz_Strbuf _qoz_sb_1051_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1051_13); qoz_strings_sb_append(&_qoz_sb_1051_13, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_1051_13, tname); qoz_strings_sb_append(&_qoz_sb_1051_13, QOZ_STR_LIT("){ ")); _qoz_bv_211 = qoz_strings_sb_finish(&_qoz_sb_1051_13);
    }
    qoz_emit_push(e, _qoz_bv_211); int64_t i = 0; { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, el); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(" })")); 
    return;
}
...
void qoz_emit_emit_expr(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    {
        qoz_Strbuf _qoz_sb_1281_61 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1281_61); qoz_strings_sb_append(&_qoz_sb_1281_61, QOZ_STR_LIT("operator `")); qoz_strings_sb_append(&_qoz_sb_1281_61, op_text); qoz_strings_sb_append(&_qoz_sb_1281_61, QOZ_STR_LIT("` for `")); qoz_strings_sb_append(&_qoz_sb_1281_61, tname); qoz_strings_sb_append(&_qoz_sb_1281_61, QOZ_STR_LIT("` has no recorded return type")); _qoz_bv_230 = qoz_strings_sb_finish(&_qoz_sb_1281_61);
    }
    (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(rhs), _qoz_bv_230)); _qoz_bv_229 = qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(rhs));
    }
    _qoz_mv_4 = (_qoz_bv_229);  break; } } qoz_TypeExpr* ret_te = _qoz_mv_4; qoz_gc_push_root(&ret_te); qoz_string ret_ct = qoz_emit_c_type_for(e, ret_te); qoz_emit_ensure_unary_byval_dispatch_helper(e, fn_name, ct, ret_ct); qoz_string _qoz_bv_231;
    {
        qoz_Strbuf _qoz_sb_1287_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1287_29); qoz_strings_sb_append(&_qoz_sb_1287_29, QOZ_STR_LIT("_qoz_byval_")); qoz_strings_sb_append(&_qoz_sb_1287_29, fn_name); qoz_strings_sb_append(&_qoz_sb_1287_29, QOZ_STR_LIT("(")); _qoz_bv_231 = qoz_strings_sb_finish(&_qoz_sb_1287_29);
    }
    qoz_emit_push(e, _qoz_bv_231); qoz_emit_emit_expr(e, rhs); qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    ...
    0;  break; } default: { NULL;  break; } } 0; qoz_TypeExpr* tail_te = qoz_emit_infer_value_te(e, tail); qoz_gc_push_root(&tail_te); if (qoz_emit_is_unit_typeexpr(tail_te)) { int64_t start_u = qoz_strings_sb_len(&e->out); qoz_emit_push(e, QOZ_STR_LIT("{\n        ")); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_emit_stmt(e, s); } }qoz_StmtScope saved_tail = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved_tail); qoz_emit_push(e, QOZ_STR_LIT("\n    }\n    ")); qoz_emit_hoist_to_prologue(e, start_u); qoz_emit_push(e, QOZ_STR_LIT("0")); return;} e->closure_counter = e->closure_counter + 1; int64_t counter = e->closure_counter; qoz_string _qoz_bv_232;
    {
        qoz_Strbuf _qoz_sb_1363_47 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1363_47); qoz_strings_sb_append_i64(&_qoz_sb_1363_47, counter); _qoz_bv_232 = qoz_strings_sb_finish(&_qoz_sb_1363_47);
    }
    qoz_string tmp_res = qoz_strings_cat(QOZ_STR_LIT("_qoz_bv_"), _qoz_bv_232); qoz_string result_c = qoz_emit_c_type_for(e, tail_te); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_233;
    {
        qoz_Strbuf _qoz_sb_1366_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1366_17); qoz_strings_sb_append(&_qoz_sb_1366_17, result_c); qoz_strings_sb_append(&_qoz_sb_1366_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_1366_17, tmp_res); qoz_strings_sb_append(&_qoz_sb_1366_17, QOZ_STR_LIT(";\n    {\n        ")); _qoz_bv_233 = qoz_strings_sb_finish(&_qoz_sb_1366_17);
    }
    qoz_emit_push(e, _qoz_bv_233); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_emit_stmt(e, s); } }qoz_StmtScope saved_inner = qoz_emit_open_statement_scope(e); qoz_string _qoz_bv_234;
    {
        qoz_Strbuf _qoz_sb_1369_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1369_17); qoz_strings_sb_append(&_qoz_sb_1369_17, tmp_res); qoz_strings_sb_append(&_qoz_sb_1369_17, QOZ_STR_LIT(" = ")); _qoz_bv_234 = qoz_strings_sb_finish(&_qoz_sb_1369_17);
    }
    qoz_emit_push(e, _qoz_bv_234); qoz_emit_emit_expr(e, tail); qoz_emit_push(e, QOZ_STR_LIT(";\n    ")); qoz_emit_close_statement_scope(e, saved_inner); qoz_emit_push(e, QOZ_STR_LIT("}\n    ")); qoz_emit_hoist_to_prologue(e, start); qoz_emit_push(e, tmp_res); 
    }
    0;  break; } case qoz_Expr_EChar: { qoz_string text = _qoz_ms_1->payload.EChar.f1; qoz_emit_push(e, text);  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_1->payload.EPath.f0; void* _qoz_bv_235;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("path expression in value position; only Enum::Variant in call position is supported"))); _qoz_bv_235 = NULL;
    }
    _qoz_bv_235;  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_1->payload.EAssign.f0; qoz_AssignOp* op = _qoz_ms_1->payload.EAssign.f1; qoz_Expr* lhs = _qoz_ms_1->payload.EAssign.f2; qoz_Expr* rhs = _qoz_ms_1->payload.EAssign.f3; {
    ...
    0;  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_1->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_1->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_1->payload.ECall.f3; qoz_emit_emit_call(e, callee, ta, args);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_1->payload.EField.f1; qoz_string name = _qoz_ms_1->payload.EField.f2; qoz_emit_emit_field(e, base, name);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_1->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_1->payload.EIndex.f2; qoz_emit_emit_index(e, base, idx);  break; } case qoz_Expr_ECast: { qoz_Expr* value = _qoz_ms_1->payload.ECast.f1; qoz_TypeExpr* t = _qoz_ms_1->payload.ECast.f2; {
        qoz_string tc = qoz_emit_c_type_for(e, t); qoz_string _qoz_bv_236;
    {
        qoz_Strbuf _qoz_sb_1388_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1388_17); qoz_strings_sb_append(&_qoz_sb_1388_17, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_1388_17, tc); qoz_strings_sb_append(&_qoz_sb_1388_17, QOZ_STR_LIT(")")); _qoz_bv_236 = qoz_strings_sb_finish(&_qoz_sb_1388_17);
    }
    qoz_emit_push(e, _qoz_bv_236); qoz_emit_emit_expr(e, value); qoz_emit_push(e, QOZ_STR_LIT(")")); 
    }
    ...
    0;  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_1->payload.EWhile.f0; void* _qoz_bv_237;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("while expression in value position; wrap in a block or use a tail expression"))); _qoz_bv_237 = NULL;
    }
    _qoz_bv_237;  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_1->payload.EFor.f0; void* _qoz_bv_238;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("for expression in value position; wrap in a block or use a tail expression"))); _qoz_bv_238 = NULL;
    }
    _qoz_bv_238;  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_1->payload.EDefer.f0; void* _qoz_bv_239;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("defer cannot appear in value position; use defer as a statement"))); _qoz_bv_239 = NULL;
    }
    _qoz_bv_239;  break; } case qoz_Expr_ESizeOf: { qoz_TypeExpr* te = _qoz_ms_1->payload.ESizeOf.f1; {
        qoz_string tc = qoz_emit_c_type_for(e, te); qoz_string _qoz_bv_240;
    {
        qoz_Strbuf _qoz_sb_1421_77 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1421_77); qoz_strings_sb_append(&_qoz_sb_1421_77, QOZ_STR_LIT("(int64_t)sizeof(")); qoz_strings_sb_append(&_qoz_sb_1421_77, tc); qoz_strings_sb_append(&_qoz_sb_1421_77, QOZ_STR_LIT(")")); _qoz_bv_240 = qoz_strings_sb_finish(&_qoz_sb_1421_77);
    }
    qoz_emit_push(e, _qoz_bv_240); 
    }
...
qoz_string qoz_emit_infer_expr_ctype(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_1 = ex; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_Expr_EAssign: { _qoz_mv_1 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EReturn: { _qoz_mv_1 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EWhile: { _qoz_mv_1 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EFor: { _qoz_mv_1 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EDefer: { _qoz_mv_1 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_1->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_1->payload.EBlock.f2; qoz_string _qoz_bv_241;
    {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_ingest_stmt_locals(e, s); } }if (qoz_emit_is_nil_expr(tail)) { return QOZ_STR_LIT("void");} _qoz_bv_241 = qoz_emit_infer_expr_ctype(e, tail);
    }
    _qoz_mv_1 = (_qoz_bv_241);  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_1->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_1->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_1->payload.EMatch.f2; qoz_string _qoz_bv_242;
    {
        if ((arms.len) == 0) { qoz_emit_emit_die(sp, QOZ_STR_LIT("match expression with no arms")); } qoz_string bare_enum = qoz_emit_bare_enum_for_pat(e, arms.data[0].pat); qoz_string enum_name = ((qoz_strings_eq_raw(bare_enum, QOZ_STR_LIT(""))) ? bare_enum : qoz_emit_enum_lookup_name(e, scrut, bare_enum)); qoz_emit_bind_arm_locals(e, enum_name, arms.data[0].pat); _qoz_bv_242 = qoz_emit_infer_expr_ctype(e, arms.data[0].body);
    }
    _qoz_mv_1 = (_qoz_bv_242);  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_1->payload.EPath.f0; _qoz_mv_1 = (qoz_emit_emit_die(sp, QOZ_STR_LIT("EPath in value position is not supported")));  break; } default: { _qoz_mv_1 = (qoz_emit_c_type_for(e, qoz_emit_infer_value_te(e, ex)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_emit_bare_enum_for_pat(qoz_Emitter* e, qoz_Pattern* pat) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&pat);
    qoz_Pattern* _qoz_ms_1 = pat; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.PatVariant.f1; qoz_string _qoz_bv_243;
    {
        if ((path.len) == 0) { return QOZ_STR_LIT("");} qoz_Option__qoz_string* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, path.data[(path.len) - 1]); qoz_string _qoz_mv_2 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_2->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_2->payload.Some.f0; _qoz_mv_2 = (en);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_2 = (QOZ_STR_LIT(""));  break; } } _qoz_bv_243 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_243);  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_1->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_3 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_3->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_3->payload.Some.f0; _qoz_mv_3 = (en);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_3 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}

qoz_string qoz_emit_emit_die(qoz_Span sp, qoz_string msg) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_string _qoz_bv_244;
    {
        qoz_Strbuf _qoz_sb_1487_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1487_17); qoz_strings_sb_append(&_qoz_sb_1487_17, sp.file); qoz_strings_sb_append(&_qoz_sb_1487_17, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_1487_17, sp.line); qoz_strings_sb_append(&_qoz_sb_1487_17, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_1487_17, sp.col); qoz_strings_sb_append(&_qoz_sb_1487_17, QOZ_STR_LIT(": emit error: ")); qoz_strings_sb_append(&_qoz_sb_1487_17, msg); _qoz_bv_244 = qoz_strings_sb_finish(&_qoz_sb_1487_17);
    }
    qoz_fmt_println(_qoz_bv_244); qoz_os_exit(1); qoz_gc_shadow_set_top(_qoz_shadow_guard); return QOZ_STR_LIT("");
}

void qoz_emit_assert_plain_assign(qoz_AssignOp* op, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_AssignOp* _qoz_ms_1 = op; switch (_qoz_ms_1->tag) { case qoz_AssignOp_AOpSet: { NULL;  break; } default: { void* _qoz_bv_245;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("internal: compound assignment reached emit; parse should have desugared it"))); _qoz_bv_245 = NULL;
    }
    _qoz_bv_245;  break; } } 0; 
    return;
}
...
qoz_TypeExpr* qoz_emit_infer_base_typeexpr(qoz_Emitter* e, qoz_Expr* base) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_1 = base; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_1->payload.EIdent.f0; qoz_string ident = _qoz_ms_1->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, ident); qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_2->payload.Some.f0; _qoz_mv_2 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_Option__qoz_string* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, ident); qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_3->payload.Some.f0; qoz_TypeExpr* _qoz_bv_246;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&path, en); _qoz_bv_246 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_3 = (_qoz_bv_246);  break; } case qoz_Option__qoz_string_None: { qoz_TypeExpr* _qoz_bv_247;
    {
        qoz_string _qoz_bv_248;
    {
        qoz_Strbuf _qoz_sb_1516_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1516_38); qoz_strings_sb_append(&_qoz_sb_1516_38, QOZ_STR_LIT("identifier `")); qoz_strings_sb_append(&_qoz_sb_1516_38, ident); qoz_strings_sb_append(&_qoz_sb_1516_38, QOZ_STR_LIT("` has no known TypeExpr (not a local, parameter, or variant)")); _qoz_bv_248 = qoz_strings_sb_finish(&_qoz_sb_1516_38);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_248)); _qoz_bv_247 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_3 = (_qoz_bv_247);  break; } } _qoz_mv_2 = (_qoz_mv_3);  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_1->payload.EField.f0; qoz_Expr* b = _qoz_ms_1->payload.EField.f1; qoz_string n = _qoz_ms_1->payload.EField.f2; qoz_TypeExpr* _qoz_bv_249;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, b); qoz_gc_push_root(&bte); _qoz_bv_249 = qoz_emit_field_typeexpr_for(e, bte, n, sp);
    }
    _qoz_mv_1 = (_qoz_bv_249);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_1->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_1->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_1->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_4 = op; qoz_TypeExpr* _qoz_mv_4 = NULL; switch (_qoz_ms_4->tag) { case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_250;
    {
        qoz_TypeExpr* inner = qoz_emit_infer_base_typeexpr(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_5 = inner; qoz_TypeExpr* _qoz_mv_5 = NULL; switch (_qoz_ms_5->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_5->payload.TEPtr.f1; _qoz_mv_5 = (t);  break; } default: { qoz_TypeExpr* _qoz_bv_251;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("dereference of non-pointer base in EField/EIndex"))); _qoz_bv_251 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_5 = (_qoz_bv_251);  break; } } _qoz_bv_250 = _qoz_mv_5;
    }
    _qoz_mv_4 = (_qoz_bv_250);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_4 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_infer_base_typeexpr(e, rhs)));  break; } default: { qoz_TypeExpr* _qoz_bv_252;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("unary operator does not yield a base TypeExpr"))); _qoz_bv_252 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_4 = (_qoz_bv_252);  break; } } _qoz_mv_1 = (_qoz_mv_4);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_1->payload.ECall.f0; qoz_Expr* c = _qoz_ms_1->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_1->payload.ECall.f2; qoz_Vec__qoz_Expr va = _qoz_ms_1->payload.ECall.f3; _qoz_mv_1 = (qoz_emit_call_return_te(e, c, ta, va, sp));  break; } case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_1->payload.ECast.f2; _qoz_mv_1 = (t);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* t = _qoz_ms_1->payload.ERecord.f1; _qoz_mv_1 = (t);  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_1->payload.EIndex.f0; qoz_Expr* b = _qoz_ms_1->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_253;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, b); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_6 = bte; qoz_TypeExpr* _qoz_mv_6 = NULL; switch (_qoz_ms_6->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_6->payload.TEPtr.f1; _qoz_mv_6 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_6->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_6->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_254;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("indexing into non-Vec/non-pointer base"))); _qoz_bv_254 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_6 = (_qoz_bv_254);  break; } default: { qoz_TypeExpr* _qoz_bv_255;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("indexing into unrecognised base"))); _qoz_bv_255 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_6 = (_qoz_bv_255);  break; } } _qoz_bv_253 = _qoz_mv_6;
    }
    _qoz_mv_1 = (_qoz_bv_253);  break; } default: { qoz_TypeExpr* _qoz_bv_250;
    {
        (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(base), QOZ_STR_LIT("base expression has no resolvable TypeExpr"))); _qoz_bv_250 = qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(base));
    }
    _qoz_mv_1 = (_qoz_bv_250);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_emit_field_typeexpr_for(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    qoz_TypeExpr* _qoz_ms_1 = base_te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_1->payload.TEPtr.f1; _qoz_mv_1 = (inner);  break; } default: { _qoz_mv_1 = (base_te);  break; } } qoz_TypeExpr* unwrapped = _qoz_mv_1; qoz_gc_push_root(&unwrapped); qoz_TypeExpr* _qoz_ms_2 = unwrapped; qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_2->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_2->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_251;
    {
        if ((path.len) < 1) { qoz_string _qoz_bv_252;
    {
        qoz_Strbuf _qoz_sb_1597_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1597_34); qoz_strings_sb_append(&_qoz_sb_1597_34, QOZ_STR_LIT("field access `.")); qoz_strings_sb_append(&_qoz_sb_1597_34, field); qoz_strings_sb_append(&_qoz_sb_1597_34, QOZ_STR_LIT("` on TypeExpr with empty path")); _qoz_bv_252 = qoz_strings_sb_finish(&_qoz_sb_1597_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_252)); return qoz_make_TypeExpr_TEUnit(sp);} qoz_string lookup = qoz_emit_type_lookup_key(e, path); qoz_Option__qoz_Decl* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, lookup); qoz_Option__qoz_Decl* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_3->payload.Some.f0; _qoz_mv_3 = (qoz_make_Option__qoz_Decl_Some(d));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_3 = (qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, lookup));  break; } } qoz_Option__qoz_Decl* decl_opt = _qoz_mv_3; qoz_gc_push_root(&decl_opt); qoz_Option__qoz_Decl* _qoz_ms_4 = decl_opt; qoz_TypeExpr* _qoz_mv_4 = NULL; switch (_qoz_ms_4->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_4->payload.Some.f0; qoz_Decl* _qoz_ms_5 = decl; qoz_TypeExpr* _qoz_mv_5 = NULL; switch (_qoz_ms_5->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_5->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_5->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_253;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_strings_eq_raw(f.name, field)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }qoz_string _qoz_bv_264;
    {
        qoz_Strbuf _qoz_sb_1617_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1617_38); qoz_strings_sb_append(&_qoz_sb_1617_38, QOZ_STR_LIT("struct `")); qoz_strings_sb_append(&_qoz_sb_1617_38, lookup); qoz_strings_sb_append(&_qoz_sb_1617_38, QOZ_STR_LIT("` has no field `")); qoz_strings_sb_append(&_qoz_sb_1617_38, field); qoz_strings_sb_append(&_qoz_sb_1617_38, QOZ_STR_LIT("`")); _qoz_bv_264 = qoz_strings_sb_finish(&_qoz_sb_1617_38);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_264)); _qoz_bv_253 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_5 = (_qoz_bv_253);  break; } default: { qoz_TypeExpr* _qoz_bv_265;
    {
        qoz_string _qoz_bv_266;
    {
        qoz_Strbuf _qoz_sb_1611_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1611_38); qoz_strings_sb_append(&_qoz_sb_1611_38, QOZ_STR_LIT("decl `")); qoz_strings_sb_append(&_qoz_sb_1611_38, lookup); qoz_strings_sb_append(&_qoz_sb_1611_38, QOZ_STR_LIT("` is not a struct")); _qoz_bv_266 = qoz_strings_sb_finish(&_qoz_sb_1611_38);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_266)); _qoz_bv_265 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_5 = (_qoz_bv_265);  break; } } _qoz_mv_4 = (_qoz_mv_5);  break; } case qoz_Option__qoz_Decl_None: { qoz_TypeExpr* _qoz_bv_267;
    {
        qoz_string _qoz_bv_268;
    {
        qoz_Strbuf _qoz_sb_1627_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1627_34); qoz_strings_sb_append(&_qoz_sb_1627_34, QOZ_STR_LIT("unknown struct `")); qoz_strings_sb_append(&_qoz_sb_1627_34, lookup); qoz_strings_sb_append(&_qoz_sb_1627_34, QOZ_STR_LIT("` for field `.")); qoz_strings_sb_append(&_qoz_sb_1627_34, field); qoz_strings_sb_append(&_qoz_sb_1627_34, QOZ_STR_LIT("`")); _qoz_bv_268 = qoz_strings_sb_finish(&_qoz_sb_1627_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_268)); _qoz_bv_267 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_4 = (_qoz_bv_267);  break; } } _qoz_bv_251 = _qoz_mv_4;
    }
    _qoz_mv_2 = (_qoz_bv_251);  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_2->payload.TETuple.f1; qoz_TypeExpr* _qoz_bv_269;
    {
        int64_t idx = qoz_emit_tuple_field_index(field); if ((idx >= 0) && (idx < (elems.len))) { return elems.data[idx];} qoz_string _qoz_bv_260;
    {
        qoz_Strbuf _qoz_sb_1635_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1635_30); qoz_strings_sb_append(&_qoz_sb_1635_30, QOZ_STR_LIT("tuple has no field `.")); qoz_strings_sb_append(&_qoz_sb_1635_30, field); qoz_strings_sb_append(&_qoz_sb_1635_30, QOZ_STR_LIT("`")); _qoz_bv_260 = qoz_strings_sb_finish(&_qoz_sb_1635_30);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_260)); _qoz_bv_269 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_2 = (_qoz_bv_269);  break; } default: { qoz_TypeExpr* _qoz_bv_261;
    {
        qoz_string _qoz_bv_262;
    {
        qoz_Strbuf _qoz_sb_1639_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1639_30); qoz_strings_sb_append(&_qoz_sb_1639_30, QOZ_STR_LIT("field access `.")); qoz_strings_sb_append(&_qoz_sb_1639_30, field); qoz_strings_sb_append(&_qoz_sb_1639_30, QOZ_STR_LIT("` on a non-named base")); _qoz_bv_262 = qoz_strings_sb_finish(&_qoz_sb_1639_30);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_262)); _qoz_bv_261 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_2 = (_qoz_bv_261);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_2;
}
...
qoz_TypeExpr* qoz_emit_infer_value_te(qoz_Emitter* e, qoz_Expr* v) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&v);
    qoz_Expr* _qoz_ms_1 = v; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_1->payload.ECast.f2; _qoz_mv_1 = (t);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* t = _qoz_ms_1->payload.ERecord.f1; qoz_TypeExpr* _qoz_bv_263;
    {
        qoz_Option__qoz_TypeExpr* _qoz_ms_2 = qoz_map_get__int64_t__qoz_TypeExpr(&e->expr_types, qoz_emit_expr_id(v)); qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* cte = _qoz_ms_2->payload.Some.f0; _qoz_mv_2 = (cte);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_2 = (t);  break; } } qoz_TypeExpr* cached = _qoz_mv_2; qoz_gc_push_root(&cached); _qoz_bv_263 = qoz_emit_prefer_typed_record(e, t, cached);
    }
    _qoz_mv_1 = (_qoz_bv_263);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_1->payload.EField.f0; qoz_Expr* base = _qoz_ms_1->payload.EField.f1; qoz_string name = _qoz_ms_1->payload.EField.f2; _qoz_mv_1 = (qoz_emit_field_typeexpr_for(e, qoz_emit_infer_base_typeexpr(e, base), name, sp));  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_1->payload.EIndex.f0; qoz_Expr* base = _qoz_ms_1->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_274;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_3 = bte; qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_3->payload.TEPtr.f1; _qoz_mv_3 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_3->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_3->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_275;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("let-binding value indexed into non-Vec base; cannot determine binding type"))); _qoz_bv_275 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_3 = (_qoz_bv_275);  break; } default: { qoz_TypeExpr* _qoz_bv_276;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("let-binding value indexed into unrecognised base"))); _qoz_bv_276 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_3 = (_qoz_bv_276);  break; } } _qoz_bv_274 = _qoz_mv_3;
    }
    _qoz_mv_1 = (_qoz_bv_274);  break; } case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_1->payload.EIdent.f0; qoz_string name = _qoz_ms_1->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_4 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_4 = NULL; switch (_qoz_ms_4->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_4->payload.Some.f0; _qoz_mv_4 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_277;
    {
        qoz_string _qoz_bv_278;
    {
        qoz_Strbuf _qoz_sb_1742_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1742_34); qoz_strings_sb_append(&_qoz_sb_1742_34, QOZ_STR_LIT("let-binding value references unknown name `")); qoz_strings_sb_append(&_qoz_sb_1742_34, name); qoz_strings_sb_append(&_qoz_sb_1742_34, QOZ_STR_LIT("`")); _qoz_bv_278 = qoz_strings_sb_finish(&_qoz_sb_1742_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_278)); _qoz_bv_277 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_4 = (_qoz_bv_277);  break; } } _qoz_mv_1 = (_qoz_mv_4);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_1->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_1->payload.ECall.f1; qoz_Vec__qoz_TypeExpr type_args = _qoz_ms_1->payload.ECall.f2; qoz_Vec__qoz_Expr vargs = _qoz_ms_1->payload.ECall.f3; _qoz_mv_1 = (qoz_emit_call_return_te(e, callee, type_args, vargs, sp));  break; } case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_1->payload.EInt.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_1->payload.EFloat.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("f64")));  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_1->payload.EString.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_1->payload.EBool.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_1->payload.EChar.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Expr_ENil: { qoz_Span sp = _qoz_ms_1->payload.ENil.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_single_named_te(sp, QOZ_STR_LIT("void"))));  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_1->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_1->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_1->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_5 = op; qoz_TypeExpr* _qoz_mv_5 = NULL; switch (_qoz_ms_5->tag) { case qoz_UnaryOp_UOpAddr: { _qoz_mv_5 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_infer_value_te(e, rhs)));  break; } case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_279;
    {
        qoz_TypeExpr* inner = qoz_emit_infer_value_te(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_6 = inner; qoz_TypeExpr* _qoz_mv_6 = NULL; switch (_qoz_ms_6->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_6->payload.TEPtr.f1; _qoz_mv_6 = (t);  break; } default: { qoz_TypeExpr* _qoz_bv_270;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("let-binding dereferences a non-pointer"))); _qoz_bv_270 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_6 = (_qoz_bv_270);  break; } } _qoz_bv_279 = _qoz_mv_6;
    }
    _qoz_mv_5 = (_qoz_bv_279);  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_5 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_UnaryOp_UOpNeg: { _qoz_mv_5 = (qoz_emit_infer_value_te(e, rhs));  break; } } _qoz_mv_1 = (_qoz_mv_5);  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_1->payload.EBinary.f0; qoz_BinaryOp* op = _qoz_ms_1->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_1->payload.EBinary.f2; qoz_BinaryOp* _qoz_ms_7 = op; qoz_TypeExpr* _qoz_mv_7 = NULL; switch (_qoz_ms_7->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_7 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } default: { _qoz_mv_7 = (qoz_emit_infer_value_te(e, l));  break; } } _qoz_mv_1 = (_qoz_mv_7);  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_1->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_1->payload.EBlock.f2; qoz_TypeExpr* _qoz_bv_271;
    {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_ingest_stmt_locals(e, s); } }_qoz_bv_271 = qoz_emit_infer_value_te(e, tail);
    }
    _qoz_mv_1 = (_qoz_bv_271);  break; } case qoz_Expr_EIf: { qoz_Expr* t = _qoz_ms_1->payload.EIf.f2; _qoz_mv_1 = (qoz_emit_infer_value_te(e, t));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_1->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_1->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_1->payload.EMatch.f2; qoz_TypeExpr* _qoz_bv_272;
    {
        if ((arms.len) == 0) { (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("match expression with no arms"))); return qoz_make_TypeExpr_TEUnit(sp);} qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); qoz_string enum_name = ((qoz_strings_eq_raw(bare_enum, QOZ_STR_LIT(""))) ? bare_enum : qoz_emit_enum_lookup_name(e, scrut, bare_enum)); qoz_emit_bind_arm_locals(e, enum_name, arms.data[0].pat); _qoz_bv_272 = qoz_emit_infer_value_te(e, arms.data[0].body);
    }
    _qoz_mv_1 = (_qoz_bv_272);  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_1->payload.ESizeOf.f0; _qoz_mv_1 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_1->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_1->payload.ETuple.f1; qoz_TypeExpr* _qoz_bv_273;
    {
        qoz_Vec__qoz_TypeExpr ets = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ets, qoz_emit_infer_value_te(e, el)); } }_qoz_bv_273 = qoz_make_TypeExpr_TETuple(sp, ets);
    }
    _qoz_mv_1 = (_qoz_bv_273);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_1->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_1->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_1->payload.EClosure.f2; qoz_TypeExpr* _qoz_bv_284;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_TypeExpr(&pte, cp.ty); } }_qoz_bv_284 = qoz_make_TypeExpr_TEFn(sp, pte, ret);
    }
    _qoz_mv_1 = (_qoz_bv_284);  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_1->payload.ETry.f0; qoz_Expr* value = _qoz_ms_1->payload.ETry.f1; qoz_TypeExpr* _qoz_bv_285;
    {
        qoz_TypeExpr* inner = qoz_emit_infer_value_te(e, value); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_8 = inner; qoz_TypeExpr* _qoz_mv_8 = NULL; switch (_qoz_ms_8->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_8->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_8->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_286;
    {
        if ((args.len) == 2) { if ((path.len) > 0) { qoz_string last = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(last, QOZ_STR_LIT("Result"))) { return args.data[0];} } } _qoz_bv_286 = inner;
    }
    _qoz_mv_8 = (_qoz_bv_286);  break; } default: { _qoz_mv_8 = (inner);  break; } } _qoz_bv_285 = _qoz_mv_8;
    }
    _qoz_mv_1 = (_qoz_bv_285);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_1->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_1->payload.EArrayLit.f1; qoz_TypeExpr* _qoz_bv_287;
    {
        if ((elems.len) == 0) { (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("empty array literal: element type cannot be inferred"))); return qoz_make_TypeExpr_TEUnit(sp);} qoz_TypeExpr* elem_te = qoz_emit_infer_value_te(e, elems.data[0]); qoz_gc_push_root(&elem_te); qoz_Vec__qoz_TypeExpr args = qoz_vec_make__qoz_TypeExpr(); qoz_vec_push__qoz_TypeExpr(&args, elem_te); qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("Vec")); _qoz_bv_287 = qoz_make_TypeExpr_TENamed(sp, path, args);
    }
    _qoz_mv_1 = (_qoz_bv_287);  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_1->payload.EAssign.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_1->payload.EWhile.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_1->payload.EFor.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_1->payload.EReturn.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_1->payload.EDefer.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_1->payload.EPath.f0; qoz_TypeExpr* _qoz_bv_288;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("EPath in value position is not supported (expected pkg.fn or a record name)"))); _qoz_bv_288 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_1 = (_qoz_bv_288);  break; } default: { qoz_TypeExpr* _qoz_bv_289;
    {
        (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(v), QOZ_STR_LIT("let-binding value shape not handled by inference"))); _qoz_bv_289 = qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(v));
    }
    _qoz_mv_1 = (_qoz_bv_289);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_emit_call_return_te(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_Span sp) {
    ...
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; qoz_Option__qoz_Decl* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_fn_decls, name); qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_2->payload.Some.f0; qoz_Decl* _qoz_ms_3 = d; qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_3->payload.DFn.f2; qoz_TypeExpr* ret = _qoz_ms_3->payload.DFn.f4; qoz_TypeExpr* _qoz_bv_282;
    {
        if (((type_args.len) == (tparams.len)) && ((tparams.len) > 0)) { return qoz_emit_substitute_type(e, ret, tparams, type_args);} _qoz_bv_282 = ret;
    }
    _qoz_mv_3 = (_qoz_bv_282);  break; } default: { qoz_TypeExpr* _qoz_bv_283;
    {
        qoz_string _qoz_bv_294;
    {
        qoz_Strbuf _qoz_sb_2026_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2026_34); qoz_strings_sb_append(&_qoz_sb_2026_34, QOZ_STR_LIT("`")); qoz_strings_sb_append(&_qoz_sb_2026_34, name); qoz_strings_sb_append(&_qoz_sb_2026_34, QOZ_STR_LIT("` is in generic_fn_decls but not a DFn")); _qoz_bv_294 = qoz_strings_sb_finish(&_qoz_sb_2026_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_294)); _qoz_bv_283 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_3 = (_qoz_bv_283);  break; } } _qoz_mv_2 = (_qoz_mv_3);  break; } case qoz_Option__qoz_Decl_None: { qoz_Option__qoz_TypeExpr* _qoz_ms_4 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->fn_returns, name); qoz_TypeExpr* _qoz_mv_4 = NULL; switch (_qoz_ms_4->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_4->payload.Some.f0; _qoz_mv_4 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_295;
    {
        qoz_string _qoz_bv_296;
    {
        qoz_Strbuf _qoz_sb_2035_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2035_34); qoz_strings_sb_append(&_qoz_sb_2035_34, QOZ_STR_LIT("call to unknown function `")); qoz_strings_sb_append(&_qoz_sb_2035_34, name); qoz_strings_sb_append(&_qoz_sb_2035_34, QOZ_STR_LIT("` (no DFn, DExternal, or builtin matched)")); _qoz_bv_296 = qoz_strings_sb_finish(&_qoz_sb_2035_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_296)); _qoz_bv_295 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_4 = (_qoz_bv_295);  break; } } _qoz_mv_2 = (_qoz_mv_4);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_2;
}
...
void qoz_emit_emit_stmt_inner(qoz_Emitter* e, qoz_Stmt* s) {
    ...
    {
        qoz_Strbuf _qoz_sb_2108_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2108_17); qoz_strings_sb_append(&_qoz_sb_2108_17, ct); qoz_strings_sb_append(&_qoz_sb_2108_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_2108_17, name); qoz_strings_sb_append(&_qoz_sb_2108_17, QOZ_STR_LIT(" = ")); _qoz_bv_297 = qoz_strings_sb_finish(&_qoz_sb_2108_17);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_2112_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2112_21); qoz_strings_sb_append(&_qoz_sb_2112_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_2112_21, name); qoz_strings_sb_append(&_qoz_sb_2112_21, QOZ_STR_LIT("); ")); _qoz_bv_298 = qoz_strings_sb_finish(&_qoz_sb_2112_21);
    }
    ...
    0;  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_1->payload.SVar.f1; qoz_TypeExpr* ty = _qoz_ms_1->payload.SVar.f2; qoz_Expr* value = _qoz_ms_1->payload.SVar.f3; {
        qoz_TypeExpr* bind_te = qoz_emit_binding_te(e, ty, value); qoz_gc_push_root(&bind_te); if (qoz_strings_eq_raw(name, QOZ_STR_LIT("_"))) { qoz_emit_push(e, QOZ_STR_LIT("(void)(")); qoz_emit_emit_value_with_hint(e, value, bind_te); qoz_emit_push(e, QOZ_STR_LIT("); ")); return;} qoz_string ct = qoz_emit_infer_value_ctype(e, ty, value); qoz_string _qoz_bv_299;
    {
        qoz_Strbuf _qoz_sb_2125_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2125_17); qoz_strings_sb_append(&_qoz_sb_2125_17, ct); qoz_strings_sb_append(&_qoz_sb_2125_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_2125_17, name); qoz_strings_sb_append(&_qoz_sb_2125_17, QOZ_STR_LIT(" = ")); _qoz_bv_299 = qoz_strings_sb_finish(&_qoz_sb_2125_17);
    }
    qoz_emit_push(e, _qoz_bv_299); qoz_emit_emit_value_with_hint(e, value, bind_te); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (qoz_emit_c_type_is_pointer(ct)) { qoz_string _qoz_bv_290;
    {
        qoz_Strbuf _qoz_sb_2129_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2129_21); qoz_strings_sb_append(&_qoz_sb_2129_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_2129_21, name); qoz_strings_sb_append(&_qoz_sb_2129_21, QOZ_STR_LIT("); ")); _qoz_bv_290 = qoz_strings_sb_finish(&_qoz_sb_2129_21);
    }
    qoz_emit_push(e, _qoz_bv_290); } qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, bind_te); 
    }
...
qoz_string qoz_emit_qualified_call_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    {
        if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_strings_cat(qoz_strings_cat(pkg, QOZ_STR_LIT("_")), method);} _qoz_bv_291 = QOZ_STR_LIT("");
    }
    _qoz_mv_2 = (_qoz_bv_291);  break; } default: { _qoz_mv_2 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } default: { _qoz_mv_1 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_emit_arm_body_ctype(qoz_Emitter* e, qoz_string enum_name, qoz_Expr* body) {
    ...
    {
        if (qoz_emit_same_enum_base(e, en, enum_name)) { return qoz_strings_cat(qoz_strings_cat(QOZ_STR_LIT("qoz_"), enum_name), QOZ_STR_LIT("*"));} _qoz_bv_292 = qoz_strings_cat(qoz_strings_cat(QOZ_STR_LIT("qoz_"), en), QOZ_STR_LIT("*"));
    }
    _qoz_mv_2 = (_qoz_bv_292);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_2 = (qoz_emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_1->payload.ECall.f1; qoz_Expr* _qoz_ms_3 = callee; qoz_string _qoz_mv_3 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_3->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_3->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_4 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_4 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_4->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_4->payload.Some.f0; qoz_string _qoz_bv_293;
    {
        if (qoz_emit_same_enum_base(e, en, enum_name)) { return qoz_strings_cat(qoz_strings_cat(QOZ_STR_LIT("qoz_"), enum_name), QOZ_STR_LIT("*"));} _qoz_bv_293 = qoz_strings_cat(qoz_strings_cat(QOZ_STR_LIT("qoz_"), en), QOZ_STR_LIT("*"));
    }
    _qoz_mv_4 = (_qoz_bv_293);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_4 = (qoz_emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_3 = (_qoz_mv_4);  break; } default: { _qoz_mv_3 = (qoz_emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } default: { _qoz_mv_1 = (qoz_emit_infer_expr_ctype(e, body));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_field(qoz_Emitter* e, qoz_Expr* base, qoz_string name) {
    ...
    {
        qoz_Strbuf _qoz_sb_2395_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2395_25); qoz_strings_sb_append(&_qoz_sb_2395_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_2395_25, enum_name); qoz_strings_sb_append(&_qoz_sb_2395_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_2395_25, name); qoz_strings_sb_append(&_qoz_sb_2395_25, QOZ_STR_LIT("()")); _qoz_bv_304 = qoz_strings_sb_finish(&_qoz_sb_2395_25);
    }
    qoz_emit_push(e, _qoz_bv_304); return;
    }
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } 0;  break; } default: { NULL;  break; } } 0; qoz_string op = qoz_emit_field_access_op(e, base); qoz_emit_emit_expr(e, base); qoz_string _qoz_bv_305;
    {
        qoz_Strbuf _qoz_sb_2416_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2416_13); qoz_strings_sb_append(&_qoz_sb_2416_13, op); qoz_strings_sb_append(&_qoz_sb_2416_13, name); _qoz_bv_305 = qoz_strings_sb_finish(&_qoz_sb_2416_13);
    }
    qoz_emit_push(e, _qoz_bv_305); 
    return;
}
...
qoz_TypeExpr* qoz_emit_base_type_for_walk(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_1 = ex; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_1->payload.EIdent.f0; qoz_string name = _qoz_ms_1->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_2->payload.Some.f0; _qoz_mv_2 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_2 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_1->payload.EField.f0; qoz_Expr* b = _qoz_ms_1->payload.EField.f1; qoz_string name = _qoz_ms_1->payload.EField.f2; qoz_TypeExpr* _qoz_bv_306;
    {
        qoz_TypeExpr* bte = qoz_emit_base_type_for_walk(e, b); qoz_gc_push_root(&bte); _qoz_bv_306 = qoz_emit_field_typeexpr_for_no_die(e, bte, name, sp);
    }
    _qoz_mv_1 = (_qoz_bv_306);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_1->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_1->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_1->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_3 = op; qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_307;
    {
        qoz_TypeExpr* inner = qoz_emit_base_type_for_walk(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_4 = inner; qoz_TypeExpr* _qoz_mv_4 = NULL; switch (_qoz_ms_4->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_4->payload.TEPtr.f1; _qoz_mv_4 = (t);  break; } default: { _qoz_mv_4 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_307 = _qoz_mv_4;
    }
    _qoz_mv_3 = (_qoz_bv_307);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_3 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_base_type_for_walk(e, rhs)));  break; } default: { _qoz_mv_3 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(ex)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_emit_field_typeexpr_for_no_die(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base_te);
    qoz_TypeExpr* _qoz_ms_1 = base_te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_1->payload.TEPtr.f1; _qoz_mv_1 = (inner);  break; } default: { _qoz_mv_1 = (base_te);  break; } } qoz_TypeExpr* unwrapped = _qoz_mv_1; qoz_gc_push_root(&unwrapped); qoz_TypeExpr* _qoz_ms_2 = unwrapped; qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_2->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_2->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_308;
    {
        if ((path.len) < 1) { return qoz_make_TypeExpr_TEUnit(sp);} qoz_string lookup = qoz_emit_type_lookup_key(e, path); qoz_Option__qoz_Decl* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, lookup); qoz_Option__qoz_Decl* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_3->payload.Some.f0; _qoz_mv_3 = (qoz_make_Option__qoz_Decl_Some(d));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_3 = (qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, lookup));  break; } } qoz_Option__qoz_Decl* decl_opt = _qoz_mv_3; qoz_gc_push_root(&decl_opt); qoz_Option__qoz_Decl* _qoz_ms_4 = decl_opt; qoz_TypeExpr* _qoz_mv_4 = NULL; switch (_qoz_ms_4->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_4->payload.Some.f0; qoz_Decl* _qoz_ms_5 = decl; qoz_TypeExpr* _qoz_mv_5 = NULL; switch (_qoz_ms_5->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_5->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_5->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_309;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_strings_eq_raw(f.name, field)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }_qoz_bv_309 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_5 = (_qoz_bv_309);  break; } default: { _qoz_mv_5 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_4 = (_qoz_mv_5);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_4 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_308 = _qoz_mv_4;
    }
    _qoz_mv_2 = (_qoz_bv_308);  break; } default: { _qoz_mv_2 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_2;
}
...
void qoz_emit_emit_assign(qoz_Emitter* e, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    qoz_Expr* _qoz_ms_1 = lhs; switch (_qoz_ms_1->tag) { case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_1->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_1->payload.EIndex.f2; {
        qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_2 = te; switch (_qoz_ms_2->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_2->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_2->payload.TENamed.f2; if ((((path.len) >= 1) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) && ((args.len) == 2)) { qoz_emit_register_map_helper(e, QOZ_STR_LIT("map_set"), args); qoz_string k_m = qoz_emit_mangle_type(e, args.data[0]); qoz_string v_m = qoz_emit_mangle_type(e, args.data[1]); qoz_string _qoz_bv_300;
    {
        qoz_Strbuf _qoz_sb_2535_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2535_25); qoz_strings_sb_append(&_qoz_sb_2535_25, QOZ_STR_LIT("qoz_map_set__")); qoz_strings_sb_append(&_qoz_sb_2535_25, k_m); qoz_strings_sb_append(&_qoz_sb_2535_25, QOZ_STR_LIT("__")); qoz_strings_sb_append(&_qoz_sb_2535_25, v_m); qoz_strings_sb_append(&_qoz_sb_2535_25, QOZ_STR_LIT("(&")); _qoz_bv_300 = qoz_strings_sb_finish(&_qoz_sb_2535_25);
    }
    qoz_emit_push(e, _qoz_bv_300); qoz_emit_emit_expr(e, base); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, idx); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, rhs); qoz_emit_push(e, QOZ_STR_LIT(")")); return;} 0;  break; } default: { NULL;  break; } } 0; 
    }
...
qoz_TypeExpr* qoz_emit_lvalue_hint(qoz_Emitter* e, qoz_Expr* lhs) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&lhs);
    qoz_Span sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_Expr* _qoz_ms_1 = lhs; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_1->payload.EField.f1; qoz_string name = _qoz_ms_1->payload.EField.f2; qoz_TypeExpr* _qoz_bv_301;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); _qoz_bv_301 = qoz_emit_field_typeexpr_for_no_die(e, bte, name, sp);
    }
    _qoz_mv_1 = (_qoz_bv_301);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_1->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_302;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_2 = bte; qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_2->payload.TEPtr.f1; _qoz_mv_2 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_2->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_2->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_303;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_303 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_2 = (_qoz_bv_303);  break; } default: { _qoz_mv_2 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_302 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_302);  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_1->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_3 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_3->payload.Some.f0; _qoz_mv_3 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_3 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_index(qoz_Emitter* e, qoz_Expr* base, qoz_Expr* idx) {
    ...
    qoz_gc_push_root(&base);
    qoz_gc_push_root(&idx);
    qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_1 = te; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(n, QOZ_STR_LIT("Vec"))) { qoz_string op = qoz_emit_field_access_op(e, base); qoz_emit_emit_expr(e, base); qoz_string _qoz_bv_314;
    {
        qoz_Strbuf _qoz_sb_2539_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2539_25); qoz_strings_sb_append(&_qoz_sb_2539_25, op); qoz_strings_sb_append(&_qoz_sb_2539_25, QOZ_STR_LIT("data[")); _qoz_bv_314 = qoz_strings_sb_finish(&_qoz_sb_2539_25);
    }
    qoz_emit_push(e, _qoz_bv_314); qoz_emit_emit_expr(e, idx); qoz_emit_push(e, QOZ_STR_LIT("]")); return;} } 0;  break; } default: { NULL;  break; } } 0; qoz_emit_emit_expr(e, base); qoz_emit_push(e, QOZ_STR_LIT("[")); qoz_emit_emit_expr(e, idx); qoz_emit_push(e, QOZ_STR_LIT("]")); 
    return;
}
...
void qoz_emit_emit_hash_builtin(qoz_Emitter* e, qoz_Expr* arg) {
    ...
    qoz_string ct = qoz_emit_infer_expr_ctype(e, arg); if (qoz_strings_eq_raw(ct, QOZ_STR_LIT("qoz_string"))) { qoz_emit_push(e, QOZ_STR_LIT("qoz_string_hash(")); qoz_emit_emit_expr(e, arg); qoz_emit_push(e, QOZ_STR_LIT(")")); return;} qoz_string record_name = qoz_emit_record_struct_name_of_ctype(e, ct); if (!qoz_strings_eq_raw(record_name, QOZ_STR_LIT(""))) { qoz_string _qoz_bv_315;
    {
        qoz_Strbuf _qoz_sb_2663_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2663_17); qoz_strings_sb_append(&_qoz_sb_2663_17, QOZ_STR_LIT("qoz_hash_")); qoz_strings_sb_append(&_qoz_sb_2663_17, record_name); qoz_strings_sb_append(&_qoz_sb_2663_17, QOZ_STR_LIT("(")); _qoz_bv_315 = qoz_strings_sb_finish(&_qoz_sb_2663_17);
    }
    qoz_emit_push(e, _qoz_bv_315); qoz_emit_emit_expr(e, arg); qoz_emit_push(e, QOZ_STR_LIT(")")); return;} qoz_emit_push(e, QOZ_STR_LIT("(uint64_t)(")); qoz_emit_emit_expr(e, arg); qoz_emit_push(e, QOZ_STR_LIT(")")); 
    return;
}
...
void qoz_emit_emit_call(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_string qualified = qoz_emit_qualified_call_name(e, callee); if (!qoz_strings_eq_raw(qualified, QOZ_STR_LIT(""))) { if (((type_args.len) > 0) && qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, qualified)) { qoz_string mi = qoz_emit_mangle_inst(e, qualified, type_args); qoz_string _qoz_bv_316;
    {
        qoz_Strbuf _qoz_sb_2698_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2698_21); qoz_strings_sb_append(&_qoz_sb_2698_21, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_2698_21, mi); qoz_strings_sb_append(&_qoz_sb_2698_21, QOZ_STR_LIT("(")); _qoz_bv_316 = qoz_strings_sb_finish(&_qoz_sb_2698_21);
    }
    qoz_emit_push(e, _qoz_bv_316); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;} qoz_Option__qoz_string* _qoz_ms_1 = qoz_map_get__qoz_string__qoz_string(&e->externs, qualified); qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_Option__qoz_string_Some: { qoz_string sym = _qoz_ms_1->payload.Some.f0; _qoz_mv_1 = (sym);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_1 = (qoz_emit_user_fn_c_name(qualified));  break; } } qoz_string dispatch_name = _qoz_mv_1; qoz_string _qoz_bv_317;
    {
        qoz_Strbuf _qoz_sb_2612_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2612_17); qoz_strings_sb_append(&_qoz_sb_2612_17, dispatch_name); qoz_strings_sb_append(&_qoz_sb_2612_17, QOZ_STR_LIT("(")); _qoz_bv_317 = qoz_strings_sb_finish(&_qoz_sb_2612_17);
    }
    qoz_emit_push(e, _qoz_bv_317); qoz_Vec__qoz_TypeExpr hints = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Vec__qoz_TypeExpr* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, qualified); switch (_qoz_ms_2->tag) { case qoz_Option__qoz_Vec__qoz_TypeExpr_Some: { qoz_Vec__qoz_TypeExpr pts = _qoz_ms_2->payload.Some.f0; hints = pts;  break; } case qoz_Option__qoz_Vec__qoz_TypeExpr_None: { NULL;  break; } } 0; int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } if (i < (hints.len)) { qoz_emit_emit_value_with_hint(e, a, hints.data[i]); }  else { qoz_emit_emit_expr(e, a); } i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;} qoz_Expr* _qoz_ms_3 = callee; switch (_qoz_ms_3->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_3->payload.EIdent.f1; {
    ...
    {
        qoz_Strbuf _qoz_sb_2756_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2756_21); qoz_strings_sb_append(&_qoz_sb_2756_21, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_2756_21, enum_name); qoz_strings_sb_append(&_qoz_sb_2756_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_2756_21, variant_name); qoz_strings_sb_append(&_qoz_sb_2756_21, QOZ_STR_LIT("(")); _qoz_bv_318 = qoz_strings_sb_finish(&_qoz_sb_2756_21);
    }
    qoz_emit_push(e, _qoz_bv_318); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } if ((type_args.len) > 0) { qoz_Expr* _qoz_ms_5 = callee; switch (_qoz_ms_5->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_5->payload.EIdent.f1; if (qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, name)) { qoz_string mi = qoz_emit_mangle_inst(e, name, type_args); qoz_string _qoz_bv_319;
    {
        qoz_Strbuf _qoz_sb_2775_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2775_25); qoz_strings_sb_append(&_qoz_sb_2775_25, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_2775_25, mi); qoz_strings_sb_append(&_qoz_sb_2775_25, QOZ_STR_LIT("(")); _qoz_bv_319 = qoz_strings_sb_finish(&_qoz_sb_2775_25);
    }
    qoz_emit_push(e, _qoz_bv_319); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;} 0;  break; } default: { NULL;  break; } } 0; } qoz_Expr* _qoz_ms_6 = callee; switch (_qoz_ms_6->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_6->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_7 = qoz_map_get__qoz_string__qoz_string(&e->externs, name); switch (_qoz_ms_7->tag) { case qoz_Option__qoz_string_Some: { qoz_string sym = _qoz_ms_7->payload.Some.f0; {
        qoz_string _qoz_bv_310;
    {
        qoz_Strbuf _qoz_sb_2797_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2797_21); qoz_strings_sb_append(&_qoz_sb_2797_21, sym); qoz_strings_sb_append(&_qoz_sb_2797_21, QOZ_STR_LIT("(")); _qoz_bv_310 = qoz_strings_sb_finish(&_qoz_sb_2797_21);
    }
    qoz_emit_push(e, _qoz_bv_310); qoz_Vec__qoz_TypeExpr hints = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Vec__qoz_TypeExpr* _qoz_ms_8 = qoz_map_get__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, name); switch (_qoz_ms_8->tag) { case qoz_Option__qoz_Vec__qoz_TypeExpr_Some: { qoz_Vec__qoz_TypeExpr pts = _qoz_ms_8->payload.Some.f0; hints = pts;  break; } case qoz_Option__qoz_Vec__qoz_TypeExpr_None: { NULL;  break; } } 0; int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } if (i < (hints.len)) { qoz_emit_emit_value_with_hint(e, a, hints.data[i]); }  else { qoz_emit_emit_expr(e, a); } i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
...
qoz_TypeExpr* qoz_emit_callee_value_typeexpr(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_1 = callee; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_1->payload.EIdent.f0; qoz_string name = _qoz_ms_1->payload.EIdent.f1; qoz_TypeExpr* _qoz_bv_311;
    {
        qoz_Option__qoz_TypeExpr* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); switch (_qoz_ms_2->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_2->payload.Some.f0; return te;  break; } default: { NULL;  break; } } 0; _qoz_bv_311 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_1 = (_qoz_bv_311);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(callee)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_binary(qoz_Emitter* e, qoz_BinaryOp* op, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    {
        qoz_Strbuf _qoz_sb_3043_57 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3043_57); qoz_strings_sb_append(&_qoz_sb_3043_57, QOZ_STR_LIT("operator `")); qoz_strings_sb_append(&_qoz_sb_3043_57, op_text); qoz_strings_sb_append(&_qoz_sb_3043_57, QOZ_STR_LIT("` for `")); qoz_strings_sb_append(&_qoz_sb_3043_57, tname); qoz_strings_sb_append(&_qoz_sb_3043_57, QOZ_STR_LIT("` has no recorded return type")); _qoz_bv_313 = qoz_strings_sb_finish(&_qoz_sb_3043_57);
    }
    (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(lhs), _qoz_bv_313)); _qoz_bv_312 = qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(lhs));
    }
    _qoz_mv_3 = (_qoz_bv_312);  break; } } qoz_TypeExpr* ret_te = _qoz_mv_3; qoz_gc_push_root(&ret_te); qoz_string ret_ct = qoz_emit_c_type_for(e, ret_te); qoz_emit_ensure_byval_dispatch_helper(e, fn_name, ct, ret_ct); qoz_string _qoz_bv_324;
    {
        qoz_Strbuf _qoz_sb_3053_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3053_25); qoz_strings_sb_append(&_qoz_sb_3053_25, QOZ_STR_LIT("_qoz_byval_")); qoz_strings_sb_append(&_qoz_sb_3053_25, fn_name); qoz_strings_sb_append(&_qoz_sb_3053_25, QOZ_STR_LIT("(")); _qoz_bv_324 = qoz_strings_sb_finish(&_qoz_sb_3053_25);
    }
    ...
    0;  break; } default: { NULL;  break; } } 0; } } qoz_string record_name = qoz_emit_record_struct_name_of_ctype(e, lct); if (!qoz_strings_eq_raw(record_name, QOZ_STR_LIT(""))) { qoz_BinaryOp* _qoz_ms_4 = op; switch (_qoz_ms_4->tag) { case qoz_BinaryOp_BOpEq: { {
        qoz_string _qoz_bv_325;
    {
        qoz_Strbuf _qoz_sb_3076_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3076_21); qoz_strings_sb_append(&_qoz_sb_3076_21, QOZ_STR_LIT("qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_3076_21, record_name); qoz_strings_sb_append(&_qoz_sb_3076_21, QOZ_STR_LIT("(")); _qoz_bv_325 = qoz_strings_sb_finish(&_qoz_sb_3076_21);
    }
    qoz_emit_push(e, _qoz_bv_325); qoz_emit_emit_expr(e, lhs); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, rhs); qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_BinaryOp_BOpNe: { {
        qoz_string _qoz_bv_326;
    {
        qoz_Strbuf _qoz_sb_3084_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3084_21); qoz_strings_sb_append(&_qoz_sb_3084_21, QOZ_STR_LIT("!qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_3084_21, record_name); qoz_strings_sb_append(&_qoz_sb_3084_21, QOZ_STR_LIT("(")); _qoz_bv_326 = qoz_strings_sb_finish(&_qoz_sb_3084_21);
    }
    qoz_emit_push(e, _qoz_bv_326); qoz_emit_emit_expr(e, lhs); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, rhs); qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; } qoz_BinaryOp* _qoz_ms_5 = op; switch (_qoz_ms_5->tag) { case qoz_BinaryOp_BOpRange: { void* _qoz_bv_327;
    {
        (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(lhs), QOZ_STR_LIT("range expression is only valid in for-loop iter position"))); _qoz_bv_327 = NULL;
    }
    _qoz_bv_327;  break; } case qoz_BinaryOp_BOpRangeInclusive: { void* _qoz_bv_328;
    {
        (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(lhs), QOZ_STR_LIT("range expression is only valid in for-loop iter position"))); _qoz_bv_328 = NULL;
    }
    _qoz_bv_328;  break; } default: { NULL;  break; } } 0; int64_t p = qoz_emit_binary_prec(op); bool needs_paren_child = qoz_emit_is_logical_op(op); qoz_emit_emit_binary_child(e, lhs, p, needs_paren_child); qoz_string bop = qoz_emit_binary_c_op(op); qoz_string _qoz_bv_329;
    {
        qoz_Strbuf _qoz_sb_3004_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3004_13); qoz_strings_sb_append(&_qoz_sb_3004_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3004_13, bop); qoz_strings_sb_append(&_qoz_sb_3004_13, QOZ_STR_LIT(" ")); _qoz_bv_329 = qoz_strings_sb_finish(&_qoz_sb_3004_13);
    }
    qoz_emit_push(e, _qoz_bv_329); qoz_emit_emit_binary_child(e, rhs, p + 1, needs_paren_child); 
    return;
}
...
void qoz_emit_emit_fn_body_block(qoz_Emitter* e, qoz_Expr* body, qoz_TypeExpr* ret_hint) {
    ...
    0;  break; } default: { NULL;  break; } } 0; if ((defers.len) == 0) { qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_push(e, e->current_return_restore); qoz_emit_push(e, QOZ_STR_LIT("return ")); qoz_emit_emit_value_with_hint(e, effective_tail, ret_hint); qoz_emit_push(e, QOZ_STR_LIT(";\n")); qoz_emit_close_statement_scope(e, saved); }  else { e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_320;
    {
        qoz_Strbuf _qoz_sb_3260_48 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3260_48); qoz_strings_sb_append_i64(&_qoz_sb_3260_48, e->closure_counter); _qoz_bv_320 = qoz_strings_sb_finish(&_qoz_sb_3260_48);
    }
    qoz_string tmp = qoz_strings_cat(QOZ_STR_LIT("_qoz_ret_"), _qoz_bv_320); qoz_string rt = qoz_emit_c_type_for(e, ret_hint); qoz_string _qoz_bv_321;
    {
        qoz_Strbuf _qoz_sb_3262_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3262_21); qoz_strings_sb_append(&_qoz_sb_3262_21, rt); qoz_strings_sb_append(&_qoz_sb_3262_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3262_21, tmp); qoz_strings_sb_append(&_qoz_sb_3262_21, QOZ_STR_LIT(" = ")); _qoz_bv_321 = qoz_strings_sb_finish(&_qoz_sb_3262_21);
    }
    qoz_emit_push(e, _qoz_bv_321); qoz_emit_emit_value_with_hint(e, effective_tail, ret_hint); qoz_emit_push(e, QOZ_STR_LIT(";\n    ")); qoz_emit_emit_defers_reverse(e, defers); qoz_string _qoz_bv_322;
    {
        qoz_Strbuf _qoz_sb_3266_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3266_21); qoz_strings_sb_append(&_qoz_sb_3266_21, QOZ_STR_LIT("\n    return ")); qoz_strings_sb_append(&_qoz_sb_3266_21, tmp); qoz_strings_sb_append(&_qoz_sb_3266_21, QOZ_STR_LIT(";\n")); _qoz_bv_322 = qoz_strings_sb_finish(&_qoz_sb_3266_21);
    }
    qoz_emit_push(e, _qoz_bv_322); } 
    }
    0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
bool qoz_emit_is_unit_typeexpr(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_1 = (true);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; bool _qoz_bv_323;
    {
        if ((path.len) != 1) { return false;} qoz_string n = path.data[0]; _qoz_bv_323 = qoz_strings_eq_raw(n, QOZ_STR_LIT("unit")) || qoz_strings_eq_raw(n, QOZ_STR_LIT("void"));
    }
    _qoz_mv_1 = (_qoz_bv_323);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_fn(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&ret);
    qoz_gc_push_root(&body);
    qoz_string ret_c = qoz_emit_c_type_for(e, ret); qoz_string c_name = qoz_emit_user_fn_c_name(name); qoz_string _qoz_bv_334;
    {
        qoz_Strbuf _qoz_sb_3297_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3297_13); qoz_strings_sb_append(&_qoz_sb_3297_13, ret_c); qoz_strings_sb_append(&_qoz_sb_3297_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3297_13, c_name); _qoz_bv_334 = qoz_strings_sb_finish(&_qoz_sb_3297_13);
    }
    qoz_emit_push(e, _qoz_bv_334); if ((params.len) == 0) { qoz_emit_push(e, QOZ_STR_LIT("(void)")); }  else { qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = qoz_emit_c_type_for(e, p.ty); qoz_string pn = p.name; qoz_string _qoz_bv_335;
    {
        qoz_Strbuf _qoz_sb_3207_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3207_21); qoz_strings_sb_append(&_qoz_sb_3207_21, pc); qoz_strings_sb_append(&_qoz_sb_3207_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3207_21, pn); _qoz_bv_335 = qoz_strings_sb_finish(&_qoz_sb_3207_21);
    }
    qoz_emit_push(e, _qoz_bv_335); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); } qoz_emit_push(e, QOZ_STR_LIT(" {\n    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();\n    ")); qoz_string saved_ret = e->current_return_restore; e->current_return_restore = QOZ_STR_LIT("qoz_gc_shadow_set_top(_qoz_shadow_guard); "); int64_t saved_match_counter = e->match_counter; e->match_counter = 0; e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, p.name, p.ty); if (qoz_emit_c_type_is_pointer(qoz_emit_c_type_for(e, p.ty))) { qoz_string pn = p.name; qoz_string _qoz_bv_336;
    {
        qoz_Strbuf _qoz_sb_3226_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3226_21); qoz_strings_sb_append(&_qoz_sb_3226_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_3226_21, pn); qoz_strings_sb_append(&_qoz_sb_3226_21, QOZ_STR_LIT(");\n    ")); _qoz_bv_336 = qoz_strings_sb_finish(&_qoz_sb_3226_21);
    }
    qoz_emit_push(e, _qoz_bv_336); } } }e->current_ret_te = ret; bool is_b = qoz_emit_is_block(body); if (is_b) { qoz_emit_emit_fn_body_block(e, body, ret); }  else { qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_string crr = e->current_return_restore; if (qoz_emit_is_unit_typeexpr(ret)) { qoz_emit_emit_expr(e, body); qoz_string _qoz_bv_337;
    {
        qoz_Strbuf _qoz_sb_3348_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3348_21); qoz_strings_sb_append(&_qoz_sb_3348_21, QOZ_STR_LIT(";\n    ")); qoz_strings_sb_append(&_qoz_sb_3348_21, crr); qoz_strings_sb_append(&_qoz_sb_3348_21, QOZ_STR_LIT("return;\n")); _qoz_bv_337 = qoz_strings_sb_finish(&_qoz_sb_3348_21);
    }
    qoz_emit_push(e, _qoz_bv_337); }  else { qoz_string _qoz_bv_338;
    {
        qoz_Strbuf _qoz_sb_3340_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3340_21); qoz_strings_sb_append(&_qoz_sb_3340_21, crr); qoz_strings_sb_append(&_qoz_sb_3340_21, QOZ_STR_LIT("return ")); _qoz_bv_338 = qoz_strings_sb_finish(&_qoz_sb_3340_21);
    }
    qoz_emit_push(e, _qoz_bv_338); qoz_emit_emit_value_with_hint(e, body, ret); qoz_emit_push(e, QOZ_STR_LIT(";\n")); } qoz_emit_close_statement_scope(e, saved); } e->current_return_restore = saved_ret; e->match_counter = saved_match_counter; e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); qoz_emit_push(e, QOZ_STR_LIT("}\n\n")); 
    return;
}
...
qoz_Option__qoz_string* qoz_emit_value_field_dep(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_Option__qoz_string* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_Option__qoz_string* _qoz_bv_339;
    {
        if ((path.len) < 1) { return qoz_make_Option__qoz_string_None();} qoz_string n = path.data[(path.len) - 1]; if (!qoz_strings_eq_raw(qoz_emit_primitive_c_name(n), QOZ_STR_LIT(""))) { return qoz_make_Option__qoz_string_None();} if (qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { return qoz_make_Option__qoz_string_None();} if ((args.len) > 0) { return qoz_make_Option__qoz_string_Some(qoz_emit_mangle_inst(e, n, args));} _qoz_bv_339 = qoz_make_Option__qoz_string_Some(n);
    }
    _qoz_mv_1 = (_qoz_bv_339);  break; } default: { _qoz_mv_1 = (qoz_make_Option__qoz_string_None());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_variant_ctor(qoz_Emitter* e, qoz_string enum_name, qoz_VariantDecl v) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string vn = v.name; qoz_string _qoz_bv_346;
    {
        qoz_Strbuf _qoz_sb_3603_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3603_13); qoz_strings_sb_append(&_qoz_sb_3603_13, QOZ_STR_LIT("static qoz_")); qoz_strings_sb_append(&_qoz_sb_3603_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3603_13, QOZ_STR_LIT(" *qoz_make_")); qoz_strings_sb_append(&_qoz_sb_3603_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3603_13, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3603_13, vn); _qoz_bv_346 = qoz_strings_sb_finish(&_qoz_sb_3603_13);
    }
    qoz_emit_push(e, _qoz_bv_346); if (!qoz_emit_variant_has_positional(v)) { qoz_emit_push(e, QOZ_STR_LIT("(void) {\n")); }  else { qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t k = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pt = __col.data[__i]; (void)pt; if (k > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = qoz_emit_c_type_for(e, pt); qoz_string ks = qoz_emit_int_to_string(k); qoz_string _qoz_bv_347;
    {
        qoz_Strbuf _qoz_sb_3613_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3613_21); qoz_strings_sb_append(&_qoz_sb_3613_21, pc); qoz_strings_sb_append(&_qoz_sb_3613_21, QOZ_STR_LIT(" f")); qoz_strings_sb_append(&_qoz_sb_3613_21, ks); _qoz_bv_347 = qoz_strings_sb_finish(&_qoz_sb_3613_21);
    }
    qoz_emit_push(e, _qoz_bv_347); k = k + 1; } }qoz_emit_push(e, QOZ_STR_LIT(") {\n")); } qoz_string _qoz_bv_348;
    {
        qoz_Strbuf _qoz_sb_3628_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3628_13); qoz_strings_sb_append(&_qoz_sb_3628_13, QOZ_STR_LIT("    qoz_")); qoz_strings_sb_append(&_qoz_sb_3628_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3628_13, QOZ_STR_LIT(" *p = qoz_gc_alloc(sizeof(qoz_")); qoz_strings_sb_append(&_qoz_sb_3628_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3628_13, QOZ_STR_LIT("), &qoz_")); qoz_strings_sb_append(&_qoz_sb_3628_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3628_13, QOZ_STR_LIT("_desc);\n")); _qoz_bv_348 = qoz_strings_sb_finish(&_qoz_sb_3628_13);
    }
    qoz_emit_push(e, _qoz_bv_348); qoz_string _qoz_bv_349;
    {
        qoz_Strbuf _qoz_sb_3629_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3629_13); qoz_strings_sb_append(&_qoz_sb_3629_13, QOZ_STR_LIT("    p->tag = qoz_")); qoz_strings_sb_append(&_qoz_sb_3629_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3629_13, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3629_13, vn); qoz_strings_sb_append(&_qoz_sb_3629_13, QOZ_STR_LIT(";\n")); _qoz_bv_349 = qoz_strings_sb_finish(&_qoz_sb_3629_13);
    }
    qoz_emit_push(e, _qoz_bv_349); if (qoz_emit_variant_has_positional(v)) { int64_t j = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* _ = __col.data[__i]; (void)_; qoz_string js = qoz_emit_int_to_string(j); qoz_string _qoz_bv_340;
    {
        qoz_Strbuf _qoz_sb_3624_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3624_21); qoz_strings_sb_append(&_qoz_sb_3624_21, QOZ_STR_LIT("    p->payload.")); qoz_strings_sb_append(&_qoz_sb_3624_21, vn); qoz_strings_sb_append(&_qoz_sb_3624_21, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_3624_21, js); qoz_strings_sb_append(&_qoz_sb_3624_21, QOZ_STR_LIT(" = f")); qoz_strings_sb_append(&_qoz_sb_3624_21, js); qoz_strings_sb_append(&_qoz_sb_3624_21, QOZ_STR_LIT(";\n")); _qoz_bv_340 = qoz_strings_sb_finish(&_qoz_sb_3624_21);
    }
    qoz_emit_push(e, _qoz_bv_340); j = j + 1; } }} qoz_emit_push(e, QOZ_STR_LIT("    return p;\n}\n\n")); 
    return;
}
...
void qoz_emit_emit_field_hash_expr(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string fname) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_string ct = qoz_emit_c_type_for(e, te); if (qoz_strings_eq_raw(ct, QOZ_STR_LIT("qoz_string"))) { qoz_string _qoz_bv_353;
    {
        qoz_Strbuf _qoz_sb_3944_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3944_17); qoz_strings_sb_append(&_qoz_sb_3944_17, QOZ_STR_LIT("qoz_string_hash(v.")); qoz_strings_sb_append(&_qoz_sb_3944_17, fname); qoz_strings_sb_append(&_qoz_sb_3944_17, QOZ_STR_LIT(")")); _qoz_bv_353 = qoz_strings_sb_finish(&_qoz_sb_3944_17);
    }
    qoz_emit_push(e, _qoz_bv_353); return;} qoz_TypeExpr* _qoz_ms_1 = te; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(qoz_emit_primitive_c_name(n), QOZ_STR_LIT(""))) { if (!qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_string mangled = (((args.len) > 0) ? qoz_emit_mangle_inst(e, n, args) : n); qoz_string _qoz_bv_364;
    {
        qoz_Strbuf _qoz_sb_3954_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3954_29); qoz_strings_sb_append(&_qoz_sb_3954_29, QOZ_STR_LIT("qoz_hash_")); qoz_strings_sb_append(&_qoz_sb_3954_29, mangled); qoz_strings_sb_append(&_qoz_sb_3954_29, QOZ_STR_LIT("(v.")); qoz_strings_sb_append(&_qoz_sb_3954_29, fname); qoz_strings_sb_append(&_qoz_sb_3954_29, QOZ_STR_LIT(")")); _qoz_bv_364 = qoz_strings_sb_finish(&_qoz_sb_3954_29);
    }
    qoz_emit_push(e, _qoz_bv_364); return;} } } 0;  break; } default: { NULL;  break; } } 0; qoz_string _qoz_bv_365;
    {
        qoz_Strbuf _qoz_sb_3962_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3962_13); qoz_strings_sb_append(&_qoz_sb_3962_13, QOZ_STR_LIT("v.")); qoz_strings_sb_append(&_qoz_sb_3962_13, fname); _qoz_bv_365 = qoz_strings_sb_finish(&_qoz_sb_3962_13);
    }
    qoz_emit_push(e, _qoz_bv_365); 
    return;
}
...
void qoz_emit_emit_fn_proto(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ret);
    qoz_string rc = qoz_emit_c_type_for(e, ret); qoz_string c_name = qoz_emit_user_fn_c_name(name); qoz_string _qoz_bv_369;
    {
        qoz_Strbuf _qoz_sb_3992_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3992_13); qoz_strings_sb_append(&_qoz_sb_3992_13, rc); qoz_strings_sb_append(&_qoz_sb_3992_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3992_13, c_name); _qoz_bv_369 = qoz_strings_sb_finish(&_qoz_sb_3992_13);
    }
    qoz_emit_push(e, _qoz_bv_369); if ((params.len) == 0) { qoz_emit_push(e, QOZ_STR_LIT("(void);\n")); return;} qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = qoz_emit_c_type_for(e, p.ty); qoz_string pn = p.name; qoz_string _qoz_bv_360;
    {
        qoz_Strbuf _qoz_sb_3903_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3903_17); qoz_strings_sb_append(&_qoz_sb_3903_17, pc); qoz_strings_sb_append(&_qoz_sb_3903_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3903_17, pn); _qoz_bv_360 = qoz_strings_sb_finish(&_qoz_sb_3903_17);
    }
    qoz_emit_push(e, _qoz_bv_360); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(");\n")); 
    return;
}
...
bool qoz_emit_hint_is_unsigned_int(qoz_TypeExpr* hint) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_1 = hint; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; bool _qoz_bv_362;
    {
        if ((path.len) != 1) { return false;} qoz_string n = path.data[0]; _qoz_bv_362 = ((qoz_strings_eq_raw(n, QOZ_STR_LIT("u8")) || qoz_strings_eq_raw(n, QOZ_STR_LIT("u16"))) || qoz_strings_eq_raw(n, QOZ_STR_LIT("u32"))) || qoz_strings_eq_raw(n, QOZ_STR_LIT("u64"));
    }
    _qoz_mv_1 = (_qoz_bv_362);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_value_with_hint(qoz_Emitter* e, qoz_Expr* value, qoz_TypeExpr* hint) {
    ...
    qoz_Expr* _qoz_ms_1 = value; switch (_qoz_ms_1->tag) { case qoz_Expr_EString: { qoz_string raw = _qoz_ms_1->payload.EString.f1; {
        if (qoz_emit_hint_is_cstring(hint)) { qoz_emit_push(e, raw); }  else { qoz_string _qoz_bv_363;
    {
        qoz_Strbuf _qoz_sb_4006_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4006_21); qoz_strings_sb_append(&_qoz_sb_4006_21, QOZ_STR_LIT("QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_4006_21, raw); qoz_strings_sb_append(&_qoz_sb_4006_21, QOZ_STR_LIT(")")); _qoz_bv_363 = qoz_strings_sb_finish(&_qoz_sb_4006_21);
    }
    qoz_emit_push(e, _qoz_bv_363); } return;
    }
    ...
    0;  break; } default: { qoz_emit_emit_value_with_hint(e, tail, hint);  break; } } 0; return;} e->closure_counter = e->closure_counter + 1; int64_t counter = e->closure_counter; qoz_string _qoz_bv_374;
    {
        qoz_Strbuf _qoz_sb_4152_47 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4152_47); qoz_strings_sb_append_i64(&_qoz_sb_4152_47, counter); _qoz_bv_374 = qoz_strings_sb_finish(&_qoz_sb_4152_47);
    }
    qoz_string tmp_res = qoz_strings_cat(QOZ_STR_LIT("_qoz_bv_"), _qoz_bv_374); qoz_string result_c = qoz_emit_c_type_for(e, hint); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_375;
    {
        qoz_Strbuf _qoz_sb_4165_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4165_17); qoz_strings_sb_append(&_qoz_sb_4165_17, result_c); qoz_strings_sb_append(&_qoz_sb_4165_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4165_17, tmp_res); qoz_strings_sb_append(&_qoz_sb_4165_17, QOZ_STR_LIT(";\n    {\n        ")); _qoz_bv_375 = qoz_strings_sb_finish(&_qoz_sb_4165_17);
    }
    qoz_emit_push(e, _qoz_bv_375); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_emit_stmt(e, s); } }qoz_Expr* _qoz_ms_4 = tail; switch (_qoz_ms_4->tag) { case qoz_Expr_EWhile: { {
    ...
    0;  break; } case qoz_Expr_EFor: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved); qoz_string _qoz_bv_377;
    {
        qoz_Strbuf _qoz_sb_4162_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4162_21); qoz_strings_sb_append(&_qoz_sb_4162_21, QOZ_STR_LIT("\n        ")); qoz_strings_sb_append(&_qoz_sb_4162_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4162_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_377 = qoz_strings_sb_finish(&_qoz_sb_4162_21);
    }
    qoz_emit_push(e, _qoz_bv_377); 
    }
    0;  break; } case qoz_Expr_EAssign: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved); qoz_string _qoz_bv_378;
    {
        qoz_Strbuf _qoz_sb_4162_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4162_21); qoz_strings_sb_append(&_qoz_sb_4162_21, QOZ_STR_LIT("\n        ")); qoz_strings_sb_append(&_qoz_sb_4162_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4162_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_378 = qoz_strings_sb_finish(&_qoz_sb_4162_21);
    }
    qoz_emit_push(e, _qoz_bv_378); 
    }
    0;  break; } default: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_string _qoz_bv_379;
    {
        qoz_Strbuf _qoz_sb_4176_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4176_21); qoz_strings_sb_append(&_qoz_sb_4176_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4176_21, QOZ_STR_LIT(" = ")); _qoz_bv_379 = qoz_strings_sb_finish(&_qoz_sb_4176_21);
    }
    qoz_emit_push(e, _qoz_bv_379); qoz_emit_emit_value_with_hint(e, tail, hint); qoz_emit_push(e, QOZ_STR_LIT(";\n    ")); qoz_emit_close_statement_scope(e, saved); 
    }
...
bool qoz_emit_emit_qualified_variant_with_hint(qoz_Emitter* e, qoz_Expr* base, qoz_string name, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&base);
    qoz_gc_push_root(&hint);
    qoz_Expr* _qoz_ms_1 = base; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Expr_EIdent: { qoz_string enum_name = _qoz_ms_1->payload.EIdent.f1; bool _qoz_bv_370;
    {
        if (!qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, enum_name)) { return false;} qoz_Option__qoz_string* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_string_Some: { bool _qoz_bv_371;
    {
    ...
    {
        qoz_Strbuf _qoz_sb_4110_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4110_25); qoz_strings_sb_append(&_qoz_sb_4110_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4110_25, mangled); qoz_strings_sb_append(&_qoz_sb_4110_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4110_25, name); qoz_strings_sb_append(&_qoz_sb_4110_25, QOZ_STR_LIT("()")); _qoz_bv_372 = qoz_strings_sb_finish(&_qoz_sb_4110_25);
    }
    qoz_emit_push(e, _qoz_bv_372); }  else { qoz_string _qoz_bv_373;
    {
        qoz_Strbuf _qoz_sb_4112_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4112_25); qoz_strings_sb_append(&_qoz_sb_4112_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4112_25, enum_name); qoz_strings_sb_append(&_qoz_sb_4112_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4112_25, name); qoz_strings_sb_append(&_qoz_sb_4112_25, QOZ_STR_LIT("()")); _qoz_bv_373 = qoz_strings_sb_finish(&_qoz_sb_4112_25);
    }
    qoz_emit_push(e, _qoz_bv_373); } _qoz_bv_371 = true;
    }
    _qoz_mv_2 = (_qoz_bv_371);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_2 = (false);  break; } } _qoz_bv_370 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_370);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_call_with_hint(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_TypeExpr* hint) {
    ...
    if ((type_args.len) > 0) { qoz_emit_emit_call(e, callee, type_args, args); return;} qoz_string variant_name = qoz_emit_variant_callee_name(e, callee); if (!qoz_strings_eq_raw(variant_name, QOZ_STR_LIT(""))) { qoz_Option__qoz_string* _qoz_ms_1 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, variant_name); switch (_qoz_ms_1->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_1->payload.Some.f0; {
        qoz_Vec__qoz_TypeExpr hint_args = qoz_emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = qoz_emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_387;
    {
        qoz_Strbuf _qoz_sb_4344_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4344_25); qoz_strings_sb_append(&_qoz_sb_4344_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4344_25, mangled); qoz_strings_sb_append(&_qoz_sb_4344_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4344_25, variant_name); qoz_strings_sb_append(&_qoz_sb_4344_25, QOZ_STR_LIT("(")); _qoz_bv_387 = qoz_strings_sb_finish(&_qoz_sb_4344_25);
    }
    qoz_emit_push(e, _qoz_bv_387); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;} 
    }
...
qoz_Vec__qoz_TypeExpr qoz_emit_hint_args_for_enum(qoz_TypeExpr* hint, qoz_string enum_name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_1 = hint; qoz_Vec__qoz_TypeExpr _qoz_mv_1 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_Vec__qoz_TypeExpr _qoz_bv_388;
    {
        if ((path.len) >= 1) { qoz_string last = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(last, enum_name)) { return args;} } _qoz_bv_388 = qoz_vec_make__qoz_TypeExpr();
    }
    _qoz_mv_1 = (_qoz_bv_388);  break; } default: { _qoz_mv_1 = (qoz_vec_make__qoz_TypeExpr());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_record_lit_with_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_Vec__qoz_RecordFieldLit fields, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* effective = qoz_emit_pick_type_with_args(te, hint); qoz_gc_push_root(&effective); qoz_Vec__qoz_RecordFieldLit expanded = qoz_emit_expand_record_spread_fields(e, effective, fields); qoz_string ec = qoz_emit_c_type_for(e, effective); qoz_string _qoz_bv_389;
    {
        qoz_Strbuf _qoz_sb_4378_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4378_13); qoz_strings_sb_append(&_qoz_sb_4378_13, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_4378_13, ec); qoz_strings_sb_append(&_qoz_sb_4378_13, QOZ_STR_LIT("){ ")); _qoz_bv_389 = qoz_strings_sb_finish(&_qoz_sb_4378_13);
    }
    qoz_emit_push(e, _qoz_bv_389); int64_t i = 0; { qoz_Vec__qoz_RecordFieldLit __col = expanded; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string fn = f.name; qoz_string _qoz_bv_380;
    {
        qoz_Strbuf _qoz_sb_4373_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4373_17); qoz_strings_sb_append(&_qoz_sb_4373_17, QOZ_STR_LIT(".")); qoz_strings_sb_append(&_qoz_sb_4373_17, fn); qoz_strings_sb_append(&_qoz_sb_4373_17, QOZ_STR_LIT(" = ")); _qoz_bv_380 = qoz_strings_sb_finish(&_qoz_sb_4373_17);
    }
    qoz_emit_push(e, _qoz_bv_380); qoz_TypeExpr* field_hint = qoz_emit_field_type_hint(e, effective, f.name); qoz_gc_push_root(&field_hint); qoz_emit_emit_value_with_hint(e, f.value, field_hint); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(" })")); 
    return;
}
...
qoz_TypeExpr* qoz_emit_field_type_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string field_name) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_381;
    {
        if ((path.len) < 1) { return te;} qoz_string name = qoz_emit_type_lookup_key(e, path); if (!qoz_map_contains__qoz_string__qoz_Decl(&e->generic_decls, name)) { return te;} qoz_Option__qoz_Decl* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, name); qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_2->payload.Some.f0; qoz_Decl* _qoz_ms_3 = decl; qoz_TypeExpr* _qoz_mv_3 = NULL; switch (_qoz_ms_3->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_3->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_3->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_382;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField sf = __col.data[__i]; (void)sf; if (qoz_strings_eq_raw(sf.name, field_name)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, sf.ty, params, args);} return sf.ty;} } }_qoz_bv_382 = te;
    }
    _qoz_mv_3 = (_qoz_bv_382);  break; } default: { _qoz_mv_3 = (te);  break; } } _qoz_mv_2 = (_qoz_mv_3);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_2 = (te);  break; } } _qoz_bv_381 = _qoz_mv_2;
    }
...
qoz_TypeExpr* qoz_emit_pick_type_with_args(qoz_TypeExpr* te, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string te_path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr te_args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_383;
    {
        if ((te_args.len) > 0) { return te;} qoz_TypeExpr* _qoz_ms_2 = hint; qoz_TypeExpr* _qoz_mv_2 = NULL; switch (_qoz_ms_2->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string h_path = _qoz_ms_2->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr h_args = _qoz_ms_2->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_394;
    {
        if ((h_args.len) == 0) { return te;} if ((((h_path.len) == 1) && ((te_path.len) == 1)) && qoz_strings_eq_raw(h_path.data[0], te_path.data[0])) { return hint;} _qoz_bv_394 = te;
    }
    _qoz_mv_2 = (_qoz_bv_394);  break; } default: { _qoz_mv_2 = (te);  break; } } _qoz_bv_383 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_383);  break; } default: { _qoz_mv_1 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_for_loop_one(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_1 = iter; switch (_qoz_ms_1->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_1->payload.EBinary.f1; qoz_Expr* lo = _qoz_ms_1->payload.EBinary.f2; qoz_Expr* hi = _qoz_ms_1->payload.EBinary.f3; if (qoz_emit_is_range_op(op)) { qoz_string _qoz_bv_395;
    {
        qoz_Strbuf _qoz_sb_4548_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4548_21); qoz_strings_sb_append(&_qoz_sb_4548_21, QOZ_STR_LIT("for (int64_t ")); qoz_strings_sb_append(&_qoz_sb_4548_21, binding); qoz_strings_sb_append(&_qoz_sb_4548_21, QOZ_STR_LIT(" = ")); _qoz_bv_395 = qoz_strings_sb_finish(&_qoz_sb_4548_21);
    }
    qoz_emit_push(e, _qoz_bv_395); qoz_emit_emit_expr(e, lo); qoz_string cmp = qoz_emit_range_cmp_op(op); qoz_string _qoz_bv_396;
    {
        qoz_Strbuf _qoz_sb_4541_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4541_21); qoz_strings_sb_append(&_qoz_sb_4541_21, QOZ_STR_LIT("; ")); qoz_strings_sb_append(&_qoz_sb_4541_21, binding); qoz_strings_sb_append(&_qoz_sb_4541_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4541_21, cmp); qoz_strings_sb_append(&_qoz_sb_4541_21, QOZ_STR_LIT(" ")); _qoz_bv_396 = qoz_strings_sb_finish(&_qoz_sb_4541_21);
    }
    qoz_emit_push(e, _qoz_bv_396); qoz_emit_emit_expr(e, hi); qoz_string _qoz_bv_397;
    {
        qoz_Strbuf _qoz_sb_4543_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4543_21); qoz_strings_sb_append(&_qoz_sb_4543_21, QOZ_STR_LIT("; ")); qoz_strings_sb_append(&_qoz_sb_4543_21, binding); qoz_strings_sb_append(&_qoz_sb_4543_21, QOZ_STR_LIT("++) ")); _qoz_bv_397 = qoz_strings_sb_finish(&_qoz_sb_4543_21);
    }
    qoz_emit_push(e, _qoz_bv_397); qoz_emit_emit_branch_as_statement(e, body); return;} 0;  break; } default: { NULL;  break; } } 0; if (qoz_strings_eq_raw(binding2, QOZ_STR_LIT(""))) { qoz_emit_emit_vec_for(e, binding, iter, body); }  else { qoz_emit_emit_map_for(e, binding, binding2, iter, body); } 
    return;
}
...
void qoz_emit_emit_vec_for(qoz_Emitter* e, qoz_string binding, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* elem_te = qoz_emit_vec_element_typeexpr(e, iter); qoz_gc_push_root(&elem_te); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, binding, elem_te); qoz_string col_ct = qoz_emit_c_type_for(e, qoz_emit_infer_base_typeexpr(e, iter)); qoz_string elem_ct = qoz_emit_c_type_for(e, elem_te); qoz_string _qoz_bv_398;
    {
        qoz_Strbuf _qoz_sb_4563_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4563_13); qoz_strings_sb_append(&_qoz_sb_4563_13, QOZ_STR_LIT("{ ")); qoz_strings_sb_append(&_qoz_sb_4563_13, col_ct); qoz_strings_sb_append(&_qoz_sb_4563_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_398 = qoz_strings_sb_finish(&_qoz_sb_4563_13);
    }
    qoz_emit_push(e, _qoz_bv_398); qoz_emit_emit_expr(e, iter); qoz_string _qoz_bv_399;
    {
        qoz_Strbuf _qoz_sb_4565_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4565_13); qoz_strings_sb_append(&_qoz_sb_4565_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.len; __i++) { ")); qoz_strings_sb_append(&_qoz_sb_4565_13, elem_ct); qoz_strings_sb_append(&_qoz_sb_4565_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4565_13, binding); qoz_strings_sb_append(&_qoz_sb_4565_13, QOZ_STR_LIT(" = __col.data[__i]; (void)")); qoz_strings_sb_append(&_qoz_sb_4565_13, binding); qoz_strings_sb_append(&_qoz_sb_4565_13, QOZ_STR_LIT("; ")); _qoz_bv_399 = qoz_strings_sb_finish(&_qoz_sb_4565_13);
    }
    qoz_emit_push(e, _qoz_bv_399); qoz_emit_emit_branch_body_inline(e, body); qoz_emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* qoz_emit_vec_element_typeexpr(qoz_Emitter* e, qoz_Expr* iter) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&iter);
    qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_390;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_390 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_1 = (_qoz_bv_390);  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_1->payload.TEPtr.f1; _qoz_mv_1 = (inner);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(iter)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
void qoz_emit_emit_map_for(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* iter_te = qoz_emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&iter_te); qoz_string col_ct = qoz_emit_c_type_for(e, iter_te); qoz_TypeExpr* key_te = qoz_emit_map_key_typeexpr(e, iter_te); qoz_gc_push_root(&key_te); qoz_TypeExpr* val_te = qoz_emit_map_val_typeexpr(e, iter_te); qoz_gc_push_root(&val_te); qoz_string key_ct = qoz_emit_c_type_for(e, key_te); qoz_string val_ct = qoz_emit_c_type_for(e, val_te); qoz_string _qoz_bv_391;
    {
        qoz_Strbuf _qoz_sb_4599_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4599_13); qoz_strings_sb_append(&_qoz_sb_4599_13, QOZ_STR_LIT("{ ")); qoz_strings_sb_append(&_qoz_sb_4599_13, col_ct); qoz_strings_sb_append(&_qoz_sb_4599_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_391 = qoz_strings_sb_finish(&_qoz_sb_4599_13);
    }
    qoz_emit_push(e, _qoz_bv_391); qoz_emit_emit_expr(e, iter); qoz_string _qoz_bv_392;
    {
        qoz_Strbuf _qoz_sb_4591_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4591_13); qoz_strings_sb_append(&_qoz_sb_4591_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.cap; __i++) { if (!__col.slots[__i].occupied || __col.slots[__i].deleted) continue; ")); qoz_strings_sb_append(&_qoz_sb_4591_13, key_ct); qoz_strings_sb_append(&_qoz_sb_4591_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4591_13, binding); qoz_strings_sb_append(&_qoz_sb_4591_13, QOZ_STR_LIT(" = __col.slots[__i].key; ")); qoz_strings_sb_append(&_qoz_sb_4591_13, val_ct); qoz_strings_sb_append(&_qoz_sb_4591_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4591_13, binding2); qoz_strings_sb_append(&_qoz_sb_4591_13, QOZ_STR_LIT(" = __col.slots[__i].value; (void)")); qoz_strings_sb_append(&_qoz_sb_4591_13, binding); qoz_strings_sb_append(&_qoz_sb_4591_13, QOZ_STR_LIT("; (void)")); qoz_strings_sb_append(&_qoz_sb_4591_13, binding2); qoz_strings_sb_append(&_qoz_sb_4591_13, QOZ_STR_LIT("; ")); _qoz_bv_392 = qoz_strings_sb_finish(&_qoz_sb_4591_13);
    }
    qoz_emit_push(e, _qoz_bv_392); qoz_emit_emit_branch_body_inline(e, body); qoz_emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* qoz_emit_map_key_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_393;
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[0];} _qoz_bv_393 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_1 = (_qoz_bv_393);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_emit_map_val_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_404;
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_strings_eq_raw(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[1];} _qoz_bv_404 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_1 = (_qoz_bv_404);  break; } default: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
bool qoz_emit_any_arm_is_literal(qoz_Vec__qoz_MatchArm arms) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm a = __col.data[__i]; (void)a; qoz_Pattern* _qoz_ms_1 = a.pat; switch (_qoz_ms_1->tag) { case qoz_Pattern_PatLitInt: { return true; break; } case qoz_Pattern_PatLitString: { return true; break; } case qoz_Pattern_PatLitBool: { return true; break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_1->payload.PatVariant.f2; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_2 = sp; switch (_qoz_ms_2->tag) { case qoz_Pattern_PatLitInt: { return true; break; } case qoz_Pattern_PatLitString: { return true; break; } case qoz_Pattern_PatLitBool: { return true; break; } default: { NULL;  break; } } 0; } }0;  break; } default: { NULL;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return false;
}
...
void qoz_emit_emit_match_as_expr(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    if (qoz_emit_any_arm_has_guard(arms)) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} if (qoz_emit_any_arm_is_literal(arms)) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); if (qoz_strings_eq_raw(bare_enum, QOZ_STR_LIT(""))) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string enum_name = qoz_emit_enum_lookup_name(e, scrut, bare_enum); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_405;
    {
        qoz_Strbuf _qoz_sb_4691_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4691_21); qoz_strings_sb_append(&_qoz_sb_4691_21, QOZ_STR_LIT("_qoz_ms_")); qoz_strings_sb_append_i64(&_qoz_sb_4691_21, e->match_counter); _qoz_bv_405 = qoz_strings_sb_finish(&_qoz_sb_4691_21);
    }
    qoz_string scrut_tmp = _qoz_bv_405; qoz_string _qoz_bv_406;
    {
        qoz_Strbuf _qoz_sb_4602_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4602_21); qoz_strings_sb_append(&_qoz_sb_4602_21, QOZ_STR_LIT("_qoz_mv_")); qoz_strings_sb_append_i64(&_qoz_sb_4602_21, e->match_counter); _qoz_bv_406 = qoz_strings_sb_finish(&_qoz_sb_4602_21);
    }
    qoz_string res_tmp = _qoz_bv_406; qoz_string res_ctype = qoz_emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_strings_eq_raw(res_ctype, QOZ_STR_LIT("void")); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_407;
    {
        qoz_Strbuf _qoz_sb_4601_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4601_13); qoz_strings_sb_append(&_qoz_sb_4601_13, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_4601_13, enum_name); qoz_strings_sb_append(&_qoz_sb_4601_13, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4601_13, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4601_13, QOZ_STR_LIT(" = ")); _qoz_bv_407 = qoz_strings_sb_finish(&_qoz_sb_4601_13);
    }
    qoz_emit_push(e, _qoz_bv_407); qoz_emit_emit_expr(e, scrut); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (!is_void) { qoz_string dv = qoz_emit_default_value_for(res_ctype); qoz_string _qoz_bv_408;
    {
        qoz_Strbuf _qoz_sb_4616_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4616_17); qoz_strings_sb_append(&_qoz_sb_4616_17, res_ctype); qoz_strings_sb_append(&_qoz_sb_4616_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4616_17, res_tmp); qoz_strings_sb_append(&_qoz_sb_4616_17, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4616_17, dv); qoz_strings_sb_append(&_qoz_sb_4616_17, QOZ_STR_LIT("; ")); _qoz_bv_408 = qoz_strings_sb_finish(&_qoz_sb_4616_17);
    }
    qoz_emit_push(e, _qoz_bv_408); } qoz_string _qoz_bv_409;
    {
        qoz_Strbuf _qoz_sb_4618_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4618_13); qoz_strings_sb_append(&_qoz_sb_4618_13, QOZ_STR_LIT("switch (")); qoz_strings_sb_append(&_qoz_sb_4618_13, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4618_13, QOZ_STR_LIT("->tag) { ")); _qoz_bv_409 = qoz_strings_sb_finish(&_qoz_sb_4618_13);
    }
    qoz_emit_push(e, _qoz_bv_409); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; qoz_emit_emit_match_arm_with_kind(e, enum_name, scrut_tmp, res_tmp, arm, is_void); } }qoz_emit_push(e, QOZ_STR_LIT("} ")); qoz_emit_hoist_to_prologue(e, start); if (is_void) { qoz_emit_push(e, QOZ_STR_LIT("0")); }  else { qoz_emit_push(e, res_tmp); } 
    return;
}
...
void qoz_emit_emit_match_as_if_chain(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); bool is_enum_match = !qoz_strings_eq_raw(bare_enum, QOZ_STR_LIT("")); qoz_string enum_name = QOZ_STR_LIT(""); if (is_enum_match) { enum_name = qoz_emit_enum_lookup_name(e, scrut, bare_enum); } qoz_string scrut_ctype = qoz_emit_infer_expr_ctype(e, scrut); qoz_TypeExpr* scrut_te = qoz_emit_infer_value_te(e, scrut); qoz_gc_push_root(&scrut_te); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_400;
    {
        qoz_Strbuf _qoz_sb_4639_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4639_21); qoz_strings_sb_append(&_qoz_sb_4639_21, QOZ_STR_LIT("_qoz_ms_")); qoz_strings_sb_append_i64(&_qoz_sb_4639_21, e->match_counter); _qoz_bv_400 = qoz_strings_sb_finish(&_qoz_sb_4639_21);
    }
    qoz_string scrut_tmp = _qoz_bv_400; qoz_string _qoz_bv_401;
    {
        qoz_Strbuf _qoz_sb_4630_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4630_21); qoz_strings_sb_append(&_qoz_sb_4630_21, QOZ_STR_LIT("_qoz_mv_")); qoz_strings_sb_append_i64(&_qoz_sb_4630_21, e->match_counter); _qoz_bv_401 = qoz_strings_sb_finish(&_qoz_sb_4630_21);
    }
    qoz_string res_tmp = _qoz_bv_401; qoz_string _qoz_bv_402;
    {
        qoz_Strbuf _qoz_sb_4631_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4631_21); qoz_strings_sb_append(&_qoz_sb_4631_21, QOZ_STR_LIT("_qoz_mm_")); qoz_strings_sb_append_i64(&_qoz_sb_4631_21, e->match_counter); _qoz_bv_402 = qoz_strings_sb_finish(&_qoz_sb_4631_21);
    }
    qoz_string mflag = _qoz_bv_402; qoz_string res_ctype = qoz_emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_strings_eq_raw(res_ctype, QOZ_STR_LIT("void")); int64_t start = qoz_strings_sb_len(&e->out); if (is_enum_match) { qoz_string _qoz_bv_403;
    {
        qoz_Strbuf _qoz_sb_4746_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4746_17); qoz_strings_sb_append(&_qoz_sb_4746_17, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_4746_17, enum_name); qoz_strings_sb_append(&_qoz_sb_4746_17, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4746_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4746_17, QOZ_STR_LIT(" = ")); _qoz_bv_403 = qoz_strings_sb_finish(&_qoz_sb_4746_17);
    }
    qoz_emit_push(e, _qoz_bv_403); }  else { qoz_string _qoz_bv_414;
    {
        qoz_Strbuf _qoz_sb_4748_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4748_17); qoz_strings_sb_append(&_qoz_sb_4748_17, scrut_ctype); qoz_strings_sb_append(&_qoz_sb_4748_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4748_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4748_17, QOZ_STR_LIT(" = ")); _qoz_bv_414 = qoz_strings_sb_finish(&_qoz_sb_4748_17);
    }
    qoz_emit_push(e, _qoz_bv_414); } qoz_emit_emit_expr(e, scrut); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (!is_void) { qoz_string dv = qoz_emit_default_value_for(res_ctype); qoz_string _qoz_bv_415;
    {
        qoz_Strbuf _qoz_sb_4754_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4754_17); qoz_strings_sb_append(&_qoz_sb_4754_17, res_ctype); qoz_strings_sb_append(&_qoz_sb_4754_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4754_17, res_tmp); qoz_strings_sb_append(&_qoz_sb_4754_17, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4754_17, dv); qoz_strings_sb_append(&_qoz_sb_4754_17, QOZ_STR_LIT("; ")); _qoz_bv_415 = qoz_strings_sb_finish(&_qoz_sb_4754_17);
    }
    qoz_emit_push(e, _qoz_bv_415); } qoz_string _qoz_bv_416;
    {
        qoz_Strbuf _qoz_sb_4756_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4756_13); qoz_strings_sb_append(&_qoz_sb_4756_13, QOZ_STR_LIT("bool ")); qoz_strings_sb_append(&_qoz_sb_4756_13, mflag); qoz_strings_sb_append(&_qoz_sb_4756_13, QOZ_STR_LIT(" = false; ")); _qoz_bv_416 = qoz_strings_sb_finish(&_qoz_sb_4756_13);
    }
    qoz_emit_push(e, _qoz_bv_416); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; qoz_emit_emit_arm_in_chain_with_te(e, enum_name, scrut_tmp, scrut_te, res_tmp, mflag, arm, is_void); } }qoz_emit_hoist_to_prologue(e, start); if (is_void) { qoz_emit_push(e, QOZ_STR_LIT("0")); }  else { qoz_emit_push(e, res_tmp); } 
    return;
}
...
void qoz_emit_emit_arm_in_chain_with_te(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_TypeExpr* scrut_te, qoz_string res_tmp, qoz_string mflag, qoz_MatchArm arm, bool is_void) {
    ...
    qoz_TypeExpr* body_hint = qoz_emit_match_body_hint(e, enum_name, arm.body); qoz_gc_push_root(&body_hint); bool is_enum_match = !qoz_strings_eq_raw(enum_name, QOZ_STR_LIT("")); qoz_emit_push(e, QOZ_STR_LIT("if (!")); qoz_emit_push(e, mflag); qoz_Pattern* _qoz_ms_1 = arm.pat; switch (_qoz_ms_1->tag) { case qoz_Pattern_PatWild: { qoz_emit_push(e, QOZ_STR_LIT(") { "));  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_1->payload.PatBind.f1; if (is_enum_match) { qoz_Option__qoz_string* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_2->tag) { case qoz_Option__qoz_string_Some: { qoz_string _qoz_bv_417;
    {
        qoz_Strbuf _qoz_sb_4778_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4778_25); qoz_strings_sb_append(&_qoz_sb_4778_25, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4778_25, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4778_25, QOZ_STR_LIT("->tag == qoz_")); qoz_strings_sb_append(&_qoz_sb_4778_25, enum_name); qoz_strings_sb_append(&_qoz_sb_4778_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4778_25, name); qoz_strings_sb_append(&_qoz_sb_4778_25, QOZ_STR_LIT(") { ")); _qoz_bv_417 = qoz_strings_sb_finish(&_qoz_sb_4778_25);
    }
    qoz_emit_push(e, _qoz_bv_417);  break; } default: { {
        qoz_string _qoz_bv_418;
    {
        qoz_Strbuf _qoz_sb_4783_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4783_25); qoz_strings_sb_append(&_qoz_sb_4783_25, QOZ_STR_LIT(") { qoz_")); qoz_strings_sb_append(&_qoz_sb_4783_25, enum_name); qoz_strings_sb_append(&_qoz_sb_4783_25, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4783_25, name); qoz_strings_sb_append(&_qoz_sb_4783_25, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4783_25, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4783_25, QOZ_STR_LIT("; (void)")); qoz_strings_sb_append(&_qoz_sb_4783_25, name); qoz_strings_sb_append(&_qoz_sb_4783_25, QOZ_STR_LIT("; ")); _qoz_bv_418 = qoz_strings_sb_finish(&_qoz_sb_4783_25);
    }
    qoz_emit_push(e, _qoz_bv_418); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, scrut_te); 
    }
    0;  break; } } 0; }  else { qoz_string sc = qoz_emit_c_type_for(e, scrut_te); qoz_string _qoz_bv_419;
    {
        qoz_Strbuf _qoz_sb_4788_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4788_21); qoz_strings_sb_append(&_qoz_sb_4788_21, QOZ_STR_LIT(") { ")); qoz_strings_sb_append(&_qoz_sb_4788_21, sc); qoz_strings_sb_append(&_qoz_sb_4788_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4788_21, name); qoz_strings_sb_append(&_qoz_sb_4788_21, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4788_21, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4788_21, QOZ_STR_LIT("; (void)")); qoz_strings_sb_append(&_qoz_sb_4788_21, name); qoz_strings_sb_append(&_qoz_sb_4788_21, QOZ_STR_LIT("; ")); _qoz_bv_419 = qoz_strings_sb_finish(&_qoz_sb_4788_21);
    }
    qoz_emit_push(e, _qoz_bv_419); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, scrut_te); } 0;  break; } case qoz_Pattern_PatLitInt: { qoz_string text = _qoz_ms_1->payload.PatLitInt.f1; {
        qoz_string tn = qoz_emit_strip_numeric_underscores(text); qoz_string _qoz_bv_410;
    {
        qoz_Strbuf _qoz_sb_4794_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4794_17); qoz_strings_sb_append(&_qoz_sb_4794_17, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4794_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4794_17, QOZ_STR_LIT(" == ")); qoz_strings_sb_append(&_qoz_sb_4794_17, tn); qoz_strings_sb_append(&_qoz_sb_4794_17, QOZ_STR_LIT(") { ")); _qoz_bv_410 = qoz_strings_sb_finish(&_qoz_sb_4794_17);
    }
    qoz_emit_push(e, _qoz_bv_410); 
    }
    0;  break; } case qoz_Pattern_PatLitBool: { bool b = _qoz_ms_1->payload.PatLitBool.f1; if (b) { qoz_string _qoz_bv_411;
    {
        qoz_Strbuf _qoz_sb_4797_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4797_24); qoz_strings_sb_append(&_qoz_sb_4797_24, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4797_24, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4797_24, QOZ_STR_LIT(" == true) { ")); _qoz_bv_411 = qoz_strings_sb_finish(&_qoz_sb_4797_24);
    }
    qoz_emit_push(e, _qoz_bv_411); }  else { qoz_string _qoz_bv_412;
    {
        qoz_Strbuf _qoz_sb_4798_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4798_24); qoz_strings_sb_append(&_qoz_sb_4798_24, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4798_24, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4798_24, QOZ_STR_LIT(" == false) { ")); _qoz_bv_412 = qoz_strings_sb_finish(&_qoz_sb_4798_24);
    }
    qoz_emit_push(e, _qoz_bv_412); } 0;  break; } case qoz_Pattern_PatLitString: { qoz_string text = _qoz_ms_1->payload.PatLitString.f1; qoz_string _qoz_bv_413;
    {
        qoz_Strbuf _qoz_sb_4791_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4791_17); qoz_strings_sb_append(&_qoz_sb_4791_17, QOZ_STR_LIT(" && qoz_string_eq(")); qoz_strings_sb_append(&_qoz_sb_4791_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4791_17, QOZ_STR_LIT(", QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_4791_17, text); qoz_strings_sb_append(&_qoz_sb_4791_17, QOZ_STR_LIT("))) { ")); _qoz_bv_413 = qoz_strings_sb_finish(&_qoz_sb_4791_17);
    }
    qoz_emit_push(e, _qoz_bv_413);  break; } case qoz_Pattern_PatVariant: { qoz_Span psp = _qoz_ms_1->payload.PatVariant.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_1->payload.PatVariant.f2; {
        if ((path.len) == 0) { (void)(qoz_emit_emit_die(psp, QOZ_STR_LIT("variant pattern has no name"))); } if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_424;
    {
        qoz_Strbuf _qoz_sb_4709_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4709_21); qoz_strings_sb_append(&_qoz_sb_4709_21, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4709_21, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4709_21, QOZ_STR_LIT("->tag == qoz_")); qoz_strings_sb_append(&_qoz_sb_4709_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4709_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4709_21, vname); _qoz_bv_424 = qoz_strings_sb_finish(&_qoz_sb_4709_21);
    }
    qoz_emit_push(e, _qoz_bv_424); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_string is = qoz_emit_int_to_string(i); qoz_Pattern* _qoz_ms_3 = sp; switch (_qoz_ms_3->tag) { case qoz_Pattern_PatLitInt: { qoz_string text = _qoz_ms_3->payload.PatLitInt.f1; {
        qoz_string tn = qoz_emit_strip_numeric_underscores(text); qoz_string _qoz_bv_425;
    {
        qoz_Strbuf _qoz_sb_4722_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4722_29); qoz_strings_sb_append(&_qoz_sb_4722_29, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4722_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4722_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4722_29, vname); qoz_strings_sb_append(&_qoz_sb_4722_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4722_29, is); qoz_strings_sb_append(&_qoz_sb_4722_29, QOZ_STR_LIT(" == ")); qoz_strings_sb_append(&_qoz_sb_4722_29, tn); _qoz_bv_425 = qoz_strings_sb_finish(&_qoz_sb_4722_29);
    }
    qoz_emit_push(e, _qoz_bv_425); 
    }
    0;  break; } case qoz_Pattern_PatLitBool: { bool b = _qoz_ms_3->payload.PatLitBool.f1; if (b) { qoz_string _qoz_bv_426;
    {
        qoz_Strbuf _qoz_sb_4725_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4725_36); qoz_strings_sb_append(&_qoz_sb_4725_36, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4725_36, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4725_36, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4725_36, vname); qoz_strings_sb_append(&_qoz_sb_4725_36, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4725_36, is); qoz_strings_sb_append(&_qoz_sb_4725_36, QOZ_STR_LIT(" == true")); _qoz_bv_426 = qoz_strings_sb_finish(&_qoz_sb_4725_36);
    }
    qoz_emit_push(e, _qoz_bv_426); }  else { qoz_string _qoz_bv_427;
    {
        qoz_Strbuf _qoz_sb_4726_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4726_36); qoz_strings_sb_append(&_qoz_sb_4726_36, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4726_36, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4726_36, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4726_36, vname); qoz_strings_sb_append(&_qoz_sb_4726_36, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4726_36, is); qoz_strings_sb_append(&_qoz_sb_4726_36, QOZ_STR_LIT(" == false")); _qoz_bv_427 = qoz_strings_sb_finish(&_qoz_sb_4726_36);
    }
    qoz_emit_push(e, _qoz_bv_427); } 0;  break; } case qoz_Pattern_PatLitString: { qoz_string text = _qoz_ms_3->payload.PatLitString.f1; qoz_string _qoz_bv_428;
    {
        qoz_Strbuf _qoz_sb_4729_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4729_29); qoz_strings_sb_append(&_qoz_sb_4729_29, QOZ_STR_LIT(" && qoz_string_eq(")); qoz_strings_sb_append(&_qoz_sb_4729_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4729_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4729_29, vname); qoz_strings_sb_append(&_qoz_sb_4729_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4729_29, is); qoz_strings_sb_append(&_qoz_sb_4729_29, QOZ_STR_LIT(", QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_4729_29, text); qoz_strings_sb_append(&_qoz_sb_4729_29, QOZ_STR_LIT("))")); _qoz_bv_428 = qoz_strings_sb_finish(&_qoz_sb_4729_29);
    }
    qoz_emit_push(e, _qoz_bv_428);  break; } default: { NULL;  break; } } 0; i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(") { ")); int64_t j = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_4 = sp; switch (_qoz_ms_4->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_4->payload.PatBind.f1; {
        qoz_string pc = qoz_emit_variant_payload_ctype(e, enum_name, vname, j); qoz_string js = qoz_emit_int_to_string(j); qoz_string _qoz_bv_429;
    {
        qoz_Strbuf _qoz_sb_4842_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4842_29); qoz_strings_sb_append(&_qoz_sb_4842_29, pc); qoz_strings_sb_append(&_qoz_sb_4842_29, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4842_29, bname); qoz_strings_sb_append(&_qoz_sb_4842_29, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4842_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4842_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4842_29, vname); qoz_strings_sb_append(&_qoz_sb_4842_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4842_29, js); qoz_strings_sb_append(&_qoz_sb_4842_29, QOZ_STR_LIT("; ")); _qoz_bv_429 = qoz_strings_sb_finish(&_qoz_sb_4842_29);
    }
    qoz_emit_push(e, _qoz_bv_429); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, qoz_emit_variant_payload_typeexpr(e, enum_name, vname, j)); 
    }
    0;  break; } default: { NULL;  break; } } 0; j = j + 1; } }}  else { qoz_emit_push(e, QOZ_STR_LIT(") { ")); } 
    }
...
void qoz_emit_emit_match_arm_with_kind(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_string res_tmp, qoz_MatchArm arm, bool is_void) {
    ...
    0;  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_1->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_2 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_2->tag) { case qoz_Option__qoz_string_Some: { {
        qoz_string _qoz_bv_420;
    {
        qoz_Strbuf _qoz_sb_4802_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4802_21); qoz_strings_sb_append(&_qoz_sb_4802_21, QOZ_STR_LIT("case qoz_")); qoz_strings_sb_append(&_qoz_sb_4802_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4802_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4802_21, name); qoz_strings_sb_append(&_qoz_sb_4802_21, QOZ_STR_LIT(": { ")); _qoz_bv_420 = qoz_strings_sb_finish(&_qoz_sb_4802_21);
    }
    qoz_emit_push(e, _qoz_bv_420); if (arm.has_guard) { qoz_emit_push(e, QOZ_STR_LIT("if (")); qoz_emit_emit_expr(e, arm.guard); qoz_emit_push(e, QOZ_STR_LIT(") { ")); qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); qoz_emit_push(e, QOZ_STR_LIT("} ")); }  else { qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); } qoz_emit_push(e, QOZ_STR_LIT(" break; } ")); 
    }
    0;  break; } case qoz_Option__qoz_string_None: { {
        qoz_string _qoz_bv_421;
    {
        qoz_Strbuf _qoz_sb_4820_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4820_21); qoz_strings_sb_append(&_qoz_sb_4820_21, QOZ_STR_LIT("default: { qoz_")); qoz_strings_sb_append(&_qoz_sb_4820_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4820_21, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4820_21, name); qoz_strings_sb_append(&_qoz_sb_4820_21, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4820_21, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4820_21, QOZ_STR_LIT("; (void)")); qoz_strings_sb_append(&_qoz_sb_4820_21, name); qoz_strings_sb_append(&_qoz_sb_4820_21, QOZ_STR_LIT("; ")); _qoz_bv_421 = qoz_strings_sb_finish(&_qoz_sb_4820_21);
    }
    qoz_emit_push(e, _qoz_bv_421); qoz_Span sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_Vec__qoz_string segs = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&segs, enum_name); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, qoz_make_TypeExpr_TENamed(sp, segs, qoz_vec_make__qoz_TypeExpr())); if (arm.has_guard) { qoz_emit_push(e, QOZ_STR_LIT("if (")); qoz_emit_emit_expr(e, arm.guard); qoz_emit_push(e, QOZ_STR_LIT(") { ")); qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); qoz_emit_push(e, QOZ_STR_LIT("} ")); }  else { qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); } qoz_emit_push(e, QOZ_STR_LIT(" break; } ")); 
    }
    0;  break; } } 0;  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_1->payload.PatVariant.f2; if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_422;
    {
        qoz_Strbuf _qoz_sb_4941_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4941_21); qoz_strings_sb_append(&_qoz_sb_4941_21, QOZ_STR_LIT("case qoz_")); qoz_strings_sb_append(&_qoz_sb_4941_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4941_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4941_21, vname); qoz_strings_sb_append(&_qoz_sb_4941_21, QOZ_STR_LIT(": { ")); _qoz_bv_422 = qoz_strings_sb_finish(&_qoz_sb_4941_21);
    }
    qoz_emit_push(e, _qoz_bv_422); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_3 = sp; switch (_qoz_ms_3->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_3->payload.PatBind.f1; {
        qoz_string pc = qoz_emit_variant_payload_ctype(e, enum_name, vname, i); qoz_string is = qoz_emit_int_to_string(i); qoz_string _qoz_bv_423;
    {
        qoz_Strbuf _qoz_sb_4958_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4958_29); qoz_strings_sb_append(&_qoz_sb_4958_29, pc); qoz_strings_sb_append(&_qoz_sb_4958_29, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4958_29, bname); qoz_strings_sb_append(&_qoz_sb_4958_29, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4958_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4958_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4958_29, vname); qoz_strings_sb_append(&_qoz_sb_4958_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4958_29, is); qoz_strings_sb_append(&_qoz_sb_4958_29, QOZ_STR_LIT("; ")); _qoz_bv_423 = qoz_strings_sb_finish(&_qoz_sb_4958_29);
    }
    qoz_emit_push(e, _qoz_bv_423); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, qoz_emit_variant_payload_typeexpr(e, enum_name, vname, i)); 
    }
...
qoz_string qoz_emit_enum_name_from_type(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string bare_enum) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_1 = te; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_1->payload.TENamed.f2; qoz_string _qoz_bv_434;
    {
        if (((args.len) > 0) && ((path.len) >= 1)) { qoz_string last = path.data[(path.len) - 1]; if (qoz_strings_eq_raw(last, bare_enum)) { return qoz_emit_mangle_inst(e, bare_enum, args);} } _qoz_bv_434 = bare_enum;
    }
    _qoz_mv_1 = (_qoz_bv_434);  break; } default: { _qoz_mv_1 = (bare_enum);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_MainRetKind* qoz_emit_main_return_kind(qoz_TypeExpr* ret) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ret);
    qoz_TypeExpr* _qoz_ms_1 = ret; qoz_MainRetKind* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_1 = (qoz_make_MainRetKind_MainRetUnit());  break; } case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_1->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_1->payload.TENamed.f1; qoz_MainRetKind* _qoz_bv_437;
    {
        if ((path.len) != 1) { qoz_string _qoz_bv_438;
    {
        qoz_Strbuf _qoz_sb_5135_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_5135_25); qoz_strings_sb_append(&_qoz_sb_5135_25, sp.file); qoz_strings_sb_append(&_qoz_sb_5135_25, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5135_25, sp.line); qoz_strings_sb_append(&_qoz_sb_5135_25, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5135_25, sp.col); qoz_strings_sb_append(&_qoz_sb_5135_25, QOZ_STR_LIT(": main return type must be a primitive integer or unit")); _qoz_bv_438 = qoz_strings_sb_finish(&_qoz_sb_5135_25);
    }
    qoz_fmt_println(_qoz_bv_438); return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));} qoz_string n = path.data[0]; if (qoz_strings_eq_raw(n, QOZ_STR_LIT("i8"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int8_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("i16"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int16_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("i32"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int32_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("i64"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("u8"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint8_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("u16"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint16_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("u32"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint32_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("u64"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint64_t"));} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("unit"))) { return qoz_make_MainRetKind_MainRetUnit();} if (qoz_strings_eq_raw(n, QOZ_STR_LIT("void"))) { return qoz_make_MainRetKind_MainRetUnit();} qoz_string _qoz_bv_439;
    {
        qoz_Strbuf _qoz_sb_5149_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_5149_21); qoz_strings_sb_append(&_qoz_sb_5149_21, sp.file); qoz_strings_sb_append(&_qoz_sb_5149_21, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5149_21, sp.line); qoz_strings_sb_append(&_qoz_sb_5149_21, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5149_21, sp.col); qoz_strings_sb_append(&_qoz_sb_5149_21, QOZ_STR_LIT(": main may return only integer types or unit, got `")); qoz_strings_sb_append(&_qoz_sb_5149_21, n); qoz_strings_sb_append(&_qoz_sb_5149_21, QOZ_STR_LIT("`")); _qoz_bv_439 = qoz_strings_sb_finish(&_qoz_sb_5149_21);
    }
    qoz_fmt_println(_qoz_bv_439); _qoz_bv_437 = qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));
    }
    _qoz_mv_1 = (_qoz_bv_437);  break; } default: { qoz_MainRetKind* _qoz_bv_430;
    {
        qoz_fmt_println(QOZ_STR_LIT("main return type must be a primitive integer or unit")); _qoz_bv_430 = qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));
    }
    _qoz_mv_1 = (_qoz_bv_430);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_TypeExpr* qoz_ty_ty_to_type_expr_at(qoz_Ty* t, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_1 = t; qoz_TypeExpr* _qoz_mv_1 = NULL; switch (_qoz_ms_1->tag) { case qoz_Ty_TyInt: { qoz_IntInfo info = _qoz_ms_1->payload.TyInt.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TENamed(sp, qoz_ty_ints_to_path(info.width, info.is_signed), qoz_vec_make__qoz_TypeExpr()));  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo info = _qoz_ms_1->payload.TyFloat.f0; qoz_TypeExpr* _qoz_bv_431;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); if (info.width == 32) { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f32")); }  else { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f64")); } _qoz_bv_431 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_1 = (_qoz_bv_431);  break; } case qoz_Ty_TyBool: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Ty_TyChar: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Ty_TyString: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Ty_TyCstring: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("cstring")));  break; } case qoz_Ty_TyUnit: { _qoz_mv_1 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Ty_TyNil: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("nil")));  break; } case qoz_Ty_TyError: { _qoz_mv_1 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("?")));  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_1->payload.TyPtr.f0; _qoz_mv_1 = (qoz_make_TypeExpr_TEPtr(sp, qoz_ty_ty_to_type_expr_at(inner, sp)));  break; } case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_1->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyAdt.f1; _qoz_mv_1 = (qoz_ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyRecord.f1; _qoz_mv_1 = (qoz_ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty fparams = _qoz_ms_1->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_1->payload.TyFn.f1; qoz_TypeExpr* _qoz_bv_432;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; qoz_vec_push__qoz_TypeExpr(&pte, qoz_ty_ty_to_type_expr_at(p, sp)); } }_qoz_bv_432 = qoz_make_TypeExpr_TEFn(sp, pte, qoz_ty_ty_to_type_expr_at(ret, sp));
    }
    _qoz_mv_1 = (_qoz_bv_432);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_1->payload.TyTuple.f0; qoz_TypeExpr* _qoz_bv_433;
    {
        qoz_Vec__qoz_TypeExpr ete = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ete, qoz_ty_ty_to_type_expr_at(el, sp)); } }_qoz_bv_433 = qoz_make_TypeExpr_TETuple(sp, ete);
    }
    _qoz_mv_1 = (_qoz_bv_433);  break; } case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_1->payload.TyVar.f1; _qoz_mv_1 = (qoz_ty_single_path_te(sp, name));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
qoz_string qoz_ty_ty_show(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_1 = t; qoz_string _qoz_mv_1 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_1->tag) { case qoz_Ty_TyInt: { qoz_IntInfo i = _qoz_ms_1->payload.TyInt.f0; qoz_string _qoz_bv_444;
    {
        qoz_string prefix = ((i.is_signed) ? QOZ_STR_LIT("i") : QOZ_STR_LIT("u")); qoz_string w = ((i.width == 8) ? QOZ_STR_LIT("8") : ((i.width == 16) ? QOZ_STR_LIT("16") : ((i.width == 32) ? QOZ_STR_LIT("32") : QOZ_STR_LIT("64")))); _qoz_bv_444 = qoz_strings_cat(prefix, w);
    }
    _qoz_mv_1 = (_qoz_bv_444);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo f = _qoz_ms_1->payload.TyFloat.f0; _qoz_mv_1 = (((f.width == 32) ? QOZ_STR_LIT("f32") : QOZ_STR_LIT("f64")));  break; } case qoz_Ty_TyBool: { _qoz_mv_1 = (QOZ_STR_LIT("bool"));  break; } case qoz_Ty_TyChar: { _qoz_mv_1 = (QOZ_STR_LIT("char"));  break; } case qoz_Ty_TyString: { _qoz_mv_1 = (QOZ_STR_LIT("string"));  break; } case qoz_Ty_TyCstring: { _qoz_mv_1 = (QOZ_STR_LIT("cstring"));  break; } case qoz_Ty_TyUnit: { _qoz_mv_1 = (QOZ_STR_LIT("unit"));  break; } case qoz_Ty_TyNil: { _qoz_mv_1 = (QOZ_STR_LIT("nil"));  break; } case qoz_Ty_TyError: { _qoz_mv_1 = (QOZ_STR_LIT("<error>"));  break; } case qoz_Ty_TyVar: { qoz_string n = _qoz_ms_1->payload.TyVar.f1; _qoz_mv_1 = (n);  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_1->payload.TyPtr.f0; _qoz_mv_1 = (qoz_strings_cat(QOZ_STR_LIT("*"), qoz_ty_ty_show(inner)));  break; } case qoz_Ty_TyAdt: { qoz_string n = _qoz_ms_1->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyAdt.f1; qoz_string _qoz_bv_445;
    {
        if ((args.len) == 0) { return n;} qoz_string out = qoz_strings_cat(n, QOZ_STR_LIT("<")); int64_t i = 0; { qoz_Vec__qoz_Ty __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(a)); i = i + 1; } }_qoz_bv_445 = qoz_strings_cat(out, QOZ_STR_LIT(">"));
    }
    _qoz_mv_1 = (_qoz_bv_445);  break; } case qoz_Ty_TyRecord: { qoz_string n = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_1->payload.TyRecord.f1; qoz_string _qoz_bv_446;
    {
        if ((args.len) == 0) { return n;} qoz_string out = qoz_strings_cat(n, QOZ_STR_LIT("<")); int64_t i = 0; { qoz_Vec__qoz_Ty __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(a)); i = i + 1; } }_qoz_bv_446 = qoz_strings_cat(out, QOZ_STR_LIT(">"));
    }
    _qoz_mv_1 = (_qoz_bv_446);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty params = _qoz_ms_1->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_1->payload.TyFn.f1; qoz_string _qoz_bv_447;
    {
        qoz_string out = QOZ_STR_LIT("fn("); int64_t i = 0; { qoz_Vec__qoz_Ty __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(p)); i = i + 1; } }out = qoz_strings_cat(out, QOZ_STR_LIT(") -> ")); _qoz_bv_447 = qoz_strings_cat(out, qoz_ty_ty_show(ret));
    }
    _qoz_mv_1 = (_qoz_bv_447);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_1->payload.TyTuple.f0; qoz_string _qoz_bv_448;
    {
        qoz_string out = QOZ_STR_LIT("("); int64_t i = 0; { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* e = __col.data[__i]; (void)e; if (i > 0) { out = qoz_strings_cat(out, QOZ_STR_LIT(", ")); } out = qoz_strings_cat(out, qoz_ty_ty_show(e)); i = i + 1; } }_qoz_bv_448 = qoz_strings_cat(out, QOZ_STR_LIT(")"));
    }
    _qoz_mv_1 = (_qoz_bv_448);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
bool qoz_ty_arg_passes_to_param(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    qoz_Ty* _qoz_ms_1 = arg; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Ty_TyError: { _qoz_mv_1 = (true);  break; } case qoz_Ty_TyNil: { _qoz_mv_1 = (qoz_ty_arg_is_nil_accepted_by(param));  break; } case qoz_Ty_TyInt: { qoz_IntInfo ai = _qoz_ms_1->payload.TyInt.f0; bool _qoz_bv_449;
    {
        if (ai.untyped && qoz_ty_untyped_int_fits(param)) { return true;} qoz_Ty* _qoz_ms_2 = param; bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_2->payload.TyInt.f0; _qoz_mv_2 = (qoz_ty_int_widens_to(pi, ai));  break; } default: { _qoz_mv_2 = (false);  break; } } _qoz_bv_449 = _qoz_mv_2;
    }
    _qoz_mv_1 = (_qoz_bv_449);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo af = _qoz_ms_1->payload.TyFloat.f0; bool _qoz_bv_440;
    {
        if (af.untyped && qoz_ty_untyped_float_fits(param)) { return true;} qoz_Ty* _qoz_ms_3 = param; bool _qoz_mv_3 = false; switch (_qoz_ms_3->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_3->payload.TyFloat.f0; _qoz_mv_3 = (pf.width >= af.width);  break; } default: { _qoz_mv_3 = (false);  break; } } _qoz_bv_440 = _qoz_mv_3;
    }
    _qoz_mv_1 = (_qoz_bv_440);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
...
bool qoz_ty_same_constructor_assignable(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    qoz_Ty* _qoz_ms_1 = param; bool _qoz_mv_1 = false; switch (_qoz_ms_1->tag) { case qoz_Ty_TyAdt: { qoz_string pn = _qoz_ms_1->payload.TyAdt.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_1->payload.TyAdt.f1; qoz_Ty* _qoz_ms_2 = arg; bool _qoz_mv_2 = false; switch (_qoz_ms_2->tag) { case qoz_Ty_TyAdt: { qoz_string an = _qoz_ms_2->payload.TyAdt.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_2->payload.TyAdt.f1; bool _qoz_bv_441;
    {
        if (!qoz_strings_eq_raw(pn, an)) { return false;} if ((pa.len) != (aa.len)) { return false;} int64_t i = 0; while (i < (pa.len)) { if (!qoz_ty_ty_assignable(pa.data[i], aa.data[i])) { return false;} i = i + 1; } _qoz_bv_441 = true;
    }
    _qoz_mv_2 = (_qoz_bv_441);  break; } default: { _qoz_mv_2 = (false);  break; } } _qoz_mv_1 = (_qoz_mv_2);  break; } case qoz_Ty_TyRecord: { qoz_string pn = _qoz_ms_1->payload.TyRecord.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_1->payload.TyRecord.f1; qoz_Ty* _qoz_ms_3 = arg; bool _qoz_mv_3 = false; switch (_qoz_ms_3->tag) { case qoz_Ty_TyRecord: { qoz_string an = _qoz_ms_3->payload.TyRecord.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_3->payload.TyRecord.f1; bool _qoz_bv_442;
    {
        if (!qoz_strings_eq_raw(pn, an)) { return false;} if ((pa.len) != (aa.len)) { return false;} int64_t i = 0; while (i < (pa.len)) { if (!qoz_ty_ty_assignable(pa.data[i], aa.data[i])) { return false;} i = i + 1; } _qoz_bv_442 = true;
    }
    _qoz_mv_3 = (_qoz_bv_442);  break; } default: { _qoz_mv_3 = (false);  break; } } _qoz_mv_1 = (_qoz_mv_3);  break; } case qoz_Ty_TyPtr: { qoz_Ty* pi = _qoz_ms_1->payload.TyPtr.f0; qoz_Ty* _qoz_ms_4 = arg; bool _qoz_mv_4 = false; switch (_qoz_ms_4->tag) { case qoz_Ty_TyPtr: { qoz_Ty* ai = _qoz_ms_4->payload.TyPtr.f0; _qoz_mv_4 = (qoz_ty_ty_assignable(pi, ai));  break; } default: { _qoz_mv_4 = (false);  break; } } _qoz_mv_1 = (_qoz_mv_4);  break; } default: { _qoz_mv_1 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_1;
}
