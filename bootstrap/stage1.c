...
qoz_Ty* check_synth_inner(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* e) {
    ...
    _qoz_mv_27 = (_qoz_bv_40);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_27->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_27->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_27->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_27->payload.ECall.f3; _qoz_mv_27 = (check_synth_call_full(tc, env, sp, callee, ta, args));  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_27->payload.EField.f0; qoz_Expr* base = _qoz_ms_27->payload.EField.f1; qoz_string name = _qoz_ms_27->payload.EField.f2; _qoz_mv_27 = (check_synth_field(tc, env, sp, base, name));  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_27->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_27->payload.EIndex.f2; _qoz_mv_27 = (check_synth_index(tc, env, base, idx));  break; } case qoz_Expr_ECast: { qoz_TypeExpr* te = _qoz_ms_27->payload.ECast.f2; _qoz_mv_27 = (check_resolve_type(tc, te));  break; } case qoz_Expr_ETry: { qoz_Expr* v = _qoz_ms_27->payload.ETry.f1; _qoz_mv_27 = (check_synth(tc, env, v));  break; } case qoz_Expr_ETuple: { qoz_Vec__qoz_Expr elems = _qoz_ms_27->payload.ETuple.f1; qoz_Ty* _qoz_bv_41;
    {
        qoz_Vec__qoz_Ty elem_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Ty(&elem_tys, check_synth(tc, env, el)); } }_qoz_bv_41 = ty_ty_tuple_(elem_tys);
    }
    _qoz_mv_27 = (_qoz_bv_41);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_27->payload.ERecord.f1; _qoz_mv_27 = (check_resolve_type(tc, te));  break; } case qoz_Expr_EClosure: { qoz_Vec__qoz_ClosureParam cps = _qoz_ms_27->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_27->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_27->payload.EClosure.f3; qoz_Ty* _qoz_bv_42;
    {
        qoz_Vec__qoz_Ty pty = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_Ty* t = check_resolve_type(tc, cp.ty); qoz_gc_push_root(&t); qoz_vec_push__qoz_Ty(&pty, t); check_env_define(env, cp.name, t); } }(void)(check_synth(tc, env, body)); _qoz_bv_42 = ty_ty_fn_(pty, check_resolve_type(tc, ret));
    }
    _qoz_mv_27 = (_qoz_bv_42);  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_27->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_27->payload.EBlock.f2; _qoz_mv_27 = (check_synth_block(tc, env, stmts, tail));  break; } case qoz_Expr_EIf: { qoz_Expr* c = _qoz_ms_27->payload.EIf.f1; qoz_Expr* t = _qoz_ms_27->payload.EIf.f2; qoz_Expr* f = _qoz_ms_27->payload.EIf.f3; _qoz_mv_27 = (check_synth_if(tc, env, c, t, f));  break; } case qoz_Expr_EMatch: { qoz_Expr* scrut = _qoz_ms_27->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_27->payload.EMatch.f2; _qoz_mv_27 = (check_synth_match(tc, env, scrut, arms));  break; } case qoz_Expr_EWhile: { qoz_Expr* c = _qoz_ms_27->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_27->payload.EWhile.f2; qoz_Ty* _qoz_bv_43;
    {
        (void)(check_synth(tc, env, c)); (void)(check_synth(tc, env, b)); _qoz_bv_43 = ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_43);  break; } case qoz_Expr_EFor: { qoz_string b1 = _qoz_ms_27->payload.EFor.f1; qoz_string b2 = _qoz_ms_27->payload.EFor.f2; qoz_Expr* it = _qoz_ms_27->payload.EFor.f3; qoz_Expr* b = _qoz_ms_27->payload.EFor.f4; qoz_Ty* _qoz_bv_44;
    {
        qoz_Ty* it_ty = check_synth(tc, env, it); qoz_gc_push_root(&it_ty); int64_t saved_len = (env->bindings.len); check_bind_for_loop(env, b1, b2, it_ty); (void)(check_synth(tc, env, b)); check_env_truncate(env, saved_len); _qoz_bv_44 = ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_44);  break; } case qoz_Expr_EReturn: { qoz_Expr* v = _qoz_ms_27->payload.EReturn.f1; qoz_Ty* _qoz_bv_45;
    {
        (void)(check_synth(tc, env, v)); _qoz_bv_45 = ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_45);  break; } case qoz_Expr_EDefer: { qoz_Expr* b = _qoz_ms_27->payload.EDefer.f1; qoz_Ty* _qoz_bv_46;
    {
        (void)(check_synth(tc, env, b)); _qoz_bv_46 = ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_46);  break; } case qoz_Expr_ESizeOf: { _qoz_mv_27 = (ty_ty_int_(64, true));  break; } case qoz_Expr_EArrayLit: { qoz_Vec__qoz_Expr elems = _qoz_ms_27->payload.EArrayLit.f1; qoz_Ty* _qoz_bv_47;
    {
        if ((elems.len) == 0) { return ty_ty_error_();} qoz_Ty* elem_ty = check_synth(tc, env, elems.data[0]); qoz_gc_push_root(&elem_ty); int64_t i = 1; while (i < (elems.len)) { (void)(check_synth(tc, env, elems.data[i])); i = i + 1; } qoz_Vec__qoz_Ty args = qoz_vec_make__qoz_Ty(); qoz_vec_push__qoz_Ty(&args, elem_ty); _qoz_bv_47 = ty_ty_record_(QOZ_STR_LIT("Vec"), args);
    }
    _qoz_mv_27 = (_qoz_bv_47);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_27;
}
...
qoz_Ty* check_field_type_of(qoz_TyContext* tc, qoz_Ty* bt, qoz_string name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&bt);
    qoz_Ty* _qoz_ms_30 = bt; qoz_Ty* _qoz_mv_30 = NULL; switch (_qoz_ms_30->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_30->payload.TyPtr.f0; _qoz_mv_30 = (check_field_type_of(tc, inner, name));  break; } case qoz_Ty_TyRecord: { qoz_string struct_name = _qoz_ms_30->payload.TyRecord.f0; qoz_Vec__qoz_Ty tyargs = _qoz_ms_30->payload.TyRecord.f1; _qoz_mv_30 = (check_lookup_field(tc, struct_name, tyargs, name));  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_30->payload.TyTuple.f0; qoz_Ty* _qoz_bv_48;
    {
        if (((name).len >= 2) && (qoz_string_byte_at(name, 0) == 95)) { int64_t idx = qoz_string_parse_int(qoz_string_slice(name, 1, (name).len)); if ((idx >= 0) && (idx < (elems.len))) { return elems.data[idx];} } _qoz_bv_48 = ty_ty_error_();
    }
    _qoz_mv_30 = (_qoz_bv_48);  break; } default: { _qoz_mv_30 = (ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_30;
}

qoz_Ty* check_lookup_field(qoz_TyContext* tc, qoz_string struct_name, qoz_Vec__qoz_Ty tyargs, qoz_string field) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_Option__qoz_Decl* _qoz_ms_31 = qoz_map_get__qoz_string__qoz_Decl(&tc->structs, struct_name); qoz_Ty* _qoz_mv_31 = NULL; switch (_qoz_ms_31->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_31->payload.Some.f0; qoz_Decl* _qoz_ms_32 = d; qoz_Ty* _qoz_mv_32 = NULL; switch (_qoz_ms_32->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_32->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_32->payload.DStruct.f3; qoz_Ty* _qoz_bv_49;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_string_eq(f.name, field)) { if ((params.len) == (tyargs.len)) { return check_resolve_type_with_subst(tc, f.ty, params, tyargs);} return check_resolve_type(tc, f.ty);} } }_qoz_bv_49 = ty_ty_error_();
    }
    _qoz_mv_32 = (_qoz_bv_49);  break; } default: { _qoz_mv_32 = (ty_ty_error_());  break; } } _qoz_mv_31 = (_qoz_mv_32);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_31 = (ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_31;
}
...
qoz_Ty* check_apply_subst(qoz_Ty* t, qoz_Vec__qoz_string params, qoz_Vec__qoz_Ty args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_33 = t; qoz_Ty* _qoz_mv_33 = NULL; switch (_qoz_ms_33->tag) { case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_33->payload.TyVar.f1; qoz_Ty* _qoz_bv_50;
    {
        int64_t i = 0; { qoz_Vec__qoz_string __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string p = __col.data[__i]; (void)p; if (qoz_string_eq(p, name)) { if (i < (args.len)) { return args.data[i];} return t;} i = i + 1; } }_qoz_bv_50 = t;
    }
    _qoz_mv_33 = (_qoz_bv_50);  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_33->payload.TyPtr.f0; _qoz_mv_33 = (ty_ty_ptr_(check_apply_subst(inner, params, args)));  break; } case qoz_Ty_TyAdt: { qoz_string n = _qoz_ms_33->payload.TyAdt.f0; qoz_Vec__qoz_Ty a = _qoz_ms_33->payload.TyAdt.f1; qoz_Ty* _qoz_bv_51;
    {
        qoz_Vec__qoz_Ty na = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = a; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&na, check_apply_subst(x, params, args)); } }_qoz_bv_51 = ty_ty_adt_(n, na);
    }
    _qoz_mv_33 = (_qoz_bv_51);  break; } case qoz_Ty_TyRecord: { qoz_string n = _qoz_ms_33->payload.TyRecord.f0; qoz_Vec__qoz_Ty a = _qoz_ms_33->payload.TyRecord.f1; qoz_Ty* _qoz_bv_52;
    {
        qoz_Vec__qoz_Ty na = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = a; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&na, check_apply_subst(x, params, args)); } }_qoz_bv_52 = ty_ty_record_(n, na);
    }
    _qoz_mv_33 = (_qoz_bv_52);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty p = _qoz_ms_33->payload.TyFn.f0; qoz_Ty* r = _qoz_ms_33->payload.TyFn.f1; qoz_Ty* _qoz_bv_53;
    {
        qoz_Vec__qoz_Ty np = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = p; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&np, check_apply_subst(x, params, args)); } }_qoz_bv_53 = ty_ty_fn_(np, check_apply_subst(r, params, args));
    }
    _qoz_mv_33 = (_qoz_bv_53);  break; } default: { _qoz_mv_33 = (t);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_33;
}
...
qoz_Ty* check_synth_index(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* base, qoz_Expr* idx) {
    ...
    qoz_Ty* bt = check_synth(tc, env, base); qoz_gc_push_root(&bt); (void)(check_synth(tc, env, idx)); qoz_Ty* _qoz_ms_34 = bt; qoz_Ty* _qoz_mv_34 = NULL; switch (_qoz_ms_34->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_34->payload.TyPtr.f0; _qoz_mv_34 = (inner);  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_34->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_34->payload.TyRecord.f1; qoz_Ty* _qoz_bv_54;
    {
        if (qoz_string_eq(name, QOZ_STR_LIT("Vec")) && ((args.len) >= 1)) { return args.data[0];} _qoz_bv_54 = ty_ty_error_();
    }
    _qoz_mv_34 = (_qoz_bv_54);  break; } default: { _qoz_mv_34 = (ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_34;
}

bool check_is_strings_callee(qoz_Expr* callee, qoz_string method) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_35 = callee; bool _qoz_mv_35 = false; switch (_qoz_ms_35->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_35->payload.EField.f1; qoz_string m = _qoz_ms_35->payload.EField.f2; bool _qoz_bv_55;
    {
        if (!qoz_string_eq(m, method)) { return false;} qoz_Expr* _qoz_ms_36 = base; bool _qoz_mv_36 = false; switch (_qoz_ms_36->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_36->payload.EIdent.f1; _qoz_mv_36 = (qoz_string_eq(name, QOZ_STR_LIT("strings")));  break; } default: { _qoz_mv_36 = (false);  break; } } _qoz_bv_55 = _qoz_mv_36;
    }
    _qoz_mv_35 = (_qoz_bv_55);  break; } default: { _qoz_mv_35 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_35;
}
...
qoz_string check_resolve_callee_fn(qoz_TyContext* tc, qoz_Expr* callee) {
    ...
    {
        if (qoz_map_contains__qoz_string__bool(&tc->packages, pkg)) { return qoz_string_cat(qoz_string_cat(pkg, QOZ_STR_LIT("_")), method);} _qoz_bv_56 = QOZ_STR_LIT("");
    }
    _qoz_mv_39 = (_qoz_bv_56);  break; } default: { _qoz_mv_39 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_38 = (_qoz_mv_39);  break; } default: { _qoz_mv_38 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_38;
}
...
qoz_Ty* check_synth_call_with_decl(qoz_TyContext* tc, qoz_Span sp, qoz_Decl* d, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Ty arg_tys) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_45 = d; qoz_Ty* _qoz_mv_45 = NULL; switch (_qoz_ms_45->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_45->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_45->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_45->payload.DFn.f4; qoz_Ty* _qoz_bv_58;
    {
    ...
    {
        qoz_Strbuf _qoz_sb_508_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_508_42); strings_sb_append(&_qoz_sb_508_42, QOZ_STR_LIT("type parameter `")); strings_sb_append(&_qoz_sb_508_42, tp); strings_sb_append(&_qoz_sb_508_42, QOZ_STR_LIT("` is not constrained by any argument; add an explicit annotation")); _qoz_bv_59 = strings_sb_finish(&_qoz_sb_508_42);
    }
    check_record_error(tc, sp, _qoz_bv_59); qoz_vec_push__qoz_Ty(&tyarg_tys, ty_ty_error_()); 
    }
    0;  break; } } 0; } }} qoz_Map__qoz_string__bool saved_b = tc->type_params; check_set_type_params(tc, tparams); qoz_Ty* raw_ret = check_resolve_type(tc, ret); qoz_gc_push_root(&raw_ret); tc->type_params = saved_b; _qoz_bv_58 = check_apply_subst(raw_ret, tparams, tyarg_tys);
    }
    _qoz_mv_45 = (_qoz_bv_58);  break; } case qoz_Decl_DExternal: { qoz_TypeExpr* ret = _qoz_ms_45->payload.DExternal.f4; _qoz_mv_45 = (check_resolve_type(tc, ret));  break; } default: { _qoz_mv_45 = (ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_45;
}
...
bool check_compatible_or_refine(qoz_Map__qoz_string__qoz_Ty* env, qoz_string name, qoz_Ty* prior, qoz_Ty* concrete) {
    ...
    qoz_gc_push_root(&concrete);
    if (ty_ty_eq(prior, concrete)) { return true;} qoz_Ty* _qoz_ms_55 = prior; bool _qoz_mv_55 = false; switch (_qoz_ms_55->tag) { case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_55->payload.TyInt.f0; qoz_Ty* _qoz_ms_56 = concrete; bool _qoz_mv_56 = false; switch (_qoz_ms_56->tag) { case qoz_Ty_TyInt: { qoz_IntInfo ci = _qoz_ms_56->payload.TyInt.f0; bool _qoz_bv_61;
    {
        if (ci.untyped) { return true;} if (pi.untyped) { qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); return true;} _qoz_bv_61 = false;
    }
    _qoz_mv_56 = (_qoz_bv_61);  break; } default: { _qoz_mv_56 = (false);  break; } } _qoz_mv_55 = (_qoz_mv_56);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_55->payload.TyFloat.f0; qoz_Ty* _qoz_ms_57 = concrete; bool _qoz_mv_57 = false; switch (_qoz_ms_57->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo cf = _qoz_ms_57->payload.TyFloat.f0; bool _qoz_bv_62;
    {
        if (cf.untyped) { return true;} if (pf.untyped) { qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); return true;} _qoz_bv_62 = false;
    }
    _qoz_mv_57 = (_qoz_bv_62);  break; } default: { _qoz_mv_57 = (false);  break; } } _qoz_mv_55 = (_qoz_mv_57);  break; } default: { _qoz_mv_55 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_55;
}
...
qoz_Ty* check_synth_ident(qoz_TyContext* tc, qoz_Env* env, qoz_Span span, qoz_string name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&env);
    if (check_env_has(env, name)) { return check_env_lookup(env, name);} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->fns, name)) { return ty_ty_error_();} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->externs, name)) { return ty_ty_error_();} qoz_Option__qoz_string* _qoz_ms_59 = qoz_map_get__qoz_string__qoz_string(&tc->variant_of, name); switch (_qoz_ms_59->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_59->payload.Some.f0; return check_synth_variant_ctor(tc, name); break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; qoz_string _qoz_bv_63;
    {
        qoz_Strbuf _qoz_sb_641_28 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_641_28); strings_sb_append(&_qoz_sb_641_28, QOZ_STR_LIT("undefined name `")); strings_sb_append(&_qoz_sb_641_28, name); strings_sb_append(&_qoz_sb_641_28, QOZ_STR_LIT("`")); _qoz_bv_63 = strings_sb_finish(&_qoz_sb_641_28);
    }
    check_record_error(tc, span, _qoz_bv_63); qoz_gc_shadow_set_top(_qoz_shadow_guard); return ty_ty_error_();
}
...
qoz_Ty* check_synth_block(qoz_TyContext* tc, qoz_Env* env, qoz_Vec__qoz_Stmt stmts, qoz_Expr* tail) {
    ...
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* ex = _qoz_ms_61->payload.SExpr.f1; void* _qoz_bv_64;
    {
        (void)(check_synth(tc, env, ex)); _qoz_bv_64 = NULL;
    }
    _qoz_bv_64;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return check_synth(tc, env, tail);
}
...
qoz_Decl* check_infer_calls_decl(qoz_TyContext* tc, qoz_Decl* d) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_77 = d; qoz_Decl* _qoz_mv_77 = NULL; switch (_qoz_ms_77->tag) { case qoz_Decl_DFn: { qoz_Span sp = _qoz_ms_77->payload.DFn.f0; qoz_string name = _qoz_ms_77->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_77->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_77->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_77->payload.DFn.f4; qoz_Expr* body = _qoz_ms_77->payload.DFn.f5; qoz_string attr = _qoz_ms_77->payload.DFn.f6; qoz_Decl* _qoz_bv_65;
    {
        check_set_type_params(tc, tparams); qoz_Env env = check_env_make(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; check_env_define(&env, pp.name, check_resolve_type(tc, pp.ty)); } }qoz_Ty* ret_ty = check_resolve_type(tc, ret); qoz_gc_push_root(&ret_ty); qoz_Expr* new_body = check_infer_calls_expr(tc, &env, body, ret_ty); qoz_gc_push_root(&new_body); check_clear_type_params(tc); _qoz_bv_65 = qoz_make_Decl_DFn(sp, name, tparams, params, ret, new_body, attr);
    }
    _qoz_mv_77 = (_qoz_bv_65);  break; } case qoz_Decl_DConst: { qoz_Span sp = _qoz_ms_77->payload.DConst.f0; qoz_string name = _qoz_ms_77->payload.DConst.f1; qoz_TypeExpr* t = _qoz_ms_77->payload.DConst.f2; qoz_Expr* val = _qoz_ms_77->payload.DConst.f3; qoz_Decl* _qoz_bv_66;
    {
        qoz_Env env = check_env_make(); qoz_Ty* expected = check_resolve_type(tc, t); qoz_gc_push_root(&expected); qoz_Expr* new_val = check_infer_calls_expr(tc, &env, val, expected); qoz_gc_push_root(&new_val); _qoz_bv_66 = qoz_make_Decl_DConst(sp, name, t, new_val);
    }
    _qoz_mv_77 = (_qoz_bv_66);  break; } default: { _qoz_mv_77 = (d);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_77;
}
...
qoz_Expr* check_infer_calls_expr(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* e, qoz_Ty* expected) {
    ...
    qoz_Expr* _qoz_ms_78 = e; qoz_Expr* _qoz_mv_78 = NULL; switch (_qoz_ms_78->tag) { case qoz_Expr_EInt: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EFloat: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EString: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EChar: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EBool: { _qoz_mv_78 = (e);  break; } case qoz_Expr_ENil: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EIdent: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EPath: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_78->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_78->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_78->payload.EUnary.f2; _qoz_mv_78 = (qoz_make_Expr_EUnary(sp, op, check_infer_calls_expr(tc, env, rhs, ty_ty_error_())));  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_78->payload.EBinary.f0; qoz_BinaryOp* op = _qoz_ms_78->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_78->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_78->payload.EBinary.f3; _qoz_mv_78 = (qoz_make_Expr_EBinary(sp, op, check_infer_calls_expr(tc, env, l, ty_ty_error_()), check_infer_calls_expr(tc, env, r, ty_ty_error_())));  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_78->payload.EAssign.f0; qoz_AssignOp* op = _qoz_ms_78->payload.EAssign.f1; qoz_Expr* l = _qoz_ms_78->payload.EAssign.f2; qoz_Expr* r = _qoz_ms_78->payload.EAssign.f3; qoz_Expr* _qoz_bv_67;
    {
        qoz_Expr* new_l = check_infer_calls_expr(tc, env, l, ty_ty_error_()); qoz_gc_push_root(&new_l); qoz_Ty* lhs_ty = check_synth(tc, env, l); qoz_gc_push_root(&lhs_ty); _qoz_bv_67 = qoz_make_Expr_EAssign(sp, op, new_l, check_infer_calls_expr(tc, env, r, lhs_ty));
    }
    _qoz_mv_78 = (_qoz_bv_67);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_78->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_78->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_78->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_78->payload.ECall.f3; _qoz_mv_78 = (check_rewrite_call(tc, env, sp, callee, ta, args, expected));  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_78->payload.EField.f0; qoz_Expr* base = _qoz_ms_78->payload.EField.f1; qoz_string name = _qoz_ms_78->payload.EField.f2; _qoz_mv_78 = (qoz_make_Expr_EField(sp, check_infer_calls_expr(tc, env, base, ty_ty_error_()), name));  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_78->payload.EIndex.f0; qoz_Expr* base = _qoz_ms_78->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_78->payload.EIndex.f2; _qoz_mv_78 = (qoz_make_Expr_EIndex(sp, check_infer_calls_expr(tc, env, base, ty_ty_error_()), check_infer_calls_expr(tc, env, idx, ty_ty_error_())));  break; } case qoz_Expr_ECast: { qoz_Span sp = _qoz_ms_78->payload.ECast.f0; qoz_Expr* value = _qoz_ms_78->payload.ECast.f1; qoz_TypeExpr* t = _qoz_ms_78->payload.ECast.f2; _qoz_mv_78 = (qoz_make_Expr_ECast(sp, check_infer_calls_expr(tc, env, value, ty_ty_error_()), t));  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_78->payload.ETry.f0; qoz_Expr* v = _qoz_ms_78->payload.ETry.f1; _qoz_mv_78 = (qoz_make_Expr_ETry(sp, check_infer_calls_expr(tc, env, v, expected)));  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_78->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_78->payload.ETuple.f1; qoz_Expr* _qoz_bv_68;
    {
        qoz_Vec__qoz_Expr ne = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&ne, check_infer_calls_expr(tc, env, el, ty_ty_error_())); } }_qoz_bv_68 = qoz_make_Expr_ETuple(sp, ne);
    }
    _qoz_mv_78 = (_qoz_bv_68);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_78->payload.ERecord.f0; qoz_TypeExpr* te = _qoz_ms_78->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_78->payload.ERecord.f2; qoz_Expr* _qoz_bv_69;
    {
        qoz_TypeExpr* effective_te = check_pick_record_type(te, expected); qoz_gc_push_root(&effective_te); qoz_Vec__qoz_RecordFieldLit nf = qoz_vec_make__qoz_RecordFieldLit(); { qoz_Vec__qoz_RecordFieldLit __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; qoz_Ty* field_hint = check_record_field_hint(tc, effective_te, f.name); qoz_gc_push_root(&field_hint); qoz_vec_push__qoz_RecordFieldLit(&nf, ((qoz_RecordFieldLit){ .name = f.name, .value = check_infer_calls_expr(tc, env, f.value, field_hint) })); } }_qoz_bv_69 = qoz_make_Expr_ERecord(sp, te, nf);
    }
    _qoz_mv_78 = (_qoz_bv_69);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_78->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_78->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_78->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_78->payload.EClosure.f3; _qoz_mv_78 = (qoz_make_Expr_EClosure(sp, cps, ret, check_infer_calls_expr(tc, env, body, ty_ty_error_())));  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_78->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_78->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_78->payload.EBlock.f2; qoz_Expr* _qoz_bv_70;
    {
        qoz_Vec__qoz_Stmt ns = qoz_vec_make__qoz_Stmt(); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_vec_push__qoz_Stmt(&ns, check_infer_calls_stmt(tc, env, s)); } }_qoz_bv_70 = qoz_make_Expr_EBlock(sp, ns, check_infer_calls_expr(tc, env, tail, expected));
    }
    _qoz_mv_78 = (_qoz_bv_70);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_78->payload.EIf.f0; qoz_Expr* c = _qoz_ms_78->payload.EIf.f1; qoz_Expr* t = _qoz_ms_78->payload.EIf.f2; qoz_Expr* f = _qoz_ms_78->payload.EIf.f3; _qoz_mv_78 = (qoz_make_Expr_EIf(sp, check_infer_calls_expr(tc, env, c, ty_ty_error_()), check_infer_calls_expr(tc, env, t, expected), check_infer_calls_expr(tc, env, f, expected)));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_78->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_78->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_78->payload.EMatch.f2; qoz_Expr* _qoz_bv_71;
    {
        qoz_Expr* new_scrut = check_infer_calls_expr(tc, env, scrut, ty_ty_error_()); qoz_gc_push_root(&new_scrut); qoz_Ty* scrut_ty = check_synth(tc, env, scrut); qoz_gc_push_root(&scrut_ty); qoz_Vec__qoz_MatchArm na = qoz_vec_make__qoz_MatchArm(); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm a = __col.data[__i]; (void)a; int64_t saved_len = (env->bindings.len); check_bind_pattern(tc, env, a.pat, scrut_ty); qoz_vec_push__qoz_MatchArm(&na, ((qoz_MatchArm){ .pat = a.pat, .body = check_infer_calls_expr(tc, env, a.body, expected), .has_guard = a.has_guard, .guard = a.guard })); check_env_truncate(env, saved_len); } }_qoz_bv_71 = qoz_make_Expr_EMatch(sp, new_scrut, na);
    }
    _qoz_mv_78 = (_qoz_bv_71);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_78->payload.EWhile.f0; qoz_Expr* c = _qoz_ms_78->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_78->payload.EWhile.f2; _qoz_mv_78 = (qoz_make_Expr_EWhile(sp, check_infer_calls_expr(tc, env, c, ty_ty_error_()), check_infer_calls_expr(tc, env, b, ty_ty_error_())));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_78->payload.EFor.f0; qoz_string b1 = _qoz_ms_78->payload.EFor.f1; qoz_string b2 = _qoz_ms_78->payload.EFor.f2; qoz_Expr* it = _qoz_ms_78->payload.EFor.f3; qoz_Expr* body = _qoz_ms_78->payload.EFor.f4; qoz_Expr* _qoz_bv_72;
    {
        qoz_Expr* new_it = check_infer_calls_expr(tc, env, it, ty_ty_error_()); qoz_gc_push_root(&new_it); qoz_Ty* it_ty = check_synth(tc, env, it); qoz_gc_push_root(&it_ty); int64_t saved_len = (env->bindings.len); check_bind_for_loop(env, b1, b2, it_ty); qoz_Expr* new_body = check_infer_calls_expr(tc, env, body, ty_ty_error_()); qoz_gc_push_root(&new_body); check_env_truncate(env, saved_len); _qoz_bv_72 = qoz_make_Expr_EFor(sp, b1, b2, new_it, new_body);
    }
    _qoz_mv_78 = (_qoz_bv_72);  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_78->payload.EReturn.f0; qoz_Expr* v = _qoz_ms_78->payload.EReturn.f1; _qoz_mv_78 = (qoz_make_Expr_EReturn(sp, check_infer_calls_expr(tc, env, v, expected)));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_78->payload.EDefer.f0; qoz_Expr* v = _qoz_ms_78->payload.EDefer.f1; _qoz_mv_78 = (qoz_make_Expr_EDefer(sp, check_infer_calls_expr(tc, env, v, ty_ty_error_())));  break; } case qoz_Expr_ESizeOf: { _qoz_mv_78 = (e);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_78->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_78->payload.EArrayLit.f1; qoz_Expr* _qoz_bv_73;
    {
        qoz_Vec__qoz_Expr ne = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&ne, check_infer_calls_expr(tc, env, el, ty_ty_error_())); } }_qoz_bv_73 = qoz_make_Expr_EArrayLit(sp, ne);
    }
    _qoz_mv_78 = (_qoz_bv_73);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_78;
}
...
qoz_Stmt* check_infer_calls_stmt(qoz_TyContext* tc, qoz_Env* env, qoz_Stmt* s) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_79 = s; qoz_Stmt* _qoz_mv_79 = NULL; switch (_qoz_ms_79->tag) { case qoz_Stmt_SLet: { qoz_Span sp = _qoz_ms_79->payload.SLet.f0; qoz_string name = _qoz_ms_79->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_79->payload.SLet.f2; qoz_Expr* val = _qoz_ms_79->payload.SLet.f3; qoz_Stmt* _qoz_bv_74;
    {
        qoz_Ty* annotated = check_resolve_type(tc, te); qoz_gc_push_root(&annotated); qoz_Expr* new_val = check_infer_calls_expr(tc, env, val, annotated); qoz_gc_push_root(&new_val); qoz_Ty* binding_ty = ((check_is_ty_unit_or_error(annotated)) ? check_synth(tc, env, new_val) : annotated); qoz_gc_push_root(&binding_ty); check_env_define(env, name, binding_ty); _qoz_bv_74 = qoz_make_Stmt_SLet(sp, name, te, new_val);
    }
    _qoz_mv_79 = (_qoz_bv_74);  break; } case qoz_Stmt_SVar: { qoz_Span sp = _qoz_ms_79->payload.SVar.f0; qoz_string name = _qoz_ms_79->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_79->payload.SVar.f2; qoz_Expr* val = _qoz_ms_79->payload.SVar.f3; qoz_Stmt* _qoz_bv_75;
    {
        qoz_Ty* annotated = check_resolve_type(tc, te); qoz_gc_push_root(&annotated); qoz_Expr* new_val = check_infer_calls_expr(tc, env, val, annotated); qoz_gc_push_root(&new_val); qoz_Ty* binding_ty = ((check_is_ty_unit_or_error(annotated)) ? check_synth(tc, env, new_val) : annotated); qoz_gc_push_root(&binding_ty); check_env_define(env, name, binding_ty); _qoz_bv_75 = qoz_make_Stmt_SVar(sp, name, te, new_val);
    }
    _qoz_mv_79 = (_qoz_bv_75);  break; } case qoz_Stmt_SExpr: { qoz_Span sp = _qoz_ms_79->payload.SExpr.f0; qoz_Expr* x = _qoz_ms_79->payload.SExpr.f1; _qoz_mv_79 = (qoz_make_Stmt_SExpr(sp, check_infer_calls_expr(tc, env, x, ty_ty_error_())));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_79;
}
...
qoz_TypeExpr* check_pick_record_type(qoz_TypeExpr* te, qoz_Ty* expected) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&expected);
    qoz_TypeExpr* _qoz_ms_80 = te; qoz_TypeExpr* _qoz_mv_80 = NULL; switch (_qoz_ms_80->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_80->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_80->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_80->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_76;
    {
        if ((args.len) > 0) { return te;} if ((path.len) != 1) { return te;} qoz_Ty* _qoz_ms_81 = expected; qoz_TypeExpr* _qoz_mv_81 = NULL; switch (_qoz_ms_81->tag) { case qoz_Ty_TyRecord: { qoz_string en = _qoz_ms_81->payload.TyRecord.f0; qoz_Vec__qoz_Ty eargs = _qoz_ms_81->payload.TyRecord.f1; qoz_TypeExpr* _qoz_bv_77;
    {
        if (qoz_string_eq(path.data[0], en) && ((eargs.len) > 0)) { qoz_Vec__qoz_TypeExpr ta = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = eargs; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_TypeExpr(&ta, ty_ty_to_type_expr_at(a, sp)); } }return qoz_make_TypeExpr_TENamed(sp, path, ta);} _qoz_bv_77 = te;
    }
    _qoz_mv_81 = (_qoz_bv_77);  break; } default: { _qoz_mv_81 = (te);  break; } } _qoz_bv_76 = _qoz_mv_81;
    }
    _qoz_mv_80 = (_qoz_bv_76);  break; } default: { _qoz_mv_80 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_80;
}
...
void check_check_fn_bodies(qoz_TyContext* tc, qoz_File f) {
    ...
    0;  break; } case qoz_Decl_DImport: { NULL;  break; } case qoz_Decl_DStruct: { NULL;  break; } case qoz_Decl_DEnum: { NULL;  break; } case qoz_Decl_DTypeAlias: { NULL;  break; } case qoz_Decl_DConst: { qoz_Expr* val = _qoz_ms_97->payload.DConst.f3; void* _qoz_bv_83;
    {
        qoz_Env env = check_env_make(); (void)(check_synth(tc, &env, val)); _qoz_bv_83 = NULL;
    }
    _qoz_bv_83;  break; } case qoz_Decl_DExternal: { NULL;  break; } case qoz_Decl_DLink: { NULL;  break; } } 0; } }
    return;
}
...
void check_validate_signatures(qoz_TyContext* tc, qoz_File f) {
    ...
    0;  break; } case qoz_Decl_DExternal: { qoz_Vec__qoz_FnParam params = _qoz_ms_98->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_98->payload.DExternal.f4; void* _qoz_bv_84;
    {
        { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; (void)(check_resolve_type(tc, pp.ty)); } }(void)(check_resolve_type(tc, ret)); _qoz_bv_84 = NULL;
    }
    _qoz_bv_84;  break; } case qoz_Decl_DStruct: { qoz_Vec__qoz_string tparams = _qoz_ms_98->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_98->payload.DStruct.f3; {
    ...
    0;  break; } case qoz_Decl_DConst: { qoz_TypeExpr* ty = _qoz_ms_98->payload.DConst.f2; void* _qoz_bv_85;
    {
        (void)(check_resolve_type(tc, ty)); _qoz_bv_85 = NULL;
    }
    _qoz_bv_85;  break; } case qoz_Decl_DImport: { NULL;  break; } case qoz_Decl_DLink: { NULL;  break; } } 0; } }
    return;
}
...
qoz_string emit_generic_callee_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    {
        if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_string_cat(qoz_string_cat(pkg, QOZ_STR_LIT("_")), method);} _qoz_bv_86 = QOZ_STR_LIT("");
    }
    _qoz_mv_101 = (_qoz_bv_86);  break; } default: { _qoz_mv_101 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_100 = (_qoz_mv_101);  break; } default: { _qoz_mv_100 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_100;
}
...
qoz_string emit_mangle_type(qoz_Emitter* e, qoz_TypeExpr* t) {
    ...
    {
        qoz_string acc = QOZ_STR_LIT("tuple"); { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; acc = qoz_string_cat(acc, QOZ_STR_LIT("__")); acc = qoz_string_cat(acc, emit_mangle_type(e, el)); } }_qoz_bv_87 = acc;
    }
    _qoz_mv_114 = (_qoz_bv_87);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_114->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_114->payload.TENamed.f2; _qoz_mv_114 = (emit_mangle_named(e, path, args));  break; } case qoz_TypeExpr_TEFn: { _qoz_mv_114 = (QOZ_STR_LIT("fn"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_114;
}
...
qoz_TypeExpr* emit_substitute_type(qoz_Emitter* e, qoz_TypeExpr* t, qoz_Vec__qoz_string params, qoz_Vec__qoz_TypeExpr args) {
    ...
    {
        qoz_Vec__qoz_TypeExpr new_elems = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&new_elems, emit_substitute_type(e, el, params, args)); } }_qoz_bv_88 = qoz_make_TypeExpr_TETuple(span, new_elems);
    }
    _qoz_mv_115 = (_qoz_bv_88);  break; } case qoz_TypeExpr_TENamed: { qoz_Span span = _qoz_ms_115->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_115->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr t_args = _qoz_ms_115->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_89;
    {
        if (((path.len) == 1) && ((t_args.len) == 0)) { qoz_string n = path.data[0]; int64_t i = 0; { qoz_Vec__qoz_string __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string p = __col.data[__i]; (void)p; if (qoz_string_eq(p, n)) { return args.data[i];} i = i + 1; } }} qoz_Vec__qoz_TypeExpr new_args = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = t_args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_TypeExpr(&new_args, emit_substitute_type(e, a, params, args)); } }_qoz_bv_89 = qoz_make_TypeExpr_TENamed(span, path, new_args);
    }
    _qoz_mv_115 = (_qoz_bv_89);  break; } case qoz_TypeExpr_TEFn: { qoz_Span span = _qoz_ms_115->payload.TEFn.f0; qoz_Vec__qoz_TypeExpr fparams = _qoz_ms_115->payload.TEFn.f1; qoz_TypeExpr* ret = _qoz_ms_115->payload.TEFn.f2; qoz_TypeExpr* _qoz_bv_90;
    {
        qoz_Vec__qoz_TypeExpr new_fparams = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* fp = __col.data[__i]; (void)fp; qoz_vec_push__qoz_TypeExpr(&new_fparams, emit_substitute_type(e, fp, params, args)); } }_qoz_bv_90 = qoz_make_TypeExpr_TEFn(span, new_fparams, emit_substitute_type(e, ret, params, args));
    }
    _qoz_mv_115 = (_qoz_bv_90);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_115;
}
...
qoz_string emit_operator_first_param_type_name(qoz_TypeExpr* te) {
    ...
    _qoz_mv_119 = (_qoz_bv_98);  break; } default: { _qoz_mv_119 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_118 = (_qoz_mv_119);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_118->payload.TENamed.f1; qoz_string _qoz_bv_99;
    {
        if ((path.len) > 0) { return path.data[(path.len) - 1];} _qoz_bv_99 = QOZ_STR_LIT("");
    }
    _qoz_mv_118 = (_qoz_bv_99);  break; } default: { _qoz_mv_118 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_118;
}
...
qoz_string emit_result_mangle_for(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_126 = te; qoz_string _qoz_mv_126 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_126->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_126->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_126->payload.TENamed.f2; qoz_string _qoz_bv_101;
    {
        if ((path.len) == 0) { return QOZ_STR_LIT("");} qoz_string last = path.data[(path.len) - 1]; if (!qoz_string_eq(last, QOZ_STR_LIT("Result"))) { return QOZ_STR_LIT("");} if ((args.len) != 2) { return QOZ_STR_LIT("");} _qoz_bv_101 = emit_mangle_inst(e, QOZ_STR_LIT("Result"), args);
    }
    _qoz_mv_126 = (_qoz_bv_101);  break; } default: { _qoz_mv_126 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_126;
}
...
void emit_emit_try(qoz_Emitter* e, qoz_Span sp, qoz_Expr* value) {
    ...
    qoz_TypeExpr* inner_te = emit_infer_value_te(e, value); qoz_gc_push_root(&inner_te); qoz_TypeExpr* outer_te = e->current_ret_te; qoz_gc_push_root(&outer_te); qoz_string inner_mangle = emit_result_mangle_for(e, inner_te); qoz_string outer_mangle = emit_result_mangle_for(e, outer_te); if (qoz_string_eq(inner_mangle, QOZ_STR_LIT(""))) { emit_emit_die(sp, QOZ_STR_LIT("try operator: operand is not Result<T, E>")); return;} if (qoz_string_eq(outer_mangle, QOZ_STR_LIT(""))) { emit_emit_die(sp, QOZ_STR_LIT("try operator: enclosing function does not return Result<T, E>")); return;} e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_102;
    {
        qoz_Strbuf _qoz_sb_928_40 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_928_40); strings_sb_append_i64(&_qoz_sb_928_40, e->closure_counter); _qoz_bv_102 = strings_sb_finish(&_qoz_sb_928_40);
    }
    qoz_string tmp = qoz_string_cat(QOZ_STR_LIT("_qoz_try_"), _qoz_bv_102); int64_t start = strings_sb_len(&e->out); qoz_string _qoz_bv_103;
    {
        qoz_Strbuf _qoz_sb_934_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_934_13); strings_sb_append(&_qoz_sb_934_13, QOZ_STR_LIT("qoz_")); strings_sb_append(&_qoz_sb_934_13, inner_mangle); strings_sb_append(&_qoz_sb_934_13, QOZ_STR_LIT("* ")); strings_sb_append(&_qoz_sb_934_13, tmp); strings_sb_append(&_qoz_sb_934_13, QOZ_STR_LIT(" = ")); _qoz_bv_103 = strings_sb_finish(&_qoz_sb_934_13);
    }
    emit_push(e, _qoz_bv_103); emit_emit_expr(e, value); qoz_string crr = e->current_return_restore; qoz_string _qoz_bv_104;
    {
        qoz_Strbuf _qoz_sb_937_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_937_13); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("; if (")); strings_sb_append(&_qoz_sb_937_13, tmp); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("->tag == qoz_")); strings_sb_append(&_qoz_sb_937_13, inner_mangle); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("_Err) { ")); strings_sb_append(&_qoz_sb_937_13, crr); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("return qoz_make_")); strings_sb_append(&_qoz_sb_937_13, outer_mangle); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("_Err(")); strings_sb_append(&_qoz_sb_937_13, tmp); strings_sb_append(&_qoz_sb_937_13, QOZ_STR_LIT("->payload.Err.f0); } ")); _qoz_bv_104 = strings_sb_finish(&_qoz_sb_937_13);
    }
    emit_push(e, _qoz_bv_104); emit_hoist_to_prologue(e, start); qoz_string _qoz_bv_105;
    {
        qoz_Strbuf _qoz_sb_940_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_940_13); strings_sb_append(&_qoz_sb_940_13, tmp); strings_sb_append(&_qoz_sb_940_13, QOZ_STR_LIT("->payload.Ok.f0")); _qoz_bv_105 = strings_sb_finish(&_qoz_sb_940_13);
    }
    emit_push(e, _qoz_bv_105); 
    return;
}
...
void emit_emit_tuple_lit(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_Expr elems) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_TypeExpr elem_tes = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&elem_tes, emit_infer_value_te(e, el)); } }qoz_string tname = emit_register_tuple_typedef(e, elem_tes); qoz_string _qoz_bv_106;
    {
        qoz_Strbuf _qoz_sb_947_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_947_13); strings_sb_append(&_qoz_sb_947_13, QOZ_STR_LIT("((")); strings_sb_append(&_qoz_sb_947_13, tname); strings_sb_append(&_qoz_sb_947_13, QOZ_STR_LIT("){ ")); _qoz_bv_106 = strings_sb_finish(&_qoz_sb_947_13);
    }
    emit_push(e, _qoz_bv_106); int64_t i = 0; { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, el); i = i + 1; } }emit_push(e, QOZ_STR_LIT(" })")); 
    return;
}
...
void emit_emit_closure_lifted(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_ClosureParam cps, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_CaptureScope sc = ((qoz_CaptureScope){ .bound = qoz_map_make__qoz_string__bool() }); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_map_set__qoz_string__bool(&sc.bound, cp.name, true); } }qoz_Vec__qoz_string captures = qoz_vec_make__qoz_string(); emit_collect_closure_captures(e, body, &sc, &captures); int64_t counter = e->closure_counter; e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_110;
    {
        qoz_Strbuf _qoz_sb_1017_41 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1017_41); strings_sb_append_i64(&_qoz_sb_1017_41, counter); _qoz_bv_110 = strings_sb_finish(&_qoz_sb_1017_41);
    }
    qoz_string cname = qoz_string_cat(QOZ_STR_LIT("qoz_clo_"), _qoz_bv_110); qoz_string _qoz_bv_111;
    {
        qoz_Strbuf _qoz_sb_1018_50 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1018_50); strings_sb_append_i64(&_qoz_sb_1018_50, counter); _qoz_bv_111 = strings_sb_finish(&_qoz_sb_1018_50);
    }
    qoz_string env_struct = qoz_string_cat(QOZ_STR_LIT("qoz_clo_env_"), _qoz_bv_111); qoz_Vec__qoz_TypeExpr capture_tes = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; qoz_Option__qoz_TypeExpr* _qoz_ms_128 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, c); switch (_qoz_ms_128->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_128->payload.Some.f0; qoz_vec_push__qoz_TypeExpr(&capture_tes, te);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_vec_push__qoz_TypeExpr(&capture_tes, qoz_make_TypeExpr_TEUnit(sp));  break; } } 0; } }qoz_Vec__qoz_TypeExpr ptes = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_TypeExpr(&ptes, cp.ty); } }qoz_string clo_type = emit_register_fn_typedef(e, ptes, ret); qoz_Vec__qoz_FnParam fparams = qoz_vec_make__qoz_FnParam(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_FnParam(&fparams, ((qoz_FnParam){ .name = cp.name, .ty = cp.ty })); } }qoz_string sig = QOZ_STR_LIT("static "); sig = qoz_string_cat(sig, emit_c_type_for(e, ret)); sig = qoz_string_cat(sig, QOZ_STR_LIT(" ")); sig = qoz_string_cat(sig, cname); sig = qoz_string_cat(sig, QOZ_STR_LIT("(void *_qoz_env")); { qoz_Vec__qoz_FnParam __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; sig = qoz_string_cat(sig, QOZ_STR_LIT(", ")); sig = qoz_string_cat(sig, emit_c_type_for(e, fp.ty)); sig = qoz_string_cat(sig, QOZ_STR_LIT(" ")); sig = qoz_string_cat(sig, fp.name); } }sig = qoz_string_cat(sig, QOZ_STR_LIT(");\n")); qoz_vec_push__qoz_string(&e->synth_fn_decls, sig); if ((captures.len) > 0) { qoz_string env_decl = QOZ_STR_LIT("struct "); env_decl = qoz_string_cat(env_decl, env_struct); env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT(" { ")); int64_t ci = 0; { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; env_decl = qoz_string_cat(env_decl, emit_c_type_for(e, capture_tes.data[ci])); env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT(" ")); env_decl = qoz_string_cat(env_decl, c); env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT("; ")); ci = ci + 1; } }env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT("};\n")); qoz_vec_push__qoz_string(&e->synth_fn_decls, env_decl); } int64_t saved_start = strings_sb_len(&e->out); qoz_Map__qoz_string__qoz_TypeExpr saved_locals = e->locals; qoz_TypeExpr* saved_ret = e->current_ret_te; qoz_gc_push_root(&saved_ret); qoz_TypeExpr* saved_hint = e->match_hint; qoz_gc_push_root(&saved_hint); qoz_string ret_c = emit_c_type_for(e, ret); qoz_string _qoz_bv_112;
    {
        qoz_Strbuf _qoz_sb_1077_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1077_13); strings_sb_append(&_qoz_sb_1077_13, QOZ_STR_LIT("static ")); strings_sb_append(&_qoz_sb_1077_13, ret_c); strings_sb_append(&_qoz_sb_1077_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1077_13, cname); strings_sb_append(&_qoz_sb_1077_13, QOZ_STR_LIT("(void *_qoz_env")); _qoz_bv_112 = strings_sb_finish(&_qoz_sb_1077_13);
    }
    emit_push(e, _qoz_bv_112); { qoz_Vec__qoz_FnParam __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; qoz_string fp_c = emit_c_type_for(e, fp.ty); qoz_string fp_n = fp.name; qoz_string _qoz_bv_113;
    {
        qoz_Strbuf _qoz_sb_1081_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1081_17); strings_sb_append(&_qoz_sb_1081_17, QOZ_STR_LIT(", ")); strings_sb_append(&_qoz_sb_1081_17, fp_c); strings_sb_append(&_qoz_sb_1081_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1081_17, fp_n); _qoz_bv_113 = strings_sb_finish(&_qoz_sb_1081_17);
    }
    emit_push(e, _qoz_bv_113); } }emit_push(e, QOZ_STR_LIT(") {\n    ")); e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_FnParam __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, fp.name, fp.ty); } }if ((captures.len) > 0) { qoz_string _qoz_bv_114;
    {
        qoz_Strbuf _qoz_sb_1087_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1087_17); strings_sb_append(&_qoz_sb_1087_17, QOZ_STR_LIT("struct ")); strings_sb_append(&_qoz_sb_1087_17, env_struct); strings_sb_append(&_qoz_sb_1087_17, QOZ_STR_LIT(" *_env = (struct ")); strings_sb_append(&_qoz_sb_1087_17, env_struct); strings_sb_append(&_qoz_sb_1087_17, QOZ_STR_LIT(" *)_qoz_env;\n    ")); _qoz_bv_114 = strings_sb_finish(&_qoz_sb_1087_17);
    }
    emit_push(e, _qoz_bv_114); int64_t ci2 = 0; { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; qoz_string c_c = emit_c_type_for(e, capture_tes.data[ci2]); qoz_string _qoz_bv_115;
    {
        qoz_Strbuf _qoz_sb_1091_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1091_21); strings_sb_append(&_qoz_sb_1091_21, c_c); strings_sb_append(&_qoz_sb_1091_21, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1091_21, c); strings_sb_append(&_qoz_sb_1091_21, QOZ_STR_LIT(" = _env->")); strings_sb_append(&_qoz_sb_1091_21, c); strings_sb_append(&_qoz_sb_1091_21, QOZ_STR_LIT(";\n    ")); _qoz_bv_115 = strings_sb_finish(&_qoz_sb_1091_21);
    }
    emit_push(e, _qoz_bv_115); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, c, capture_tes.data[ci2]); ci2 = ci2 + 1; } }} e->current_ret_te = ret; if (emit_is_block(body)) { emit_emit_fn_body_block(e, body, ret); }  else { qoz_StmtScope saved = emit_open_statement_scope(e); if (emit_is_unit_typeexpr(ret)) { emit_emit_expr(e, body); emit_push(e, QOZ_STR_LIT(";\n    return;\n")); }  else { emit_push(e, QOZ_STR_LIT("return ")); emit_emit_value_with_hint(e, body, ret); emit_push(e, QOZ_STR_LIT(";\n")); } emit_close_statement_scope(e, saved); } emit_push(e, QOZ_STR_LIT("}\n\n")); qoz_string def = strings_sb_slice_copy(&e->out, saved_start, strings_sb_len(&e->out)); strings_sb_truncate(&e->out, saved_start); e->locals = saved_locals; e->current_ret_te = saved_ret; e->match_hint = saved_hint; qoz_vec_push__qoz_string(&e->synth_fn_defs, def); qoz_string _qoz_bv_116;
    {
        qoz_Strbuf _qoz_sb_1123_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1123_13); strings_sb_append(&_qoz_sb_1123_13, QOZ_STR_LIT("((")); strings_sb_append(&_qoz_sb_1123_13, clo_type); strings_sb_append(&_qoz_sb_1123_13, QOZ_STR_LIT("){ .env = ")); _qoz_bv_116 = strings_sb_finish(&_qoz_sb_1123_13);
    }
    emit_push(e, _qoz_bv_116); if ((captures.len) == 0) { emit_push(e, QOZ_STR_LIT("NULL")); }  else { qoz_string _qoz_bv_117;
    {
        qoz_Strbuf _qoz_sb_1129_50 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1129_50); strings_sb_append_i64(&_qoz_sb_1129_50, counter); _qoz_bv_117 = strings_sb_finish(&_qoz_sb_1129_50);
    }
    qoz_string env_local = qoz_string_cat(QOZ_STR_LIT("_qoz_env_"), _qoz_bv_117); int64_t start = strings_sb_len(&e->out); qoz_string _qoz_bv_118;
    {
        qoz_Strbuf _qoz_sb_1131_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1131_17); strings_sb_append(&_qoz_sb_1131_17, QOZ_STR_LIT("struct ")); strings_sb_append(&_qoz_sb_1131_17, env_struct); strings_sb_append(&_qoz_sb_1131_17, QOZ_STR_LIT(" *")); strings_sb_append(&_qoz_sb_1131_17, env_local); strings_sb_append(&_qoz_sb_1131_17, QOZ_STR_LIT(" = qoz_alloc(sizeof(struct ")); strings_sb_append(&_qoz_sb_1131_17, env_struct); strings_sb_append(&_qoz_sb_1131_17, QOZ_STR_LIT(")); ")); _qoz_bv_118 = strings_sb_finish(&_qoz_sb_1131_17);
    }
    emit_push(e, _qoz_bv_118); { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; qoz_string _qoz_bv_119;
    {
        qoz_Strbuf _qoz_sb_1133_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1133_21); strings_sb_append(&_qoz_sb_1133_21, env_local); strings_sb_append(&_qoz_sb_1133_21, QOZ_STR_LIT("->")); strings_sb_append(&_qoz_sb_1133_21, c); strings_sb_append(&_qoz_sb_1133_21, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_1133_21, c); strings_sb_append(&_qoz_sb_1133_21, QOZ_STR_LIT("; ")); _qoz_bv_119 = strings_sb_finish(&_qoz_sb_1133_21);
    }
    emit_push(e, _qoz_bv_119); } }emit_hoist_to_prologue(e, start); qoz_string _qoz_bv_120;
    {
        qoz_Strbuf _qoz_sb_1136_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1136_17); strings_sb_append(&_qoz_sb_1136_17, QOZ_STR_LIT("(void *)")); strings_sb_append(&_qoz_sb_1136_17, env_local); _qoz_bv_120 = strings_sb_finish(&_qoz_sb_1136_17);
    }
    emit_push(e, _qoz_bv_120); } qoz_string _qoz_bv_121;
    {
        qoz_Strbuf _qoz_sb_1138_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1138_13); strings_sb_append(&_qoz_sb_1138_13, QOZ_STR_LIT(", .fn = ")); strings_sb_append(&_qoz_sb_1138_13, cname); strings_sb_append(&_qoz_sb_1138_13, QOZ_STR_LIT(" })")); _qoz_bv_121 = strings_sb_finish(&_qoz_sb_1138_13);
    }
    emit_push(e, _qoz_bv_121); 
    return;
}
...
void emit_emit_expr(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    {
        qoz_Strbuf _qoz_sb_1150_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1150_21); strings_sb_append(&_qoz_sb_1150_21, QOZ_STR_LIT("qoz_make_")); strings_sb_append(&_qoz_sb_1150_21, enum_name); strings_sb_append(&_qoz_sb_1150_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_1150_21, name); strings_sb_append(&_qoz_sb_1150_21, QOZ_STR_LIT("()")); _qoz_bv_122 = strings_sb_finish(&_qoz_sb_1150_21);
    }
    emit_push(e, _qoz_bv_122);  break; } case qoz_Option__qoz_string_None: { emit_push(e, name);  break; } } 0;  break; } case qoz_Expr_EString: { qoz_string text = _qoz_ms_129->payload.EString.f1; qoz_string _qoz_bv_123;
    {
        qoz_Strbuf _qoz_sb_1155_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1155_36); strings_sb_append(&_qoz_sb_1155_36, QOZ_STR_LIT("QOZ_STR_LIT(")); strings_sb_append(&_qoz_sb_1155_36, text); strings_sb_append(&_qoz_sb_1155_36, QOZ_STR_LIT(")")); _qoz_bv_123 = strings_sb_finish(&_qoz_sb_1155_36);
    }
    emit_push(e, _qoz_bv_123);  break; } case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_129->payload.EBinary.f1; qoz_Expr* lhs = _qoz_ms_129->payload.EBinary.f2; qoz_Expr* rhs = _qoz_ms_129->payload.EBinary.f3; emit_emit_binary(e, op, lhs, rhs);  break; } case qoz_Expr_EUnary: { qoz_UnaryOp* op = _qoz_ms_129->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_129->payload.EUnary.f2; {
        emit_push(e, emit_unary_c_op(op)); qoz_Expr* _qoz_ms_131 = rhs; switch (_qoz_ms_131->tag) { case qoz_Expr_EBinary: { {
    ...
    0;  break; } case qoz_Expr_EReturn: { qoz_Expr* value = _qoz_ms_129->payload.EReturn.f1; if (emit_is_nil_expr(value)) { emit_push(e, QOZ_STR_LIT("return")); }  else { emit_push(e, QOZ_STR_LIT("return ")); emit_emit_value_with_hint(e, value, e->current_ret_te); } 0;  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_129->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_129->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_129->payload.EBlock.f2; {
        if ((stmts.len) == 0) { emit_emit_block_tail_as_value(e, tail); return;} qoz_Expr* _qoz_ms_132 = tail; switch (_qoz_ms_132->tag) { case qoz_Expr_EWhile: { {
    ...
    0;  break; } default: { NULL;  break; } } 0; qoz_TypeExpr* tail_te = emit_infer_value_te(e, tail); qoz_gc_push_root(&tail_te); if (emit_is_unit_typeexpr(tail_te)) { int64_t start_u = strings_sb_len(&e->out); emit_push(e, QOZ_STR_LIT("{\n        ")); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_emit_stmt(e, s); } }qoz_StmtScope saved_tail = emit_open_statement_scope(e); emit_emit_stmt_expr(e, tail); emit_close_statement_scope(e, saved_tail); emit_push(e, QOZ_STR_LIT("\n    }\n    ")); emit_hoist_to_prologue(e, start_u); emit_push(e, QOZ_STR_LIT("0")); return;} e->closure_counter = e->closure_counter + 1; int64_t counter = e->closure_counter; qoz_string _qoz_bv_124;
    {
        qoz_Strbuf _qoz_sb_1224_47 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1224_47); strings_sb_append_i64(&_qoz_sb_1224_47, counter); _qoz_bv_124 = strings_sb_finish(&_qoz_sb_1224_47);
    }
    qoz_string tmp_res = qoz_string_cat(QOZ_STR_LIT("_qoz_bv_"), _qoz_bv_124); qoz_string result_c = emit_c_type_for(e, tail_te); int64_t start = strings_sb_len(&e->out); qoz_string _qoz_bv_125;
    {
        qoz_Strbuf _qoz_sb_1227_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1227_17); strings_sb_append(&_qoz_sb_1227_17, result_c); strings_sb_append(&_qoz_sb_1227_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1227_17, tmp_res); strings_sb_append(&_qoz_sb_1227_17, QOZ_STR_LIT(";\n    {\n        ")); _qoz_bv_125 = strings_sb_finish(&_qoz_sb_1227_17);
    }
    emit_push(e, _qoz_bv_125); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_emit_stmt(e, s); } }qoz_StmtScope saved_inner = emit_open_statement_scope(e); qoz_string _qoz_bv_126;
    {
        qoz_Strbuf _qoz_sb_1230_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1230_17); strings_sb_append(&_qoz_sb_1230_17, tmp_res); strings_sb_append(&_qoz_sb_1230_17, QOZ_STR_LIT(" = ")); _qoz_bv_126 = strings_sb_finish(&_qoz_sb_1230_17);
    }
    emit_push(e, _qoz_bv_126); emit_emit_expr(e, tail); emit_push(e, QOZ_STR_LIT(";\n    ")); emit_close_statement_scope(e, saved_inner); emit_push(e, QOZ_STR_LIT("}\n    ")); emit_hoist_to_prologue(e, start); emit_push(e, tmp_res); 
    }
    0;  break; } case qoz_Expr_EChar: { qoz_string text = _qoz_ms_129->payload.EChar.f1; emit_push(e, text);  break; } case qoz_Expr_EPath: { emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_EAssign: { qoz_Expr* lhs = _qoz_ms_129->payload.EAssign.f2; qoz_Expr* rhs = _qoz_ms_129->payload.EAssign.f3; emit_emit_assign(e, lhs, rhs);  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_129->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_129->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_129->payload.ECall.f3; emit_emit_call(e, callee, ta, args);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_129->payload.EField.f1; qoz_string name = _qoz_ms_129->payload.EField.f2; emit_emit_field(e, base, name);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_129->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_129->payload.EIndex.f2; emit_emit_index(e, base, idx);  break; } case qoz_Expr_ECast: { qoz_Expr* value = _qoz_ms_129->payload.ECast.f1; qoz_TypeExpr* t = _qoz_ms_129->payload.ECast.f2; {
        qoz_string tc = emit_c_type_for(e, t); qoz_string _qoz_bv_127;
    {
        qoz_Strbuf _qoz_sb_1246_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1246_17); strings_sb_append(&_qoz_sb_1246_17, QOZ_STR_LIT("((")); strings_sb_append(&_qoz_sb_1246_17, tc); strings_sb_append(&_qoz_sb_1246_17, QOZ_STR_LIT(")")); _qoz_bv_127 = strings_sb_finish(&_qoz_sb_1246_17);
    }
    emit_push(e, _qoz_bv_127); emit_emit_expr(e, value); emit_push(e, QOZ_STR_LIT(")")); 
    }
    ...
    0;  break; } case qoz_Expr_EWhile: { emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_EFor: { emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_EDefer: { emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_ESizeOf: { qoz_TypeExpr* te = _qoz_ms_129->payload.ESizeOf.f1; {
        qoz_string tc = emit_c_type_for(e, te); qoz_string _qoz_bv_128;
    {
        qoz_Strbuf _qoz_sb_1264_77 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1264_77); strings_sb_append(&_qoz_sb_1264_77, QOZ_STR_LIT("(int64_t)sizeof(")); strings_sb_append(&_qoz_sb_1264_77, tc); strings_sb_append(&_qoz_sb_1264_77, QOZ_STR_LIT(")")); _qoz_bv_128 = strings_sb_finish(&_qoz_sb_1264_77);
    }
    emit_push(e, _qoz_bv_128); 
    }
...
qoz_string emit_infer_value_ctype(qoz_Emitter* e, qoz_TypeExpr* ty, qoz_Expr* value) {
    ...
    qoz_gc_push_root(&ty);
    qoz_gc_push_root(&value);
    qoz_TypeExpr* _qoz_ms_133 = ty; qoz_string _qoz_mv_133 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_133->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_133 = (emit_c_type_for(e, emit_binding_te(e, ty, value)));  break; } default: { _qoz_mv_133 = (emit_c_type_for(e, ty));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_133;
}
...
qoz_string emit_infer_expr_ctype(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_134 = ex; qoz_string _qoz_mv_134 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_134->tag) { case qoz_Expr_EAssign: { _qoz_mv_134 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EReturn: { _qoz_mv_134 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EWhile: { _qoz_mv_134 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EFor: { _qoz_mv_134 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EDefer: { _qoz_mv_134 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_134->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_134->payload.EBlock.f2; qoz_string _qoz_bv_129;
    {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_ingest_stmt_locals(e, s); } }if (emit_is_nil_expr(tail)) { return QOZ_STR_LIT("void");} _qoz_bv_129 = emit_infer_expr_ctype(e, tail);
    }
    _qoz_mv_134 = (_qoz_bv_129);  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_134->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_134->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_134->payload.EMatch.f2; qoz_string _qoz_bv_130;
    {
        if ((arms.len) == 0) { emit_emit_die(sp, QOZ_STR_LIT("match expression with no arms")); } qoz_string bare_enum = emit_bare_enum_for_pat(e, arms.data[0].pat); qoz_string enum_name = ((qoz_string_eq(bare_enum, QOZ_STR_LIT(""))) ? bare_enum : emit_enum_lookup_name(e, scrut, bare_enum)); emit_bind_arm_locals(e, enum_name, arms.data[0].pat); _qoz_bv_130 = emit_infer_expr_ctype(e, arms.data[0].body);
    }
    _qoz_mv_134 = (_qoz_bv_130);  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_134->payload.EPath.f0; _qoz_mv_134 = (emit_emit_die(sp, QOZ_STR_LIT("EPath in value position is not supported")));  break; } default: { _qoz_mv_134 = (emit_c_type_for(e, emit_infer_value_te(e, ex)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_134;
}
...
void emit_ingest_stmt_locals(qoz_Emitter* e, qoz_Stmt* s) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_135 = s; switch (_qoz_ms_135->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_135->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_135->payload.SLet.f2; qoz_Expr* val = _qoz_ms_135->payload.SLet.f3; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, emit_binding_te(e, te, val));  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_135->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_135->payload.SVar.f2; qoz_Expr* val = _qoz_ms_135->payload.SVar.f3; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, emit_binding_te(e, te, val));  break; } case qoz_Stmt_SExpr: { NULL;  break; } } 0; 
    return;
}
...
qoz_string emit_bare_enum_for_pat(qoz_Emitter* e, qoz_Pattern* pat) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&pat);
    qoz_Pattern* _qoz_ms_136 = pat; qoz_string _qoz_mv_136 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_136->tag) { case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_136->payload.PatVariant.f1; qoz_string _qoz_bv_131;
    {
        if ((path.len) == 0) { return QOZ_STR_LIT("");} qoz_Option__qoz_string* _qoz_ms_137 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, path.data[(path.len) - 1]); qoz_string _qoz_mv_137 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_137->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_137->payload.Some.f0; _qoz_mv_137 = (en);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_137 = (QOZ_STR_LIT(""));  break; } } _qoz_bv_131 = _qoz_mv_137;
    }
    _qoz_mv_136 = (_qoz_bv_131);  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_136->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_138 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_138 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_138->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_138->payload.Some.f0; _qoz_mv_138 = (en);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_138 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_136 = (_qoz_mv_138);  break; } default: { _qoz_mv_136 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_136;
}
...
qoz_string emit_emit_die(qoz_Span sp, qoz_string msg) {
    ...
    {
        qoz_Strbuf _qoz_sb_1330_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1330_17); strings_sb_append(&_qoz_sb_1330_17, sp.file); strings_sb_append(&_qoz_sb_1330_17, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_1330_17, sp.line); strings_sb_append(&_qoz_sb_1330_17, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_1330_17, sp.col); strings_sb_append(&_qoz_sb_1330_17, QOZ_STR_LIT(": emit error: ")); strings_sb_append(&_qoz_sb_1330_17, msg); _qoz_bv_132 = strings_sb_finish(&_qoz_sb_1330_17);
    }
    fmt_println(_qoz_bv_132); qoz_os_exit(1); qoz_gc_shadow_set_top(_qoz_shadow_guard); return QOZ_STR_LIT("");
}
...
qoz_TypeExpr* emit_infer_base_typeexpr(qoz_Emitter* e, qoz_Expr* base) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_139 = base; qoz_TypeExpr* _qoz_mv_139 = NULL; switch (_qoz_ms_139->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_139->payload.EIdent.f0; qoz_string ident = _qoz_ms_139->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_140 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, ident); qoz_TypeExpr* _qoz_mv_140 = NULL; switch (_qoz_ms_140->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_140->payload.Some.f0; _qoz_mv_140 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_Option__qoz_string* _qoz_ms_141 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, ident); qoz_TypeExpr* _qoz_mv_141 = NULL; switch (_qoz_ms_141->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_141->payload.Some.f0; qoz_TypeExpr* _qoz_bv_133;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&path, en); _qoz_bv_133 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_141 = (_qoz_bv_133);  break; } case qoz_Option__qoz_string_None: { qoz_TypeExpr* _qoz_bv_134;
    {
        qoz_string _qoz_bv_135;
    {
        qoz_Strbuf _qoz_sb_1348_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1348_38); strings_sb_append(&_qoz_sb_1348_38, QOZ_STR_LIT("identifier `")); strings_sb_append(&_qoz_sb_1348_38, ident); strings_sb_append(&_qoz_sb_1348_38, QOZ_STR_LIT("` has no known TypeExpr (not a local, parameter, or variant)")); _qoz_bv_135 = strings_sb_finish(&_qoz_sb_1348_38);
    }
    (void)(emit_emit_die(sp, _qoz_bv_135)); _qoz_bv_134 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_141 = (_qoz_bv_134);  break; } } _qoz_mv_140 = (_qoz_mv_141);  break; } } _qoz_mv_139 = (_qoz_mv_140);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_139->payload.EField.f0; qoz_Expr* b = _qoz_ms_139->payload.EField.f1; qoz_string n = _qoz_ms_139->payload.EField.f2; qoz_TypeExpr* _qoz_bv_136;
    {
        qoz_TypeExpr* bte = emit_infer_base_typeexpr(e, b); qoz_gc_push_root(&bte); _qoz_bv_136 = emit_field_typeexpr_for(e, bte, n, sp);
    }
    _qoz_mv_139 = (_qoz_bv_136);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_139->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_139->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_139->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_142 = op; qoz_TypeExpr* _qoz_mv_142 = NULL; switch (_qoz_ms_142->tag) { case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_137;
    {
        qoz_TypeExpr* inner = emit_infer_base_typeexpr(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_143 = inner; qoz_TypeExpr* _qoz_mv_143 = NULL; switch (_qoz_ms_143->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_143->payload.TEPtr.f1; _qoz_mv_143 = (t);  break; } default: { qoz_TypeExpr* _qoz_bv_138;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("dereference of non-pointer base in EField/EIndex"))); _qoz_bv_138 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_143 = (_qoz_bv_138);  break; } } _qoz_bv_137 = _qoz_mv_143;
    }
    _qoz_mv_142 = (_qoz_bv_137);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_142 = (qoz_make_TypeExpr_TEPtr(sp, emit_infer_base_typeexpr(e, rhs)));  break; } default: { qoz_TypeExpr* _qoz_bv_139;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("unary operator does not yield a base TypeExpr"))); _qoz_bv_139 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_142 = (_qoz_bv_139);  break; } } _qoz_mv_139 = (_qoz_mv_142);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_139->payload.ECall.f0; qoz_Expr* c = _qoz_ms_139->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_139->payload.ECall.f2; qoz_Vec__qoz_Expr va = _qoz_ms_139->payload.ECall.f3; _qoz_mv_139 = (emit_call_return_te(e, c, ta, va, sp));  break; } case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_139->payload.ECast.f2; _qoz_mv_139 = (t);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* t = _qoz_ms_139->payload.ERecord.f1; _qoz_mv_139 = (t);  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_139->payload.EIndex.f0; qoz_Expr* b = _qoz_ms_139->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_140;
    {
        qoz_TypeExpr* bte = emit_infer_base_typeexpr(e, b); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_144 = bte; qoz_TypeExpr* _qoz_mv_144 = NULL; switch (_qoz_ms_144->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_144->payload.TEPtr.f1; _qoz_mv_144 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_144->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_144->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_141;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(emit_emit_die(sp, QOZ_STR_LIT("indexing into non-Vec/non-pointer base"))); _qoz_bv_141 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_144 = (_qoz_bv_141);  break; } default: { qoz_TypeExpr* _qoz_bv_142;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("indexing into unrecognised base"))); _qoz_bv_142 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_144 = (_qoz_bv_142);  break; } } _qoz_bv_140 = _qoz_mv_144;
    }
    _qoz_mv_139 = (_qoz_bv_140);  break; } default: { qoz_TypeExpr* _qoz_bv_143;
    {
        (void)(emit_emit_die(emit_span_of_expr(base), QOZ_STR_LIT("base expression has no resolvable TypeExpr"))); _qoz_bv_143 = qoz_make_TypeExpr_TEUnit(emit_span_of_expr(base));
    }
    _qoz_mv_139 = (_qoz_bv_143);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_139;
}

qoz_Span emit_span_of_expr(qoz_Expr* e) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Expr* _qoz_ms_145 = e; qoz_Span _qoz_mv_145 = ((qoz_Span){0}); switch (_qoz_ms_145->tag) { case qoz_Expr_ENil: { qoz_Span sp = _qoz_ms_145->payload.ENil.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_145->payload.EInt.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_145->payload.EFloat.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_145->payload.EString.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_145->payload.EChar.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_145->payload.EBool.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_145->payload.EIdent.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_145->payload.EPath.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_145->payload.EReturn.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_145->payload.EDefer.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_145->payload.ESizeOf.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_145->payload.EArrayLit.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_145->payload.ETry.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_145->payload.ETuple.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_145->payload.EUnary.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_145->payload.EField.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_145->payload.EIndex.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_ECast: { qoz_Span sp = _qoz_ms_145->payload.ECast.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_145->payload.ERecord.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_145->payload.EBlock.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_145->payload.EWhile.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_145->payload.EMatch.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_145->payload.EBinary.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_145->payload.EAssign.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_145->payload.ECall.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_145->payload.EIf.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_145->payload.EClosure.f0; _qoz_mv_145 = (sp);  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_145->payload.EFor.f0; _qoz_mv_145 = (sp);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_145;
}
...
qoz_TypeExpr* emit_field_typeexpr_for(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    qoz_TypeExpr* _qoz_ms_146 = base_te; qoz_TypeExpr* _qoz_mv_146 = NULL; switch (_qoz_ms_146->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_146->payload.TEPtr.f1; _qoz_mv_146 = (inner);  break; } default: { _qoz_mv_146 = (base_te);  break; } } qoz_TypeExpr* unwrapped = _qoz_mv_146; qoz_gc_push_root(&unwrapped); qoz_TypeExpr* _qoz_ms_147 = unwrapped; qoz_TypeExpr* _qoz_mv_147 = NULL; switch (_qoz_ms_147->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_147->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_147->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_144;
    {
        if ((path.len) < 1) { qoz_string _qoz_bv_145;
    {
        qoz_Strbuf _qoz_sb_1425_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1425_34); strings_sb_append(&_qoz_sb_1425_34, QOZ_STR_LIT("field access `.")); strings_sb_append(&_qoz_sb_1425_34, field); strings_sb_append(&_qoz_sb_1425_34, QOZ_STR_LIT("` on TypeExpr with empty path")); _qoz_bv_145 = strings_sb_finish(&_qoz_sb_1425_34);
    }
    (void)(emit_emit_die(sp, _qoz_bv_145)); return qoz_make_TypeExpr_TEUnit(sp);} qoz_string lookup = emit_type_lookup_key(e, path); qoz_Option__qoz_Decl* _qoz_ms_148 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, lookup); qoz_Option__qoz_Decl* _qoz_mv_148 = NULL; switch (_qoz_ms_148->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_148->payload.Some.f0; _qoz_mv_148 = (qoz_make_Option__qoz_Decl_Some(d));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_148 = (qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, lookup));  break; } } qoz_Option__qoz_Decl* decl_opt = _qoz_mv_148; qoz_gc_push_root(&decl_opt); qoz_Option__qoz_Decl* _qoz_ms_149 = decl_opt; qoz_TypeExpr* _qoz_mv_149 = NULL; switch (_qoz_ms_149->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_149->payload.Some.f0; qoz_Decl* _qoz_ms_150 = decl; qoz_TypeExpr* _qoz_mv_150 = NULL; switch (_qoz_ms_150->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_150->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_150->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_146;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_string_eq(f.name, field)) { if ((args.len) == (params.len)) { return emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }qoz_string _qoz_bv_147;
    {
        qoz_Strbuf _qoz_sb_1445_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1445_38); strings_sb_append(&_qoz_sb_1445_38, QOZ_STR_LIT("struct `")); strings_sb_append(&_qoz_sb_1445_38, lookup); strings_sb_append(&_qoz_sb_1445_38, QOZ_STR_LIT("` has no field `")); strings_sb_append(&_qoz_sb_1445_38, field); strings_sb_append(&_qoz_sb_1445_38, QOZ_STR_LIT("`")); _qoz_bv_147 = strings_sb_finish(&_qoz_sb_1445_38);
    }
    (void)(emit_emit_die(sp, _qoz_bv_147)); _qoz_bv_146 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_150 = (_qoz_bv_146);  break; } default: { qoz_TypeExpr* _qoz_bv_148;
    {
        qoz_string _qoz_bv_149;
    {
        qoz_Strbuf _qoz_sb_1449_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1449_38); strings_sb_append(&_qoz_sb_1449_38, QOZ_STR_LIT("decl `")); strings_sb_append(&_qoz_sb_1449_38, lookup); strings_sb_append(&_qoz_sb_1449_38, QOZ_STR_LIT("` is not a struct")); _qoz_bv_149 = strings_sb_finish(&_qoz_sb_1449_38);
    }
    (void)(emit_emit_die(sp, _qoz_bv_149)); _qoz_bv_148 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_150 = (_qoz_bv_148);  break; } } _qoz_mv_149 = (_qoz_mv_150);  break; } case qoz_Option__qoz_Decl_None: { qoz_TypeExpr* _qoz_bv_150;
    {
        qoz_string _qoz_bv_151;
    {
        qoz_Strbuf _qoz_sb_1455_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1455_34); strings_sb_append(&_qoz_sb_1455_34, QOZ_STR_LIT("unknown struct `")); strings_sb_append(&_qoz_sb_1455_34, lookup); strings_sb_append(&_qoz_sb_1455_34, QOZ_STR_LIT("` for field `.")); strings_sb_append(&_qoz_sb_1455_34, field); strings_sb_append(&_qoz_sb_1455_34, QOZ_STR_LIT("`")); _qoz_bv_151 = strings_sb_finish(&_qoz_sb_1455_34);
    }
    (void)(emit_emit_die(sp, _qoz_bv_151)); _qoz_bv_150 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_149 = (_qoz_bv_150);  break; } } _qoz_bv_144 = _qoz_mv_149;
    }
    _qoz_mv_147 = (_qoz_bv_144);  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_147->payload.TETuple.f1; qoz_TypeExpr* _qoz_bv_152;
    {
        int64_t idx = emit_tuple_field_index(field); if ((idx >= 0) && (idx < (elems.len))) { return elems.data[idx];} qoz_string _qoz_bv_153;
    {
        qoz_Strbuf _qoz_sb_1463_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1463_30); strings_sb_append(&_qoz_sb_1463_30, QOZ_STR_LIT("tuple has no field `.")); strings_sb_append(&_qoz_sb_1463_30, field); strings_sb_append(&_qoz_sb_1463_30, QOZ_STR_LIT("`")); _qoz_bv_153 = strings_sb_finish(&_qoz_sb_1463_30);
    }
    (void)(emit_emit_die(sp, _qoz_bv_153)); _qoz_bv_152 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_147 = (_qoz_bv_152);  break; } default: { qoz_TypeExpr* _qoz_bv_154;
    {
        qoz_string _qoz_bv_155;
    {
        qoz_Strbuf _qoz_sb_1467_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1467_30); strings_sb_append(&_qoz_sb_1467_30, QOZ_STR_LIT("field access `.")); strings_sb_append(&_qoz_sb_1467_30, field); strings_sb_append(&_qoz_sb_1467_30, QOZ_STR_LIT("` on a non-named base")); _qoz_bv_155 = strings_sb_finish(&_qoz_sb_1467_30);
    }
    (void)(emit_emit_die(sp, _qoz_bv_155)); _qoz_bv_154 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_147 = (_qoz_bv_154);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_147;
}
...
qoz_Span emit_span_of_te(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_151 = te; qoz_Span _qoz_mv_151 = ((qoz_Span){0}); switch (_qoz_ms_151->tag) { case qoz_TypeExpr_TEUnit: { qoz_Span sp = _qoz_ms_151->payload.TEUnit.f0; _qoz_mv_151 = (sp);  break; } case qoz_TypeExpr_TEPtr: { qoz_Span sp = _qoz_ms_151->payload.TEPtr.f0; _qoz_mv_151 = (sp);  break; } case qoz_TypeExpr_TETuple: { qoz_Span sp = _qoz_ms_151->payload.TETuple.f0; _qoz_mv_151 = (sp);  break; } case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_151->payload.TENamed.f0; _qoz_mv_151 = (sp);  break; } case qoz_TypeExpr_TEFn: { qoz_Span sp = _qoz_ms_151->payload.TEFn.f0; _qoz_mv_151 = (sp);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_151;
}
...
qoz_TypeExpr* emit_binding_te(qoz_Emitter* e, qoz_TypeExpr* declared, qoz_Expr* value) {
    ...
    qoz_gc_push_root(&value);
    qoz_TypeExpr* _qoz_ms_152 = declared; qoz_TypeExpr* _qoz_mv_152 = NULL; switch (_qoz_ms_152->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_152 = (emit_infer_value_te(e, value));  break; } default: { _qoz_mv_152 = (declared);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_152;
}
...
qoz_TypeExpr* emit_infer_value_te_cached(qoz_Emitter* e, qoz_Expr* v) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&v);
    qoz_Option__qoz_TypeExpr* _qoz_ms_153 = qoz_map_get__int64_t__qoz_TypeExpr(&e->expr_types, emit_expr_id(v)); qoz_TypeExpr* _qoz_mv_153 = NULL; switch (_qoz_ms_153->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_153->payload.Some.f0; _qoz_mv_153 = ((((e->current_tparams.len) > 0) ? emit_substitute_type(e, te, e->current_tparams, e->current_targs) : te));  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_153 = (emit_infer_value_te(e, v));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_153;
}
...
qoz_TypeExpr* emit_infer_value_te(qoz_Emitter* e, qoz_Expr* v) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&v);
    qoz_Expr* _qoz_ms_154 = v; qoz_TypeExpr* _qoz_mv_154 = NULL; switch (_qoz_ms_154->tag) { case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_154->payload.ECast.f2; _qoz_mv_154 = (t);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* t = _qoz_ms_154->payload.ERecord.f1; _qoz_mv_154 = (t);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_154->payload.EField.f0; qoz_Expr* base = _qoz_ms_154->payload.EField.f1; qoz_string name = _qoz_ms_154->payload.EField.f2; _qoz_mv_154 = (emit_field_typeexpr_for(e, emit_infer_base_typeexpr(e, base), name, sp));  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_154->payload.EIndex.f0; qoz_Expr* base = _qoz_ms_154->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_156;
    {
        qoz_TypeExpr* bte = emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_155 = bte; qoz_TypeExpr* _qoz_mv_155 = NULL; switch (_qoz_ms_155->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_155->payload.TEPtr.f1; _qoz_mv_155 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_155->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_155->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_157;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(emit_emit_die(sp, QOZ_STR_LIT("let-binding value indexed into non-Vec base; cannot determine binding type"))); _qoz_bv_157 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_155 = (_qoz_bv_157);  break; } default: { qoz_TypeExpr* _qoz_bv_158;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("let-binding value indexed into unrecognised base"))); _qoz_bv_158 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_155 = (_qoz_bv_158);  break; } } _qoz_bv_156 = _qoz_mv_155;
    }
    _qoz_mv_154 = (_qoz_bv_156);  break; } case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_154->payload.EIdent.f0; qoz_string name = _qoz_ms_154->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_156 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_156 = NULL; switch (_qoz_ms_156->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_156->payload.Some.f0; _qoz_mv_156 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_159;
    {
        qoz_string _qoz_bv_160;
    {
        qoz_Strbuf _qoz_sb_1551_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1551_34); strings_sb_append(&_qoz_sb_1551_34, QOZ_STR_LIT("let-binding value references unknown name `")); strings_sb_append(&_qoz_sb_1551_34, name); strings_sb_append(&_qoz_sb_1551_34, QOZ_STR_LIT("`")); _qoz_bv_160 = strings_sb_finish(&_qoz_sb_1551_34);
    }
    (void)(emit_emit_die(sp, _qoz_bv_160)); _qoz_bv_159 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_156 = (_qoz_bv_159);  break; } } _qoz_mv_154 = (_qoz_mv_156);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_154->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_154->payload.ECall.f1; qoz_Vec__qoz_TypeExpr type_args = _qoz_ms_154->payload.ECall.f2; qoz_Vec__qoz_Expr vargs = _qoz_ms_154->payload.ECall.f3; _qoz_mv_154 = (emit_call_return_te(e, callee, type_args, vargs, sp));  break; } case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_154->payload.EInt.f0; _qoz_mv_154 = (emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_154->payload.EFloat.f0; _qoz_mv_154 = (emit_single_named_te(sp, QOZ_STR_LIT("f64")));  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_154->payload.EString.f0; _qoz_mv_154 = (emit_single_named_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_154->payload.EBool.f0; _qoz_mv_154 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_154->payload.EChar.f0; _qoz_mv_154 = (emit_single_named_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Expr_ENil: { qoz_Span sp = _qoz_ms_154->payload.ENil.f0; _qoz_mv_154 = (qoz_make_TypeExpr_TEPtr(sp, emit_single_named_te(sp, QOZ_STR_LIT("void"))));  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_154->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_154->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_154->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_157 = op; qoz_TypeExpr* _qoz_mv_157 = NULL; switch (_qoz_ms_157->tag) { case qoz_UnaryOp_UOpAddr: { _qoz_mv_157 = (qoz_make_TypeExpr_TEPtr(sp, emit_infer_value_te(e, rhs)));  break; } case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_161;
    {
        qoz_TypeExpr* inner = emit_infer_value_te(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_158 = inner; qoz_TypeExpr* _qoz_mv_158 = NULL; switch (_qoz_ms_158->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_158->payload.TEPtr.f1; _qoz_mv_158 = (t);  break; } default: { qoz_TypeExpr* _qoz_bv_162;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("let-binding dereferences a non-pointer"))); _qoz_bv_162 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_158 = (_qoz_bv_162);  break; } } _qoz_bv_161 = _qoz_mv_158;
    }
    _qoz_mv_157 = (_qoz_bv_161);  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_157 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_UnaryOp_UOpNeg: { _qoz_mv_157 = (emit_infer_value_te(e, rhs));  break; } } _qoz_mv_154 = (_qoz_mv_157);  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_154->payload.EBinary.f0; qoz_BinaryOp* op = _qoz_ms_154->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_154->payload.EBinary.f2; qoz_BinaryOp* _qoz_ms_159 = op; qoz_TypeExpr* _qoz_mv_159 = NULL; switch (_qoz_ms_159->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_159 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_159 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_159 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_159 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_159 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_159 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_159 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_159 = (emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } default: { _qoz_mv_159 = (emit_infer_value_te(e, l));  break; } } _qoz_mv_154 = (_qoz_mv_159);  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_154->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_154->payload.EBlock.f2; qoz_TypeExpr* _qoz_bv_163;
    {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_ingest_stmt_locals(e, s); } }_qoz_bv_163 = emit_infer_value_te(e, tail);
    }
    _qoz_mv_154 = (_qoz_bv_163);  break; } case qoz_Expr_EIf: { qoz_Expr* t = _qoz_ms_154->payload.EIf.f2; _qoz_mv_154 = (emit_infer_value_te(e, t));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_154->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_154->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_154->payload.EMatch.f2; qoz_TypeExpr* _qoz_bv_164;
    {
        if ((arms.len) == 0) { (void)(emit_emit_die(sp, QOZ_STR_LIT("match expression with no arms"))); return qoz_make_TypeExpr_TEUnit(sp);} qoz_string bare_enum = emit_find_enum_from_arms(e, arms); qoz_string enum_name = ((qoz_string_eq(bare_enum, QOZ_STR_LIT(""))) ? bare_enum : emit_enum_lookup_name(e, scrut, bare_enum)); emit_bind_arm_locals(e, enum_name, arms.data[0].pat); _qoz_bv_164 = emit_infer_value_te(e, arms.data[0].body);
    }
    _qoz_mv_154 = (_qoz_bv_164);  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_154->payload.ESizeOf.f0; _qoz_mv_154 = (emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_154->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_154->payload.ETuple.f1; qoz_TypeExpr* _qoz_bv_165;
    {
        qoz_Vec__qoz_TypeExpr ets = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ets, emit_infer_value_te(e, el)); } }_qoz_bv_165 = qoz_make_TypeExpr_TETuple(sp, ets);
    }
    _qoz_mv_154 = (_qoz_bv_165);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_154->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_154->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_154->payload.EClosure.f2; qoz_TypeExpr* _qoz_bv_166;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_TypeExpr(&pte, cp.ty); } }_qoz_bv_166 = qoz_make_TypeExpr_TEFn(sp, pte, ret);
    }
    _qoz_mv_154 = (_qoz_bv_166);  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_154->payload.ETry.f0; qoz_Expr* value = _qoz_ms_154->payload.ETry.f1; qoz_TypeExpr* _qoz_bv_167;
    {
        qoz_TypeExpr* inner = emit_infer_value_te(e, value); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_160 = inner; qoz_TypeExpr* _qoz_mv_160 = NULL; switch (_qoz_ms_160->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_160->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_160->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_168;
    {
        if ((args.len) == 2) { if ((path.len) > 0) { qoz_string last = path.data[(path.len) - 1]; if (qoz_string_eq(last, QOZ_STR_LIT("Result"))) { return args.data[0];} } } _qoz_bv_168 = inner;
    }
    _qoz_mv_160 = (_qoz_bv_168);  break; } default: { _qoz_mv_160 = (inner);  break; } } _qoz_bv_167 = _qoz_mv_160;
    }
    _qoz_mv_154 = (_qoz_bv_167);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_154->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_154->payload.EArrayLit.f1; qoz_TypeExpr* _qoz_bv_169;
    {
        if ((elems.len) == 0) { (void)(emit_emit_die(sp, QOZ_STR_LIT("empty array literal: element type cannot be inferred"))); return qoz_make_TypeExpr_TEUnit(sp);} qoz_TypeExpr* elem_te = emit_infer_value_te(e, elems.data[0]); qoz_gc_push_root(&elem_te); qoz_Vec__qoz_TypeExpr args = qoz_vec_make__qoz_TypeExpr(); qoz_vec_push__qoz_TypeExpr(&args, elem_te); qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("Vec")); _qoz_bv_169 = qoz_make_TypeExpr_TENamed(sp, path, args);
    }
    _qoz_mv_154 = (_qoz_bv_169);  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_154->payload.EAssign.f0; _qoz_mv_154 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_154->payload.EWhile.f0; _qoz_mv_154 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_154->payload.EFor.f0; _qoz_mv_154 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_154->payload.EReturn.f0; _qoz_mv_154 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_154->payload.EDefer.f0; _qoz_mv_154 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_154->payload.EPath.f0; qoz_TypeExpr* _qoz_bv_170;
    {
        (void)(emit_emit_die(sp, QOZ_STR_LIT("EPath in value position is not supported (expected pkg.fn or a record name)"))); _qoz_bv_170 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_154 = (_qoz_bv_170);  break; } default: { qoz_TypeExpr* _qoz_bv_171;
    {
        (void)(emit_emit_die(emit_span_of_expr(v), QOZ_STR_LIT("let-binding value shape not handled by inference"))); _qoz_bv_171 = qoz_make_TypeExpr_TEUnit(emit_span_of_expr(v));
    }
    _qoz_mv_154 = (_qoz_bv_171);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_154;
}
...
qoz_Vec__qoz_TypeExpr emit_infer_variant_type_args(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, qoz_Vec__qoz_Expr args, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_TypeExpr out = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Decl* _qoz_ms_161 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, enum_name); qoz_Vec__qoz_TypeExpr _qoz_mv_161 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_161->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_161 = (out);  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_161->payload.Some.f0; qoz_Decl* _qoz_ms_162 = d; qoz_Vec__qoz_TypeExpr _qoz_mv_162 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_162->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_162->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_162->payload.DEnum.f3; qoz_Vec__qoz_TypeExpr _qoz_bv_172;
    {
        if ((tparams.len) == 0) { return out;} qoz_Map__qoz_string__qoz_TypeExpr bindings = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_string_eq(v.name, variant)) { int64_t i = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pos_te = __col.data[__i]; (void)pos_te; if (i < (args.len)) { qoz_TypeExpr* arg_te = emit_infer_value_te(e, args.data[i]); qoz_gc_push_root(&arg_te); emit_unify_te(pos_te, arg_te, &bindings); } i = i + 1; } }} } }{ qoz_Vec__qoz_string __col = tparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string tp = __col.data[__i]; (void)tp; qoz_Option__qoz_TypeExpr* _qoz_ms_163 = qoz_map_get__qoz_string__qoz_TypeExpr(&bindings, tp); switch (_qoz_ms_163->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_163->payload.Some.f0; qoz_vec_push__qoz_TypeExpr(&out, t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_vec_push__qoz_TypeExpr(&out, emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } } 0; } }_qoz_bv_172 = out;
    }
    _qoz_mv_162 = (_qoz_bv_172);  break; } default: { _qoz_mv_162 = (out);  break; } } _qoz_mv_161 = (_qoz_mv_162);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_161;
}
...
void emit_unify_te(qoz_TypeExpr* pattern, qoz_TypeExpr* concrete, qoz_Map__qoz_string__qoz_TypeExpr* env) {
    ...
    qoz_gc_push_root(&concrete);
    qoz_gc_push_root(&env);
    qoz_TypeExpr* _qoz_ms_164 = pattern; switch (_qoz_ms_164->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_164->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr p_args = _qoz_ms_164->payload.TENamed.f2; {
        if (((path.len) == 1) && ((p_args.len) == 0)) { qoz_string n = path.data[0]; if (emit_is_type_var_name(n)) { if (!qoz_map_contains__qoz_string__qoz_TypeExpr(env, n)) { qoz_map_set__qoz_string__qoz_TypeExpr(env, n, concrete); } return;} } qoz_TypeExpr* _qoz_ms_165 = concrete; switch (_qoz_ms_165->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string c_path = _qoz_ms_165->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr c_args = _qoz_ms_165->payload.TENamed.f2; if ((p_args.len) == (c_args.len)) { int64_t i = 0; while (i < (p_args.len)) { emit_unify_te(p_args.data[i], c_args.data[i], env); i = i + 1; } } 0;  break; } default: { NULL;  break; } } 0; 
    }
    0;  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* p_inner = _qoz_ms_164->payload.TEPtr.f1; qoz_TypeExpr* _qoz_ms_166 = concrete; switch (_qoz_ms_166->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* c_inner = _qoz_ms_166->payload.TEPtr.f1; emit_unify_te(p_inner, c_inner, env);  break; } default: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
qoz_TypeExpr* emit_call_return_te(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_Span sp) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_string name = emit_generic_callee_name(e, callee); if (qoz_string_eq(name, QOZ_STR_LIT(""))) { (void)(emit_emit_die(sp, QOZ_STR_LIT("could not derive return type: callee has no recognisable name"))); return qoz_make_TypeExpr_TEUnit(sp);} if (qoz_string_eq(name, QOZ_STR_LIT("len"))) { return emit_single_named_te(sp, QOZ_STR_LIT("i64"));} if (qoz_string_eq(name, QOZ_STR_LIT("size_of"))) { return emit_single_named_te(sp, QOZ_STR_LIT("i64"));} if (qoz_string_eq(name, QOZ_STR_LIT("hash"))) { return emit_single_named_te(sp, QOZ_STR_LIT("u64"));} qoz_Option__qoz_string* _qoz_ms_167 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_167->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_167->payload.Some.f0; {
    ...
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; qoz_Option__qoz_Decl* _qoz_ms_168 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_fn_decls, name); qoz_TypeExpr* _qoz_mv_168 = NULL; switch (_qoz_ms_168->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_168->payload.Some.f0; qoz_Decl* _qoz_ms_169 = d; qoz_TypeExpr* _qoz_mv_169 = NULL; switch (_qoz_ms_169->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_169->payload.DFn.f2; qoz_TypeExpr* ret = _qoz_ms_169->payload.DFn.f4; qoz_TypeExpr* _qoz_bv_173;
    {
        if (((type_args.len) == (tparams.len)) && ((tparams.len) > 0)) { return emit_substitute_type(e, ret, tparams, type_args);} _qoz_bv_173 = ret;
    }
    _qoz_mv_169 = (_qoz_bv_173);  break; } default: { qoz_TypeExpr* _qoz_bv_174;
    {
        qoz_string _qoz_bv_175;
    {
        qoz_Strbuf _qoz_sb_1786_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1786_34); strings_sb_append(&_qoz_sb_1786_34, QOZ_STR_LIT("`")); strings_sb_append(&_qoz_sb_1786_34, name); strings_sb_append(&_qoz_sb_1786_34, QOZ_STR_LIT("` is in generic_fn_decls but not a DFn")); _qoz_bv_175 = strings_sb_finish(&_qoz_sb_1786_34);
    }
    (void)(emit_emit_die(sp, _qoz_bv_175)); _qoz_bv_174 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_169 = (_qoz_bv_174);  break; } } _qoz_mv_168 = (_qoz_mv_169);  break; } case qoz_Option__qoz_Decl_None: { qoz_Option__qoz_TypeExpr* _qoz_ms_170 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->fn_returns, name); qoz_TypeExpr* _qoz_mv_170 = NULL; switch (_qoz_ms_170->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_170->payload.Some.f0; _qoz_mv_170 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_176;
    {
        qoz_string _qoz_bv_177;
    {
        qoz_Strbuf _qoz_sb_1795_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1795_34); strings_sb_append(&_qoz_sb_1795_34, QOZ_STR_LIT("call to unknown function `")); strings_sb_append(&_qoz_sb_1795_34, name); strings_sb_append(&_qoz_sb_1795_34, QOZ_STR_LIT("` (no DFn, DExternal, or builtin matched)")); _qoz_bv_177 = strings_sb_finish(&_qoz_sb_1795_34);
    }
    (void)(emit_emit_die(sp, _qoz_bv_177)); _qoz_bv_176 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_170 = (_qoz_bv_176);  break; } } _qoz_mv_168 = (_qoz_mv_170);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_168;
}
...
void emit_emit_stmt_inner(qoz_Emitter* e, qoz_Stmt* s) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_171 = s; switch (_qoz_ms_171->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_171->payload.SLet.f1; qoz_TypeExpr* ty = _qoz_ms_171->payload.SLet.f2; qoz_Expr* value = _qoz_ms_171->payload.SLet.f3; {
        qoz_TypeExpr* bind_te = emit_binding_te(e, ty, value); qoz_gc_push_root(&bind_te); if (qoz_string_eq(name, QOZ_STR_LIT("_"))) { emit_push(e, QOZ_STR_LIT("(void)(")); emit_emit_value_with_hint(e, value, bind_te); emit_push(e, QOZ_STR_LIT("); ")); return;} qoz_string ct = emit_infer_value_ctype(e, ty, value); qoz_string _qoz_bv_178;
    {
        qoz_Strbuf _qoz_sb_1864_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1864_17); strings_sb_append(&_qoz_sb_1864_17, ct); strings_sb_append(&_qoz_sb_1864_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1864_17, name); strings_sb_append(&_qoz_sb_1864_17, QOZ_STR_LIT(" = ")); _qoz_bv_178 = strings_sb_finish(&_qoz_sb_1864_17);
    }
    emit_push(e, _qoz_bv_178); emit_emit_value_with_hint(e, value, bind_te); emit_push(e, QOZ_STR_LIT("; ")); if (emit_c_type_is_pointer(ct)) { qoz_string _qoz_bv_179;
    {
        qoz_Strbuf _qoz_sb_1868_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1868_21); strings_sb_append(&_qoz_sb_1868_21, QOZ_STR_LIT("qoz_gc_push_root(&")); strings_sb_append(&_qoz_sb_1868_21, name); strings_sb_append(&_qoz_sb_1868_21, QOZ_STR_LIT("); ")); _qoz_bv_179 = strings_sb_finish(&_qoz_sb_1868_21);
    }
    emit_push(e, _qoz_bv_179); } qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, bind_te); 
    }
    0;  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_171->payload.SVar.f1; qoz_TypeExpr* ty = _qoz_ms_171->payload.SVar.f2; qoz_Expr* value = _qoz_ms_171->payload.SVar.f3; {
        qoz_TypeExpr* bind_te = emit_binding_te(e, ty, value); qoz_gc_push_root(&bind_te); if (qoz_string_eq(name, QOZ_STR_LIT("_"))) { emit_push(e, QOZ_STR_LIT("(void)(")); emit_emit_value_with_hint(e, value, bind_te); emit_push(e, QOZ_STR_LIT("); ")); return;} qoz_string ct = emit_infer_value_ctype(e, ty, value); qoz_string _qoz_bv_180;
    {
        qoz_Strbuf _qoz_sb_1881_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1881_17); strings_sb_append(&_qoz_sb_1881_17, ct); strings_sb_append(&_qoz_sb_1881_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_1881_17, name); strings_sb_append(&_qoz_sb_1881_17, QOZ_STR_LIT(" = ")); _qoz_bv_180 = strings_sb_finish(&_qoz_sb_1881_17);
    }
    emit_push(e, _qoz_bv_180); emit_emit_value_with_hint(e, value, bind_te); emit_push(e, QOZ_STR_LIT("; ")); if (emit_c_type_is_pointer(ct)) { qoz_string _qoz_bv_181;
    {
        qoz_Strbuf _qoz_sb_1885_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_1885_21); strings_sb_append(&_qoz_sb_1885_21, QOZ_STR_LIT("qoz_gc_push_root(&")); strings_sb_append(&_qoz_sb_1885_21, name); strings_sb_append(&_qoz_sb_1885_21, QOZ_STR_LIT("); ")); _qoz_bv_181 = strings_sb_finish(&_qoz_sb_1885_21);
    }
    emit_push(e, _qoz_bv_181); } qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, bind_te); 
    }
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* expr = _qoz_ms_171->payload.SExpr.f1; qoz_Expr* _qoz_ms_172 = expr; switch (_qoz_ms_172->tag) { case qoz_Expr_EDefer: { NULL;  break; } default: { emit_emit_stmt_expr(e, expr);  break; } } 0;  break; } } 0; 
    return;
}

qoz_Vec__qoz_Expr emit_collect_defers_in_stmts(qoz_Vec__qoz_Stmt stmts) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_Vec__qoz_Expr defers = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_Stmt* _qoz_ms_173 = s; switch (_qoz_ms_173->tag) { case qoz_Stmt_SExpr: { qoz_Expr* expr = _qoz_ms_173->payload.SExpr.f1; qoz_Expr* _qoz_ms_174 = expr; switch (_qoz_ms_174->tag) { case qoz_Expr_EDefer: { qoz_Expr* body = _qoz_ms_174->payload.EDefer.f1; qoz_vec_push__qoz_Expr(&defers, body);  break; } default: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return defers;
}
...
void emit_emit_cond(qoz_Emitter* e, qoz_Expr* cond) {
    ...
    emit_push(e, QOZ_STR_LIT("(")); qoz_Expr* _qoz_ms_175 = cond; switch (_qoz_ms_175->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_175->payload.EBinary.f1; qoz_Expr* lhs = _qoz_ms_175->payload.EBinary.f2; qoz_Expr* rhs = _qoz_ms_175->payload.EBinary.f3; emit_emit_binary(e, op, lhs, rhs);  break; } default: { emit_emit_expr(e, cond);  break; } } 0; emit_push(e, QOZ_STR_LIT(")")); 
    return;
}
...
void emit_emit_stmt_expr(qoz_Emitter* e, qoz_Expr* expr) {
    ...
    qoz_Expr* _qoz_ms_176 = expr; switch (_qoz_ms_176->tag) { case qoz_Expr_EIf: { qoz_Expr* cond = _qoz_ms_176->payload.EIf.f1; qoz_Expr* then_b = _qoz_ms_176->payload.EIf.f2; qoz_Expr* else_b = _qoz_ms_176->payload.EIf.f3; {
    ...
    0;  break; } case qoz_Expr_EWhile: { qoz_Expr* cond = _qoz_ms_176->payload.EWhile.f1; qoz_Expr* body = _qoz_ms_176->payload.EWhile.f2; {
        emit_push(e, QOZ_STR_LIT("while (")); emit_emit_expr(e, cond); emit_push(e, QOZ_STR_LIT(") ")); emit_emit_branch_as_statement(e, body); 
    }
    0;  break; } case qoz_Expr_EFor: { qoz_string binding = _qoz_ms_176->payload.EFor.f1; qoz_string binding2 = _qoz_ms_176->payload.EFor.f2; qoz_Expr* iter = _qoz_ms_176->payload.EFor.f3; qoz_Expr* body = _qoz_ms_176->payload.EFor.f4; emit_emit_for_loop_one(e, binding, binding2, iter, body);  break; } case qoz_Expr_EReturn: { qoz_Expr* value = _qoz_ms_176->payload.EReturn.f1; if (emit_is_nil_expr(value)) { emit_push(e, QOZ_STR_LIT("return;")); }  else { emit_push(e, QOZ_STR_LIT("return ")); emit_emit_value_with_hint(e, value, e->current_ret_te); emit_push(e, QOZ_STR_LIT(";")); } 0;  break; } default: { {
...
void emit_emit_branch_as_statement(qoz_Emitter* e, qoz_Expr* br) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&br);
    qoz_Expr* _qoz_ms_177 = br; switch (_qoz_ms_177->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_177->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_177->payload.EBlock.f2; {
...
bool emit_path_is(qoz_Expr* callee, qoz_string a, qoz_string b) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_178 = callee; bool _qoz_mv_178 = false; switch (_qoz_ms_178->tag) { case qoz_Expr_EPath: { qoz_Vec__qoz_string segs = _qoz_ms_178->payload.EPath.f1; _qoz_mv_178 = ((((segs.len) == 2) && qoz_string_eq(segs.data[0], a)) && qoz_string_eq(segs.data[1], b));  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_178->payload.EField.f1; qoz_string name = _qoz_ms_178->payload.EField.f2; _qoz_mv_178 = (qoz_string_eq(name, b) && emit_ident_is(base, a));  break; } default: { _qoz_mv_178 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_178;
}

bool emit_ident_is(qoz_Expr* ex, qoz_string name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_179 = ex; bool _qoz_mv_179 = false; switch (_qoz_ms_179->tag) { case qoz_Expr_EIdent: { qoz_string n = _qoz_ms_179->payload.EIdent.f1; _qoz_mv_179 = (qoz_string_eq(n, name));  break; } default: { _qoz_mv_179 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_179;
}
...
qoz_string emit_qualified_call_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_180 = callee; qoz_string _qoz_mv_180 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_180->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_180->payload.EField.f1; qoz_string method = _qoz_ms_180->payload.EField.f2; qoz_Expr* _qoz_ms_181 = base; qoz_string _qoz_mv_181 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_181->tag) { case qoz_Expr_EIdent: { qoz_string pkg = _qoz_ms_181->payload.EIdent.f1; qoz_string _qoz_bv_182;
    {
        if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_string_cat(qoz_string_cat(pkg, QOZ_STR_LIT("_")), method);} _qoz_bv_182 = QOZ_STR_LIT("");
    }
    _qoz_mv_181 = (_qoz_bv_182);  break; } default: { _qoz_mv_181 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_180 = (_qoz_mv_181);  break; } default: { _qoz_mv_180 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_180;
}
...
qoz_string emit_arm_body_ctype(qoz_Emitter* e, qoz_string enum_name, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_182 = body; qoz_string _qoz_mv_182 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_182->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_182->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_183 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_183 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_183->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_183->payload.Some.f0; qoz_string _qoz_bv_183;
    {
    ...
    _qoz_mv_183 = (_qoz_bv_183);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_183 = (emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_182 = (_qoz_mv_183);  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_182->payload.ECall.f1; qoz_Expr* _qoz_ms_184 = callee; qoz_string _qoz_mv_184 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_184->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_184->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_185 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_185 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_185->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_185->payload.Some.f0; qoz_string _qoz_bv_184;
    {
        if (emit_same_enum_base(e, en, enum_name)) { return qoz_string_cat(qoz_string_cat(QOZ_STR_LIT("qoz_"), enum_name), QOZ_STR_LIT("*"));} _qoz_bv_184 = qoz_string_cat(qoz_string_cat(QOZ_STR_LIT("qoz_"), en), QOZ_STR_LIT("*"));
    }
    _qoz_mv_185 = (_qoz_bv_184);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_185 = (emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_184 = (_qoz_mv_185);  break; } default: { _qoz_mv_184 = (emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_182 = (_qoz_mv_184);  break; } default: { _qoz_mv_182 = (emit_infer_expr_ctype(e, body));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_182;
}
...
void emit_bind_arm_locals(qoz_Emitter* e, qoz_string enum_name, qoz_Pattern* pat) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&pat);
    qoz_Pattern* _qoz_ms_186 = pat; switch (_qoz_ms_186->tag) { case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_186->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_186->payload.PatVariant.f2; {
        if ((path.len) < 1) { return;} qoz_string vname = path.data[(path.len) - 1]; int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_187 = sp; switch (_qoz_ms_187->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_187->payload.PatBind.f1; (qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, emit_variant_payload_typeexpr(e, enum_name, vname, i)), 0);  break; } default: { NULL;  break; } } 0; i = i + 1; } }
    }
    0;  break; } case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_186->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_188 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, bname); switch (_qoz_ms_188->tag) { case qoz_Option__qoz_string_Some: { NULL;  break; } case qoz_Option__qoz_string_None: { {
...
void emit_emit_field(qoz_Emitter* e, qoz_Expr* base, qoz_string name) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base);
    qoz_string op = emit_field_access_op(e, base); emit_emit_expr(e, base); qoz_string _qoz_bv_185;
    {
        qoz_Strbuf _qoz_sb_2139_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2139_13); strings_sb_append(&_qoz_sb_2139_13, op); strings_sb_append(&_qoz_sb_2139_13, name); _qoz_bv_185 = strings_sb_finish(&_qoz_sb_2139_13);
    }
    emit_push(e, _qoz_bv_185); 
    return;
}
...
qoz_string emit_field_access_op(qoz_Emitter* e, qoz_Expr* base) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_189 = base; qoz_string _qoz_mv_189 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_189->tag) { case qoz_Expr_EIdent: { qoz_string ident = _qoz_ms_189->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_190 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, ident); qoz_string _qoz_mv_190 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_190->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_190->payload.Some.f0; qoz_TypeExpr* _qoz_ms_191 = te; qoz_string _qoz_mv_191 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_191->tag) { case qoz_TypeExpr_TEPtr: { _qoz_mv_191 = (QOZ_STR_LIT("->"));  break; } default: { _qoz_mv_191 = (QOZ_STR_LIT("."));  break; } } _qoz_mv_190 = (_qoz_mv_191);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_190 = (QOZ_STR_LIT("."));  break; } } _qoz_mv_189 = (_qoz_mv_190);  break; } case qoz_Expr_EUnary: { qoz_UnaryOp* op = _qoz_ms_189->payload.EUnary.f1; qoz_UnaryOp* _qoz_ms_192 = op; qoz_string _qoz_mv_192 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_192->tag) { case qoz_UnaryOp_UOpAddr: { _qoz_mv_192 = (QOZ_STR_LIT("->"));  break; } default: { _qoz_mv_192 = (QOZ_STR_LIT("."));  break; } } _qoz_mv_189 = (_qoz_mv_192);  break; } default: { _qoz_mv_189 = (QOZ_STR_LIT("."));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_189;
}
...
void emit_walk_assign_for_map_helpers(qoz_Emitter* e, qoz_Expr* lhs) {
    ...
    qoz_Expr* _qoz_ms_193 = lhs; switch (_qoz_ms_193->tag) { case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_193->payload.EIndex.f1; {
        qoz_TypeExpr* bte = emit_base_type_for_walk(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_194 = bte; switch (_qoz_ms_194->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_194->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_194->payload.TENamed.f2; if ((((path.len) >= 1) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) && ((args.len) == 2)) { emit_register_map_helper(e, QOZ_STR_LIT("map_set"), args); } 0;  break; } default: { NULL;  break; } } 0; 
    }
    0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
qoz_TypeExpr* emit_base_type_for_walk(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_195 = ex; qoz_TypeExpr* _qoz_mv_195 = NULL; switch (_qoz_ms_195->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_195->payload.EIdent.f0; qoz_string name = _qoz_ms_195->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_196 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_196 = NULL; switch (_qoz_ms_196->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_196->payload.Some.f0; _qoz_mv_196 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_196 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_195 = (_qoz_mv_196);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_195->payload.EField.f0; qoz_Expr* b = _qoz_ms_195->payload.EField.f1; qoz_string name = _qoz_ms_195->payload.EField.f2; qoz_TypeExpr* _qoz_bv_186;
    {
        qoz_TypeExpr* bte = emit_base_type_for_walk(e, b); qoz_gc_push_root(&bte); _qoz_bv_186 = emit_field_typeexpr_for_no_die(e, bte, name, sp);
    }
    _qoz_mv_195 = (_qoz_bv_186);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_195->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_195->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_195->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_197 = op; qoz_TypeExpr* _qoz_mv_197 = NULL; switch (_qoz_ms_197->tag) { case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_187;
    {
        qoz_TypeExpr* inner = emit_base_type_for_walk(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_198 = inner; qoz_TypeExpr* _qoz_mv_198 = NULL; switch (_qoz_ms_198->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_198->payload.TEPtr.f1; _qoz_mv_198 = (t);  break; } default: { _qoz_mv_198 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_187 = _qoz_mv_198;
    }
    _qoz_mv_197 = (_qoz_bv_187);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_197 = (qoz_make_TypeExpr_TEPtr(sp, emit_base_type_for_walk(e, rhs)));  break; } default: { _qoz_mv_197 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_195 = (_qoz_mv_197);  break; } default: { _qoz_mv_195 = (qoz_make_TypeExpr_TEUnit(emit_span_of_expr(ex)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_195;
}
...
qoz_TypeExpr* emit_field_typeexpr_for_no_die(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base_te);
    qoz_TypeExpr* _qoz_ms_199 = base_te; qoz_TypeExpr* _qoz_mv_199 = NULL; switch (_qoz_ms_199->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_199->payload.TEPtr.f1; _qoz_mv_199 = (inner);  break; } default: { _qoz_mv_199 = (base_te);  break; } } qoz_TypeExpr* unwrapped = _qoz_mv_199; qoz_gc_push_root(&unwrapped); qoz_TypeExpr* _qoz_ms_200 = unwrapped; qoz_TypeExpr* _qoz_mv_200 = NULL; switch (_qoz_ms_200->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_200->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_200->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_188;
    {
        if ((path.len) < 1) { return qoz_make_TypeExpr_TEUnit(sp);} qoz_string lookup = emit_type_lookup_key(e, path); qoz_Option__qoz_Decl* _qoz_ms_201 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, lookup); qoz_Option__qoz_Decl* _qoz_mv_201 = NULL; switch (_qoz_ms_201->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_201->payload.Some.f0; _qoz_mv_201 = (qoz_make_Option__qoz_Decl_Some(d));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_201 = (qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, lookup));  break; } } qoz_Option__qoz_Decl* decl_opt = _qoz_mv_201; qoz_gc_push_root(&decl_opt); qoz_Option__qoz_Decl* _qoz_ms_202 = decl_opt; qoz_TypeExpr* _qoz_mv_202 = NULL; switch (_qoz_ms_202->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_202->payload.Some.f0; qoz_Decl* _qoz_ms_203 = decl; qoz_TypeExpr* _qoz_mv_203 = NULL; switch (_qoz_ms_203->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_203->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_203->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_189;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_string_eq(f.name, field)) { if ((args.len) == (params.len)) { return emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }_qoz_bv_189 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_203 = (_qoz_bv_189);  break; } default: { _qoz_mv_203 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_202 = (_qoz_mv_203);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_202 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_188 = _qoz_mv_202;
    }
    _qoz_mv_200 = (_qoz_bv_188);  break; } default: { _qoz_mv_200 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_200;
}

void emit_register_map_helper(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_TypeExpr args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    if (!qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, name)) { return;} qoz_string mangled = emit_mangle_inst(e, name, args); if (qoz_map_contains__qoz_string__bool(&e->fn_seen, mangled)) { return;} qoz_map_set__qoz_string__bool(&e->fn_seen, mangled, true); qoz_vec_push__qoz_Instantiation(&e->fn_insts, ((qoz_Instantiation){ .name = name, .args = args, .mangled = mangled })); qoz_Option__qoz_Decl* _qoz_ms_204 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_fn_decls, name); switch (_qoz_ms_204->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_204->payload.Some.f0; emit_walk_fn_body_with_subst(e, d, args);  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; 
    return;
}
...
void emit_emit_assign(qoz_Emitter* e, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    qoz_gc_push_root(&lhs);
    qoz_gc_push_root(&rhs);
    qoz_Expr* _qoz_ms_205 = lhs; switch (_qoz_ms_205->tag) { case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_205->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_205->payload.EIndex.f2; {
        qoz_TypeExpr* te = emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_206 = te; switch (_qoz_ms_206->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_206->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_206->payload.TENamed.f2; if ((((path.len) >= 1) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) && ((args.len) == 2)) { emit_register_map_helper(e, QOZ_STR_LIT("map_set"), args); qoz_string k_m = emit_mangle_type(e, args.data[0]); qoz_string v_m = emit_mangle_type(e, args.data[1]); qoz_string _qoz_bv_190;
    {
        qoz_Strbuf _qoz_sb_2280_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2280_25); strings_sb_append(&_qoz_sb_2280_25, QOZ_STR_LIT("qoz_map_set__")); strings_sb_append(&_qoz_sb_2280_25, k_m); strings_sb_append(&_qoz_sb_2280_25, QOZ_STR_LIT("__")); strings_sb_append(&_qoz_sb_2280_25, v_m); strings_sb_append(&_qoz_sb_2280_25, QOZ_STR_LIT("(&")); _qoz_bv_190 = strings_sb_finish(&_qoz_sb_2280_25);
    }
    emit_push(e, _qoz_bv_190); emit_emit_expr(e, base); emit_push(e, QOZ_STR_LIT(", ")); emit_emit_expr(e, idx); emit_push(e, QOZ_STR_LIT(", ")); emit_emit_expr(e, rhs); emit_push(e, QOZ_STR_LIT(")")); return;} 0;  break; } default: { NULL;  break; } } 0; 
    }
...
qoz_TypeExpr* emit_lvalue_hint(qoz_Emitter* e, qoz_Expr* lhs) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&lhs);
    qoz_Span sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_Expr* _qoz_ms_207 = lhs; qoz_TypeExpr* _qoz_mv_207 = NULL; switch (_qoz_ms_207->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_207->payload.EField.f1; qoz_string name = _qoz_ms_207->payload.EField.f2; qoz_TypeExpr* _qoz_bv_191;
    {
        qoz_TypeExpr* bte = emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); _qoz_bv_191 = emit_field_typeexpr_for_no_die(e, bte, name, sp);
    }
    _qoz_mv_207 = (_qoz_bv_191);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_207->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_192;
    {
        qoz_TypeExpr* bte = emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_208 = bte; qoz_TypeExpr* _qoz_mv_208 = NULL; switch (_qoz_ms_208->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_208->payload.TEPtr.f1; _qoz_mv_208 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_208->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_208->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_193;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_193 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_208 = (_qoz_bv_193);  break; } default: { _qoz_mv_208 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_192 = _qoz_mv_208;
    }
    _qoz_mv_207 = (_qoz_bv_192);  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_207->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_209 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_209 = NULL; switch (_qoz_ms_209->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_209->payload.Some.f0; _qoz_mv_209 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_209 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_207 = (_qoz_mv_209);  break; } default: { _qoz_mv_207 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_207;
}
...
void emit_emit_index(qoz_Emitter* e, qoz_Expr* base, qoz_Expr* idx) {
    ...
    qoz_gc_push_root(&base);
    qoz_gc_push_root(&idx);
    qoz_TypeExpr* te = emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_210 = te; switch (_qoz_ms_210->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_210->payload.TENamed.f1; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_string_eq(n, QOZ_STR_LIT("Vec"))) { qoz_string op = emit_field_access_op(e, base); emit_emit_expr(e, base); qoz_string _qoz_bv_194;
    {
        qoz_Strbuf _qoz_sb_2340_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2340_25); strings_sb_append(&_qoz_sb_2340_25, op); strings_sb_append(&_qoz_sb_2340_25, QOZ_STR_LIT("data[")); _qoz_bv_194 = strings_sb_finish(&_qoz_sb_2340_25);
    }
    emit_push(e, _qoz_bv_194); emit_emit_expr(e, idx); emit_push(e, QOZ_STR_LIT("]")); return;} } 0;  break; } default: { NULL;  break; } } 0; emit_emit_expr(e, base); emit_push(e, QOZ_STR_LIT("[")); emit_emit_expr(e, idx); emit_push(e, QOZ_STR_LIT("]")); 
    return;
}
...
void emit_emit_hash_builtin(qoz_Emitter* e, qoz_Expr* arg) {
    ...
    qoz_string ct = emit_infer_expr_ctype(e, arg); if (qoz_string_eq(ct, QOZ_STR_LIT("qoz_string"))) { emit_push(e, QOZ_STR_LIT("qoz_string_hash(")); emit_emit_expr(e, arg); emit_push(e, QOZ_STR_LIT(")")); return;} qoz_string record_name = emit_record_struct_name_of_ctype(e, ct); if (!qoz_string_eq(record_name, QOZ_STR_LIT(""))) { qoz_string _qoz_bv_195;
    {
        qoz_Strbuf _qoz_sb_2364_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2364_17); strings_sb_append(&_qoz_sb_2364_17, QOZ_STR_LIT("qoz_hash_")); strings_sb_append(&_qoz_sb_2364_17, record_name); strings_sb_append(&_qoz_sb_2364_17, QOZ_STR_LIT("(")); _qoz_bv_195 = strings_sb_finish(&_qoz_sb_2364_17);
    }
    emit_push(e, _qoz_bv_195); emit_emit_expr(e, arg); emit_push(e, QOZ_STR_LIT(")")); return;} emit_push(e, QOZ_STR_LIT("(uint64_t)(")); emit_emit_expr(e, arg); emit_push(e, QOZ_STR_LIT(")")); 
    return;
}
...
void emit_emit_call(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_string qualified = emit_qualified_call_name(e, callee); if (!qoz_string_eq(qualified, QOZ_STR_LIT(""))) { if (((type_args.len) > 0) && qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, qualified)) { qoz_string mi = emit_mangle_inst(e, qualified, type_args); qoz_string _qoz_bv_196;
    {
        qoz_Strbuf _qoz_sb_2399_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2399_21); strings_sb_append(&_qoz_sb_2399_21, QOZ_STR_LIT("qoz_")); strings_sb_append(&_qoz_sb_2399_21, mi); strings_sb_append(&_qoz_sb_2399_21, QOZ_STR_LIT("(")); _qoz_bv_196 = strings_sb_finish(&_qoz_sb_2399_21);
    }
    emit_push(e, _qoz_bv_196); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, a); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;} qoz_Option__qoz_string* _qoz_ms_211 = qoz_map_get__qoz_string__qoz_string(&e->externs, qualified); qoz_string _qoz_mv_211 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_211->tag) { case qoz_Option__qoz_string_Some: { qoz_string sym = _qoz_ms_211->payload.Some.f0; _qoz_mv_211 = (sym);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_211 = (qualified);  break; } } qoz_string dispatch_name = _qoz_mv_211; qoz_string _qoz_bv_197;
    {
        qoz_Strbuf _qoz_sb_2413_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2413_17); strings_sb_append(&_qoz_sb_2413_17, dispatch_name); strings_sb_append(&_qoz_sb_2413_17, QOZ_STR_LIT("(")); _qoz_bv_197 = strings_sb_finish(&_qoz_sb_2413_17);
    }
    emit_push(e, _qoz_bv_197); qoz_Vec__qoz_TypeExpr hints = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Vec__qoz_TypeExpr* _qoz_ms_212 = qoz_map_get__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, qualified); switch (_qoz_ms_212->tag) { case qoz_Option__qoz_Vec__qoz_TypeExpr_Some: { qoz_Vec__qoz_TypeExpr pts = _qoz_ms_212->payload.Some.f0; hints = pts;  break; } case qoz_Option__qoz_Vec__qoz_TypeExpr_None: { NULL;  break; } } 0; int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } if (i < (hints.len)) { emit_emit_value_with_hint(e, a, hints.data[i]); }  else { emit_emit_expr(e, a); } i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;} qoz_Expr* _qoz_ms_213 = callee; switch (_qoz_ms_213->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_213->payload.EIdent.f1; {
    ...
    0;  break; } default: { NULL;  break; } } 0; qoz_Expr* _qoz_ms_214 = callee; switch (_qoz_ms_214->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_214->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_215 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_215->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_215->payload.Some.f0; {
        qoz_string _qoz_bv_198;
    {
        qoz_Strbuf _qoz_sb_2454_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2454_21); strings_sb_append(&_qoz_sb_2454_21, QOZ_STR_LIT("qoz_make_")); strings_sb_append(&_qoz_sb_2454_21, enum_name); strings_sb_append(&_qoz_sb_2454_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_2454_21, name); strings_sb_append(&_qoz_sb_2454_21, QOZ_STR_LIT("(")); _qoz_bv_198 = strings_sb_finish(&_qoz_sb_2454_21);
    }
    emit_push(e, _qoz_bv_198); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, a); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; if ((type_args.len) > 0) { qoz_Expr* _qoz_ms_216 = callee; switch (_qoz_ms_216->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_216->payload.EIdent.f1; if (qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, name)) { qoz_string mi = emit_mangle_inst(e, name, type_args); qoz_string _qoz_bv_199;
    {
        qoz_Strbuf _qoz_sb_2475_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2475_25); strings_sb_append(&_qoz_sb_2475_25, QOZ_STR_LIT("qoz_")); strings_sb_append(&_qoz_sb_2475_25, mi); strings_sb_append(&_qoz_sb_2475_25, QOZ_STR_LIT("(")); _qoz_bv_199 = strings_sb_finish(&_qoz_sb_2475_25);
    }
    emit_push(e, _qoz_bv_199); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, a); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;} 0;  break; } default: { NULL;  break; } } 0; } qoz_Expr* _qoz_ms_217 = callee; switch (_qoz_ms_217->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_217->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_218 = qoz_map_get__qoz_string__qoz_string(&e->externs, name); switch (_qoz_ms_218->tag) { case qoz_Option__qoz_string_Some: { qoz_string sym = _qoz_ms_218->payload.Some.f0; {
        qoz_string _qoz_bv_200;
    {
        qoz_Strbuf _qoz_sb_2494_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2494_21); strings_sb_append(&_qoz_sb_2494_21, sym); strings_sb_append(&_qoz_sb_2494_21, QOZ_STR_LIT("(")); _qoz_bv_200 = strings_sb_finish(&_qoz_sb_2494_21);
    }
    emit_push(e, _qoz_bv_200); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, a); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; qoz_TypeExpr* callee_te = emit_callee_value_typeexpr(e, callee); qoz_gc_push_root(&callee_te); qoz_TypeExpr* _qoz_ms_219 = callee_te; switch (_qoz_ms_219->tag) { case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr fn_params_te = _qoz_ms_219->payload.TEFn.f1; {
    ...
    0;  break; } default: { NULL;  break; } } 0; emit_emit_expr(e, callee); emit_push(e, QOZ_STR_LIT("(")); qoz_Vec__qoz_TypeExpr fallback_hints = qoz_vec_make__qoz_TypeExpr(); qoz_Expr* _qoz_ms_220 = callee; switch (_qoz_ms_220->tag) { case qoz_Expr_EIdent: { qoz_string cname = _qoz_ms_220->payload.EIdent.f1; qoz_Option__qoz_Vec__qoz_TypeExpr* _qoz_ms_221 = qoz_map_get__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, cname); switch (_qoz_ms_221->tag) { case qoz_Option__qoz_Vec__qoz_TypeExpr_Some: { qoz_Vec__qoz_TypeExpr pts = _qoz_ms_221->payload.Some.f0; fallback_hints = pts;  break; } case qoz_Option__qoz_Vec__qoz_TypeExpr_None: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } if (i < (fallback_hints.len)) { emit_emit_value_with_hint(e, a, fallback_hints.data[i]); }  else { emit_emit_expr(e, a); } i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); 
    return;
}
...
qoz_TypeExpr* emit_callee_value_typeexpr(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_222 = callee; qoz_TypeExpr* _qoz_mv_222 = NULL; switch (_qoz_ms_222->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_222->payload.EIdent.f0; qoz_string name = _qoz_ms_222->payload.EIdent.f1; qoz_TypeExpr* _qoz_bv_201;
    {
        qoz_Option__qoz_TypeExpr* _qoz_ms_223 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); switch (_qoz_ms_223->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_223->payload.Some.f0; return te;  break; } default: { NULL;  break; } } 0; _qoz_bv_201 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_222 = (_qoz_bv_201);  break; } default: { _qoz_mv_222 = (qoz_make_TypeExpr_TEUnit(emit_span_of_expr(callee)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_222;
}
...
qoz_string emit_binary_op_text(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_224 = op; qoz_string _qoz_mv_224 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_224->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_224 = (QOZ_STR_LIT("=="));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_224 = (QOZ_STR_LIT("!="));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_224 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_224 = (QOZ_STR_LIT(">"));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_224 = (QOZ_STR_LIT("<="));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_224 = (QOZ_STR_LIT(">="));  break; } case qoz_BinaryOp_BOpAdd: { _qoz_mv_224 = (QOZ_STR_LIT("+"));  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_224 = (QOZ_STR_LIT("-"));  break; } case qoz_BinaryOp_BOpMul: { _qoz_mv_224 = (QOZ_STR_LIT("*"));  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_224 = (QOZ_STR_LIT("/"));  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_224 = (QOZ_STR_LIT("%"));  break; } default: { _qoz_mv_224 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_224;
}
...
void emit_emit_binary(qoz_Emitter* e, qoz_BinaryOp* op, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    qoz_gc_push_root(&lhs);
    qoz_gc_push_root(&rhs);
    qoz_string lct = emit_infer_expr_ctype(e, lhs); if (qoz_string_eq(lct, QOZ_STR_LIT("qoz_string"))) { qoz_BinaryOp* _qoz_ms_225 = op; switch (_qoz_ms_225->tag) { case qoz_BinaryOp_BOpEq: { {
    ...
    0;  break; } default: { NULL;  break; } } 0; } qoz_string op_text = emit_binary_op_text(op); if (!qoz_string_eq(op_text, QOZ_STR_LIT(""))) { qoz_TypeExpr* lhs_te = emit_infer_value_te(e, lhs); qoz_gc_push_root(&lhs_te); qoz_string tname = emit_operator_first_param_type_name(lhs_te); if (!qoz_string_eq(tname, QOZ_STR_LIT(""))) { qoz_string key = qoz_string_cat(qoz_string_cat(op_text, QOZ_STR_LIT("::")), tname); qoz_Option__qoz_string* _qoz_ms_226 = qoz_map_get__qoz_string__qoz_string(&e->op_dispatch, key); switch (_qoz_ms_226->tag) { case qoz_Option__qoz_string_Some: { qoz_string fn_name = _qoz_ms_226->payload.Some.f0; {
        qoz_string ct = emit_c_type_for(e, lhs_te); qoz_Option__qoz_TypeExpr* _qoz_ms_227 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->fn_returns, fn_name); qoz_TypeExpr* _qoz_mv_227 = NULL; switch (_qoz_ms_227->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_227->payload.Some.f0; _qoz_mv_227 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_227 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_TypeExpr* ret_te = _qoz_mv_227; qoz_gc_push_root(&ret_te); qoz_string ret_ct = emit_c_type_for(e, ret_te); emit_ensure_byval_dispatch_helper(e, fn_name, ct, ret_ct); qoz_string _qoz_bv_202;
    {
        qoz_Strbuf _qoz_sb_2677_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2677_25); strings_sb_append(&_qoz_sb_2677_25, QOZ_STR_LIT("_qoz_byval_")); strings_sb_append(&_qoz_sb_2677_25, fn_name); strings_sb_append(&_qoz_sb_2677_25, QOZ_STR_LIT("(")); _qoz_bv_202 = strings_sb_finish(&_qoz_sb_2677_25);
    }
    emit_push(e, _qoz_bv_202); emit_emit_expr(e, lhs); emit_push(e, QOZ_STR_LIT(", ")); emit_emit_expr(e, rhs); emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; } } qoz_string record_name = emit_record_struct_name_of_ctype(e, lct); if (!qoz_string_eq(record_name, QOZ_STR_LIT(""))) { qoz_BinaryOp* _qoz_ms_228 = op; switch (_qoz_ms_228->tag) { case qoz_BinaryOp_BOpEq: { {
        qoz_string _qoz_bv_203;
    {
        qoz_Strbuf _qoz_sb_2690_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2690_21); strings_sb_append(&_qoz_sb_2690_21, QOZ_STR_LIT("qoz_eq_")); strings_sb_append(&_qoz_sb_2690_21, record_name); strings_sb_append(&_qoz_sb_2690_21, QOZ_STR_LIT("(")); _qoz_bv_203 = strings_sb_finish(&_qoz_sb_2690_21);
    }
    emit_push(e, _qoz_bv_203); emit_emit_expr(e, lhs); emit_push(e, QOZ_STR_LIT(", ")); emit_emit_expr(e, rhs); emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_BinaryOp_BOpNe: { {
        qoz_string _qoz_bv_204;
    {
        qoz_Strbuf _qoz_sb_2698_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2698_21); strings_sb_append(&_qoz_sb_2698_21, QOZ_STR_LIT("!qoz_eq_")); strings_sb_append(&_qoz_sb_2698_21, record_name); strings_sb_append(&_qoz_sb_2698_21, QOZ_STR_LIT("(")); _qoz_bv_204 = strings_sb_finish(&_qoz_sb_2698_21);
    }
    emit_push(e, _qoz_bv_204); emit_emit_expr(e, lhs); emit_push(e, QOZ_STR_LIT(", ")); emit_emit_expr(e, rhs); emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; } int64_t p = emit_binary_prec(op); bool needs_paren_child = emit_is_logical_op(op); emit_emit_binary_child(e, lhs, p, needs_paren_child); qoz_string bop = emit_binary_c_op(op); qoz_string _qoz_bv_205;
    {
        qoz_Strbuf _qoz_sb_2712_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2712_13); strings_sb_append(&_qoz_sb_2712_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_2712_13, bop); strings_sb_append(&_qoz_sb_2712_13, QOZ_STR_LIT(" ")); _qoz_bv_205 = strings_sb_finish(&_qoz_sb_2712_13);
    }
    emit_push(e, _qoz_bv_205); emit_emit_binary_child(e, rhs, p + 1, needs_paren_child); 
    return;
}
...
bool emit_is_logical_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_229 = op; bool _qoz_mv_229 = false; switch (_qoz_ms_229->tag) { case qoz_BinaryOp_BOpAnd: { _qoz_mv_229 = (true);  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_229 = (true);  break; } default: { _qoz_mv_229 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_229;
}
...
void emit_emit_binary_child(qoz_Emitter* e, qoz_Expr* ex, int64_t min_prec, bool force_paren_if_binary) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_230 = ex; switch (_qoz_ms_230->tag) { case qoz_Expr_EBinary: { if (force_paren_if_binary) { emit_push(e, QOZ_STR_LIT("(")); emit_emit_expr(e, ex); emit_push(e, QOZ_STR_LIT(")")); }  else { emit_emit_with_prec(e, ex, min_prec); } 0;  break; } default: { emit_emit_with_prec(e, ex, min_prec);  break; } } 0; 
    return;
}
...
int64_t emit_binary_prec(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_231 = op; int64_t _qoz_mv_231 = 0; switch (_qoz_ms_231->tag) { case qoz_BinaryOp_BOpMul: { _qoz_mv_231 = (12);  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_231 = (12);  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_231 = (12);  break; } case qoz_BinaryOp_BOpAdd: { _qoz_mv_231 = (11);  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_231 = (11);  break; } case qoz_BinaryOp_BOpShl: { _qoz_mv_231 = (10);  break; } case qoz_BinaryOp_BOpShr: { _qoz_mv_231 = (10);  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_231 = (8);  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_231 = (8);  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_231 = (8);  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_231 = (8);  break; } case qoz_BinaryOp_BOpRange: { _qoz_mv_231 = (8);  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_231 = (8);  break; } case qoz_BinaryOp_BOpEq: { _qoz_mv_231 = (7);  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_231 = (7);  break; } case qoz_BinaryOp_BOpBitAnd: { _qoz_mv_231 = (6);  break; } case qoz_BinaryOp_BOpBitXor: { _qoz_mv_231 = (5);  break; } case qoz_BinaryOp_BOpBitOr: { _qoz_mv_231 = (4);  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_231 = (3);  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_231 = (2);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_231;
}
...
void emit_emit_with_prec(qoz_Emitter* e, qoz_Expr* ex, int64_t min_prec) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_232 = ex; switch (_qoz_ms_232->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_232->payload.EBinary.f1; {
...
qoz_string emit_binary_c_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_233 = op; qoz_string _qoz_mv_233 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_233->tag) { case qoz_BinaryOp_BOpAdd: { _qoz_mv_233 = (QOZ_STR_LIT("+"));  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_233 = (QOZ_STR_LIT("-"));  break; } case qoz_BinaryOp_BOpMul: { _qoz_mv_233 = (QOZ_STR_LIT("*"));  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_233 = (QOZ_STR_LIT("/"));  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_233 = (QOZ_STR_LIT("%"));  break; } case qoz_BinaryOp_BOpEq: { _qoz_mv_233 = (QOZ_STR_LIT("=="));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_233 = (QOZ_STR_LIT("!="));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_233 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_233 = (QOZ_STR_LIT(">"));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_233 = (QOZ_STR_LIT("<="));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_233 = (QOZ_STR_LIT(">="));  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_233 = (QOZ_STR_LIT("&&"));  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_233 = (QOZ_STR_LIT("||"));  break; } case qoz_BinaryOp_BOpBitAnd: { _qoz_mv_233 = (QOZ_STR_LIT("&"));  break; } case qoz_BinaryOp_BOpBitOr: { _qoz_mv_233 = (QOZ_STR_LIT("|"));  break; } case qoz_BinaryOp_BOpBitXor: { _qoz_mv_233 = (QOZ_STR_LIT("^"));  break; } case qoz_BinaryOp_BOpShl: { _qoz_mv_233 = (QOZ_STR_LIT("<<"));  break; } case qoz_BinaryOp_BOpShr: { _qoz_mv_233 = (QOZ_STR_LIT(">>"));  break; } case qoz_BinaryOp_BOpRange: { _qoz_mv_233 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_233 = (QOZ_STR_LIT("<="));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_233;
}

qoz_string emit_unary_c_op(qoz_UnaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_UnaryOp* _qoz_ms_234 = op; qoz_string _qoz_mv_234 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_234->tag) { case qoz_UnaryOp_UOpNeg: { _qoz_mv_234 = (QOZ_STR_LIT("-"));  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_234 = (QOZ_STR_LIT("!"));  break; } case qoz_UnaryOp_UOpDeref: { _qoz_mv_234 = (QOZ_STR_LIT("*"));  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_234 = (QOZ_STR_LIT("&"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_234;
}

bool emit_is_block(qoz_Expr* ex) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_235 = ex; bool _qoz_mv_235 = false; switch (_qoz_ms_235->tag) { case qoz_Expr_EBlock: { _qoz_mv_235 = (true);  break; } default: { _qoz_mv_235 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_235;
}

bool emit_is_nil_expr(qoz_Expr* ex) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_236 = ex; bool _qoz_mv_236 = false; switch (_qoz_ms_236->tag) { case qoz_Expr_ENil: { _qoz_mv_236 = (true);  break; } default: { _qoz_mv_236 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_236;
}
...
void emit_emit_fn_body_block(qoz_Emitter* e, qoz_Expr* body, qoz_TypeExpr* ret_hint) {
    ...
    qoz_Expr* _qoz_ms_237 = body; switch (_qoz_ms_237->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_237->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_237->payload.EBlock.f2; {
        qoz_Vec__qoz_Expr defers = emit_collect_defers_in_stmts(stmts); qoz_Expr* effective_tail = tail; qoz_gc_push_root(&effective_tail); qoz_Expr* _qoz_ms_238 = tail; switch (_qoz_ms_238->tag) { case qoz_Expr_EDefer: { qoz_Expr* dbody = _qoz_ms_238->payload.EDefer.f1; {
        qoz_vec_push__qoz_Expr(&defers, dbody); effective_tail = qoz_make_Expr_ENil(emit_span_of_expr(tail)); 
    }
    0;  break; } default: { NULL;  break; } } 0; { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_emit_stmt(e, s); } }if (emit_is_nil_expr(effective_tail)) { emit_emit_defers_reverse(e, defers); emit_push(e, QOZ_STR_LIT("return;\n")); return;} if (emit_is_unit_typeexpr(ret_hint)) { qoz_StmtScope saved = emit_open_statement_scope(e); emit_emit_stmt_expr(e, effective_tail); emit_close_statement_scope(e, saved); emit_emit_defers_reverse(e, defers); emit_push(e, QOZ_STR_LIT("\n    return;\n")); return;} qoz_Expr* _qoz_ms_239 = effective_tail; switch (_qoz_ms_239->tag) { case qoz_Expr_EReturn: { {
        emit_emit_expr(e, effective_tail); emit_push(e, QOZ_STR_LIT(";\n")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; if ((defers.len) == 0) { qoz_StmtScope saved = emit_open_statement_scope(e); emit_push(e, e->current_return_restore); emit_push(e, QOZ_STR_LIT("return ")); emit_emit_value_with_hint(e, effective_tail, ret_hint); emit_push(e, QOZ_STR_LIT(";\n")); emit_close_statement_scope(e, saved); }  else { e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_206;
    {
        qoz_Strbuf _qoz_sb_2874_48 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2874_48); strings_sb_append_i64(&_qoz_sb_2874_48, e->closure_counter); _qoz_bv_206 = strings_sb_finish(&_qoz_sb_2874_48);
    }
    qoz_string tmp = qoz_string_cat(QOZ_STR_LIT("_qoz_ret_"), _qoz_bv_206); qoz_string rt = emit_c_type_for(e, ret_hint); qoz_string _qoz_bv_207;
    {
        qoz_Strbuf _qoz_sb_2876_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2876_21); strings_sb_append(&_qoz_sb_2876_21, rt); strings_sb_append(&_qoz_sb_2876_21, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_2876_21, tmp); strings_sb_append(&_qoz_sb_2876_21, QOZ_STR_LIT(" = ")); _qoz_bv_207 = strings_sb_finish(&_qoz_sb_2876_21);
    }
    emit_push(e, _qoz_bv_207); emit_emit_value_with_hint(e, effective_tail, ret_hint); emit_push(e, QOZ_STR_LIT(";\n    ")); emit_emit_defers_reverse(e, defers); qoz_string _qoz_bv_208;
    {
        qoz_Strbuf _qoz_sb_2880_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2880_21); strings_sb_append(&_qoz_sb_2880_21, QOZ_STR_LIT("\n    return ")); strings_sb_append(&_qoz_sb_2880_21, tmp); strings_sb_append(&_qoz_sb_2880_21, QOZ_STR_LIT(";\n")); _qoz_bv_208 = strings_sb_finish(&_qoz_sb_2880_21);
    }
    emit_push(e, _qoz_bv_208); } 
    }
    0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
bool emit_is_unit_typeexpr(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_240 = te; bool _qoz_mv_240 = false; switch (_qoz_ms_240->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_240 = (true);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_240->payload.TENamed.f1; bool _qoz_bv_209;
    {
        if ((path.len) != 1) { return false;} qoz_string n = path.data[0]; _qoz_bv_209 = qoz_string_eq(n, QOZ_STR_LIT("unit")) || qoz_string_eq(n, QOZ_STR_LIT("void"));
    }
    _qoz_mv_240 = (_qoz_bv_209);  break; } default: { _qoz_mv_240 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_240;
}
...
void emit_emit_fn(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&ret);
    qoz_gc_push_root(&body);
    qoz_string ret_c = emit_c_type_for(e, ret); qoz_string _qoz_bv_210;
    {
        qoz_Strbuf _qoz_sb_2901_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2901_13); strings_sb_append(&_qoz_sb_2901_13, ret_c); strings_sb_append(&_qoz_sb_2901_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_2901_13, name); _qoz_bv_210 = strings_sb_finish(&_qoz_sb_2901_13);
    }
    emit_push(e, _qoz_bv_210); if ((params.len) == 0) { emit_push(e, QOZ_STR_LIT("(void)")); }  else { emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = emit_c_type_for(e, p.ty); qoz_string pn = p.name; qoz_string _qoz_bv_211;
    {
        qoz_Strbuf _qoz_sb_2911_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2911_21); strings_sb_append(&_qoz_sb_2911_21, pc); strings_sb_append(&_qoz_sb_2911_21, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_2911_21, pn); _qoz_bv_211 = strings_sb_finish(&_qoz_sb_2911_21);
    }
    emit_push(e, _qoz_bv_211); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); } emit_push(e, QOZ_STR_LIT(" {\n    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();\n    ")); qoz_string saved_ret = e->current_return_restore; e->current_return_restore = QOZ_STR_LIT("qoz_gc_shadow_set_top(_qoz_shadow_guard); "); e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, p.name, p.ty); if (emit_c_type_is_pointer(emit_c_type_for(e, p.ty))) { qoz_string pn = p.name; qoz_string _qoz_bv_212;
    {
        qoz_Strbuf _qoz_sb_2924_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2924_21); strings_sb_append(&_qoz_sb_2924_21, QOZ_STR_LIT("qoz_gc_push_root(&")); strings_sb_append(&_qoz_sb_2924_21, pn); strings_sb_append(&_qoz_sb_2924_21, QOZ_STR_LIT(");\n    ")); _qoz_bv_212 = strings_sb_finish(&_qoz_sb_2924_21);
    }
    emit_push(e, _qoz_bv_212); } } }e->current_ret_te = ret; bool is_b = emit_is_block(body); if (is_b) { emit_emit_fn_body_block(e, body, ret); }  else { qoz_StmtScope saved = emit_open_statement_scope(e); qoz_string crr = e->current_return_restore; if (emit_is_unit_typeexpr(ret)) { emit_emit_expr(e, body); qoz_string _qoz_bv_213;
    {
        qoz_Strbuf _qoz_sb_2936_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2936_21); strings_sb_append(&_qoz_sb_2936_21, QOZ_STR_LIT(";\n    ")); strings_sb_append(&_qoz_sb_2936_21, crr); strings_sb_append(&_qoz_sb_2936_21, QOZ_STR_LIT("return;\n")); _qoz_bv_213 = strings_sb_finish(&_qoz_sb_2936_21);
    }
    emit_push(e, _qoz_bv_213); }  else { qoz_string _qoz_bv_214;
    {
        qoz_Strbuf _qoz_sb_2938_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_2938_21); strings_sb_append(&_qoz_sb_2938_21, crr); strings_sb_append(&_qoz_sb_2938_21, QOZ_STR_LIT("return ")); _qoz_bv_214 = strings_sb_finish(&_qoz_sb_2938_21);
    }
    emit_push(e, _qoz_bv_214); emit_emit_value_with_hint(e, body, ret); emit_push(e, QOZ_STR_LIT(";\n")); } emit_close_statement_scope(e, saved); } e->current_return_restore = saved_ret; e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); emit_push(e, QOZ_STR_LIT("}\n\n")); 
    return;
}
...
void emit_emit_records_topological(qoz_Emitter* e, qoz_File f) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_string names = qoz_vec_make__qoz_string(); qoz_Vec__qoz_Vec__qoz_StructField field_lists = qoz_vec_make__qoz_Vec__qoz_StructField(); { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_241 = d; switch (_qoz_ms_241->tag) { case qoz_Decl_DStruct: { qoz_string name = _qoz_ms_241->payload.DStruct.f1; qoz_Vec__qoz_string params = _qoz_ms_241->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_241->payload.DStruct.f3; if ((params.len) == 0) { qoz_vec_push__qoz_string(&names, name); qoz_vec_push__qoz_Vec__qoz_StructField(&field_lists, fields); } 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e->record_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_242 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, inst.name); switch (_qoz_ms_242->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_242->payload.Some.f0; qoz_Decl* _qoz_ms_243 = decl; switch (_qoz_ms_243->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_243->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_243->payload.DStruct.f3; {
...
qoz_Option__qoz_string* emit_value_field_dep(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_245 = te; qoz_Option__qoz_string* _qoz_mv_245 = NULL; switch (_qoz_ms_245->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_245->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_245->payload.TENamed.f2; qoz_Option__qoz_string* _qoz_bv_215;
    {
        if ((path.len) < 1) { return qoz_make_Option__qoz_string_None();} qoz_string n = path.data[(path.len) - 1]; if (!qoz_string_eq(emit_primitive_c_name(n), QOZ_STR_LIT(""))) { return qoz_make_Option__qoz_string_None();} if (qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { return qoz_make_Option__qoz_string_None();} if ((args.len) > 0) { return qoz_make_Option__qoz_string_Some(emit_mangle_inst(e, n, args));} _qoz_bv_215 = qoz_make_Option__qoz_string_Some(n);
    }
    _qoz_mv_245 = (_qoz_bv_215);  break; } default: { _qoz_mv_245 = (qoz_make_Option__qoz_string_None());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_245;
}
...
qoz_string emit_emit_program(qoz_File f, qoz_Map__int64_t__qoz_TypeExpr expr_types) {
    ...
    0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_250 = d; switch (_qoz_ms_250->tag) { case qoz_Decl_DEnum: { qoz_string name = _qoz_ms_250->payload.DEnum.f1; qoz_Vec__qoz_string params = _qoz_ms_250->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_250->payload.DEnum.f3; if ((params.len) == 0) { { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; emit_emit_variant_ctor(&e, name, v); } }} 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_251 = d; switch (_qoz_ms_251->tag) { case qoz_Decl_DFn: { qoz_string name = _qoz_ms_251->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_251->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_251->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_251->payload.DFn.f4; if (!emit_is_main(name) && ((tparams.len) == 0)) { emit_emit_fn_proto(&e, name, params, ret); } 0;  break; } case qoz_Decl_DExternal: { qoz_string symbol = _qoz_ms_251->payload.DExternal.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_251->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_251->payload.DExternal.f4; emit_emit_extern_proto(&e, symbol, params, ret);  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e.fn_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_252 = qoz_map_get__qoz_string__qoz_Decl(&e.generic_fn_decls, inst.name); switch (_qoz_ms_252->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_252->payload.Some.f0; qoz_Decl* _qoz_ms_253 = decl; switch (_qoz_ms_253->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_253->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_253->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_253->payload.DFn.f4; {
    ...
    0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } }emit_push(&e, QOZ_STR_LIT("\n")); { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_254 = d; switch (_qoz_ms_254->tag) { case qoz_Decl_DFn: { qoz_string name = _qoz_ms_254->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_254->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_254->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_254->payload.DFn.f4; qoz_Expr* body = _qoz_ms_254->payload.DFn.f5; if (emit_is_main(name)) { emit_emit_main(&e, ret, body); }  else if ((tparams.len) == 0) { emit_emit_fn(&e, name, params, ret, body); } 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e.fn_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_255 = qoz_map_get__qoz_string__qoz_Decl(&e.generic_fn_decls, inst.name); switch (_qoz_ms_255->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_255->payload.Some.f0; qoz_Decl* _qoz_ms_256 = decl; switch (_qoz_ms_256->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_256->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_256->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_256->payload.DFn.f4; qoz_Expr* body = _qoz_ms_256->payload.DFn.f5; {
...
void emit_emit_enum(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_VariantDecl variants) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    emit_push(e, QOZ_STR_LIT("typedef enum {\n")); int64_t i = 0; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_string vn = v.name; qoz_string _qoz_bv_216;
    {
        qoz_Strbuf _qoz_sb_3259_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3259_17); strings_sb_append(&_qoz_sb_3259_17, QOZ_STR_LIT("    qoz_")); strings_sb_append(&_qoz_sb_3259_17, name); strings_sb_append(&_qoz_sb_3259_17, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3259_17, vn); strings_sb_append(&_qoz_sb_3259_17, QOZ_STR_LIT(",\n")); _qoz_bv_216 = strings_sb_finish(&_qoz_sb_3259_17);
    }
    emit_push(e, _qoz_bv_216); i = i + 1; } }qoz_string _qoz_bv_217;
    {
        qoz_Strbuf _qoz_sb_3262_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3262_13); strings_sb_append(&_qoz_sb_3262_13, QOZ_STR_LIT("} qoz_")); strings_sb_append(&_qoz_sb_3262_13, name); strings_sb_append(&_qoz_sb_3262_13, QOZ_STR_LIT("_tag;\n\n")); _qoz_bv_217 = strings_sb_finish(&_qoz_sb_3262_13);
    }
    emit_push(e, _qoz_bv_217); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (emit_variant_has_positional(v)) { qoz_string vn = v.name; emit_push(e, QOZ_STR_LIT("typedef struct {\n")); int64_t k = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pt = __col.data[__i]; (void)pt; qoz_string pc = emit_c_type_for(e, pt); qoz_string ks = emit_int_to_string(k); qoz_string _qoz_bv_218;
    {
        qoz_Strbuf _qoz_sb_3271_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3271_25); strings_sb_append(&_qoz_sb_3271_25, QOZ_STR_LIT("    ")); strings_sb_append(&_qoz_sb_3271_25, pc); strings_sb_append(&_qoz_sb_3271_25, QOZ_STR_LIT(" f")); strings_sb_append(&_qoz_sb_3271_25, ks); strings_sb_append(&_qoz_sb_3271_25, QOZ_STR_LIT(";\n")); _qoz_bv_218 = strings_sb_finish(&_qoz_sb_3271_25);
    }
    emit_push(e, _qoz_bv_218); k = k + 1; } }qoz_string _qoz_bv_219;
    {
        qoz_Strbuf _qoz_sb_3274_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3274_21); strings_sb_append(&_qoz_sb_3274_21, QOZ_STR_LIT("} qoz_")); strings_sb_append(&_qoz_sb_3274_21, name); strings_sb_append(&_qoz_sb_3274_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3274_21, vn); strings_sb_append(&_qoz_sb_3274_21, QOZ_STR_LIT("_payload;\n\n")); _qoz_bv_219 = strings_sb_finish(&_qoz_sb_3274_21);
    }
    emit_push(e, _qoz_bv_219); } } }qoz_string _qoz_bv_220;
    {
        qoz_Strbuf _qoz_sb_3277_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3277_13); strings_sb_append(&_qoz_sb_3277_13, QOZ_STR_LIT("struct qoz_")); strings_sb_append(&_qoz_sb_3277_13, name); strings_sb_append(&_qoz_sb_3277_13, QOZ_STR_LIT(" {\n    qoz_")); strings_sb_append(&_qoz_sb_3277_13, name); strings_sb_append(&_qoz_sb_3277_13, QOZ_STR_LIT("_tag tag;\n")); _qoz_bv_220 = strings_sb_finish(&_qoz_sb_3277_13);
    }
    emit_push(e, _qoz_bv_220); bool any_payload = false; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (emit_variant_has_positional(v)) { any_payload = true; } } }if (any_payload) { emit_push(e, QOZ_STR_LIT("    union {\n")); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (emit_variant_has_positional(v)) { qoz_string vn = v.name; qoz_string _qoz_bv_221;
    {
        qoz_Strbuf _qoz_sb_3287_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3287_25); strings_sb_append(&_qoz_sb_3287_25, QOZ_STR_LIT("        qoz_")); strings_sb_append(&_qoz_sb_3287_25, name); strings_sb_append(&_qoz_sb_3287_25, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3287_25, vn); strings_sb_append(&_qoz_sb_3287_25, QOZ_STR_LIT("_payload ")); strings_sb_append(&_qoz_sb_3287_25, vn); strings_sb_append(&_qoz_sb_3287_25, QOZ_STR_LIT(";\n")); _qoz_bv_221 = strings_sb_finish(&_qoz_sb_3287_25);
    }
    emit_push(e, _qoz_bv_221); } } }emit_push(e, QOZ_STR_LIT("    } payload;\n")); } emit_push(e, QOZ_STR_LIT("};\n\n")); emit_emit_adt_desc(e, name, variants); 
    return;
}
...
qoz_string emit_int_to_string(int64_t n) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_Strbuf _qoz_sb_3298_37 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3298_37); strings_sb_append_i64(&_qoz_sb_3298_37, n); qoz_gc_shadow_set_top(_qoz_shadow_guard); return strings_sb_finish(&_qoz_sb_3298_37);
}

void emit_emit_variant_ctor(qoz_Emitter* e, qoz_string enum_name, qoz_VariantDecl v) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string vn = v.name; qoz_string _qoz_bv_222;
    {
        qoz_Strbuf _qoz_sb_3302_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3302_13); strings_sb_append(&_qoz_sb_3302_13, QOZ_STR_LIT("static qoz_")); strings_sb_append(&_qoz_sb_3302_13, enum_name); strings_sb_append(&_qoz_sb_3302_13, QOZ_STR_LIT(" *qoz_make_")); strings_sb_append(&_qoz_sb_3302_13, enum_name); strings_sb_append(&_qoz_sb_3302_13, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3302_13, vn); _qoz_bv_222 = strings_sb_finish(&_qoz_sb_3302_13);
    }
    emit_push(e, _qoz_bv_222); if (!emit_variant_has_positional(v)) { emit_push(e, QOZ_STR_LIT("(void) {\n")); }  else { emit_push(e, QOZ_STR_LIT("(")); int64_t k = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pt = __col.data[__i]; (void)pt; if (k > 0) { emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = emit_c_type_for(e, pt); qoz_string ks = emit_int_to_string(k); qoz_string _qoz_bv_223;
    {
        qoz_Strbuf _qoz_sb_3312_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3312_21); strings_sb_append(&_qoz_sb_3312_21, pc); strings_sb_append(&_qoz_sb_3312_21, QOZ_STR_LIT(" f")); strings_sb_append(&_qoz_sb_3312_21, ks); _qoz_bv_223 = strings_sb_finish(&_qoz_sb_3312_21);
    }
    emit_push(e, _qoz_bv_223); k = k + 1; } }emit_push(e, QOZ_STR_LIT(") {\n")); } qoz_string _qoz_bv_224;
    {
        qoz_Strbuf _qoz_sb_3317_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3317_13); strings_sb_append(&_qoz_sb_3317_13, QOZ_STR_LIT("    qoz_")); strings_sb_append(&_qoz_sb_3317_13, enum_name); strings_sb_append(&_qoz_sb_3317_13, QOZ_STR_LIT(" *p = qoz_gc_alloc(sizeof(qoz_")); strings_sb_append(&_qoz_sb_3317_13, enum_name); strings_sb_append(&_qoz_sb_3317_13, QOZ_STR_LIT("), &qoz_")); strings_sb_append(&_qoz_sb_3317_13, enum_name); strings_sb_append(&_qoz_sb_3317_13, QOZ_STR_LIT("_desc);\n")); _qoz_bv_224 = strings_sb_finish(&_qoz_sb_3317_13);
    }
    emit_push(e, _qoz_bv_224); qoz_string _qoz_bv_225;
    {
        qoz_Strbuf _qoz_sb_3318_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3318_13); strings_sb_append(&_qoz_sb_3318_13, QOZ_STR_LIT("    p->tag = qoz_")); strings_sb_append(&_qoz_sb_3318_13, enum_name); strings_sb_append(&_qoz_sb_3318_13, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3318_13, vn); strings_sb_append(&_qoz_sb_3318_13, QOZ_STR_LIT(";\n")); _qoz_bv_225 = strings_sb_finish(&_qoz_sb_3318_13);
    }
    emit_push(e, _qoz_bv_225); if (emit_variant_has_positional(v)) { int64_t j = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* _ = __col.data[__i]; (void)_; qoz_string js = emit_int_to_string(j); qoz_string _qoz_bv_226;
    {
        qoz_Strbuf _qoz_sb_3323_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3323_21); strings_sb_append(&_qoz_sb_3323_21, QOZ_STR_LIT("    p->payload.")); strings_sb_append(&_qoz_sb_3323_21, vn); strings_sb_append(&_qoz_sb_3323_21, QOZ_STR_LIT(".f")); strings_sb_append(&_qoz_sb_3323_21, js); strings_sb_append(&_qoz_sb_3323_21, QOZ_STR_LIT(" = f")); strings_sb_append(&_qoz_sb_3323_21, js); strings_sb_append(&_qoz_sb_3323_21, QOZ_STR_LIT(";\n")); _qoz_bv_226 = strings_sb_finish(&_qoz_sb_3323_21);
    }
    emit_push(e, _qoz_bv_226); j = j + 1; } }} emit_push(e, QOZ_STR_LIT("    return p;\n}\n\n")); 
    return;
}
...
void emit_collect_field_ptr_offsets(qoz_Emitter* e, qoz_string parent, qoz_string field, qoz_TypeExpr* te, qoz_Vec__qoz_string* out) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&out);
    qoz_string base = qoz_string_cat(QOZ_STR_LIT("offsetof("), qoz_string_cat(parent, qoz_string_cat(QOZ_STR_LIT(", "), qoz_string_cat(field, QOZ_STR_LIT(")"))))); qoz_TypeExpr* _qoz_ms_257 = te; switch (_qoz_ms_257->tag) { case qoz_TypeExpr_TEPtr: { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)"), base));  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_257->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_257->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)"), base)); return;} if (qoz_string_eq(n, QOZ_STR_LIT("string"))) { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)("), qoz_string_cat(base, QOZ_STR_LIT(" + offsetof(qoz_string, data))")))); qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)("), qoz_string_cat(base, QOZ_STR_LIT(" + offsetof(qoz_string, root))")))); return;} if (qoz_string_eq(n, QOZ_STR_LIT("Vec")) || qoz_string_eq(n, QOZ_STR_LIT("Map"))) { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)"), base)); return;} if ((args.len) == 0) { qoz_Option__qoz_Decl* _qoz_ms_258 = qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, n); switch (_qoz_ms_258->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_258->payload.Some.f0; qoz_Decl* _qoz_ms_259 = d; switch (_qoz_ms_259->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_259->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_259->payload.DStruct.f3; if ((params.len) == 0) { qoz_string inner_parent = qoz_string_cat(QOZ_STR_LIT("struct qoz_"), n); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField sf = __col.data[__i]; (void)sf; qoz_string composed_parent = inner_parent; qoz_string composed_field = sf.name; qoz_Vec__qoz_string inner_offsets = qoz_vec_make__qoz_string(); emit_collect_field_ptr_offsets(e, composed_parent, composed_field, sf.ty, &inner_offsets); { qoz_Vec__qoz_string __col = inner_offsets; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string inner = __col.data[__i]; (void)inner; qoz_string stripped = qoz_string_slice(inner, 9, (inner).len); qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)("), qoz_string_cat(base, qoz_string_cat(QOZ_STR_LIT(" + "), qoz_string_cat(stripped, QOZ_STR_LIT(")")))))); } }} }return;} 0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } } 0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
void emit_emit_record_desc(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string parent = qoz_string_cat(QOZ_STR_LIT("struct qoz_"), name); qoz_Vec__qoz_string offsets = qoz_vec_make__qoz_string(); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; emit_collect_field_ptr_offsets(e, parent, f.name, f.ty, &offsets); } }int64_t nptrs = (offsets.len); if (nptrs > 0) { qoz_string _qoz_bv_227;
    {
        qoz_Strbuf _qoz_sb_3412_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3412_17); strings_sb_append(&_qoz_sb_3412_17, QOZ_STR_LIT("static const int32_t qoz_")); strings_sb_append(&_qoz_sb_3412_17, name); strings_sb_append(&_qoz_sb_3412_17, QOZ_STR_LIT("_offsets[] = { ")); _qoz_bv_227 = strings_sb_finish(&_qoz_sb_3412_17);
    }
    emit_push(e, _qoz_bv_227); int64_t i = 0; { qoz_Vec__qoz_string __col = offsets; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string expr = __col.data[__i]; (void)expr; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_push(e, expr); i = i + 1; } }emit_push(e, QOZ_STR_LIT(" };\n")); } if (nptrs == 0) { qoz_string _qoz_bv_228;
    {
        qoz_Strbuf _qoz_sb_3422_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3422_17); strings_sb_append(&_qoz_sb_3422_17, QOZ_STR_LIT("static const qoz_type_desc qoz_")); strings_sb_append(&_qoz_sb_3422_17, name); strings_sb_append(&_qoz_sb_3422_17, QOZ_STR_LIT("_desc = { QOZ_DESC_LEAF, (int32_t)sizeof(struct qoz_")); strings_sb_append(&_qoz_sb_3422_17, name); strings_sb_append(&_qoz_sb_3422_17, QOZ_STR_LIT("), 0, NULL, 0, 0, 0, NULL, \"")); strings_sb_append(&_qoz_sb_3422_17, name); strings_sb_append(&_qoz_sb_3422_17, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_228 = strings_sb_finish(&_qoz_sb_3422_17);
    }
    emit_push(e, _qoz_bv_228); }  else { qoz_string np = emit_int_to_string(nptrs); qoz_string _qoz_bv_229;
    {
        qoz_Strbuf _qoz_sb_3425_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3425_17); strings_sb_append(&_qoz_sb_3425_17, QOZ_STR_LIT("static const qoz_type_desc qoz_")); strings_sb_append(&_qoz_sb_3425_17, name); strings_sb_append(&_qoz_sb_3425_17, QOZ_STR_LIT("_desc = { QOZ_DESC_OFFSETS, (int32_t)sizeof(struct qoz_")); strings_sb_append(&_qoz_sb_3425_17, name); strings_sb_append(&_qoz_sb_3425_17, QOZ_STR_LIT("), ")); strings_sb_append(&_qoz_sb_3425_17, np); strings_sb_append(&_qoz_sb_3425_17, QOZ_STR_LIT(", qoz_")); strings_sb_append(&_qoz_sb_3425_17, name); strings_sb_append(&_qoz_sb_3425_17, QOZ_STR_LIT("_offsets, 0, 0, 0, NULL, \"")); strings_sb_append(&_qoz_sb_3425_17, name); strings_sb_append(&_qoz_sb_3425_17, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_229 = strings_sb_finish(&_qoz_sb_3425_17);
    }
    emit_push(e, _qoz_bv_229); } 
    return;
}
...
void emit_emit_adt_desc(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_VariantDecl variants) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_Vec__qoz_string voffs = emit_collect_variant_ptr_offsets(e, name, v); if ((voffs.len) > 0) { qoz_string vn = v.name; qoz_string _qoz_bv_230;
    {
        qoz_Strbuf _qoz_sb_3462_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3462_21); strings_sb_append(&_qoz_sb_3462_21, QOZ_STR_LIT("static const int32_t qoz_")); strings_sb_append(&_qoz_sb_3462_21, name); strings_sb_append(&_qoz_sb_3462_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3462_21, vn); strings_sb_append(&_qoz_sb_3462_21, QOZ_STR_LIT("_offsets[] = { ")); _qoz_bv_230 = strings_sb_finish(&_qoz_sb_3462_21);
    }
    emit_push(e, _qoz_bv_230); int64_t j = 0; { qoz_Vec__qoz_string __col = voffs; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string expr = __col.data[__i]; (void)expr; if (j > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_push(e, expr); j = j + 1; } }emit_push(e, QOZ_STR_LIT(" };\n")); } } }qoz_string _qoz_bv_231;
    {
        qoz_Strbuf _qoz_sb_3472_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3472_13); strings_sb_append(&_qoz_sb_3472_13, QOZ_STR_LIT("static const qoz_variant_desc qoz_")); strings_sb_append(&_qoz_sb_3472_13, name); strings_sb_append(&_qoz_sb_3472_13, QOZ_STR_LIT("_variants[] = {\n")); _qoz_bv_231 = strings_sb_finish(&_qoz_sb_3472_13);
    }
    emit_push(e, _qoz_bv_231); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_Vec__qoz_string voffs = emit_collect_variant_ptr_offsets(e, name, v); int64_t nptrs = (voffs.len); qoz_string vn = v.name; qoz_string np = emit_int_to_string(nptrs); if (nptrs > 0) { qoz_string _qoz_bv_232;
    {
        qoz_Strbuf _qoz_sb_3479_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3479_21); strings_sb_append(&_qoz_sb_3479_21, QOZ_STR_LIT("    { qoz_")); strings_sb_append(&_qoz_sb_3479_21, name); strings_sb_append(&_qoz_sb_3479_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3479_21, vn); strings_sb_append(&_qoz_sb_3479_21, QOZ_STR_LIT(", ")); strings_sb_append(&_qoz_sb_3479_21, np); strings_sb_append(&_qoz_sb_3479_21, QOZ_STR_LIT(", qoz_")); strings_sb_append(&_qoz_sb_3479_21, name); strings_sb_append(&_qoz_sb_3479_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3479_21, vn); strings_sb_append(&_qoz_sb_3479_21, QOZ_STR_LIT("_offsets },\n")); _qoz_bv_232 = strings_sb_finish(&_qoz_sb_3479_21);
    }
    emit_push(e, _qoz_bv_232); }  else { qoz_string _qoz_bv_233;
    {
        qoz_Strbuf _qoz_sb_3481_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3481_21); strings_sb_append(&_qoz_sb_3481_21, QOZ_STR_LIT("    { qoz_")); strings_sb_append(&_qoz_sb_3481_21, name); strings_sb_append(&_qoz_sb_3481_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3481_21, vn); strings_sb_append(&_qoz_sb_3481_21, QOZ_STR_LIT(", ")); strings_sb_append(&_qoz_sb_3481_21, np); strings_sb_append(&_qoz_sb_3481_21, QOZ_STR_LIT(", NULL },\n")); _qoz_bv_233 = strings_sb_finish(&_qoz_sb_3481_21);
    }
    emit_push(e, _qoz_bv_233); } } }emit_push(e, QOZ_STR_LIT("};\n")); bool any_payload2 = false; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (emit_variant_has_positional(v)) { any_payload2 = true; } } }qoz_string payload_off_expr = ((any_payload2) ? qoz_string_cat(QOZ_STR_LIT("(int32_t)offsetof(struct qoz_"), qoz_string_cat(name, QOZ_STR_LIT(", payload)"))) : QOZ_STR_LIT("0")); qoz_string nvar = emit_int_to_string((variants.len)); qoz_string _qoz_bv_234;
    {
        qoz_Strbuf _qoz_sb_3495_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3495_13); strings_sb_append(&_qoz_sb_3495_13, QOZ_STR_LIT("static const qoz_type_desc qoz_")); strings_sb_append(&_qoz_sb_3495_13, name); strings_sb_append(&_qoz_sb_3495_13, QOZ_STR_LIT("_desc = { QOZ_DESC_ADT, (int32_t)sizeof(struct qoz_")); strings_sb_append(&_qoz_sb_3495_13, name); strings_sb_append(&_qoz_sb_3495_13, QOZ_STR_LIT("), 0, NULL, (int32_t)offsetof(struct qoz_")); strings_sb_append(&_qoz_sb_3495_13, name); strings_sb_append(&_qoz_sb_3495_13, QOZ_STR_LIT(", tag), ")); strings_sb_append(&_qoz_sb_3495_13, payload_off_expr); strings_sb_append(&_qoz_sb_3495_13, QOZ_STR_LIT(", ")); strings_sb_append(&_qoz_sb_3495_13, nvar); strings_sb_append(&_qoz_sb_3495_13, QOZ_STR_LIT(", qoz_")); strings_sb_append(&_qoz_sb_3495_13, name); strings_sb_append(&_qoz_sb_3495_13, QOZ_STR_LIT("_variants, \"")); strings_sb_append(&_qoz_sb_3495_13, name); strings_sb_append(&_qoz_sb_3495_13, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_234 = strings_sb_finish(&_qoz_sb_3495_13);
    }
...
void emit_emit_struct(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string _qoz_bv_235;
    {
        qoz_Strbuf _qoz_sb_3499_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3499_13); strings_sb_append(&_qoz_sb_3499_13, QOZ_STR_LIT("struct qoz_")); strings_sb_append(&_qoz_sb_3499_13, name); strings_sb_append(&_qoz_sb_3499_13, QOZ_STR_LIT(" {\n")); _qoz_bv_235 = strings_sb_finish(&_qoz_sb_3499_13);
    }
    emit_push(e, _qoz_bv_235); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; qoz_string ct = emit_c_type_for(e, f.ty); qoz_string fname = f.name; qoz_string _qoz_bv_236;
    {
        qoz_Strbuf _qoz_sb_3503_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3503_17); strings_sb_append(&_qoz_sb_3503_17, QOZ_STR_LIT("    ")); strings_sb_append(&_qoz_sb_3503_17, ct); strings_sb_append(&_qoz_sb_3503_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3503_17, fname); strings_sb_append(&_qoz_sb_3503_17, QOZ_STR_LIT(";\n")); _qoz_bv_236 = strings_sb_finish(&_qoz_sb_3503_17);
    }
    emit_push(e, _qoz_bv_236); } }emit_push(e, QOZ_STR_LIT("};\n\n")); emit_emit_record_eq(e, name, fields); emit_emit_record_desc(e, name, fields); 
    return;
}
...
void emit_emit_record_eq(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    ...
    {
        qoz_Strbuf _qoz_sb_3511_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3511_13); strings_sb_append(&_qoz_sb_3511_13, QOZ_STR_LIT("static bool qoz_eq_")); strings_sb_append(&_qoz_sb_3511_13, name); strings_sb_append(&_qoz_sb_3511_13, QOZ_STR_LIT("(qoz_")); strings_sb_append(&_qoz_sb_3511_13, name); strings_sb_append(&_qoz_sb_3511_13, QOZ_STR_LIT(" a, qoz_")); strings_sb_append(&_qoz_sb_3511_13, name); strings_sb_append(&_qoz_sb_3511_13, QOZ_STR_LIT(" b) {\n    return ")); _qoz_bv_237 = strings_sb_finish(&_qoz_sb_3511_13);
    }
    emit_push(e, _qoz_bv_237); if ((fields.len) == 0) { emit_push(e, QOZ_STR_LIT("true")); }  else { int64_t i = 0; { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (i > 0) { emit_push(e, QOZ_STR_LIT(" && ")); } emit_emit_field_eq_expr(e, f.ty, f.name); i = i + 1; } }} emit_push(e, QOZ_STR_LIT(";\n}\n\n")); emit_emit_record_hash(e, name, fields); 
    return;
}
...
void emit_emit_record_hash(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string _qoz_bv_238;
    {
        qoz_Strbuf _qoz_sb_3527_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3527_13); strings_sb_append(&_qoz_sb_3527_13, QOZ_STR_LIT("static uint64_t qoz_hash_")); strings_sb_append(&_qoz_sb_3527_13, name); strings_sb_append(&_qoz_sb_3527_13, QOZ_STR_LIT("(qoz_")); strings_sb_append(&_qoz_sb_3527_13, name); strings_sb_append(&_qoz_sb_3527_13, QOZ_STR_LIT(" v) {\n    uint64_t h = 0;\n")); _qoz_bv_238 = strings_sb_finish(&_qoz_sb_3527_13);
    }
    emit_push(e, _qoz_bv_238); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; emit_push(e, QOZ_STR_LIT("    h = h * 31 + (uint64_t)(")); emit_emit_field_hash_expr(e, f.ty, f.name); emit_push(e, QOZ_STR_LIT(");\n")); } }emit_push(e, QOZ_STR_LIT("    return h;\n}\n\n")); 
    return;
}
...
void emit_emit_field_hash_expr(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string fname) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_string ct = emit_c_type_for(e, te); if (qoz_string_eq(ct, QOZ_STR_LIT("qoz_string"))) { qoz_string _qoz_bv_239;
    {
        qoz_Strbuf _qoz_sb_3539_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3539_17); strings_sb_append(&_qoz_sb_3539_17, QOZ_STR_LIT("qoz_string_hash(v.")); strings_sb_append(&_qoz_sb_3539_17, fname); strings_sb_append(&_qoz_sb_3539_17, QOZ_STR_LIT(")")); _qoz_bv_239 = strings_sb_finish(&_qoz_sb_3539_17);
    }
    emit_push(e, _qoz_bv_239); return;} qoz_TypeExpr* _qoz_ms_260 = te; switch (_qoz_ms_260->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_260->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_260->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_string_eq(emit_primitive_c_name(n), QOZ_STR_LIT(""))) { if (!qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_string mangled = (((args.len) > 0) ? emit_mangle_inst(e, n, args) : n); qoz_string _qoz_bv_240;
    {
        qoz_Strbuf _qoz_sb_3549_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3549_29); strings_sb_append(&_qoz_sb_3549_29, QOZ_STR_LIT("qoz_hash_")); strings_sb_append(&_qoz_sb_3549_29, mangled); strings_sb_append(&_qoz_sb_3549_29, QOZ_STR_LIT("(v.")); strings_sb_append(&_qoz_sb_3549_29, fname); strings_sb_append(&_qoz_sb_3549_29, QOZ_STR_LIT(")")); _qoz_bv_240 = strings_sb_finish(&_qoz_sb_3549_29);
    }
    emit_push(e, _qoz_bv_240); return;} } } 0;  break; } default: { NULL;  break; } } 0; qoz_string _qoz_bv_241;
    {
        qoz_Strbuf _qoz_sb_3557_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3557_13); strings_sb_append(&_qoz_sb_3557_13, QOZ_STR_LIT("v.")); strings_sb_append(&_qoz_sb_3557_13, fname); _qoz_bv_241 = strings_sb_finish(&_qoz_sb_3557_13);
    }
    emit_push(e, _qoz_bv_241); 
    return;
}
...
void emit_emit_field_eq_expr(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string fname) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_string ct = emit_c_type_for(e, te); if (qoz_string_eq(ct, QOZ_STR_LIT("qoz_string"))) { qoz_string _qoz_bv_242;
    {
        qoz_Strbuf _qoz_sb_3563_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3563_17); strings_sb_append(&_qoz_sb_3563_17, QOZ_STR_LIT("qoz_string_eq(a.")); strings_sb_append(&_qoz_sb_3563_17, fname); strings_sb_append(&_qoz_sb_3563_17, QOZ_STR_LIT(", b.")); strings_sb_append(&_qoz_sb_3563_17, fname); strings_sb_append(&_qoz_sb_3563_17, QOZ_STR_LIT(")")); _qoz_bv_242 = strings_sb_finish(&_qoz_sb_3563_17);
    }
    emit_push(e, _qoz_bv_242); return;} qoz_TypeExpr* _qoz_ms_261 = te; switch (_qoz_ms_261->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_261->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_261->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_string_eq(emit_primitive_c_name(n), QOZ_STR_LIT(""))) { if (!qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_string mangled = (((args.len) > 0) ? emit_mangle_inst(e, n, args) : n); qoz_string _qoz_bv_243;
    {
        qoz_Strbuf _qoz_sb_3573_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3573_29); strings_sb_append(&_qoz_sb_3573_29, QOZ_STR_LIT("qoz_eq_")); strings_sb_append(&_qoz_sb_3573_29, mangled); strings_sb_append(&_qoz_sb_3573_29, QOZ_STR_LIT("(a.")); strings_sb_append(&_qoz_sb_3573_29, fname); strings_sb_append(&_qoz_sb_3573_29, QOZ_STR_LIT(", b.")); strings_sb_append(&_qoz_sb_3573_29, fname); strings_sb_append(&_qoz_sb_3573_29, QOZ_STR_LIT(")")); _qoz_bv_243 = strings_sb_finish(&_qoz_sb_3573_29);
    }
    emit_push(e, _qoz_bv_243); return;} } } 0;  break; } default: { NULL;  break; } } 0; qoz_string _qoz_bv_244;
    {
        qoz_Strbuf _qoz_sb_3581_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3581_13); strings_sb_append(&_qoz_sb_3581_13, QOZ_STR_LIT("a.")); strings_sb_append(&_qoz_sb_3581_13, fname); strings_sb_append(&_qoz_sb_3581_13, QOZ_STR_LIT(" == b.")); strings_sb_append(&_qoz_sb_3581_13, fname); _qoz_bv_244 = strings_sb_finish(&_qoz_sb_3581_13);
    }
    emit_push(e, _qoz_bv_244); 
    return;
}
...
void emit_emit_fn_proto(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ret);
    qoz_string rc = emit_c_type_for(e, ret); qoz_string _qoz_bv_245;
    {
        qoz_Strbuf _qoz_sb_3586_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3586_13); strings_sb_append(&_qoz_sb_3586_13, rc); strings_sb_append(&_qoz_sb_3586_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3586_13, name); _qoz_bv_245 = strings_sb_finish(&_qoz_sb_3586_13);
    }
    emit_push(e, _qoz_bv_245); if ((params.len) == 0) { emit_push(e, QOZ_STR_LIT("(void);\n")); return;} emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = emit_c_type_for(e, p.ty); qoz_string pn = p.name; qoz_string _qoz_bv_246;
    {
        qoz_Strbuf _qoz_sb_3597_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3597_17); strings_sb_append(&_qoz_sb_3597_17, pc); strings_sb_append(&_qoz_sb_3597_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3597_17, pn); _qoz_bv_246 = strings_sb_finish(&_qoz_sb_3597_17);
    }
    emit_push(e, _qoz_bv_246); i = i + 1; } }emit_push(e, QOZ_STR_LIT(");\n")); 
    return;
}
...
void emit_emit_extern_proto(qoz_Emitter* e, qoz_string symbol, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ret);
    qoz_string rc = emit_c_type_for(e, ret); qoz_string _qoz_bv_247;
    {
        qoz_Strbuf _qoz_sb_3605_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3605_13); strings_sb_append(&_qoz_sb_3605_13, QOZ_STR_LIT("extern ")); strings_sb_append(&_qoz_sb_3605_13, rc); strings_sb_append(&_qoz_sb_3605_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3605_13, symbol); _qoz_bv_247 = strings_sb_finish(&_qoz_sb_3605_13);
    }
    emit_push(e, _qoz_bv_247); if ((params.len) == 0) { emit_push(e, QOZ_STR_LIT("(void);\n")); return;} emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_push(e, emit_c_type_for(e, p.ty)); i = i + 1; } }emit_push(e, QOZ_STR_LIT(");\n")); 
    return;
}
...
bool emit_is_range_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_262 = op; bool _qoz_mv_262 = false; switch (_qoz_ms_262->tag) { case qoz_BinaryOp_BOpRange: { _qoz_mv_262 = (true);  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_262 = (true);  break; } default: { _qoz_mv_262 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_262;
}

qoz_string emit_range_cmp_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_263 = op; qoz_string _qoz_mv_263 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_263->tag) { case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_263 = (QOZ_STR_LIT("<="));  break; } default: { _qoz_mv_263 = (QOZ_STR_LIT("<"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_263;
}
...
void emit_emit_block_tail_as_value(qoz_Emitter* e, qoz_Expr* tail) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&tail);
    qoz_Expr* _qoz_ms_264 = tail; switch (_qoz_ms_264->tag) { case qoz_Expr_EAssign: { qoz_Expr* lhs = _qoz_ms_264->payload.EAssign.f2; qoz_Expr* rhs = _qoz_ms_264->payload.EAssign.f3; {
    ...
    0;  break; } case qoz_Expr_EIf: { qoz_Expr* f = _qoz_ms_264->payload.EIf.f3; {
...
void emit_emit_value_with_hint(qoz_Emitter* e, qoz_Expr* value, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&value);
    qoz_gc_push_root(&hint);
    qoz_Expr* _qoz_ms_265 = value; switch (_qoz_ms_265->tag) { case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_265->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_265->payload.ERecord.f2; emit_emit_record_lit_with_hint(e, te, fields, hint);  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_265->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_265->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_265->payload.ECall.f3; emit_emit_call_with_hint(e, callee, ta, args, hint);  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_265->payload.EIdent.f1; emit_emit_ident_with_hint(e, name, hint);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_265->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_265->payload.EArrayLit.f1; emit_emit_array_lit_with_hint(e, sp, elems, hint);  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_265->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_265->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_265->payload.EBlock.f2; {
        if ((stmts.len) == 0) { qoz_Expr* _qoz_ms_266 = tail; switch (_qoz_ms_266->tag) { case qoz_Expr_EWhile: { {
    ...
    0;  break; } default: { emit_emit_value_with_hint(e, tail, hint);  break; } } 0; return;} e->closure_counter = e->closure_counter + 1; int64_t counter = e->closure_counter; qoz_string _qoz_bv_248;
    {
        qoz_Strbuf _qoz_sb_3698_47 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3698_47); strings_sb_append_i64(&_qoz_sb_3698_47, counter); _qoz_bv_248 = strings_sb_finish(&_qoz_sb_3698_47);
    }
    qoz_string tmp_res = qoz_string_cat(QOZ_STR_LIT("_qoz_bv_"), _qoz_bv_248); qoz_string result_c = emit_c_type_for(e, hint); int64_t start = strings_sb_len(&e->out); qoz_string _qoz_bv_249;
    {
        qoz_Strbuf _qoz_sb_3701_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3701_17); strings_sb_append(&_qoz_sb_3701_17, result_c); strings_sb_append(&_qoz_sb_3701_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3701_17, tmp_res); strings_sb_append(&_qoz_sb_3701_17, QOZ_STR_LIT(";\n    {\n        ")); _qoz_bv_249 = strings_sb_finish(&_qoz_sb_3701_17);
    }
    emit_push(e, _qoz_bv_249); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; emit_emit_stmt(e, s); } }qoz_Expr* _qoz_ms_267 = tail; switch (_qoz_ms_267->tag) { case qoz_Expr_EWhile: { {
    ...
    {
        qoz_Strbuf _qoz_sb_3708_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3708_21); strings_sb_append(&_qoz_sb_3708_21, QOZ_STR_LIT("\n        ")); strings_sb_append(&_qoz_sb_3708_21, tmp_res); strings_sb_append(&_qoz_sb_3708_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_250 = strings_sb_finish(&_qoz_sb_3708_21);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_3708_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3708_21); strings_sb_append(&_qoz_sb_3708_21, QOZ_STR_LIT("\n        ")); strings_sb_append(&_qoz_sb_3708_21, tmp_res); strings_sb_append(&_qoz_sb_3708_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_251 = strings_sb_finish(&_qoz_sb_3708_21);
    }
    emit_push(e, _qoz_bv_251); 
    }
    0;  break; } case qoz_Expr_EAssign: { {
        qoz_StmtScope saved = emit_open_statement_scope(e); emit_emit_stmt_expr(e, tail); emit_close_statement_scope(e, saved); qoz_string _qoz_bv_252;
    {
        qoz_Strbuf _qoz_sb_3708_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3708_21); strings_sb_append(&_qoz_sb_3708_21, QOZ_STR_LIT("\n        ")); strings_sb_append(&_qoz_sb_3708_21, tmp_res); strings_sb_append(&_qoz_sb_3708_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_252 = strings_sb_finish(&_qoz_sb_3708_21);
    }
    emit_push(e, _qoz_bv_252); 
    }
    0;  break; } default: { {
        qoz_StmtScope saved = emit_open_statement_scope(e); qoz_string _qoz_bv_253;
    {
        qoz_Strbuf _qoz_sb_3712_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3712_21); strings_sb_append(&_qoz_sb_3712_21, tmp_res); strings_sb_append(&_qoz_sb_3712_21, QOZ_STR_LIT(" = ")); _qoz_bv_253 = strings_sb_finish(&_qoz_sb_3712_21);
    }
    emit_push(e, _qoz_bv_253); emit_emit_value_with_hint(e, tail, hint); emit_push(e, QOZ_STR_LIT(";\n    ")); emit_close_statement_scope(e, saved); 
    }
    0;  break; } } 0; emit_push(e, QOZ_STR_LIT("}\n    ")); emit_hoist_to_prologue(e, start); emit_push(e, tmp_res); 
    }
    0;  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_265->payload.EIf.f0; qoz_Expr* c = _qoz_ms_265->payload.EIf.f1; qoz_Expr* t = _qoz_ms_265->payload.EIf.f2; qoz_Expr* f = _qoz_ms_265->payload.EIf.f3; {
    ...
    0;  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_265->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_265->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_265->payload.EMatch.f2; emit_emit_match_as_expr_with_hint(e, sp, scrut, arms, hint);  break; } default: { emit_emit_expr(e, value);  break; } } 0; 
    return;
}
...
void emit_emit_ident_with_hint(qoz_Emitter* e, qoz_string name, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&hint);
    qoz_Option__qoz_string* _qoz_ms_268 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_268->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_268->payload.Some.f0; {
        qoz_Vec__qoz_TypeExpr hint_args = emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_254;
    {
        qoz_Strbuf _qoz_sb_3749_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3749_21); strings_sb_append(&_qoz_sb_3749_21, QOZ_STR_LIT("qoz_make_")); strings_sb_append(&_qoz_sb_3749_21, mangled); strings_sb_append(&_qoz_sb_3749_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3749_21, name); strings_sb_append(&_qoz_sb_3749_21, QOZ_STR_LIT("()")); _qoz_bv_254 = strings_sb_finish(&_qoz_sb_3749_21);
    }
    emit_push(e, _qoz_bv_254); return;} qoz_string _qoz_bv_255;
    {
        qoz_Strbuf _qoz_sb_3752_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3752_17); strings_sb_append(&_qoz_sb_3752_17, QOZ_STR_LIT("qoz_make_")); strings_sb_append(&_qoz_sb_3752_17, enum_name); strings_sb_append(&_qoz_sb_3752_17, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3752_17, name); strings_sb_append(&_qoz_sb_3752_17, QOZ_STR_LIT("()")); _qoz_bv_255 = strings_sb_finish(&_qoz_sb_3752_17);
    }
    emit_push(e, _qoz_bv_255); 
    }
    0;  break; } case qoz_Option__qoz_string_None: { {
        qoz_TypeExpr* _qoz_ms_269 = hint; switch (_qoz_ms_269->tag) { case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr fn_ps = _qoz_ms_269->payload.TEFn.f1; qoz_TypeExpr* fn_ret = _qoz_ms_269->payload.TEFn.f2; if (qoz_map_contains__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, name)) { if (!qoz_map_contains__qoz_string__qoz_TypeExpr(&e->locals, name)) { qoz_string thunk = emit_register_fn_thunk(e, name, fn_ps, fn_ret); qoz_string clo_t = emit_c_type_for(e, hint); qoz_string _qoz_bv_256;
    {
        qoz_Strbuf _qoz_sb_3763_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3763_29); strings_sb_append(&_qoz_sb_3763_29, QOZ_STR_LIT("((")); strings_sb_append(&_qoz_sb_3763_29, clo_t); strings_sb_append(&_qoz_sb_3763_29, QOZ_STR_LIT("){ .env = NULL, .fn = ")); strings_sb_append(&_qoz_sb_3763_29, thunk); strings_sb_append(&_qoz_sb_3763_29, QOZ_STR_LIT(" })")); _qoz_bv_256 = strings_sb_finish(&_qoz_sb_3763_29);
    }
    emit_push(e, _qoz_bv_256); return;} } 0;  break; } default: { NULL;  break; } } 0; emit_push(e, name); 
    }
    0;  break; } } 0; 
    return;
}
...
void emit_emit_call_with_hint(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&callee);
    qoz_gc_push_root(&hint);
    if ((type_args.len) > 0) { emit_emit_call(e, callee, type_args, args); return;} qoz_Expr* _qoz_ms_270 = callee; switch (_qoz_ms_270->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_270->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_271 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_271->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_271->payload.Some.f0; {
        qoz_Vec__qoz_TypeExpr hint_args = emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_257;
    {
        qoz_Strbuf _qoz_sb_3848_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3848_25); strings_sb_append(&_qoz_sb_3848_25, QOZ_STR_LIT("qoz_make_")); strings_sb_append(&_qoz_sb_3848_25, mangled); strings_sb_append(&_qoz_sb_3848_25, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_3848_25, name); strings_sb_append(&_qoz_sb_3848_25, QOZ_STR_LIT("(")); _qoz_bv_257 = strings_sb_finish(&_qoz_sb_3848_25);
    }
    emit_push(e, _qoz_bv_257); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } emit_emit_expr(e, a); i = i + 1; } }emit_push(e, QOZ_STR_LIT(")")); return;} 
    }
...
qoz_Vec__qoz_TypeExpr emit_hint_args_for_enum(qoz_TypeExpr* hint, qoz_string enum_name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_272 = hint; qoz_Vec__qoz_TypeExpr _qoz_mv_272 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_272->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_272->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_272->payload.TENamed.f2; qoz_Vec__qoz_TypeExpr _qoz_bv_258;
    {
        if ((path.len) >= 1) { qoz_string last = path.data[(path.len) - 1]; if (qoz_string_eq(last, enum_name)) { return args;} } _qoz_bv_258 = qoz_vec_make__qoz_TypeExpr();
    }
    _qoz_mv_272 = (_qoz_bv_258);  break; } default: { _qoz_mv_272 = (qoz_vec_make__qoz_TypeExpr());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_272;
}
...
void emit_emit_record_lit_with_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_Vec__qoz_RecordFieldLit fields, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* effective = emit_pick_type_with_args(te, hint); qoz_gc_push_root(&effective); qoz_string ec = emit_c_type_for(e, effective); qoz_string _qoz_bv_259;
    {
        qoz_Strbuf _qoz_sb_3883_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3883_13); strings_sb_append(&_qoz_sb_3883_13, QOZ_STR_LIT("((")); strings_sb_append(&_qoz_sb_3883_13, ec); strings_sb_append(&_qoz_sb_3883_13, QOZ_STR_LIT("){ ")); _qoz_bv_259 = strings_sb_finish(&_qoz_sb_3883_13);
    }
    emit_push(e, _qoz_bv_259); int64_t i = 0; { qoz_Vec__qoz_RecordFieldLit __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; if (i > 0) { emit_push(e, QOZ_STR_LIT(", ")); } qoz_string fn = f.name; qoz_string _qoz_bv_260;
    {
        qoz_Strbuf _qoz_sb_3888_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3888_17); strings_sb_append(&_qoz_sb_3888_17, QOZ_STR_LIT(".")); strings_sb_append(&_qoz_sb_3888_17, fn); strings_sb_append(&_qoz_sb_3888_17, QOZ_STR_LIT(" = ")); _qoz_bv_260 = strings_sb_finish(&_qoz_sb_3888_17);
    }
    emit_push(e, _qoz_bv_260); qoz_TypeExpr* field_hint = emit_field_type_hint(e, effective, f.name); qoz_gc_push_root(&field_hint); emit_emit_value_with_hint(e, f.value, field_hint); i = i + 1; } }emit_push(e, QOZ_STR_LIT(" })")); 
    return;
}
...
qoz_TypeExpr* emit_field_type_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string field_name) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_273 = te; qoz_TypeExpr* _qoz_mv_273 = NULL; switch (_qoz_ms_273->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_273->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_273->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_273->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_261;
    {
        if ((path.len) < 1) { return te;} qoz_string name = emit_type_lookup_key(e, path); if (!qoz_map_contains__qoz_string__qoz_Decl(&e->generic_decls, name)) { return te;} qoz_Option__qoz_Decl* _qoz_ms_274 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, name); qoz_TypeExpr* _qoz_mv_274 = NULL; switch (_qoz_ms_274->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_274->payload.Some.f0; qoz_Decl* _qoz_ms_275 = decl; qoz_TypeExpr* _qoz_mv_275 = NULL; switch (_qoz_ms_275->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_275->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_275->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_262;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField sf = __col.data[__i]; (void)sf; if (qoz_string_eq(sf.name, field_name)) { if ((args.len) == (params.len)) { return emit_substitute_type(e, sf.ty, params, args);} return sf.ty;} } }_qoz_bv_262 = te;
    }
    _qoz_mv_275 = (_qoz_bv_262);  break; } default: { _qoz_mv_275 = (te);  break; } } _qoz_mv_274 = (_qoz_mv_275);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_274 = (te);  break; } } _qoz_bv_261 = _qoz_mv_274;
    }
    _qoz_mv_273 = (_qoz_bv_261);  break; } default: { _qoz_mv_273 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_273;
}
...
qoz_TypeExpr* emit_pick_type_with_args(qoz_TypeExpr* te, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_276 = te; qoz_TypeExpr* _qoz_mv_276 = NULL; switch (_qoz_ms_276->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string te_path = _qoz_ms_276->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr te_args = _qoz_ms_276->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_263;
    {
        if ((te_args.len) > 0) { return te;} qoz_TypeExpr* _qoz_ms_277 = hint; qoz_TypeExpr* _qoz_mv_277 = NULL; switch (_qoz_ms_277->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string h_path = _qoz_ms_277->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr h_args = _qoz_ms_277->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_264;
    {
        if ((h_args.len) == 0) { return te;} if ((((h_path.len) == 1) && ((te_path.len) == 1)) && qoz_string_eq(h_path.data[0], te_path.data[0])) { return hint;} _qoz_bv_264 = te;
    }
    _qoz_mv_277 = (_qoz_bv_264);  break; } default: { _qoz_mv_277 = (te);  break; } } _qoz_bv_263 = _qoz_mv_277;
    }
    _qoz_mv_276 = (_qoz_bv_263);  break; } default: { _qoz_mv_276 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_276;
}
...
void emit_emit_for_loop_one(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_278 = iter; switch (_qoz_ms_278->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_278->payload.EBinary.f1; qoz_Expr* lo = _qoz_ms_278->payload.EBinary.f2; qoz_Expr* hi = _qoz_ms_278->payload.EBinary.f3; if (emit_is_range_op(op)) { qoz_string _qoz_bv_265;
    {
        qoz_Strbuf _qoz_sb_3964_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3964_21); strings_sb_append(&_qoz_sb_3964_21, QOZ_STR_LIT("for (int64_t ")); strings_sb_append(&_qoz_sb_3964_21, binding); strings_sb_append(&_qoz_sb_3964_21, QOZ_STR_LIT(" = ")); _qoz_bv_265 = strings_sb_finish(&_qoz_sb_3964_21);
    }
    emit_push(e, _qoz_bv_265); emit_emit_expr(e, lo); qoz_string cmp = emit_range_cmp_op(op); qoz_string _qoz_bv_266;
    {
        qoz_Strbuf _qoz_sb_3967_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3967_21); strings_sb_append(&_qoz_sb_3967_21, QOZ_STR_LIT("; ")); strings_sb_append(&_qoz_sb_3967_21, binding); strings_sb_append(&_qoz_sb_3967_21, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3967_21, cmp); strings_sb_append(&_qoz_sb_3967_21, QOZ_STR_LIT(" ")); _qoz_bv_266 = strings_sb_finish(&_qoz_sb_3967_21);
    }
    emit_push(e, _qoz_bv_266); emit_emit_expr(e, hi); qoz_string _qoz_bv_267;
    {
        qoz_Strbuf _qoz_sb_3969_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3969_21); strings_sb_append(&_qoz_sb_3969_21, QOZ_STR_LIT("; ")); strings_sb_append(&_qoz_sb_3969_21, binding); strings_sb_append(&_qoz_sb_3969_21, QOZ_STR_LIT("++) ")); _qoz_bv_267 = strings_sb_finish(&_qoz_sb_3969_21);
    }
    emit_push(e, _qoz_bv_267); emit_emit_branch_as_statement(e, body); return;} 0;  break; } default: { NULL;  break; } } 0; if (qoz_string_eq(binding2, QOZ_STR_LIT(""))) { emit_emit_vec_for(e, binding, iter, body); }  else { emit_emit_map_for(e, binding, binding2, iter, body); } 
    return;
}
...
void emit_emit_vec_for(qoz_Emitter* e, qoz_string binding, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* elem_te = emit_vec_element_typeexpr(e, iter); qoz_gc_push_root(&elem_te); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, binding, elem_te); qoz_string col_ct = emit_c_type_for(e, emit_infer_base_typeexpr(e, iter)); qoz_string elem_ct = emit_c_type_for(e, elem_te); qoz_string _qoz_bv_268;
    {
        qoz_Strbuf _qoz_sb_3989_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3989_13); strings_sb_append(&_qoz_sb_3989_13, QOZ_STR_LIT("{ ")); strings_sb_append(&_qoz_sb_3989_13, col_ct); strings_sb_append(&_qoz_sb_3989_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_268 = strings_sb_finish(&_qoz_sb_3989_13);
    }
    emit_push(e, _qoz_bv_268); emit_emit_expr(e, iter); qoz_string _qoz_bv_269;
    {
        qoz_Strbuf _qoz_sb_3991_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_3991_13); strings_sb_append(&_qoz_sb_3991_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.len; __i++) { ")); strings_sb_append(&_qoz_sb_3991_13, elem_ct); strings_sb_append(&_qoz_sb_3991_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_3991_13, binding); strings_sb_append(&_qoz_sb_3991_13, QOZ_STR_LIT(" = __col.data[__i]; (void)")); strings_sb_append(&_qoz_sb_3991_13, binding); strings_sb_append(&_qoz_sb_3991_13, QOZ_STR_LIT("; ")); _qoz_bv_269 = strings_sb_finish(&_qoz_sb_3991_13);
    }
    emit_push(e, _qoz_bv_269); emit_emit_branch_body_inline(e, body); emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* emit_vec_element_typeexpr(qoz_Emitter* e, qoz_Expr* iter) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&iter);
    qoz_TypeExpr* te = emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_279 = te; qoz_TypeExpr* _qoz_mv_279 = NULL; switch (_qoz_ms_279->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_279->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_279->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_279->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_270;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_270 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_279 = (_qoz_bv_270);  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_279->payload.TEPtr.f1; _qoz_mv_279 = (inner);  break; } default: { _qoz_mv_279 = (qoz_make_TypeExpr_TEUnit(emit_span_of_expr(iter)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_279;
}
...
void emit_emit_map_for(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* iter_te = emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&iter_te); qoz_string col_ct = emit_c_type_for(e, iter_te); qoz_TypeExpr* key_te = emit_map_key_typeexpr(e, iter_te); qoz_gc_push_root(&key_te); qoz_TypeExpr* val_te = emit_map_val_typeexpr(e, iter_te); qoz_gc_push_root(&val_te); qoz_string key_ct = emit_c_type_for(e, key_te); qoz_string val_ct = emit_c_type_for(e, val_te); qoz_string _qoz_bv_271;
    {
        qoz_Strbuf _qoz_sb_4015_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4015_13); strings_sb_append(&_qoz_sb_4015_13, QOZ_STR_LIT("{ ")); strings_sb_append(&_qoz_sb_4015_13, col_ct); strings_sb_append(&_qoz_sb_4015_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_271 = strings_sb_finish(&_qoz_sb_4015_13);
    }
    emit_push(e, _qoz_bv_271); emit_emit_expr(e, iter); qoz_string _qoz_bv_272;
    {
        qoz_Strbuf _qoz_sb_4017_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4017_13); strings_sb_append(&_qoz_sb_4017_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.cap; __i++) { if (!__col.slots[__i].occupied || __col.slots[__i].deleted) continue; ")); strings_sb_append(&_qoz_sb_4017_13, key_ct); strings_sb_append(&_qoz_sb_4017_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4017_13, binding); strings_sb_append(&_qoz_sb_4017_13, QOZ_STR_LIT(" = __col.slots[__i].key; ")); strings_sb_append(&_qoz_sb_4017_13, val_ct); strings_sb_append(&_qoz_sb_4017_13, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4017_13, binding2); strings_sb_append(&_qoz_sb_4017_13, QOZ_STR_LIT(" = __col.slots[__i].value; (void)")); strings_sb_append(&_qoz_sb_4017_13, binding); strings_sb_append(&_qoz_sb_4017_13, QOZ_STR_LIT("; (void)")); strings_sb_append(&_qoz_sb_4017_13, binding2); strings_sb_append(&_qoz_sb_4017_13, QOZ_STR_LIT("; ")); _qoz_bv_272 = strings_sb_finish(&_qoz_sb_4017_13);
    }
    emit_push(e, _qoz_bv_272); emit_emit_branch_body_inline(e, body); emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* emit_map_key_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[0];} _qoz_bv_273 = qoz_make_TypeExpr_TEUnit(sp);
    }
...
qoz_TypeExpr* emit_map_val_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_281 = te; qoz_TypeExpr* _qoz_mv_281 = NULL; switch (_qoz_ms_281->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_281->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_281->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_281->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_274;
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[1];} _qoz_bv_274 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_281 = (_qoz_bv_274);  break; } default: { _qoz_mv_281 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_281;
}
...
void emit_emit_branch_body_inline(qoz_Emitter* e, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_282 = body; switch (_qoz_ms_282->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_282->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_282->payload.EBlock.f2; {
...
bool emit_any_arm_is_literal(qoz_Vec__qoz_MatchArm arms) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm a = __col.data[__i]; (void)a; qoz_Pattern* _qoz_ms_283 = a.pat; switch (_qoz_ms_283->tag) { case qoz_Pattern_PatLitInt: { return true; break; } case qoz_Pattern_PatLitString: { return true; break; } case qoz_Pattern_PatLitBool: { return true; break; } default: { NULL;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return false;
}
...
void emit_emit_match_as_expr(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    if (emit_any_arm_has_guard(arms)) { emit_emit_match_as_if_chain(e, span, scrut, arms); return;} if (emit_any_arm_is_literal(arms)) { emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string bare_enum = emit_find_enum_from_arms(e, arms); if (qoz_string_eq(bare_enum, QOZ_STR_LIT(""))) { emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string enum_name = emit_enum_lookup_name(e, scrut, bare_enum); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_275;
    {
        qoz_Strbuf _qoz_sb_4103_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4103_21); strings_sb_append(&_qoz_sb_4103_21, QOZ_STR_LIT("_qoz_ms_")); strings_sb_append_i64(&_qoz_sb_4103_21, e->match_counter); _qoz_bv_275 = strings_sb_finish(&_qoz_sb_4103_21);
    }
    qoz_string scrut_tmp = _qoz_bv_275; qoz_string _qoz_bv_276;
    {
        qoz_Strbuf _qoz_sb_4104_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4104_21); strings_sb_append(&_qoz_sb_4104_21, QOZ_STR_LIT("_qoz_mv_")); strings_sb_append_i64(&_qoz_sb_4104_21, e->match_counter); _qoz_bv_276 = strings_sb_finish(&_qoz_sb_4104_21);
    }
    qoz_string res_tmp = _qoz_bv_276; qoz_string res_ctype = emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_string_eq(res_ctype, QOZ_STR_LIT("void")); int64_t start = strings_sb_len(&e->out); qoz_string _qoz_bv_277;
    {
        qoz_Strbuf _qoz_sb_4113_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4113_13); strings_sb_append(&_qoz_sb_4113_13, QOZ_STR_LIT("qoz_")); strings_sb_append(&_qoz_sb_4113_13, enum_name); strings_sb_append(&_qoz_sb_4113_13, QOZ_STR_LIT("* ")); strings_sb_append(&_qoz_sb_4113_13, scrut_tmp); strings_sb_append(&_qoz_sb_4113_13, QOZ_STR_LIT(" = ")); _qoz_bv_277 = strings_sb_finish(&_qoz_sb_4113_13);
    }
    emit_push(e, _qoz_bv_277); emit_emit_expr(e, scrut); emit_push(e, QOZ_STR_LIT("; ")); if (!is_void) { qoz_string dv = emit_default_value_for(res_ctype); qoz_string _qoz_bv_278;
    {
        qoz_Strbuf _qoz_sb_4118_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4118_17); strings_sb_append(&_qoz_sb_4118_17, res_ctype); strings_sb_append(&_qoz_sb_4118_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4118_17, res_tmp); strings_sb_append(&_qoz_sb_4118_17, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_4118_17, dv); strings_sb_append(&_qoz_sb_4118_17, QOZ_STR_LIT("; ")); _qoz_bv_278 = strings_sb_finish(&_qoz_sb_4118_17);
    }
    emit_push(e, _qoz_bv_278); } qoz_string _qoz_bv_279;
    {
        qoz_Strbuf _qoz_sb_4120_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4120_13); strings_sb_append(&_qoz_sb_4120_13, QOZ_STR_LIT("switch (")); strings_sb_append(&_qoz_sb_4120_13, scrut_tmp); strings_sb_append(&_qoz_sb_4120_13, QOZ_STR_LIT("->tag) { ")); _qoz_bv_279 = strings_sb_finish(&_qoz_sb_4120_13);
    }
    emit_push(e, _qoz_bv_279); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; emit_emit_match_arm_with_kind(e, enum_name, scrut_tmp, res_tmp, arm, is_void); } }emit_push(e, QOZ_STR_LIT("} ")); emit_hoist_to_prologue(e, start); if (is_void) { emit_push(e, QOZ_STR_LIT("0")); }  else { emit_push(e, res_tmp); } 
    return;
}
...
void emit_emit_match_as_if_chain(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    qoz_string bare_enum = emit_find_enum_from_arms(e, arms); bool is_enum_match = !qoz_string_eq(bare_enum, QOZ_STR_LIT("")); qoz_string enum_name = QOZ_STR_LIT(""); if (is_enum_match) { enum_name = emit_enum_lookup_name(e, scrut, bare_enum); } qoz_string scrut_ctype = emit_infer_expr_ctype(e, scrut); qoz_TypeExpr* scrut_te = emit_infer_value_te(e, scrut); qoz_gc_push_root(&scrut_te); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_280;
    {
        qoz_Strbuf _qoz_sb_4141_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4141_21); strings_sb_append(&_qoz_sb_4141_21, QOZ_STR_LIT("_qoz_ms_")); strings_sb_append_i64(&_qoz_sb_4141_21, e->match_counter); _qoz_bv_280 = strings_sb_finish(&_qoz_sb_4141_21);
    }
    qoz_string scrut_tmp = _qoz_bv_280; qoz_string _qoz_bv_281;
    {
        qoz_Strbuf _qoz_sb_4142_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4142_21); strings_sb_append(&_qoz_sb_4142_21, QOZ_STR_LIT("_qoz_mv_")); strings_sb_append_i64(&_qoz_sb_4142_21, e->match_counter); _qoz_bv_281 = strings_sb_finish(&_qoz_sb_4142_21);
    }
    qoz_string res_tmp = _qoz_bv_281; qoz_string _qoz_bv_282;
    {
        qoz_Strbuf _qoz_sb_4143_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4143_21); strings_sb_append(&_qoz_sb_4143_21, QOZ_STR_LIT("_qoz_mm_")); strings_sb_append_i64(&_qoz_sb_4143_21, e->match_counter); _qoz_bv_282 = strings_sb_finish(&_qoz_sb_4143_21);
    }
    qoz_string mflag = _qoz_bv_282; qoz_string res_ctype = emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_string_eq(res_ctype, QOZ_STR_LIT("void")); int64_t start = strings_sb_len(&e->out); if (is_enum_match) { qoz_string _qoz_bv_283;
    {
        qoz_Strbuf _qoz_sb_4148_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4148_17); strings_sb_append(&_qoz_sb_4148_17, QOZ_STR_LIT("qoz_")); strings_sb_append(&_qoz_sb_4148_17, enum_name); strings_sb_append(&_qoz_sb_4148_17, QOZ_STR_LIT("* ")); strings_sb_append(&_qoz_sb_4148_17, scrut_tmp); strings_sb_append(&_qoz_sb_4148_17, QOZ_STR_LIT(" = ")); _qoz_bv_283 = strings_sb_finish(&_qoz_sb_4148_17);
    }
    emit_push(e, _qoz_bv_283); }  else { qoz_string _qoz_bv_284;
    {
        qoz_Strbuf _qoz_sb_4150_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4150_17); strings_sb_append(&_qoz_sb_4150_17, scrut_ctype); strings_sb_append(&_qoz_sb_4150_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4150_17, scrut_tmp); strings_sb_append(&_qoz_sb_4150_17, QOZ_STR_LIT(" = ")); _qoz_bv_284 = strings_sb_finish(&_qoz_sb_4150_17);
    }
    emit_push(e, _qoz_bv_284); } emit_emit_expr(e, scrut); emit_push(e, QOZ_STR_LIT("; ")); if (!is_void) { qoz_string dv = emit_default_value_for(res_ctype); qoz_string _qoz_bv_285;
    {
        qoz_Strbuf _qoz_sb_4156_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4156_17); strings_sb_append(&_qoz_sb_4156_17, res_ctype); strings_sb_append(&_qoz_sb_4156_17, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4156_17, res_tmp); strings_sb_append(&_qoz_sb_4156_17, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_4156_17, dv); strings_sb_append(&_qoz_sb_4156_17, QOZ_STR_LIT("; ")); _qoz_bv_285 = strings_sb_finish(&_qoz_sb_4156_17);
    }
    emit_push(e, _qoz_bv_285); } qoz_string _qoz_bv_286;
    {
        qoz_Strbuf _qoz_sb_4158_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4158_13); strings_sb_append(&_qoz_sb_4158_13, QOZ_STR_LIT("bool ")); strings_sb_append(&_qoz_sb_4158_13, mflag); strings_sb_append(&_qoz_sb_4158_13, QOZ_STR_LIT(" = false; ")); _qoz_bv_286 = strings_sb_finish(&_qoz_sb_4158_13);
    }
    emit_push(e, _qoz_bv_286); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; emit_emit_arm_in_chain_with_te(e, enum_name, scrut_tmp, scrut_te, res_tmp, mflag, arm, is_void); } }emit_hoist_to_prologue(e, start); if (is_void) { emit_push(e, QOZ_STR_LIT("0")); }  else { emit_push(e, res_tmp); } 
    return;
}
...
void emit_emit_arm_in_chain_with_te(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_TypeExpr* scrut_te, qoz_string res_tmp, qoz_string mflag, qoz_MatchArm arm, bool is_void) {
    ...
    qoz_TypeExpr* body_hint = emit_match_body_hint(e, enum_name, arm.body); qoz_gc_push_root(&body_hint); bool is_enum_match = !qoz_string_eq(enum_name, QOZ_STR_LIT("")); emit_push(e, QOZ_STR_LIT("if (!")); emit_push(e, mflag); qoz_Pattern* _qoz_ms_284 = arm.pat; switch (_qoz_ms_284->tag) { case qoz_Pattern_PatWild: { emit_push(e, QOZ_STR_LIT(") { "));  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_284->payload.PatBind.f1; if (is_enum_match) { qoz_Option__qoz_string* _qoz_ms_285 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_285->tag) { case qoz_Option__qoz_string_Some: { qoz_string _qoz_bv_287;
    {
        qoz_Strbuf _qoz_sb_4180_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4180_25); strings_sb_append(&_qoz_sb_4180_25, QOZ_STR_LIT(" && ")); strings_sb_append(&_qoz_sb_4180_25, scrut_tmp); strings_sb_append(&_qoz_sb_4180_25, QOZ_STR_LIT("->tag == qoz_")); strings_sb_append(&_qoz_sb_4180_25, enum_name); strings_sb_append(&_qoz_sb_4180_25, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_4180_25, name); strings_sb_append(&_qoz_sb_4180_25, QOZ_STR_LIT(") { ")); _qoz_bv_287 = strings_sb_finish(&_qoz_sb_4180_25);
    }
    emit_push(e, _qoz_bv_287);  break; } default: { qoz_string _qoz_bv_288;
    {
        qoz_Strbuf _qoz_sb_4182_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4182_25); strings_sb_append(&_qoz_sb_4182_25, QOZ_STR_LIT(") { int64_t ")); strings_sb_append(&_qoz_sb_4182_25, name); strings_sb_append(&_qoz_sb_4182_25, QOZ_STR_LIT(" = 0; (void)")); strings_sb_append(&_qoz_sb_4182_25, name); strings_sb_append(&_qoz_sb_4182_25, QOZ_STR_LIT("; ")); _qoz_bv_288 = strings_sb_finish(&_qoz_sb_4182_25);
    }
    emit_push(e, _qoz_bv_288);  break; } } 0; }  else { qoz_string sc = emit_c_type_for(e, scrut_te); qoz_string _qoz_bv_289;
    {
        qoz_Strbuf _qoz_sb_4186_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4186_21); strings_sb_append(&_qoz_sb_4186_21, QOZ_STR_LIT(") { ")); strings_sb_append(&_qoz_sb_4186_21, sc); strings_sb_append(&_qoz_sb_4186_21, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4186_21, name); strings_sb_append(&_qoz_sb_4186_21, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_4186_21, scrut_tmp); strings_sb_append(&_qoz_sb_4186_21, QOZ_STR_LIT("; (void)")); strings_sb_append(&_qoz_sb_4186_21, name); strings_sb_append(&_qoz_sb_4186_21, QOZ_STR_LIT("; ")); _qoz_bv_289 = strings_sb_finish(&_qoz_sb_4186_21);
    }
    emit_push(e, _qoz_bv_289); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, scrut_te); } 0;  break; } case qoz_Pattern_PatLitInt: { qoz_string text = _qoz_ms_284->payload.PatLitInt.f1; {
        qoz_string tn = emit_strip_numeric_underscores(text); qoz_string _qoz_bv_290;
    {
        qoz_Strbuf _qoz_sb_4192_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4192_17); strings_sb_append(&_qoz_sb_4192_17, QOZ_STR_LIT(" && ")); strings_sb_append(&_qoz_sb_4192_17, scrut_tmp); strings_sb_append(&_qoz_sb_4192_17, QOZ_STR_LIT(" == ")); strings_sb_append(&_qoz_sb_4192_17, tn); strings_sb_append(&_qoz_sb_4192_17, QOZ_STR_LIT(") { ")); _qoz_bv_290 = strings_sb_finish(&_qoz_sb_4192_17);
    }
    emit_push(e, _qoz_bv_290); 
    }
    0;  break; } case qoz_Pattern_PatLitBool: { bool b = _qoz_ms_284->payload.PatLitBool.f1; if (b) { qoz_string _qoz_bv_291;
    {
        qoz_Strbuf _qoz_sb_4195_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4195_24); strings_sb_append(&_qoz_sb_4195_24, QOZ_STR_LIT(" && ")); strings_sb_append(&_qoz_sb_4195_24, scrut_tmp); strings_sb_append(&_qoz_sb_4195_24, QOZ_STR_LIT(" == true) { ")); _qoz_bv_291 = strings_sb_finish(&_qoz_sb_4195_24);
    }
    emit_push(e, _qoz_bv_291); }  else { qoz_string _qoz_bv_292;
    {
        qoz_Strbuf _qoz_sb_4196_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4196_24); strings_sb_append(&_qoz_sb_4196_24, QOZ_STR_LIT(" && ")); strings_sb_append(&_qoz_sb_4196_24, scrut_tmp); strings_sb_append(&_qoz_sb_4196_24, QOZ_STR_LIT(" == false) { ")); _qoz_bv_292 = strings_sb_finish(&_qoz_sb_4196_24);
    }
    emit_push(e, _qoz_bv_292); } 0;  break; } case qoz_Pattern_PatLitString: { qoz_string text = _qoz_ms_284->payload.PatLitString.f1; qoz_string _qoz_bv_293;
    {
        qoz_Strbuf _qoz_sb_4199_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4199_17); strings_sb_append(&_qoz_sb_4199_17, QOZ_STR_LIT(" && qoz_string_eq(")); strings_sb_append(&_qoz_sb_4199_17, scrut_tmp); strings_sb_append(&_qoz_sb_4199_17, QOZ_STR_LIT(", QOZ_STR_LIT(")); strings_sb_append(&_qoz_sb_4199_17, text); strings_sb_append(&_qoz_sb_4199_17, QOZ_STR_LIT("))) { ")); _qoz_bv_293 = strings_sb_finish(&_qoz_sb_4199_17);
    }
    emit_push(e, _qoz_bv_293);  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_284->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_284->payload.PatVariant.f2; if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_294;
    {
        qoz_Strbuf _qoz_sb_4204_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4204_21); strings_sb_append(&_qoz_sb_4204_21, QOZ_STR_LIT(" && ")); strings_sb_append(&_qoz_sb_4204_21, scrut_tmp); strings_sb_append(&_qoz_sb_4204_21, QOZ_STR_LIT("->tag == qoz_")); strings_sb_append(&_qoz_sb_4204_21, enum_name); strings_sb_append(&_qoz_sb_4204_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_4204_21, vname); strings_sb_append(&_qoz_sb_4204_21, QOZ_STR_LIT(") { ")); _qoz_bv_294 = strings_sb_finish(&_qoz_sb_4204_21);
    }
    emit_push(e, _qoz_bv_294); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_286 = sp; switch (_qoz_ms_286->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_286->payload.PatBind.f1; {
        qoz_string pc = emit_variant_payload_ctype(e, enum_name, vname, i); qoz_string is = emit_int_to_string(i); qoz_string _qoz_bv_295;
    {
        qoz_Strbuf _qoz_sb_4211_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4211_29); strings_sb_append(&_qoz_sb_4211_29, pc); strings_sb_append(&_qoz_sb_4211_29, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4211_29, bname); strings_sb_append(&_qoz_sb_4211_29, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_4211_29, scrut_tmp); strings_sb_append(&_qoz_sb_4211_29, QOZ_STR_LIT("->payload.")); strings_sb_append(&_qoz_sb_4211_29, vname); strings_sb_append(&_qoz_sb_4211_29, QOZ_STR_LIT(".f")); strings_sb_append(&_qoz_sb_4211_29, is); strings_sb_append(&_qoz_sb_4211_29, QOZ_STR_LIT("; ")); _qoz_bv_295 = strings_sb_finish(&_qoz_sb_4211_29);
    }
    emit_push(e, _qoz_bv_295); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, emit_variant_payload_typeexpr(e, enum_name, vname, i)); 
    }
...
void emit_emit_match_arm_with_kind(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_string res_tmp, qoz_MatchArm arm, bool is_void) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_TypeExpr* body_hint = emit_match_body_hint(e, enum_name, arm.body); qoz_gc_push_root(&body_hint); qoz_Pattern* _qoz_ms_287 = arm.pat; switch (_qoz_ms_287->tag) { case qoz_Pattern_PatWild: { {
    ...
    0;  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_287->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_288 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_288->tag) { case qoz_Option__qoz_string_Some: { {
        qoz_string _qoz_bv_296;
    {
        qoz_Strbuf _qoz_sb_4274_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4274_21); strings_sb_append(&_qoz_sb_4274_21, QOZ_STR_LIT("case qoz_")); strings_sb_append(&_qoz_sb_4274_21, enum_name); strings_sb_append(&_qoz_sb_4274_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_4274_21, name); strings_sb_append(&_qoz_sb_4274_21, QOZ_STR_LIT(": { ")); _qoz_bv_296 = strings_sb_finish(&_qoz_sb_4274_21);
    }
    ...
    0;  break; } case qoz_Option__qoz_string_None: { {
        if (is_void) { emit_push(e, QOZ_STR_LIT("default: { ")); }  else { qoz_string _qoz_bv_297;
    {
        qoz_Strbuf _qoz_sb_4290_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4290_25); strings_sb_append(&_qoz_sb_4290_25, QOZ_STR_LIT("default: { int64_t ")); strings_sb_append(&_qoz_sb_4290_25, name); strings_sb_append(&_qoz_sb_4290_25, QOZ_STR_LIT(" = 0; (void)")); strings_sb_append(&_qoz_sb_4290_25, name); strings_sb_append(&_qoz_sb_4290_25, QOZ_STR_LIT("; ")); _qoz_bv_297 = strings_sb_finish(&_qoz_sb_4290_25);
    }
    emit_push(e, _qoz_bv_297); } if (arm.has_guard) { emit_push(e, QOZ_STR_LIT("if (")); emit_emit_expr(e, arm.guard); emit_push(e, QOZ_STR_LIT(") { ")); emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); emit_push(e, QOZ_STR_LIT("} ")); }  else { emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); } emit_push(e, QOZ_STR_LIT(" break; } ")); 
    }
    0;  break; } } 0;  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_287->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_287->payload.PatVariant.f2; if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_298;
    {
        qoz_Strbuf _qoz_sb_4308_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4308_21); strings_sb_append(&_qoz_sb_4308_21, QOZ_STR_LIT("case qoz_")); strings_sb_append(&_qoz_sb_4308_21, enum_name); strings_sb_append(&_qoz_sb_4308_21, QOZ_STR_LIT("_")); strings_sb_append(&_qoz_sb_4308_21, vname); strings_sb_append(&_qoz_sb_4308_21, QOZ_STR_LIT(": { ")); _qoz_bv_298 = strings_sb_finish(&_qoz_sb_4308_21);
    }
    emit_push(e, _qoz_bv_298); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_289 = sp; switch (_qoz_ms_289->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_289->payload.PatBind.f1; {
        qoz_string pc = emit_variant_payload_ctype(e, enum_name, vname, i); qoz_string is = emit_int_to_string(i); qoz_string _qoz_bv_299;
    {
        qoz_Strbuf _qoz_sb_4315_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4315_29); strings_sb_append(&_qoz_sb_4315_29, pc); strings_sb_append(&_qoz_sb_4315_29, QOZ_STR_LIT(" ")); strings_sb_append(&_qoz_sb_4315_29, bname); strings_sb_append(&_qoz_sb_4315_29, QOZ_STR_LIT(" = ")); strings_sb_append(&_qoz_sb_4315_29, scrut_tmp); strings_sb_append(&_qoz_sb_4315_29, QOZ_STR_LIT("->payload.")); strings_sb_append(&_qoz_sb_4315_29, vname); strings_sb_append(&_qoz_sb_4315_29, QOZ_STR_LIT(".f")); strings_sb_append(&_qoz_sb_4315_29, is); strings_sb_append(&_qoz_sb_4315_29, QOZ_STR_LIT("; ")); _qoz_bv_299 = strings_sb_finish(&_qoz_sb_4315_29);
    }
    emit_push(e, _qoz_bv_299); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, emit_variant_payload_typeexpr(e, enum_name, vname, i)); 
    }
...
qoz_string emit_enum_name_from_type(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string bare_enum) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_290 = te; qoz_string _qoz_mv_290 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_290->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_290->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_290->payload.TENamed.f2; qoz_string _qoz_bv_300;
    {
        if (((args.len) > 0) && ((path.len) >= 1)) { qoz_string last = path.data[(path.len) - 1]; if (qoz_string_eq(last, bare_enum)) { return emit_mangle_inst(e, bare_enum, args);} } _qoz_bv_300 = bare_enum;
    }
    _qoz_mv_290 = (_qoz_bv_300);  break; } default: { _qoz_mv_290 = (bare_enum);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_290;
}
...
qoz_TypeExpr* emit_variant_payload_typeexpr(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, int64_t pos) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string bare = emit_strip_mangled(enum_name); qoz_Span unit_sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_Option__qoz_Decl* _qoz_ms_291 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, bare); qoz_TypeExpr* _qoz_mv_291 = NULL; switch (_qoz_ms_291->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_291 = (qoz_make_TypeExpr_TEUnit(unit_sp));  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_291->payload.Some.f0; qoz_Decl* _qoz_ms_292 = d; qoz_TypeExpr* _qoz_mv_292 = NULL; switch (_qoz_ms_292->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_292->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_292->payload.DEnum.f3; qoz_TypeExpr* _qoz_bv_301;
    {
        qoz_Vec__qoz_TypeExpr inst_args = emit_variant_inst_args(e, enum_name, bare); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_string_eq(v.name, variant)) { if ((pos >= 0) && (pos < (v.pos.len))) { if (((tparams.len) > 0) && ((inst_args.len) == (tparams.len))) { return emit_substitute_type(e, v.pos.data[pos], tparams, inst_args);} return v.pos.data[pos];} } } }_qoz_bv_301 = qoz_make_TypeExpr_TEUnit(unit_sp);
    }
    _qoz_mv_292 = (_qoz_bv_301);  break; } default: { _qoz_mv_292 = (qoz_make_TypeExpr_TEUnit(unit_sp));  break; } } _qoz_mv_291 = (_qoz_mv_292);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_291;
}

qoz_string emit_variant_payload_ctype(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, int64_t pos) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string bare = emit_strip_mangled(enum_name); qoz_Option__qoz_Decl* _qoz_ms_293 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, bare); qoz_string _qoz_mv_293 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_293->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_293 = (QOZ_STR_LIT("int64_t"));  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_293->payload.Some.f0; qoz_Decl* _qoz_ms_294 = d; qoz_string _qoz_mv_294 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_294->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_294->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_294->payload.DEnum.f3; qoz_string _qoz_bv_302;
    {
        qoz_Vec__qoz_TypeExpr inst_args = emit_variant_inst_args(e, enum_name, bare); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_string_eq(v.name, variant)) { if ((pos >= 0) && (pos < (v.pos.len))) { qoz_TypeExpr* subst = ((((tparams.len) > 0) && ((inst_args.len) == (tparams.len))) ? emit_substitute_type(e, v.pos.data[pos], tparams, inst_args) : v.pos.data[pos]); qoz_gc_push_root(&subst); return emit_c_type_for(e, subst);} } } }_qoz_bv_302 = QOZ_STR_LIT("int64_t");
    }
    _qoz_mv_294 = (_qoz_bv_302);  break; } default: { _qoz_mv_294 = (QOZ_STR_LIT("int64_t"));  break; } } _qoz_mv_293 = (_qoz_mv_294);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_293;
}
...
void emit_emit_arm_body_with_hint(qoz_Emitter* e, qoz_string res_tmp, qoz_Expr* body, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&body);
    qoz_gc_push_root(&hint);
    qoz_Expr* _qoz_ms_295 = body; switch (_qoz_ms_295->tag) { case qoz_Expr_EReturn: { qoz_Expr* v = _qoz_ms_295->payload.EReturn.f1; if (emit_is_nil_expr(v)) { emit_push(e, QOZ_STR_LIT("return; ")); }  else { emit_push(e, QOZ_STR_LIT("return ")); emit_emit_value_with_hint(e, v, e->current_ret_te); emit_push(e, QOZ_STR_LIT("; ")); } 0;  break; } default: { {
...
void emit_emit_main(qoz_Emitter* e, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&ret);
    qoz_gc_push_root(&body);
    qoz_MainRetKind* kind = emit_main_return_kind(ret); qoz_gc_push_root(&kind); emit_push(e, QOZ_STR_LIT("int main(int argc, char **argv) {\n    qoz_set_argv(argc, argv);\n    int qoz_stack_anchor;\n    qoz_init(&qoz_stack_anchor);\n    ")); qoz_Expr* _qoz_ms_296 = body; switch (_qoz_ms_296->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_296->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_296->payload.EBlock.f2; {
...
qoz_MainRetKind* emit_main_return_kind(qoz_TypeExpr* ret) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ret);
    qoz_TypeExpr* _qoz_ms_297 = ret; qoz_MainRetKind* _qoz_mv_297 = NULL; switch (_qoz_ms_297->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_297 = (qoz_make_MainRetKind_MainRetUnit());  break; } case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_297->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_297->payload.TENamed.f1; qoz_MainRetKind* _qoz_bv_303;
    {
        if ((path.len) != 1) { qoz_string _qoz_bv_304;
    {
        qoz_Strbuf _qoz_sb_4558_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4558_25); strings_sb_append(&_qoz_sb_4558_25, sp.file); strings_sb_append(&_qoz_sb_4558_25, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_4558_25, sp.line); strings_sb_append(&_qoz_sb_4558_25, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_4558_25, sp.col); strings_sb_append(&_qoz_sb_4558_25, QOZ_STR_LIT(": main return type must be a primitive integer or unit")); _qoz_bv_304 = strings_sb_finish(&_qoz_sb_4558_25);
    }
    fmt_println(_qoz_bv_304); return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));} qoz_string n = path.data[0]; if (qoz_string_eq(n, QOZ_STR_LIT("i8"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int8_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("i16"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int16_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("i32"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int32_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("i64"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u8"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint8_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u16"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint16_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u32"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint32_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u64"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint64_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("unit"))) { return qoz_make_MainRetKind_MainRetUnit();} if (qoz_string_eq(n, QOZ_STR_LIT("void"))) { return qoz_make_MainRetKind_MainRetUnit();} qoz_string _qoz_bv_305;
    {
        qoz_Strbuf _qoz_sb_4572_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); strings_sb_init(&_qoz_sb_4572_21); strings_sb_append(&_qoz_sb_4572_21, sp.file); strings_sb_append(&_qoz_sb_4572_21, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_4572_21, sp.line); strings_sb_append(&_qoz_sb_4572_21, QOZ_STR_LIT(":")); strings_sb_append_i64(&_qoz_sb_4572_21, sp.col); strings_sb_append(&_qoz_sb_4572_21, QOZ_STR_LIT(": main may return only integer types or unit, got `")); strings_sb_append(&_qoz_sb_4572_21, n); strings_sb_append(&_qoz_sb_4572_21, QOZ_STR_LIT("`")); _qoz_bv_305 = strings_sb_finish(&_qoz_sb_4572_21);
    }
    fmt_println(_qoz_bv_305); _qoz_bv_303 = qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));
    }
    _qoz_mv_297 = (_qoz_bv_303);  break; } default: { qoz_MainRetKind* _qoz_bv_306;
    {
        fmt_println(QOZ_STR_LIT("main return type must be a primitive integer or unit")); _qoz_bv_306 = qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));
    }
    _qoz_mv_297 = (_qoz_bv_306);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_297;
}
...
void emit_emit_main_tail(qoz_Emitter* e, qoz_MainRetKind* kind, qoz_Expr* tail) {
    ...
    qoz_gc_push_root(&tail);
    qoz_MainRetKind* _qoz_ms_298 = kind; switch (_qoz_ms_298->tag) { case qoz_MainRetKind_MainRetUnit: { {
        qoz_Expr* _qoz_ms_299 = tail; bool _qoz_mv_299 = false; switch (_qoz_ms_299->tag) { case qoz_Expr_EIf: { qoz_Expr* f = _qoz_ms_299->payload.EIf.f3; _qoz_mv_299 = (emit_is_nil_expr(f) || emit_is_unit_typeexpr(emit_infer_value_te(e, tail)));  break; } default: { _qoz_mv_299 = (false);  break; } } bool is_unit_if = _qoz_mv_299; qoz_Expr* _qoz_ms_300 = tail; switch (_qoz_ms_300->tag) { case qoz_Expr_EFor: { {
    ...
    0;  break; } case qoz_MainRetKind_MainRetInt: { qoz_string ctype = _qoz_ms_298->payload.MainRetInt.f0; {
...
bool ty_ty_eq(qoz_Ty* a, qoz_Ty* b) {
    ...
    qoz_gc_push_root(&a);
    qoz_gc_push_root(&b);
    qoz_Ty* _qoz_ms_301 = a; bool _qoz_mv_301 = false; switch (_qoz_ms_301->tag) { case qoz_Ty_TyInt: { qoz_IntInfo ai = _qoz_ms_301->payload.TyInt.f0; qoz_Ty* _qoz_ms_302 = b; bool _qoz_mv_302 = false; switch (_qoz_ms_302->tag) { case qoz_Ty_TyInt: { qoz_IntInfo bi = _qoz_ms_302->payload.TyInt.f0; _qoz_mv_302 = (((ai.width == bi.width) && (ai.is_signed == bi.is_signed)) && (ai.untyped == bi.untyped));  break; } default: { _qoz_mv_302 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_302);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo af = _qoz_ms_301->payload.TyFloat.f0; qoz_Ty* _qoz_ms_303 = b; bool _qoz_mv_303 = false; switch (_qoz_ms_303->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo bf = _qoz_ms_303->payload.TyFloat.f0; _qoz_mv_303 = ((af.width == bf.width) && (af.untyped == bf.untyped));  break; } default: { _qoz_mv_303 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_303);  break; } case qoz_Ty_TyBool: { qoz_Ty* _qoz_ms_304 = b; bool _qoz_mv_304 = false; switch (_qoz_ms_304->tag) { case qoz_Ty_TyBool: { _qoz_mv_304 = (true);  break; } default: { _qoz_mv_304 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_304);  break; } case qoz_Ty_TyChar: { qoz_Ty* _qoz_ms_305 = b; bool _qoz_mv_305 = false; switch (_qoz_ms_305->tag) { case qoz_Ty_TyChar: { _qoz_mv_305 = (true);  break; } default: { _qoz_mv_305 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_305);  break; } case qoz_Ty_TyString: { qoz_Ty* _qoz_ms_306 = b; bool _qoz_mv_306 = false; switch (_qoz_ms_306->tag) { case qoz_Ty_TyString: { _qoz_mv_306 = (true);  break; } default: { _qoz_mv_306 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_306);  break; } case qoz_Ty_TyCstring: { qoz_Ty* _qoz_ms_307 = b; bool _qoz_mv_307 = false; switch (_qoz_ms_307->tag) { case qoz_Ty_TyCstring: { _qoz_mv_307 = (true);  break; } default: { _qoz_mv_307 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_307);  break; } case qoz_Ty_TyUnit: { qoz_Ty* _qoz_ms_308 = b; bool _qoz_mv_308 = false; switch (_qoz_ms_308->tag) { case qoz_Ty_TyUnit: { _qoz_mv_308 = (true);  break; } default: { _qoz_mv_308 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_308);  break; } case qoz_Ty_TyNil: { qoz_Ty* _qoz_ms_309 = b; bool _qoz_mv_309 = false; switch (_qoz_ms_309->tag) { case qoz_Ty_TyNil: { _qoz_mv_309 = (true);  break; } default: { _qoz_mv_309 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_309);  break; } case qoz_Ty_TyError: { qoz_Ty* _qoz_ms_310 = b; bool _qoz_mv_310 = false; switch (_qoz_ms_310->tag) { case qoz_Ty_TyError: { _qoz_mv_310 = (true);  break; } default: { _qoz_mv_310 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_310);  break; } case qoz_Ty_TyPtr: { qoz_Ty* ai = _qoz_ms_301->payload.TyPtr.f0; qoz_Ty* _qoz_ms_311 = b; bool _qoz_mv_311 = false; switch (_qoz_ms_311->tag) { case qoz_Ty_TyPtr: { qoz_Ty* bi = _qoz_ms_311->payload.TyPtr.f0; _qoz_mv_311 = (ty_ty_eq(ai, bi));  break; } default: { _qoz_mv_311 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_311);  break; } case qoz_Ty_TyAdt: { qoz_string an = _qoz_ms_301->payload.TyAdt.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_301->payload.TyAdt.f1; qoz_Ty* _qoz_ms_312 = b; bool _qoz_mv_312 = false; switch (_qoz_ms_312->tag) { case qoz_Ty_TyAdt: { qoz_string bn = _qoz_ms_312->payload.TyAdt.f0; qoz_Vec__qoz_Ty ba = _qoz_ms_312->payload.TyAdt.f1; _qoz_mv_312 = (qoz_string_eq(an, bn) && ty_ty_args_eq(aa, ba));  break; } default: { _qoz_mv_312 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_312);  break; } case qoz_Ty_TyRecord: { qoz_string an = _qoz_ms_301->payload.TyRecord.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_301->payload.TyRecord.f1; qoz_Ty* _qoz_ms_313 = b; bool _qoz_mv_313 = false; switch (_qoz_ms_313->tag) { case qoz_Ty_TyRecord: { qoz_string bn = _qoz_ms_313->payload.TyRecord.f0; qoz_Vec__qoz_Ty ba = _qoz_ms_313->payload.TyRecord.f1; _qoz_mv_313 = (qoz_string_eq(an, bn) && ty_ty_args_eq(aa, ba));  break; } default: { _qoz_mv_313 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_313);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty ap = _qoz_ms_301->payload.TyFn.f0; qoz_Ty* ar = _qoz_ms_301->payload.TyFn.f1; qoz_Ty* _qoz_ms_314 = b; bool _qoz_mv_314 = false; switch (_qoz_ms_314->tag) { case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty bp = _qoz_ms_314->payload.TyFn.f0; qoz_Ty* br = _qoz_ms_314->payload.TyFn.f1; _qoz_mv_314 = (ty_ty_args_eq(ap, bp) && ty_ty_eq(ar, br));  break; } default: { _qoz_mv_314 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_314);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty ae = _qoz_ms_301->payload.TyTuple.f0; qoz_Ty* _qoz_ms_315 = b; bool _qoz_mv_315 = false; switch (_qoz_ms_315->tag) { case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty be = _qoz_ms_315->payload.TyTuple.f0; _qoz_mv_315 = (ty_ty_args_eq(ae, be));  break; } default: { _qoz_mv_315 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_315);  break; } case qoz_Ty_TyVar: { qoz_string an = _qoz_ms_301->payload.TyVar.f1; qoz_Ty* _qoz_ms_316 = b; bool _qoz_mv_316 = false; switch (_qoz_ms_316->tag) { case qoz_Ty_TyVar: { qoz_string bn = _qoz_ms_316->payload.TyVar.f1; _qoz_mv_316 = (qoz_string_eq(an, bn));  break; } default: { _qoz_mv_316 = (false);  break; } } _qoz_mv_301 = (_qoz_mv_316);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_301;
}

qoz_TypeExpr* ty_ty_to_type_expr_at(qoz_Ty* t, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_317 = t; qoz_TypeExpr* _qoz_mv_317 = NULL; switch (_qoz_ms_317->tag) { case qoz_Ty_TyInt: { qoz_IntInfo info = _qoz_ms_317->payload.TyInt.f0; _qoz_mv_317 = (qoz_make_TypeExpr_TENamed(sp, ty_ints_to_path(info.width, info.is_signed), qoz_vec_make__qoz_TypeExpr()));  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo info = _qoz_ms_317->payload.TyFloat.f0; qoz_TypeExpr* _qoz_bv_307;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); if (info.width == 32) { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f32")); }  else { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f64")); } _qoz_bv_307 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_317 = (_qoz_bv_307);  break; } case qoz_Ty_TyBool: { _qoz_mv_317 = (ty_single_path_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Ty_TyChar: { _qoz_mv_317 = (ty_single_path_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Ty_TyString: { _qoz_mv_317 = (ty_single_path_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Ty_TyCstring: { _qoz_mv_317 = (ty_single_path_te(sp, QOZ_STR_LIT("cstring")));  break; } case qoz_Ty_TyUnit: { _qoz_mv_317 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Ty_TyNil: { _qoz_mv_317 = (ty_single_path_te(sp, QOZ_STR_LIT("nil")));  break; } case qoz_Ty_TyError: { _qoz_mv_317 = (ty_single_path_te(sp, QOZ_STR_LIT("?")));  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_317->payload.TyPtr.f0; _qoz_mv_317 = (qoz_make_TypeExpr_TEPtr(sp, ty_ty_to_type_expr_at(inner, sp)));  break; } case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_317->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_317->payload.TyAdt.f1; _qoz_mv_317 = (ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_317->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_317->payload.TyRecord.f1; _qoz_mv_317 = (ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty fparams = _qoz_ms_317->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_317->payload.TyFn.f1; qoz_TypeExpr* _qoz_bv_308;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; qoz_vec_push__qoz_TypeExpr(&pte, ty_ty_to_type_expr_at(p, sp)); } }_qoz_bv_308 = qoz_make_TypeExpr_TEFn(sp, pte, ty_ty_to_type_expr_at(ret, sp));
    }
    _qoz_mv_317 = (_qoz_bv_308);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_317->payload.TyTuple.f0; qoz_TypeExpr* _qoz_bv_309;
    {
        qoz_Vec__qoz_TypeExpr ete = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ete, ty_ty_to_type_expr_at(el, sp)); } }_qoz_bv_309 = qoz_make_TypeExpr_TETuple(sp, ete);
    }
    _qoz_mv_317 = (_qoz_bv_309);  break; } case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_317->payload.TyVar.f1; _qoz_mv_317 = (ty_single_path_te(sp, name));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_317;
}
