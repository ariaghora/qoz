...
qoz_Ty* qoz_check_synth_unary(qoz_TyContext* tc, qoz_Env* env, qoz_UnaryOp* op, qoz_Expr* rhs);
...
qoz_Ty* qoz_check_synth_index(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* base, qoz_Expr* idx);
...
qoz_Ty* qoz_check_synth_record(qoz_TyContext* tc, qoz_Env* env, qoz_TypeExpr* te, qoz_Vec__qoz_RecordFieldLit fields);
...
qoz_Ty* qoz_check_synth_binary(qoz_TyContext* tc, qoz_Env* env, qoz_BinaryOp* op, qoz_Expr* l, qoz_Expr* r);
qoz_Ty* qoz_check_synth_block(qoz_TyContext* tc, qoz_Env* env, qoz_Vec__qoz_Stmt stmts, qoz_Expr* tail);
qoz_Ty* qoz_check_synth_if(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* c, qoz_Expr* t, qoz_Expr* f);
qoz_Ty* qoz_check_synth_match(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms);
...
void qoz_check_bind_variant_pattern(qoz_TyContext* tc, qoz_Env* env, qoz_Vec__qoz_string path, qoz_Vec__qoz_Pattern sub_pats, qoz_Ty* scrut);
...
qoz_Decl* qoz_rename_with_pkg(qoz_Decl* d, qoz_string pkg, qoz_Map__qoz_string__bool local_fns) {
    ...
    {
        qoz_Expr* new_body = qoz_rewrite_ident_refs(body, pkg, local_fns); qoz_gc_push_root(&new_body); _qoz_bv_1 = qoz_make_Decl_DFn(sp, qoz_string_cat(qoz_string_cat(pkg, QOZ_STR_LIT("_")), n), tp, fp, rt, new_body, attr);
    }
...
qoz_Expr* qoz_rewrite_ident_refs(qoz_Expr* e, qoz_string pkg, qoz_Map__qoz_string__bool local_fns) {
    ...
    _qoz_mv_4 = (_qoz_bv_7);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_4->payload.EWhile.f0; qoz_Expr* c = _qoz_ms_4->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_4->payload.EWhile.f2; _qoz_mv_4 = (qoz_make_Expr_EWhile(sp, qoz_rewrite_ident_refs(c, pkg, local_fns), qoz_rewrite_ident_refs(b, pkg, local_fns)));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_4->payload.EFor.f0; qoz_string b1 = _qoz_ms_4->payload.EFor.f1; qoz_string b2 = _qoz_ms_4->payload.EFor.f2; qoz_Expr* it = _qoz_ms_4->payload.EFor.f3; qoz_Expr* body = _qoz_ms_4->payload.EFor.f4; _qoz_mv_4 = (qoz_make_Expr_EFor(sp, b1, b2, qoz_rewrite_ident_refs(it, pkg, local_fns), qoz_rewrite_ident_refs(body, pkg, local_fns)));  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_4->payload.EReturn.f0; qoz_Expr* v = _qoz_ms_4->payload.EReturn.f1; _qoz_mv_4 = (qoz_make_Expr_EReturn(sp, qoz_rewrite_ident_refs(v, pkg, local_fns)));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_4->payload.EDefer.f0; qoz_Expr* v = _qoz_ms_4->payload.EDefer.f1; _qoz_mv_4 = (qoz_make_Expr_EDefer(sp, qoz_rewrite_ident_refs(v, pkg, local_fns)));  break; } case qoz_Expr_ESizeOf: { _qoz_mv_4 = (e);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_4->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_4->payload.EArrayLit.f1; qoz_Expr* _qoz_bv_8;
    {
...
qoz_string qoz_cmd_build(qoz_string path, qoz_string qoz_root) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_Loaded loaded = qoz_load_all(path, qoz_root); qoz_File file = loaded.file; qoz_TyContext tc = qoz_check_make_ctx(); qoz_check_register_file(&tc, file); qoz_check_validate_signatures(&tc, file); qoz_File inferred = qoz_check_infer_calls(&tc, file); qoz_check_check_fn_bodies(&tc, inferred); qoz_check_report(&tc); if ((tc.errors.len) > 0) { qoz_os_exit(1); } qoz_string c_source = qoz_emit_emit_program(inferred, tc.expr_types); qoz_Vec__qoz_string _keep_alive = loaded.sources; qoz_string out_path = qoz_string_cat(path, QOZ_STR_LIT(".c")); bool ok = qoz_fs_write_file(out_path, c_source); if (!ok) { qoz_string _qoz_bv_11;
    {
        qoz_Strbuf _qoz_sb_307_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_307_21); qoz_strings_sb_append(&_qoz_sb_307_21, QOZ_STR_LIT("could not write ")); qoz_strings_sb_append(&_qoz_sb_307_21, out_path); _qoz_bv_11 = qoz_strings_sb_finish(&_qoz_sb_307_21);
    }
...
void qoz_cmd_run(qoz_string path, qoz_string qoz_root) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_string c_path = qoz_cmd_build(path, qoz_root); qoz_string bin_path = qoz_string_cat(path, QOZ_STR_LIT(".bin")); qoz_Vec__qoz_string cargv = qoz_clang_argv(c_path, bin_path); qoz_ProcessResult clang_result = qoz_os_process_exec(cargv); if (clang_result.exit_code != 0) { qoz_fmt_print(clang_result.stdout); qoz_fmt_print(clang_result.stderr); qoz_os_exit(1); } qoz_Vec__qoz_string run_argv = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&run_argv, bin_path); qoz_ProcessResult result = qoz_os_process_exec(run_argv); qoz_fmt_print(result.stdout); qoz_fmt_print(result.stderr); qoz_os_exit(result.exit_code); 
    return;
}
...
int main(int argc, char **argv) {
    ...
    qoz_Vec__qoz_string args = qoz_os_args(); if ((args.len) < 2) { qoz_fmt_println(QOZ_STR_LIT("usage: qoz <subcommand> <path>")); qoz_fmt_println(QOZ_STR_LIT("       qoz build <path>   compile to <path>.c and clang to <path>.bin")); qoz_fmt_println(QOZ_STR_LIT("       qoz run   <path>   build, then execute and propagate exit code")); qoz_fmt_println(QOZ_STR_LIT("       qoz emit  <path>   write <path>.c only (no clang)")); qoz_os_exit(1); } qoz_string qoz_root = qoz_os_getenv(QOZ_STR_LIT("QOZ_ROOT")); qoz_string first = args.data[1]; if (qoz_string_eq(first, QOZ_STR_LIT("emit"))) { if ((args.len) < 3) { qoz_fmt_println(QOZ_STR_LIT("usage: qoz emit <path>")); qoz_os_exit(1); } qoz_string out = qoz_cmd_build(args.data[2], qoz_root); qoz_string _qoz_bv_12;
    {
        qoz_Strbuf _qoz_sb_380_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_380_21); qoz_strings_sb_append(&_qoz_sb_380_21, QOZ_STR_LIT("wrote ")); qoz_strings_sb_append(&_qoz_sb_380_21, out); _qoz_bv_12 = qoz_strings_sb_finish(&_qoz_sb_380_21);
    }
    qoz_fmt_println(_qoz_bv_12); qoz_os_exit(0); }  else { if (qoz_string_eq(first, QOZ_STR_LIT("build"))) { if ((args.len) < 3) { qoz_fmt_println(QOZ_STR_LIT("usage: qoz build <path>")); qoz_os_exit(1); } qoz_string path = args.data[2]; qoz_string c_path = qoz_cmd_build(path, qoz_root); qoz_string bin_path = qoz_string_cat(path, QOZ_STR_LIT(".bin")); qoz_Vec__qoz_string cargv = qoz_clang_argv(c_path, bin_path); qoz_ProcessResult r = qoz_os_process_exec(cargv); if (r.exit_code != 0) { qoz_fmt_print(r.stdout); qoz_fmt_print(r.stderr); qoz_os_exit(1); } qoz_os_exit(0); }  else { if (qoz_string_eq(first, QOZ_STR_LIT("run"))) { if ((args.len) < 3) { qoz_fmt_println(QOZ_STR_LIT("usage: qoz run <path>")); qoz_os_exit(1); } qoz_cmd_run(args.data[2], qoz_root); }  else { qoz_string out = qoz_cmd_build(first, qoz_root); qoz_string _qoz_bv_13;
    {
        qoz_Strbuf _qoz_sb_410_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_410_21); qoz_strings_sb_append(&_qoz_sb_410_21, QOZ_STR_LIT("wrote ")); qoz_strings_sb_append(&_qoz_sb_410_21, out); _qoz_bv_13 = qoz_strings_sb_finish(&_qoz_sb_410_21);
    }
...
void qoz_tokenize_skip_whitespace_and_comments(qoz_Lexer* l) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&l);
    bool changed = true; while (changed) { changed = false; while ((l->pos < (l->src).len) && qoz_tokenize_is_space(qoz_tokenize_lex_at(l))) { qoz_tokenize_lex_advance(l); changed = true; } if (((l->pos + 1 < (l->src).len) && (qoz_tokenize_lex_at(l) == 47)) && (qoz_string_byte_at(l->src, l->pos + 1) == 47)) { while ((l->pos < (l->src).len) && (qoz_tokenize_lex_at(l) != 10)) { qoz_tokenize_lex_advance(l); } changed = true; } if (((l->pos + 1 < (l->src).len) && (qoz_tokenize_lex_at(l) == 47)) && (qoz_string_byte_at(l->src, l->pos + 1) == 42)) { qoz_tokenize_lex_advance(l); qoz_tokenize_lex_advance(l); int64_t depth = 1; while ((depth > 0) && (l->pos < (l->src).len)) { if (((l->pos + 1 < (l->src).len) && (qoz_tokenize_lex_at(l) == 47)) && (qoz_string_byte_at(l->src, l->pos + 1) == 42)) { qoz_tokenize_lex_advance(l); qoz_tokenize_lex_advance(l); depth = depth + 1; }  else if (((l->pos + 1 < (l->src).len) && (qoz_tokenize_lex_at(l) == 42)) && (qoz_string_byte_at(l->src, l->pos + 1) == 47)) { qoz_tokenize_lex_advance(l); qoz_tokenize_lex_advance(l); depth = depth - 1; }  else { qoz_tokenize_lex_advance(l); } } changed = true; } } 
    return;
}
...
qoz_Token qoz_tokenize_lex_one(qoz_Lexer* l, qoz_Map__qoz_string__bool* kw) {
    ...
    qoz_gc_push_root(&l);
    qoz_gc_push_root(&kw);
    qoz_tokenize_skip_whitespace_and_comments(l); if (l->pos >= (l->src).len) { return ((qoz_Token){ .kind = qoz_make_TokenKind_TokEOF(), .text = QOZ_STR_LIT(""), .line = l->line, .col = l->col });} int64_t start_pos = l->pos; int64_t start_line = l->line; int64_t start_col = l->col; int64_t c = qoz_tokenize_lex_at(l); if (qoz_tokenize_is_digit(c)) { if ((c == 48) && (l->pos + 1 < (l->src).len)) { int64_t n = qoz_string_byte_at(l->src, l->pos + 1); if ((n == 120) || (n == 88)) { qoz_tokenize_lex_advance(l); qoz_tokenize_lex_advance(l); while ((l->pos < (l->src).len) && (qoz_tokenize_is_hex_digit(qoz_tokenize_lex_at(l)) || (qoz_tokenize_lex_at(l) == 95))) { qoz_tokenize_lex_advance(l); } return ((qoz_Token){ .kind = qoz_make_TokenKind_TokInt(), .text = qoz_string_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} if ((n == 98) || (n == 66)) { qoz_tokenize_lex_advance(l); qoz_tokenize_lex_advance(l); while ((l->pos < (l->src).len) && (qoz_tokenize_is_bin_digit(qoz_tokenize_lex_at(l)) || (qoz_tokenize_lex_at(l) == 95))) { qoz_tokenize_lex_advance(l); } return ((qoz_Token){ .kind = qoz_make_TokenKind_TokInt(), .text = qoz_string_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} if ((n == 111) || (n == 79)) { qoz_tokenize_lex_advance(l); qoz_tokenize_lex_advance(l); while ((l->pos < (l->src).len) && (qoz_tokenize_is_oct_digit(qoz_tokenize_lex_at(l)) || (qoz_tokenize_lex_at(l) == 95))) { qoz_tokenize_lex_advance(l); } return ((qoz_Token){ .kind = qoz_make_TokenKind_TokInt(), .text = qoz_string_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} } bool is_float = false; while ((l->pos < (l->src).len) && (qoz_tokenize_is_digit(qoz_tokenize_lex_at(l)) || (qoz_tokenize_lex_at(l) == 95))) { qoz_tokenize_lex_advance(l); } if (((l->pos + 1 < (l->src).len) && (qoz_tokenize_lex_at(l) == 46)) && qoz_tokenize_is_digit(qoz_string_byte_at(l->src, l->pos + 1))) { is_float = true; qoz_tokenize_lex_advance(l); while ((l->pos < (l->src).len) && (qoz_tokenize_is_digit(qoz_tokenize_lex_at(l)) || (qoz_tokenize_lex_at(l) == 95))) { qoz_tokenize_lex_advance(l); } } if ((l->pos < (l->src).len) && ((qoz_tokenize_lex_at(l) == 101) || (qoz_tokenize_lex_at(l) == 69))) { is_float = true; qoz_tokenize_lex_advance(l); if ((l->pos < (l->src).len) && ((qoz_tokenize_lex_at(l) == 43) || (qoz_tokenize_lex_at(l) == 45))) { qoz_tokenize_lex_advance(l); } while ((l->pos < (l->src).len) && qoz_tokenize_is_digit(qoz_tokenize_lex_at(l))) { qoz_tokenize_lex_advance(l); } } qoz_TokenKind* kind = ((is_float) ? qoz_make_TokenKind_TokFloat() : qoz_make_TokenKind_TokInt()); qoz_gc_push_root(&kind); return ((qoz_Token){ .kind = kind, .text = qoz_string_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} if (c == 39) { qoz_tokenize_lex_advance(l); if ((l->pos < (l->src).len) && (qoz_tokenize_lex_at(l) == 92)) { qoz_tokenize_lex_advance(l); } if (l->pos < (l->src).len) { qoz_tokenize_lex_advance(l); } if ((l->pos < (l->src).len) && (qoz_tokenize_lex_at(l) == 39)) { qoz_tokenize_lex_advance(l); } return ((qoz_Token){ .kind = qoz_make_TokenKind_TokChar(), .text = qoz_string_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} if (qoz_tokenize_is_alpha(c)) { while ((l->pos < (l->src).len) && qoz_tokenize_is_alnum(qoz_tokenize_lex_at(l))) { qoz_tokenize_lex_advance(l); } qoz_string word = qoz_string_slice(l->src, start_pos, l->pos); qoz_TokenKind* k = qoz_make_TokenKind_TokIdent(); qoz_gc_push_root(&k); if (qoz_tokenize_is_keyword(kw, word)) { k = qoz_make_TokenKind_TokKeyword(); } return ((qoz_Token){ .kind = k, .text = word, .line = start_line, .col = start_col });} if (c == 34) { qoz_tokenize_lex_advance(l); while ((l->pos < (l->src).len) && (qoz_tokenize_lex_at(l) != 34)) { if ((qoz_tokenize_lex_at(l) == 92) && (l->pos + 1 < (l->src).len)) { qoz_tokenize_lex_advance(l); } qoz_tokenize_lex_advance(l); } if (l->pos < (l->src).len) { qoz_tokenize_lex_advance(l); } return ((qoz_Token){ .kind = qoz_make_TokenKind_TokString(), .text = qoz_string_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} if (qoz_tokenize_is_punct(c)) { qoz_tokenize_lex_advance(l); if (l->pos < (l->src).len) { int64_t n = qoz_tokenize_lex_at(l); bool two_char = ((((((((((c == 61) && (n == 61)) || ((c == 33) && (n == 61))) || ((c == 60) && (n == 61))) || ((c == 62) && (n == 61))) || ((c == 60) && (n == 60))) || ((c == 45) && (n == 62))) || ((c == 38) && (n == 38))) || ((c == 124) && (n == 124))) || ((c == 46) && (n == 46))) || ((c == 58) && (n == 58)); if (two_char) { qoz_tokenize_lex_advance(l); int64_t m = qoz_tokenize_lex_at(l); if (((c == 46) && (n == 46)) && ((m == 60) || (m == 61))) { qoz_tokenize_lex_advance(l); } } } return ((qoz_Token){ .kind = qoz_make_TokenKind_TokPunct(), .text = qoz_string_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });} qoz_tokenize_lex_advance(l); return ((qoz_Token){ .kind = qoz_make_TokenKind_TokPunct(), .text = qoz_string_slice(l->src, start_pos, l->pos), .line = start_line, .col = start_col });
}
...
qoz_Vec__qoz_Token qoz_tokenize_run(qoz_string src) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_Vec__qoz_Token raw = qoz_vec_make__qoz_Token(); qoz_Lexer l = qoz_tokenize_make_lexer(src); qoz_Map__qoz_string__bool kw = qoz_tokenize_build_keywords(); bool running = true; while (running) { qoz_Token t = qoz_tokenize_lex_one(&l, &kw); qoz_TokenKind* _qoz_ms_11 = t.kind; switch (_qoz_ms_11->tag) { case qoz_TokenKind_TokEOF: { running = false;  break; } default: { qoz_vec_push__qoz_Token(&raw, t);  break; } } 0; } qoz_Vec__qoz_Token out = qoz_vec_make__qoz_Token(); int64_t paren_depth = 0; int64_t i = 0; while (i < (raw.len)) { qoz_Token cur = raw.data[i]; if ((i > 0) && (paren_depth == 0)) { qoz_Token prev = raw.data[i - 1]; if (((cur.line > prev.line) && qoz_tokenize_is_stmt_ender(prev)) && !qoz_tokenize_is_line_continuation(cur)) { qoz_vec_push__qoz_Token(&out, ((qoz_Token){ .kind = qoz_make_TokenKind_TokPunct(), .text = QOZ_STR_LIT(";"), .line = prev.line, .col = prev.col })); } } qoz_vec_push__qoz_Token(&out, cur); qoz_TokenKind* _qoz_ms_12 = cur.kind; switch (_qoz_ms_12->tag) { case qoz_TokenKind_TokPunct: { if (qoz_string_eq(cur.text, QOZ_STR_LIT("("))) { paren_depth = paren_depth + 1; }  else if (qoz_string_eq(cur.text, QOZ_STR_LIT("["))) { paren_depth = paren_depth + 1; }  else if (qoz_string_eq(cur.text, QOZ_STR_LIT(")"))) { paren_depth = paren_depth - 1; }  else if (qoz_string_eq(cur.text, QOZ_STR_LIT("]"))) { paren_depth = paren_depth - 1; } 0;  break; } default: { NULL;  break; } } 0; i = i + 1; } qoz_gc_shadow_set_top(_qoz_shadow_guard); return out;
}
...
qoz_string qoz_parse_c_escape_bytes(qoz_string src) {
    ...
    {
        qoz_Strbuf _qoz_sb_645_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_645_36); qoz_strings_sb_append(&_qoz_sb_645_36, QOZ_STR_LIT("\\x")); qoz_strings_sb_append(&_qoz_sb_645_36, qoz_parse_hex2(b)); _qoz_bv_20 = qoz_strings_sb_finish(&_qoz_sb_645_36);
    }
...
qoz_string qoz_parse_hex_digit(int64_t n) {
    ...
    {
        qoz_Strbuf _qoz_sb_656_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_656_24); qoz_strings_sb_append_i64(&_qoz_sb_656_24, n); _qoz_bv_21 = qoz_strings_sb_finish(&_qoz_sb_656_24);
    }
...
qoz_string qoz_parse_hex2(int64_t b) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    int64_t hi = b / 16 % 16; int64_t lo = b % 16; qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_string_cat(qoz_parse_hex_digit(hi), qoz_parse_hex_digit(lo));
}
...
int64_t qoz_parse_scan_interp_end(qoz_string body, int64_t start) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    int64_t n = (body).len; if (start >= n) { return -1;} if (!qoz_parse_is_interp_start_byte(qoz_string_byte_at(body, start))) { return -1;} int64_t depth = 1; int64_t i = start; bool in_str = false; while (i < n) { int64_t c = qoz_string_byte_at(body, i); if (in_str) { if ((c == 92) && (i + 1 < n)) { i = i + 2; }  else { if (c == 34) { in_str = false; } i = i + 1; } }  else { if (c == 34) { in_str = true; }  else if (c == 123) { depth = depth + 1; }  else if (c == 125) { depth = depth - 1; if (depth == 0) { return i;} } i = i + 1; } } return -1;
}
...
qoz_string qoz_parse_interp_var_name(qoz_Span span) {
    ...
    {
        qoz_Strbuf _qoz_sb_811_41 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_811_41); qoz_strings_sb_append_i64(&_qoz_sb_811_41, span.line); _qoz_bv_22 = qoz_strings_sb_finish(&_qoz_sb_811_41);
    }
    qoz_string _qoz_bv_23;
    {
        qoz_Strbuf _qoz_sb_811_73 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_811_73); qoz_strings_sb_append_i64(&_qoz_sb_811_73, span.col); _qoz_bv_23 = qoz_strings_sb_finish(&_qoz_sb_811_73);
    }
...
qoz_Expr* qoz_parse_parse_atom(qoz_Parser* p) {
    ...
    {
        qoz_Strbuf _qoz_sb_916_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_916_29); qoz_strings_sb_append(&_qoz_sb_916_29, QOZ_STR_LIT("expected directive name after `#`, got `")); qoz_strings_sb_append(&_qoz_sb_916_29, name_tok.text); qoz_strings_sb_append(&_qoz_sb_916_29, QOZ_STR_LIT("`")); _qoz_bv_24 = qoz_strings_sb_finish(&_qoz_sb_916_29);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_923_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_923_29); qoz_strings_sb_append(&_qoz_sb_923_29, QOZ_STR_LIT("#")); qoz_strings_sb_append(&_qoz_sb_923_29, name_tok.text); qoz_strings_sb_append(&_qoz_sb_923_29, QOZ_STR_LIT(" expects a string literal path")); _qoz_bv_25 = qoz_strings_sb_finish(&_qoz_sb_923_29);
    }
    qoz_parse_record_error(p, _qoz_bv_25); return qoz_make_Expr_ENil(span);} qoz_parse_advance(p); qoz_parse_expect_punct(p, QOZ_STR_LIT(")")); if (!qoz_string_eq(name_tok.text, QOZ_STR_LIT("load_string"))) { qoz_string _qoz_bv_26;
    {
        qoz_Strbuf _qoz_sb_929_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_929_29); qoz_strings_sb_append(&_qoz_sb_929_29, QOZ_STR_LIT("unknown directive `#")); qoz_strings_sb_append(&_qoz_sb_929_29, name_tok.text); qoz_strings_sb_append(&_qoz_sb_929_29, QOZ_STR_LIT("` in expression position; supported: #load_string")); _qoz_bv_26 = qoz_strings_sb_finish(&_qoz_sb_929_29);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_940_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_940_29); qoz_strings_sb_append(&_qoz_sb_940_29, QOZ_STR_LIT("#load_string: cannot read `")); qoz_strings_sb_append(&_qoz_sb_940_29, raw_path); qoz_strings_sb_append(&_qoz_sb_940_29, QOZ_STR_LIT("`")); _qoz_bv_27 = qoz_strings_sb_finish(&_qoz_sb_940_29);
    }
...
qoz_Expr* qoz_parse_parse_block(qoz_Parser* p) {
    ...
    {
        qoz_Strbuf _qoz_sb_1274_27 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1274_27); qoz_strings_sb_append(&_qoz_sb_1274_27, QOZ_STR_LIT("_qoz_tup_")); qoz_strings_sb_append_i64(&_qoz_sb_1274_27, n); _qoz_bv_28 = qoz_strings_sb_finish(&_qoz_sb_1274_27);
    }
    ...
    {
        qoz_Strbuf _qoz_sb_1279_37 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1279_37); qoz_strings_sb_append(&_qoz_sb_1279_37, QOZ_STR_LIT("_")); qoz_strings_sb_append_i64(&_qoz_sb_1279_37, bi); _qoz_bv_29 = qoz_strings_sb_finish(&_qoz_sb_1279_37);
    }
...
qoz_Decl* qoz_parse_parse_external(qoz_Parser* p, qoz_string link_name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&p);
    qoz_Token kw_tok = qoz_parse_peek(p); qoz_Span span = qoz_parse_span_of(p, kw_tok); qoz_parse_advance(p); if (!qoz_parse_is_kw(qoz_parse_peek(p), QOZ_STR_LIT("let"))) { qoz_parse_err_unexpected(p, QOZ_STR_LIT("`let` after `external`"), qoz_parse_peek(p)); }  else { qoz_parse_advance(p); } qoz_string name = qoz_parse_expect_ident(p); qoz_string symbol = ((qoz_string_eq(link_name, QOZ_STR_LIT(""))) ? name : link_name); qoz_Vec__qoz_FnParam params = qoz_parse_parse_fn_params(p); qoz_TypeExpr* ret_ty = qoz_make_TypeExpr_TEUnit(span); qoz_gc_push_root(&ret_ty); if (qoz_parse_is_punct(qoz_parse_peek(p), QOZ_STR_LIT(":"))) { qoz_parse_advance(p); ret_ty = qoz_parse_parse_type(p); } qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_make_Decl_DExternal(span, name, symbol, params, ret_ty);
}

qoz_Decl* qoz_parse_parse_top_let_with_op(qoz_Parser* p, qoz_string operator) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&p);
    qoz_Decl* d = qoz_parse_parse_top_let(p); qoz_gc_push_root(&d); if (qoz_string_eq(operator, QOZ_STR_LIT(""))) { return d;} qoz_Decl* _qoz_ms_24 = d; qoz_Decl* _qoz_mv_24 = NULL; switch (_qoz_ms_24->tag) { case qoz_Decl_DImport: { _qoz_mv_24 = (d);  break; } case qoz_Decl_DStruct: { _qoz_mv_24 = (d);  break; } case qoz_Decl_DEnum: { _qoz_mv_24 = (d);  break; } case qoz_Decl_DTypeAlias: { _qoz_mv_24 = (d);  break; } case qoz_Decl_DConst: { _qoz_mv_24 = (d);  break; } case qoz_Decl_DExternal: { _qoz_mv_24 = (d);  break; } case qoz_Decl_DLink: { _qoz_mv_24 = (d);  break; } case qoz_Decl_DFn: { qoz_Span s = _qoz_ms_24->payload.DFn.f0; qoz_string n = _qoz_ms_24->payload.DFn.f1; qoz_Vec__qoz_string tps = _qoz_ms_24->payload.DFn.f2; qoz_Vec__qoz_FnParam ps = _qoz_ms_24->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_24->payload.DFn.f4; qoz_Expr* body = _qoz_ms_24->payload.DFn.f5; _qoz_mv_24 = (qoz_make_Decl_DFn(s, n, tps, ps, ret, body, operator));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_24;
}
...
void qoz_check_report(qoz_TyContext* tc) {
    ...
    {
        qoz_Strbuf _qoz_sb_87_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_87_21); qoz_strings_sb_append(&_qoz_sb_87_21, e.span.file); qoz_strings_sb_append(&_qoz_sb_87_21, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_87_21, e.span.line); qoz_strings_sb_append(&_qoz_sb_87_21, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_87_21, e.span.col); qoz_strings_sb_append(&_qoz_sb_87_21, QOZ_STR_LIT(": ")); qoz_strings_sb_append(&_qoz_sb_87_21, e.message); _qoz_bv_30 = qoz_strings_sb_finish(&_qoz_sb_87_21);
    }
    qoz_fmt_println(_qoz_bv_30); } }
    return;
}
...
void qoz_check_summary(qoz_TyContext* tc) {
    ...
    {
        qoz_Strbuf _qoz_sb_92_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_92_17); qoz_strings_sb_append(&_qoz_sb_92_17, QOZ_STR_LIT("enums:    ")); qoz_strings_sb_append_i64(&_qoz_sb_92_17, (tc->enums.len)); _qoz_bv_31 = qoz_strings_sb_finish(&_qoz_sb_92_17);
    }
    qoz_fmt_println(_qoz_bv_31); qoz_string _qoz_bv_32;
    {
        qoz_Strbuf _qoz_sb_93_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_93_17); qoz_strings_sb_append(&_qoz_sb_93_17, QOZ_STR_LIT("structs:  ")); qoz_strings_sb_append_i64(&_qoz_sb_93_17, (tc->structs.len)); _qoz_bv_32 = qoz_strings_sb_finish(&_qoz_sb_93_17);
    }
    qoz_fmt_println(_qoz_bv_32); qoz_string _qoz_bv_33;
    {
        qoz_Strbuf _qoz_sb_94_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_94_17); qoz_strings_sb_append(&_qoz_sb_94_17, QOZ_STR_LIT("aliases:  ")); qoz_strings_sb_append_i64(&_qoz_sb_94_17, (tc->aliases.len)); _qoz_bv_33 = qoz_strings_sb_finish(&_qoz_sb_94_17);
    }
    qoz_fmt_println(_qoz_bv_33); qoz_string _qoz_bv_34;
    {
        qoz_Strbuf _qoz_sb_95_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_95_17); qoz_strings_sb_append(&_qoz_sb_95_17, QOZ_STR_LIT("fns:      ")); qoz_strings_sb_append_i64(&_qoz_sb_95_17, (tc->fns.len)); _qoz_bv_34 = qoz_strings_sb_finish(&_qoz_sb_95_17);
    }
    qoz_fmt_println(_qoz_bv_34); qoz_string _qoz_bv_35;
    {
        qoz_Strbuf _qoz_sb_96_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_96_17); qoz_strings_sb_append(&_qoz_sb_96_17, QOZ_STR_LIT("externs:  ")); qoz_strings_sb_append_i64(&_qoz_sb_96_17, (tc->externs.len)); _qoz_bv_35 = qoz_strings_sb_finish(&_qoz_sb_96_17);
    }
    qoz_fmt_println(_qoz_bv_35); qoz_string _qoz_bv_36;
    {
        qoz_Strbuf _qoz_sb_97_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_97_17); qoz_strings_sb_append(&_qoz_sb_97_17, QOZ_STR_LIT("packages: ")); qoz_strings_sb_append_i64(&_qoz_sb_97_17, (tc->packages.len)); _qoz_bv_36 = qoz_strings_sb_finish(&_qoz_sb_97_17);
    }
    qoz_fmt_println(_qoz_bv_36); qoz_string _qoz_bv_37;
    {
        qoz_Strbuf _qoz_sb_98_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_98_17); qoz_strings_sb_append(&_qoz_sb_98_17, QOZ_STR_LIT("errors:   ")); qoz_strings_sb_append_i64(&_qoz_sb_98_17, (tc->errors.len)); _qoz_bv_37 = qoz_strings_sb_finish(&_qoz_sb_98_17);
    }
    qoz_fmt_println(_qoz_bv_37); 
    return;
}
...
qoz_Ty* qoz_check_resolve_type(qoz_TyContext* tc, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_26 = te; qoz_Ty* _qoz_mv_26 = NULL; switch (_qoz_ms_26->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_26 = (qoz_ty_ty_unit_());  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_26->payload.TEPtr.f1; _qoz_mv_26 = (qoz_ty_ty_ptr_(qoz_check_resolve_type(tc, inner)));  break; } case qoz_TypeExpr_TETuple: { _qoz_mv_26 = (qoz_ty_ty_error_());  break; } case qoz_TypeExpr_TENamed: { qoz_Span span = _qoz_ms_26->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_26->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_26->payload.TENamed.f2; _qoz_mv_26 = (qoz_check_resolve_named(tc, span, path, args));  break; } case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr params = _qoz_ms_26->payload.TEFn.f1; qoz_TypeExpr* ret = _qoz_ms_26->payload.TEFn.f2; qoz_Ty* _qoz_bv_38;
    {
        qoz_Vec__qoz_Ty resolved = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_TypeExpr __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* p = __col.data[__i]; (void)p; qoz_vec_push__qoz_Ty(&resolved, qoz_check_resolve_type(tc, p)); } }_qoz_bv_38 = qoz_ty_ty_fn_(resolved, qoz_check_resolve_type(tc, ret));
    }
...
qoz_Ty* qoz_check_resolve_named(qoz_TyContext* tc, qoz_Span span, qoz_Vec__qoz_string path, qoz_Vec__qoz_TypeExpr args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    if ((path.len) != 1) { qoz_check_record_error(tc, span, QOZ_STR_LIT("qualified type paths are not yet resolved in Stage B")); return qoz_ty_ty_error_();} qoz_string name = path.data[0]; if (qoz_map_contains__qoz_string__bool(&tc->type_params, name)) { return qoz_ty_ty_var_(name);} if (qoz_string_eq(name, QOZ_STR_LIT("i8"))) { return qoz_ty_ty_int_(8, true);} if (qoz_string_eq(name, QOZ_STR_LIT("i16"))) { return qoz_ty_ty_int_(16, true);} if (qoz_string_eq(name, QOZ_STR_LIT("i32"))) { return qoz_ty_ty_int_(32, true);} if (qoz_string_eq(name, QOZ_STR_LIT("i64"))) { return qoz_ty_ty_int_(64, true);} if (qoz_string_eq(name, QOZ_STR_LIT("u8"))) { return qoz_ty_ty_int_(8, false);} if (qoz_string_eq(name, QOZ_STR_LIT("u16"))) { return qoz_ty_ty_int_(16, false);} if (qoz_string_eq(name, QOZ_STR_LIT("u32"))) { return qoz_ty_ty_int_(32, false);} if (qoz_string_eq(name, QOZ_STR_LIT("u64"))) { return qoz_ty_ty_int_(64, false);} if (qoz_string_eq(name, QOZ_STR_LIT("f32"))) { return qoz_ty_ty_float_(32);} if (qoz_string_eq(name, QOZ_STR_LIT("f64"))) { return qoz_ty_ty_float_(64);} if (qoz_string_eq(name, QOZ_STR_LIT("bool"))) { return qoz_ty_ty_bool_();} if (qoz_string_eq(name, QOZ_STR_LIT("char"))) { return qoz_ty_ty_char_();} if (qoz_string_eq(name, QOZ_STR_LIT("string"))) { return qoz_ty_ty_string_();} if (qoz_string_eq(name, QOZ_STR_LIT("cstring"))) { return qoz_ty_ty_cstring_();} if (qoz_string_eq(name, QOZ_STR_LIT("unit"))) { return qoz_ty_ty_unit_();} if (qoz_string_eq(name, QOZ_STR_LIT("void"))) { return qoz_ty_ty_unit_();} qoz_Vec__qoz_Ty resolved_args = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_TypeExpr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_Ty(&resolved_args, qoz_check_resolve_type(tc, a)); } }if (qoz_map_contains__qoz_string__qoz_Decl(&tc->enums, name)) { return qoz_ty_ty_adt_(name, resolved_args);} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->structs, name)) { return qoz_ty_ty_record_(name, resolved_args);} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->aliases, name)) { return qoz_ty_ty_record_(name, resolved_args);} qoz_string _qoz_bv_39;
    {
        qoz_Strbuf _qoz_sb_158_28 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_158_28); qoz_strings_sb_append(&_qoz_sb_158_28, QOZ_STR_LIT("unknown type `")); qoz_strings_sb_append(&_qoz_sb_158_28, name); qoz_strings_sb_append(&_qoz_sb_158_28, QOZ_STR_LIT("`")); _qoz_bv_39 = qoz_strings_sb_finish(&_qoz_sb_158_28);
    }
    qoz_check_record_error(tc, span, _qoz_bv_39); qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_ty_ty_error_();
}
...
qoz_Ty* qoz_check_env_lookup(qoz_Env* env, qoz_string name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&env);
    int64_t i = (env->bindings.len) - 1; while (i >= 0) { qoz_Binding b = env->bindings.data[i]; if (qoz_string_eq(b.name, name)) { return b.ty;} i = i - 1; } qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_ty_ty_error_();
}
...
qoz_Ty* qoz_check_synth_inner(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* e) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&e);
    qoz_Expr* _qoz_ms_27 = e; qoz_Ty* _qoz_mv_27 = NULL; switch (_qoz_ms_27->tag) { case qoz_Expr_EInt: { _qoz_mv_27 = (qoz_ty_ty_int_untyped());  break; } case qoz_Expr_EFloat: { _qoz_mv_27 = (qoz_ty_ty_float_untyped());  break; } case qoz_Expr_EString: { _qoz_mv_27 = (qoz_ty_ty_string_());  break; } case qoz_Expr_EChar: { _qoz_mv_27 = (qoz_ty_ty_char_());  break; } case qoz_Expr_EBool: { _qoz_mv_27 = (qoz_ty_ty_bool_());  break; } case qoz_Expr_ENil: { _qoz_mv_27 = (qoz_ty_ty_nil_());  break; } case qoz_Expr_EIdent: { qoz_Span span = _qoz_ms_27->payload.EIdent.f0; qoz_string name = _qoz_ms_27->payload.EIdent.f1; _qoz_mv_27 = (qoz_check_synth_ident(tc, env, span, name));  break; } case qoz_Expr_EPath: { _qoz_mv_27 = (qoz_ty_ty_error_());  break; } case qoz_Expr_EUnary: { qoz_UnaryOp* op = _qoz_ms_27->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_27->payload.EUnary.f2; _qoz_mv_27 = (qoz_check_synth_unary(tc, env, op, rhs));  break; } case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_27->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_27->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_27->payload.EBinary.f3; _qoz_mv_27 = (qoz_check_synth_binary(tc, env, op, l, r));  break; } case qoz_Expr_EAssign: { qoz_Expr* v = _qoz_ms_27->payload.EAssign.f3; qoz_Ty* _qoz_bv_40;
    {
        (void)(qoz_check_synth(tc, env, v)); _qoz_bv_40 = qoz_ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_40);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_27->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_27->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_27->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_27->payload.ECall.f3; _qoz_mv_27 = (qoz_check_synth_call_full(tc, env, sp, callee, ta, args));  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_27->payload.EField.f0; qoz_Expr* base = _qoz_ms_27->payload.EField.f1; qoz_string name = _qoz_ms_27->payload.EField.f2; _qoz_mv_27 = (qoz_check_synth_field(tc, env, sp, base, name));  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_27->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_27->payload.EIndex.f2; _qoz_mv_27 = (qoz_check_synth_index(tc, env, base, idx));  break; } case qoz_Expr_ECast: { qoz_TypeExpr* te = _qoz_ms_27->payload.ECast.f2; _qoz_mv_27 = (qoz_check_resolve_type(tc, te));  break; } case qoz_Expr_ETry: { qoz_Expr* v = _qoz_ms_27->payload.ETry.f1; qoz_Ty* _qoz_bv_41;
    {
        qoz_Ty* t = qoz_check_synth(tc, env, v); qoz_gc_push_root(&t); qoz_Ty* _qoz_ms_28 = t; qoz_Ty* _qoz_mv_28 = NULL; switch (_qoz_ms_28->tag) { case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_28->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_28->payload.TyAdt.f1; qoz_Ty* _qoz_bv_42;
    {
    ...
    {
        qoz_Vec__qoz_Ty elem_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Ty(&elem_tys, qoz_check_synth(tc, env, el)); } }_qoz_bv_43 = qoz_ty_ty_tuple_(elem_tys);
    }
    _qoz_mv_27 = (_qoz_bv_43);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_27->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_27->payload.ERecord.f2; _qoz_mv_27 = (qoz_check_synth_record(tc, env, te, fields));  break; } case qoz_Expr_EClosure: { qoz_Vec__qoz_ClosureParam cps = _qoz_ms_27->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_27->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_27->payload.EClosure.f3; qoz_Ty* _qoz_bv_44;
    {
        qoz_Vec__qoz_Ty pty = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_Ty* t = qoz_check_resolve_type(tc, cp.ty); qoz_gc_push_root(&t); qoz_vec_push__qoz_Ty(&pty, t); qoz_check_env_define(env, cp.name, t); } }(void)(qoz_check_synth(tc, env, body)); _qoz_bv_44 = qoz_ty_ty_fn_(pty, qoz_check_resolve_type(tc, ret));
    }
    _qoz_mv_27 = (_qoz_bv_44);  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_27->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_27->payload.EBlock.f2; _qoz_mv_27 = (qoz_check_synth_block(tc, env, stmts, tail));  break; } case qoz_Expr_EIf: { qoz_Expr* c = _qoz_ms_27->payload.EIf.f1; qoz_Expr* t = _qoz_ms_27->payload.EIf.f2; qoz_Expr* f = _qoz_ms_27->payload.EIf.f3; _qoz_mv_27 = (qoz_check_synth_if(tc, env, c, t, f));  break; } case qoz_Expr_EMatch: { qoz_Expr* scrut = _qoz_ms_27->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_27->payload.EMatch.f2; _qoz_mv_27 = (qoz_check_synth_match(tc, env, scrut, arms));  break; } case qoz_Expr_EWhile: { qoz_Expr* c = _qoz_ms_27->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_27->payload.EWhile.f2; qoz_Ty* _qoz_bv_45;
    {
        (void)(qoz_check_synth(tc, env, c)); (void)(qoz_check_synth(tc, env, b)); _qoz_bv_45 = qoz_ty_ty_unit_();
    }
    ...
    {
        qoz_Ty* it_ty = qoz_check_synth(tc, env, it); qoz_gc_push_root(&it_ty); int64_t saved_len = (env->bindings.len); qoz_check_bind_for_loop(env, b1, b2, it_ty); (void)(qoz_check_synth(tc, env, b)); qoz_check_env_truncate(env, saved_len); _qoz_bv_46 = qoz_ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_46);  break; } case qoz_Expr_EReturn: { qoz_Expr* v = _qoz_ms_27->payload.EReturn.f1; qoz_Ty* _qoz_bv_47;
    {
        (void)(qoz_check_synth(tc, env, v)); _qoz_bv_47 = qoz_ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_47);  break; } case qoz_Expr_EDefer: { qoz_Expr* b = _qoz_ms_27->payload.EDefer.f1; qoz_Ty* _qoz_bv_48;
    {
        (void)(qoz_check_synth(tc, env, b)); _qoz_bv_48 = qoz_ty_ty_unit_();
    }
    _qoz_mv_27 = (_qoz_bv_48);  break; } case qoz_Expr_ESizeOf: { _qoz_mv_27 = (qoz_ty_ty_int_(64, true));  break; } case qoz_Expr_EArrayLit: { qoz_Vec__qoz_Expr elems = _qoz_ms_27->payload.EArrayLit.f1; qoz_Ty* _qoz_bv_49;
    {
        if ((elems.len) == 0) { return qoz_ty_ty_error_();} qoz_Ty* elem_ty = qoz_check_synth(tc, env, elems.data[0]); qoz_gc_push_root(&elem_ty); int64_t i = 1; while (i < (elems.len)) { (void)(qoz_check_synth(tc, env, elems.data[i])); i = i + 1; } qoz_Vec__qoz_Ty args = qoz_vec_make__qoz_Ty(); qoz_vec_push__qoz_Ty(&args, elem_ty); _qoz_bv_49 = qoz_ty_ty_record_(QOZ_STR_LIT("Vec"), args);
    }
...
qoz_Ty* qoz_check_synth_unary(qoz_TyContext* tc, qoz_Env* env, qoz_UnaryOp* op, qoz_Expr* rhs) {
    ...
    qoz_Ty* t = qoz_check_synth(tc, env, rhs); qoz_gc_push_root(&t); qoz_UnaryOp* _qoz_ms_29 = op; qoz_Ty* _qoz_mv_29 = NULL; switch (_qoz_ms_29->tag) { case qoz_UnaryOp_UOpNeg: { _qoz_mv_29 = (t);  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_29 = (qoz_ty_ty_bool_());  break; } case qoz_UnaryOp_UOpDeref: { qoz_Ty* _qoz_ms_30 = t; qoz_Ty* _qoz_mv_30 = NULL; switch (_qoz_ms_30->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_30->payload.TyPtr.f0; _qoz_mv_30 = (inner);  break; } default: { _qoz_mv_30 = (qoz_ty_ty_error_());  break; } } _qoz_mv_29 = (_qoz_mv_30);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_29 = (qoz_ty_ty_ptr_(t));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_29;
}
...
qoz_Ty* qoz_check_synth_field(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* base, qoz_string name) {
    ...
    if (qoz_check_is_qualified_variant_field(tc, base, name)) { return qoz_check_synth_variant_ctor(tc, name);} qoz_Ty* bt = qoz_check_synth(tc, env, base); qoz_gc_push_root(&bt); qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_check_field_type_of(tc, bt, name);
}
...
bool qoz_check_is_qualified_variant_field(qoz_TyContext* tc, qoz_Expr* base, qoz_string name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_31 = base; bool _qoz_mv_31 = false; switch (_qoz_ms_31->tag) { case qoz_Expr_EIdent: { qoz_string base_name = _qoz_ms_31->payload.EIdent.f1; _qoz_mv_31 = (qoz_map_contains__qoz_string__qoz_Decl(&tc->enums, base_name) && qoz_map_contains__qoz_string__qoz_string(&tc->variant_of, name));  break; } default: { _qoz_mv_31 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_31;
}
...
qoz_Ty* qoz_check_field_type_of(qoz_TyContext* tc, qoz_Ty* bt, qoz_string name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&bt);
    qoz_Ty* _qoz_ms_32 = bt; qoz_Ty* _qoz_mv_32 = NULL; switch (_qoz_ms_32->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_32->payload.TyPtr.f0; _qoz_mv_32 = (qoz_check_field_type_of(tc, inner, name));  break; } case qoz_Ty_TyRecord: { qoz_string struct_name = _qoz_ms_32->payload.TyRecord.f0; qoz_Vec__qoz_Ty tyargs = _qoz_ms_32->payload.TyRecord.f1; _qoz_mv_32 = (qoz_check_lookup_field(tc, struct_name, tyargs, name));  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_32->payload.TyTuple.f0; qoz_Ty* _qoz_bv_50;
    {
        if (((name).len >= 2) && (qoz_string_byte_at(name, 0) == 95)) { int64_t idx = qoz_string_parse_int(qoz_string_slice(name, 1, (name).len)); if ((idx >= 0) && (idx < (elems.len))) { return elems.data[idx];} } _qoz_bv_50 = qoz_ty_ty_error_();
    }
    _qoz_mv_32 = (_qoz_bv_50);  break; } default: { _qoz_mv_32 = (qoz_ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_32;
}

qoz_Ty* qoz_check_lookup_field(qoz_TyContext* tc, qoz_string struct_name, qoz_Vec__qoz_Ty tyargs, qoz_string field) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_Option__qoz_Decl* _qoz_ms_33 = qoz_map_get__qoz_string__qoz_Decl(&tc->structs, struct_name); qoz_Ty* _qoz_mv_33 = NULL; switch (_qoz_ms_33->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_33->payload.Some.f0; qoz_Decl* _qoz_ms_34 = d; qoz_Ty* _qoz_mv_34 = NULL; switch (_qoz_ms_34->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_34->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_34->payload.DStruct.f3; qoz_Ty* _qoz_bv_51;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_string_eq(f.name, field)) { if ((params.len) == (tyargs.len)) { return qoz_check_resolve_type_with_subst(tc, f.ty, params, tyargs);} return qoz_check_resolve_type(tc, f.ty);} } }_qoz_bv_51 = qoz_ty_ty_error_();
    }
    _qoz_mv_34 = (_qoz_bv_51);  break; } default: { _qoz_mv_34 = (qoz_ty_ty_error_());  break; } } _qoz_mv_33 = (_qoz_mv_34);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_33 = (qoz_ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_33;
}
...
qoz_Ty* qoz_check_apply_subst(qoz_Ty* t, qoz_Vec__qoz_string params, qoz_Vec__qoz_Ty args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_35 = t; qoz_Ty* _qoz_mv_35 = NULL; switch (_qoz_ms_35->tag) { case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_35->payload.TyVar.f1; qoz_Ty* _qoz_bv_52;
    {
    ...
    _qoz_mv_35 = (_qoz_bv_52);  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_35->payload.TyPtr.f0; _qoz_mv_35 = (qoz_ty_ty_ptr_(qoz_check_apply_subst(inner, params, args)));  break; } case qoz_Ty_TyAdt: { qoz_string n = _qoz_ms_35->payload.TyAdt.f0; qoz_Vec__qoz_Ty a = _qoz_ms_35->payload.TyAdt.f1; qoz_Ty* _qoz_bv_53;
    {
        qoz_Vec__qoz_Ty na = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = a; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&na, qoz_check_apply_subst(x, params, args)); } }_qoz_bv_53 = qoz_ty_ty_adt_(n, na);
    }
    _qoz_mv_35 = (_qoz_bv_53);  break; } case qoz_Ty_TyRecord: { qoz_string n = _qoz_ms_35->payload.TyRecord.f0; qoz_Vec__qoz_Ty a = _qoz_ms_35->payload.TyRecord.f1; qoz_Ty* _qoz_bv_54;
    {
        qoz_Vec__qoz_Ty na = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = a; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&na, qoz_check_apply_subst(x, params, args)); } }_qoz_bv_54 = qoz_ty_ty_record_(n, na);
    }
    _qoz_mv_35 = (_qoz_bv_54);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty p = _qoz_ms_35->payload.TyFn.f0; qoz_Ty* r = _qoz_ms_35->payload.TyFn.f1; qoz_Ty* _qoz_bv_55;
    {
        qoz_Vec__qoz_Ty np = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Ty __col = p; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* x = __col.data[__i]; (void)x; qoz_vec_push__qoz_Ty(&np, qoz_check_apply_subst(x, params, args)); } }_qoz_bv_55 = qoz_ty_ty_fn_(np, qoz_check_apply_subst(r, params, args));
    }
    _qoz_mv_35 = (_qoz_bv_55);  break; } default: { _qoz_mv_35 = (t);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_35;
}
...
qoz_Ty* qoz_check_synth_index(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* base, qoz_Expr* idx) {
    ...
    qoz_Ty* bt = qoz_check_synth(tc, env, base); qoz_gc_push_root(&bt); (void)(qoz_check_synth(tc, env, idx)); qoz_Ty* _qoz_ms_36 = bt; qoz_Ty* _qoz_mv_36 = NULL; switch (_qoz_ms_36->tag) { case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_36->payload.TyPtr.f0; _qoz_mv_36 = (inner);  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_36->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_36->payload.TyRecord.f1; qoz_Ty* _qoz_bv_56;
    {
        if (qoz_string_eq(name, QOZ_STR_LIT("Vec")) && ((args.len) >= 1)) { return args.data[0];} _qoz_bv_56 = qoz_ty_ty_error_();
    }
    _qoz_mv_36 = (_qoz_bv_56);  break; } default: { _qoz_mv_36 = (qoz_ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_36;
}

bool qoz_check_is_strings_callee(qoz_Expr* callee, qoz_string method) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_37 = callee; bool _qoz_mv_37 = false; switch (_qoz_ms_37->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_37->payload.EField.f1; qoz_string m = _qoz_ms_37->payload.EField.f2; bool _qoz_bv_57;
    {
        if (!qoz_string_eq(m, method)) { return false;} qoz_Expr* _qoz_ms_38 = base; bool _qoz_mv_38 = false; switch (_qoz_ms_38->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_38->payload.EIdent.f1; _qoz_mv_38 = (qoz_string_eq(name, QOZ_STR_LIT("strings")));  break; } default: { _qoz_mv_38 = (false);  break; } } _qoz_bv_57 = _qoz_mv_38;
    }
    _qoz_mv_37 = (_qoz_bv_57);  break; } default: { _qoz_mv_37 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_37;
}

qoz_string qoz_check_sb_append_method_for(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_39 = t; qoz_string _qoz_mv_39 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_39->tag) { case qoz_Ty_TyString: { _qoz_mv_39 = (QOZ_STR_LIT("sb_append"));  break; } case qoz_Ty_TyBool: { _qoz_mv_39 = (QOZ_STR_LIT("sb_append_bool"));  break; } case qoz_Ty_TyFloat: { _qoz_mv_39 = (QOZ_STR_LIT("sb_append_f64"));  break; } case qoz_Ty_TyInt: { _qoz_mv_39 = (QOZ_STR_LIT("sb_append_i64"));  break; } case qoz_Ty_TyChar: { _qoz_mv_39 = (QOZ_STR_LIT("sb_append_i64"));  break; } default: { _qoz_mv_39 = (QOZ_STR_LIT("sb_append"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_39;
}
...
qoz_string qoz_check_resolve_callee_fn(qoz_TyContext* tc, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_40 = callee; qoz_string _qoz_mv_40 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_40->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_40->payload.EIdent.f1; _qoz_mv_40 = (name);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_40->payload.EField.f1; qoz_string method = _qoz_ms_40->payload.EField.f2; qoz_Expr* _qoz_ms_41 = base; qoz_string _qoz_mv_41 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_41->tag) { case qoz_Expr_EIdent: { qoz_string pkg = _qoz_ms_41->payload.EIdent.f1; qoz_string _qoz_bv_58;
    {
        if (qoz_map_contains__qoz_string__bool(&tc->packages, pkg)) { return qoz_string_cat(qoz_string_cat(pkg, QOZ_STR_LIT("_")), method);} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->enums, pkg)) { if (qoz_map_contains__qoz_string__qoz_string(&tc->variant_of, method)) { return method;} } _qoz_bv_58 = QOZ_STR_LIT("");
    }
    _qoz_mv_41 = (_qoz_bv_58);  break; } default: { _qoz_mv_41 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_40 = (_qoz_mv_41);  break; } default: { _qoz_mv_40 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_40;
}
...
qoz_Ty* qoz_check_synth_call_full(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&callee);
    qoz_string fn_name = qoz_check_resolve_callee_fn(tc, callee); if (qoz_string_eq(fn_name, QOZ_STR_LIT("len")) || qoz_string_eq(fn_name, QOZ_STR_LIT("size_of"))) { { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; (void)(qoz_check_synth(tc, env, a)); } }return qoz_ty_ty_int_(64, true);} if (qoz_string_eq(fn_name, QOZ_STR_LIT("hash"))) { { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; (void)(qoz_check_synth(tc, env, a)); } }return qoz_ty_ty_int_(64, false);} qoz_Vec__qoz_Ty arg_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_Ty(&arg_tys, qoz_check_synth(tc, env, a)); } }if (qoz_string_eq(fn_name, QOZ_STR_LIT(""))) { return qoz_ty_ty_error_();} qoz_Option__qoz_Decl* _qoz_ms_42 = qoz_map_get__qoz_string__qoz_Decl(&tc->fns, fn_name); qoz_Ty* _qoz_mv_42 = NULL; switch (_qoz_ms_42->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_42->payload.Some.f0; _qoz_mv_42 = (qoz_check_synth_call_with_decl(tc, sp, d, type_args, arg_tys));  break; } case qoz_Option__qoz_Decl_None: { qoz_Option__qoz_Decl* _qoz_ms_43 = qoz_map_get__qoz_string__qoz_Decl(&tc->externs, fn_name); qoz_Ty* _qoz_mv_43 = NULL; switch (_qoz_ms_43->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_43->payload.Some.f0; _qoz_mv_43 = (qoz_check_synth_call_with_decl(tc, sp, d, type_args, arg_tys));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_43 = (qoz_check_synth_variant_ctor_with_args(tc, fn_name, arg_tys));  break; } } _qoz_mv_42 = (_qoz_mv_43);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_42;
}
...
qoz_Ty* qoz_check_synth_record(qoz_TyContext* tc, qoz_Env* env, qoz_TypeExpr* te, qoz_Vec__qoz_RecordFieldLit fields) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&te);
    qoz_Ty* bare_resolved = qoz_check_resolve_type(tc, te); qoz_gc_push_root(&bare_resolved); qoz_string struct_name = qoz_check_record_name_of(bare_resolved); if (qoz_string_eq(struct_name, QOZ_STR_LIT(""))) { return bare_resolved;} qoz_Vec__qoz_string tparams = qoz_check_struct_tparams(tc, struct_name); if ((tparams.len) == 0) { return bare_resolved;} if (qoz_check_annotation_pins_type_args(te, tparams)) { return bare_resolved;} qoz_Map__qoz_string__qoz_Ty bindings = qoz_map_make__qoz_string__qoz_Ty(); qoz_Map__qoz_string__bool saved = tc->type_params; qoz_check_set_type_params(tc, tparams); int64_t i = 0; while (i < (fields.len)) { qoz_RecordFieldLit f = fields.data[i]; if (!qoz_string_eq(f.name, QOZ_STR_LIT(".."))) { qoz_Option__qoz_TypeExpr* _qoz_ms_44 = qoz_check_struct_field_typeexpr(tc, struct_name, f.name); switch (_qoz_ms_44->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* dte = _qoz_ms_44->payload.Some.f0; void* _qoz_bv_59;
    {
        qoz_Ty* p_ty = qoz_check_resolve_type(tc, dte); qoz_gc_push_root(&p_ty); qoz_Ty* v_ty = qoz_check_synth(tc, env, f.value); qoz_gc_push_root(&v_ty); (void)(qoz_check_unify(p_ty, v_ty, &bindings)); _qoz_bv_59 = NULL;
    }
    _qoz_bv_59;  break; } default: { NULL;  break; } } 0; } i = i + 1; } tc->type_params = saved; qoz_Vec__qoz_Ty args = qoz_vec_make__qoz_Ty(); int64_t ti = 0; while (ti < (tparams.len)) { qoz_string tp = tparams.data[ti]; qoz_Option__qoz_Ty* _qoz_ms_45 = qoz_map_get__qoz_string__qoz_Ty(&bindings, tp); switch (_qoz_ms_45->tag) { case qoz_Option__qoz_Ty_Some: { qoz_Ty* t = _qoz_ms_45->payload.Some.f0; qoz_vec_push__qoz_Ty(&args, t);  break; } default: { qoz_vec_push__qoz_Ty(&args, qoz_ty_ty_var_(tp));  break; } } 0; ti = ti + 1; } qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_ty_ty_record_(struct_name, args);
}
...
qoz_TypeExpr* qoz_check_inferred_record_te(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_TypeExpr* te, qoz_Vec__qoz_RecordFieldLit fields) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&te);
    qoz_Vec__qoz_string orig_path = qoz_check_te_path_segments(te); qoz_string struct_name = (((orig_path.len) >= 1) ? orig_path.data[(orig_path.len) - 1] : QOZ_STR_LIT("")); if (qoz_string_eq(struct_name, QOZ_STR_LIT(""))) { return te;} qoz_Vec__qoz_string tparams = qoz_check_struct_tparams(tc, struct_name); if ((tparams.len) == 0) { return te;} if (qoz_check_annotation_pins_type_args(te, tparams)) { return te;} qoz_Ty* synth_ty = qoz_check_synth_record(tc, env, te, fields); qoz_gc_push_root(&synth_ty); qoz_Vec__qoz_Ty args = qoz_check_ty_record_args(synth_ty); if ((args.len) != (tparams.len)) { return te;} qoz_Vec__qoz_TypeExpr te_args = qoz_vec_make__qoz_TypeExpr(); int64_t i = 0; while (i < (args.len)) { qoz_vec_push__qoz_TypeExpr(&te_args, qoz_ty_ty_to_type_expr_at(args.data[i], sp)); i = i + 1; } qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_make_TypeExpr_TENamed(sp, orig_path, te_args);
}

qoz_Vec__qoz_string qoz_check_te_path_segments(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_Vec__qoz_string empty = qoz_vec_make__qoz_string(); qoz_TypeExpr* _qoz_ms_46 = te; qoz_Vec__qoz_string _qoz_mv_46 = ((qoz_Vec__qoz_string){0}); switch (_qoz_ms_46->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_46->payload.TENamed.f1; _qoz_mv_46 = (path);  break; } default: { _qoz_mv_46 = (empty);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_46;
}

qoz_Vec__qoz_Ty qoz_check_ty_record_args(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Vec__qoz_Ty empty = qoz_vec_make__qoz_Ty(); qoz_Ty* _qoz_ms_47 = t; qoz_Vec__qoz_Ty _qoz_mv_47 = ((qoz_Vec__qoz_Ty){0}); switch (_qoz_ms_47->tag) { case qoz_Ty_TyRecord: { qoz_Vec__qoz_Ty args = _qoz_ms_47->payload.TyRecord.f1; _qoz_mv_47 = (args);  break; } default: { _qoz_mv_47 = (empty);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_47;
}
...
void qoz_check_check_binding_compat(qoz_TyContext* tc, qoz_Span sp, qoz_TypeExpr* te, qoz_Ty* bound, qoz_Ty* vt) {
    ...
    qoz_gc_push_root(&vt);
    qoz_TypeExpr* _qoz_ms_48 = te; switch (_qoz_ms_48->tag) { case qoz_TypeExpr_TEUnit: { return;  break; } default: { NULL;  break; } } 0; if (!qoz_ty_ty_assignable(bound, vt)) { qoz_string want = qoz_ty_ty_show(bound); qoz_string got = qoz_ty_ty_show(vt); qoz_string _qoz_bv_60;
    {
        qoz_Strbuf _qoz_sb_587_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_587_30); qoz_strings_sb_append(&_qoz_sb_587_30, QOZ_STR_LIT("binding type ")); qoz_strings_sb_append(&_qoz_sb_587_30, want); qoz_strings_sb_append(&_qoz_sb_587_30, QOZ_STR_LIT(" cannot accept value of type ")); qoz_strings_sb_append(&_qoz_sb_587_30, got); _qoz_bv_60 = qoz_strings_sb_finish(&_qoz_sb_587_30);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_60); } 
    return;
}
...
bool qoz_check_annotation_pins_type_args(qoz_TypeExpr* te, qoz_Vec__qoz_string tparams) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_49 = te; bool _qoz_mv_49 = false; switch (_qoz_ms_49->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_TypeExpr ann_args = _qoz_ms_49->payload.TENamed.f2; _qoz_mv_49 = ((ann_args.len) == (tparams.len));  break; } default: { _qoz_mv_49 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_49;
}

qoz_Vec__qoz_string qoz_check_struct_tparams(qoz_TyContext* tc, qoz_string name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_Vec__qoz_string empty = qoz_vec_make__qoz_string(); qoz_Option__qoz_Decl* _qoz_ms_50 = qoz_map_get__qoz_string__qoz_Decl(&tc->structs, name); qoz_Vec__qoz_string _qoz_mv_50 = ((qoz_Vec__qoz_string){0}); switch (_qoz_ms_50->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_50->payload.Some.f0; qoz_Decl* _qoz_ms_51 = d; qoz_Vec__qoz_string _qoz_mv_51 = ((qoz_Vec__qoz_string){0}); switch (_qoz_ms_51->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string tps = _qoz_ms_51->payload.DStruct.f2; _qoz_mv_51 = (tps);  break; } default: { _qoz_mv_51 = (empty);  break; } } _qoz_mv_50 = (_qoz_mv_51);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_50 = (empty);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_50;
}

qoz_Option__qoz_TypeExpr* qoz_check_struct_field_typeexpr(qoz_TyContext* tc, qoz_string name, qoz_string field) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_Option__qoz_Decl* _qoz_ms_52 = qoz_map_get__qoz_string__qoz_Decl(&tc->structs, name); qoz_Option__qoz_TypeExpr* _qoz_mv_52 = NULL; switch (_qoz_ms_52->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_52->payload.Some.f0; qoz_Decl* _qoz_ms_53 = d; qoz_Option__qoz_TypeExpr* _qoz_mv_53 = NULL; switch (_qoz_ms_53->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_StructField fields = _qoz_ms_53->payload.DStruct.f3; qoz_Option__qoz_TypeExpr* _qoz_bv_61;
    {
        int64_t i = 0; while (i < (fields.len)) { if (qoz_string_eq(fields.data[i].name, field)) { return qoz_make_Option__qoz_TypeExpr_Some(fields.data[i].ty);} i = i + 1; } _qoz_bv_61 = qoz_make_Option__qoz_TypeExpr_None();
    }
    _qoz_mv_53 = (_qoz_bv_61);  break; } default: { _qoz_mv_53 = (qoz_make_Option__qoz_TypeExpr_None());  break; } } _qoz_mv_52 = (_qoz_mv_53);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_52 = (qoz_make_Option__qoz_TypeExpr_None());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_52;
}
...
qoz_Ty* qoz_check_synth_variant_ctor_with_args(qoz_TyContext* tc, qoz_string name, qoz_Vec__qoz_Ty arg_tys) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_string enum_name = qoz_check_variant_enum_name(tc, name); if (qoz_string_eq(enum_name, QOZ_STR_LIT(""))) { return qoz_ty_ty_error_();} qoz_Vec__qoz_string tparams = qoz_check_enum_tparams(tc, enum_name); if ((tparams.len) == 0) { return qoz_ty_ty_adt_(enum_name, qoz_vec_make__qoz_Ty());} qoz_Vec__qoz_TypeExpr variant_pos = qoz_check_variant_positional_types(tc, enum_name, name); qoz_Map__qoz_string__qoz_Ty bindings = qoz_map_make__qoz_string__qoz_Ty(); qoz_Map__qoz_string__bool saved = tc->type_params; qoz_check_set_type_params(tc, tparams); int64_t i = 0; while (i < (variant_pos.len)) { if (i < (arg_tys.len)) { qoz_Ty* pos_ty = qoz_check_resolve_type(tc, variant_pos.data[i]); qoz_gc_push_root(&pos_ty); (void)(qoz_check_unify(pos_ty, arg_tys.data[i], &bindings)); } i = i + 1; } tc->type_params = saved; qoz_Vec__qoz_Ty args = qoz_vec_make__qoz_Ty(); int64_t ti = 0; while (ti < (tparams.len)) { qoz_string tp = tparams.data[ti]; qoz_Option__qoz_Ty* _qoz_ms_54 = qoz_map_get__qoz_string__qoz_Ty(&bindings, tp); switch (_qoz_ms_54->tag) { case qoz_Option__qoz_Ty_Some: { qoz_Ty* t = _qoz_ms_54->payload.Some.f0; qoz_vec_push__qoz_Ty(&args, t);  break; } default: { qoz_vec_push__qoz_Ty(&args, qoz_ty_ty_var_(tp));  break; } } 0; ti = ti + 1; } qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_ty_ty_adt_(enum_name, args);
}

qoz_string qoz_check_record_name_of(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_55 = t; qoz_string _qoz_mv_55 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_55->tag) { case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_55->payload.TyRecord.f0; _qoz_mv_55 = (name);  break; } default: { _qoz_mv_55 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_55;
}

qoz_string qoz_check_variant_enum_name(qoz_TyContext* tc, qoz_string variant) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_Option__qoz_string* _qoz_ms_56 = qoz_map_get__qoz_string__qoz_string(&tc->variant_of, variant); qoz_string _qoz_mv_56 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_56->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_56->payload.Some.f0; _qoz_mv_56 = (en);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_56 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_56;
}

qoz_Vec__qoz_string qoz_check_enum_tparams(qoz_TyContext* tc, qoz_string enum_name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_Vec__qoz_string empty = qoz_vec_make__qoz_string(); qoz_Option__qoz_Decl* _qoz_ms_57 = qoz_map_get__qoz_string__qoz_Decl(&tc->enums, enum_name); qoz_Vec__qoz_string _qoz_mv_57 = ((qoz_Vec__qoz_string){0}); switch (_qoz_ms_57->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_57->payload.Some.f0; qoz_Decl* _qoz_ms_58 = d; qoz_Vec__qoz_string _qoz_mv_58 = ((qoz_Vec__qoz_string){0}); switch (_qoz_ms_58->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tps = _qoz_ms_58->payload.DEnum.f2; _qoz_mv_58 = (tps);  break; } default: { _qoz_mv_58 = (empty);  break; } } _qoz_mv_57 = (_qoz_mv_58);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_57 = (empty);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_57;
}

qoz_Vec__qoz_TypeExpr qoz_check_variant_positional_types(qoz_TyContext* tc, qoz_string enum_name, qoz_string variant) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    qoz_Vec__qoz_TypeExpr empty = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Decl* _qoz_ms_59 = qoz_map_get__qoz_string__qoz_Decl(&tc->enums, enum_name); qoz_Vec__qoz_TypeExpr _qoz_mv_59 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_59->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_59->payload.Some.f0; qoz_Decl* _qoz_ms_60 = d; qoz_Vec__qoz_TypeExpr _qoz_mv_60 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_60->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_VariantDecl variants = _qoz_ms_60->payload.DEnum.f3; qoz_Vec__qoz_TypeExpr _qoz_bv_62;
    {
        qoz_Vec__qoz_TypeExpr out = qoz_vec_make__qoz_TypeExpr(); bool found = false; int64_t i = 0; while (i < (variants.len)) { qoz_VariantDecl v = variants.data[i]; if (!found) { if (qoz_string_eq(v.name, variant)) { out = v.pos; found = true; } } i = i + 1; } _qoz_bv_62 = out;
    }
    _qoz_mv_60 = (_qoz_bv_62);  break; } default: { _qoz_mv_60 = (empty);  break; } } _qoz_mv_59 = (_qoz_mv_60);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_59 = (empty);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_59;
}
...
qoz_Ty* qoz_check_synth_call_with_decl(qoz_TyContext* tc, qoz_Span sp, qoz_Decl* d, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Ty arg_tys) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_61 = d; qoz_Ty* _qoz_mv_61 = NULL; switch (_qoz_ms_61->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_61->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_61->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_61->payload.DFn.f4; qoz_Ty* _qoz_bv_63;
    {
        if ((arg_tys.len) != (params.len)) { qoz_string _qoz_bv_64;
    {
        qoz_Strbuf _qoz_sb_732_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_732_34); qoz_strings_sb_append(&_qoz_sb_732_34, QOZ_STR_LIT("function expects ")); qoz_strings_sb_append_i64(&_qoz_sb_732_34, (params.len)); qoz_strings_sb_append(&_qoz_sb_732_34, QOZ_STR_LIT(" argument(s), got ")); qoz_strings_sb_append_i64(&_qoz_sb_732_34, (arg_tys.len)); _qoz_bv_64 = qoz_strings_sb_finish(&_qoz_sb_732_34);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_64); } if ((tparams.len) == 0) { qoz_Map__qoz_string__bool saved = tc->type_params; qoz_check_set_type_params(tc, tparams); int64_t i = 0; while ((i < (params.len)) && (i < (arg_tys.len))) { qoz_Ty* p_ty = qoz_check_resolve_type(tc, params.data[i].ty); qoz_gc_push_root(&p_ty); if (!qoz_ty_ty_assignable(p_ty, arg_tys.data[i])) { qoz_string want = qoz_ty_ty_show(p_ty); qoz_string got = qoz_ty_ty_show(arg_tys.data[i]); qoz_string _qoz_bv_65;
    {
        qoz_Strbuf _qoz_sb_746_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_746_42); qoz_strings_sb_append(&_qoz_sb_746_42, QOZ_STR_LIT("expected ")); qoz_strings_sb_append(&_qoz_sb_746_42, want); qoz_strings_sb_append(&_qoz_sb_746_42, QOZ_STR_LIT(", got ")); qoz_strings_sb_append(&_qoz_sb_746_42, got); _qoz_bv_65 = qoz_strings_sb_finish(&_qoz_sb_746_42);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_65); } i = i + 1; } qoz_Ty* r = qoz_check_resolve_type(tc, ret); qoz_gc_push_root(&r); tc->type_params = saved; return r;} qoz_Vec__qoz_Ty tyarg_tys = qoz_vec_make__qoz_Ty(); if ((type_args.len) == (tparams.len)) { { qoz_Vec__qoz_TypeExpr __col = type_args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* ta = __col.data[__i]; (void)ta; qoz_vec_push__qoz_Ty(&tyarg_tys, qoz_check_resolve_type(tc, ta)); } }}  else { qoz_Map__qoz_string__bool saved_a = tc->type_params; qoz_check_set_type_params(tc, tparams); qoz_Vec__qoz_Ty param_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_vec_push__qoz_Ty(&param_tys, qoz_check_resolve_type(tc, pp.ty)); } }tc->type_params = saved_a; qoz_Map__qoz_string__qoz_Ty subst_env = qoz_map_make__qoz_string__qoz_Ty(); bool ok = true; int64_t i = 0; while ((i < (arg_tys.len)) && (i < (param_tys.len))) { if (!qoz_check_unify(param_tys.data[i], arg_tys.data[i], &subst_env)) { ok = false; } i = i + 1; } if (!ok) { qoz_check_record_error(tc, sp, QOZ_STR_LIT("could not infer generic type arguments at call site")); } { qoz_Vec__qoz_string __col = tparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string tp = __col.data[__i]; (void)tp; qoz_Option__qoz_Ty* _qoz_ms_62 = qoz_map_get__qoz_string__qoz_Ty(&subst_env, tp); switch (_qoz_ms_62->tag) { case qoz_Option__qoz_Ty_Some: { qoz_Ty* t = _qoz_ms_62->payload.Some.f0; qoz_vec_push__qoz_Ty(&tyarg_tys, t);  break; } case qoz_Option__qoz_Ty_None: { {
        qoz_string _qoz_bv_66;
    {
        qoz_Strbuf _qoz_sb_777_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_777_42); qoz_strings_sb_append(&_qoz_sb_777_42, QOZ_STR_LIT("type parameter `")); qoz_strings_sb_append(&_qoz_sb_777_42, tp); qoz_strings_sb_append(&_qoz_sb_777_42, QOZ_STR_LIT("` is not constrained by any argument; add an explicit annotation")); _qoz_bv_66 = qoz_strings_sb_finish(&_qoz_sb_777_42);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_66); qoz_vec_push__qoz_Ty(&tyarg_tys, qoz_ty_ty_error_()); 
    }
    0;  break; } } 0; } }} qoz_Map__qoz_string__bool saved_b = tc->type_params; qoz_check_set_type_params(tc, tparams); qoz_Ty* raw_ret = qoz_check_resolve_type(tc, ret); qoz_gc_push_root(&raw_ret); tc->type_params = saved_b; _qoz_bv_63 = qoz_check_apply_subst(raw_ret, tparams, tyarg_tys);
    }
    _qoz_mv_61 = (_qoz_bv_63);  break; } case qoz_Decl_DExternal: { qoz_TypeExpr* ret = _qoz_ms_61->payload.DExternal.f4; _qoz_mv_61 = (qoz_check_resolve_type(tc, ret));  break; } default: { _qoz_mv_61 = (qoz_ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_61;
}
...
bool qoz_check_unify(qoz_Ty* pattern, qoz_Ty* concrete, qoz_Map__qoz_string__qoz_Ty* env) {
    ...
    qoz_gc_push_root(&env);
    qoz_Ty* _qoz_ms_63 = pattern; bool _qoz_mv_63 = false; switch (_qoz_ms_63->tag) { case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_63->payload.TyVar.f1; qoz_Option__qoz_Ty* _qoz_ms_64 = qoz_map_get__qoz_string__qoz_Ty(env, name); bool _qoz_mv_64 = false; switch (_qoz_ms_64->tag) { case qoz_Option__qoz_Ty_Some: { qoz_Ty* prior = _qoz_ms_64->payload.Some.f0; _qoz_mv_64 = (qoz_check_compatible_or_refine(env, name, prior, concrete));  break; } case qoz_Option__qoz_Ty_None: { bool _qoz_bv_67;
    {
        qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); _qoz_bv_67 = true;
    }
    _qoz_mv_64 = (_qoz_bv_67);  break; } } _qoz_mv_63 = (_qoz_mv_64);  break; } case qoz_Ty_TyPtr: { qoz_Ty* pi = _qoz_ms_63->payload.TyPtr.f0; qoz_Ty* _qoz_ms_65 = concrete; bool _qoz_mv_65 = false; switch (_qoz_ms_65->tag) { case qoz_Ty_TyPtr: { qoz_Ty* ci = _qoz_ms_65->payload.TyPtr.f0; _qoz_mv_65 = (qoz_check_unify(pi, ci, env));  break; } case qoz_Ty_TyNil: { _qoz_mv_65 = (true);  break; } default: { _qoz_mv_65 = (false);  break; } } _qoz_mv_63 = (_qoz_mv_65);  break; } case qoz_Ty_TyAdt: { qoz_string pn = _qoz_ms_63->payload.TyAdt.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_63->payload.TyAdt.f1; qoz_Ty* _qoz_ms_66 = concrete; bool _qoz_mv_66 = false; switch (_qoz_ms_66->tag) { case qoz_Ty_TyAdt: { qoz_string cn = _qoz_ms_66->payload.TyAdt.f0; qoz_Vec__qoz_Ty ca = _qoz_ms_66->payload.TyAdt.f1; _qoz_mv_66 = (qoz_string_eq(pn, cn) && qoz_check_unify_args(pa, ca, env));  break; } default: { _qoz_mv_66 = (false);  break; } } _qoz_mv_63 = (_qoz_mv_66);  break; } case qoz_Ty_TyRecord: { qoz_string pn = _qoz_ms_63->payload.TyRecord.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_63->payload.TyRecord.f1; qoz_Ty* _qoz_ms_67 = concrete; bool _qoz_mv_67 = false; switch (_qoz_ms_67->tag) { case qoz_Ty_TyRecord: { qoz_string cn = _qoz_ms_67->payload.TyRecord.f0; qoz_Vec__qoz_Ty ca = _qoz_ms_67->payload.TyRecord.f1; _qoz_mv_67 = (qoz_string_eq(pn, cn) && qoz_check_unify_args(pa, ca, env));  break; } default: { _qoz_mv_67 = (false);  break; } } _qoz_mv_63 = (_qoz_mv_67);  break; } case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_63->payload.TyInt.f0; qoz_Ty* _qoz_ms_68 = concrete; bool _qoz_mv_68 = false; switch (_qoz_ms_68->tag) { case qoz_Ty_TyInt: { qoz_IntInfo ci = _qoz_ms_68->payload.TyInt.f0; _qoz_mv_68 = (ci.untyped || ((pi.width == ci.width) && (pi.is_signed == ci.is_signed)));  break; } default: { _qoz_mv_68 = (false);  break; } } _qoz_mv_63 = (_qoz_mv_68);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_63->payload.TyFloat.f0; qoz_Ty* _qoz_ms_69 = concrete; bool _qoz_mv_69 = false; switch (_qoz_ms_69->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo cf = _qoz_ms_69->payload.TyFloat.f0; _qoz_mv_69 = (cf.untyped || (pf.width == cf.width));  break; } default: { _qoz_mv_69 = (false);  break; } } _qoz_mv_63 = (_qoz_mv_69);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty pp = _qoz_ms_63->payload.TyFn.f0; qoz_Ty* pr = _qoz_ms_63->payload.TyFn.f1; qoz_Ty* _qoz_ms_70 = concrete; bool _qoz_mv_70 = false; switch (_qoz_ms_70->tag) { case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty cp = _qoz_ms_70->payload.TyFn.f0; qoz_Ty* cr = _qoz_ms_70->payload.TyFn.f1; _qoz_mv_70 = (qoz_check_unify_args(pp, cp, env) && qoz_check_unify(pr, cr, env));  break; } default: { _qoz_mv_70 = (false);  break; } } _qoz_mv_63 = (_qoz_mv_70);  break; } default: { _qoz_mv_63 = (qoz_ty_ty_eq(pattern, concrete));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_63;
}
...
bool qoz_check_compatible_or_refine(qoz_Map__qoz_string__qoz_Ty* env, qoz_string name, qoz_Ty* prior, qoz_Ty* concrete) {
    ...
    qoz_gc_push_root(&concrete);
    if (qoz_ty_ty_eq(prior, concrete)) { return true;} qoz_Ty* _qoz_ms_71 = prior; bool _qoz_mv_71 = false; switch (_qoz_ms_71->tag) { case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_71->payload.TyInt.f0; qoz_Ty* _qoz_ms_72 = concrete; bool _qoz_mv_72 = false; switch (_qoz_ms_72->tag) { case qoz_Ty_TyInt: { qoz_IntInfo ci = _qoz_ms_72->payload.TyInt.f0; bool _qoz_bv_68;
    {
        if (ci.untyped) { return true;} if (pi.untyped) { qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); return true;} _qoz_bv_68 = false;
    }
    _qoz_mv_72 = (_qoz_bv_68);  break; } default: { _qoz_mv_72 = (false);  break; } } _qoz_mv_71 = (_qoz_mv_72);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_71->payload.TyFloat.f0; qoz_Ty* _qoz_ms_73 = concrete; bool _qoz_mv_73 = false; switch (_qoz_ms_73->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo cf = _qoz_ms_73->payload.TyFloat.f0; bool _qoz_bv_69;
    {
        if (cf.untyped) { return true;} if (pf.untyped) { qoz_map_set__qoz_string__qoz_Ty(env, name, concrete); return true;} _qoz_bv_69 = false;
    }
    _qoz_mv_73 = (_qoz_bv_69);  break; } default: { _qoz_mv_73 = (false);  break; } } _qoz_mv_71 = (_qoz_mv_73);  break; } default: { _qoz_mv_71 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_71;
}
...
bool qoz_check_is_ty_error(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_74 = t; bool _qoz_mv_74 = false; switch (_qoz_ms_74->tag) { case qoz_Ty_TyError: { _qoz_mv_74 = (true);  break; } default: { _qoz_mv_74 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_74;
}
...
qoz_Ty* qoz_check_synth_ident(qoz_TyContext* tc, qoz_Env* env, qoz_Span span, qoz_string name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&env);
    if (qoz_check_env_has(env, name)) { return qoz_check_env_lookup(env, name);} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->fns, name)) { return qoz_ty_ty_error_();} if (qoz_map_contains__qoz_string__qoz_Decl(&tc->externs, name)) { return qoz_ty_ty_error_();} qoz_Option__qoz_string* _qoz_ms_75 = qoz_map_get__qoz_string__qoz_string(&tc->variant_of, name); switch (_qoz_ms_75->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_75->payload.Some.f0; return qoz_check_synth_variant_ctor(tc, name); break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; qoz_string _qoz_bv_70;
    {
        qoz_Strbuf _qoz_sb_910_28 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_910_28); qoz_strings_sb_append(&_qoz_sb_910_28, QOZ_STR_LIT("undefined name `")); qoz_strings_sb_append(&_qoz_sb_910_28, name); qoz_strings_sb_append(&_qoz_sb_910_28, QOZ_STR_LIT("`")); _qoz_bv_70 = qoz_strings_sb_finish(&_qoz_sb_910_28);
    }
    qoz_check_record_error(tc, span, _qoz_bv_70); qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_ty_ty_error_();
}
...
qoz_Ty* qoz_check_synth_binary(qoz_TyContext* tc, qoz_Env* env, qoz_BinaryOp* op, qoz_Expr* l, qoz_Expr* r) {
    ...
    qoz_gc_push_root(&l);
    qoz_gc_push_root(&r);
    qoz_Ty* lt = qoz_check_synth(tc, env, l); qoz_gc_push_root(&lt); (void)(qoz_check_synth(tc, env, r)); qoz_BinaryOp* _qoz_ms_76 = op; qoz_Ty* _qoz_mv_76 = NULL; switch (_qoz_ms_76->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_76 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_76 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_76 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_76 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_76 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_76 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_76 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_76 = (qoz_ty_ty_bool_());  break; } case qoz_BinaryOp_BOpAdd: { _qoz_mv_76 = (lt);  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_76 = (lt);  break; } case qoz_BinaryOp_BOpMul: { _qoz_mv_76 = (lt);  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_76 = (lt);  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_76 = (lt);  break; } case qoz_BinaryOp_BOpBitAnd: { _qoz_mv_76 = (lt);  break; } case qoz_BinaryOp_BOpBitOr: { _qoz_mv_76 = (lt);  break; } case qoz_BinaryOp_BOpBitXor: { _qoz_mv_76 = (lt);  break; } case qoz_BinaryOp_BOpShl: { _qoz_mv_76 = (lt);  break; } case qoz_BinaryOp_BOpShr: { _qoz_mv_76 = (lt);  break; } case qoz_BinaryOp_BOpRange: { _qoz_mv_76 = (lt);  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_76 = (lt);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_76;
}
...
qoz_Ty* qoz_check_synth_block(qoz_TyContext* tc, qoz_Env* env, qoz_Vec__qoz_Stmt stmts, qoz_Expr* tail) {
    ...
    { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_Stmt* _qoz_ms_77 = s; switch (_qoz_ms_77->tag) { case qoz_Stmt_SLet: { qoz_Span sp = _qoz_ms_77->payload.SLet.f0; qoz_string name = _qoz_ms_77->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_77->payload.SLet.f2; qoz_Expr* val = _qoz_ms_77->payload.SLet.f3; {
        qoz_Ty* vt = qoz_check_synth(tc, env, val); qoz_gc_push_root(&vt); qoz_TypeExpr* _qoz_ms_78 = te; qoz_Ty* _qoz_mv_78 = NULL; switch (_qoz_ms_78->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_78 = (vt);  break; } default: { _qoz_mv_78 = (qoz_check_resolve_type(tc, te));  break; } } qoz_Ty* bound = _qoz_mv_78; qoz_gc_push_root(&bound); qoz_check_check_binding_compat(tc, sp, te, bound, vt); qoz_check_env_define(env, name, bound); 
    }
    0;  break; } case qoz_Stmt_SVar: { qoz_Span sp = _qoz_ms_77->payload.SVar.f0; qoz_string name = _qoz_ms_77->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_77->payload.SVar.f2; qoz_Expr* val = _qoz_ms_77->payload.SVar.f3; {
        qoz_Ty* vt = qoz_check_synth(tc, env, val); qoz_gc_push_root(&vt); qoz_TypeExpr* _qoz_ms_79 = te; qoz_Ty* _qoz_mv_79 = NULL; switch (_qoz_ms_79->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_79 = (vt);  break; } default: { _qoz_mv_79 = (qoz_check_resolve_type(tc, te));  break; } } qoz_Ty* bound = _qoz_mv_79; qoz_gc_push_root(&bound); qoz_check_check_binding_compat(tc, sp, te, bound, vt); qoz_check_env_define(env, name, bound); 
    }
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* ex = _qoz_ms_77->payload.SExpr.f1; void* _qoz_bv_71;
    {
        (void)(qoz_check_synth(tc, env, ex)); _qoz_bv_71 = NULL;
    }
    _qoz_bv_71;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_check_synth(tc, env, tail);
}
...
qoz_Ty* qoz_check_synth_if(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* c, qoz_Expr* t, qoz_Expr* f) {
    ...
    qoz_gc_push_root(&t);
    qoz_gc_push_root(&f);
    (void)(qoz_check_synth(tc, env, c)); qoz_Ty* tt = qoz_check_synth(tc, env, t); qoz_gc_push_root(&tt); (void)(qoz_check_synth(tc, env, f)); qoz_gc_shadow_set_top(_qoz_shadow_guard); return tt;
}
...
qoz_Ty* qoz_check_synth_match(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_Ty* scrut_ty = qoz_check_synth(tc, env, scrut); qoz_gc_push_root(&scrut_ty); qoz_Ty* result = qoz_ty_ty_unit_(); qoz_gc_push_root(&result); bool first = true; { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; int64_t saved_len = (env->bindings.len); qoz_check_bind_pattern(tc, env, arm.pat, scrut_ty); qoz_Ty* armt = qoz_check_synth(tc, env, arm.body); qoz_gc_push_root(&armt); qoz_check_env_truncate(env, saved_len); if (first) { result = armt; first = false; } } }qoz_check_check_match_exhaustiveness(tc, scrut, scrut_ty, arms); qoz_gc_shadow_set_top(_qoz_shadow_guard); return result;
}
...
void qoz_check_check_match_exhaustiveness(qoz_TyContext* tc, qoz_Expr* scrut, qoz_Ty* scrut_ty, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_string enum_name = qoz_check_enum_name_of_ty(scrut_ty); if (qoz_string_eq(enum_name, QOZ_STR_LIT(""))) { return;} qoz_Option__qoz_Decl* _qoz_ms_80 = qoz_map_get__qoz_string__qoz_Decl(&tc->enums, enum_name); switch (_qoz_ms_80->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_80->payload.Some.f0; qoz_Decl* _qoz_ms_81 = decl; switch (_qoz_ms_81->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_VariantDecl variants = _qoz_ms_81->payload.DEnum.f3; {
        qoz_CoverSet vs = ((qoz_CoverSet){ .bound = qoz_map_make__qoz_string__bool() }); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_map_set__qoz_string__bool(&vs.bound, v.name, true); } }if (qoz_check_has_catch_all_with_variants(arms, &vs)) { return;} qoz_CoverSet cs = ((qoz_CoverSet){ .bound = qoz_map_make__qoz_string__bool() }); qoz_check_collect_covered_variants(arms, &cs); qoz_Vec__qoz_string missing = qoz_vec_make__qoz_string(); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (!qoz_map_contains__qoz_string__bool(&cs.bound, v.name)) { qoz_vec_push__qoz_string(&missing, v.name); } } }if ((missing.len) > 0) { qoz_string msg = QOZ_STR_LIT("non-exhaustive match: missing"); { qoz_Vec__qoz_string __col = missing; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string m = __col.data[__i]; (void)m; msg = qoz_string_cat(msg, QOZ_STR_LIT(" ")); msg = qoz_string_cat(msg, m); } }qoz_check_record_error(tc, qoz_check_scrut_span(scrut), msg); } 
    }
...
qoz_Span qoz_check_scrut_span(qoz_Expr* scrut) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&scrut);
    qoz_Expr* _qoz_ms_82 = scrut; qoz_Span _qoz_mv_82 = ((qoz_Span){0}); switch (_qoz_ms_82->tag) { case qoz_Expr_ENil: { qoz_Span sp = _qoz_ms_82->payload.ENil.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_82->payload.EInt.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_82->payload.EFloat.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_82->payload.EString.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_82->payload.EChar.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_82->payload.EBool.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_82->payload.EIdent.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_82->payload.EPath.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_82->payload.EReturn.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_82->payload.EDefer.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_82->payload.ESizeOf.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_82->payload.EArrayLit.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_82->payload.ETry.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_82->payload.ETuple.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_82->payload.EUnary.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_82->payload.EField.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_82->payload.EIndex.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_ECast: { qoz_Span sp = _qoz_ms_82->payload.ECast.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_82->payload.ERecord.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_82->payload.EBlock.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_82->payload.EWhile.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_82->payload.EMatch.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_82->payload.EBinary.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_82->payload.EAssign.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_82->payload.ECall.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_82->payload.EIf.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_82->payload.EClosure.f0; _qoz_mv_82 = (sp);  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_82->payload.EFor.f0; _qoz_mv_82 = (sp);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_82;
}

qoz_string qoz_check_enum_name_of_ty(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_83 = t; qoz_string _qoz_mv_83 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_83->tag) { case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_83->payload.TyAdt.f0; _qoz_mv_83 = (name);  break; } default: { _qoz_mv_83 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_83;
}

bool qoz_check_has_catch_all_with_variants(qoz_Vec__qoz_MatchArm arms, qoz_CoverSet* variants) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&variants);
    { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; if (!arm.has_guard) { qoz_Pattern* _qoz_ms_84 = arm.pat; switch (_qoz_ms_84->tag) { case qoz_Pattern_PatWild: { return true; break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_84->payload.PatBind.f1; if (!qoz_map_contains__qoz_string__bool(&variants->bound, name)) { return true;} 0;  break; } default: { NULL;  break; } } 0; } } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return false;
}

void qoz_check_collect_covered_variants(qoz_Vec__qoz_MatchArm arms, qoz_CoverSet* cs) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&cs);
    { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; if (!arm.has_guard) { qoz_Pattern* _qoz_ms_85 = arm.pat; switch (_qoz_ms_85->tag) { case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_85->payload.PatVariant.f1; if ((path.len) > 0) { qoz_string last = path.data[(path.len) - 1]; qoz_map_set__qoz_string__bool(&cs->bound, last, true); } 0;  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_85->payload.PatBind.f1; (qoz_map_set__qoz_string__bool(&cs->bound, name, true), 0);  break; } default: { NULL;  break; } } 0; } } }
    return;
}
...
void qoz_check_bind_for_loop(qoz_Env* env, qoz_string b1, qoz_string b2, qoz_Ty* it_ty) {
    ...
    if (qoz_string_eq(b2, QOZ_STR_LIT(""))) { qoz_Ty* _qoz_ms_86 = it_ty; switch (_qoz_ms_86->tag) { case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_86->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_86->payload.TyRecord.f1; if (qoz_string_eq(name, QOZ_STR_LIT("Vec")) && ((args.len) >= 1)) { qoz_check_env_define(env, b1, args.data[0]); return;} 0;  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_86->payload.TyPtr.f0; {
        qoz_check_env_define(env, b1, inner); return;
    }
    0;  break; } default: { NULL;  break; } } 0; qoz_check_env_define(env, b1, qoz_ty_ty_int_(64, true)); }  else { qoz_Ty* _qoz_ms_87 = it_ty; switch (_qoz_ms_87->tag) { case qoz_Ty_TyRecord: { qoz_Vec__qoz_Ty args = _qoz_ms_87->payload.TyRecord.f1; if ((args.len) == 2) { qoz_check_env_define(env, b1, args.data[0]); qoz_check_env_define(env, b2, args.data[1]); return;} 0;  break; } default: { NULL;  break; } } 0; qoz_check_env_define(env, b1, qoz_ty_ty_int_(64, true)); qoz_check_env_define(env, b2, qoz_ty_ty_int_(64, true)); } 
    return;
}
...
void qoz_check_bind_pattern(qoz_TyContext* tc, qoz_Env* env, qoz_Pattern* pat, qoz_Ty* scrut) {
    ...
    qoz_gc_push_root(&scrut);
    qoz_Pattern* _qoz_ms_88 = pat; switch (_qoz_ms_88->tag) { case qoz_Pattern_PatWild: { NULL;  break; } case qoz_Pattern_PatLitInt: { NULL;  break; } case qoz_Pattern_PatLitString: { NULL;  break; } case qoz_Pattern_PatLitBool: { NULL;  break; } case qoz_Pattern_PatTuple: { NULL;  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_88->payload.PatBind.f1; qoz_check_env_define(env, name, scrut);  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_88->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_88->payload.PatVariant.f2; qoz_check_bind_variant_pattern(tc, env, path, sub_pats, scrut);  break; } } 0; 
    return;
}
...
qoz_Decl* qoz_check_infer_calls_decl(qoz_TyContext* tc, qoz_Decl* d) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_93 = d; qoz_Decl* _qoz_mv_93 = NULL; switch (_qoz_ms_93->tag) { case qoz_Decl_DFn: { qoz_Span sp = _qoz_ms_93->payload.DFn.f0; qoz_string name = _qoz_ms_93->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_93->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_93->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_93->payload.DFn.f4; qoz_Expr* body = _qoz_ms_93->payload.DFn.f5; qoz_string attr = _qoz_ms_93->payload.DFn.f6; qoz_Decl* _qoz_bv_72;
    {
        qoz_check_set_type_params(tc, tparams); qoz_Env env = qoz_check_env_make(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_check_env_define(&env, pp.name, qoz_check_resolve_type(tc, pp.ty)); } }qoz_Ty* ret_ty = qoz_check_resolve_type(tc, ret); qoz_gc_push_root(&ret_ty); qoz_Expr* new_body = qoz_check_infer_calls_expr(tc, &env, body, ret_ty); qoz_gc_push_root(&new_body); qoz_check_clear_type_params(tc); _qoz_bv_72 = qoz_make_Decl_DFn(sp, name, tparams, params, ret, new_body, attr);
    }
    _qoz_mv_93 = (_qoz_bv_72);  break; } case qoz_Decl_DConst: { qoz_Span sp = _qoz_ms_93->payload.DConst.f0; qoz_string name = _qoz_ms_93->payload.DConst.f1; qoz_TypeExpr* t = _qoz_ms_93->payload.DConst.f2; qoz_Expr* val = _qoz_ms_93->payload.DConst.f3; qoz_Decl* _qoz_bv_73;
    {
        qoz_Env env = qoz_check_env_make(); qoz_Ty* expected = qoz_check_resolve_type(tc, t); qoz_gc_push_root(&expected); qoz_Expr* new_val = qoz_check_infer_calls_expr(tc, &env, val, expected); qoz_gc_push_root(&new_val); _qoz_bv_73 = qoz_make_Decl_DConst(sp, name, t, new_val);
    }
    _qoz_mv_93 = (_qoz_bv_73);  break; } default: { _qoz_mv_93 = (d);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_93;
}
...
qoz_Expr* qoz_check_infer_calls_expr(qoz_TyContext* tc, qoz_Env* env, qoz_Expr* e, qoz_Ty* expected) {
    ...
    qoz_Expr* _qoz_ms_94 = e; qoz_Expr* _qoz_mv_94 = NULL; switch (_qoz_ms_94->tag) { case qoz_Expr_EInt: { _qoz_mv_94 = (e);  break; } case qoz_Expr_EFloat: { _qoz_mv_94 = (e);  break; } case qoz_Expr_EString: { _qoz_mv_94 = (e);  break; } case qoz_Expr_EChar: { _qoz_mv_94 = (e);  break; } case qoz_Expr_EBool: { _qoz_mv_94 = (e);  break; } case qoz_Expr_ENil: { _qoz_mv_94 = (e);  break; } case qoz_Expr_EIdent: { _qoz_mv_94 = (e);  break; } case qoz_Expr_EPath: { _qoz_mv_94 = (e);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_94->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_94->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_94->payload.EUnary.f2; _qoz_mv_94 = (qoz_make_Expr_EUnary(sp, op, qoz_check_infer_calls_expr(tc, env, rhs, qoz_ty_ty_error_())));  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_94->payload.EBinary.f0; qoz_BinaryOp* op = _qoz_ms_94->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_94->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_94->payload.EBinary.f3; _qoz_mv_94 = (qoz_make_Expr_EBinary(sp, op, qoz_check_infer_calls_expr(tc, env, l, qoz_ty_ty_error_()), qoz_check_infer_calls_expr(tc, env, r, qoz_ty_ty_error_())));  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_94->payload.EAssign.f0; qoz_AssignOp* op = _qoz_ms_94->payload.EAssign.f1; qoz_Expr* l = _qoz_ms_94->payload.EAssign.f2; qoz_Expr* r = _qoz_ms_94->payload.EAssign.f3; qoz_Expr* _qoz_bv_74;
    {
        qoz_Expr* new_l = qoz_check_infer_calls_expr(tc, env, l, qoz_ty_ty_error_()); qoz_gc_push_root(&new_l); qoz_Ty* lhs_ty = qoz_check_synth(tc, env, l); qoz_gc_push_root(&lhs_ty); _qoz_bv_74 = qoz_make_Expr_EAssign(sp, op, new_l, qoz_check_infer_calls_expr(tc, env, r, lhs_ty));
    }
    _qoz_mv_94 = (_qoz_bv_74);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_94->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_94->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_94->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_94->payload.ECall.f3; _qoz_mv_94 = (qoz_check_rewrite_call(tc, env, sp, callee, ta, args, expected));  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_94->payload.EField.f0; qoz_Expr* base = _qoz_ms_94->payload.EField.f1; qoz_string name = _qoz_ms_94->payload.EField.f2; _qoz_mv_94 = (qoz_make_Expr_EField(sp, qoz_check_infer_calls_expr(tc, env, base, qoz_ty_ty_error_()), name));  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_94->payload.EIndex.f0; qoz_Expr* base = _qoz_ms_94->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_94->payload.EIndex.f2; _qoz_mv_94 = (qoz_make_Expr_EIndex(sp, qoz_check_infer_calls_expr(tc, env, base, qoz_ty_ty_error_()), qoz_check_infer_calls_expr(tc, env, idx, qoz_ty_ty_error_())));  break; } case qoz_Expr_ECast: { qoz_Span sp = _qoz_ms_94->payload.ECast.f0; qoz_Expr* value = _qoz_ms_94->payload.ECast.f1; qoz_TypeExpr* t = _qoz_ms_94->payload.ECast.f2; _qoz_mv_94 = (qoz_make_Expr_ECast(sp, qoz_check_infer_calls_expr(tc, env, value, qoz_ty_ty_error_()), t));  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_94->payload.ETry.f0; qoz_Expr* v = _qoz_ms_94->payload.ETry.f1; _qoz_mv_94 = (qoz_make_Expr_ETry(sp, qoz_check_infer_calls_expr(tc, env, v, expected)));  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_94->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_94->payload.ETuple.f1; qoz_Expr* _qoz_bv_75;
    {
        qoz_Vec__qoz_Expr ne = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&ne, qoz_check_infer_calls_expr(tc, env, el, qoz_ty_ty_error_())); } }_qoz_bv_75 = qoz_make_Expr_ETuple(sp, ne);
    }
    _qoz_mv_94 = (_qoz_bv_75);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_94->payload.ERecord.f0; qoz_TypeExpr* te = _qoz_ms_94->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_94->payload.ERecord.f2; qoz_Expr* _qoz_bv_76;
    {
        qoz_TypeExpr* effective_te = qoz_check_pick_record_type(te, expected); qoz_gc_push_root(&effective_te); qoz_Vec__qoz_RecordFieldLit nf = qoz_vec_make__qoz_RecordFieldLit(); { qoz_Vec__qoz_RecordFieldLit __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; qoz_Ty* field_hint = qoz_check_record_field_hint(tc, effective_te, f.name); qoz_gc_push_root(&field_hint); qoz_vec_push__qoz_RecordFieldLit(&nf, ((qoz_RecordFieldLit){ .name = f.name, .value = qoz_check_infer_calls_expr(tc, env, f.value, field_hint) })); } }qoz_TypeExpr* inferred_te = qoz_check_inferred_record_te(tc, env, sp, effective_te, nf); qoz_gc_push_root(&inferred_te); _qoz_bv_76 = qoz_make_Expr_ERecord(sp, inferred_te, nf);
    }
    _qoz_mv_94 = (_qoz_bv_76);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_94->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_94->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_94->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_94->payload.EClosure.f3; _qoz_mv_94 = (qoz_make_Expr_EClosure(sp, cps, ret, qoz_check_infer_calls_expr(tc, env, body, qoz_ty_ty_error_())));  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_94->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_94->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_94->payload.EBlock.f2; qoz_Expr* _qoz_bv_77;
    {
        qoz_Vec__qoz_Stmt ns = qoz_vec_make__qoz_Stmt(); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_vec_push__qoz_Stmt(&ns, qoz_check_infer_calls_stmt(tc, env, s)); } }_qoz_bv_77 = qoz_make_Expr_EBlock(sp, ns, qoz_check_infer_calls_expr(tc, env, tail, expected));
    }
    _qoz_mv_94 = (_qoz_bv_77);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_94->payload.EIf.f0; qoz_Expr* c = _qoz_ms_94->payload.EIf.f1; qoz_Expr* t = _qoz_ms_94->payload.EIf.f2; qoz_Expr* f = _qoz_ms_94->payload.EIf.f3; _qoz_mv_94 = (qoz_make_Expr_EIf(sp, qoz_check_infer_calls_expr(tc, env, c, qoz_ty_ty_error_()), qoz_check_infer_calls_expr(tc, env, t, expected), qoz_check_infer_calls_expr(tc, env, f, expected)));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_94->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_94->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_94->payload.EMatch.f2; qoz_Expr* _qoz_bv_78;
    {
        qoz_Expr* new_scrut = qoz_check_infer_calls_expr(tc, env, scrut, qoz_ty_ty_error_()); qoz_gc_push_root(&new_scrut); qoz_Ty* scrut_ty = qoz_check_synth(tc, env, scrut); qoz_gc_push_root(&scrut_ty); qoz_Vec__qoz_MatchArm na = qoz_vec_make__qoz_MatchArm(); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm a = __col.data[__i]; (void)a; int64_t saved_len = (env->bindings.len); qoz_check_bind_pattern(tc, env, a.pat, scrut_ty); qoz_vec_push__qoz_MatchArm(&na, ((qoz_MatchArm){ .pat = a.pat, .body = qoz_check_infer_calls_expr(tc, env, a.body, expected), .has_guard = a.has_guard, .guard = a.guard })); qoz_check_env_truncate(env, saved_len); } }_qoz_bv_78 = qoz_make_Expr_EMatch(sp, new_scrut, na);
    }
    _qoz_mv_94 = (_qoz_bv_78);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_94->payload.EWhile.f0; qoz_Expr* c = _qoz_ms_94->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_94->payload.EWhile.f2; _qoz_mv_94 = (qoz_make_Expr_EWhile(sp, qoz_check_infer_calls_expr(tc, env, c, qoz_ty_ty_error_()), qoz_check_infer_calls_expr(tc, env, b, qoz_ty_ty_error_())));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_94->payload.EFor.f0; qoz_string b1 = _qoz_ms_94->payload.EFor.f1; qoz_string b2 = _qoz_ms_94->payload.EFor.f2; qoz_Expr* it = _qoz_ms_94->payload.EFor.f3; qoz_Expr* body = _qoz_ms_94->payload.EFor.f4; qoz_Expr* _qoz_bv_79;
    {
        qoz_Expr* new_it = qoz_check_infer_calls_expr(tc, env, it, qoz_ty_ty_error_()); qoz_gc_push_root(&new_it); qoz_Ty* it_ty = qoz_check_synth(tc, env, it); qoz_gc_push_root(&it_ty); int64_t saved_len = (env->bindings.len); qoz_check_bind_for_loop(env, b1, b2, it_ty); qoz_Expr* new_body = qoz_check_infer_calls_expr(tc, env, body, qoz_ty_ty_error_()); qoz_gc_push_root(&new_body); qoz_check_env_truncate(env, saved_len); _qoz_bv_79 = qoz_make_Expr_EFor(sp, b1, b2, new_it, new_body);
    }
    _qoz_mv_94 = (_qoz_bv_79);  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_94->payload.EReturn.f0; qoz_Expr* v = _qoz_ms_94->payload.EReturn.f1; _qoz_mv_94 = (qoz_make_Expr_EReturn(sp, qoz_check_infer_calls_expr(tc, env, v, expected)));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_94->payload.EDefer.f0; qoz_Expr* v = _qoz_ms_94->payload.EDefer.f1; _qoz_mv_94 = (qoz_make_Expr_EDefer(sp, qoz_check_infer_calls_expr(tc, env, v, qoz_ty_ty_error_())));  break; } case qoz_Expr_ESizeOf: { _qoz_mv_94 = (e);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_94->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_94->payload.EArrayLit.f1; qoz_Expr* _qoz_bv_80;
    {
        qoz_Vec__qoz_Expr ne = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&ne, qoz_check_infer_calls_expr(tc, env, el, qoz_ty_ty_error_())); } }_qoz_bv_80 = qoz_make_Expr_EArrayLit(sp, ne);
    }
    _qoz_mv_94 = (_qoz_bv_80);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_94;
}
...
qoz_Stmt* qoz_check_infer_calls_stmt(qoz_TyContext* tc, qoz_Env* env, qoz_Stmt* s) {
    ...
    qoz_gc_push_root(&env);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_95 = s; qoz_Stmt* _qoz_mv_95 = NULL; switch (_qoz_ms_95->tag) { case qoz_Stmt_SLet: { qoz_Span sp = _qoz_ms_95->payload.SLet.f0; qoz_string name = _qoz_ms_95->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_95->payload.SLet.f2; qoz_Expr* val = _qoz_ms_95->payload.SLet.f3; qoz_Stmt* _qoz_bv_81;
    {
        qoz_Ty* annotated = qoz_check_resolve_type(tc, te); qoz_gc_push_root(&annotated); qoz_Expr* new_val = qoz_check_infer_calls_expr(tc, env, val, annotated); qoz_gc_push_root(&new_val); qoz_Ty* binding_ty = ((qoz_check_is_ty_unit_or_error(annotated)) ? qoz_check_synth(tc, env, new_val) : annotated); qoz_gc_push_root(&binding_ty); qoz_check_env_define(env, name, binding_ty); _qoz_bv_81 = qoz_make_Stmt_SLet(sp, name, te, new_val);
    }
    _qoz_mv_95 = (_qoz_bv_81);  break; } case qoz_Stmt_SVar: { qoz_Span sp = _qoz_ms_95->payload.SVar.f0; qoz_string name = _qoz_ms_95->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_95->payload.SVar.f2; qoz_Expr* val = _qoz_ms_95->payload.SVar.f3; qoz_Stmt* _qoz_bv_82;
    {
        qoz_Ty* annotated = qoz_check_resolve_type(tc, te); qoz_gc_push_root(&annotated); qoz_Expr* new_val = qoz_check_infer_calls_expr(tc, env, val, annotated); qoz_gc_push_root(&new_val); qoz_Ty* binding_ty = ((qoz_check_is_ty_unit_or_error(annotated)) ? qoz_check_synth(tc, env, new_val) : annotated); qoz_gc_push_root(&binding_ty); qoz_check_env_define(env, name, binding_ty); _qoz_bv_82 = qoz_make_Stmt_SVar(sp, name, te, new_val);
    }
    _qoz_mv_95 = (_qoz_bv_82);  break; } case qoz_Stmt_SExpr: { qoz_Span sp = _qoz_ms_95->payload.SExpr.f0; qoz_Expr* x = _qoz_ms_95->payload.SExpr.f1; _qoz_mv_95 = (qoz_make_Stmt_SExpr(sp, qoz_check_infer_calls_expr(tc, env, x, qoz_ty_ty_error_())));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_95;
}
...
qoz_TypeExpr* qoz_check_pick_record_type(qoz_TypeExpr* te, qoz_Ty* expected) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&expected);
    qoz_TypeExpr* _qoz_ms_96 = te; qoz_TypeExpr* _qoz_mv_96 = NULL; switch (_qoz_ms_96->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_96->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_96->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_96->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_83;
    {
        if ((args.len) > 0) { return te;} if ((path.len) != 1) { return te;} qoz_Ty* _qoz_ms_97 = expected; qoz_TypeExpr* _qoz_mv_97 = NULL; switch (_qoz_ms_97->tag) { case qoz_Ty_TyRecord: { qoz_string en = _qoz_ms_97->payload.TyRecord.f0; qoz_Vec__qoz_Ty eargs = _qoz_ms_97->payload.TyRecord.f1; qoz_TypeExpr* _qoz_bv_84;
    {
        if (qoz_string_eq(path.data[0], en) && ((eargs.len) > 0)) { qoz_Vec__qoz_TypeExpr ta = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = eargs; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_TypeExpr(&ta, qoz_ty_ty_to_type_expr_at(a, sp)); } }return qoz_make_TypeExpr_TENamed(sp, path, ta);} _qoz_bv_84 = te;
    }
    _qoz_mv_97 = (_qoz_bv_84);  break; } default: { _qoz_mv_97 = (te);  break; } } _qoz_bv_83 = _qoz_mv_97;
    }
    _qoz_mv_96 = (_qoz_bv_83);  break; } default: { _qoz_mv_96 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_96;
}
...
qoz_Ty* qoz_check_record_field_hint(qoz_TyContext* tc, qoz_TypeExpr* te, qoz_string field_name) {
    ...
    qoz_gc_push_root(&tc);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_98 = te; qoz_Ty* _qoz_mv_98 = NULL; switch (_qoz_ms_98->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_98->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_98->payload.TENamed.f2; qoz_Ty* _qoz_bv_85;
    {
        if ((path.len) < 1) { return qoz_ty_ty_error_();} qoz_string name = path.data[(path.len) - 1]; qoz_Option__qoz_Decl* _qoz_ms_99 = qoz_map_get__qoz_string__qoz_Decl(&tc->structs, name); qoz_Ty* _qoz_mv_99 = NULL; switch (_qoz_ms_99->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_99 = (qoz_ty_ty_error_());  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_99->payload.Some.f0; qoz_Decl* _qoz_ms_100 = d; qoz_Ty* _qoz_mv_100 = NULL; switch (_qoz_ms_100->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_100->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_100->payload.DStruct.f3; qoz_Ty* _qoz_bv_86;
    {
        qoz_Map__qoz_string__bool saved = tc->type_params; qoz_check_set_type_params(tc, params); qoz_Vec__qoz_Ty arg_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_TypeExpr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_Ty(&arg_tys, qoz_check_resolve_type(tc, a)); } }qoz_Ty* result = qoz_ty_ty_error_(); qoz_gc_push_root(&result); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_string_eq(f.name, field_name)) { qoz_Ty* raw = qoz_check_resolve_type(tc, f.ty); qoz_gc_push_root(&raw); result = ((((arg_tys.len) == (params.len)) && ((params.len) > 0)) ? qoz_check_apply_subst(raw, params, arg_tys) : raw); } } }tc->type_params = saved; _qoz_bv_86 = result;
    }
    _qoz_mv_100 = (_qoz_bv_86);  break; } default: { _qoz_mv_100 = (qoz_ty_ty_error_());  break; } } _qoz_mv_99 = (_qoz_mv_100);  break; } } _qoz_bv_85 = _qoz_mv_99;
    }
    _qoz_mv_98 = (_qoz_bv_85);  break; } default: { _qoz_mv_98 = (qoz_ty_ty_error_());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_98;
}
...
void qoz_check_collect_arg_hints(qoz_TyContext* tc, qoz_Expr* callee, int64_t n, qoz_Vec__qoz_Ty* out) {
    ...
    qoz_string name = qoz_check_resolve_callee_fn(tc, callee); if (!qoz_string_eq(name, QOZ_STR_LIT(""))) { qoz_Option__qoz_Decl* _qoz_ms_101 = qoz_map_get__qoz_string__qoz_Decl(&tc->fns, name); switch (_qoz_ms_101->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_101->payload.Some.f0; {
        qoz_check_fill_fn_param_hints(tc, d, out); return;
    }
    0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; qoz_Option__qoz_Decl* _qoz_ms_102 = qoz_map_get__qoz_string__qoz_Decl(&tc->externs, name); switch (_qoz_ms_102->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_102->payload.Some.f0; {
        qoz_check_fill_fn_param_hints(tc, d, out); return;
    }
    0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } qoz_Expr* _qoz_ms_103 = callee; switch (_qoz_ms_103->tag) { case qoz_Expr_EIdent: { qoz_string vname = _qoz_ms_103->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_104 = qoz_map_get__qoz_string__qoz_string(&tc->variant_of, vname); switch (_qoz_ms_104->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_104->payload.Some.f0; qoz_Option__qoz_Decl* _qoz_ms_105 = qoz_map_get__qoz_string__qoz_Decl(&tc->enums, enum_name); switch (_qoz_ms_105->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_105->payload.Some.f0; qoz_Decl* _qoz_ms_106 = d; switch (_qoz_ms_106->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_106->payload.DEnum.f2; if ((tparams.len) == 0) { qoz_check_fill_variant_pos_hints(tc, d, vname, out); } 0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
void qoz_check_fill_fn_param_hints(qoz_TyContext* tc, qoz_Decl* d, qoz_Vec__qoz_Ty* out) {
    ...
    qoz_gc_push_root(&d);
    qoz_gc_push_root(&out);
    qoz_Decl* _qoz_ms_107 = d; switch (_qoz_ms_107->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_107->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_107->payload.DFn.f3; {
    ...
    0;  break; } case qoz_Decl_DExternal: { qoz_Vec__qoz_FnParam params = _qoz_ms_107->payload.DExternal.f3; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_vec_push__qoz_Ty(out, qoz_check_resolve_type(tc, pp.ty)); } }0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
void qoz_check_fill_variant_pos_hints(qoz_TyContext* tc, qoz_Decl* d, qoz_string variant_name, qoz_Vec__qoz_Ty* out) {
    ...
    qoz_gc_push_root(&d);
    qoz_gc_push_root(&out);
    qoz_Decl* _qoz_ms_108 = d; switch (_qoz_ms_108->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_108->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_108->payload.DEnum.f3; {
...
bool qoz_check_is_ty_unit_or_error(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_109 = t; bool _qoz_mv_109 = false; switch (_qoz_ms_109->tag) { case qoz_Ty_TyUnit: { _qoz_mv_109 = (true);  break; } case qoz_Ty_TyError: { _qoz_mv_109 = (true);  break; } default: { _qoz_mv_109 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_109;
}
...
qoz_Expr* qoz_check_rewrite_call(qoz_TyContext* tc, qoz_Env* env, qoz_Span sp, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_Ty* expected) {
    ...
    qoz_gc_push_root(&callee);
    qoz_gc_push_root(&expected);
    if (qoz_check_is_strings_callee(callee, QOZ_STR_LIT("sb_append")) && ((args.len) == 2)) { qoz_Ty* val_ty = qoz_check_synth(tc, env, args.data[1]); qoz_gc_push_root(&val_ty); qoz_string method = qoz_check_sb_append_method_for(val_ty); if (!qoz_string_eq(method, QOZ_STR_LIT("sb_append"))) { qoz_Expr* new_callee2 = qoz_make_Expr_EField(sp, qoz_make_Expr_EIdent(sp, QOZ_STR_LIT("strings")), method); qoz_gc_push_root(&new_callee2); qoz_Vec__qoz_Expr new_args = qoz_vec_make__qoz_Expr(); qoz_vec_push__qoz_Expr(&new_args, qoz_check_infer_calls_expr(tc, env, args.data[0], qoz_ty_ty_error_())); qoz_vec_push__qoz_Expr(&new_args, qoz_check_infer_calls_expr(tc, env, args.data[1], val_ty)); return qoz_make_Expr_ECall(sp, new_callee2, type_args, new_args);} } qoz_Expr* new_callee = qoz_check_infer_calls_expr(tc, env, callee, qoz_ty_ty_error_()); qoz_gc_push_root(&new_callee); qoz_Vec__qoz_Expr new_args = qoz_vec_make__qoz_Expr(); qoz_Vec__qoz_Ty arg_hints = qoz_vec_make__qoz_Ty(); qoz_check_collect_arg_hints(tc, callee, (args.len), &arg_hints); int64_t ai = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; qoz_Ty* hint = ((ai < (arg_hints.len)) ? arg_hints.data[ai] : qoz_ty_ty_error_()); qoz_gc_push_root(&hint); qoz_vec_push__qoz_Expr(&new_args, qoz_check_infer_calls_expr(tc, env, a, hint)); ai = ai + 1; } }if ((type_args.len) > 0) { return qoz_make_Expr_ECall(sp, new_callee, type_args, new_args);} qoz_string fn_name = qoz_check_resolve_callee_fn(tc, callee); if (qoz_string_eq(fn_name, QOZ_STR_LIT(""))) { return qoz_make_Expr_ECall(sp, new_callee, type_args, new_args);} qoz_Option__qoz_Decl* _qoz_ms_110 = qoz_map_get__qoz_string__qoz_Decl(&tc->fns, fn_name); qoz_Expr* _qoz_mv_110 = NULL; switch (_qoz_ms_110->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_110->payload.Some.f0; qoz_Decl* _qoz_ms_111 = d; qoz_Expr* _qoz_mv_111 = NULL; switch (_qoz_ms_111->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_111->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_111->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_111->payload.DFn.f4; qoz_Expr* _qoz_bv_87;
    {
        if ((tparams.len) == 0) { return qoz_make_Expr_ECall(sp, new_callee, type_args, new_args);} qoz_Vec__qoz_Ty arg_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_Ty(&arg_tys, qoz_check_synth(tc, env, a)); } }qoz_Map__qoz_string__bool saved_c = tc->type_params; qoz_check_set_type_params(tc, tparams); qoz_Vec__qoz_Ty param_tys = qoz_vec_make__qoz_Ty(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_vec_push__qoz_Ty(&param_tys, qoz_check_resolve_type(tc, pp.ty)); } }qoz_Ty* ret_pattern = qoz_check_resolve_type(tc, ret); qoz_gc_push_root(&ret_pattern); tc->type_params = saved_c; qoz_Map__qoz_string__qoz_Ty subst_env = qoz_map_make__qoz_string__qoz_Ty(); int64_t i = 0; bool ok = true; while ((i < (arg_tys.len)) && (i < (param_tys.len))) { if (!qoz_check_unify(param_tys.data[i], arg_tys.data[i], &subst_env)) { ok = false; } i = i + 1; } if (!qoz_check_is_ty_error(expected)) { (void)(qoz_check_unify(ret_pattern, expected, &subst_env)); } if (!ok) { qoz_string _qoz_bv_88;
    {
        qoz_Strbuf _qoz_sb_1490_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1490_38); qoz_strings_sb_append(&_qoz_sb_1490_38, QOZ_STR_LIT("could not unify argument types with generic parameters of `")); qoz_strings_sb_append(&_qoz_sb_1490_38, fn_name); qoz_strings_sb_append(&_qoz_sb_1490_38, QOZ_STR_LIT("`")); _qoz_bv_88 = qoz_strings_sb_finish(&_qoz_sb_1490_38);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_88); return qoz_make_Expr_ECall(sp, new_callee, type_args, new_args);} qoz_Vec__qoz_TypeExpr inferred = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_string __col = tparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string tp = __col.data[__i]; (void)tp; qoz_Option__qoz_Ty* _qoz_ms_112 = qoz_map_get__qoz_string__qoz_Ty(&subst_env, tp); switch (_qoz_ms_112->tag) { case qoz_Option__qoz_Ty_Some: { qoz_Ty* t = _qoz_ms_112->payload.Some.f0; qoz_vec_push__qoz_TypeExpr(&inferred, qoz_ty_ty_to_type_expr_at(t, sp));  break; } case qoz_Option__qoz_Ty_None: { {
        qoz_string _qoz_bv_89;
    {
        qoz_Strbuf _qoz_sb_1498_42 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1498_42); qoz_strings_sb_append(&_qoz_sb_1498_42, QOZ_STR_LIT("type parameter `")); qoz_strings_sb_append(&_qoz_sb_1498_42, tp); qoz_strings_sb_append(&_qoz_sb_1498_42, QOZ_STR_LIT("` of `")); qoz_strings_sb_append(&_qoz_sb_1498_42, fn_name); qoz_strings_sb_append(&_qoz_sb_1498_42, QOZ_STR_LIT("` is not constrained; add an explicit annotation")); _qoz_bv_89 = qoz_strings_sb_finish(&_qoz_sb_1498_42);
    }
    qoz_check_record_error(tc, sp, _qoz_bv_89); qoz_vec_push__qoz_TypeExpr(&inferred, qoz_ty_ty_to_type_expr_at(qoz_ty_ty_error_(), sp)); 
    }
    0;  break; } } 0; } }_qoz_bv_87 = qoz_make_Expr_ECall(sp, new_callee, inferred, new_args);
    }
    _qoz_mv_111 = (_qoz_bv_87);  break; } default: { _qoz_mv_111 = (qoz_make_Expr_ECall(sp, new_callee, type_args, new_args));  break; } } _qoz_mv_110 = (_qoz_mv_111);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_110 = (qoz_make_Expr_ECall(sp, new_callee, type_args, new_args));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_110;
}

void qoz_check_check_fn_bodies(qoz_TyContext* tc, qoz_File f) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_113 = d; switch (_qoz_ms_113->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_113->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_113->payload.DFn.f3; qoz_Expr* body = _qoz_ms_113->payload.DFn.f5; {
        qoz_check_set_type_params(tc, tparams); qoz_Env env = qoz_check_env_make(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_check_env_define(&env, pp.name, qoz_check_resolve_type(tc, pp.ty)); } }(void)(qoz_check_synth(tc, &env, body)); qoz_check_clear_type_params(tc); 
    }
    0;  break; } case qoz_Decl_DImport: { NULL;  break; } case qoz_Decl_DStruct: { NULL;  break; } case qoz_Decl_DEnum: { NULL;  break; } case qoz_Decl_DTypeAlias: { NULL;  break; } case qoz_Decl_DConst: { qoz_Expr* val = _qoz_ms_113->payload.DConst.f3; void* _qoz_bv_90;
    {
        qoz_Env env = qoz_check_env_make(); (void)(qoz_check_synth(tc, &env, val)); _qoz_bv_90 = NULL;
    }
    _qoz_bv_90;  break; } case qoz_Decl_DExternal: { NULL;  break; } case qoz_Decl_DLink: { NULL;  break; } } 0; } }
    return;
}
...
void qoz_check_validate_signatures(qoz_TyContext* tc, qoz_File f) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&tc);
    { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_114 = d; switch (_qoz_ms_114->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_114->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_114->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_114->payload.DFn.f4; {
    ...
    0;  break; } case qoz_Decl_DExternal: { qoz_Vec__qoz_FnParam params = _qoz_ms_114->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_114->payload.DExternal.f4; void* _qoz_bv_91;
    {
        { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; (void)(qoz_check_resolve_type(tc, pp.ty)); } }(void)(qoz_check_resolve_type(tc, ret)); _qoz_bv_91 = NULL;
    }
    _qoz_bv_91;  break; } case qoz_Decl_DStruct: { qoz_Vec__qoz_string tparams = _qoz_ms_114->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_114->payload.DStruct.f3; {
    ...
    0;  break; } case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_114->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_114->payload.DEnum.f3; {
    ...
    0;  break; } case qoz_Decl_DTypeAlias: { qoz_Vec__qoz_string tparams = _qoz_ms_114->payload.DTypeAlias.f2; qoz_TypeExpr* target = _qoz_ms_114->payload.DTypeAlias.f3; {
        qoz_check_set_type_params(tc, tparams); (void)(qoz_check_resolve_type(tc, target)); qoz_check_clear_type_params(tc); 
    }
    0;  break; } case qoz_Decl_DConst: { qoz_TypeExpr* ty = _qoz_ms_114->payload.DConst.f2; void* _qoz_bv_92;
    {
        (void)(qoz_check_resolve_type(tc, ty)); _qoz_bv_92 = NULL;
    }
    _qoz_bv_92;  break; } case qoz_Decl_DImport: { NULL;  break; } case qoz_Decl_DLink: { NULL;  break; } } 0; } }
    return;
}
...
void qoz_emit_register_generics(qoz_Emitter* e, qoz_File file) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    { qoz_Vec__qoz_Decl __col = file.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_115 = d; switch (_qoz_ms_115->tag) { case qoz_Decl_DStruct: { qoz_string name = _qoz_ms_115->payload.DStruct.f1; qoz_Vec__qoz_string params = _qoz_ms_115->payload.DStruct.f2; if ((params.len) > 0) { qoz_map_set__qoz_string__qoz_Decl(&e->generic_decls, name, d); } 0;  break; } case qoz_Decl_DEnum: { qoz_string name = _qoz_ms_115->payload.DEnum.f1; qoz_Vec__qoz_string params = _qoz_ms_115->payload.DEnum.f2; if ((params.len) > 0) { qoz_map_set__qoz_string__qoz_Decl(&e->generic_decls, name, d); } 0;  break; } case qoz_Decl_DFn: { qoz_string name = _qoz_ms_115->payload.DFn.f1; qoz_Vec__qoz_string params = _qoz_ms_115->payload.DFn.f2; if ((params.len) > 0) { qoz_map_set__qoz_string__qoz_Decl(&e->generic_fn_decls, name, d); } 0;  break; } default: { NULL;  break; } } 0; } }
    return;
}
...
qoz_string qoz_emit_variant_callee_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_116 = callee; qoz_string _qoz_mv_116 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_116->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_116->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_117 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_117 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_117->tag) { case qoz_Option__qoz_string_Some: { _qoz_mv_117 = (name);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_117 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_116 = (_qoz_mv_117);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_116->payload.EField.f1; qoz_string method = _qoz_ms_116->payload.EField.f2; qoz_Expr* _qoz_ms_118 = base; qoz_string _qoz_mv_118 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_118->tag) { case qoz_Expr_EIdent: { qoz_string enum_name = _qoz_ms_118->payload.EIdent.f1; qoz_string _qoz_bv_93;
    {
        if (!qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, enum_name)) { return QOZ_STR_LIT("");} qoz_Option__qoz_string* _qoz_ms_119 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, method); qoz_string _qoz_mv_119 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_119->tag) { case qoz_Option__qoz_string_Some: { _qoz_mv_119 = (method);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_119 = (QOZ_STR_LIT(""));  break; } } _qoz_bv_93 = _qoz_mv_119;
    }
    _qoz_mv_118 = (_qoz_bv_93);  break; } default: { _qoz_mv_118 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_116 = (_qoz_mv_118);  break; } case qoz_Expr_EPath: { qoz_Vec__qoz_string segs = _qoz_ms_116->payload.EPath.f1; qoz_string _qoz_bv_94;
    {
        if ((segs.len) != 2) { return QOZ_STR_LIT("");} if (!qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, segs.data[0])) { return QOZ_STR_LIT("");} qoz_Option__qoz_string* _qoz_ms_120 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, segs.data[1]); qoz_string _qoz_mv_120 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_120->tag) { case qoz_Option__qoz_string_Some: { _qoz_mv_120 = (segs.data[1]);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_120 = (QOZ_STR_LIT(""));  break; } } _qoz_bv_94 = _qoz_mv_120;
    }
    _qoz_mv_116 = (_qoz_bv_94);  break; } default: { _qoz_mv_116 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_116;
}
...
qoz_string qoz_emit_generic_callee_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_121 = callee; qoz_string _qoz_mv_121 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_121->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_121->payload.EIdent.f1; _qoz_mv_121 = (name);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_121->payload.EField.f1; qoz_string method = _qoz_ms_121->payload.EField.f2; qoz_Expr* _qoz_ms_122 = base; qoz_string _qoz_mv_122 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_122->tag) { case qoz_Expr_EIdent: { qoz_string pkg = _qoz_ms_122->payload.EIdent.f1; qoz_string _qoz_bv_95;
    {
        if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_string_cat(qoz_string_cat(pkg, QOZ_STR_LIT("_")), method);} if (qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, pkg)) { qoz_Option__qoz_string* _qoz_ms_123 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, method); switch (_qoz_ms_123->tag) { case qoz_Option__qoz_string_Some: { return method; break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } _qoz_bv_95 = QOZ_STR_LIT("");
    }
    _qoz_mv_122 = (_qoz_bv_95);  break; } default: { _qoz_mv_122 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_121 = (_qoz_mv_122);  break; } case qoz_Expr_EPath: { qoz_Vec__qoz_string segs = _qoz_ms_121->payload.EPath.f1; qoz_string _qoz_bv_96;
    {
        if ((segs.len) == 2) { qoz_string pkg = segs.data[0]; qoz_string method = segs.data[1]; if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_string_cat(qoz_string_cat(pkg, QOZ_STR_LIT("_")), method);} if (qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, pkg)) { qoz_Option__qoz_string* _qoz_ms_124 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, method); switch (_qoz_ms_124->tag) { case qoz_Option__qoz_string_Some: { return method; break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } } _qoz_bv_96 = QOZ_STR_LIT("");
    }
    _qoz_mv_121 = (_qoz_bv_96);  break; } default: { _qoz_mv_121 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_121;
}

void qoz_emit_collect_type_instantiations(qoz_Emitter* e, qoz_File file) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    { qoz_Vec__qoz_Decl __col = file.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_emit_walk_decl_for_types(e, d); } }bool stable = false; int64_t iters = 0; while (!stable) { if (iters > 32) { stable = true; } iters = iters + 1; int64_t before_r = (e->record_insts.len); int64_t before_e = (e->enum_insts.len); int64_t before_f = (e->fn_insts.len); int64_t i = 0; while (i < (e->record_insts.len)) { qoz_Instantiation inst = e->record_insts.data[i]; qoz_Option__qoz_Decl* _qoz_ms_125 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, inst.name); switch (_qoz_ms_125->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_125->payload.Some.f0; qoz_emit_walk_struct_fields_with_subst(e, decl, inst.args);  break; } default: { NULL;  break; } } 0; i = i + 1; } int64_t j = 0; while (j < (e->enum_insts.len)) { qoz_Instantiation inst = e->enum_insts.data[j]; qoz_Option__qoz_Decl* _qoz_ms_126 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, inst.name); switch (_qoz_ms_126->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_126->payload.Some.f0; qoz_emit_walk_enum_variants_with_subst(e, decl, inst.args);  break; } default: { NULL;  break; } } 0; j = j + 1; } int64_t k = 0; while (k < (e->fn_insts.len)) { qoz_Instantiation inst = e->fn_insts.data[k]; qoz_Option__qoz_Decl* _qoz_ms_127 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_fn_decls, inst.name); switch (_qoz_ms_127->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_127->payload.Some.f0; qoz_emit_walk_fn_body_with_subst(e, decl, inst.args);  break; } default: { NULL;  break; } } 0; k = k + 1; } if ((((e->record_insts.len) == before_r) && ((e->enum_insts.len) == before_e)) && ((e->fn_insts.len) == before_f)) { stable = true; } } 
    return;
}
...
void qoz_emit_walk_fn_body_with_subst(qoz_Emitter* e, qoz_Decl* d, qoz_Vec__qoz_TypeExpr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_128 = d; switch (_qoz_ms_128->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string params = _qoz_ms_128->payload.DFn.f2; qoz_Vec__qoz_FnParam fn_params = _qoz_ms_128->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_128->payload.DFn.f4; qoz_Expr* body = _qoz_ms_128->payload.DFn.f5; {
...
void qoz_emit_walk_struct_fields_with_subst(qoz_Emitter* e, qoz_Decl* d, qoz_Vec__qoz_TypeExpr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_129 = d; switch (_qoz_ms_129->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_129->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_129->payload.DStruct.f3; { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; qoz_TypeExpr* substituted = qoz_emit_substitute_type(e, f.ty, params, args); qoz_gc_push_root(&substituted); qoz_emit_walk_typeexpr(e, substituted); } }0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
void qoz_emit_walk_decl_for_types(qoz_Emitter* e, qoz_Decl* d) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&d);
    qoz_Decl* _qoz_ms_131 = d; switch (_qoz_ms_131->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_131->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_131->payload.DStruct.f3; if ((params.len) == 0) { { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; qoz_emit_walk_typeexpr(e, f.ty); } }} 0;  break; } case qoz_Decl_DEnum: { qoz_Vec__qoz_string params = _qoz_ms_131->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_131->payload.DEnum.f3; if ((params.len) == 0) { { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pt = __col.data[__i]; (void)pt; qoz_emit_walk_typeexpr(e, pt); } }{ qoz_Vec__qoz_StructField __col = v.named; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField nf = __col.data[__i]; (void)nf; qoz_emit_walk_typeexpr(e, nf.ty); } }} }} 0;  break; } case qoz_Decl_DFn: { qoz_Vec__qoz_string params = _qoz_ms_131->payload.DFn.f2; qoz_Vec__qoz_FnParam fn_params = _qoz_ms_131->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_131->payload.DFn.f4; qoz_Expr* body = _qoz_ms_131->payload.DFn.f5; if ((params.len) == 0) { { qoz_Vec__qoz_FnParam __col = fn_params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; qoz_emit_walk_typeexpr(e, fp.ty); } }qoz_emit_walk_typeexpr(e, ret); e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_FnParam __col = fn_params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, fp.name, fp.ty); } }qoz_emit_walk_expr_for_types(e, body); } 0;  break; } case qoz_Decl_DExternal: { qoz_Vec__qoz_FnParam fn_params = _qoz_ms_131->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_131->payload.DExternal.f4; {
    ...
    0;  break; } case qoz_Decl_DConst: { qoz_TypeExpr* ty = _qoz_ms_131->payload.DConst.f2; qoz_Expr* value = _qoz_ms_131->payload.DConst.f3; {
...
void qoz_emit_walk_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_132 = te; switch (_qoz_ms_132->tag) { case qoz_TypeExpr_TEUnit: { NULL;  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_132->payload.TEPtr.f1; qoz_emit_walk_typeexpr(e, inner);  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_132->payload.TETuple.f1; { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; qoz_emit_walk_typeexpr(e, el); } }0;  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_132->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_132->payload.TENamed.f2; {
    ...
    0;  break; } case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr params = _qoz_ms_132->payload.TEFn.f1; qoz_TypeExpr* ret = _qoz_ms_132->payload.TEFn.f2; {
...
qoz_Option__qoz_TypeExpr* qoz_emit_literal_typeexpr(qoz_Expr* ex) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_133 = ex; qoz_Option__qoz_TypeExpr* _qoz_mv_133 = NULL; switch (_qoz_ms_133->tag) { case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_133->payload.EInt.f0; _qoz_mv_133 = (qoz_make_Option__qoz_TypeExpr_Some(qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64"))));  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_133->payload.EFloat.f0; _qoz_mv_133 = (qoz_make_Option__qoz_TypeExpr_Some(qoz_emit_single_named_te(sp, QOZ_STR_LIT("f64"))));  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_133->payload.EString.f0; _qoz_mv_133 = (qoz_make_Option__qoz_TypeExpr_Some(qoz_emit_single_named_te(sp, QOZ_STR_LIT("string"))));  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_133->payload.EBool.f0; _qoz_mv_133 = (qoz_make_Option__qoz_TypeExpr_Some(qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool"))));  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_133->payload.EChar.f0; _qoz_mv_133 = (qoz_make_Option__qoz_TypeExpr_Some(qoz_emit_single_named_te(sp, QOZ_STR_LIT("char"))));  break; } case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_133->payload.ECast.f2; _qoz_mv_133 = (qoz_make_Option__qoz_TypeExpr_Some(t));  break; } default: { _qoz_mv_133 = (qoz_make_Option__qoz_TypeExpr_None());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_133;
}
...
void qoz_emit_walk_let_value_for_array_hint(qoz_Emitter* e, qoz_TypeExpr* ty, qoz_Expr* val) {
    ...
    if (qoz_emit_is_unit_typeexpr(ty)) { return;} qoz_TypeExpr* _qoz_ms_134 = ty; switch (_qoz_ms_134->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_134->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_134->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_134->payload.TENamed.f2; {
        if ((path.len) < 1) { return;} if (!qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return;} if ((args.len) < 1) { return;} qoz_Expr* _qoz_ms_135 = val; switch (_qoz_ms_135->tag) { case qoz_Expr_EArrayLit: { {
...
void qoz_emit_walk_expr_for_types(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_136 = ex; switch (_qoz_ms_136->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_136->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_136->payload.EBlock.f2; {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_Stmt* _qoz_ms_137 = s; switch (_qoz_ms_137->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_137->payload.SLet.f1; qoz_TypeExpr* ty = _qoz_ms_137->payload.SLet.f2; qoz_Expr* val = _qoz_ms_137->payload.SLet.f3; {
    ...
    0;  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_137->payload.SVar.f1; qoz_TypeExpr* ty = _qoz_ms_137->payload.SVar.f2; qoz_Expr* val = _qoz_ms_137->payload.SVar.f3; {
        qoz_emit_walk_typeexpr(e, ty); qoz_emit_walk_let_value_for_array_hint(e, ty, val); qoz_emit_walk_expr_for_types(e, val); if (!qoz_emit_is_unit_typeexpr(ty)) { qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, ty); } 
    }
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* ex2 = _qoz_ms_137->payload.SExpr.f1; qoz_emit_walk_expr_for_types(e, ex2);  break; } } 0; } }qoz_emit_walk_expr_for_types(e, tail); 
    }
    0;  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_136->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_136->payload.ERecord.f2; {
    ...
    0;  break; } case qoz_Expr_ECast: { qoz_Expr* val = _qoz_ms_136->payload.ECast.f1; qoz_TypeExpr* te = _qoz_ms_136->payload.ECast.f2; {
        qoz_emit_walk_typeexpr(e, te); qoz_emit_walk_expr_for_types(e, val); 
    }
    0;  break; } case qoz_Expr_ESizeOf: { qoz_TypeExpr* te = _qoz_ms_136->payload.ESizeOf.f1; qoz_emit_walk_typeexpr(e, te);  break; } case qoz_Expr_EBinary: { qoz_Expr* l = _qoz_ms_136->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_136->payload.EBinary.f3; {
        qoz_emit_walk_expr_for_types(e, l); qoz_emit_walk_expr_for_types(e, r); 
    }
    0;  break; } case qoz_Expr_EUnary: { qoz_Expr* rhs = _qoz_ms_136->payload.EUnary.f2; qoz_emit_walk_expr_for_types(e, rhs);  break; } case qoz_Expr_EAssign: { qoz_Expr* l = _qoz_ms_136->payload.EAssign.f2; qoz_Expr* r = _qoz_ms_136->payload.EAssign.f3; {
        qoz_emit_walk_expr_for_types(e, l); qoz_emit_walk_expr_for_types(e, r); qoz_emit_walk_assign_for_map_helpers(e, l); 
    }
    0;  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_136->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_136->payload.ECall.f1; qoz_Vec__qoz_TypeExpr type_args = _qoz_ms_136->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_136->payload.ECall.f3; {
        qoz_emit_walk_expr_for_types(e, callee); { qoz_Vec__qoz_TypeExpr __col = type_args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* ta = __col.data[__i]; (void)ta; qoz_emit_walk_typeexpr(e, ta); } }{ qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; qoz_emit_walk_expr_for_types(e, a); } }qoz_emit_register_fn_instantiation(e, callee, type_args); if ((type_args.len) == 0) { qoz_string vname = qoz_emit_variant_callee_name(e, callee); if (!qoz_string_eq(vname, QOZ_STR_LIT(""))) { qoz_Option__qoz_string* _qoz_ms_138 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, vname); switch (_qoz_ms_138->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_138->payload.Some.f0; {
    ...
    0;  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_136->payload.EField.f1; qoz_emit_walk_expr_for_types(e, base);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_136->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_136->payload.EIndex.f2; {
        qoz_emit_walk_expr_for_types(e, base); qoz_emit_walk_expr_for_types(e, idx); 
    }
    0;  break; } case qoz_Expr_ETry: { qoz_Expr* val = _qoz_ms_136->payload.ETry.f1; qoz_emit_walk_expr_for_types(e, val);  break; } case qoz_Expr_EIf: { qoz_Expr* c = _qoz_ms_136->payload.EIf.f1; qoz_Expr* t = _qoz_ms_136->payload.EIf.f2; qoz_Expr* f = _qoz_ms_136->payload.EIf.f3; {
        qoz_emit_walk_expr_for_types(e, c); qoz_emit_walk_expr_for_types(e, t); qoz_emit_walk_expr_for_types(e, f); 
    }
    0;  break; } case qoz_Expr_EMatch: { qoz_Expr* scrut = _qoz_ms_136->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_136->payload.EMatch.f2; {
    ...
    0;  break; } case qoz_Expr_EWhile: { qoz_Expr* c = _qoz_ms_136->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_136->payload.EWhile.f2; {
        qoz_emit_walk_expr_for_types(e, c); qoz_emit_walk_expr_for_types(e, b); 
    }
    0;  break; } case qoz_Expr_EFor: { qoz_Expr* it = _qoz_ms_136->payload.EFor.f3; qoz_Expr* b = _qoz_ms_136->payload.EFor.f4; {
        qoz_emit_walk_expr_for_types(e, it); qoz_emit_walk_expr_for_types(e, b); 
    }
    0;  break; } case qoz_Expr_EReturn: { qoz_Expr* v = _qoz_ms_136->payload.EReturn.f1; qoz_emit_walk_expr_for_types(e, v);  break; } case qoz_Expr_EDefer: { qoz_Expr* b = _qoz_ms_136->payload.EDefer.f1; qoz_emit_walk_expr_for_types(e, b);  break; } case qoz_Expr_ETuple: { qoz_Vec__qoz_Expr elems = _qoz_ms_136->payload.ETuple.f1; { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_emit_walk_expr_for_types(e, el); } }0;  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_136->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_136->payload.EArrayLit.f1; {
        { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_emit_walk_expr_for_types(e, el); } }if ((elems.len) > 0) { qoz_Option__qoz_TypeExpr* elem_te = qoz_emit_literal_typeexpr(elems.data[0]); qoz_gc_push_root(&elem_te); qoz_Option__qoz_TypeExpr* _qoz_ms_139 = elem_te; switch (_qoz_ms_139->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* et = _qoz_ms_139->payload.Some.f0; {
    ...
    0;  break; } case qoz_Expr_EClosure: { qoz_Expr* body = _qoz_ms_136->payload.EClosure.f3; qoz_emit_walk_expr_for_types(e, body);  break; } default: { NULL;  break; } } 0; 
    return;
}
...
qoz_string qoz_emit_mangle_inst(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_TypeExpr args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string acc = name; { qoz_Vec__qoz_TypeExpr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* a = __col.data[__i]; (void)a; acc = qoz_string_cat(acc, QOZ_STR_LIT("__")); acc = qoz_string_cat(acc, qoz_emit_mangle_type(e, a)); } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return acc;
}
...
qoz_string qoz_emit_mangle_type(qoz_Emitter* e, qoz_TypeExpr* t) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&t);
    qoz_TypeExpr* _qoz_ms_140 = t; qoz_string _qoz_mv_140 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_140->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_140 = (QOZ_STR_LIT("void"));  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_140->payload.TEPtr.f1; _qoz_mv_140 = (qoz_string_cat(qoz_emit_mangle_type(e, inner), QOZ_STR_LIT("_ptr")));  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_140->payload.TETuple.f1; qoz_string _qoz_bv_97;
    {
        qoz_string acc = QOZ_STR_LIT("tuple"); { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; acc = qoz_string_cat(acc, QOZ_STR_LIT("__")); acc = qoz_string_cat(acc, qoz_emit_mangle_type(e, el)); } }_qoz_bv_97 = acc;
    }
    _qoz_mv_140 = (_qoz_bv_97);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_140->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_140->payload.TENamed.f2; _qoz_mv_140 = (qoz_emit_mangle_named(e, path, args));  break; } case qoz_TypeExpr_TEFn: { _qoz_mv_140 = (QOZ_STR_LIT("fn"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_140;
}

qoz_string qoz_emit_mangle_named(qoz_Emitter* e, qoz_Vec__qoz_string path, qoz_Vec__qoz_TypeExpr args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    if ((path.len) != 1) { return QOZ_STR_LIT("unknown");} qoz_string n = path.data[0]; qoz_string prim = qoz_emit_primitive_c_name(n); if (!qoz_string_eq(prim, QOZ_STR_LIT(""))) { return prim;} if ((args.len) > 0) { return qoz_string_cat(QOZ_STR_LIT("qoz_"), qoz_emit_mangle_inst(e, n, args));} qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_string_cat(QOZ_STR_LIT("qoz_"), n);
}
...
qoz_TypeExpr* qoz_emit_substitute_type(qoz_Emitter* e, qoz_TypeExpr* t, qoz_Vec__qoz_string params, qoz_Vec__qoz_TypeExpr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&t);
    qoz_TypeExpr* _qoz_ms_141 = t; qoz_TypeExpr* _qoz_mv_141 = NULL; switch (_qoz_ms_141->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_141 = (t);  break; } case qoz_TypeExpr_TEPtr: { qoz_Span span = _qoz_ms_141->payload.TEPtr.f0; qoz_TypeExpr* inner = _qoz_ms_141->payload.TEPtr.f1; _qoz_mv_141 = (qoz_make_TypeExpr_TEPtr(span, qoz_emit_substitute_type(e, inner, params, args)));  break; } case qoz_TypeExpr_TETuple: { qoz_Span span = _qoz_ms_141->payload.TETuple.f0; qoz_Vec__qoz_TypeExpr elems = _qoz_ms_141->payload.TETuple.f1; qoz_TypeExpr* _qoz_bv_98;
    {
        qoz_Vec__qoz_TypeExpr new_elems = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&new_elems, qoz_emit_substitute_type(e, el, params, args)); } }_qoz_bv_98 = qoz_make_TypeExpr_TETuple(span, new_elems);
    }
    _qoz_mv_141 = (_qoz_bv_98);  break; } case qoz_TypeExpr_TENamed: { qoz_Span span = _qoz_ms_141->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_141->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr t_args = _qoz_ms_141->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_99;
    {
        if (((path.len) == 1) && ((t_args.len) == 0)) { qoz_string n = path.data[0]; int64_t i = 0; { qoz_Vec__qoz_string __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string p = __col.data[__i]; (void)p; if (qoz_string_eq(p, n)) { return args.data[i];} i = i + 1; } }} qoz_Vec__qoz_TypeExpr new_args = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = t_args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_TypeExpr(&new_args, qoz_emit_substitute_type(e, a, params, args)); } }_qoz_bv_99 = qoz_make_TypeExpr_TENamed(span, path, new_args);
    }
    _qoz_mv_141 = (_qoz_bv_99);  break; } case qoz_TypeExpr_TEFn: { qoz_Span span = _qoz_ms_141->payload.TEFn.f0; qoz_Vec__qoz_TypeExpr fparams = _qoz_ms_141->payload.TEFn.f1; qoz_TypeExpr* ret = _qoz_ms_141->payload.TEFn.f2; qoz_TypeExpr* _qoz_bv_100;
    {
        qoz_Vec__qoz_TypeExpr new_fparams = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* fp = __col.data[__i]; (void)fp; qoz_vec_push__qoz_TypeExpr(&new_fparams, qoz_emit_substitute_type(e, fp, params, args)); } }_qoz_bv_100 = qoz_make_TypeExpr_TEFn(span, new_fparams, qoz_emit_substitute_type(e, ret, params, args));
    }
    _qoz_mv_141 = (_qoz_bv_100);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_141;
}
...
qoz_Expr* qoz_emit_substitute_expr(qoz_Emitter* e, qoz_Expr* x, qoz_Vec__qoz_string params, qoz_Vec__qoz_TypeExpr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&x);
    qoz_Expr* _qoz_ms_142 = x; qoz_Expr* _qoz_mv_142 = NULL; switch (_qoz_ms_142->tag) { case qoz_Expr_EInt: { _qoz_mv_142 = (x);  break; } case qoz_Expr_EFloat: { _qoz_mv_142 = (x);  break; } case qoz_Expr_EString: { _qoz_mv_142 = (x);  break; } case qoz_Expr_EChar: { _qoz_mv_142 = (x);  break; } case qoz_Expr_EBool: { _qoz_mv_142 = (x);  break; } case qoz_Expr_ENil: { _qoz_mv_142 = (x);  break; } case qoz_Expr_EIdent: { _qoz_mv_142 = (x);  break; } case qoz_Expr_EPath: { _qoz_mv_142 = (x);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_142->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_142->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_142->payload.EUnary.f2; _qoz_mv_142 = (qoz_make_Expr_EUnary(sp, op, qoz_emit_substitute_expr(e, rhs, params, args)));  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_142->payload.EBinary.f0; qoz_BinaryOp* op = _qoz_ms_142->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_142->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_142->payload.EBinary.f3; _qoz_mv_142 = (qoz_make_Expr_EBinary(sp, op, qoz_emit_substitute_expr(e, l, params, args), qoz_emit_substitute_expr(e, r, params, args)));  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_142->payload.EAssign.f0; qoz_AssignOp* op = _qoz_ms_142->payload.EAssign.f1; qoz_Expr* l = _qoz_ms_142->payload.EAssign.f2; qoz_Expr* r = _qoz_ms_142->payload.EAssign.f3; _qoz_mv_142 = (qoz_make_Expr_EAssign(sp, op, qoz_emit_substitute_expr(e, l, params, args), qoz_emit_substitute_expr(e, r, params, args)));  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_142->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_142->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_142->payload.ECall.f2; qoz_Vec__qoz_Expr ax = _qoz_ms_142->payload.ECall.f3; qoz_Expr* _qoz_bv_101;
    {
        qoz_Vec__qoz_TypeExpr new_ta = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_TypeExpr __col = ta; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* t = __col.data[__i]; (void)t; qoz_vec_push__qoz_TypeExpr(&new_ta, qoz_emit_substitute_type(e, t, params, args)); } }qoz_Vec__qoz_Expr new_args = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = ax; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; qoz_vec_push__qoz_Expr(&new_args, qoz_emit_substitute_expr(e, a, params, args)); } }_qoz_bv_101 = qoz_make_Expr_ECall(sp, qoz_emit_substitute_expr(e, callee, params, args), new_ta, new_args);
    }
    _qoz_mv_142 = (_qoz_bv_101);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_142->payload.EField.f0; qoz_Expr* base = _qoz_ms_142->payload.EField.f1; qoz_string name = _qoz_ms_142->payload.EField.f2; _qoz_mv_142 = (qoz_make_Expr_EField(sp, qoz_emit_substitute_expr(e, base, params, args), name));  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_142->payload.EIndex.f0; qoz_Expr* base = _qoz_ms_142->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_142->payload.EIndex.f2; _qoz_mv_142 = (qoz_make_Expr_EIndex(sp, qoz_emit_substitute_expr(e, base, params, args), qoz_emit_substitute_expr(e, idx, params, args)));  break; } case qoz_Expr_ECast: { qoz_Span sp = _qoz_ms_142->payload.ECast.f0; qoz_Expr* value = _qoz_ms_142->payload.ECast.f1; qoz_TypeExpr* t = _qoz_ms_142->payload.ECast.f2; _qoz_mv_142 = (qoz_make_Expr_ECast(sp, qoz_emit_substitute_expr(e, value, params, args), qoz_emit_substitute_type(e, t, params, args)));  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_142->payload.ETry.f0; qoz_Expr* value = _qoz_ms_142->payload.ETry.f1; _qoz_mv_142 = (qoz_make_Expr_ETry(sp, qoz_emit_substitute_expr(e, value, params, args)));  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_142->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_142->payload.ETuple.f1; qoz_Expr* _qoz_bv_102;
    {
        qoz_Vec__qoz_Expr new_e = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&new_e, qoz_emit_substitute_expr(e, el, params, args)); } }_qoz_bv_102 = qoz_make_Expr_ETuple(sp, new_e);
    }
    _qoz_mv_142 = (_qoz_bv_102);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_142->payload.ERecord.f0; qoz_TypeExpr* te = _qoz_ms_142->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_142->payload.ERecord.f2; qoz_Expr* _qoz_bv_103;
    {
        qoz_Vec__qoz_RecordFieldLit new_fields = qoz_vec_make__qoz_RecordFieldLit(); { qoz_Vec__qoz_RecordFieldLit __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; qoz_vec_push__qoz_RecordFieldLit(&new_fields, ((qoz_RecordFieldLit){ .name = f.name, .value = qoz_emit_substitute_expr(e, f.value, params, args) })); } }_qoz_bv_103 = qoz_make_Expr_ERecord(sp, qoz_emit_substitute_type(e, te, params, args), new_fields);
    }
    _qoz_mv_142 = (_qoz_bv_103);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_142->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_142->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_142->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_142->payload.EClosure.f3; qoz_Expr* _qoz_bv_104;
    {
        qoz_Vec__qoz_ClosureParam new_cps = qoz_vec_make__qoz_ClosureParam(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_ClosureParam(&new_cps, ((qoz_ClosureParam){ .name = cp.name, .ty = qoz_emit_substitute_type(e, cp.ty, params, args) })); } }_qoz_bv_104 = qoz_make_Expr_EClosure(sp, new_cps, qoz_emit_substitute_type(e, ret, params, args), qoz_emit_substitute_expr(e, body, params, args));
    }
    _qoz_mv_142 = (_qoz_bv_104);  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_142->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_142->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_142->payload.EBlock.f2; qoz_Expr* _qoz_bv_105;
    {
        qoz_Vec__qoz_Stmt new_stmts = qoz_vec_make__qoz_Stmt(); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_vec_push__qoz_Stmt(&new_stmts, qoz_emit_substitute_stmt(e, s, params, args)); } }_qoz_bv_105 = qoz_make_Expr_EBlock(sp, new_stmts, qoz_emit_substitute_expr(e, tail, params, args));
    }
    _qoz_mv_142 = (_qoz_bv_105);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_142->payload.EIf.f0; qoz_Expr* c = _qoz_ms_142->payload.EIf.f1; qoz_Expr* t = _qoz_ms_142->payload.EIf.f2; qoz_Expr* f = _qoz_ms_142->payload.EIf.f3; _qoz_mv_142 = (qoz_make_Expr_EIf(sp, qoz_emit_substitute_expr(e, c, params, args), qoz_emit_substitute_expr(e, t, params, args), qoz_emit_substitute_expr(e, f, params, args)));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_142->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_142->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_142->payload.EMatch.f2; qoz_Expr* _qoz_bv_106;
    {
        qoz_Vec__qoz_MatchArm new_arms = qoz_vec_make__qoz_MatchArm(); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm a = __col.data[__i]; (void)a; qoz_vec_push__qoz_MatchArm(&new_arms, ((qoz_MatchArm){ .pat = a.pat, .body = qoz_emit_substitute_expr(e, a.body, params, args), .has_guard = a.has_guard, .guard = ((a.has_guard) ? qoz_emit_substitute_expr(e, a.guard, params, args) : a.guard) })); } }_qoz_bv_106 = qoz_make_Expr_EMatch(sp, qoz_emit_substitute_expr(e, scrut, params, args), new_arms);
    }
    _qoz_mv_142 = (_qoz_bv_106);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_142->payload.EWhile.f0; qoz_Expr* c = _qoz_ms_142->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_142->payload.EWhile.f2; _qoz_mv_142 = (qoz_make_Expr_EWhile(sp, qoz_emit_substitute_expr(e, c, params, args), qoz_emit_substitute_expr(e, b, params, args)));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_142->payload.EFor.f0; qoz_string b1 = _qoz_ms_142->payload.EFor.f1; qoz_string b2 = _qoz_ms_142->payload.EFor.f2; qoz_Expr* it = _qoz_ms_142->payload.EFor.f3; qoz_Expr* body = _qoz_ms_142->payload.EFor.f4; _qoz_mv_142 = (qoz_make_Expr_EFor(sp, b1, b2, qoz_emit_substitute_expr(e, it, params, args), qoz_emit_substitute_expr(e, body, params, args)));  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_142->payload.EReturn.f0; qoz_Expr* v = _qoz_ms_142->payload.EReturn.f1; _qoz_mv_142 = (qoz_make_Expr_EReturn(sp, qoz_emit_substitute_expr(e, v, params, args)));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_142->payload.EDefer.f0; qoz_Expr* v = _qoz_ms_142->payload.EDefer.f1; _qoz_mv_142 = (qoz_make_Expr_EDefer(sp, qoz_emit_substitute_expr(e, v, params, args)));  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_142->payload.ESizeOf.f0; qoz_TypeExpr* t = _qoz_ms_142->payload.ESizeOf.f1; _qoz_mv_142 = (qoz_make_Expr_ESizeOf(sp, qoz_emit_substitute_type(e, t, params, args)));  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_142->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_142->payload.EArrayLit.f1; qoz_Expr* _qoz_bv_107;
    {
        qoz_Vec__qoz_Expr new_e = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_Expr(&new_e, qoz_emit_substitute_expr(e, el, params, args)); } }_qoz_bv_107 = qoz_make_Expr_EArrayLit(sp, new_e);
    }
    _qoz_mv_142 = (_qoz_bv_107);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_142;
}
...
qoz_Stmt* qoz_emit_substitute_stmt(qoz_Emitter* e, qoz_Stmt* s, qoz_Vec__qoz_string params, qoz_Vec__qoz_TypeExpr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_143 = s; qoz_Stmt* _qoz_mv_143 = NULL; switch (_qoz_ms_143->tag) { case qoz_Stmt_SLet: { qoz_Span sp = _qoz_ms_143->payload.SLet.f0; qoz_string name = _qoz_ms_143->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_143->payload.SLet.f2; qoz_Expr* val = _qoz_ms_143->payload.SLet.f3; _qoz_mv_143 = (qoz_make_Stmt_SLet(sp, name, qoz_emit_substitute_type(e, te, params, args), qoz_emit_substitute_expr(e, val, params, args)));  break; } case qoz_Stmt_SVar: { qoz_Span sp = _qoz_ms_143->payload.SVar.f0; qoz_string name = _qoz_ms_143->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_143->payload.SVar.f2; qoz_Expr* val = _qoz_ms_143->payload.SVar.f3; _qoz_mv_143 = (qoz_make_Stmt_SVar(sp, name, qoz_emit_substitute_type(e, te, params, args), qoz_emit_substitute_expr(e, val, params, args)));  break; } case qoz_Stmt_SExpr: { qoz_Span sp = _qoz_ms_143->payload.SExpr.f0; qoz_Expr* x = _qoz_ms_143->payload.SExpr.f1; _qoz_mv_143 = (qoz_make_Stmt_SExpr(sp, qoz_emit_substitute_expr(e, x, params, args)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_143;
}

qoz_string qoz_emit_operator_first_param_type_name(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_144 = te; qoz_string _qoz_mv_144 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_144->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_144->payload.TEPtr.f1; qoz_TypeExpr* _qoz_ms_145 = inner; qoz_string _qoz_mv_145 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_145->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_145->payload.TENamed.f1; qoz_string _qoz_bv_108;
    {
        if ((path.len) > 0) { return path.data[(path.len) - 1];} _qoz_bv_108 = QOZ_STR_LIT("");
    }
    _qoz_mv_145 = (_qoz_bv_108);  break; } default: { _qoz_mv_145 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_144 = (_qoz_mv_145);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_144->payload.TENamed.f1; qoz_string _qoz_bv_109;
    {
        if ((path.len) > 0) { return path.data[(path.len) - 1];} _qoz_bv_109 = QOZ_STR_LIT("");
    }
    _qoz_mv_144 = (_qoz_bv_109);  break; } default: { _qoz_mv_144 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_144;
}

void qoz_emit_register_variants(qoz_Emitter* e, qoz_File file) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    { qoz_Vec__qoz_Decl __col = file.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_146 = d; switch (_qoz_ms_146->tag) { case qoz_Decl_DEnum: { qoz_string name = _qoz_ms_146->payload.DEnum.f1; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_146->payload.DEnum.f3; {
    ...
    0;  break; } case qoz_Decl_DStruct: { qoz_string name = _qoz_ms_146->payload.DStruct.f1; (qoz_map_set__qoz_string__qoz_Decl(&e->struct_decls, name, d), 0);  break; } case qoz_Decl_DExternal: { qoz_string name = _qoz_ms_146->payload.DExternal.f1; qoz_string symbol = _qoz_ms_146->payload.DExternal.f2; qoz_Vec__qoz_FnParam fps = _qoz_ms_146->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_146->payload.DExternal.f4; {
    ...
    0;  break; } case qoz_Decl_DFn: { qoz_string name = _qoz_ms_146->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_146->payload.DFn.f2; qoz_Vec__qoz_FnParam fps = _qoz_ms_146->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_146->payload.DFn.f4; qoz_string attr = _qoz_ms_146->payload.DFn.f6; {
    ...
    0;  break; } case qoz_Decl_DImport: { qoz_Vec__qoz_string ipath = _qoz_ms_146->payload.DImport.f1; qoz_string alias = _qoz_ms_146->payload.DImport.f2; {
...
qoz_string qoz_emit_c_type_for(qoz_Emitter* e, qoz_TypeExpr* t) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&t);
    qoz_TypeExpr* _qoz_ms_149 = t; qoz_string _qoz_mv_149 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_149->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_149 = (QOZ_STR_LIT("void"));  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_149->payload.TEPtr.f1; _qoz_mv_149 = (qoz_string_cat(qoz_emit_c_type_for(e, inner), QOZ_STR_LIT("*")));  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_149->payload.TETuple.f1; _qoz_mv_149 = (qoz_emit_register_tuple_typedef(e, elems));  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_149->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_149->payload.TENamed.f2; _qoz_mv_149 = (qoz_emit_c_type_for_named_with_args(e, path, args));  break; } case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr params = _qoz_ms_149->payload.TEFn.f1; qoz_TypeExpr* ret = _qoz_ms_149->payload.TEFn.f2; _qoz_mv_149 = (qoz_emit_register_fn_typedef(e, params, ret));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_149;
}

qoz_string qoz_emit_register_tuple_typedef(qoz_Emitter* e, qoz_Vec__qoz_TypeExpr elems) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string name = QOZ_STR_LIT("qoz_tuple"); { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; name = qoz_string_cat(name, QOZ_STR_LIT("__")); name = qoz_string_cat(name, qoz_emit_mangle_type(e, el)); } }if (!qoz_map_contains__qoz_string__qoz_string(&e->tuple_typedefs, name)) { qoz_string body = QOZ_STR_LIT("typedef struct { "); int64_t i = 0; { qoz_Vec__qoz_TypeExpr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* el = __col.data[__i]; (void)el; body = qoz_string_cat(body, qoz_emit_c_type_for(e, el)); body = qoz_string_cat(body, QOZ_STR_LIT(" _")); body = qoz_string_cat(body, qoz_emit_int_to_string(i)); body = qoz_string_cat(body, QOZ_STR_LIT("; ")); i = i + 1; } }body = qoz_string_cat(body, QOZ_STR_LIT("} ")); body = qoz_string_cat(body, name); body = qoz_string_cat(body, QOZ_STR_LIT(";\n")); qoz_map_set__qoz_string__qoz_string(&e->tuple_typedefs, name, body); qoz_vec_push__qoz_string(&e->tuple_typedef_order, name); } qoz_gc_shadow_set_top(_qoz_shadow_guard); return name;
}

qoz_string qoz_emit_c_type_for_named_with_args(qoz_Emitter* e, qoz_Vec__qoz_string path, qoz_Vec__qoz_TypeExpr args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    if ((path.len) != 1) { return QOZ_STR_LIT("int64_t");} qoz_string n = path.data[0]; qoz_string prim = qoz_emit_primitive_c_name(n); if (!qoz_string_eq(prim, QOZ_STR_LIT(""))) { return prim;} if (qoz_string_eq(n, QOZ_STR_LIT("cstring"))) { return QOZ_STR_LIT("const char *");} if (qoz_string_eq(n, QOZ_STR_LIT("void"))) { return QOZ_STR_LIT("void");} if (qoz_string_eq(n, QOZ_STR_LIT("unit"))) { return QOZ_STR_LIT("void");} qoz_string base = (((args.len) > 0) ? qoz_string_cat(QOZ_STR_LIT("qoz_"), qoz_emit_mangle_inst(e, n, args)) : qoz_string_cat(QOZ_STR_LIT("qoz_"), n)); if (qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { return qoz_string_cat(base, QOZ_STR_LIT("*"));} qoz_gc_shadow_set_top(_qoz_shadow_guard); return base;
}
...
void qoz_emit_collect_closure_captures(qoz_Emitter* e, qoz_Expr* ex, qoz_CaptureScope* sc, qoz_Vec__qoz_string* out) {
    ...
    qoz_gc_push_root(&sc);
    qoz_gc_push_root(&out);
    qoz_Expr* _qoz_ms_150 = ex; switch (_qoz_ms_150->tag) { case qoz_Expr_EInt: { NULL;  break; } case qoz_Expr_EFloat: { NULL;  break; } case qoz_Expr_EString: { NULL;  break; } case qoz_Expr_EChar: { NULL;  break; } case qoz_Expr_EBool: { NULL;  break; } case qoz_Expr_ENil: { NULL;  break; } case qoz_Expr_EPath: { NULL;  break; } case qoz_Expr_ESizeOf: { NULL;  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_150->payload.EIdent.f1; if (!qoz_map_contains__qoz_string__bool(&sc->bound, name)) { if (qoz_map_contains__qoz_string__qoz_TypeExpr(&e->locals, name)) { qoz_vec_push__qoz_string(out, name); } } 0;  break; } case qoz_Expr_EUnary: { qoz_Expr* sub = _qoz_ms_150->payload.EUnary.f2; qoz_emit_collect_closure_captures(e, sub, sc, out);  break; } case qoz_Expr_EBinary: { qoz_Expr* l = _qoz_ms_150->payload.EBinary.f2; qoz_Expr* r = _qoz_ms_150->payload.EBinary.f3; {
        qoz_emit_collect_closure_captures(e, l, sc, out); qoz_emit_collect_closure_captures(e, r, sc, out); 
    }
    0;  break; } case qoz_Expr_EAssign: { qoz_Expr* l = _qoz_ms_150->payload.EAssign.f2; qoz_Expr* r = _qoz_ms_150->payload.EAssign.f3; {
        qoz_emit_collect_closure_captures(e, l, sc, out); qoz_emit_collect_closure_captures(e, r, sc, out); 
    }
    0;  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_150->payload.ECall.f1; qoz_Vec__qoz_Expr args = _qoz_ms_150->payload.ECall.f3; {
    ...
    0;  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_150->payload.EField.f1; qoz_emit_collect_closure_captures(e, base, sc, out);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_150->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_150->payload.EIndex.f2; {
        qoz_emit_collect_closure_captures(e, base, sc, out); qoz_emit_collect_closure_captures(e, idx, sc, out); 
    }
    0;  break; } case qoz_Expr_ECast: { qoz_Expr* v = _qoz_ms_150->payload.ECast.f1; qoz_emit_collect_closure_captures(e, v, sc, out);  break; } case qoz_Expr_ETry: { qoz_Expr* v = _qoz_ms_150->payload.ETry.f1; qoz_emit_collect_closure_captures(e, v, sc, out);  break; } case qoz_Expr_EReturn: { qoz_Expr* v = _qoz_ms_150->payload.EReturn.f1; qoz_emit_collect_closure_captures(e, v, sc, out);  break; } case qoz_Expr_EDefer: { qoz_Expr* v = _qoz_ms_150->payload.EDefer.f1; qoz_emit_collect_closure_captures(e, v, sc, out);  break; } case qoz_Expr_ETuple: { qoz_Vec__qoz_Expr elems = _qoz_ms_150->payload.ETuple.f1; { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_emit_collect_closure_captures(e, el, sc, out); } }0;  break; } case qoz_Expr_ERecord: { qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_150->payload.ERecord.f2; { qoz_Vec__qoz_RecordFieldLit __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit fl = __col.data[__i]; (void)fl; qoz_emit_collect_closure_captures(e, fl.value, sc, out); } }0;  break; } case qoz_Expr_EArrayLit: { qoz_Vec__qoz_Expr elems = _qoz_ms_150->payload.EArrayLit.f1; { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_emit_collect_closure_captures(e, el, sc, out); } }0;  break; } case qoz_Expr_EClosure: { NULL;  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_150->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_150->payload.EBlock.f2; {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* st = __col.data[__i]; (void)st; qoz_Stmt* _qoz_ms_151 = st; switch (_qoz_ms_151->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_151->payload.SLet.f1; qoz_Expr* value = _qoz_ms_151->payload.SLet.f3; {
        qoz_emit_collect_closure_captures(e, value, sc, out); qoz_map_set__qoz_string__bool(&sc->bound, name, true); 
    }
    0;  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_151->payload.SVar.f1; qoz_Expr* value = _qoz_ms_151->payload.SVar.f3; {
        qoz_emit_collect_closure_captures(e, value, sc, out); qoz_map_set__qoz_string__bool(&sc->bound, name, true); 
    }
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* expr = _qoz_ms_151->payload.SExpr.f1; qoz_emit_collect_closure_captures(e, expr, sc, out);  break; } } 0; } }qoz_emit_collect_closure_captures(e, tail, sc, out); 
    }
    0;  break; } case qoz_Expr_EIf: { qoz_Expr* c = _qoz_ms_150->payload.EIf.f1; qoz_Expr* t = _qoz_ms_150->payload.EIf.f2; qoz_Expr* f = _qoz_ms_150->payload.EIf.f3; {
    ...
    0;  break; } case qoz_Expr_EMatch: { qoz_Expr* scrut = _qoz_ms_150->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_150->payload.EMatch.f2; {
    ...
    0;  break; } case qoz_Expr_EWhile: { qoz_Expr* c = _qoz_ms_150->payload.EWhile.f1; qoz_Expr* b = _qoz_ms_150->payload.EWhile.f2; {
        qoz_emit_collect_closure_captures(e, c, sc, out); qoz_emit_collect_closure_captures(e, b, sc, out); 
    }
    0;  break; } case qoz_Expr_EFor: { qoz_string bn = _qoz_ms_150->payload.EFor.f1; qoz_string bn2 = _qoz_ms_150->payload.EFor.f2; qoz_Expr* it = _qoz_ms_150->payload.EFor.f3; qoz_Expr* b = _qoz_ms_150->payload.EFor.f4; {
        qoz_emit_collect_closure_captures(e, it, sc, out); qoz_map_set__qoz_string__bool(&sc->bound, bn, true); if (!qoz_string_eq(bn2, QOZ_STR_LIT(""))) { qoz_map_set__qoz_string__bool(&sc->bound, bn2, true); } qoz_emit_collect_closure_captures(e, b, sc, out); 
    }
    0;  break; } } 0; 
    return;
}
...
qoz_string qoz_emit_result_mangle_for(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_152 = te; qoz_string _qoz_mv_152 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_152->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_152->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_152->payload.TENamed.f2; qoz_string _qoz_bv_111;
    {
        if ((path.len) == 0) { return QOZ_STR_LIT("");} qoz_string last = path.data[(path.len) - 1]; if (!qoz_string_eq(last, QOZ_STR_LIT("Result"))) { return QOZ_STR_LIT("");} if ((args.len) != 2) { return QOZ_STR_LIT("");} _qoz_bv_111 = qoz_emit_mangle_inst(e, QOZ_STR_LIT("Result"), args);
    }
    _qoz_mv_152 = (_qoz_bv_111);  break; } default: { _qoz_mv_152 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_152;
}
...
void qoz_emit_emit_try(qoz_Emitter* e, qoz_Span sp, qoz_Expr* value) {
    ...
    qoz_TypeExpr* inner_te = qoz_emit_infer_value_te(e, value); qoz_gc_push_root(&inner_te); qoz_TypeExpr* outer_te = e->current_ret_te; qoz_gc_push_root(&outer_te); qoz_string inner_mangle = qoz_emit_result_mangle_for(e, inner_te); qoz_string outer_mangle = qoz_emit_result_mangle_for(e, outer_te); if (qoz_string_eq(inner_mangle, QOZ_STR_LIT(""))) { qoz_emit_emit_die(sp, QOZ_STR_LIT("try operator: operand is not Result<T, E>")); return;} if (qoz_string_eq(outer_mangle, QOZ_STR_LIT(""))) { qoz_emit_emit_die(sp, QOZ_STR_LIT("try operator: enclosing function does not return Result<T, E>")); return;} e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_112;
    {
        qoz_Strbuf _qoz_sb_1036_40 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1036_40); qoz_strings_sb_append_i64(&_qoz_sb_1036_40, e->closure_counter); _qoz_bv_112 = qoz_strings_sb_finish(&_qoz_sb_1036_40);
    }
    qoz_string tmp = qoz_string_cat(QOZ_STR_LIT("_qoz_try_"), _qoz_bv_112); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_113;
    {
        qoz_Strbuf _qoz_sb_1042_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1042_13); qoz_strings_sb_append(&_qoz_sb_1042_13, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_1042_13, inner_mangle); qoz_strings_sb_append(&_qoz_sb_1042_13, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_1042_13, tmp); qoz_strings_sb_append(&_qoz_sb_1042_13, QOZ_STR_LIT(" = ")); _qoz_bv_113 = qoz_strings_sb_finish(&_qoz_sb_1042_13);
    }
    qoz_emit_push(e, _qoz_bv_113); qoz_emit_emit_expr(e, value); qoz_string crr = e->current_return_restore; qoz_string _qoz_bv_114;
    {
        qoz_Strbuf _qoz_sb_1045_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1045_13); qoz_strings_sb_append(&_qoz_sb_1045_13, QOZ_STR_LIT("; if (")); qoz_strings_sb_append(&_qoz_sb_1045_13, tmp); qoz_strings_sb_append(&_qoz_sb_1045_13, QOZ_STR_LIT("->tag == qoz_")); qoz_strings_sb_append(&_qoz_sb_1045_13, inner_mangle); qoz_strings_sb_append(&_qoz_sb_1045_13, QOZ_STR_LIT("_Err) { ")); qoz_strings_sb_append(&_qoz_sb_1045_13, crr); qoz_strings_sb_append(&_qoz_sb_1045_13, QOZ_STR_LIT("return qoz_make_")); qoz_strings_sb_append(&_qoz_sb_1045_13, outer_mangle); qoz_strings_sb_append(&_qoz_sb_1045_13, QOZ_STR_LIT("_Err(")); qoz_strings_sb_append(&_qoz_sb_1045_13, tmp); qoz_strings_sb_append(&_qoz_sb_1045_13, QOZ_STR_LIT("->payload.Err.f0); } ")); _qoz_bv_114 = qoz_strings_sb_finish(&_qoz_sb_1045_13);
    }
    qoz_emit_push(e, _qoz_bv_114); qoz_emit_hoist_to_prologue(e, start); qoz_string _qoz_bv_115;
    {
        qoz_Strbuf _qoz_sb_1048_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1048_13); qoz_strings_sb_append(&_qoz_sb_1048_13, tmp); qoz_strings_sb_append(&_qoz_sb_1048_13, QOZ_STR_LIT("->payload.Ok.f0")); _qoz_bv_115 = qoz_strings_sb_finish(&_qoz_sb_1048_13);
    }
    qoz_emit_push(e, _qoz_bv_115); 
    return;
}
...
void qoz_emit_emit_tuple_lit(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_Expr elems) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_TypeExpr elem_tes = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&elem_tes, qoz_emit_infer_value_te(e, el)); } }qoz_string tname = qoz_emit_register_tuple_typedef(e, elem_tes); qoz_string _qoz_bv_116;
    {
        qoz_Strbuf _qoz_sb_1055_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1055_13); qoz_strings_sb_append(&_qoz_sb_1055_13, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_1055_13, tname); qoz_strings_sb_append(&_qoz_sb_1055_13, QOZ_STR_LIT("){ ")); _qoz_bv_116 = qoz_strings_sb_finish(&_qoz_sb_1055_13);
    }
    qoz_emit_push(e, _qoz_bv_116); int64_t i = 0; { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, el); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(" })")); 
    return;
}
...
void qoz_emit_emit_array_lit_with_hint(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_Expr elems, qoz_TypeExpr* hint) {
    ...
    qoz_TypeExpr* elem_hint = qoz_make_TypeExpr_TEUnit(sp); qoz_gc_push_root(&elem_hint); qoz_TypeExpr* _qoz_ms_153 = hint; switch (_qoz_ms_153->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_153->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_153->payload.TENamed.f2; if (((path.len) > 0) && ((args.len) >= 1)) { qoz_string last = path.data[(path.len) - 1]; if (qoz_string_eq(last, QOZ_STR_LIT("Vec"))) { elem_hint = args.data[0]; } } 0;  break; } default: { NULL;  break; } } 0; qoz_emit_emit_array_lit_using(e, sp, elems, elem_hint); 
    return;
}
...
void qoz_emit_emit_array_lit_using(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_Expr elems, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&hint);
    if (((elems.len) == 0) && qoz_emit_is_unit_typeexpr(hint)) { qoz_emit_emit_die(sp, QOZ_STR_LIT("empty array literal: element type cannot be inferred")); return;} qoz_TypeExpr* elem_te = hint; qoz_gc_push_root(&elem_te); if (qoz_emit_is_unit_typeexpr(elem_te)) { elem_te = qoz_emit_infer_value_te(e, elems.data[0]); } qoz_Vec__qoz_TypeExpr elem_args = qoz_vec_make__qoz_TypeExpr(); qoz_vec_push__qoz_TypeExpr(&elem_args, elem_te); qoz_Vec__qoz_string pkg_path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&pkg_path, QOZ_STR_LIT("vec")); qoz_Expr* vec_callee_make = qoz_make_Expr_EField(sp, qoz_make_Expr_EIdent(sp, QOZ_STR_LIT("vec")), QOZ_STR_LIT("make")); qoz_gc_push_root(&vec_callee_make); qoz_Expr* vec_callee_push = qoz_make_Expr_EField(sp, qoz_make_Expr_EIdent(sp, QOZ_STR_LIT("vec")), QOZ_STR_LIT("push")); qoz_gc_push_root(&vec_callee_push); qoz_emit_register_fn_instantiation(e, vec_callee_make, elem_args); qoz_emit_register_fn_instantiation(e, vec_callee_push, elem_args); qoz_Vec__qoz_string vec_path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&vec_path, QOZ_STR_LIT("Vec")); qoz_emit_walk_typeexpr(e, qoz_make_TypeExpr_TENamed(sp, vec_path, elem_args)); qoz_string make_mangled = qoz_emit_mangle_inst(e, QOZ_STR_LIT("vec_make"), elem_args); qoz_string push_mangled = qoz_emit_mangle_inst(e, QOZ_STR_LIT("vec_push"), elem_args); qoz_string vec_c = qoz_string_cat(QOZ_STR_LIT("qoz_"), qoz_emit_mangle_inst(e, QOZ_STR_LIT("Vec"), elem_args)); e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_117;
    {
        qoz_Strbuf _qoz_sb_1105_40 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1105_40); qoz_strings_sb_append_i64(&_qoz_sb_1105_40, e->closure_counter); _qoz_bv_117 = qoz_strings_sb_finish(&_qoz_sb_1105_40);
    }
    qoz_string tmp = qoz_string_cat(QOZ_STR_LIT("_qoz_arr_"), _qoz_bv_117); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_118;
    {
        qoz_Strbuf _qoz_sb_1107_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1107_13); qoz_strings_sb_append(&_qoz_sb_1107_13, vec_c); qoz_strings_sb_append(&_qoz_sb_1107_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_1107_13, tmp); qoz_strings_sb_append(&_qoz_sb_1107_13, QOZ_STR_LIT(" = qoz_")); qoz_strings_sb_append(&_qoz_sb_1107_13, make_mangled); qoz_strings_sb_append(&_qoz_sb_1107_13, QOZ_STR_LIT("(); ")); _qoz_bv_118 = qoz_strings_sb_finish(&_qoz_sb_1107_13);
    }
    qoz_emit_push(e, _qoz_bv_118); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_string _qoz_bv_119;
    {
        qoz_Strbuf _qoz_sb_1109_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1109_17); qoz_strings_sb_append(&_qoz_sb_1109_17, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_1109_17, push_mangled); qoz_strings_sb_append(&_qoz_sb_1109_17, QOZ_STR_LIT("(&")); qoz_strings_sb_append(&_qoz_sb_1109_17, tmp); qoz_strings_sb_append(&_qoz_sb_1109_17, QOZ_STR_LIT(", ")); _qoz_bv_119 = qoz_strings_sb_finish(&_qoz_sb_1109_17);
    }
    qoz_emit_push(e, _qoz_bv_119); qoz_emit_emit_expr(e, el); qoz_emit_push(e, QOZ_STR_LIT("); ")); } }qoz_emit_hoist_to_prologue(e, start); qoz_emit_push(e, tmp); 
    return;
}
...
void qoz_emit_emit_closure_lifted(qoz_Emitter* e, qoz_Span sp, qoz_Vec__qoz_ClosureParam cps, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_CaptureScope sc = ((qoz_CaptureScope){ .bound = qoz_map_make__qoz_string__bool() }); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_map_set__qoz_string__bool(&sc.bound, cp.name, true); } }qoz_Vec__qoz_string captures = qoz_vec_make__qoz_string(); qoz_emit_collect_closure_captures(e, body, &sc, &captures); int64_t counter = e->closure_counter; e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_120;
    {
        qoz_Strbuf _qoz_sb_1125_41 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1125_41); qoz_strings_sb_append_i64(&_qoz_sb_1125_41, counter); _qoz_bv_120 = qoz_strings_sb_finish(&_qoz_sb_1125_41);
    }
    qoz_string cname = qoz_string_cat(QOZ_STR_LIT("qoz_clo_"), _qoz_bv_120); qoz_string _qoz_bv_121;
    {
        qoz_Strbuf _qoz_sb_1126_50 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1126_50); qoz_strings_sb_append_i64(&_qoz_sb_1126_50, counter); _qoz_bv_121 = qoz_strings_sb_finish(&_qoz_sb_1126_50);
    }
    qoz_string env_struct = qoz_string_cat(QOZ_STR_LIT("qoz_clo_env_"), _qoz_bv_121); qoz_Vec__qoz_TypeExpr capture_tes = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; qoz_Option__qoz_TypeExpr* _qoz_ms_154 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, c); switch (_qoz_ms_154->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_154->payload.Some.f0; qoz_vec_push__qoz_TypeExpr(&capture_tes, te);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_vec_push__qoz_TypeExpr(&capture_tes, qoz_make_TypeExpr_TEUnit(sp));  break; } } 0; } }qoz_Vec__qoz_TypeExpr ptes = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_TypeExpr(&ptes, cp.ty); } }qoz_string clo_type = qoz_emit_register_fn_typedef(e, ptes, ret); qoz_Vec__qoz_FnParam fparams = qoz_vec_make__qoz_FnParam(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_FnParam(&fparams, ((qoz_FnParam){ .name = cp.name, .ty = cp.ty })); } }qoz_string sig = QOZ_STR_LIT("static "); sig = qoz_string_cat(sig, qoz_emit_c_type_for(e, ret)); sig = qoz_string_cat(sig, QOZ_STR_LIT(" ")); sig = qoz_string_cat(sig, cname); sig = qoz_string_cat(sig, QOZ_STR_LIT("(void *_qoz_env")); { qoz_Vec__qoz_FnParam __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; sig = qoz_string_cat(sig, QOZ_STR_LIT(", ")); sig = qoz_string_cat(sig, qoz_emit_c_type_for(e, fp.ty)); sig = qoz_string_cat(sig, QOZ_STR_LIT(" ")); sig = qoz_string_cat(sig, fp.name); } }sig = qoz_string_cat(sig, QOZ_STR_LIT(");\n")); qoz_vec_push__qoz_string(&e->synth_fn_decls, sig); if ((captures.len) > 0) { qoz_string env_decl = QOZ_STR_LIT("struct "); env_decl = qoz_string_cat(env_decl, env_struct); env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT(" { ")); int64_t ci = 0; { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; env_decl = qoz_string_cat(env_decl, qoz_emit_c_type_for(e, capture_tes.data[ci])); env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT(" ")); env_decl = qoz_string_cat(env_decl, c); env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT("; ")); ci = ci + 1; } }env_decl = qoz_string_cat(env_decl, QOZ_STR_LIT("};\n")); qoz_vec_push__qoz_string(&e->synth_fn_decls, env_decl); } int64_t saved_start = qoz_strings_sb_len(&e->out); qoz_Map__qoz_string__qoz_TypeExpr saved_locals = e->locals; qoz_TypeExpr* saved_ret = e->current_ret_te; qoz_gc_push_root(&saved_ret); qoz_TypeExpr* saved_hint = e->match_hint; qoz_gc_push_root(&saved_hint); qoz_string ret_c = qoz_emit_c_type_for(e, ret); qoz_string _qoz_bv_122;
    {
        qoz_Strbuf _qoz_sb_1185_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1185_13); qoz_strings_sb_append(&_qoz_sb_1185_13, QOZ_STR_LIT("static ")); qoz_strings_sb_append(&_qoz_sb_1185_13, ret_c); qoz_strings_sb_append(&_qoz_sb_1185_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_1185_13, cname); qoz_strings_sb_append(&_qoz_sb_1185_13, QOZ_STR_LIT("(void *_qoz_env")); _qoz_bv_122 = qoz_strings_sb_finish(&_qoz_sb_1185_13);
    }
    qoz_emit_push(e, _qoz_bv_122); { qoz_Vec__qoz_FnParam __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; qoz_string fp_c = qoz_emit_c_type_for(e, fp.ty); qoz_string fp_n = fp.name; qoz_string _qoz_bv_123;
    {
        qoz_Strbuf _qoz_sb_1189_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1189_17); qoz_strings_sb_append(&_qoz_sb_1189_17, QOZ_STR_LIT(", ")); qoz_strings_sb_append(&_qoz_sb_1189_17, fp_c); qoz_strings_sb_append(&_qoz_sb_1189_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_1189_17, fp_n); _qoz_bv_123 = qoz_strings_sb_finish(&_qoz_sb_1189_17);
    }
    qoz_emit_push(e, _qoz_bv_123); } }qoz_emit_push(e, QOZ_STR_LIT(") {\n    ")); e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_FnParam __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam fp = __col.data[__i]; (void)fp; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, fp.name, fp.ty); } }if ((captures.len) > 0) { qoz_string _qoz_bv_124;
    {
        qoz_Strbuf _qoz_sb_1195_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1195_17); qoz_strings_sb_append(&_qoz_sb_1195_17, QOZ_STR_LIT("struct ")); qoz_strings_sb_append(&_qoz_sb_1195_17, env_struct); qoz_strings_sb_append(&_qoz_sb_1195_17, QOZ_STR_LIT(" *_env = (struct ")); qoz_strings_sb_append(&_qoz_sb_1195_17, env_struct); qoz_strings_sb_append(&_qoz_sb_1195_17, QOZ_STR_LIT(" *)_qoz_env;\n    ")); _qoz_bv_124 = qoz_strings_sb_finish(&_qoz_sb_1195_17);
    }
    qoz_emit_push(e, _qoz_bv_124); int64_t ci2 = 0; { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; qoz_string c_c = qoz_emit_c_type_for(e, capture_tes.data[ci2]); qoz_string _qoz_bv_125;
    {
        qoz_Strbuf _qoz_sb_1199_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1199_21); qoz_strings_sb_append(&_qoz_sb_1199_21, c_c); qoz_strings_sb_append(&_qoz_sb_1199_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_1199_21, c); qoz_strings_sb_append(&_qoz_sb_1199_21, QOZ_STR_LIT(" = _env->")); qoz_strings_sb_append(&_qoz_sb_1199_21, c); qoz_strings_sb_append(&_qoz_sb_1199_21, QOZ_STR_LIT(";\n    ")); _qoz_bv_125 = qoz_strings_sb_finish(&_qoz_sb_1199_21);
    }
    qoz_emit_push(e, _qoz_bv_125); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, c, capture_tes.data[ci2]); ci2 = ci2 + 1; } }} e->current_ret_te = ret; if (qoz_emit_is_block(body)) { qoz_emit_emit_fn_body_block(e, body, ret); }  else { qoz_StmtScope saved = qoz_emit_open_statement_scope(e); if (qoz_emit_is_unit_typeexpr(ret)) { qoz_emit_emit_expr(e, body); qoz_emit_push(e, QOZ_STR_LIT(";\n    return;\n")); }  else { qoz_emit_push(e, QOZ_STR_LIT("return ")); qoz_emit_emit_value_with_hint(e, body, ret); qoz_emit_push(e, QOZ_STR_LIT(";\n")); } qoz_emit_close_statement_scope(e, saved); } qoz_emit_push(e, QOZ_STR_LIT("}\n\n")); qoz_string def = qoz_strings_sb_slice_copy(&e->out, saved_start, qoz_strings_sb_len(&e->out)); qoz_strings_sb_truncate(&e->out, saved_start); e->locals = saved_locals; e->current_ret_te = saved_ret; e->match_hint = saved_hint; qoz_vec_push__qoz_string(&e->synth_fn_defs, def); qoz_string _qoz_bv_126;
    {
        qoz_Strbuf _qoz_sb_1231_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1231_13); qoz_strings_sb_append(&_qoz_sb_1231_13, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_1231_13, clo_type); qoz_strings_sb_append(&_qoz_sb_1231_13, QOZ_STR_LIT("){ .env = ")); _qoz_bv_126 = qoz_strings_sb_finish(&_qoz_sb_1231_13);
    }
    qoz_emit_push(e, _qoz_bv_126); if ((captures.len) == 0) { qoz_emit_push(e, QOZ_STR_LIT("NULL")); }  else { qoz_string _qoz_bv_127;
    {
        qoz_Strbuf _qoz_sb_1237_50 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1237_50); qoz_strings_sb_append_i64(&_qoz_sb_1237_50, counter); _qoz_bv_127 = qoz_strings_sb_finish(&_qoz_sb_1237_50);
    }
    qoz_string env_local = qoz_string_cat(QOZ_STR_LIT("_qoz_env_"), _qoz_bv_127); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_128;
    {
        qoz_Strbuf _qoz_sb_1239_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1239_17); qoz_strings_sb_append(&_qoz_sb_1239_17, QOZ_STR_LIT("struct ")); qoz_strings_sb_append(&_qoz_sb_1239_17, env_struct); qoz_strings_sb_append(&_qoz_sb_1239_17, QOZ_STR_LIT(" *")); qoz_strings_sb_append(&_qoz_sb_1239_17, env_local); qoz_strings_sb_append(&_qoz_sb_1239_17, QOZ_STR_LIT(" = qoz_alloc(sizeof(struct ")); qoz_strings_sb_append(&_qoz_sb_1239_17, env_struct); qoz_strings_sb_append(&_qoz_sb_1239_17, QOZ_STR_LIT(")); ")); _qoz_bv_128 = qoz_strings_sb_finish(&_qoz_sb_1239_17);
    }
    qoz_emit_push(e, _qoz_bv_128); { qoz_Vec__qoz_string __col = captures; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string c = __col.data[__i]; (void)c; qoz_string _qoz_bv_129;
    {
        qoz_Strbuf _qoz_sb_1241_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1241_21); qoz_strings_sb_append(&_qoz_sb_1241_21, env_local); qoz_strings_sb_append(&_qoz_sb_1241_21, QOZ_STR_LIT("->")); qoz_strings_sb_append(&_qoz_sb_1241_21, c); qoz_strings_sb_append(&_qoz_sb_1241_21, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_1241_21, c); qoz_strings_sb_append(&_qoz_sb_1241_21, QOZ_STR_LIT("; ")); _qoz_bv_129 = qoz_strings_sb_finish(&_qoz_sb_1241_21);
    }
    qoz_emit_push(e, _qoz_bv_129); } }qoz_emit_hoist_to_prologue(e, start); qoz_string _qoz_bv_130;
    {
        qoz_Strbuf _qoz_sb_1244_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1244_17); qoz_strings_sb_append(&_qoz_sb_1244_17, QOZ_STR_LIT("(void *)")); qoz_strings_sb_append(&_qoz_sb_1244_17, env_local); _qoz_bv_130 = qoz_strings_sb_finish(&_qoz_sb_1244_17);
    }
    qoz_emit_push(e, _qoz_bv_130); } qoz_string _qoz_bv_131;
    {
        qoz_Strbuf _qoz_sb_1246_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1246_13); qoz_strings_sb_append(&_qoz_sb_1246_13, QOZ_STR_LIT(", .fn = ")); qoz_strings_sb_append(&_qoz_sb_1246_13, cname); qoz_strings_sb_append(&_qoz_sb_1246_13, QOZ_STR_LIT(" })")); _qoz_bv_131 = qoz_strings_sb_finish(&_qoz_sb_1246_13);
    }
    qoz_emit_push(e, _qoz_bv_131); 
    return;
}
...
void qoz_emit_emit_expr(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_155 = ex; switch (_qoz_ms_155->tag) { case qoz_Expr_EInt: { qoz_string text = _qoz_ms_155->payload.EInt.f1; qoz_emit_push(e, qoz_emit_strip_numeric_underscores(text));  break; } case qoz_Expr_EFloat: { qoz_string text = _qoz_ms_155->payload.EFloat.f1; qoz_emit_push(e, qoz_emit_strip_numeric_underscores(text));  break; } case qoz_Expr_EBool: { bool v = _qoz_ms_155->payload.EBool.f1; qoz_emit_push(e, ((v) ? QOZ_STR_LIT("true") : QOZ_STR_LIT("false")));  break; } case qoz_Expr_ENil: { qoz_emit_push(e, QOZ_STR_LIT("NULL"));  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_155->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_156 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_156->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_156->payload.Some.f0; qoz_string _qoz_bv_132;
    {
        qoz_Strbuf _qoz_sb_1258_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1258_21); qoz_strings_sb_append(&_qoz_sb_1258_21, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_1258_21, enum_name); qoz_strings_sb_append(&_qoz_sb_1258_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_1258_21, name); qoz_strings_sb_append(&_qoz_sb_1258_21, QOZ_STR_LIT("()")); _qoz_bv_132 = qoz_strings_sb_finish(&_qoz_sb_1258_21);
    }
    qoz_emit_push(e, _qoz_bv_132);  break; } case qoz_Option__qoz_string_None: { qoz_emit_push(e, name);  break; } } 0;  break; } case qoz_Expr_EString: { qoz_string text = _qoz_ms_155->payload.EString.f1; qoz_string _qoz_bv_133;
    {
        qoz_Strbuf _qoz_sb_1263_36 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1263_36); qoz_strings_sb_append(&_qoz_sb_1263_36, QOZ_STR_LIT("QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_1263_36, text); qoz_strings_sb_append(&_qoz_sb_1263_36, QOZ_STR_LIT(")")); _qoz_bv_133 = qoz_strings_sb_finish(&_qoz_sb_1263_36);
    }
    qoz_emit_push(e, _qoz_bv_133);  break; } case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_155->payload.EBinary.f1; qoz_Expr* lhs = _qoz_ms_155->payload.EBinary.f2; qoz_Expr* rhs = _qoz_ms_155->payload.EBinary.f3; qoz_emit_emit_binary(e, op, lhs, rhs);  break; } case qoz_Expr_EUnary: { qoz_UnaryOp* op = _qoz_ms_155->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_155->payload.EUnary.f2; {
        qoz_string op_text = qoz_emit_unary_op_text(op); if (!qoz_string_eq(op_text, QOZ_STR_LIT(""))) { qoz_TypeExpr* rhs_te = qoz_emit_infer_value_te(e, rhs); qoz_gc_push_root(&rhs_te); qoz_string tname = qoz_emit_operator_first_param_type_name(rhs_te); if (!qoz_string_eq(tname, QOZ_STR_LIT(""))) { qoz_string key = qoz_string_cat(qoz_string_cat(op_text, QOZ_STR_LIT("::")), tname); qoz_Option__qoz_string* _qoz_ms_157 = qoz_map_get__qoz_string__qoz_string(&e->op_dispatch, key); switch (_qoz_ms_157->tag) { case qoz_Option__qoz_string_Some: { qoz_string fn_name = _qoz_ms_157->payload.Some.f0; {
        qoz_string ct = qoz_emit_c_type_for(e, rhs_te); qoz_Option__qoz_TypeExpr* _qoz_ms_158 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->fn_returns, fn_name); qoz_TypeExpr* _qoz_mv_158 = NULL; switch (_qoz_ms_158->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_158->payload.Some.f0; _qoz_mv_158 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_134;
    {
        qoz_string _qoz_bv_135;
    {
        qoz_Strbuf _qoz_sb_1281_61 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1281_61); qoz_strings_sb_append(&_qoz_sb_1281_61, QOZ_STR_LIT("operator `")); qoz_strings_sb_append(&_qoz_sb_1281_61, op_text); qoz_strings_sb_append(&_qoz_sb_1281_61, QOZ_STR_LIT("` for `")); qoz_strings_sb_append(&_qoz_sb_1281_61, tname); qoz_strings_sb_append(&_qoz_sb_1281_61, QOZ_STR_LIT("` has no recorded return type")); _qoz_bv_135 = qoz_strings_sb_finish(&_qoz_sb_1281_61);
    }
    (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(rhs), _qoz_bv_135)); _qoz_bv_134 = qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(rhs));
    }
    _qoz_mv_158 = (_qoz_bv_134);  break; } } qoz_TypeExpr* ret_te = _qoz_mv_158; qoz_gc_push_root(&ret_te); qoz_string ret_ct = qoz_emit_c_type_for(e, ret_te); qoz_emit_ensure_unary_byval_dispatch_helper(e, fn_name, ct, ret_ct); qoz_string _qoz_bv_136;
    {
        qoz_Strbuf _qoz_sb_1287_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1287_29); qoz_strings_sb_append(&_qoz_sb_1287_29, QOZ_STR_LIT("_qoz_byval_")); qoz_strings_sb_append(&_qoz_sb_1287_29, fn_name); qoz_strings_sb_append(&_qoz_sb_1287_29, QOZ_STR_LIT("(")); _qoz_bv_136 = qoz_strings_sb_finish(&_qoz_sb_1287_29);
    }
    qoz_emit_push(e, _qoz_bv_136); qoz_emit_emit_expr(e, rhs); qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; } } qoz_emit_push(e, qoz_emit_unary_c_op(op)); qoz_Expr* _qoz_ms_159 = rhs; switch (_qoz_ms_159->tag) { case qoz_Expr_EBinary: { {
    ...
    0;  break; } case qoz_Expr_EReturn: { qoz_Expr* value = _qoz_ms_155->payload.EReturn.f1; if (qoz_emit_is_nil_expr(value)) { qoz_emit_push(e, QOZ_STR_LIT("return")); }  else { qoz_emit_push(e, QOZ_STR_LIT("return ")); qoz_emit_emit_value_with_hint(e, value, e->current_ret_te); } 0;  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_155->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_155->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_155->payload.EBlock.f2; {
        if ((stmts.len) == 0) { qoz_emit_emit_block_tail_as_value(e, tail); return;} qoz_Expr* _qoz_ms_160 = tail; switch (_qoz_ms_160->tag) { case qoz_Expr_EWhile: { {
    ...
    0;  break; } default: { NULL;  break; } } 0; qoz_TypeExpr* tail_te = qoz_emit_infer_value_te(e, tail); qoz_gc_push_root(&tail_te); if (qoz_emit_is_unit_typeexpr(tail_te)) { int64_t start_u = qoz_strings_sb_len(&e->out); qoz_emit_push(e, QOZ_STR_LIT("{\n        ")); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_emit_stmt(e, s); } }qoz_StmtScope saved_tail = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved_tail); qoz_emit_push(e, QOZ_STR_LIT("\n    }\n    ")); qoz_emit_hoist_to_prologue(e, start_u); qoz_emit_push(e, QOZ_STR_LIT("0")); return;} e->closure_counter = e->closure_counter + 1; int64_t counter = e->closure_counter; qoz_string _qoz_bv_137;
    {
        qoz_Strbuf _qoz_sb_1360_47 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1360_47); qoz_strings_sb_append_i64(&_qoz_sb_1360_47, counter); _qoz_bv_137 = qoz_strings_sb_finish(&_qoz_sb_1360_47);
    }
    qoz_string tmp_res = qoz_string_cat(QOZ_STR_LIT("_qoz_bv_"), _qoz_bv_137); qoz_string result_c = qoz_emit_c_type_for(e, tail_te); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_138;
    {
        qoz_Strbuf _qoz_sb_1363_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1363_17); qoz_strings_sb_append(&_qoz_sb_1363_17, result_c); qoz_strings_sb_append(&_qoz_sb_1363_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_1363_17, tmp_res); qoz_strings_sb_append(&_qoz_sb_1363_17, QOZ_STR_LIT(";\n    {\n        ")); _qoz_bv_138 = qoz_strings_sb_finish(&_qoz_sb_1363_17);
    }
    qoz_emit_push(e, _qoz_bv_138); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_emit_stmt(e, s); } }qoz_StmtScope saved_inner = qoz_emit_open_statement_scope(e); qoz_string _qoz_bv_139;
    {
        qoz_Strbuf _qoz_sb_1366_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1366_17); qoz_strings_sb_append(&_qoz_sb_1366_17, tmp_res); qoz_strings_sb_append(&_qoz_sb_1366_17, QOZ_STR_LIT(" = ")); _qoz_bv_139 = qoz_strings_sb_finish(&_qoz_sb_1366_17);
    }
    qoz_emit_push(e, _qoz_bv_139); qoz_emit_emit_expr(e, tail); qoz_emit_push(e, QOZ_STR_LIT(";\n    ")); qoz_emit_close_statement_scope(e, saved_inner); qoz_emit_push(e, QOZ_STR_LIT("}\n    ")); qoz_emit_hoist_to_prologue(e, start); qoz_emit_push(e, tmp_res); 
    }
    0;  break; } case qoz_Expr_EChar: { qoz_string text = _qoz_ms_155->payload.EChar.f1; qoz_emit_push(e, text);  break; } case qoz_Expr_EPath: { qoz_emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_EAssign: { qoz_Expr* lhs = _qoz_ms_155->payload.EAssign.f2; qoz_Expr* rhs = _qoz_ms_155->payload.EAssign.f3; qoz_emit_emit_assign(e, lhs, rhs);  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_155->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_155->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_155->payload.ECall.f3; qoz_emit_emit_call(e, callee, ta, args);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_155->payload.EField.f1; qoz_string name = _qoz_ms_155->payload.EField.f2; qoz_emit_emit_field(e, base, name);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_155->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_155->payload.EIndex.f2; qoz_emit_emit_index(e, base, idx);  break; } case qoz_Expr_ECast: { qoz_Expr* value = _qoz_ms_155->payload.ECast.f1; qoz_TypeExpr* t = _qoz_ms_155->payload.ECast.f2; {
        qoz_string tc = qoz_emit_c_type_for(e, t); qoz_string _qoz_bv_140;
    {
        qoz_Strbuf _qoz_sb_1382_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1382_17); qoz_strings_sb_append(&_qoz_sb_1382_17, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_1382_17, tc); qoz_strings_sb_append(&_qoz_sb_1382_17, QOZ_STR_LIT(")")); _qoz_bv_140 = qoz_strings_sb_finish(&_qoz_sb_1382_17);
    }
    qoz_emit_push(e, _qoz_bv_140); qoz_emit_emit_expr(e, value); qoz_emit_push(e, QOZ_STR_LIT(")")); 
    }
    0;  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_155->payload.ETry.f0; qoz_Expr* value = _qoz_ms_155->payload.ETry.f1; qoz_emit_emit_try(e, sp, value);  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_155->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_155->payload.ETuple.f1; qoz_emit_emit_tuple_lit(e, sp, elems);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_155->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_155->payload.ERecord.f2; qoz_emit_emit_record_lit_with_hint(e, te, fields, te);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_155->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_155->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_155->payload.EClosure.f2; qoz_Expr* body = _qoz_ms_155->payload.EClosure.f3; qoz_emit_emit_closure_lifted(e, sp, cps, ret, body);  break; } case qoz_Expr_EIf: { qoz_Expr* c = _qoz_ms_155->payload.EIf.f1; qoz_Expr* t = _qoz_ms_155->payload.EIf.f2; qoz_Expr* f = _qoz_ms_155->payload.EIf.f3; {
        qoz_emit_push(e, QOZ_STR_LIT("(")); qoz_emit_emit_expr(e, c); qoz_emit_push(e, QOZ_STR_LIT(" ? ")); qoz_emit_emit_expr(e, t); qoz_emit_push(e, QOZ_STR_LIT(" : ")); qoz_emit_emit_expr(e, f); qoz_emit_push(e, QOZ_STR_LIT(")")); 
    }
    0;  break; } case qoz_Expr_EMatch: { qoz_Span span = _qoz_ms_155->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_155->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_155->payload.EMatch.f2; {
    ...
    0;  break; } case qoz_Expr_EWhile: { qoz_emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_EFor: { qoz_emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_EDefer: { qoz_emit_push(e, QOZ_STR_LIT("0"));  break; } case qoz_Expr_ESizeOf: { qoz_TypeExpr* te = _qoz_ms_155->payload.ESizeOf.f1; {
        qoz_string tc = qoz_emit_c_type_for(e, te); qoz_string _qoz_bv_141;
    {
        qoz_Strbuf _qoz_sb_1400_77 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1400_77); qoz_strings_sb_append(&_qoz_sb_1400_77, QOZ_STR_LIT("(int64_t)sizeof(")); qoz_strings_sb_append(&_qoz_sb_1400_77, tc); qoz_strings_sb_append(&_qoz_sb_1400_77, QOZ_STR_LIT(")")); _qoz_bv_141 = qoz_strings_sb_finish(&_qoz_sb_1400_77);
    }
    qoz_emit_push(e, _qoz_bv_141); 
    }
    0;  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_155->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_155->payload.EArrayLit.f1; qoz_emit_emit_array_lit_using(e, sp, elems, qoz_make_TypeExpr_TEUnit(sp));  break; } } 0; 
    return;
}
...
qoz_string qoz_emit_infer_value_ctype(qoz_Emitter* e, qoz_TypeExpr* ty, qoz_Expr* value) {
    ...
    qoz_gc_push_root(&ty);
    qoz_gc_push_root(&value);
    qoz_TypeExpr* _qoz_ms_161 = ty; qoz_string _qoz_mv_161 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_161->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_161 = (qoz_emit_c_type_for(e, qoz_emit_binding_te(e, ty, value)));  break; } default: { _qoz_mv_161 = (qoz_emit_c_type_for(e, ty));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_161;
}
...
qoz_string qoz_emit_infer_expr_ctype(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_162 = ex; qoz_string _qoz_mv_162 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_162->tag) { case qoz_Expr_EAssign: { _qoz_mv_162 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EReturn: { _qoz_mv_162 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EWhile: { _qoz_mv_162 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EFor: { _qoz_mv_162 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EDefer: { _qoz_mv_162 = (QOZ_STR_LIT("void"));  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_162->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_162->payload.EBlock.f2; qoz_string _qoz_bv_142;
    {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_ingest_stmt_locals(e, s); } }if (qoz_emit_is_nil_expr(tail)) { return QOZ_STR_LIT("void");} _qoz_bv_142 = qoz_emit_infer_expr_ctype(e, tail);
    }
    _qoz_mv_162 = (_qoz_bv_142);  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_162->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_162->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_162->payload.EMatch.f2; qoz_string _qoz_bv_143;
    {
        if ((arms.len) == 0) { qoz_emit_emit_die(sp, QOZ_STR_LIT("match expression with no arms")); } qoz_string bare_enum = qoz_emit_bare_enum_for_pat(e, arms.data[0].pat); qoz_string enum_name = ((qoz_string_eq(bare_enum, QOZ_STR_LIT(""))) ? bare_enum : qoz_emit_enum_lookup_name(e, scrut, bare_enum)); qoz_emit_bind_arm_locals(e, enum_name, arms.data[0].pat); _qoz_bv_143 = qoz_emit_infer_expr_ctype(e, arms.data[0].body);
    }
    _qoz_mv_162 = (_qoz_bv_143);  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_162->payload.EPath.f0; _qoz_mv_162 = (qoz_emit_emit_die(sp, QOZ_STR_LIT("EPath in value position is not supported")));  break; } default: { _qoz_mv_162 = (qoz_emit_c_type_for(e, qoz_emit_infer_value_te(e, ex)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_162;
}
...
void qoz_emit_ingest_stmt_locals(qoz_Emitter* e, qoz_Stmt* s) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_163 = s; switch (_qoz_ms_163->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_163->payload.SLet.f1; qoz_TypeExpr* te = _qoz_ms_163->payload.SLet.f2; qoz_Expr* val = _qoz_ms_163->payload.SLet.f3; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, qoz_emit_binding_te(e, te, val));  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_163->payload.SVar.f1; qoz_TypeExpr* te = _qoz_ms_163->payload.SVar.f2; qoz_Expr* val = _qoz_ms_163->payload.SVar.f3; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, qoz_emit_binding_te(e, te, val));  break; } case qoz_Stmt_SExpr: { NULL;  break; } } 0; 
    return;
}
...
qoz_string qoz_emit_bare_enum_for_pat(qoz_Emitter* e, qoz_Pattern* pat) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&pat);
    qoz_Pattern* _qoz_ms_164 = pat; qoz_string _qoz_mv_164 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_164->tag) { case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_164->payload.PatVariant.f1; qoz_string _qoz_bv_144;
    {
        if ((path.len) == 0) { return QOZ_STR_LIT("");} qoz_Option__qoz_string* _qoz_ms_165 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, path.data[(path.len) - 1]); qoz_string _qoz_mv_165 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_165->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_165->payload.Some.f0; _qoz_mv_165 = (en);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_165 = (QOZ_STR_LIT(""));  break; } } _qoz_bv_144 = _qoz_mv_165;
    }
    _qoz_mv_164 = (_qoz_bv_144);  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_164->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_166 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_166 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_166->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_166->payload.Some.f0; _qoz_mv_166 = (en);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_166 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_164 = (_qoz_mv_166);  break; } default: { _qoz_mv_164 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_164;
}

qoz_string qoz_emit_emit_die(qoz_Span sp, qoz_string msg) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_string _qoz_bv_145;
    {
        qoz_Strbuf _qoz_sb_1466_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1466_17); qoz_strings_sb_append(&_qoz_sb_1466_17, sp.file); qoz_strings_sb_append(&_qoz_sb_1466_17, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_1466_17, sp.line); qoz_strings_sb_append(&_qoz_sb_1466_17, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_1466_17, sp.col); qoz_strings_sb_append(&_qoz_sb_1466_17, QOZ_STR_LIT(": emit error: ")); qoz_strings_sb_append(&_qoz_sb_1466_17, msg); _qoz_bv_145 = qoz_strings_sb_finish(&_qoz_sb_1466_17);
    }
    qoz_fmt_println(_qoz_bv_145); qoz_os_exit(1); qoz_gc_shadow_set_top(_qoz_shadow_guard); return QOZ_STR_LIT("");
}
...
qoz_TypeExpr* qoz_emit_infer_base_typeexpr(qoz_Emitter* e, qoz_Expr* base) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_167 = base; qoz_TypeExpr* _qoz_mv_167 = NULL; switch (_qoz_ms_167->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_167->payload.EIdent.f0; qoz_string ident = _qoz_ms_167->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_168 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, ident); qoz_TypeExpr* _qoz_mv_168 = NULL; switch (_qoz_ms_168->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_168->payload.Some.f0; _qoz_mv_168 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_Option__qoz_string* _qoz_ms_169 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, ident); qoz_TypeExpr* _qoz_mv_169 = NULL; switch (_qoz_ms_169->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_169->payload.Some.f0; qoz_TypeExpr* _qoz_bv_146;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&path, en); _qoz_bv_146 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_169 = (_qoz_bv_146);  break; } case qoz_Option__qoz_string_None: { qoz_TypeExpr* _qoz_bv_147;
    {
        qoz_string _qoz_bv_148;
    {
        qoz_Strbuf _qoz_sb_1484_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1484_38); qoz_strings_sb_append(&_qoz_sb_1484_38, QOZ_STR_LIT("identifier `")); qoz_strings_sb_append(&_qoz_sb_1484_38, ident); qoz_strings_sb_append(&_qoz_sb_1484_38, QOZ_STR_LIT("` has no known TypeExpr (not a local, parameter, or variant)")); _qoz_bv_148 = qoz_strings_sb_finish(&_qoz_sb_1484_38);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_148)); _qoz_bv_147 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_169 = (_qoz_bv_147);  break; } } _qoz_mv_168 = (_qoz_mv_169);  break; } } _qoz_mv_167 = (_qoz_mv_168);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_167->payload.EField.f0; qoz_Expr* b = _qoz_ms_167->payload.EField.f1; qoz_string n = _qoz_ms_167->payload.EField.f2; qoz_TypeExpr* _qoz_bv_149;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, b); qoz_gc_push_root(&bte); _qoz_bv_149 = qoz_emit_field_typeexpr_for(e, bte, n, sp);
    }
    _qoz_mv_167 = (_qoz_bv_149);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_167->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_167->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_167->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_170 = op; qoz_TypeExpr* _qoz_mv_170 = NULL; switch (_qoz_ms_170->tag) { case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_150;
    {
        qoz_TypeExpr* inner = qoz_emit_infer_base_typeexpr(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_171 = inner; qoz_TypeExpr* _qoz_mv_171 = NULL; switch (_qoz_ms_171->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_171->payload.TEPtr.f1; _qoz_mv_171 = (t);  break; } default: { qoz_TypeExpr* _qoz_bv_151;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("dereference of non-pointer base in EField/EIndex"))); _qoz_bv_151 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_171 = (_qoz_bv_151);  break; } } _qoz_bv_150 = _qoz_mv_171;
    }
    _qoz_mv_170 = (_qoz_bv_150);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_170 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_infer_base_typeexpr(e, rhs)));  break; } default: { qoz_TypeExpr* _qoz_bv_152;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("unary operator does not yield a base TypeExpr"))); _qoz_bv_152 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_170 = (_qoz_bv_152);  break; } } _qoz_mv_167 = (_qoz_mv_170);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_167->payload.ECall.f0; qoz_Expr* c = _qoz_ms_167->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_167->payload.ECall.f2; qoz_Vec__qoz_Expr va = _qoz_ms_167->payload.ECall.f3; _qoz_mv_167 = (qoz_emit_call_return_te(e, c, ta, va, sp));  break; } case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_167->payload.ECast.f2; _qoz_mv_167 = (t);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* t = _qoz_ms_167->payload.ERecord.f1; _qoz_mv_167 = (t);  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_167->payload.EIndex.f0; qoz_Expr* b = _qoz_ms_167->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_153;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, b); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_172 = bte; qoz_TypeExpr* _qoz_mv_172 = NULL; switch (_qoz_ms_172->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_172->payload.TEPtr.f1; _qoz_mv_172 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_172->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_172->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_154;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("indexing into non-Vec/non-pointer base"))); _qoz_bv_154 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_172 = (_qoz_bv_154);  break; } default: { qoz_TypeExpr* _qoz_bv_155;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("indexing into unrecognised base"))); _qoz_bv_155 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_172 = (_qoz_bv_155);  break; } } _qoz_bv_153 = _qoz_mv_172;
    }
    _qoz_mv_167 = (_qoz_bv_153);  break; } default: { qoz_TypeExpr* _qoz_bv_156;
    {
        (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(base), QOZ_STR_LIT("base expression has no resolvable TypeExpr"))); _qoz_bv_156 = qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(base));
    }
    _qoz_mv_167 = (_qoz_bv_156);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_167;
}

qoz_Span qoz_emit_span_of_expr(qoz_Expr* e) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Expr* _qoz_ms_173 = e; qoz_Span _qoz_mv_173 = ((qoz_Span){0}); switch (_qoz_ms_173->tag) { case qoz_Expr_ENil: { qoz_Span sp = _qoz_ms_173->payload.ENil.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_173->payload.EInt.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_173->payload.EFloat.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_173->payload.EString.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_173->payload.EChar.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_173->payload.EBool.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_173->payload.EIdent.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_173->payload.EPath.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_173->payload.EReturn.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_173->payload.EDefer.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_173->payload.ESizeOf.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_173->payload.EArrayLit.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_173->payload.ETry.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_173->payload.ETuple.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_173->payload.EUnary.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_173->payload.EField.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_173->payload.EIndex.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_ECast: { qoz_Span sp = _qoz_ms_173->payload.ECast.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_ERecord: { qoz_Span sp = _qoz_ms_173->payload.ERecord.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_173->payload.EBlock.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_173->payload.EWhile.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_173->payload.EMatch.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_173->payload.EBinary.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_173->payload.EAssign.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_173->payload.ECall.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_173->payload.EIf.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_173->payload.EClosure.f0; _qoz_mv_173 = (sp);  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_173->payload.EFor.f0; _qoz_mv_173 = (sp);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_173;
}
...
qoz_TypeExpr* qoz_emit_field_typeexpr_for(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    qoz_TypeExpr* _qoz_ms_174 = base_te; qoz_TypeExpr* _qoz_mv_174 = NULL; switch (_qoz_ms_174->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_174->payload.TEPtr.f1; _qoz_mv_174 = (inner);  break; } default: { _qoz_mv_174 = (base_te);  break; } } qoz_TypeExpr* unwrapped = _qoz_mv_174; qoz_gc_push_root(&unwrapped); qoz_TypeExpr* _qoz_ms_175 = unwrapped; qoz_TypeExpr* _qoz_mv_175 = NULL; switch (_qoz_ms_175->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_175->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_175->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_157;
    {
        if ((path.len) < 1) { qoz_string _qoz_bv_158;
    {
        qoz_Strbuf _qoz_sb_1561_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1561_34); qoz_strings_sb_append(&_qoz_sb_1561_34, QOZ_STR_LIT("field access `.")); qoz_strings_sb_append(&_qoz_sb_1561_34, field); qoz_strings_sb_append(&_qoz_sb_1561_34, QOZ_STR_LIT("` on TypeExpr with empty path")); _qoz_bv_158 = qoz_strings_sb_finish(&_qoz_sb_1561_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_158)); return qoz_make_TypeExpr_TEUnit(sp);} qoz_string lookup = qoz_emit_type_lookup_key(e, path); qoz_Option__qoz_Decl* _qoz_ms_176 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, lookup); qoz_Option__qoz_Decl* _qoz_mv_176 = NULL; switch (_qoz_ms_176->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_176->payload.Some.f0; _qoz_mv_176 = (qoz_make_Option__qoz_Decl_Some(d));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_176 = (qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, lookup));  break; } } qoz_Option__qoz_Decl* decl_opt = _qoz_mv_176; qoz_gc_push_root(&decl_opt); qoz_Option__qoz_Decl* _qoz_ms_177 = decl_opt; qoz_TypeExpr* _qoz_mv_177 = NULL; switch (_qoz_ms_177->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_177->payload.Some.f0; qoz_Decl* _qoz_ms_178 = decl; qoz_TypeExpr* _qoz_mv_178 = NULL; switch (_qoz_ms_178->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_178->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_178->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_159;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_string_eq(f.name, field)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }qoz_string _qoz_bv_160;
    {
        qoz_Strbuf _qoz_sb_1581_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1581_38); qoz_strings_sb_append(&_qoz_sb_1581_38, QOZ_STR_LIT("struct `")); qoz_strings_sb_append(&_qoz_sb_1581_38, lookup); qoz_strings_sb_append(&_qoz_sb_1581_38, QOZ_STR_LIT("` has no field `")); qoz_strings_sb_append(&_qoz_sb_1581_38, field); qoz_strings_sb_append(&_qoz_sb_1581_38, QOZ_STR_LIT("`")); _qoz_bv_160 = qoz_strings_sb_finish(&_qoz_sb_1581_38);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_160)); _qoz_bv_159 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_178 = (_qoz_bv_159);  break; } default: { qoz_TypeExpr* _qoz_bv_161;
    {
        qoz_string _qoz_bv_162;
    {
        qoz_Strbuf _qoz_sb_1585_38 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1585_38); qoz_strings_sb_append(&_qoz_sb_1585_38, QOZ_STR_LIT("decl `")); qoz_strings_sb_append(&_qoz_sb_1585_38, lookup); qoz_strings_sb_append(&_qoz_sb_1585_38, QOZ_STR_LIT("` is not a struct")); _qoz_bv_162 = qoz_strings_sb_finish(&_qoz_sb_1585_38);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_162)); _qoz_bv_161 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_178 = (_qoz_bv_161);  break; } } _qoz_mv_177 = (_qoz_mv_178);  break; } case qoz_Option__qoz_Decl_None: { qoz_TypeExpr* _qoz_bv_163;
    {
        qoz_string _qoz_bv_164;
    {
        qoz_Strbuf _qoz_sb_1591_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1591_34); qoz_strings_sb_append(&_qoz_sb_1591_34, QOZ_STR_LIT("unknown struct `")); qoz_strings_sb_append(&_qoz_sb_1591_34, lookup); qoz_strings_sb_append(&_qoz_sb_1591_34, QOZ_STR_LIT("` for field `.")); qoz_strings_sb_append(&_qoz_sb_1591_34, field); qoz_strings_sb_append(&_qoz_sb_1591_34, QOZ_STR_LIT("`")); _qoz_bv_164 = qoz_strings_sb_finish(&_qoz_sb_1591_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_164)); _qoz_bv_163 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_177 = (_qoz_bv_163);  break; } } _qoz_bv_157 = _qoz_mv_177;
    }
    _qoz_mv_175 = (_qoz_bv_157);  break; } case qoz_TypeExpr_TETuple: { qoz_Vec__qoz_TypeExpr elems = _qoz_ms_175->payload.TETuple.f1; qoz_TypeExpr* _qoz_bv_165;
    {
        int64_t idx = qoz_emit_tuple_field_index(field); if ((idx >= 0) && (idx < (elems.len))) { return elems.data[idx];} qoz_string _qoz_bv_166;
    {
        qoz_Strbuf _qoz_sb_1599_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1599_30); qoz_strings_sb_append(&_qoz_sb_1599_30, QOZ_STR_LIT("tuple has no field `.")); qoz_strings_sb_append(&_qoz_sb_1599_30, field); qoz_strings_sb_append(&_qoz_sb_1599_30, QOZ_STR_LIT("`")); _qoz_bv_166 = qoz_strings_sb_finish(&_qoz_sb_1599_30);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_166)); _qoz_bv_165 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_175 = (_qoz_bv_165);  break; } default: { qoz_TypeExpr* _qoz_bv_167;
    {
        qoz_string _qoz_bv_168;
    {
        qoz_Strbuf _qoz_sb_1603_30 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1603_30); qoz_strings_sb_append(&_qoz_sb_1603_30, QOZ_STR_LIT("field access `.")); qoz_strings_sb_append(&_qoz_sb_1603_30, field); qoz_strings_sb_append(&_qoz_sb_1603_30, QOZ_STR_LIT("` on a non-named base")); _qoz_bv_168 = qoz_strings_sb_finish(&_qoz_sb_1603_30);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_168)); _qoz_bv_167 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_175 = (_qoz_bv_167);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_175;
}
...
qoz_Span qoz_emit_span_of_te(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_179 = te; qoz_Span _qoz_mv_179 = ((qoz_Span){0}); switch (_qoz_ms_179->tag) { case qoz_TypeExpr_TEUnit: { qoz_Span sp = _qoz_ms_179->payload.TEUnit.f0; _qoz_mv_179 = (sp);  break; } case qoz_TypeExpr_TEPtr: { qoz_Span sp = _qoz_ms_179->payload.TEPtr.f0; _qoz_mv_179 = (sp);  break; } case qoz_TypeExpr_TETuple: { qoz_Span sp = _qoz_ms_179->payload.TETuple.f0; _qoz_mv_179 = (sp);  break; } case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_179->payload.TENamed.f0; _qoz_mv_179 = (sp);  break; } case qoz_TypeExpr_TEFn: { qoz_Span sp = _qoz_ms_179->payload.TEFn.f0; _qoz_mv_179 = (sp);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_179;
}
...
qoz_TypeExpr* qoz_emit_binding_te(qoz_Emitter* e, qoz_TypeExpr* declared, qoz_Expr* value) {
    ...
    qoz_gc_push_root(&value);
    qoz_TypeExpr* _qoz_ms_180 = declared; qoz_TypeExpr* _qoz_mv_180 = NULL; switch (_qoz_ms_180->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_180 = (qoz_emit_infer_value_te(e, value));  break; } default: { _qoz_mv_180 = (declared);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_180;
}
...
qoz_Vec__qoz_TypeExpr qoz_emit_type_args_of(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_Vec__qoz_TypeExpr empty = qoz_vec_make__qoz_TypeExpr(); qoz_TypeExpr* _qoz_ms_181 = te; qoz_Vec__qoz_TypeExpr _qoz_mv_181 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_181->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_TypeExpr args = _qoz_ms_181->payload.TENamed.f2; _qoz_mv_181 = (args);  break; } default: { _qoz_mv_181 = (empty);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_181;
}
...
qoz_TypeExpr* qoz_emit_infer_value_te_cached(qoz_Emitter* e, qoz_Expr* v) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&v);
    qoz_Option__qoz_TypeExpr* _qoz_ms_182 = qoz_map_get__int64_t__qoz_TypeExpr(&e->expr_types, qoz_emit_expr_id(v)); qoz_TypeExpr* _qoz_mv_182 = NULL; switch (_qoz_ms_182->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_182->payload.Some.f0; _qoz_mv_182 = ((((e->current_tparams.len) > 0) ? qoz_emit_substitute_type(e, te, e->current_tparams, e->current_targs) : te));  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_182 = (qoz_emit_infer_value_te(e, v));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_182;
}
...
qoz_TypeExpr* qoz_emit_infer_value_te(qoz_Emitter* e, qoz_Expr* v) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&v);
    qoz_Expr* _qoz_ms_183 = v; qoz_TypeExpr* _qoz_mv_183 = NULL; switch (_qoz_ms_183->tag) { case qoz_Expr_ECast: { qoz_TypeExpr* t = _qoz_ms_183->payload.ECast.f2; _qoz_mv_183 = (t);  break; } case qoz_Expr_ERecord: { qoz_TypeExpr* t = _qoz_ms_183->payload.ERecord.f1; qoz_TypeExpr* _qoz_bv_169;
    {
        qoz_Option__qoz_TypeExpr* _qoz_ms_184 = qoz_map_get__int64_t__qoz_TypeExpr(&e->expr_types, qoz_emit_expr_id(v)); qoz_TypeExpr* _qoz_mv_184 = NULL; switch (_qoz_ms_184->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* cte = _qoz_ms_184->payload.Some.f0; _qoz_mv_184 = (cte);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_184 = (t);  break; } } qoz_TypeExpr* cached = _qoz_mv_184; qoz_gc_push_root(&cached); _qoz_bv_169 = qoz_emit_prefer_typed_record(e, t, cached);
    }
    _qoz_mv_183 = (_qoz_bv_169);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_183->payload.EField.f0; qoz_Expr* base = _qoz_ms_183->payload.EField.f1; qoz_string name = _qoz_ms_183->payload.EField.f2; _qoz_mv_183 = (qoz_emit_field_typeexpr_for(e, qoz_emit_infer_base_typeexpr(e, base), name, sp));  break; } case qoz_Expr_EIndex: { qoz_Span sp = _qoz_ms_183->payload.EIndex.f0; qoz_Expr* base = _qoz_ms_183->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_170;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_185 = bte; qoz_TypeExpr* _qoz_mv_185 = NULL; switch (_qoz_ms_185->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_185->payload.TEPtr.f1; _qoz_mv_185 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_185->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_185->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_171;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("let-binding value indexed into non-Vec base; cannot determine binding type"))); _qoz_bv_171 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_185 = (_qoz_bv_171);  break; } default: { qoz_TypeExpr* _qoz_bv_172;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("let-binding value indexed into unrecognised base"))); _qoz_bv_172 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_185 = (_qoz_bv_172);  break; } } _qoz_bv_170 = _qoz_mv_185;
    }
    _qoz_mv_183 = (_qoz_bv_170);  break; } case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_183->payload.EIdent.f0; qoz_string name = _qoz_ms_183->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_186 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_186 = NULL; switch (_qoz_ms_186->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_186->payload.Some.f0; _qoz_mv_186 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_173;
    {
        qoz_string _qoz_bv_174;
    {
        qoz_Strbuf _qoz_sb_1716_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1716_34); qoz_strings_sb_append(&_qoz_sb_1716_34, QOZ_STR_LIT("let-binding value references unknown name `")); qoz_strings_sb_append(&_qoz_sb_1716_34, name); qoz_strings_sb_append(&_qoz_sb_1716_34, QOZ_STR_LIT("`")); _qoz_bv_174 = qoz_strings_sb_finish(&_qoz_sb_1716_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_174)); _qoz_bv_173 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_186 = (_qoz_bv_173);  break; } } _qoz_mv_183 = (_qoz_mv_186);  break; } case qoz_Expr_ECall: { qoz_Span sp = _qoz_ms_183->payload.ECall.f0; qoz_Expr* callee = _qoz_ms_183->payload.ECall.f1; qoz_Vec__qoz_TypeExpr type_args = _qoz_ms_183->payload.ECall.f2; qoz_Vec__qoz_Expr vargs = _qoz_ms_183->payload.ECall.f3; _qoz_mv_183 = (qoz_emit_call_return_te(e, callee, type_args, vargs, sp));  break; } case qoz_Expr_EInt: { qoz_Span sp = _qoz_ms_183->payload.EInt.f0; _qoz_mv_183 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } case qoz_Expr_EFloat: { qoz_Span sp = _qoz_ms_183->payload.EFloat.f0; _qoz_mv_183 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("f64")));  break; } case qoz_Expr_EString: { qoz_Span sp = _qoz_ms_183->payload.EString.f0; _qoz_mv_183 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Expr_EBool: { qoz_Span sp = _qoz_ms_183->payload.EBool.f0; _qoz_mv_183 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Expr_EChar: { qoz_Span sp = _qoz_ms_183->payload.EChar.f0; _qoz_mv_183 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Expr_ENil: { qoz_Span sp = _qoz_ms_183->payload.ENil.f0; _qoz_mv_183 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_single_named_te(sp, QOZ_STR_LIT("void"))));  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_183->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_183->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_183->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_187 = op; qoz_TypeExpr* _qoz_mv_187 = NULL; switch (_qoz_ms_187->tag) { case qoz_UnaryOp_UOpAddr: { _qoz_mv_187 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_infer_value_te(e, rhs)));  break; } case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_175;
    {
        qoz_TypeExpr* inner = qoz_emit_infer_value_te(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_188 = inner; qoz_TypeExpr* _qoz_mv_188 = NULL; switch (_qoz_ms_188->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_188->payload.TEPtr.f1; _qoz_mv_188 = (t);  break; } default: { qoz_TypeExpr* _qoz_bv_176;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("let-binding dereferences a non-pointer"))); _qoz_bv_176 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_188 = (_qoz_bv_176);  break; } } _qoz_bv_175 = _qoz_mv_188;
    }
    _qoz_mv_187 = (_qoz_bv_175);  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_187 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_UnaryOp_UOpNeg: { _qoz_mv_187 = (qoz_emit_infer_value_te(e, rhs));  break; } } _qoz_mv_183 = (_qoz_mv_187);  break; } case qoz_Expr_EBinary: { qoz_Span sp = _qoz_ms_183->payload.EBinary.f0; qoz_BinaryOp* op = _qoz_ms_183->payload.EBinary.f1; qoz_Expr* l = _qoz_ms_183->payload.EBinary.f2; qoz_BinaryOp* _qoz_ms_189 = op; qoz_TypeExpr* _qoz_mv_189 = NULL; switch (_qoz_ms_189->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_189 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_189 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_189 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_189 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_189 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_189 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_189 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_189 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("bool")));  break; } default: { _qoz_mv_189 = (qoz_emit_infer_value_te(e, l));  break; } } _qoz_mv_183 = (_qoz_mv_189);  break; } case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_183->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_183->payload.EBlock.f2; qoz_TypeExpr* _qoz_bv_177;
    {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_ingest_stmt_locals(e, s); } }_qoz_bv_177 = qoz_emit_infer_value_te(e, tail);
    }
    _qoz_mv_183 = (_qoz_bv_177);  break; } case qoz_Expr_EIf: { qoz_Expr* t = _qoz_ms_183->payload.EIf.f2; _qoz_mv_183 = (qoz_emit_infer_value_te(e, t));  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_183->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_183->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_183->payload.EMatch.f2; qoz_TypeExpr* _qoz_bv_178;
    {
        if ((arms.len) == 0) { (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("match expression with no arms"))); return qoz_make_TypeExpr_TEUnit(sp);} qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); qoz_string enum_name = ((qoz_string_eq(bare_enum, QOZ_STR_LIT(""))) ? bare_enum : qoz_emit_enum_lookup_name(e, scrut, bare_enum)); qoz_emit_bind_arm_locals(e, enum_name, arms.data[0].pat); _qoz_bv_178 = qoz_emit_infer_value_te(e, arms.data[0].body);
    }
    _qoz_mv_183 = (_qoz_bv_178);  break; } case qoz_Expr_ESizeOf: { qoz_Span sp = _qoz_ms_183->payload.ESizeOf.f0; _qoz_mv_183 = (qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } case qoz_Expr_ETuple: { qoz_Span sp = _qoz_ms_183->payload.ETuple.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_183->payload.ETuple.f1; qoz_TypeExpr* _qoz_bv_179;
    {
        qoz_Vec__qoz_TypeExpr ets = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Expr __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ets, qoz_emit_infer_value_te(e, el)); } }_qoz_bv_179 = qoz_make_TypeExpr_TETuple(sp, ets);
    }
    _qoz_mv_183 = (_qoz_bv_179);  break; } case qoz_Expr_EClosure: { qoz_Span sp = _qoz_ms_183->payload.EClosure.f0; qoz_Vec__qoz_ClosureParam cps = _qoz_ms_183->payload.EClosure.f1; qoz_TypeExpr* ret = _qoz_ms_183->payload.EClosure.f2; qoz_TypeExpr* _qoz_bv_180;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_ClosureParam __col = cps; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_ClosureParam cp = __col.data[__i]; (void)cp; qoz_vec_push__qoz_TypeExpr(&pte, cp.ty); } }_qoz_bv_180 = qoz_make_TypeExpr_TEFn(sp, pte, ret);
    }
    _qoz_mv_183 = (_qoz_bv_180);  break; } case qoz_Expr_ETry: { qoz_Span sp = _qoz_ms_183->payload.ETry.f0; qoz_Expr* value = _qoz_ms_183->payload.ETry.f1; qoz_TypeExpr* _qoz_bv_181;
    {
        qoz_TypeExpr* inner = qoz_emit_infer_value_te(e, value); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_190 = inner; qoz_TypeExpr* _qoz_mv_190 = NULL; switch (_qoz_ms_190->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_190->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_190->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_182;
    {
        if ((args.len) == 2) { if ((path.len) > 0) { qoz_string last = path.data[(path.len) - 1]; if (qoz_string_eq(last, QOZ_STR_LIT("Result"))) { return args.data[0];} } } _qoz_bv_182 = inner;
    }
    _qoz_mv_190 = (_qoz_bv_182);  break; } default: { _qoz_mv_190 = (inner);  break; } } _qoz_bv_181 = _qoz_mv_190;
    }
    _qoz_mv_183 = (_qoz_bv_181);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_183->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_183->payload.EArrayLit.f1; qoz_TypeExpr* _qoz_bv_183;
    {
        if ((elems.len) == 0) { (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("empty array literal: element type cannot be inferred"))); return qoz_make_TypeExpr_TEUnit(sp);} qoz_TypeExpr* elem_te = qoz_emit_infer_value_te(e, elems.data[0]); qoz_gc_push_root(&elem_te); qoz_Vec__qoz_TypeExpr args = qoz_vec_make__qoz_TypeExpr(); qoz_vec_push__qoz_TypeExpr(&args, elem_te); qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("Vec")); _qoz_bv_183 = qoz_make_TypeExpr_TENamed(sp, path, args);
    }
    _qoz_mv_183 = (_qoz_bv_183);  break; } case qoz_Expr_EAssign: { qoz_Span sp = _qoz_ms_183->payload.EAssign.f0; _qoz_mv_183 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EWhile: { qoz_Span sp = _qoz_ms_183->payload.EWhile.f0; _qoz_mv_183 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EFor: { qoz_Span sp = _qoz_ms_183->payload.EFor.f0; _qoz_mv_183 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EReturn: { qoz_Span sp = _qoz_ms_183->payload.EReturn.f0; _qoz_mv_183 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EDefer: { qoz_Span sp = _qoz_ms_183->payload.EDefer.f0; _qoz_mv_183 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Expr_EPath: { qoz_Span sp = _qoz_ms_183->payload.EPath.f0; qoz_TypeExpr* _qoz_bv_184;
    {
        (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("EPath in value position is not supported (expected pkg.fn or a record name)"))); _qoz_bv_184 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_183 = (_qoz_bv_184);  break; } default: { qoz_TypeExpr* _qoz_bv_185;
    {
        (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(v), QOZ_STR_LIT("let-binding value shape not handled by inference"))); _qoz_bv_185 = qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(v));
    }
    _qoz_mv_183 = (_qoz_bv_185);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_183;
}
...
qoz_Vec__qoz_TypeExpr qoz_emit_literal_variant_type_args(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, qoz_Vec__qoz_Expr args, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_TypeExpr out = qoz_vec_make__qoz_TypeExpr(); qoz_Vec__qoz_TypeExpr empty = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Decl* _qoz_ms_191 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, enum_name); qoz_Vec__qoz_TypeExpr _qoz_mv_191 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_191->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_191 = (empty);  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_191->payload.Some.f0; qoz_Decl* _qoz_ms_192 = d; qoz_Vec__qoz_TypeExpr _qoz_mv_192 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_192->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_192->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_192->payload.DEnum.f3; qoz_Vec__qoz_TypeExpr _qoz_bv_186;
    {
        if ((tparams.len) == 0) { return empty;} qoz_Map__qoz_string__qoz_TypeExpr bindings = qoz_map_make__qoz_string__qoz_TypeExpr(); bool resolved_all = true; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_string_eq(v.name, variant)) { int64_t i = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pos_te = __col.data[__i]; (void)pos_te; if (i < (args.len)) { qoz_Option__qoz_TypeExpr* _qoz_ms_193 = qoz_emit_literal_typeexpr(args.data[i]); switch (_qoz_ms_193->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* arg_te = _qoz_ms_193->payload.Some.f0; qoz_emit_unify_te(pos_te, arg_te, &bindings);  break; } case qoz_Option__qoz_TypeExpr_None: { resolved_all = false;  break; } } 0; } i = i + 1; } }} } }if (!resolved_all) { return empty;} { qoz_Vec__qoz_string __col = tparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string tp = __col.data[__i]; (void)tp; qoz_Option__qoz_TypeExpr* _qoz_ms_194 = qoz_map_get__qoz_string__qoz_TypeExpr(&bindings, tp); switch (_qoz_ms_194->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_194->payload.Some.f0; qoz_vec_push__qoz_TypeExpr(&out, t);  break; } case qoz_Option__qoz_TypeExpr_None: { NULL;  break; } } 0; } }if ((out.len) != (tparams.len)) { return empty;} _qoz_bv_186 = out;
    }
    _qoz_mv_192 = (_qoz_bv_186);  break; } default: { _qoz_mv_192 = (empty);  break; } } _qoz_mv_191 = (_qoz_mv_192);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_191;
}

qoz_Vec__qoz_TypeExpr qoz_emit_infer_variant_type_args(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, qoz_Vec__qoz_Expr args, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_TypeExpr out = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Decl* _qoz_ms_195 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, enum_name); qoz_Vec__qoz_TypeExpr _qoz_mv_195 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_195->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_195 = (out);  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_195->payload.Some.f0; qoz_Decl* _qoz_ms_196 = d; qoz_Vec__qoz_TypeExpr _qoz_mv_196 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_196->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_196->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_196->payload.DEnum.f3; qoz_Vec__qoz_TypeExpr _qoz_bv_187;
    {
        if ((tparams.len) == 0) { return out;} qoz_Map__qoz_string__qoz_TypeExpr bindings = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_string_eq(v.name, variant)) { int64_t i = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pos_te = __col.data[__i]; (void)pos_te; if (i < (args.len)) { qoz_TypeExpr* arg_te = qoz_emit_infer_value_te(e, args.data[i]); qoz_gc_push_root(&arg_te); qoz_emit_unify_te(pos_te, arg_te, &bindings); } i = i + 1; } }} } }{ qoz_Vec__qoz_string __col = tparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string tp = __col.data[__i]; (void)tp; qoz_Option__qoz_TypeExpr* _qoz_ms_197 = qoz_map_get__qoz_string__qoz_TypeExpr(&bindings, tp); switch (_qoz_ms_197->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_197->payload.Some.f0; qoz_vec_push__qoz_TypeExpr(&out, t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_vec_push__qoz_TypeExpr(&out, qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64")));  break; } } 0; } }_qoz_bv_187 = out;
    }
    _qoz_mv_196 = (_qoz_bv_187);  break; } default: { _qoz_mv_196 = (out);  break; } } _qoz_mv_195 = (_qoz_mv_196);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_195;
}
...
void qoz_emit_unify_te(qoz_TypeExpr* pattern, qoz_TypeExpr* concrete, qoz_Map__qoz_string__qoz_TypeExpr* env) {
    ...
    qoz_gc_push_root(&concrete);
    qoz_gc_push_root(&env);
    qoz_TypeExpr* _qoz_ms_198 = pattern; switch (_qoz_ms_198->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_198->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr p_args = _qoz_ms_198->payload.TENamed.f2; {
        if (((path.len) == 1) && ((p_args.len) == 0)) { qoz_string n = path.data[0]; if (qoz_emit_is_type_var_name(n)) { if (!qoz_map_contains__qoz_string__qoz_TypeExpr(env, n)) { qoz_map_set__qoz_string__qoz_TypeExpr(env, n, concrete); } return;} } qoz_TypeExpr* _qoz_ms_199 = concrete; switch (_qoz_ms_199->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string c_path = _qoz_ms_199->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr c_args = _qoz_ms_199->payload.TENamed.f2; if ((p_args.len) == (c_args.len)) { int64_t i = 0; while (i < (p_args.len)) { qoz_emit_unify_te(p_args.data[i], c_args.data[i], env); i = i + 1; } } 0;  break; } default: { NULL;  break; } } 0; 
    }
    0;  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* p_inner = _qoz_ms_198->payload.TEPtr.f1; qoz_TypeExpr* _qoz_ms_200 = concrete; switch (_qoz_ms_200->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* c_inner = _qoz_ms_200->payload.TEPtr.f1; qoz_emit_unify_te(p_inner, c_inner, env);  break; } default: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
qoz_TypeExpr* qoz_emit_call_return_te(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_Span sp) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_string name = qoz_emit_generic_callee_name(e, callee); if (qoz_string_eq(name, QOZ_STR_LIT(""))) { (void)(qoz_emit_emit_die(sp, QOZ_STR_LIT("could not derive return type: callee has no recognisable name"))); return qoz_make_TypeExpr_TEUnit(sp);} if (qoz_string_eq(name, QOZ_STR_LIT("len"))) { return qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64"));} if (qoz_string_eq(name, QOZ_STR_LIT("size_of"))) { return qoz_emit_single_named_te(sp, QOZ_STR_LIT("i64"));} if (qoz_string_eq(name, QOZ_STR_LIT("hash"))) { return qoz_emit_single_named_te(sp, QOZ_STR_LIT("u64"));} qoz_Option__qoz_string* _qoz_ms_201 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_201->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_201->payload.Some.f0; {
    ...
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; qoz_Option__qoz_Decl* _qoz_ms_202 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_fn_decls, name); qoz_TypeExpr* _qoz_mv_202 = NULL; switch (_qoz_ms_202->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_202->payload.Some.f0; qoz_Decl* _qoz_ms_203 = d; qoz_TypeExpr* _qoz_mv_203 = NULL; switch (_qoz_ms_203->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_203->payload.DFn.f2; qoz_TypeExpr* ret = _qoz_ms_203->payload.DFn.f4; qoz_TypeExpr* _qoz_bv_188;
    {
        if (((type_args.len) == (tparams.len)) && ((tparams.len) > 0)) { return qoz_emit_substitute_type(e, ret, tparams, type_args);} _qoz_bv_188 = ret;
    }
    _qoz_mv_203 = (_qoz_bv_188);  break; } default: { qoz_TypeExpr* _qoz_bv_189;
    {
        qoz_string _qoz_bv_190;
    {
        qoz_Strbuf _qoz_sb_1996_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_1996_34); qoz_strings_sb_append(&_qoz_sb_1996_34, QOZ_STR_LIT("`")); qoz_strings_sb_append(&_qoz_sb_1996_34, name); qoz_strings_sb_append(&_qoz_sb_1996_34, QOZ_STR_LIT("` is in generic_fn_decls but not a DFn")); _qoz_bv_190 = qoz_strings_sb_finish(&_qoz_sb_1996_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_190)); _qoz_bv_189 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_203 = (_qoz_bv_189);  break; } } _qoz_mv_202 = (_qoz_mv_203);  break; } case qoz_Option__qoz_Decl_None: { qoz_Option__qoz_TypeExpr* _qoz_ms_204 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->fn_returns, name); qoz_TypeExpr* _qoz_mv_204 = NULL; switch (_qoz_ms_204->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_204->payload.Some.f0; _qoz_mv_204 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_191;
    {
        qoz_string _qoz_bv_192;
    {
        qoz_Strbuf _qoz_sb_2005_34 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2005_34); qoz_strings_sb_append(&_qoz_sb_2005_34, QOZ_STR_LIT("call to unknown function `")); qoz_strings_sb_append(&_qoz_sb_2005_34, name); qoz_strings_sb_append(&_qoz_sb_2005_34, QOZ_STR_LIT("` (no DFn, DExternal, or builtin matched)")); _qoz_bv_192 = qoz_strings_sb_finish(&_qoz_sb_2005_34);
    }
    (void)(qoz_emit_emit_die(sp, _qoz_bv_192)); _qoz_bv_191 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_204 = (_qoz_bv_191);  break; } } _qoz_mv_202 = (_qoz_mv_204);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_202;
}
...
void qoz_emit_emit_stmt_inner(qoz_Emitter* e, qoz_Stmt* s) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&s);
    qoz_Stmt* _qoz_ms_205 = s; switch (_qoz_ms_205->tag) { case qoz_Stmt_SLet: { qoz_string name = _qoz_ms_205->payload.SLet.f1; qoz_TypeExpr* ty = _qoz_ms_205->payload.SLet.f2; qoz_Expr* value = _qoz_ms_205->payload.SLet.f3; {
        qoz_TypeExpr* bind_te = qoz_emit_binding_te(e, ty, value); qoz_gc_push_root(&bind_te); if (qoz_string_eq(name, QOZ_STR_LIT("_"))) { qoz_emit_push(e, QOZ_STR_LIT("(void)(")); qoz_emit_emit_value_with_hint(e, value, bind_te); qoz_emit_push(e, QOZ_STR_LIT("); ")); return;} qoz_string ct = qoz_emit_infer_value_ctype(e, ty, value); qoz_string _qoz_bv_193;
    {
        qoz_Strbuf _qoz_sb_2074_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2074_17); qoz_strings_sb_append(&_qoz_sb_2074_17, ct); qoz_strings_sb_append(&_qoz_sb_2074_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_2074_17, name); qoz_strings_sb_append(&_qoz_sb_2074_17, QOZ_STR_LIT(" = ")); _qoz_bv_193 = qoz_strings_sb_finish(&_qoz_sb_2074_17);
    }
    qoz_emit_push(e, _qoz_bv_193); qoz_emit_emit_value_with_hint(e, value, bind_te); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (qoz_emit_c_type_is_pointer(ct)) { qoz_string _qoz_bv_194;
    {
        qoz_Strbuf _qoz_sb_2078_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2078_21); qoz_strings_sb_append(&_qoz_sb_2078_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_2078_21, name); qoz_strings_sb_append(&_qoz_sb_2078_21, QOZ_STR_LIT("); ")); _qoz_bv_194 = qoz_strings_sb_finish(&_qoz_sb_2078_21);
    }
    qoz_emit_push(e, _qoz_bv_194); } qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, bind_te); 
    }
    0;  break; } case qoz_Stmt_SVar: { qoz_string name = _qoz_ms_205->payload.SVar.f1; qoz_TypeExpr* ty = _qoz_ms_205->payload.SVar.f2; qoz_Expr* value = _qoz_ms_205->payload.SVar.f3; {
        qoz_TypeExpr* bind_te = qoz_emit_binding_te(e, ty, value); qoz_gc_push_root(&bind_te); if (qoz_string_eq(name, QOZ_STR_LIT("_"))) { qoz_emit_push(e, QOZ_STR_LIT("(void)(")); qoz_emit_emit_value_with_hint(e, value, bind_te); qoz_emit_push(e, QOZ_STR_LIT("); ")); return;} qoz_string ct = qoz_emit_infer_value_ctype(e, ty, value); qoz_string _qoz_bv_195;
    {
        qoz_Strbuf _qoz_sb_2091_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2091_17); qoz_strings_sb_append(&_qoz_sb_2091_17, ct); qoz_strings_sb_append(&_qoz_sb_2091_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_2091_17, name); qoz_strings_sb_append(&_qoz_sb_2091_17, QOZ_STR_LIT(" = ")); _qoz_bv_195 = qoz_strings_sb_finish(&_qoz_sb_2091_17);
    }
    qoz_emit_push(e, _qoz_bv_195); qoz_emit_emit_value_with_hint(e, value, bind_te); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (qoz_emit_c_type_is_pointer(ct)) { qoz_string _qoz_bv_196;
    {
        qoz_Strbuf _qoz_sb_2095_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2095_21); qoz_strings_sb_append(&_qoz_sb_2095_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_2095_21, name); qoz_strings_sb_append(&_qoz_sb_2095_21, QOZ_STR_LIT("); ")); _qoz_bv_196 = qoz_strings_sb_finish(&_qoz_sb_2095_21);
    }
    qoz_emit_push(e, _qoz_bv_196); } qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, bind_te); 
    }
    0;  break; } case qoz_Stmt_SExpr: { qoz_Expr* expr = _qoz_ms_205->payload.SExpr.f1; qoz_Expr* _qoz_ms_206 = expr; switch (_qoz_ms_206->tag) { case qoz_Expr_EDefer: { NULL;  break; } default: { qoz_emit_emit_stmt_expr(e, expr);  break; } } 0;  break; } } 0; 
    return;
}

qoz_Vec__qoz_Expr qoz_emit_collect_defers_in_stmts(qoz_Vec__qoz_Stmt stmts) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_Vec__qoz_Expr defers = qoz_vec_make__qoz_Expr(); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_Stmt* _qoz_ms_207 = s; switch (_qoz_ms_207->tag) { case qoz_Stmt_SExpr: { qoz_Expr* expr = _qoz_ms_207->payload.SExpr.f1; qoz_Expr* _qoz_ms_208 = expr; switch (_qoz_ms_208->tag) { case qoz_Expr_EDefer: { qoz_Expr* body = _qoz_ms_208->payload.EDefer.f1; qoz_vec_push__qoz_Expr(&defers, body);  break; } default: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return defers;
}
...
void qoz_emit_emit_cond(qoz_Emitter* e, qoz_Expr* cond) {
    ...
    qoz_emit_push(e, QOZ_STR_LIT("(")); qoz_Expr* _qoz_ms_209 = cond; switch (_qoz_ms_209->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_209->payload.EBinary.f1; qoz_Expr* lhs = _qoz_ms_209->payload.EBinary.f2; qoz_Expr* rhs = _qoz_ms_209->payload.EBinary.f3; qoz_emit_emit_binary(e, op, lhs, rhs);  break; } default: { qoz_emit_emit_expr(e, cond);  break; } } 0; qoz_emit_push(e, QOZ_STR_LIT(")")); 
    return;
}
...
void qoz_emit_emit_stmt_expr(qoz_Emitter* e, qoz_Expr* expr) {
    ...
    qoz_Expr* _qoz_ms_210 = expr; switch (_qoz_ms_210->tag) { case qoz_Expr_EIf: { qoz_Expr* cond = _qoz_ms_210->payload.EIf.f1; qoz_Expr* then_b = _qoz_ms_210->payload.EIf.f2; qoz_Expr* else_b = _qoz_ms_210->payload.EIf.f3; {
    ...
    0;  break; } case qoz_Expr_EWhile: { qoz_Expr* cond = _qoz_ms_210->payload.EWhile.f1; qoz_Expr* body = _qoz_ms_210->payload.EWhile.f2; {
    ...
    0;  break; } case qoz_Expr_EFor: { qoz_string binding = _qoz_ms_210->payload.EFor.f1; qoz_string binding2 = _qoz_ms_210->payload.EFor.f2; qoz_Expr* iter = _qoz_ms_210->payload.EFor.f3; qoz_Expr* body = _qoz_ms_210->payload.EFor.f4; qoz_emit_emit_for_loop_one(e, binding, binding2, iter, body);  break; } case qoz_Expr_EReturn: { qoz_Expr* value = _qoz_ms_210->payload.EReturn.f1; if (qoz_emit_is_nil_expr(value)) { qoz_emit_push(e, QOZ_STR_LIT("return;")); }  else { qoz_emit_push(e, QOZ_STR_LIT("return ")); qoz_emit_emit_value_with_hint(e, value, e->current_ret_te); qoz_emit_push(e, QOZ_STR_LIT(";")); } 0;  break; } default: { {
...
void qoz_emit_emit_branch_as_statement(qoz_Emitter* e, qoz_Expr* br) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&br);
    qoz_Expr* _qoz_ms_211 = br; switch (_qoz_ms_211->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_211->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_211->payload.EBlock.f2; {
        qoz_emit_push(e, QOZ_STR_LIT("{ ")); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_emit_stmt(e, s); } }if (!qoz_emit_is_nil_expr(tail)) { qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved); } qoz_emit_push(e, QOZ_STR_LIT("} ")); 
    }
    0;  break; } default: { {
...
bool qoz_emit_path_is(qoz_Expr* callee, qoz_string a, qoz_string b) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_212 = callee; bool _qoz_mv_212 = false; switch (_qoz_ms_212->tag) { case qoz_Expr_EPath: { qoz_Vec__qoz_string segs = _qoz_ms_212->payload.EPath.f1; _qoz_mv_212 = ((((segs.len) == 2) && qoz_string_eq(segs.data[0], a)) && qoz_string_eq(segs.data[1], b));  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_212->payload.EField.f1; qoz_string name = _qoz_ms_212->payload.EField.f2; _qoz_mv_212 = (qoz_string_eq(name, b) && qoz_emit_ident_is(base, a));  break; } default: { _qoz_mv_212 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_212;
}

bool qoz_emit_ident_is(qoz_Expr* ex, qoz_string name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_213 = ex; bool _qoz_mv_213 = false; switch (_qoz_ms_213->tag) { case qoz_Expr_EIdent: { qoz_string n = _qoz_ms_213->payload.EIdent.f1; _qoz_mv_213 = (qoz_string_eq(n, name));  break; } default: { _qoz_mv_213 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_213;
}
...
qoz_string qoz_emit_qualified_call_name(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_214 = callee; qoz_string _qoz_mv_214 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_214->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_214->payload.EField.f1; qoz_string method = _qoz_ms_214->payload.EField.f2; qoz_Expr* _qoz_ms_215 = base; qoz_string _qoz_mv_215 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_215->tag) { case qoz_Expr_EIdent: { qoz_string pkg = _qoz_ms_215->payload.EIdent.f1; qoz_string _qoz_bv_197;
    {
        if (qoz_map_contains__qoz_string__bool(&e->packages, pkg)) { return qoz_string_cat(qoz_string_cat(pkg, QOZ_STR_LIT("_")), method);} _qoz_bv_197 = QOZ_STR_LIT("");
    }
    _qoz_mv_215 = (_qoz_bv_197);  break; } default: { _qoz_mv_215 = (QOZ_STR_LIT(""));  break; } } _qoz_mv_214 = (_qoz_mv_215);  break; } default: { _qoz_mv_214 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_214;
}
...
qoz_string qoz_emit_match_result_ctype(qoz_Emitter* e, qoz_string enum_name, qoz_Vec__qoz_MatchArm arms) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    bool all_void = true; { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; qoz_emit_bind_arm_locals(e, enum_name, arm.pat); qoz_string ct = qoz_emit_arm_body_ctype(e, enum_name, arm.body); if (!qoz_string_eq(ct, QOZ_STR_LIT("void"))) { all_void = false; } if (!qoz_string_eq(ct, QOZ_STR_LIT("int64_t")) && !qoz_string_eq(ct, QOZ_STR_LIT("void"))) { return ct;} } }if (all_void) { return QOZ_STR_LIT("void");} qoz_gc_shadow_set_top(_qoz_shadow_guard); return QOZ_STR_LIT("int64_t");
}
...
qoz_string qoz_emit_arm_body_ctype(qoz_Emitter* e, qoz_string enum_name, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_216 = body; qoz_string _qoz_mv_216 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_216->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_216->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_217 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_217 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_217->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_217->payload.Some.f0; qoz_string _qoz_bv_198;
    {
        if (qoz_emit_same_enum_base(e, en, enum_name)) { return qoz_string_cat(qoz_string_cat(QOZ_STR_LIT("qoz_"), enum_name), QOZ_STR_LIT("*"));} _qoz_bv_198 = qoz_string_cat(qoz_string_cat(QOZ_STR_LIT("qoz_"), en), QOZ_STR_LIT("*"));
    }
    _qoz_mv_217 = (_qoz_bv_198);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_217 = (qoz_emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_216 = (_qoz_mv_217);  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_216->payload.ECall.f1; qoz_Expr* _qoz_ms_218 = callee; qoz_string _qoz_mv_218 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_218->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_218->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_219 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); qoz_string _qoz_mv_219 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_219->tag) { case qoz_Option__qoz_string_Some: { qoz_string en = _qoz_ms_219->payload.Some.f0; qoz_string _qoz_bv_199;
    {
        if (qoz_emit_same_enum_base(e, en, enum_name)) { return qoz_string_cat(qoz_string_cat(QOZ_STR_LIT("qoz_"), enum_name), QOZ_STR_LIT("*"));} _qoz_bv_199 = qoz_string_cat(qoz_string_cat(QOZ_STR_LIT("qoz_"), en), QOZ_STR_LIT("*"));
    }
    _qoz_mv_219 = (_qoz_bv_199);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_219 = (qoz_emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_218 = (_qoz_mv_219);  break; } default: { _qoz_mv_218 = (qoz_emit_infer_expr_ctype(e, body));  break; } } _qoz_mv_216 = (_qoz_mv_218);  break; } default: { _qoz_mv_216 = (qoz_emit_infer_expr_ctype(e, body));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_216;
}

bool qoz_emit_same_enum_base(qoz_Emitter* e, qoz_string bare, qoz_string maybe_mangled) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    if (qoz_string_eq(bare, maybe_mangled)) { return true;} qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_string_eq(qoz_emit_strip_mangled(maybe_mangled), bare);
}
...
void qoz_emit_bind_arm_locals(qoz_Emitter* e, qoz_string enum_name, qoz_Pattern* pat) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&pat);
    qoz_Pattern* _qoz_ms_220 = pat; switch (_qoz_ms_220->tag) { case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_220->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_220->payload.PatVariant.f2; {
        if ((path.len) < 1) { return;} qoz_string vname = path.data[(path.len) - 1]; int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_221 = sp; switch (_qoz_ms_221->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_221->payload.PatBind.f1; (qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, qoz_emit_variant_payload_typeexpr(e, enum_name, vname, i)), 0);  break; } default: { NULL;  break; } } 0; i = i + 1; } }
    }
    0;  break; } case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_220->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_222 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, bname); switch (_qoz_ms_222->tag) { case qoz_Option__qoz_string_Some: { NULL;  break; } case qoz_Option__qoz_string_None: { {
...
void qoz_emit_emit_field(qoz_Emitter* e, qoz_Expr* base, qoz_string name) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_223 = base; switch (_qoz_ms_223->tag) { case qoz_Expr_EIdent: { qoz_string enum_name = _qoz_ms_223->payload.EIdent.f1; if (qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, enum_name)) { qoz_Option__qoz_string* _qoz_ms_224 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_224->tag) { case qoz_Option__qoz_string_Some: { {
        qoz_string _qoz_bv_200;
    {
        qoz_Strbuf _qoz_sb_2357_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2357_25); qoz_strings_sb_append(&_qoz_sb_2357_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_2357_25, enum_name); qoz_strings_sb_append(&_qoz_sb_2357_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_2357_25, name); qoz_strings_sb_append(&_qoz_sb_2357_25, QOZ_STR_LIT("()")); _qoz_bv_200 = qoz_strings_sb_finish(&_qoz_sb_2357_25);
    }
    qoz_emit_push(e, _qoz_bv_200); return;
    }
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } 0;  break; } default: { NULL;  break; } } 0; qoz_string op = qoz_emit_field_access_op(e, base); qoz_emit_emit_expr(e, base); qoz_string _qoz_bv_201;
    {
        qoz_Strbuf _qoz_sb_2368_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2368_13); qoz_strings_sb_append(&_qoz_sb_2368_13, op); qoz_strings_sb_append(&_qoz_sb_2368_13, name); _qoz_bv_201 = qoz_strings_sb_finish(&_qoz_sb_2368_13);
    }
    qoz_emit_push(e, _qoz_bv_201); 
    return;
}
...
qoz_string qoz_emit_field_access_op(qoz_Emitter* e, qoz_Expr* base) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base);
    qoz_Expr* _qoz_ms_225 = base; qoz_string _qoz_mv_225 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_225->tag) { case qoz_Expr_EIdent: { qoz_string ident = _qoz_ms_225->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_226 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, ident); qoz_string _qoz_mv_226 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_226->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_226->payload.Some.f0; qoz_TypeExpr* _qoz_ms_227 = te; qoz_string _qoz_mv_227 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_227->tag) { case qoz_TypeExpr_TEPtr: { _qoz_mv_227 = (QOZ_STR_LIT("->"));  break; } default: { _qoz_mv_227 = (QOZ_STR_LIT("."));  break; } } _qoz_mv_226 = (_qoz_mv_227);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_226 = (QOZ_STR_LIT("."));  break; } } _qoz_mv_225 = (_qoz_mv_226);  break; } case qoz_Expr_EUnary: { qoz_UnaryOp* op = _qoz_ms_225->payload.EUnary.f1; qoz_UnaryOp* _qoz_ms_228 = op; qoz_string _qoz_mv_228 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_228->tag) { case qoz_UnaryOp_UOpAddr: { _qoz_mv_228 = (QOZ_STR_LIT("->"));  break; } default: { _qoz_mv_228 = (QOZ_STR_LIT("."));  break; } } _qoz_mv_225 = (_qoz_mv_228);  break; } default: { _qoz_mv_225 = (QOZ_STR_LIT("."));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_225;
}
...
void qoz_emit_walk_assign_for_map_helpers(qoz_Emitter* e, qoz_Expr* lhs) {
    ...
    qoz_Expr* _qoz_ms_229 = lhs; switch (_qoz_ms_229->tag) { case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_229->payload.EIndex.f1; {
        qoz_TypeExpr* bte = qoz_emit_base_type_for_walk(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_230 = bte; switch (_qoz_ms_230->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_230->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_230->payload.TENamed.f2; if ((((path.len) >= 1) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) && ((args.len) == 2)) { qoz_emit_register_map_helper(e, QOZ_STR_LIT("map_set"), args); } 0;  break; } default: { NULL;  break; } } 0; 
    }
    0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
qoz_TypeExpr* qoz_emit_base_type_for_walk(qoz_Emitter* e, qoz_Expr* ex) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_231 = ex; qoz_TypeExpr* _qoz_mv_231 = NULL; switch (_qoz_ms_231->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_231->payload.EIdent.f0; qoz_string name = _qoz_ms_231->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_232 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_232 = NULL; switch (_qoz_ms_232->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_232->payload.Some.f0; _qoz_mv_232 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_232 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_231 = (_qoz_mv_232);  break; } case qoz_Expr_EField: { qoz_Span sp = _qoz_ms_231->payload.EField.f0; qoz_Expr* b = _qoz_ms_231->payload.EField.f1; qoz_string name = _qoz_ms_231->payload.EField.f2; qoz_TypeExpr* _qoz_bv_202;
    {
        qoz_TypeExpr* bte = qoz_emit_base_type_for_walk(e, b); qoz_gc_push_root(&bte); _qoz_bv_202 = qoz_emit_field_typeexpr_for_no_die(e, bte, name, sp);
    }
    _qoz_mv_231 = (_qoz_bv_202);  break; } case qoz_Expr_EUnary: { qoz_Span sp = _qoz_ms_231->payload.EUnary.f0; qoz_UnaryOp* op = _qoz_ms_231->payload.EUnary.f1; qoz_Expr* rhs = _qoz_ms_231->payload.EUnary.f2; qoz_UnaryOp* _qoz_ms_233 = op; qoz_TypeExpr* _qoz_mv_233 = NULL; switch (_qoz_ms_233->tag) { case qoz_UnaryOp_UOpDeref: { qoz_TypeExpr* _qoz_bv_203;
    {
        qoz_TypeExpr* inner = qoz_emit_base_type_for_walk(e, rhs); qoz_gc_push_root(&inner); qoz_TypeExpr* _qoz_ms_234 = inner; qoz_TypeExpr* _qoz_mv_234 = NULL; switch (_qoz_ms_234->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* t = _qoz_ms_234->payload.TEPtr.f1; _qoz_mv_234 = (t);  break; } default: { _qoz_mv_234 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_203 = _qoz_mv_234;
    }
    _qoz_mv_233 = (_qoz_bv_203);  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_233 = (qoz_make_TypeExpr_TEPtr(sp, qoz_emit_base_type_for_walk(e, rhs)));  break; } default: { _qoz_mv_233 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_231 = (_qoz_mv_233);  break; } default: { _qoz_mv_231 = (qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(ex)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_231;
}
...
qoz_TypeExpr* qoz_emit_field_typeexpr_for_no_die(qoz_Emitter* e, qoz_TypeExpr* base_te, qoz_string field, qoz_Span sp) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&base_te);
    qoz_TypeExpr* _qoz_ms_235 = base_te; qoz_TypeExpr* _qoz_mv_235 = NULL; switch (_qoz_ms_235->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_235->payload.TEPtr.f1; _qoz_mv_235 = (inner);  break; } default: { _qoz_mv_235 = (base_te);  break; } } qoz_TypeExpr* unwrapped = _qoz_mv_235; qoz_gc_push_root(&unwrapped); qoz_TypeExpr* _qoz_ms_236 = unwrapped; qoz_TypeExpr* _qoz_mv_236 = NULL; switch (_qoz_ms_236->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_236->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_236->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_204;
    {
        if ((path.len) < 1) { return qoz_make_TypeExpr_TEUnit(sp);} qoz_string lookup = qoz_emit_type_lookup_key(e, path); qoz_Option__qoz_Decl* _qoz_ms_237 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, lookup); qoz_Option__qoz_Decl* _qoz_mv_237 = NULL; switch (_qoz_ms_237->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_237->payload.Some.f0; _qoz_mv_237 = (qoz_make_Option__qoz_Decl_Some(d));  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_237 = (qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, lookup));  break; } } qoz_Option__qoz_Decl* decl_opt = _qoz_mv_237; qoz_gc_push_root(&decl_opt); qoz_Option__qoz_Decl* _qoz_ms_238 = decl_opt; qoz_TypeExpr* _qoz_mv_238 = NULL; switch (_qoz_ms_238->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_238->payload.Some.f0; qoz_Decl* _qoz_ms_239 = decl; qoz_TypeExpr* _qoz_mv_239 = NULL; switch (_qoz_ms_239->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_239->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_239->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_205;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (qoz_string_eq(f.name, field)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, f.ty, params, args);} return f.ty;} } }_qoz_bv_205 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_239 = (_qoz_bv_205);  break; } default: { _qoz_mv_239 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_238 = (_qoz_mv_239);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_238 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_204 = _qoz_mv_238;
    }
    _qoz_mv_236 = (_qoz_bv_204);  break; } default: { _qoz_mv_236 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_236;
}

void qoz_emit_register_map_helper(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_TypeExpr args) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    if (!qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, name)) { return;} qoz_string mangled = qoz_emit_mangle_inst(e, name, args); if (qoz_map_contains__qoz_string__bool(&e->fn_seen, mangled)) { return;} qoz_map_set__qoz_string__bool(&e->fn_seen, mangled, true); qoz_vec_push__qoz_Instantiation(&e->fn_insts, ((qoz_Instantiation){ .name = name, .args = args, .mangled = mangled })); qoz_Option__qoz_Decl* _qoz_ms_240 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_fn_decls, name); switch (_qoz_ms_240->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_240->payload.Some.f0; qoz_emit_walk_fn_body_with_subst(e, d, args);  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; 
    return;
}
...
void qoz_emit_emit_assign(qoz_Emitter* e, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    qoz_gc_push_root(&lhs);
    qoz_gc_push_root(&rhs);
    qoz_Expr* _qoz_ms_241 = lhs; switch (_qoz_ms_241->tag) { case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_241->payload.EIndex.f1; qoz_Expr* idx = _qoz_ms_241->payload.EIndex.f2; {
        qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_242 = te; switch (_qoz_ms_242->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_242->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_242->payload.TENamed.f2; if ((((path.len) >= 1) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) && ((args.len) == 2)) { qoz_emit_register_map_helper(e, QOZ_STR_LIT("map_set"), args); qoz_string k_m = qoz_emit_mangle_type(e, args.data[0]); qoz_string v_m = qoz_emit_mangle_type(e, args.data[1]); qoz_string _qoz_bv_206;
    {
        qoz_Strbuf _qoz_sb_2509_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2509_25); qoz_strings_sb_append(&_qoz_sb_2509_25, QOZ_STR_LIT("qoz_map_set__")); qoz_strings_sb_append(&_qoz_sb_2509_25, k_m); qoz_strings_sb_append(&_qoz_sb_2509_25, QOZ_STR_LIT("__")); qoz_strings_sb_append(&_qoz_sb_2509_25, v_m); qoz_strings_sb_append(&_qoz_sb_2509_25, QOZ_STR_LIT("(&")); _qoz_bv_206 = qoz_strings_sb_finish(&_qoz_sb_2509_25);
    }
    qoz_emit_push(e, _qoz_bv_206); qoz_emit_emit_expr(e, base); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, idx); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, rhs); qoz_emit_push(e, QOZ_STR_LIT(")")); return;} 0;  break; } default: { NULL;  break; } } 0; 
    }
...
qoz_TypeExpr* qoz_emit_lvalue_hint(qoz_Emitter* e, qoz_Expr* lhs) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&lhs);
    qoz_Span sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_Expr* _qoz_ms_243 = lhs; qoz_TypeExpr* _qoz_mv_243 = NULL; switch (_qoz_ms_243->tag) { case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_243->payload.EField.f1; qoz_string name = _qoz_ms_243->payload.EField.f2; qoz_TypeExpr* _qoz_bv_207;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); _qoz_bv_207 = qoz_emit_field_typeexpr_for_no_die(e, bte, name, sp);
    }
    _qoz_mv_243 = (_qoz_bv_207);  break; } case qoz_Expr_EIndex: { qoz_Expr* base = _qoz_ms_243->payload.EIndex.f1; qoz_TypeExpr* _qoz_bv_208;
    {
        qoz_TypeExpr* bte = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&bte); qoz_TypeExpr* _qoz_ms_244 = bte; qoz_TypeExpr* _qoz_mv_244 = NULL; switch (_qoz_ms_244->tag) { case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_244->payload.TEPtr.f1; _qoz_mv_244 = (inner);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_244->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_244->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_209;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_209 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_244 = (_qoz_bv_209);  break; } default: { _qoz_mv_244 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_bv_208 = _qoz_mv_244;
    }
    _qoz_mv_243 = (_qoz_bv_208);  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_243->payload.EIdent.f1; qoz_Option__qoz_TypeExpr* _qoz_ms_245 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); qoz_TypeExpr* _qoz_mv_245 = NULL; switch (_qoz_ms_245->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_245->payload.Some.f0; _qoz_mv_245 = (te);  break; } case qoz_Option__qoz_TypeExpr_None: { _qoz_mv_245 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } _qoz_mv_243 = (_qoz_mv_245);  break; } default: { _qoz_mv_243 = (qoz_make_TypeExpr_TEUnit(sp));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_243;
}
...
void qoz_emit_emit_index(qoz_Emitter* e, qoz_Expr* base, qoz_Expr* idx) {
    ...
    qoz_gc_push_root(&base);
    qoz_gc_push_root(&idx);
    qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, base); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_246 = te; switch (_qoz_ms_246->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_246->payload.TENamed.f1; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_string_eq(n, QOZ_STR_LIT("Vec"))) { qoz_string op = qoz_emit_field_access_op(e, base); qoz_emit_emit_expr(e, base); qoz_string _qoz_bv_210;
    {
        qoz_Strbuf _qoz_sb_2569_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2569_25); qoz_strings_sb_append(&_qoz_sb_2569_25, op); qoz_strings_sb_append(&_qoz_sb_2569_25, QOZ_STR_LIT("data[")); _qoz_bv_210 = qoz_strings_sb_finish(&_qoz_sb_2569_25);
    }
    qoz_emit_push(e, _qoz_bv_210); qoz_emit_emit_expr(e, idx); qoz_emit_push(e, QOZ_STR_LIT("]")); return;} } 0;  break; } default: { NULL;  break; } } 0; qoz_emit_emit_expr(e, base); qoz_emit_push(e, QOZ_STR_LIT("[")); qoz_emit_emit_expr(e, idx); qoz_emit_push(e, QOZ_STR_LIT("]")); 
    return;
}
...
void qoz_emit_emit_hash_builtin(qoz_Emitter* e, qoz_Expr* arg) {
    ...
    qoz_string ct = qoz_emit_infer_expr_ctype(e, arg); if (qoz_string_eq(ct, QOZ_STR_LIT("qoz_string"))) { qoz_emit_push(e, QOZ_STR_LIT("qoz_string_hash(")); qoz_emit_emit_expr(e, arg); qoz_emit_push(e, QOZ_STR_LIT(")")); return;} qoz_string record_name = qoz_emit_record_struct_name_of_ctype(e, ct); if (!qoz_string_eq(record_name, QOZ_STR_LIT(""))) { qoz_string _qoz_bv_211;
    {
        qoz_Strbuf _qoz_sb_2593_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2593_17); qoz_strings_sb_append(&_qoz_sb_2593_17, QOZ_STR_LIT("qoz_hash_")); qoz_strings_sb_append(&_qoz_sb_2593_17, record_name); qoz_strings_sb_append(&_qoz_sb_2593_17, QOZ_STR_LIT("(")); _qoz_bv_211 = qoz_strings_sb_finish(&_qoz_sb_2593_17);
    }
    qoz_emit_push(e, _qoz_bv_211); qoz_emit_emit_expr(e, arg); qoz_emit_push(e, QOZ_STR_LIT(")")); return;} qoz_emit_push(e, QOZ_STR_LIT("(uint64_t)(")); qoz_emit_emit_expr(e, arg); qoz_emit_push(e, QOZ_STR_LIT(")")); 
    return;
}
...
void qoz_emit_emit_call(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_string qualified = qoz_emit_qualified_call_name(e, callee); if (!qoz_string_eq(qualified, QOZ_STR_LIT(""))) { if (((type_args.len) > 0) && qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, qualified)) { qoz_string mi = qoz_emit_mangle_inst(e, qualified, type_args); qoz_string _qoz_bv_212;
    {
        qoz_Strbuf _qoz_sb_2628_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2628_21); qoz_strings_sb_append(&_qoz_sb_2628_21, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_2628_21, mi); qoz_strings_sb_append(&_qoz_sb_2628_21, QOZ_STR_LIT("(")); _qoz_bv_212 = qoz_strings_sb_finish(&_qoz_sb_2628_21);
    }
    qoz_emit_push(e, _qoz_bv_212); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;} qoz_Option__qoz_string* _qoz_ms_247 = qoz_map_get__qoz_string__qoz_string(&e->externs, qualified); qoz_string _qoz_mv_247 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_247->tag) { case qoz_Option__qoz_string_Some: { qoz_string sym = _qoz_ms_247->payload.Some.f0; _qoz_mv_247 = (sym);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_247 = (qoz_emit_user_fn_c_name(qualified));  break; } } qoz_string dispatch_name = _qoz_mv_247; qoz_string _qoz_bv_213;
    {
        qoz_Strbuf _qoz_sb_2642_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2642_17); qoz_strings_sb_append(&_qoz_sb_2642_17, dispatch_name); qoz_strings_sb_append(&_qoz_sb_2642_17, QOZ_STR_LIT("(")); _qoz_bv_213 = qoz_strings_sb_finish(&_qoz_sb_2642_17);
    }
    qoz_emit_push(e, _qoz_bv_213); qoz_Vec__qoz_TypeExpr hints = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Vec__qoz_TypeExpr* _qoz_ms_248 = qoz_map_get__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, qualified); switch (_qoz_ms_248->tag) { case qoz_Option__qoz_Vec__qoz_TypeExpr_Some: { qoz_Vec__qoz_TypeExpr pts = _qoz_ms_248->payload.Some.f0; hints = pts;  break; } case qoz_Option__qoz_Vec__qoz_TypeExpr_None: { NULL;  break; } } 0; int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } if (i < (hints.len)) { qoz_emit_emit_value_with_hint(e, a, hints.data[i]); }  else { qoz_emit_emit_expr(e, a); } i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;} qoz_Expr* _qoz_ms_249 = callee; switch (_qoz_ms_249->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_249->payload.EIdent.f1; {
        if (qoz_string_eq(name, QOZ_STR_LIT("size_of")) && ((args.len) == 1)) { qoz_emit_push(e, QOZ_STR_LIT("(int64_t)sizeof(int64_t)")); return;} if (qoz_string_eq(name, QOZ_STR_LIT("len")) && ((args.len) == 1)) { qoz_emit_emit_len_builtin(e, args.data[0]); return;} if (qoz_string_eq(name, QOZ_STR_LIT("hash")) && ((args.len) == 1)) { qoz_emit_emit_hash_builtin(e, args.data[0]); return;} 
    }
    0;  break; } default: { NULL;  break; } } 0; qoz_string variant_name = qoz_emit_variant_callee_name(e, callee); if (!qoz_string_eq(variant_name, QOZ_STR_LIT(""))) { qoz_Option__qoz_string* _qoz_ms_250 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, variant_name); switch (_qoz_ms_250->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_250->payload.Some.f0; {
        qoz_string _qoz_bv_214;
    {
        qoz_Strbuf _qoz_sb_2686_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2686_21); qoz_strings_sb_append(&_qoz_sb_2686_21, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_2686_21, enum_name); qoz_strings_sb_append(&_qoz_sb_2686_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_2686_21, variant_name); qoz_strings_sb_append(&_qoz_sb_2686_21, QOZ_STR_LIT("(")); _qoz_bv_214 = qoz_strings_sb_finish(&_qoz_sb_2686_21);
    }
    qoz_emit_push(e, _qoz_bv_214); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0; } if ((type_args.len) > 0) { qoz_Expr* _qoz_ms_251 = callee; switch (_qoz_ms_251->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_251->payload.EIdent.f1; if (qoz_map_contains__qoz_string__qoz_Decl(&e->generic_fn_decls, name)) { qoz_string mi = qoz_emit_mangle_inst(e, name, type_args); qoz_string _qoz_bv_215;
    {
        qoz_Strbuf _qoz_sb_2705_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2705_25); qoz_strings_sb_append(&_qoz_sb_2705_25, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_2705_25, mi); qoz_strings_sb_append(&_qoz_sb_2705_25, QOZ_STR_LIT("(")); _qoz_bv_215 = qoz_strings_sb_finish(&_qoz_sb_2705_25);
    }
    qoz_emit_push(e, _qoz_bv_215); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;} 0;  break; } default: { NULL;  break; } } 0; } qoz_Expr* _qoz_ms_252 = callee; switch (_qoz_ms_252->tag) { case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_252->payload.EIdent.f1; qoz_Option__qoz_string* _qoz_ms_253 = qoz_map_get__qoz_string__qoz_string(&e->externs, name); switch (_qoz_ms_253->tag) { case qoz_Option__qoz_string_Some: { qoz_string sym = _qoz_ms_253->payload.Some.f0; {
        qoz_string _qoz_bv_216;
    {
        qoz_Strbuf _qoz_sb_2727_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2727_21); qoz_strings_sb_append(&_qoz_sb_2727_21, sym); qoz_strings_sb_append(&_qoz_sb_2727_21, QOZ_STR_LIT("(")); _qoz_bv_216 = qoz_strings_sb_finish(&_qoz_sb_2727_21);
    }
    qoz_emit_push(e, _qoz_bv_216); qoz_Vec__qoz_TypeExpr hints = qoz_vec_make__qoz_TypeExpr(); qoz_Option__qoz_Vec__qoz_TypeExpr* _qoz_ms_254 = qoz_map_get__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, name); switch (_qoz_ms_254->tag) { case qoz_Option__qoz_Vec__qoz_TypeExpr_Some: { qoz_Vec__qoz_TypeExpr pts = _qoz_ms_254->payload.Some.f0; hints = pts;  break; } case qoz_Option__qoz_Vec__qoz_TypeExpr_None: { NULL;  break; } } 0; int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } if (i < (hints.len)) { qoz_emit_emit_value_with_hint(e, a, hints.data[i]); }  else { qoz_emit_emit_expr(e, a); } i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_Option__qoz_string_None: { NULL;  break; } } 0;  break; } default: { NULL;  break; } } 0; qoz_TypeExpr* callee_te = qoz_emit_callee_value_typeexpr(e, callee); qoz_gc_push_root(&callee_te); qoz_TypeExpr* _qoz_ms_255 = callee_te; switch (_qoz_ms_255->tag) { case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr fn_params_te = _qoz_ms_255->payload.TEFn.f1; {
...
qoz_TypeExpr* qoz_emit_callee_value_typeexpr(qoz_Emitter* e, qoz_Expr* callee) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&callee);
    qoz_Expr* _qoz_ms_259 = callee; qoz_TypeExpr* _qoz_mv_259 = NULL; switch (_qoz_ms_259->tag) { case qoz_Expr_EIdent: { qoz_Span sp = _qoz_ms_259->payload.EIdent.f0; qoz_string name = _qoz_ms_259->payload.EIdent.f1; qoz_TypeExpr* _qoz_bv_217;
    {
        qoz_Option__qoz_TypeExpr* _qoz_ms_260 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->locals, name); switch (_qoz_ms_260->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* te = _qoz_ms_260->payload.Some.f0; return te;  break; } default: { NULL;  break; } } 0; _qoz_bv_217 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_259 = (_qoz_bv_217);  break; } default: { _qoz_mv_259 = (qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(callee)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_259;
}

void qoz_emit_ensure_unary_byval_dispatch_helper(qoz_Emitter* e, qoz_string fn_name, qoz_string operand_ct, qoz_string ret_ct) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    if (qoz_map_contains__qoz_string__bool(&e->byval_helpers_emitted, fn_name)) { return;} qoz_map_set__qoz_string__bool(&e->byval_helpers_emitted, fn_name, true); qoz_string call_name = qoz_emit_user_fn_c_name(fn_name); qoz_string src = QOZ_STR_LIT("static "); src = qoz_string_cat(src, ret_ct); src = qoz_string_cat(src, QOZ_STR_LIT(" _qoz_byval_")); src = qoz_string_cat(src, fn_name); src = qoz_string_cat(src, QOZ_STR_LIT("(")); src = qoz_string_cat(src, operand_ct); src = qoz_string_cat(src, QOZ_STR_LIT(" a) { return ")); src = qoz_string_cat(src, call_name); src = qoz_string_cat(src, QOZ_STR_LIT("(&a); }\n")); qoz_string proto = QOZ_STR_LIT("static "); proto = qoz_string_cat(proto, ret_ct); proto = qoz_string_cat(proto, QOZ_STR_LIT(" _qoz_byval_")); proto = qoz_string_cat(proto, fn_name); proto = qoz_string_cat(proto, QOZ_STR_LIT("(")); proto = qoz_string_cat(proto, operand_ct); proto = qoz_string_cat(proto, QOZ_STR_LIT(");\n")); qoz_vec_push__qoz_string(&e->synth_fn_decls, proto); qoz_vec_push__qoz_string(&e->synth_fn_defs, src); 
    return;
}
...
qoz_string qoz_emit_unary_op_text(qoz_UnaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_UnaryOp* _qoz_ms_261 = op; qoz_string _qoz_mv_261 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_261->tag) { case qoz_UnaryOp_UOpNeg: { _qoz_mv_261 = (QOZ_STR_LIT("unary-"));  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_261 = (QOZ_STR_LIT("unary!"));  break; } case qoz_UnaryOp_UOpDeref: { _qoz_mv_261 = (QOZ_STR_LIT(""));  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_261 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_261;
}

void qoz_emit_ensure_byval_dispatch_helper(qoz_Emitter* e, qoz_string fn_name, qoz_string operand_ct, qoz_string ret_ct) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    if (qoz_map_contains__qoz_string__bool(&e->byval_helpers_emitted, fn_name)) { return;} qoz_map_set__qoz_string__bool(&e->byval_helpers_emitted, fn_name, true); qoz_string call_name = qoz_emit_user_fn_c_name(fn_name); qoz_string src = QOZ_STR_LIT("static "); src = qoz_string_cat(src, ret_ct); src = qoz_string_cat(src, QOZ_STR_LIT(" _qoz_byval_")); src = qoz_string_cat(src, fn_name); src = qoz_string_cat(src, QOZ_STR_LIT("(")); src = qoz_string_cat(src, operand_ct); src = qoz_string_cat(src, QOZ_STR_LIT(" a, ")); src = qoz_string_cat(src, operand_ct); src = qoz_string_cat(src, QOZ_STR_LIT(" b) { return ")); src = qoz_string_cat(src, call_name); qoz_string proto = QOZ_STR_LIT("static "); proto = qoz_string_cat(proto, ret_ct); proto = qoz_string_cat(proto, QOZ_STR_LIT(" _qoz_byval_")); proto = qoz_string_cat(proto, fn_name); proto = qoz_string_cat(proto, QOZ_STR_LIT("(")); proto = qoz_string_cat(proto, operand_ct); proto = qoz_string_cat(proto, QOZ_STR_LIT(", ")); proto = qoz_string_cat(proto, operand_ct); proto = qoz_string_cat(proto, QOZ_STR_LIT(");\n")); qoz_vec_push__qoz_string(&e->synth_fn_decls, proto); src = qoz_string_cat(src, QOZ_STR_LIT("(&a, &b); }\n")); qoz_vec_push__qoz_string(&e->synth_fn_defs, src); 
    return;
}
...
qoz_string qoz_emit_binary_op_text(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_262 = op; qoz_string _qoz_mv_262 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_262->tag) { case qoz_BinaryOp_BOpEq: { _qoz_mv_262 = (QOZ_STR_LIT("=="));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_262 = (QOZ_STR_LIT("!="));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_262 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_262 = (QOZ_STR_LIT(">"));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_262 = (QOZ_STR_LIT("<="));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_262 = (QOZ_STR_LIT(">="));  break; } case qoz_BinaryOp_BOpAdd: { _qoz_mv_262 = (QOZ_STR_LIT("+"));  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_262 = (QOZ_STR_LIT("-"));  break; } case qoz_BinaryOp_BOpMul: { _qoz_mv_262 = (QOZ_STR_LIT("*"));  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_262 = (QOZ_STR_LIT("/"));  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_262 = (QOZ_STR_LIT("%"));  break; } default: { _qoz_mv_262 = (QOZ_STR_LIT(""));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_262;
}
...
void qoz_emit_emit_binary(qoz_Emitter* e, qoz_BinaryOp* op, qoz_Expr* lhs, qoz_Expr* rhs) {
    ...
    qoz_gc_push_root(&lhs);
    qoz_gc_push_root(&rhs);
    qoz_string lct = qoz_emit_infer_expr_ctype(e, lhs); if (qoz_string_eq(lct, QOZ_STR_LIT("qoz_string"))) { qoz_BinaryOp* _qoz_ms_263 = op; switch (_qoz_ms_263->tag) { case qoz_BinaryOp_BOpEq: { {
    ...
    0;  break; } default: { NULL;  break; } } 0; } qoz_string op_text = qoz_emit_binary_op_text(op); if (!qoz_string_eq(op_text, QOZ_STR_LIT(""))) { qoz_TypeExpr* lhs_te = qoz_emit_infer_value_te(e, lhs); qoz_gc_push_root(&lhs_te); qoz_string tname = qoz_emit_operator_first_param_type_name(lhs_te); if (!qoz_string_eq(tname, QOZ_STR_LIT(""))) { qoz_string key = qoz_string_cat(qoz_string_cat(op_text, QOZ_STR_LIT("::")), tname); qoz_Option__qoz_string* _qoz_ms_264 = qoz_map_get__qoz_string__qoz_string(&e->op_dispatch, key); switch (_qoz_ms_264->tag) { case qoz_Option__qoz_string_Some: { qoz_string fn_name = _qoz_ms_264->payload.Some.f0; {
        qoz_string ct = qoz_emit_c_type_for(e, lhs_te); qoz_Option__qoz_TypeExpr* _qoz_ms_265 = qoz_map_get__qoz_string__qoz_TypeExpr(&e->fn_returns, fn_name); qoz_TypeExpr* _qoz_mv_265 = NULL; switch (_qoz_ms_265->tag) { case qoz_Option__qoz_TypeExpr_Some: { qoz_TypeExpr* t = _qoz_ms_265->payload.Some.f0; _qoz_mv_265 = (t);  break; } case qoz_Option__qoz_TypeExpr_None: { qoz_TypeExpr* _qoz_bv_218;
    {
        qoz_string _qoz_bv_219;
    {
        qoz_Strbuf _qoz_sb_2967_57 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2967_57); qoz_strings_sb_append(&_qoz_sb_2967_57, QOZ_STR_LIT("operator `")); qoz_strings_sb_append(&_qoz_sb_2967_57, op_text); qoz_strings_sb_append(&_qoz_sb_2967_57, QOZ_STR_LIT("` for `")); qoz_strings_sb_append(&_qoz_sb_2967_57, tname); qoz_strings_sb_append(&_qoz_sb_2967_57, QOZ_STR_LIT("` has no recorded return type")); _qoz_bv_219 = qoz_strings_sb_finish(&_qoz_sb_2967_57);
    }
    (void)(qoz_emit_emit_die(qoz_emit_span_of_expr(lhs), _qoz_bv_219)); _qoz_bv_218 = qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(lhs));
    }
    _qoz_mv_265 = (_qoz_bv_218);  break; } } qoz_TypeExpr* ret_te = _qoz_mv_265; qoz_gc_push_root(&ret_te); qoz_string ret_ct = qoz_emit_c_type_for(e, ret_te); qoz_emit_ensure_byval_dispatch_helper(e, fn_name, ct, ret_ct); qoz_string _qoz_bv_220;
    {
        qoz_Strbuf _qoz_sb_2977_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2977_25); qoz_strings_sb_append(&_qoz_sb_2977_25, QOZ_STR_LIT("_qoz_byval_")); qoz_strings_sb_append(&_qoz_sb_2977_25, fn_name); qoz_strings_sb_append(&_qoz_sb_2977_25, QOZ_STR_LIT("(")); _qoz_bv_220 = qoz_strings_sb_finish(&_qoz_sb_2977_25);
    }
    qoz_emit_push(e, _qoz_bv_220); qoz_emit_emit_expr(e, lhs); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, rhs); qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; } } qoz_string record_name = qoz_emit_record_struct_name_of_ctype(e, lct); if (!qoz_string_eq(record_name, QOZ_STR_LIT(""))) { qoz_BinaryOp* _qoz_ms_266 = op; switch (_qoz_ms_266->tag) { case qoz_BinaryOp_BOpEq: { {
        qoz_string _qoz_bv_221;
    {
        qoz_Strbuf _qoz_sb_2990_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2990_21); qoz_strings_sb_append(&_qoz_sb_2990_21, QOZ_STR_LIT("qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_2990_21, record_name); qoz_strings_sb_append(&_qoz_sb_2990_21, QOZ_STR_LIT("(")); _qoz_bv_221 = qoz_strings_sb_finish(&_qoz_sb_2990_21);
    }
    qoz_emit_push(e, _qoz_bv_221); qoz_emit_emit_expr(e, lhs); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, rhs); qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } case qoz_BinaryOp_BOpNe: { {
        qoz_string _qoz_bv_222;
    {
        qoz_Strbuf _qoz_sb_2998_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_2998_21); qoz_strings_sb_append(&_qoz_sb_2998_21, QOZ_STR_LIT("!qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_2998_21, record_name); qoz_strings_sb_append(&_qoz_sb_2998_21, QOZ_STR_LIT("(")); _qoz_bv_222 = qoz_strings_sb_finish(&_qoz_sb_2998_21);
    }
    qoz_emit_push(e, _qoz_bv_222); qoz_emit_emit_expr(e, lhs); qoz_emit_push(e, QOZ_STR_LIT(", ")); qoz_emit_emit_expr(e, rhs); qoz_emit_push(e, QOZ_STR_LIT(")")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; } int64_t p = qoz_emit_binary_prec(op); bool needs_paren_child = qoz_emit_is_logical_op(op); qoz_emit_emit_binary_child(e, lhs, p, needs_paren_child); qoz_string bop = qoz_emit_binary_c_op(op); qoz_string _qoz_bv_223;
    {
        qoz_Strbuf _qoz_sb_3012_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3012_13); qoz_strings_sb_append(&_qoz_sb_3012_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3012_13, bop); qoz_strings_sb_append(&_qoz_sb_3012_13, QOZ_STR_LIT(" ")); _qoz_bv_223 = qoz_strings_sb_finish(&_qoz_sb_3012_13);
    }
    qoz_emit_push(e, _qoz_bv_223); qoz_emit_emit_binary_child(e, rhs, p + 1, needs_paren_child); 
    return;
}
...
bool qoz_emit_is_logical_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_267 = op; bool _qoz_mv_267 = false; switch (_qoz_ms_267->tag) { case qoz_BinaryOp_BOpAnd: { _qoz_mv_267 = (true);  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_267 = (true);  break; } default: { _qoz_mv_267 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_267;
}
...
void qoz_emit_emit_binary_child(qoz_Emitter* e, qoz_Expr* ex, int64_t min_prec, bool force_paren_if_binary) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_268 = ex; switch (_qoz_ms_268->tag) { case qoz_Expr_EBinary: { if (force_paren_if_binary) { qoz_emit_push(e, QOZ_STR_LIT("(")); qoz_emit_emit_expr(e, ex); qoz_emit_push(e, QOZ_STR_LIT(")")); }  else { qoz_emit_emit_with_prec(e, ex, min_prec); } 0;  break; } default: { qoz_emit_emit_with_prec(e, ex, min_prec);  break; } } 0; 
    return;
}
...
int64_t qoz_emit_binary_prec(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_269 = op; int64_t _qoz_mv_269 = 0; switch (_qoz_ms_269->tag) { case qoz_BinaryOp_BOpMul: { _qoz_mv_269 = (12);  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_269 = (12);  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_269 = (12);  break; } case qoz_BinaryOp_BOpAdd: { _qoz_mv_269 = (11);  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_269 = (11);  break; } case qoz_BinaryOp_BOpShl: { _qoz_mv_269 = (10);  break; } case qoz_BinaryOp_BOpShr: { _qoz_mv_269 = (10);  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_269 = (8);  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_269 = (8);  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_269 = (8);  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_269 = (8);  break; } case qoz_BinaryOp_BOpRange: { _qoz_mv_269 = (8);  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_269 = (8);  break; } case qoz_BinaryOp_BOpEq: { _qoz_mv_269 = (7);  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_269 = (7);  break; } case qoz_BinaryOp_BOpBitAnd: { _qoz_mv_269 = (6);  break; } case qoz_BinaryOp_BOpBitXor: { _qoz_mv_269 = (5);  break; } case qoz_BinaryOp_BOpBitOr: { _qoz_mv_269 = (4);  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_269 = (3);  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_269 = (2);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_269;
}
...
void qoz_emit_emit_with_prec(qoz_Emitter* e, qoz_Expr* ex, int64_t min_prec) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_270 = ex; switch (_qoz_ms_270->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_270->payload.EBinary.f1; {
...
qoz_string qoz_emit_binary_c_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_271 = op; qoz_string _qoz_mv_271 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_271->tag) { case qoz_BinaryOp_BOpAdd: { _qoz_mv_271 = (QOZ_STR_LIT("+"));  break; } case qoz_BinaryOp_BOpSub: { _qoz_mv_271 = (QOZ_STR_LIT("-"));  break; } case qoz_BinaryOp_BOpMul: { _qoz_mv_271 = (QOZ_STR_LIT("*"));  break; } case qoz_BinaryOp_BOpDiv: { _qoz_mv_271 = (QOZ_STR_LIT("/"));  break; } case qoz_BinaryOp_BOpMod: { _qoz_mv_271 = (QOZ_STR_LIT("%"));  break; } case qoz_BinaryOp_BOpEq: { _qoz_mv_271 = (QOZ_STR_LIT("=="));  break; } case qoz_BinaryOp_BOpNe: { _qoz_mv_271 = (QOZ_STR_LIT("!="));  break; } case qoz_BinaryOp_BOpLt: { _qoz_mv_271 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpGt: { _qoz_mv_271 = (QOZ_STR_LIT(">"));  break; } case qoz_BinaryOp_BOpLe: { _qoz_mv_271 = (QOZ_STR_LIT("<="));  break; } case qoz_BinaryOp_BOpGe: { _qoz_mv_271 = (QOZ_STR_LIT(">="));  break; } case qoz_BinaryOp_BOpAnd: { _qoz_mv_271 = (QOZ_STR_LIT("&&"));  break; } case qoz_BinaryOp_BOpOr: { _qoz_mv_271 = (QOZ_STR_LIT("||"));  break; } case qoz_BinaryOp_BOpBitAnd: { _qoz_mv_271 = (QOZ_STR_LIT("&"));  break; } case qoz_BinaryOp_BOpBitOr: { _qoz_mv_271 = (QOZ_STR_LIT("|"));  break; } case qoz_BinaryOp_BOpBitXor: { _qoz_mv_271 = (QOZ_STR_LIT("^"));  break; } case qoz_BinaryOp_BOpShl: { _qoz_mv_271 = (QOZ_STR_LIT("<<"));  break; } case qoz_BinaryOp_BOpShr: { _qoz_mv_271 = (QOZ_STR_LIT(">>"));  break; } case qoz_BinaryOp_BOpRange: { _qoz_mv_271 = (QOZ_STR_LIT("<"));  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_271 = (QOZ_STR_LIT("<="));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_271;
}

qoz_string qoz_emit_unary_c_op(qoz_UnaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_UnaryOp* _qoz_ms_272 = op; qoz_string _qoz_mv_272 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_272->tag) { case qoz_UnaryOp_UOpNeg: { _qoz_mv_272 = (QOZ_STR_LIT("-"));  break; } case qoz_UnaryOp_UOpNot: { _qoz_mv_272 = (QOZ_STR_LIT("!"));  break; } case qoz_UnaryOp_UOpDeref: { _qoz_mv_272 = (QOZ_STR_LIT("*"));  break; } case qoz_UnaryOp_UOpAddr: { _qoz_mv_272 = (QOZ_STR_LIT("&"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_272;
}

bool qoz_emit_is_block(qoz_Expr* ex) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_273 = ex; bool _qoz_mv_273 = false; switch (_qoz_ms_273->tag) { case qoz_Expr_EBlock: { _qoz_mv_273 = (true);  break; } default: { _qoz_mv_273 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_273;
}

bool qoz_emit_is_nil_expr(qoz_Expr* ex) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ex);
    qoz_Expr* _qoz_ms_274 = ex; bool _qoz_mv_274 = false; switch (_qoz_ms_274->tag) { case qoz_Expr_ENil: { _qoz_mv_274 = (true);  break; } default: { _qoz_mv_274 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_274;
}
...
void qoz_emit_emit_fn_body_block(qoz_Emitter* e, qoz_Expr* body, qoz_TypeExpr* ret_hint) {
    ...
    qoz_Expr* _qoz_ms_275 = body; switch (_qoz_ms_275->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_275->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_275->payload.EBlock.f2; {
        qoz_Vec__qoz_Expr defers = qoz_emit_collect_defers_in_stmts(stmts); qoz_Expr* effective_tail = tail; qoz_gc_push_root(&effective_tail); qoz_Expr* _qoz_ms_276 = tail; switch (_qoz_ms_276->tag) { case qoz_Expr_EDefer: { qoz_Expr* dbody = _qoz_ms_276->payload.EDefer.f1; {
        qoz_vec_push__qoz_Expr(&defers, dbody); effective_tail = qoz_make_Expr_ENil(qoz_emit_span_of_expr(tail)); 
    }
    0;  break; } default: { NULL;  break; } } 0; { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_emit_stmt(e, s); } }if (qoz_emit_is_nil_expr(effective_tail)) { qoz_emit_emit_defers_reverse(e, defers); qoz_emit_push(e, QOZ_STR_LIT("return;\n")); return;} if (qoz_emit_is_unit_typeexpr(ret_hint)) { qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, effective_tail); qoz_emit_close_statement_scope(e, saved); qoz_emit_emit_defers_reverse(e, defers); qoz_emit_push(e, QOZ_STR_LIT("\n    return;\n")); return;} qoz_Expr* _qoz_ms_277 = effective_tail; switch (_qoz_ms_277->tag) { case qoz_Expr_EReturn: { {
        qoz_emit_emit_expr(e, effective_tail); qoz_emit_push(e, QOZ_STR_LIT(";\n")); return;
    }
    0;  break; } default: { NULL;  break; } } 0; if ((defers.len) == 0) { qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_push(e, e->current_return_restore); qoz_emit_push(e, QOZ_STR_LIT("return ")); qoz_emit_emit_value_with_hint(e, effective_tail, ret_hint); qoz_emit_push(e, QOZ_STR_LIT(";\n")); qoz_emit_close_statement_scope(e, saved); }  else { e->closure_counter = e->closure_counter + 1; qoz_string _qoz_bv_224;
    {
        qoz_Strbuf _qoz_sb_3174_48 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3174_48); qoz_strings_sb_append_i64(&_qoz_sb_3174_48, e->closure_counter); _qoz_bv_224 = qoz_strings_sb_finish(&_qoz_sb_3174_48);
    }
    qoz_string tmp = qoz_string_cat(QOZ_STR_LIT("_qoz_ret_"), _qoz_bv_224); qoz_string rt = qoz_emit_c_type_for(e, ret_hint); qoz_string _qoz_bv_225;
    {
        qoz_Strbuf _qoz_sb_3176_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3176_21); qoz_strings_sb_append(&_qoz_sb_3176_21, rt); qoz_strings_sb_append(&_qoz_sb_3176_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3176_21, tmp); qoz_strings_sb_append(&_qoz_sb_3176_21, QOZ_STR_LIT(" = ")); _qoz_bv_225 = qoz_strings_sb_finish(&_qoz_sb_3176_21);
    }
    qoz_emit_push(e, _qoz_bv_225); qoz_emit_emit_value_with_hint(e, effective_tail, ret_hint); qoz_emit_push(e, QOZ_STR_LIT(";\n    ")); qoz_emit_emit_defers_reverse(e, defers); qoz_string _qoz_bv_226;
    {
        qoz_Strbuf _qoz_sb_3180_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3180_21); qoz_strings_sb_append(&_qoz_sb_3180_21, QOZ_STR_LIT("\n    return ")); qoz_strings_sb_append(&_qoz_sb_3180_21, tmp); qoz_strings_sb_append(&_qoz_sb_3180_21, QOZ_STR_LIT(";\n")); _qoz_bv_226 = qoz_strings_sb_finish(&_qoz_sb_3180_21);
    }
    qoz_emit_push(e, _qoz_bv_226); } 
    }
    0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
bool qoz_emit_is_unit_typeexpr(qoz_TypeExpr* te) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_278 = te; bool _qoz_mv_278 = false; switch (_qoz_ms_278->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_278 = (true);  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_278->payload.TENamed.f1; bool _qoz_bv_227;
    {
        if ((path.len) != 1) { return false;} qoz_string n = path.data[0]; _qoz_bv_227 = qoz_string_eq(n, QOZ_STR_LIT("unit")) || qoz_string_eq(n, QOZ_STR_LIT("void"));
    }
    _qoz_mv_278 = (_qoz_bv_227);  break; } default: { _qoz_mv_278 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_278;
}

qoz_string qoz_emit_user_fn_c_name(qoz_string name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    if (qoz_string_has_prefix(name, QOZ_STR_LIT("qoz_"))) { return name;} qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_string_cat(QOZ_STR_LIT("qoz_"), name);
}
...
void qoz_emit_emit_fn(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&ret);
    qoz_gc_push_root(&body);
    qoz_string ret_c = qoz_emit_c_type_for(e, ret); qoz_string c_name = qoz_emit_user_fn_c_name(name); qoz_string _qoz_bv_228;
    {
        qoz_Strbuf _qoz_sb_3211_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3211_13); qoz_strings_sb_append(&_qoz_sb_3211_13, ret_c); qoz_strings_sb_append(&_qoz_sb_3211_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3211_13, c_name); _qoz_bv_228 = qoz_strings_sb_finish(&_qoz_sb_3211_13);
    }
    qoz_emit_push(e, _qoz_bv_228); if ((params.len) == 0) { qoz_emit_push(e, QOZ_STR_LIT("(void)")); }  else { qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = qoz_emit_c_type_for(e, p.ty); qoz_string pn = p.name; qoz_string _qoz_bv_229;
    {
        qoz_Strbuf _qoz_sb_3221_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3221_21); qoz_strings_sb_append(&_qoz_sb_3221_21, pc); qoz_strings_sb_append(&_qoz_sb_3221_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3221_21, pn); _qoz_bv_229 = qoz_strings_sb_finish(&_qoz_sb_3221_21);
    }
    qoz_emit_push(e, _qoz_bv_229); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); } qoz_emit_push(e, QOZ_STR_LIT(" {\n    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();\n    ")); qoz_string saved_ret = e->current_return_restore; e->current_return_restore = QOZ_STR_LIT("qoz_gc_shadow_set_top(_qoz_shadow_guard); "); e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, p.name, p.ty); if (qoz_emit_c_type_is_pointer(qoz_emit_c_type_for(e, p.ty))) { qoz_string pn = p.name; qoz_string _qoz_bv_230;
    {
        qoz_Strbuf _qoz_sb_3234_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3234_21); qoz_strings_sb_append(&_qoz_sb_3234_21, QOZ_STR_LIT("qoz_gc_push_root(&")); qoz_strings_sb_append(&_qoz_sb_3234_21, pn); qoz_strings_sb_append(&_qoz_sb_3234_21, QOZ_STR_LIT(");\n    ")); _qoz_bv_230 = qoz_strings_sb_finish(&_qoz_sb_3234_21);
    }
    qoz_emit_push(e, _qoz_bv_230); } } }e->current_ret_te = ret; bool is_b = qoz_emit_is_block(body); if (is_b) { qoz_emit_emit_fn_body_block(e, body, ret); }  else { qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_string crr = e->current_return_restore; if (qoz_emit_is_unit_typeexpr(ret)) { qoz_emit_emit_expr(e, body); qoz_string _qoz_bv_231;
    {
        qoz_Strbuf _qoz_sb_3246_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3246_21); qoz_strings_sb_append(&_qoz_sb_3246_21, QOZ_STR_LIT(";\n    ")); qoz_strings_sb_append(&_qoz_sb_3246_21, crr); qoz_strings_sb_append(&_qoz_sb_3246_21, QOZ_STR_LIT("return;\n")); _qoz_bv_231 = qoz_strings_sb_finish(&_qoz_sb_3246_21);
    }
    qoz_emit_push(e, _qoz_bv_231); }  else { qoz_string _qoz_bv_232;
    {
        qoz_Strbuf _qoz_sb_3248_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3248_21); qoz_strings_sb_append(&_qoz_sb_3248_21, crr); qoz_strings_sb_append(&_qoz_sb_3248_21, QOZ_STR_LIT("return ")); _qoz_bv_232 = qoz_strings_sb_finish(&_qoz_sb_3248_21);
    }
    qoz_emit_push(e, _qoz_bv_232); qoz_emit_emit_value_with_hint(e, body, ret); qoz_emit_push(e, QOZ_STR_LIT(";\n")); } qoz_emit_close_statement_scope(e, saved); } e->current_return_restore = saved_ret; e->locals = qoz_map_make__qoz_string__qoz_TypeExpr(); qoz_emit_push(e, QOZ_STR_LIT("}\n\n")); 
    return;
}
...
void qoz_emit_emit_records_topological(qoz_Emitter* e, qoz_File f) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_string names = qoz_vec_make__qoz_string(); qoz_Vec__qoz_Vec__qoz_StructField field_lists = qoz_vec_make__qoz_Vec__qoz_StructField(); { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_279 = d; switch (_qoz_ms_279->tag) { case qoz_Decl_DStruct: { qoz_string name = _qoz_ms_279->payload.DStruct.f1; qoz_Vec__qoz_string params = _qoz_ms_279->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_279->payload.DStruct.f3; if ((params.len) == 0) { qoz_vec_push__qoz_string(&names, name); qoz_vec_push__qoz_Vec__qoz_StructField(&field_lists, fields); } 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e->record_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_280 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, inst.name); switch (_qoz_ms_280->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_280->payload.Some.f0; qoz_Decl* _qoz_ms_281 = decl; switch (_qoz_ms_281->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_281->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_281->payload.DStruct.f3; {
...
qoz_Option__qoz_string* qoz_emit_value_field_dep(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_283 = te; qoz_Option__qoz_string* _qoz_mv_283 = NULL; switch (_qoz_ms_283->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_283->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_283->payload.TENamed.f2; qoz_Option__qoz_string* _qoz_bv_233;
    {
        if ((path.len) < 1) { return qoz_make_Option__qoz_string_None();} qoz_string n = path.data[(path.len) - 1]; if (!qoz_string_eq(qoz_emit_primitive_c_name(n), QOZ_STR_LIT(""))) { return qoz_make_Option__qoz_string_None();} if (qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { return qoz_make_Option__qoz_string_None();} if ((args.len) > 0) { return qoz_make_Option__qoz_string_Some(qoz_emit_mangle_inst(e, n, args));} _qoz_bv_233 = qoz_make_Option__qoz_string_Some(n);
    }
    _qoz_mv_283 = (_qoz_bv_233);  break; } default: { _qoz_mv_283 = (qoz_make_Option__qoz_string_None());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_283;
}
...
qoz_string qoz_emit_emit_program(qoz_File f, qoz_Map__int64_t__qoz_TypeExpr expr_types) {
    ...
    0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_288 = d; switch (_qoz_ms_288->tag) { case qoz_Decl_DEnum: { qoz_string name = _qoz_ms_288->payload.DEnum.f1; qoz_Vec__qoz_string params = _qoz_ms_288->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_288->payload.DEnum.f3; if ((params.len) == 0) { { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_emit_emit_variant_ctor(&e, name, v); } }} 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_289 = d; switch (_qoz_ms_289->tag) { case qoz_Decl_DFn: { qoz_string name = _qoz_ms_289->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_289->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_289->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_289->payload.DFn.f4; if (!qoz_emit_is_main(name) && ((tparams.len) == 0)) { qoz_emit_emit_fn_proto(&e, name, params, ret); } 0;  break; } case qoz_Decl_DExternal: { qoz_string symbol = _qoz_ms_289->payload.DExternal.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_289->payload.DExternal.f3; qoz_TypeExpr* ret = _qoz_ms_289->payload.DExternal.f4; qoz_emit_emit_extern_proto(&e, symbol, params, ret);  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e.fn_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_290 = qoz_map_get__qoz_string__qoz_Decl(&e.generic_fn_decls, inst.name); switch (_qoz_ms_290->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_290->payload.Some.f0; qoz_Decl* _qoz_ms_291 = decl; switch (_qoz_ms_291->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_291->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_291->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_291->payload.DFn.f4; {
        qoz_Vec__qoz_FnParam subst_params = qoz_vec_make__qoz_FnParam(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_vec_push__qoz_FnParam(&subst_params, ((qoz_FnParam){ .name = pp.name, .ty = qoz_emit_substitute_type(&e, pp.ty, tparams, inst.args) })); } }qoz_TypeExpr* subst_ret = qoz_emit_substitute_type(&e, ret, tparams, inst.args); qoz_gc_push_root(&subst_ret); qoz_emit_emit_fn_proto(&e, qoz_string_cat(QOZ_STR_LIT("qoz_"), inst.mangled), subst_params, subst_ret); 
    }
    0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } }qoz_emit_push(&e, QOZ_STR_LIT("\n")); { qoz_Vec__qoz_Decl __col = f.decls; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Decl* d = __col.data[__i]; (void)d; qoz_Decl* _qoz_ms_292 = d; switch (_qoz_ms_292->tag) { case qoz_Decl_DFn: { qoz_string name = _qoz_ms_292->payload.DFn.f1; qoz_Vec__qoz_string tparams = _qoz_ms_292->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_292->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_292->payload.DFn.f4; qoz_Expr* body = _qoz_ms_292->payload.DFn.f5; if (qoz_emit_is_main(name)) { qoz_emit_emit_main(&e, ret, body); }  else if ((tparams.len) == 0) { qoz_emit_emit_fn(&e, name, params, ret, body); } 0;  break; } default: { NULL;  break; } } 0; } }{ qoz_Vec__qoz_Instantiation __col = e.fn_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; qoz_Option__qoz_Decl* _qoz_ms_293 = qoz_map_get__qoz_string__qoz_Decl(&e.generic_fn_decls, inst.name); switch (_qoz_ms_293->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_293->payload.Some.f0; qoz_Decl* _qoz_ms_294 = decl; switch (_qoz_ms_294->tag) { case qoz_Decl_DFn: { qoz_Vec__qoz_string tparams = _qoz_ms_294->payload.DFn.f2; qoz_Vec__qoz_FnParam params = _qoz_ms_294->payload.DFn.f3; qoz_TypeExpr* ret = _qoz_ms_294->payload.DFn.f4; qoz_Expr* body = _qoz_ms_294->payload.DFn.f5; {
        qoz_Vec__qoz_FnParam subst_params = qoz_vec_make__qoz_FnParam(); { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam pp = __col.data[__i]; (void)pp; qoz_vec_push__qoz_FnParam(&subst_params, ((qoz_FnParam){ .name = pp.name, .ty = qoz_emit_substitute_type(&e, pp.ty, tparams, inst.args) })); } }qoz_TypeExpr* subst_ret = qoz_emit_substitute_type(&e, ret, tparams, inst.args); qoz_gc_push_root(&subst_ret); qoz_Expr* subst_body = qoz_emit_substitute_expr(&e, body, tparams, inst.args); qoz_gc_push_root(&subst_body); qoz_Vec__qoz_string saved_tparams = e.current_tparams; qoz_Vec__qoz_TypeExpr saved_targs = e.current_targs; e.current_tparams = tparams; e.current_targs = inst.args; qoz_emit_emit_fn(&e, qoz_string_cat(QOZ_STR_LIT("qoz_"), inst.mangled), subst_params, subst_ret, subst_body); e.current_tparams = saved_tparams; e.current_targs = saved_targs; 
    }
...
void qoz_emit_emit_enum(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_VariantDecl variants) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_emit_push(e, QOZ_STR_LIT("typedef enum {\n")); int64_t i = 0; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_string vn = v.name; qoz_string _qoz_bv_234;
    {
        qoz_Strbuf _qoz_sb_3569_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3569_17); qoz_strings_sb_append(&_qoz_sb_3569_17, QOZ_STR_LIT("    qoz_")); qoz_strings_sb_append(&_qoz_sb_3569_17, name); qoz_strings_sb_append(&_qoz_sb_3569_17, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3569_17, vn); qoz_strings_sb_append(&_qoz_sb_3569_17, QOZ_STR_LIT(",\n")); _qoz_bv_234 = qoz_strings_sb_finish(&_qoz_sb_3569_17);
    }
    qoz_emit_push(e, _qoz_bv_234); i = i + 1; } }qoz_string _qoz_bv_235;
    {
        qoz_Strbuf _qoz_sb_3572_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3572_13); qoz_strings_sb_append(&_qoz_sb_3572_13, QOZ_STR_LIT("} qoz_")); qoz_strings_sb_append(&_qoz_sb_3572_13, name); qoz_strings_sb_append(&_qoz_sb_3572_13, QOZ_STR_LIT("_tag;\n\n")); _qoz_bv_235 = qoz_strings_sb_finish(&_qoz_sb_3572_13);
    }
    qoz_emit_push(e, _qoz_bv_235); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_emit_variant_has_positional(v)) { qoz_string vn = v.name; qoz_emit_push(e, QOZ_STR_LIT("typedef struct {\n")); int64_t k = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pt = __col.data[__i]; (void)pt; qoz_string pc = qoz_emit_c_type_for(e, pt); qoz_string ks = qoz_emit_int_to_string(k); qoz_string _qoz_bv_236;
    {
        qoz_Strbuf _qoz_sb_3581_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3581_25); qoz_strings_sb_append(&_qoz_sb_3581_25, QOZ_STR_LIT("    ")); qoz_strings_sb_append(&_qoz_sb_3581_25, pc); qoz_strings_sb_append(&_qoz_sb_3581_25, QOZ_STR_LIT(" f")); qoz_strings_sb_append(&_qoz_sb_3581_25, ks); qoz_strings_sb_append(&_qoz_sb_3581_25, QOZ_STR_LIT(";\n")); _qoz_bv_236 = qoz_strings_sb_finish(&_qoz_sb_3581_25);
    }
    qoz_emit_push(e, _qoz_bv_236); k = k + 1; } }qoz_string _qoz_bv_237;
    {
        qoz_Strbuf _qoz_sb_3584_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3584_21); qoz_strings_sb_append(&_qoz_sb_3584_21, QOZ_STR_LIT("} qoz_")); qoz_strings_sb_append(&_qoz_sb_3584_21, name); qoz_strings_sb_append(&_qoz_sb_3584_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3584_21, vn); qoz_strings_sb_append(&_qoz_sb_3584_21, QOZ_STR_LIT("_payload;\n\n")); _qoz_bv_237 = qoz_strings_sb_finish(&_qoz_sb_3584_21);
    }
    qoz_emit_push(e, _qoz_bv_237); } } }qoz_string _qoz_bv_238;
    {
        qoz_Strbuf _qoz_sb_3587_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3587_13); qoz_strings_sb_append(&_qoz_sb_3587_13, QOZ_STR_LIT("struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3587_13, name); qoz_strings_sb_append(&_qoz_sb_3587_13, QOZ_STR_LIT(" {\n    qoz_")); qoz_strings_sb_append(&_qoz_sb_3587_13, name); qoz_strings_sb_append(&_qoz_sb_3587_13, QOZ_STR_LIT("_tag tag;\n")); _qoz_bv_238 = qoz_strings_sb_finish(&_qoz_sb_3587_13);
    }
    qoz_emit_push(e, _qoz_bv_238); bool any_payload = false; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_emit_variant_has_positional(v)) { any_payload = true; } } }if (any_payload) { qoz_emit_push(e, QOZ_STR_LIT("    union {\n")); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_emit_variant_has_positional(v)) { qoz_string vn = v.name; qoz_string _qoz_bv_239;
    {
        qoz_Strbuf _qoz_sb_3597_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3597_25); qoz_strings_sb_append(&_qoz_sb_3597_25, QOZ_STR_LIT("        qoz_")); qoz_strings_sb_append(&_qoz_sb_3597_25, name); qoz_strings_sb_append(&_qoz_sb_3597_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3597_25, vn); qoz_strings_sb_append(&_qoz_sb_3597_25, QOZ_STR_LIT("_payload ")); qoz_strings_sb_append(&_qoz_sb_3597_25, vn); qoz_strings_sb_append(&_qoz_sb_3597_25, QOZ_STR_LIT(";\n")); _qoz_bv_239 = qoz_strings_sb_finish(&_qoz_sb_3597_25);
    }
    qoz_emit_push(e, _qoz_bv_239); } } }qoz_emit_push(e, QOZ_STR_LIT("    } payload;\n")); } qoz_emit_push(e, QOZ_STR_LIT("};\n\n")); qoz_emit_emit_adt_desc(e, name, variants); 
    return;
}
...
qoz_string qoz_emit_int_to_string(int64_t n) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_Strbuf _qoz_sb_3608_37 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3608_37); qoz_strings_sb_append_i64(&_qoz_sb_3608_37, n); qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_strings_sb_finish(&_qoz_sb_3608_37);
}

void qoz_emit_emit_variant_ctor(qoz_Emitter* e, qoz_string enum_name, qoz_VariantDecl v) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string vn = v.name; qoz_string _qoz_bv_240;
    {
        qoz_Strbuf _qoz_sb_3612_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3612_13); qoz_strings_sb_append(&_qoz_sb_3612_13, QOZ_STR_LIT("static qoz_")); qoz_strings_sb_append(&_qoz_sb_3612_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3612_13, QOZ_STR_LIT(" *qoz_make_")); qoz_strings_sb_append(&_qoz_sb_3612_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3612_13, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3612_13, vn); _qoz_bv_240 = qoz_strings_sb_finish(&_qoz_sb_3612_13);
    }
    qoz_emit_push(e, _qoz_bv_240); if (!qoz_emit_variant_has_positional(v)) { qoz_emit_push(e, QOZ_STR_LIT("(void) {\n")); }  else { qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t k = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pt = __col.data[__i]; (void)pt; if (k > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = qoz_emit_c_type_for(e, pt); qoz_string ks = qoz_emit_int_to_string(k); qoz_string _qoz_bv_241;
    {
        qoz_Strbuf _qoz_sb_3622_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3622_21); qoz_strings_sb_append(&_qoz_sb_3622_21, pc); qoz_strings_sb_append(&_qoz_sb_3622_21, QOZ_STR_LIT(" f")); qoz_strings_sb_append(&_qoz_sb_3622_21, ks); _qoz_bv_241 = qoz_strings_sb_finish(&_qoz_sb_3622_21);
    }
    qoz_emit_push(e, _qoz_bv_241); k = k + 1; } }qoz_emit_push(e, QOZ_STR_LIT(") {\n")); } qoz_string _qoz_bv_242;
    {
        qoz_Strbuf _qoz_sb_3627_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3627_13); qoz_strings_sb_append(&_qoz_sb_3627_13, QOZ_STR_LIT("    qoz_")); qoz_strings_sb_append(&_qoz_sb_3627_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3627_13, QOZ_STR_LIT(" *p = qoz_gc_alloc(sizeof(qoz_")); qoz_strings_sb_append(&_qoz_sb_3627_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3627_13, QOZ_STR_LIT("), &qoz_")); qoz_strings_sb_append(&_qoz_sb_3627_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3627_13, QOZ_STR_LIT("_desc);\n")); _qoz_bv_242 = qoz_strings_sb_finish(&_qoz_sb_3627_13);
    }
    qoz_emit_push(e, _qoz_bv_242); qoz_string _qoz_bv_243;
    {
        qoz_Strbuf _qoz_sb_3628_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3628_13); qoz_strings_sb_append(&_qoz_sb_3628_13, QOZ_STR_LIT("    p->tag = qoz_")); qoz_strings_sb_append(&_qoz_sb_3628_13, enum_name); qoz_strings_sb_append(&_qoz_sb_3628_13, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3628_13, vn); qoz_strings_sb_append(&_qoz_sb_3628_13, QOZ_STR_LIT(";\n")); _qoz_bv_243 = qoz_strings_sb_finish(&_qoz_sb_3628_13);
    }
    qoz_emit_push(e, _qoz_bv_243); if (qoz_emit_variant_has_positional(v)) { int64_t j = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* _ = __col.data[__i]; (void)_; qoz_string js = qoz_emit_int_to_string(j); qoz_string _qoz_bv_244;
    {
        qoz_Strbuf _qoz_sb_3633_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3633_21); qoz_strings_sb_append(&_qoz_sb_3633_21, QOZ_STR_LIT("    p->payload.")); qoz_strings_sb_append(&_qoz_sb_3633_21, vn); qoz_strings_sb_append(&_qoz_sb_3633_21, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_3633_21, js); qoz_strings_sb_append(&_qoz_sb_3633_21, QOZ_STR_LIT(" = f")); qoz_strings_sb_append(&_qoz_sb_3633_21, js); qoz_strings_sb_append(&_qoz_sb_3633_21, QOZ_STR_LIT(";\n")); _qoz_bv_244 = qoz_strings_sb_finish(&_qoz_sb_3633_21);
    }
    qoz_emit_push(e, _qoz_bv_244); j = j + 1; } }} qoz_emit_push(e, QOZ_STR_LIT("    return p;\n}\n\n")); 
    return;
}
...
void qoz_emit_collect_field_ptr_offsets(qoz_Emitter* e, qoz_string parent, qoz_string field, qoz_TypeExpr* te, qoz_Vec__qoz_string* out) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&out);
    qoz_string base = qoz_string_cat(QOZ_STR_LIT("offsetof("), qoz_string_cat(parent, qoz_string_cat(QOZ_STR_LIT(", "), qoz_string_cat(field, QOZ_STR_LIT(")"))))); qoz_TypeExpr* _qoz_ms_295 = te; switch (_qoz_ms_295->tag) { case qoz_TypeExpr_TEPtr: { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)"), base));  break; } case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_295->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_295->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)"), base)); return;} if (qoz_string_eq(n, QOZ_STR_LIT("string"))) { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)("), qoz_string_cat(base, QOZ_STR_LIT(" + offsetof(qoz_string, data))")))); qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)("), qoz_string_cat(base, QOZ_STR_LIT(" + offsetof(qoz_string, root))")))); return;} if (qoz_string_eq(n, QOZ_STR_LIT("Vec")) || qoz_string_eq(n, QOZ_STR_LIT("Map"))) { qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)"), base)); return;} if ((args.len) == 0) { qoz_Option__qoz_Decl* _qoz_ms_296 = qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, n); switch (_qoz_ms_296->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_296->payload.Some.f0; qoz_Decl* _qoz_ms_297 = d; switch (_qoz_ms_297->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_297->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_297->payload.DStruct.f3; if ((params.len) == 0) { qoz_string inner_parent = qoz_string_cat(QOZ_STR_LIT("struct qoz_"), n); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField sf = __col.data[__i]; (void)sf; qoz_string composed_parent = inner_parent; qoz_string composed_field = sf.name; qoz_Vec__qoz_string inner_offsets = qoz_vec_make__qoz_string(); qoz_emit_collect_field_ptr_offsets(e, composed_parent, composed_field, sf.ty, &inner_offsets); { qoz_Vec__qoz_string __col = inner_offsets; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string inner = __col.data[__i]; (void)inner; qoz_string stripped = qoz_string_slice(inner, 9, (inner).len); qoz_vec_push__qoz_string(out, qoz_string_cat(QOZ_STR_LIT("(int32_t)("), qoz_string_cat(base, qoz_string_cat(QOZ_STR_LIT(" + "), qoz_string_cat(stripped, QOZ_STR_LIT(")")))))); } }} }return;} 0;  break; } default: { NULL;  break; } } 0;  break; } case qoz_Option__qoz_Decl_None: { NULL;  break; } } 0; } } 0;  break; } default: { NULL;  break; } } 0; 
    return;
}
...
void qoz_emit_emit_record_desc(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string parent = qoz_string_cat(QOZ_STR_LIT("struct qoz_"), name); qoz_Vec__qoz_string offsets = qoz_vec_make__qoz_string(); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; qoz_emit_collect_field_ptr_offsets(e, parent, f.name, f.ty, &offsets); } }int64_t nptrs = (offsets.len); if (nptrs > 0) { qoz_string _qoz_bv_245;
    {
        qoz_Strbuf _qoz_sb_3722_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3722_17); qoz_strings_sb_append(&_qoz_sb_3722_17, QOZ_STR_LIT("static const int32_t qoz_")); qoz_strings_sb_append(&_qoz_sb_3722_17, name); qoz_strings_sb_append(&_qoz_sb_3722_17, QOZ_STR_LIT("_offsets[] = { ")); _qoz_bv_245 = qoz_strings_sb_finish(&_qoz_sb_3722_17);
    }
    qoz_emit_push(e, _qoz_bv_245); int64_t i = 0; { qoz_Vec__qoz_string __col = offsets; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string expr = __col.data[__i]; (void)expr; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_push(e, expr); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(" };\n")); } if (nptrs == 0) { qoz_string _qoz_bv_246;
    {
        qoz_Strbuf _qoz_sb_3732_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3732_17); qoz_strings_sb_append(&_qoz_sb_3732_17, QOZ_STR_LIT("static const qoz_type_desc qoz_")); qoz_strings_sb_append(&_qoz_sb_3732_17, name); qoz_strings_sb_append(&_qoz_sb_3732_17, QOZ_STR_LIT("_desc = { QOZ_DESC_LEAF, (int32_t)sizeof(struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3732_17, name); qoz_strings_sb_append(&_qoz_sb_3732_17, QOZ_STR_LIT("), 0, NULL, 0, 0, 0, NULL, \"")); qoz_strings_sb_append(&_qoz_sb_3732_17, name); qoz_strings_sb_append(&_qoz_sb_3732_17, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_246 = qoz_strings_sb_finish(&_qoz_sb_3732_17);
    }
    qoz_emit_push(e, _qoz_bv_246); }  else { qoz_string np = qoz_emit_int_to_string(nptrs); qoz_string _qoz_bv_247;
    {
        qoz_Strbuf _qoz_sb_3735_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3735_17); qoz_strings_sb_append(&_qoz_sb_3735_17, QOZ_STR_LIT("static const qoz_type_desc qoz_")); qoz_strings_sb_append(&_qoz_sb_3735_17, name); qoz_strings_sb_append(&_qoz_sb_3735_17, QOZ_STR_LIT("_desc = { QOZ_DESC_OFFSETS, (int32_t)sizeof(struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3735_17, name); qoz_strings_sb_append(&_qoz_sb_3735_17, QOZ_STR_LIT("), ")); qoz_strings_sb_append(&_qoz_sb_3735_17, np); qoz_strings_sb_append(&_qoz_sb_3735_17, QOZ_STR_LIT(", qoz_")); qoz_strings_sb_append(&_qoz_sb_3735_17, name); qoz_strings_sb_append(&_qoz_sb_3735_17, QOZ_STR_LIT("_offsets, 0, 0, 0, NULL, \"")); qoz_strings_sb_append(&_qoz_sb_3735_17, name); qoz_strings_sb_append(&_qoz_sb_3735_17, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_247 = qoz_strings_sb_finish(&_qoz_sb_3735_17);
    }
    qoz_emit_push(e, _qoz_bv_247); } 
    return;
}
...
qoz_Vec__qoz_string qoz_emit_collect_variant_ptr_offsets(qoz_Emitter* e, qoz_string enum_name, qoz_VariantDecl v) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_string out = qoz_vec_make__qoz_string(); qoz_string parent = qoz_string_cat(QOZ_STR_LIT("qoz_"), qoz_string_cat(enum_name, qoz_string_cat(QOZ_STR_LIT("_"), qoz_string_cat(v.name, QOZ_STR_LIT("_payload"))))); if (qoz_emit_variant_has_positional(v)) { int64_t i = 0; { qoz_Vec__qoz_TypeExpr __col = v.pos; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* pt = __col.data[__i]; (void)pt; qoz_string field = qoz_string_cat(QOZ_STR_LIT("f"), qoz_emit_int_to_string(i)); qoz_emit_collect_field_ptr_offsets(e, parent, field, pt, &out); i = i + 1; } }return out;} { qoz_Vec__qoz_StructField __col = v.named; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField sf = __col.data[__i]; (void)sf; qoz_emit_collect_field_ptr_offsets(e, parent, sf.name, sf.ty, &out); } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return out;
}

void qoz_emit_emit_adt_desc(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_VariantDecl variants) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_Vec__qoz_string voffs = qoz_emit_collect_variant_ptr_offsets(e, name, v); if ((voffs.len) > 0) { qoz_string vn = v.name; qoz_string _qoz_bv_248;
    {
        qoz_Strbuf _qoz_sb_3772_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3772_21); qoz_strings_sb_append(&_qoz_sb_3772_21, QOZ_STR_LIT("static const int32_t qoz_")); qoz_strings_sb_append(&_qoz_sb_3772_21, name); qoz_strings_sb_append(&_qoz_sb_3772_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3772_21, vn); qoz_strings_sb_append(&_qoz_sb_3772_21, QOZ_STR_LIT("_offsets[] = { ")); _qoz_bv_248 = qoz_strings_sb_finish(&_qoz_sb_3772_21);
    }
    qoz_emit_push(e, _qoz_bv_248); int64_t j = 0; { qoz_Vec__qoz_string __col = voffs; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_string expr = __col.data[__i]; (void)expr; if (j > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_push(e, expr); j = j + 1; } }qoz_emit_push(e, QOZ_STR_LIT(" };\n")); } } }qoz_string _qoz_bv_249;
    {
        qoz_Strbuf _qoz_sb_3782_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3782_13); qoz_strings_sb_append(&_qoz_sb_3782_13, QOZ_STR_LIT("static const qoz_variant_desc qoz_")); qoz_strings_sb_append(&_qoz_sb_3782_13, name); qoz_strings_sb_append(&_qoz_sb_3782_13, QOZ_STR_LIT("_variants[] = {\n")); _qoz_bv_249 = qoz_strings_sb_finish(&_qoz_sb_3782_13);
    }
    qoz_emit_push(e, _qoz_bv_249); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; qoz_Vec__qoz_string voffs = qoz_emit_collect_variant_ptr_offsets(e, name, v); int64_t nptrs = (voffs.len); qoz_string vn = v.name; qoz_string np = qoz_emit_int_to_string(nptrs); if (nptrs > 0) { qoz_string _qoz_bv_250;
    {
        qoz_Strbuf _qoz_sb_3789_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3789_21); qoz_strings_sb_append(&_qoz_sb_3789_21, QOZ_STR_LIT("    { qoz_")); qoz_strings_sb_append(&_qoz_sb_3789_21, name); qoz_strings_sb_append(&_qoz_sb_3789_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3789_21, vn); qoz_strings_sb_append(&_qoz_sb_3789_21, QOZ_STR_LIT(", ")); qoz_strings_sb_append(&_qoz_sb_3789_21, np); qoz_strings_sb_append(&_qoz_sb_3789_21, QOZ_STR_LIT(", qoz_")); qoz_strings_sb_append(&_qoz_sb_3789_21, name); qoz_strings_sb_append(&_qoz_sb_3789_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3789_21, vn); qoz_strings_sb_append(&_qoz_sb_3789_21, QOZ_STR_LIT("_offsets },\n")); _qoz_bv_250 = qoz_strings_sb_finish(&_qoz_sb_3789_21);
    }
    qoz_emit_push(e, _qoz_bv_250); }  else { qoz_string _qoz_bv_251;
    {
        qoz_Strbuf _qoz_sb_3791_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3791_21); qoz_strings_sb_append(&_qoz_sb_3791_21, QOZ_STR_LIT("    { qoz_")); qoz_strings_sb_append(&_qoz_sb_3791_21, name); qoz_strings_sb_append(&_qoz_sb_3791_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_3791_21, vn); qoz_strings_sb_append(&_qoz_sb_3791_21, QOZ_STR_LIT(", ")); qoz_strings_sb_append(&_qoz_sb_3791_21, np); qoz_strings_sb_append(&_qoz_sb_3791_21, QOZ_STR_LIT(", NULL },\n")); _qoz_bv_251 = qoz_strings_sb_finish(&_qoz_sb_3791_21);
    }
    qoz_emit_push(e, _qoz_bv_251); } } }qoz_emit_push(e, QOZ_STR_LIT("};\n")); bool any_payload2 = false; { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_emit_variant_has_positional(v)) { any_payload2 = true; } } }qoz_string payload_off_expr = ((any_payload2) ? qoz_string_cat(QOZ_STR_LIT("(int32_t)offsetof(struct qoz_"), qoz_string_cat(name, QOZ_STR_LIT(", payload)"))) : QOZ_STR_LIT("0")); qoz_string nvar = qoz_emit_int_to_string((variants.len)); qoz_string _qoz_bv_252;
    {
        qoz_Strbuf _qoz_sb_3805_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3805_13); qoz_strings_sb_append(&_qoz_sb_3805_13, QOZ_STR_LIT("static const qoz_type_desc qoz_")); qoz_strings_sb_append(&_qoz_sb_3805_13, name); qoz_strings_sb_append(&_qoz_sb_3805_13, QOZ_STR_LIT("_desc = { QOZ_DESC_ADT, (int32_t)sizeof(struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3805_13, name); qoz_strings_sb_append(&_qoz_sb_3805_13, QOZ_STR_LIT("), 0, NULL, (int32_t)offsetof(struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3805_13, name); qoz_strings_sb_append(&_qoz_sb_3805_13, QOZ_STR_LIT(", tag), ")); qoz_strings_sb_append(&_qoz_sb_3805_13, payload_off_expr); qoz_strings_sb_append(&_qoz_sb_3805_13, QOZ_STR_LIT(", ")); qoz_strings_sb_append(&_qoz_sb_3805_13, nvar); qoz_strings_sb_append(&_qoz_sb_3805_13, QOZ_STR_LIT(", qoz_")); qoz_strings_sb_append(&_qoz_sb_3805_13, name); qoz_strings_sb_append(&_qoz_sb_3805_13, QOZ_STR_LIT("_variants, \"")); qoz_strings_sb_append(&_qoz_sb_3805_13, name); qoz_strings_sb_append(&_qoz_sb_3805_13, QOZ_STR_LIT("\" };\n\n")); _qoz_bv_252 = qoz_strings_sb_finish(&_qoz_sb_3805_13);
    }
    qoz_emit_push(e, _qoz_bv_252); 
    return;
}
...
void qoz_emit_emit_struct(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string _qoz_bv_253;
    {
        qoz_Strbuf _qoz_sb_3809_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3809_13); qoz_strings_sb_append(&_qoz_sb_3809_13, QOZ_STR_LIT("struct qoz_")); qoz_strings_sb_append(&_qoz_sb_3809_13, name); qoz_strings_sb_append(&_qoz_sb_3809_13, QOZ_STR_LIT(" {\n")); _qoz_bv_253 = qoz_strings_sb_finish(&_qoz_sb_3809_13);
    }
    qoz_emit_push(e, _qoz_bv_253); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; qoz_string ct = qoz_emit_c_type_for(e, f.ty); qoz_string fname = f.name; qoz_string _qoz_bv_254;
    {
        qoz_Strbuf _qoz_sb_3813_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3813_17); qoz_strings_sb_append(&_qoz_sb_3813_17, QOZ_STR_LIT("    ")); qoz_strings_sb_append(&_qoz_sb_3813_17, ct); qoz_strings_sb_append(&_qoz_sb_3813_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3813_17, fname); qoz_strings_sb_append(&_qoz_sb_3813_17, QOZ_STR_LIT(";\n")); _qoz_bv_254 = qoz_strings_sb_finish(&_qoz_sb_3813_17);
    }
    qoz_emit_push(e, _qoz_bv_254); } }qoz_emit_push(e, QOZ_STR_LIT("};\n\n")); qoz_emit_emit_record_eq(e, name, fields); qoz_emit_emit_record_desc(e, name, fields); 
    return;
}
...
void qoz_emit_emit_record_eq(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string _qoz_bv_255;
    {
        qoz_Strbuf _qoz_sb_3821_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3821_13); qoz_strings_sb_append(&_qoz_sb_3821_13, QOZ_STR_LIT("static bool qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_3821_13, name); qoz_strings_sb_append(&_qoz_sb_3821_13, QOZ_STR_LIT("(qoz_")); qoz_strings_sb_append(&_qoz_sb_3821_13, name); qoz_strings_sb_append(&_qoz_sb_3821_13, QOZ_STR_LIT(" a, qoz_")); qoz_strings_sb_append(&_qoz_sb_3821_13, name); qoz_strings_sb_append(&_qoz_sb_3821_13, QOZ_STR_LIT(" b) {\n    return ")); _qoz_bv_255 = qoz_strings_sb_finish(&_qoz_sb_3821_13);
    }
    qoz_emit_push(e, _qoz_bv_255); if ((fields.len) == 0) { qoz_emit_push(e, QOZ_STR_LIT("true")); }  else { int64_t i = 0; { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(" && ")); } qoz_emit_emit_field_eq_expr(e, f.ty, f.name); i = i + 1; } }} qoz_emit_push(e, QOZ_STR_LIT(";\n}\n\n")); qoz_emit_emit_record_hash(e, name, fields); 
    return;
}
...
void qoz_emit_emit_record_hash(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_StructField fields) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string _qoz_bv_256;
    {
        qoz_Strbuf _qoz_sb_3837_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3837_13); qoz_strings_sb_append(&_qoz_sb_3837_13, QOZ_STR_LIT("static uint64_t qoz_hash_")); qoz_strings_sb_append(&_qoz_sb_3837_13, name); qoz_strings_sb_append(&_qoz_sb_3837_13, QOZ_STR_LIT("(qoz_")); qoz_strings_sb_append(&_qoz_sb_3837_13, name); qoz_strings_sb_append(&_qoz_sb_3837_13, QOZ_STR_LIT(" v) {\n    uint64_t h = 0;\n")); _qoz_bv_256 = qoz_strings_sb_finish(&_qoz_sb_3837_13);
    }
    qoz_emit_push(e, _qoz_bv_256); { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField f = __col.data[__i]; (void)f; qoz_emit_push(e, QOZ_STR_LIT("    h = h * 31 + (uint64_t)(")); qoz_emit_emit_field_hash_expr(e, f.ty, f.name); qoz_emit_push(e, QOZ_STR_LIT(");\n")); } }qoz_emit_push(e, QOZ_STR_LIT("    return h;\n}\n\n")); 
    return;
}
...
void qoz_emit_emit_field_hash_expr(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string fname) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_string ct = qoz_emit_c_type_for(e, te); if (qoz_string_eq(ct, QOZ_STR_LIT("qoz_string"))) { qoz_string _qoz_bv_257;
    {
        qoz_Strbuf _qoz_sb_3849_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3849_17); qoz_strings_sb_append(&_qoz_sb_3849_17, QOZ_STR_LIT("qoz_string_hash(v.")); qoz_strings_sb_append(&_qoz_sb_3849_17, fname); qoz_strings_sb_append(&_qoz_sb_3849_17, QOZ_STR_LIT(")")); _qoz_bv_257 = qoz_strings_sb_finish(&_qoz_sb_3849_17);
    }
    qoz_emit_push(e, _qoz_bv_257); return;} qoz_TypeExpr* _qoz_ms_298 = te; switch (_qoz_ms_298->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_298->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_298->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_string_eq(qoz_emit_primitive_c_name(n), QOZ_STR_LIT(""))) { if (!qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_string mangled = (((args.len) > 0) ? qoz_emit_mangle_inst(e, n, args) : n); qoz_string _qoz_bv_258;
    {
        qoz_Strbuf _qoz_sb_3859_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3859_29); qoz_strings_sb_append(&_qoz_sb_3859_29, QOZ_STR_LIT("qoz_hash_")); qoz_strings_sb_append(&_qoz_sb_3859_29, mangled); qoz_strings_sb_append(&_qoz_sb_3859_29, QOZ_STR_LIT("(v.")); qoz_strings_sb_append(&_qoz_sb_3859_29, fname); qoz_strings_sb_append(&_qoz_sb_3859_29, QOZ_STR_LIT(")")); _qoz_bv_258 = qoz_strings_sb_finish(&_qoz_sb_3859_29);
    }
    qoz_emit_push(e, _qoz_bv_258); return;} } } 0;  break; } default: { NULL;  break; } } 0; qoz_string _qoz_bv_259;
    {
        qoz_Strbuf _qoz_sb_3867_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3867_13); qoz_strings_sb_append(&_qoz_sb_3867_13, QOZ_STR_LIT("v.")); qoz_strings_sb_append(&_qoz_sb_3867_13, fname); _qoz_bv_259 = qoz_strings_sb_finish(&_qoz_sb_3867_13);
    }
    qoz_emit_push(e, _qoz_bv_259); 
    return;
}
...
void qoz_emit_emit_field_eq_expr(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string fname) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_string ct = qoz_emit_c_type_for(e, te); if (qoz_string_eq(ct, QOZ_STR_LIT("qoz_string"))) { qoz_string _qoz_bv_260;
    {
        qoz_Strbuf _qoz_sb_3873_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3873_17); qoz_strings_sb_append(&_qoz_sb_3873_17, QOZ_STR_LIT("qoz_string_eq(a.")); qoz_strings_sb_append(&_qoz_sb_3873_17, fname); qoz_strings_sb_append(&_qoz_sb_3873_17, QOZ_STR_LIT(", b.")); qoz_strings_sb_append(&_qoz_sb_3873_17, fname); qoz_strings_sb_append(&_qoz_sb_3873_17, QOZ_STR_LIT(")")); _qoz_bv_260 = qoz_strings_sb_finish(&_qoz_sb_3873_17);
    }
    qoz_emit_push(e, _qoz_bv_260); return;} qoz_TypeExpr* _qoz_ms_299 = te; switch (_qoz_ms_299->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_299->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_299->payload.TENamed.f2; if ((path.len) >= 1) { qoz_string n = path.data[(path.len) - 1]; if (qoz_string_eq(qoz_emit_primitive_c_name(n), QOZ_STR_LIT(""))) { if (!qoz_map_contains__qoz_string__bool(&e->is_enum, n)) { qoz_string mangled = (((args.len) > 0) ? qoz_emit_mangle_inst(e, n, args) : n); qoz_string _qoz_bv_261;
    {
        qoz_Strbuf _qoz_sb_3883_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3883_29); qoz_strings_sb_append(&_qoz_sb_3883_29, QOZ_STR_LIT("qoz_eq_")); qoz_strings_sb_append(&_qoz_sb_3883_29, mangled); qoz_strings_sb_append(&_qoz_sb_3883_29, QOZ_STR_LIT("(a.")); qoz_strings_sb_append(&_qoz_sb_3883_29, fname); qoz_strings_sb_append(&_qoz_sb_3883_29, QOZ_STR_LIT(", b.")); qoz_strings_sb_append(&_qoz_sb_3883_29, fname); qoz_strings_sb_append(&_qoz_sb_3883_29, QOZ_STR_LIT(")")); _qoz_bv_261 = qoz_strings_sb_finish(&_qoz_sb_3883_29);
    }
    qoz_emit_push(e, _qoz_bv_261); return;} } } 0;  break; } default: { NULL;  break; } } 0; qoz_string _qoz_bv_262;
    {
        qoz_Strbuf _qoz_sb_3891_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3891_13); qoz_strings_sb_append(&_qoz_sb_3891_13, QOZ_STR_LIT("a.")); qoz_strings_sb_append(&_qoz_sb_3891_13, fname); qoz_strings_sb_append(&_qoz_sb_3891_13, QOZ_STR_LIT(" == b.")); qoz_strings_sb_append(&_qoz_sb_3891_13, fname); _qoz_bv_262 = qoz_strings_sb_finish(&_qoz_sb_3891_13);
    }
    qoz_emit_push(e, _qoz_bv_262); 
    return;
}
...
void qoz_emit_emit_fn_proto(qoz_Emitter* e, qoz_string name, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ret);
    qoz_string rc = qoz_emit_c_type_for(e, ret); qoz_string c_name = qoz_emit_user_fn_c_name(name); qoz_string _qoz_bv_263;
    {
        qoz_Strbuf _qoz_sb_3897_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3897_13); qoz_strings_sb_append(&_qoz_sb_3897_13, rc); qoz_strings_sb_append(&_qoz_sb_3897_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3897_13, c_name); _qoz_bv_263 = qoz_strings_sb_finish(&_qoz_sb_3897_13);
    }
    qoz_emit_push(e, _qoz_bv_263); if ((params.len) == 0) { qoz_emit_push(e, QOZ_STR_LIT("(void);\n")); return;} qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string pc = qoz_emit_c_type_for(e, p.ty); qoz_string pn = p.name; qoz_string _qoz_bv_264;
    {
        qoz_Strbuf _qoz_sb_3908_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3908_17); qoz_strings_sb_append(&_qoz_sb_3908_17, pc); qoz_strings_sb_append(&_qoz_sb_3908_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3908_17, pn); _qoz_bv_264 = qoz_strings_sb_finish(&_qoz_sb_3908_17);
    }
    qoz_emit_push(e, _qoz_bv_264); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(");\n")); 
    return;
}
...
void qoz_emit_emit_extern_proto(qoz_Emitter* e, qoz_string symbol, qoz_Vec__qoz_FnParam params, qoz_TypeExpr* ret) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ret);
    qoz_string rc = qoz_emit_c_type_for(e, ret); qoz_string _qoz_bv_265;
    {
        qoz_Strbuf _qoz_sb_3916_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3916_13); qoz_strings_sb_append(&_qoz_sb_3916_13, QOZ_STR_LIT("extern ")); qoz_strings_sb_append(&_qoz_sb_3916_13, rc); qoz_strings_sb_append(&_qoz_sb_3916_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_3916_13, symbol); _qoz_bv_265 = qoz_strings_sb_finish(&_qoz_sb_3916_13);
    }
    qoz_emit_push(e, _qoz_bv_265); if ((params.len) == 0) { qoz_emit_push(e, QOZ_STR_LIT("(void);\n")); return;} qoz_emit_push(e, QOZ_STR_LIT("(")); int64_t i = 0; { qoz_Vec__qoz_FnParam __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_FnParam p = __col.data[__i]; (void)p; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_push(e, qoz_emit_c_type_for(e, p.ty)); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(");\n")); 
    return;
}
...
bool qoz_emit_is_range_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_300 = op; bool _qoz_mv_300 = false; switch (_qoz_ms_300->tag) { case qoz_BinaryOp_BOpRange: { _qoz_mv_300 = (true);  break; } case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_300 = (true);  break; } default: { _qoz_mv_300 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_300;
}

qoz_string qoz_emit_range_cmp_op(qoz_BinaryOp* op) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&op);
    qoz_BinaryOp* _qoz_ms_301 = op; qoz_string _qoz_mv_301 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_301->tag) { case qoz_BinaryOp_BOpRangeInclusive: { _qoz_mv_301 = (QOZ_STR_LIT("<="));  break; } default: { _qoz_mv_301 = (QOZ_STR_LIT("<"));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_301;
}
...
void qoz_emit_emit_block_tail_as_value(qoz_Emitter* e, qoz_Expr* tail) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&tail);
    qoz_Expr* _qoz_ms_302 = tail; switch (_qoz_ms_302->tag) { case qoz_Expr_EAssign: { qoz_Expr* lhs = _qoz_ms_302->payload.EAssign.f2; qoz_Expr* rhs = _qoz_ms_302->payload.EAssign.f3; {
        qoz_emit_push(e, QOZ_STR_LIT("(")); qoz_emit_emit_assign(e, lhs, rhs); qoz_emit_push(e, QOZ_STR_LIT(", 0)")); 
    }
    ...
    0;  break; } case qoz_Expr_EIf: { qoz_Expr* f = _qoz_ms_302->payload.EIf.f3; {
...
bool qoz_emit_hint_is_cstring(qoz_TypeExpr* hint) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_303 = hint; bool _qoz_mv_303 = false; switch (_qoz_ms_303->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_303->payload.TENamed.f1; _qoz_mv_303 = (((path.len) == 1) && qoz_string_eq(path.data[0], QOZ_STR_LIT("cstring")));  break; } default: { _qoz_mv_303 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_303;
}
...
void qoz_emit_emit_value_with_hint(qoz_Emitter* e, qoz_Expr* value, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&value);
    qoz_gc_push_root(&hint);
    qoz_Expr* _qoz_ms_304 = value; switch (_qoz_ms_304->tag) { case qoz_Expr_EString: { qoz_string raw = _qoz_ms_304->payload.EString.f1; {
        if (qoz_emit_hint_is_cstring(hint)) { qoz_emit_push(e, raw); }  else { qoz_string _qoz_bv_266;
    {
        qoz_Strbuf _qoz_sb_3998_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_3998_21); qoz_strings_sb_append(&_qoz_sb_3998_21, QOZ_STR_LIT("QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_3998_21, raw); qoz_strings_sb_append(&_qoz_sb_3998_21, QOZ_STR_LIT(")")); _qoz_bv_266 = qoz_strings_sb_finish(&_qoz_sb_3998_21);
    }
    qoz_emit_push(e, _qoz_bv_266); } return;
    }
    0;  break; } default: { NULL;  break; } } 0; qoz_Expr* _qoz_ms_305 = value; switch (_qoz_ms_305->tag) { case qoz_Expr_ERecord: { qoz_TypeExpr* te = _qoz_ms_305->payload.ERecord.f1; qoz_Vec__qoz_RecordFieldLit fields = _qoz_ms_305->payload.ERecord.f2; qoz_emit_emit_record_lit_with_hint(e, te, fields, hint);  break; } case qoz_Expr_ECall: { qoz_Expr* callee = _qoz_ms_305->payload.ECall.f1; qoz_Vec__qoz_TypeExpr ta = _qoz_ms_305->payload.ECall.f2; qoz_Vec__qoz_Expr args = _qoz_ms_305->payload.ECall.f3; qoz_emit_emit_call_with_hint(e, callee, ta, args, hint);  break; } case qoz_Expr_EIdent: { qoz_string name = _qoz_ms_305->payload.EIdent.f1; qoz_emit_emit_ident_with_hint(e, name, hint);  break; } case qoz_Expr_EArrayLit: { qoz_Span sp = _qoz_ms_305->payload.EArrayLit.f0; qoz_Vec__qoz_Expr elems = _qoz_ms_305->payload.EArrayLit.f1; qoz_emit_emit_array_lit_with_hint(e, sp, elems, hint);  break; } case qoz_Expr_EField: { qoz_Expr* base = _qoz_ms_305->payload.EField.f1; qoz_string name = _qoz_ms_305->payload.EField.f2; {
        bool did_emit = qoz_emit_emit_qualified_variant_with_hint(e, base, name, hint); if (!did_emit) { qoz_emit_emit_field(e, base, name); } 
    }
    0;  break; } case qoz_Expr_EBlock: { qoz_Span sp = _qoz_ms_305->payload.EBlock.f0; qoz_Vec__qoz_Stmt stmts = _qoz_ms_305->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_305->payload.EBlock.f2; {
        if ((stmts.len) == 0) { qoz_Expr* _qoz_ms_306 = tail; switch (_qoz_ms_306->tag) { case qoz_Expr_EWhile: { {
    ...
    0;  break; } default: { qoz_emit_emit_value_with_hint(e, tail, hint);  break; } } 0; return;} e->closure_counter = e->closure_counter + 1; int64_t counter = e->closure_counter; qoz_string _qoz_bv_267;
    {
        qoz_Strbuf _qoz_sb_4037_47 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4037_47); qoz_strings_sb_append_i64(&_qoz_sb_4037_47, counter); _qoz_bv_267 = qoz_strings_sb_finish(&_qoz_sb_4037_47);
    }
    qoz_string tmp_res = qoz_string_cat(QOZ_STR_LIT("_qoz_bv_"), _qoz_bv_267); qoz_string result_c = qoz_emit_c_type_for(e, hint); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_268;
    {
        qoz_Strbuf _qoz_sb_4040_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4040_17); qoz_strings_sb_append(&_qoz_sb_4040_17, result_c); qoz_strings_sb_append(&_qoz_sb_4040_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4040_17, tmp_res); qoz_strings_sb_append(&_qoz_sb_4040_17, QOZ_STR_LIT(";\n    {\n        ")); _qoz_bv_268 = qoz_strings_sb_finish(&_qoz_sb_4040_17);
    }
    qoz_emit_push(e, _qoz_bv_268); { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_emit_stmt(e, s); } }qoz_Expr* _qoz_ms_307 = tail; switch (_qoz_ms_307->tag) { case qoz_Expr_EWhile: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved); qoz_string _qoz_bv_269;
    {
        qoz_Strbuf _qoz_sb_4047_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4047_21); qoz_strings_sb_append(&_qoz_sb_4047_21, QOZ_STR_LIT("\n        ")); qoz_strings_sb_append(&_qoz_sb_4047_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4047_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_269 = qoz_strings_sb_finish(&_qoz_sb_4047_21);
    }
    qoz_emit_push(e, _qoz_bv_269); 
    }
    0;  break; } case qoz_Expr_EFor: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved); qoz_string _qoz_bv_270;
    {
        qoz_Strbuf _qoz_sb_4047_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4047_21); qoz_strings_sb_append(&_qoz_sb_4047_21, QOZ_STR_LIT("\n        ")); qoz_strings_sb_append(&_qoz_sb_4047_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4047_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_270 = qoz_strings_sb_finish(&_qoz_sb_4047_21);
    }
    qoz_emit_push(e, _qoz_bv_270); 
    }
    0;  break; } case qoz_Expr_EAssign: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved); qoz_string _qoz_bv_271;
    {
        qoz_Strbuf _qoz_sb_4047_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4047_21); qoz_strings_sb_append(&_qoz_sb_4047_21, QOZ_STR_LIT("\n        ")); qoz_strings_sb_append(&_qoz_sb_4047_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4047_21, QOZ_STR_LIT(" = 0;\n    ")); _qoz_bv_271 = qoz_strings_sb_finish(&_qoz_sb_4047_21);
    }
    qoz_emit_push(e, _qoz_bv_271); 
    }
    0;  break; } default: { {
        qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_string _qoz_bv_272;
    {
        qoz_Strbuf _qoz_sb_4051_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4051_21); qoz_strings_sb_append(&_qoz_sb_4051_21, tmp_res); qoz_strings_sb_append(&_qoz_sb_4051_21, QOZ_STR_LIT(" = ")); _qoz_bv_272 = qoz_strings_sb_finish(&_qoz_sb_4051_21);
    }
    qoz_emit_push(e, _qoz_bv_272); qoz_emit_emit_value_with_hint(e, tail, hint); qoz_emit_push(e, QOZ_STR_LIT(";\n    ")); qoz_emit_close_statement_scope(e, saved); 
    }
    0;  break; } } 0; qoz_emit_push(e, QOZ_STR_LIT("}\n    ")); qoz_emit_hoist_to_prologue(e, start); qoz_emit_push(e, tmp_res); 
    }
    0;  break; } case qoz_Expr_EIf: { qoz_Span sp = _qoz_ms_305->payload.EIf.f0; qoz_Expr* c = _qoz_ms_305->payload.EIf.f1; qoz_Expr* t = _qoz_ms_305->payload.EIf.f2; qoz_Expr* f = _qoz_ms_305->payload.EIf.f3; {
    ...
    0;  break; } case qoz_Expr_EMatch: { qoz_Span sp = _qoz_ms_305->payload.EMatch.f0; qoz_Expr* scrut = _qoz_ms_305->payload.EMatch.f1; qoz_Vec__qoz_MatchArm arms = _qoz_ms_305->payload.EMatch.f2; qoz_emit_emit_match_as_expr_with_hint(e, sp, scrut, arms, hint);  break; } default: { qoz_emit_emit_expr(e, value);  break; } } 0; 
    return;
}
...
bool qoz_emit_emit_qualified_variant_with_hint(qoz_Emitter* e, qoz_Expr* base, qoz_string name, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&base);
    qoz_gc_push_root(&hint);
    qoz_Expr* _qoz_ms_308 = base; bool _qoz_mv_308 = false; switch (_qoz_ms_308->tag) { case qoz_Expr_EIdent: { qoz_string enum_name = _qoz_ms_308->payload.EIdent.f1; bool _qoz_bv_273;
    {
        if (!qoz_map_contains__qoz_string__qoz_Decl(&e->enum_decls, enum_name)) { return false;} qoz_Option__qoz_string* _qoz_ms_309 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); bool _qoz_mv_309 = false; switch (_qoz_ms_309->tag) { case qoz_Option__qoz_string_Some: { bool _qoz_bv_274;
    {
        qoz_Vec__qoz_TypeExpr hint_args = qoz_emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = qoz_emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_275;
    {
        qoz_Strbuf _qoz_sb_4095_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4095_25); qoz_strings_sb_append(&_qoz_sb_4095_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4095_25, mangled); qoz_strings_sb_append(&_qoz_sb_4095_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4095_25, name); qoz_strings_sb_append(&_qoz_sb_4095_25, QOZ_STR_LIT("()")); _qoz_bv_275 = qoz_strings_sb_finish(&_qoz_sb_4095_25);
    }
    qoz_emit_push(e, _qoz_bv_275); }  else { qoz_string _qoz_bv_276;
    {
        qoz_Strbuf _qoz_sb_4097_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4097_25); qoz_strings_sb_append(&_qoz_sb_4097_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4097_25, enum_name); qoz_strings_sb_append(&_qoz_sb_4097_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4097_25, name); qoz_strings_sb_append(&_qoz_sb_4097_25, QOZ_STR_LIT("()")); _qoz_bv_276 = qoz_strings_sb_finish(&_qoz_sb_4097_25);
    }
    qoz_emit_push(e, _qoz_bv_276); } _qoz_bv_274 = true;
    }
    _qoz_mv_309 = (_qoz_bv_274);  break; } case qoz_Option__qoz_string_None: { _qoz_mv_309 = (false);  break; } } _qoz_bv_273 = _qoz_mv_309;
    }
    _qoz_mv_308 = (_qoz_bv_273);  break; } default: { _qoz_mv_308 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_308;
}
...
void qoz_emit_emit_ident_with_hint(qoz_Emitter* e, qoz_string name, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&hint);
    qoz_Option__qoz_string* _qoz_ms_310 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_310->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_310->payload.Some.f0; {
        qoz_Vec__qoz_TypeExpr hint_args = qoz_emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = qoz_emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_277;
    {
        qoz_Strbuf _qoz_sb_4114_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4114_21); qoz_strings_sb_append(&_qoz_sb_4114_21, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4114_21, mangled); qoz_strings_sb_append(&_qoz_sb_4114_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4114_21, name); qoz_strings_sb_append(&_qoz_sb_4114_21, QOZ_STR_LIT("()")); _qoz_bv_277 = qoz_strings_sb_finish(&_qoz_sb_4114_21);
    }
    qoz_emit_push(e, _qoz_bv_277); return;} qoz_string _qoz_bv_278;
    {
        qoz_Strbuf _qoz_sb_4117_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4117_17); qoz_strings_sb_append(&_qoz_sb_4117_17, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4117_17, enum_name); qoz_strings_sb_append(&_qoz_sb_4117_17, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4117_17, name); qoz_strings_sb_append(&_qoz_sb_4117_17, QOZ_STR_LIT("()")); _qoz_bv_278 = qoz_strings_sb_finish(&_qoz_sb_4117_17);
    }
    qoz_emit_push(e, _qoz_bv_278); 
    }
    0;  break; } case qoz_Option__qoz_string_None: { {
        qoz_TypeExpr* _qoz_ms_311 = hint; switch (_qoz_ms_311->tag) { case qoz_TypeExpr_TEFn: { qoz_Vec__qoz_TypeExpr fn_ps = _qoz_ms_311->payload.TEFn.f1; qoz_TypeExpr* fn_ret = _qoz_ms_311->payload.TEFn.f2; if (qoz_map_contains__qoz_string__qoz_Vec__qoz_TypeExpr(&e->fn_params, name)) { if (!qoz_map_contains__qoz_string__qoz_TypeExpr(&e->locals, name)) { qoz_string thunk = qoz_emit_register_fn_thunk(e, name, fn_ps, fn_ret); qoz_string clo_t = qoz_emit_c_type_for(e, hint); qoz_string _qoz_bv_279;
    {
        qoz_Strbuf _qoz_sb_4128_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4128_29); qoz_strings_sb_append(&_qoz_sb_4128_29, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_4128_29, clo_t); qoz_strings_sb_append(&_qoz_sb_4128_29, QOZ_STR_LIT("){ .env = NULL, .fn = ")); qoz_strings_sb_append(&_qoz_sb_4128_29, thunk); qoz_strings_sb_append(&_qoz_sb_4128_29, QOZ_STR_LIT(" })")); _qoz_bv_279 = qoz_strings_sb_finish(&_qoz_sb_4128_29);
    }
    qoz_emit_push(e, _qoz_bv_279); return;} } 0;  break; } default: { NULL;  break; } } 0; qoz_emit_push(e, name); 
    }
    0;  break; } } 0; 
    return;
}
...
qoz_string qoz_emit_register_fn_thunk(qoz_Emitter* e, qoz_string fn_name, qoz_Vec__qoz_TypeExpr params, qoz_TypeExpr* ret) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&ret);
    qoz_string key = fn_name; key = qoz_string_cat(key, QOZ_STR_LIT("__thunk")); if (qoz_map_contains__qoz_string__qoz_string(&e->fn_typedefs, key)) { return key;} qoz_map_set__qoz_string__qoz_string(&e->fn_typedefs, key, QOZ_STR_LIT("")); qoz_string sig = QOZ_STR_LIT("static "); sig = qoz_string_cat(sig, qoz_emit_c_type_for(e, ret)); sig = qoz_string_cat(sig, QOZ_STR_LIT(" ")); sig = qoz_string_cat(sig, key); sig = qoz_string_cat(sig, QOZ_STR_LIT("(void *_qoz_env")); int64_t pi = 0; { qoz_Vec__qoz_TypeExpr __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* p = __col.data[__i]; (void)p; sig = qoz_string_cat(sig, QOZ_STR_LIT(", ")); sig = qoz_string_cat(sig, qoz_emit_c_type_for(e, p)); sig = qoz_string_cat(sig, QOZ_STR_LIT(" _p")); sig = qoz_string_cat(sig, qoz_emit_int_to_string(pi)); pi = pi + 1; } }qoz_string sig_decl = qoz_string_cat(sig, QOZ_STR_LIT(");\n")); qoz_vec_push__qoz_string(&e->synth_fn_decls, sig_decl); qoz_string def = sig; def = qoz_string_cat(def, QOZ_STR_LIT(") {\n    (void)_qoz_env;\n    ")); qoz_string call_name = qoz_emit_user_fn_c_name(fn_name); if (qoz_emit_is_unit_typeexpr(ret)) { def = qoz_string_cat(def, call_name); def = qoz_string_cat(def, QOZ_STR_LIT("(")); int64_t pj = 0; { qoz_Vec__qoz_TypeExpr __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* _p = __col.data[__i]; (void)_p; if (pj > 0) { def = qoz_string_cat(def, QOZ_STR_LIT(", ")); } def = qoz_string_cat(def, QOZ_STR_LIT("_p")); def = qoz_string_cat(def, qoz_emit_int_to_string(pj)); pj = pj + 1; } }def = qoz_string_cat(def, QOZ_STR_LIT(");\n    return;\n")); }  else { def = qoz_string_cat(def, QOZ_STR_LIT("return ")); def = qoz_string_cat(def, call_name); def = qoz_string_cat(def, QOZ_STR_LIT("(")); int64_t pj = 0; { qoz_Vec__qoz_TypeExpr __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_TypeExpr* _p = __col.data[__i]; (void)_p; if (pj > 0) { def = qoz_string_cat(def, QOZ_STR_LIT(", ")); } def = qoz_string_cat(def, QOZ_STR_LIT("_p")); def = qoz_string_cat(def, qoz_emit_int_to_string(pj)); pj = pj + 1; } }def = qoz_string_cat(def, QOZ_STR_LIT(");\n")); } def = qoz_string_cat(def, QOZ_STR_LIT("}\n\n")); qoz_vec_push__qoz_string(&e->synth_fn_defs, def); qoz_gc_shadow_set_top(_qoz_shadow_guard); return key;
}
...
void qoz_emit_emit_call_with_hint(qoz_Emitter* e, qoz_Expr* callee, qoz_Vec__qoz_TypeExpr type_args, qoz_Vec__qoz_Expr args, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&callee);
    qoz_gc_push_root(&hint);
    if ((type_args.len) > 0) { qoz_emit_emit_call(e, callee, type_args, args); return;} qoz_string variant_name = qoz_emit_variant_callee_name(e, callee); if (!qoz_string_eq(variant_name, QOZ_STR_LIT(""))) { qoz_Option__qoz_string* _qoz_ms_312 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, variant_name); switch (_qoz_ms_312->tag) { case qoz_Option__qoz_string_Some: { qoz_string enum_name = _qoz_ms_312->payload.Some.f0; {
        qoz_Vec__qoz_TypeExpr hint_args = qoz_emit_hint_args_for_enum(hint, enum_name); if ((hint_args.len) > 0) { qoz_string mangled = qoz_emit_mangle_inst(e, enum_name, hint_args); qoz_string _qoz_bv_280;
    {
        qoz_Strbuf _qoz_sb_4219_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4219_25); qoz_strings_sb_append(&_qoz_sb_4219_25, QOZ_STR_LIT("qoz_make_")); qoz_strings_sb_append(&_qoz_sb_4219_25, mangled); qoz_strings_sb_append(&_qoz_sb_4219_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4219_25, variant_name); qoz_strings_sb_append(&_qoz_sb_4219_25, QOZ_STR_LIT("(")); _qoz_bv_280 = qoz_strings_sb_finish(&_qoz_sb_4219_25);
    }
    qoz_emit_push(e, _qoz_bv_280); int64_t i = 0; { qoz_Vec__qoz_Expr __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Expr* a = __col.data[__i]; (void)a; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_emit_emit_expr(e, a); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(")")); return;} 
    }
...
qoz_Vec__qoz_TypeExpr qoz_emit_hint_args_for_enum(qoz_TypeExpr* hint, qoz_string enum_name) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_313 = hint; qoz_Vec__qoz_TypeExpr _qoz_mv_313 = ((qoz_Vec__qoz_TypeExpr){0}); switch (_qoz_ms_313->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_313->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_313->payload.TENamed.f2; qoz_Vec__qoz_TypeExpr _qoz_bv_281;
    {
        if ((path.len) >= 1) { qoz_string last = path.data[(path.len) - 1]; if (qoz_string_eq(last, enum_name)) { return args;} } _qoz_bv_281 = qoz_vec_make__qoz_TypeExpr();
    }
    _qoz_mv_313 = (_qoz_bv_281);  break; } default: { _qoz_mv_313 = (qoz_vec_make__qoz_TypeExpr());  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_313;
}
...
void qoz_emit_emit_record_lit_with_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_Vec__qoz_RecordFieldLit fields, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* effective = qoz_emit_pick_type_with_args(te, hint); qoz_gc_push_root(&effective); qoz_Vec__qoz_RecordFieldLit expanded = qoz_emit_expand_record_spread_fields(e, effective, fields); qoz_string ec = qoz_emit_c_type_for(e, effective); qoz_string _qoz_bv_282;
    {
        qoz_Strbuf _qoz_sb_4253_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4253_13); qoz_strings_sb_append(&_qoz_sb_4253_13, QOZ_STR_LIT("((")); qoz_strings_sb_append(&_qoz_sb_4253_13, ec); qoz_strings_sb_append(&_qoz_sb_4253_13, QOZ_STR_LIT("){ ")); _qoz_bv_282 = qoz_strings_sb_finish(&_qoz_sb_4253_13);
    }
    qoz_emit_push(e, _qoz_bv_282); int64_t i = 0; { qoz_Vec__qoz_RecordFieldLit __col = expanded; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_RecordFieldLit f = __col.data[__i]; (void)f; if (i > 0) { qoz_emit_push(e, QOZ_STR_LIT(", ")); } qoz_string fn = f.name; qoz_string _qoz_bv_283;
    {
        qoz_Strbuf _qoz_sb_4258_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4258_17); qoz_strings_sb_append(&_qoz_sb_4258_17, QOZ_STR_LIT(".")); qoz_strings_sb_append(&_qoz_sb_4258_17, fn); qoz_strings_sb_append(&_qoz_sb_4258_17, QOZ_STR_LIT(" = ")); _qoz_bv_283 = qoz_strings_sb_finish(&_qoz_sb_4258_17);
    }
    qoz_emit_push(e, _qoz_bv_283); qoz_TypeExpr* field_hint = qoz_emit_field_type_hint(e, effective, f.name); qoz_gc_push_root(&field_hint); qoz_emit_emit_value_with_hint(e, f.value, field_hint); i = i + 1; } }qoz_emit_push(e, QOZ_STR_LIT(" })")); 
    return;
}
...
qoz_Vec__qoz_string qoz_emit_struct_field_names_from_te(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_Vec__qoz_string empty = qoz_vec_make__qoz_string(); qoz_Vec__qoz_string path_segments = qoz_vec_make__qoz_string(); qoz_TypeExpr* _qoz_ms_314 = te; switch (_qoz_ms_314->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_314->payload.TENamed.f1; path_segments = path;  break; } default: { return empty;  break; } } 0; if ((path_segments.len) < 1) { return empty;} qoz_string key = qoz_emit_type_lookup_key(e, path_segments); qoz_Option__qoz_Decl* _qoz_ms_315 = qoz_map_get__qoz_string__qoz_Decl(&e->struct_decls, key); qoz_Vec__qoz_string _qoz_mv_315 = ((qoz_Vec__qoz_string){0}); switch (_qoz_ms_315->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_315->payload.Some.f0; qoz_Decl* _qoz_ms_316 = decl; qoz_Vec__qoz_string _qoz_mv_316 = ((qoz_Vec__qoz_string){0}); switch (_qoz_ms_316->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_StructField fs = _qoz_ms_316->payload.DStruct.f3; _qoz_mv_316 = (qoz_emit_struct_decl_field_names(fs));  break; } default: { _qoz_mv_316 = (empty);  break; } } _qoz_mv_315 = (_qoz_mv_316);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_315 = (empty);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_315;
}
...
qoz_TypeExpr* qoz_emit_field_type_hint(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string field_name) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_317 = te; qoz_TypeExpr* _qoz_mv_317 = NULL; switch (_qoz_ms_317->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_317->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_317->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_317->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_284;
    {
        if ((path.len) < 1) { return te;} qoz_string name = qoz_emit_type_lookup_key(e, path); if (!qoz_map_contains__qoz_string__qoz_Decl(&e->generic_decls, name)) { return te;} qoz_Option__qoz_Decl* _qoz_ms_318 = qoz_map_get__qoz_string__qoz_Decl(&e->generic_decls, name); qoz_TypeExpr* _qoz_mv_318 = NULL; switch (_qoz_ms_318->tag) { case qoz_Option__qoz_Decl_Some: { qoz_Decl* decl = _qoz_ms_318->payload.Some.f0; qoz_Decl* _qoz_ms_319 = decl; qoz_TypeExpr* _qoz_mv_319 = NULL; switch (_qoz_ms_319->tag) { case qoz_Decl_DStruct: { qoz_Vec__qoz_string params = _qoz_ms_319->payload.DStruct.f2; qoz_Vec__qoz_StructField fields = _qoz_ms_319->payload.DStruct.f3; qoz_TypeExpr* _qoz_bv_285;
    {
        { qoz_Vec__qoz_StructField __col = fields; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_StructField sf = __col.data[__i]; (void)sf; if (qoz_string_eq(sf.name, field_name)) { if ((args.len) == (params.len)) { return qoz_emit_substitute_type(e, sf.ty, params, args);} return sf.ty;} } }_qoz_bv_285 = te;
    }
    _qoz_mv_319 = (_qoz_bv_285);  break; } default: { _qoz_mv_319 = (te);  break; } } _qoz_mv_318 = (_qoz_mv_319);  break; } case qoz_Option__qoz_Decl_None: { _qoz_mv_318 = (te);  break; } } _qoz_bv_284 = _qoz_mv_318;
    }
    _qoz_mv_317 = (_qoz_bv_284);  break; } default: { _qoz_mv_317 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_317;
}
...
qoz_TypeExpr* qoz_emit_pick_type_with_args(qoz_TypeExpr* te, qoz_TypeExpr* hint) {
    ...
    qoz_gc_push_root(&te);
    qoz_gc_push_root(&hint);
    qoz_TypeExpr* _qoz_ms_320 = te; qoz_TypeExpr* _qoz_mv_320 = NULL; switch (_qoz_ms_320->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string te_path = _qoz_ms_320->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr te_args = _qoz_ms_320->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_286;
    {
        if ((te_args.len) > 0) { return te;} qoz_TypeExpr* _qoz_ms_321 = hint; qoz_TypeExpr* _qoz_mv_321 = NULL; switch (_qoz_ms_321->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string h_path = _qoz_ms_321->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr h_args = _qoz_ms_321->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_287;
    {
        if ((h_args.len) == 0) { return te;} if ((((h_path.len) == 1) && ((te_path.len) == 1)) && qoz_string_eq(h_path.data[0], te_path.data[0])) { return hint;} _qoz_bv_287 = te;
    }
    _qoz_mv_321 = (_qoz_bv_287);  break; } default: { _qoz_mv_321 = (te);  break; } } _qoz_bv_286 = _qoz_mv_321;
    }
    _qoz_mv_320 = (_qoz_bv_286);  break; } default: { _qoz_mv_320 = (te);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_320;
}
...
void qoz_emit_emit_for_loop_one(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_322 = iter; switch (_qoz_ms_322->tag) { case qoz_Expr_EBinary: { qoz_BinaryOp* op = _qoz_ms_322->payload.EBinary.f1; qoz_Expr* lo = _qoz_ms_322->payload.EBinary.f2; qoz_Expr* hi = _qoz_ms_322->payload.EBinary.f3; if (qoz_emit_is_range_op(op)) { qoz_string _qoz_bv_288;
    {
        qoz_Strbuf _qoz_sb_4419_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4419_21); qoz_strings_sb_append(&_qoz_sb_4419_21, QOZ_STR_LIT("for (int64_t ")); qoz_strings_sb_append(&_qoz_sb_4419_21, binding); qoz_strings_sb_append(&_qoz_sb_4419_21, QOZ_STR_LIT(" = ")); _qoz_bv_288 = qoz_strings_sb_finish(&_qoz_sb_4419_21);
    }
    qoz_emit_push(e, _qoz_bv_288); qoz_emit_emit_expr(e, lo); qoz_string cmp = qoz_emit_range_cmp_op(op); qoz_string _qoz_bv_289;
    {
        qoz_Strbuf _qoz_sb_4422_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4422_21); qoz_strings_sb_append(&_qoz_sb_4422_21, QOZ_STR_LIT("; ")); qoz_strings_sb_append(&_qoz_sb_4422_21, binding); qoz_strings_sb_append(&_qoz_sb_4422_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4422_21, cmp); qoz_strings_sb_append(&_qoz_sb_4422_21, QOZ_STR_LIT(" ")); _qoz_bv_289 = qoz_strings_sb_finish(&_qoz_sb_4422_21);
    }
    qoz_emit_push(e, _qoz_bv_289); qoz_emit_emit_expr(e, hi); qoz_string _qoz_bv_290;
    {
        qoz_Strbuf _qoz_sb_4424_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4424_21); qoz_strings_sb_append(&_qoz_sb_4424_21, QOZ_STR_LIT("; ")); qoz_strings_sb_append(&_qoz_sb_4424_21, binding); qoz_strings_sb_append(&_qoz_sb_4424_21, QOZ_STR_LIT("++) ")); _qoz_bv_290 = qoz_strings_sb_finish(&_qoz_sb_4424_21);
    }
    qoz_emit_push(e, _qoz_bv_290); qoz_emit_emit_branch_as_statement(e, body); return;} 0;  break; } default: { NULL;  break; } } 0; if (qoz_string_eq(binding2, QOZ_STR_LIT(""))) { qoz_emit_emit_vec_for(e, binding, iter, body); }  else { qoz_emit_emit_map_for(e, binding, binding2, iter, body); } 
    return;
}
...
void qoz_emit_emit_vec_for(qoz_Emitter* e, qoz_string binding, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* elem_te = qoz_emit_vec_element_typeexpr(e, iter); qoz_gc_push_root(&elem_te); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, binding, elem_te); qoz_string col_ct = qoz_emit_c_type_for(e, qoz_emit_infer_base_typeexpr(e, iter)); qoz_string elem_ct = qoz_emit_c_type_for(e, elem_te); qoz_string _qoz_bv_291;
    {
        qoz_Strbuf _qoz_sb_4444_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4444_13); qoz_strings_sb_append(&_qoz_sb_4444_13, QOZ_STR_LIT("{ ")); qoz_strings_sb_append(&_qoz_sb_4444_13, col_ct); qoz_strings_sb_append(&_qoz_sb_4444_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_291 = qoz_strings_sb_finish(&_qoz_sb_4444_13);
    }
    qoz_emit_push(e, _qoz_bv_291); qoz_emit_emit_expr(e, iter); qoz_string _qoz_bv_292;
    {
        qoz_Strbuf _qoz_sb_4446_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4446_13); qoz_strings_sb_append(&_qoz_sb_4446_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.len; __i++) { ")); qoz_strings_sb_append(&_qoz_sb_4446_13, elem_ct); qoz_strings_sb_append(&_qoz_sb_4446_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4446_13, binding); qoz_strings_sb_append(&_qoz_sb_4446_13, QOZ_STR_LIT(" = __col.data[__i]; (void)")); qoz_strings_sb_append(&_qoz_sb_4446_13, binding); qoz_strings_sb_append(&_qoz_sb_4446_13, QOZ_STR_LIT("; ")); _qoz_bv_292 = qoz_strings_sb_finish(&_qoz_sb_4446_13);
    }
    qoz_emit_push(e, _qoz_bv_292); qoz_emit_emit_branch_body_inline(e, body); qoz_emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* qoz_emit_vec_element_typeexpr(qoz_Emitter* e, qoz_Expr* iter) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&iter);
    qoz_TypeExpr* te = qoz_emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&te); qoz_TypeExpr* _qoz_ms_323 = te; qoz_TypeExpr* _qoz_mv_323 = NULL; switch (_qoz_ms_323->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_323->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_323->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_323->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_293;
    {
        if ((((args.len) >= 1) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Vec"))) { return args.data[0];} _qoz_bv_293 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_323 = (_qoz_bv_293);  break; } case qoz_TypeExpr_TEPtr: { qoz_TypeExpr* inner = _qoz_ms_323->payload.TEPtr.f1; _qoz_mv_323 = (inner);  break; } default: { _qoz_mv_323 = (qoz_make_TypeExpr_TEUnit(qoz_emit_span_of_expr(iter)));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_323;
}
...
void qoz_emit_emit_map_for(qoz_Emitter* e, qoz_string binding, qoz_string binding2, qoz_Expr* iter, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&iter);
    qoz_gc_push_root(&body);
    qoz_TypeExpr* iter_te = qoz_emit_infer_base_typeexpr(e, iter); qoz_gc_push_root(&iter_te); qoz_string col_ct = qoz_emit_c_type_for(e, iter_te); qoz_TypeExpr* key_te = qoz_emit_map_key_typeexpr(e, iter_te); qoz_gc_push_root(&key_te); qoz_TypeExpr* val_te = qoz_emit_map_val_typeexpr(e, iter_te); qoz_gc_push_root(&val_te); qoz_string key_ct = qoz_emit_c_type_for(e, key_te); qoz_string val_ct = qoz_emit_c_type_for(e, val_te); qoz_string _qoz_bv_294;
    {
        qoz_Strbuf _qoz_sb_4470_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4470_13); qoz_strings_sb_append(&_qoz_sb_4470_13, QOZ_STR_LIT("{ ")); qoz_strings_sb_append(&_qoz_sb_4470_13, col_ct); qoz_strings_sb_append(&_qoz_sb_4470_13, QOZ_STR_LIT(" __col = ")); _qoz_bv_294 = qoz_strings_sb_finish(&_qoz_sb_4470_13);
    }
    qoz_emit_push(e, _qoz_bv_294); qoz_emit_emit_expr(e, iter); qoz_string _qoz_bv_295;
    {
        qoz_Strbuf _qoz_sb_4472_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4472_13); qoz_strings_sb_append(&_qoz_sb_4472_13, QOZ_STR_LIT("; for (int64_t __i = 0; __i < __col.cap; __i++) { if (!__col.slots[__i].occupied || __col.slots[__i].deleted) continue; ")); qoz_strings_sb_append(&_qoz_sb_4472_13, key_ct); qoz_strings_sb_append(&_qoz_sb_4472_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4472_13, binding); qoz_strings_sb_append(&_qoz_sb_4472_13, QOZ_STR_LIT(" = __col.slots[__i].key; ")); qoz_strings_sb_append(&_qoz_sb_4472_13, val_ct); qoz_strings_sb_append(&_qoz_sb_4472_13, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4472_13, binding2); qoz_strings_sb_append(&_qoz_sb_4472_13, QOZ_STR_LIT(" = __col.slots[__i].value; (void)")); qoz_strings_sb_append(&_qoz_sb_4472_13, binding); qoz_strings_sb_append(&_qoz_sb_4472_13, QOZ_STR_LIT("; (void)")); qoz_strings_sb_append(&_qoz_sb_4472_13, binding2); qoz_strings_sb_append(&_qoz_sb_4472_13, QOZ_STR_LIT("; ")); _qoz_bv_295 = qoz_strings_sb_finish(&_qoz_sb_4472_13);
    }
    qoz_emit_push(e, _qoz_bv_295); qoz_emit_emit_branch_body_inline(e, body); qoz_emit_push(e, QOZ_STR_LIT("} }")); 
    return;
}
...
qoz_TypeExpr* qoz_emit_map_key_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_324 = te; qoz_TypeExpr* _qoz_mv_324 = NULL; switch (_qoz_ms_324->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_324->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_324->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_324->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_296;
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[0];} _qoz_bv_296 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_324 = (_qoz_bv_296);  break; } default: { _qoz_mv_324 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_324;
}
...
qoz_TypeExpr* qoz_emit_map_val_typeexpr(qoz_Emitter* e, qoz_TypeExpr* te) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_325 = te; qoz_TypeExpr* _qoz_mv_325 = NULL; switch (_qoz_ms_325->tag) { case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_325->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_325->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_325->payload.TENamed.f2; qoz_TypeExpr* _qoz_bv_297;
    {
        if ((((args.len) >= 2) && ((path.len) >= 1)) && qoz_string_eq(path.data[(path.len) - 1], QOZ_STR_LIT("Map"))) { return args.data[1];} _qoz_bv_297 = qoz_make_TypeExpr_TEUnit(sp);
    }
    _qoz_mv_325 = (_qoz_bv_297);  break; } default: { _qoz_mv_325 = (qoz_make_TypeExpr_TEUnit(((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 })));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_325;
}
...
void qoz_emit_emit_branch_body_inline(qoz_Emitter* e, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&body);
    qoz_Expr* _qoz_ms_326 = body; switch (_qoz_ms_326->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_326->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_326->payload.EBlock.f2; {
        { qoz_Vec__qoz_Stmt __col = stmts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Stmt* s = __col.data[__i]; (void)s; qoz_emit_emit_stmt(e, s); } }if (!qoz_emit_is_nil_expr(tail)) { qoz_StmtScope saved = qoz_emit_open_statement_scope(e); qoz_emit_emit_stmt_expr(e, tail); qoz_emit_close_statement_scope(e, saved); } 
    }
    0;  break; } default: { {
...
qoz_string qoz_emit_find_enum_from_arms(qoz_Emitter* e, qoz_Vec__qoz_MatchArm arms) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; qoz_string en = qoz_emit_bare_enum_for_pat(e, arm.pat); if (!qoz_string_eq(en, QOZ_STR_LIT(""))) { return en;} } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return QOZ_STR_LIT("");
}
...
bool qoz_emit_any_arm_is_literal(qoz_Vec__qoz_MatchArm arms) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm a = __col.data[__i]; (void)a; qoz_Pattern* _qoz_ms_327 = a.pat; switch (_qoz_ms_327->tag) { case qoz_Pattern_PatLitInt: { return true; break; } case qoz_Pattern_PatLitString: { return true; break; } case qoz_Pattern_PatLitBool: { return true; break; } default: { NULL;  break; } } 0; } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return false;
}
...
void qoz_emit_emit_match_as_expr(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    if (qoz_emit_any_arm_has_guard(arms)) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} if (qoz_emit_any_arm_is_literal(arms)) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); if (qoz_string_eq(bare_enum, QOZ_STR_LIT(""))) { qoz_emit_emit_match_as_if_chain(e, span, scrut, arms); return;} qoz_string enum_name = qoz_emit_enum_lookup_name(e, scrut, bare_enum); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_298;
    {
        qoz_Strbuf _qoz_sb_4558_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4558_21); qoz_strings_sb_append(&_qoz_sb_4558_21, QOZ_STR_LIT("_qoz_ms_")); qoz_strings_sb_append_i64(&_qoz_sb_4558_21, e->match_counter); _qoz_bv_298 = qoz_strings_sb_finish(&_qoz_sb_4558_21);
    }
    qoz_string scrut_tmp = _qoz_bv_298; qoz_string _qoz_bv_299;
    {
        qoz_Strbuf _qoz_sb_4559_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4559_21); qoz_strings_sb_append(&_qoz_sb_4559_21, QOZ_STR_LIT("_qoz_mv_")); qoz_strings_sb_append_i64(&_qoz_sb_4559_21, e->match_counter); _qoz_bv_299 = qoz_strings_sb_finish(&_qoz_sb_4559_21);
    }
    qoz_string res_tmp = _qoz_bv_299; qoz_string res_ctype = qoz_emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_string_eq(res_ctype, QOZ_STR_LIT("void")); int64_t start = qoz_strings_sb_len(&e->out); qoz_string _qoz_bv_300;
    {
        qoz_Strbuf _qoz_sb_4568_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4568_13); qoz_strings_sb_append(&_qoz_sb_4568_13, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_4568_13, enum_name); qoz_strings_sb_append(&_qoz_sb_4568_13, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4568_13, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4568_13, QOZ_STR_LIT(" = ")); _qoz_bv_300 = qoz_strings_sb_finish(&_qoz_sb_4568_13);
    }
    qoz_emit_push(e, _qoz_bv_300); qoz_emit_emit_expr(e, scrut); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (!is_void) { qoz_string dv = qoz_emit_default_value_for(res_ctype); qoz_string _qoz_bv_301;
    {
        qoz_Strbuf _qoz_sb_4573_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4573_17); qoz_strings_sb_append(&_qoz_sb_4573_17, res_ctype); qoz_strings_sb_append(&_qoz_sb_4573_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4573_17, res_tmp); qoz_strings_sb_append(&_qoz_sb_4573_17, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4573_17, dv); qoz_strings_sb_append(&_qoz_sb_4573_17, QOZ_STR_LIT("; ")); _qoz_bv_301 = qoz_strings_sb_finish(&_qoz_sb_4573_17);
    }
    qoz_emit_push(e, _qoz_bv_301); } qoz_string _qoz_bv_302;
    {
        qoz_Strbuf _qoz_sb_4575_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4575_13); qoz_strings_sb_append(&_qoz_sb_4575_13, QOZ_STR_LIT("switch (")); qoz_strings_sb_append(&_qoz_sb_4575_13, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4575_13, QOZ_STR_LIT("->tag) { ")); _qoz_bv_302 = qoz_strings_sb_finish(&_qoz_sb_4575_13);
    }
    qoz_emit_push(e, _qoz_bv_302); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; qoz_emit_emit_match_arm_with_kind(e, enum_name, scrut_tmp, res_tmp, arm, is_void); } }qoz_emit_push(e, QOZ_STR_LIT("} ")); qoz_emit_hoist_to_prologue(e, start); if (is_void) { qoz_emit_push(e, QOZ_STR_LIT("0")); }  else { qoz_emit_push(e, res_tmp); } 
    return;
}
...
void qoz_emit_emit_match_as_if_chain(qoz_Emitter* e, qoz_Span span, qoz_Expr* scrut, qoz_Vec__qoz_MatchArm arms) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&scrut);
    qoz_string bare_enum = qoz_emit_find_enum_from_arms(e, arms); bool is_enum_match = !qoz_string_eq(bare_enum, QOZ_STR_LIT("")); qoz_string enum_name = QOZ_STR_LIT(""); if (is_enum_match) { enum_name = qoz_emit_enum_lookup_name(e, scrut, bare_enum); } qoz_string scrut_ctype = qoz_emit_infer_expr_ctype(e, scrut); qoz_TypeExpr* scrut_te = qoz_emit_infer_value_te(e, scrut); qoz_gc_push_root(&scrut_te); e->match_counter = e->match_counter + 1; qoz_string _qoz_bv_303;
    {
        qoz_Strbuf _qoz_sb_4596_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4596_21); qoz_strings_sb_append(&_qoz_sb_4596_21, QOZ_STR_LIT("_qoz_ms_")); qoz_strings_sb_append_i64(&_qoz_sb_4596_21, e->match_counter); _qoz_bv_303 = qoz_strings_sb_finish(&_qoz_sb_4596_21);
    }
    qoz_string scrut_tmp = _qoz_bv_303; qoz_string _qoz_bv_304;
    {
        qoz_Strbuf _qoz_sb_4597_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4597_21); qoz_strings_sb_append(&_qoz_sb_4597_21, QOZ_STR_LIT("_qoz_mv_")); qoz_strings_sb_append_i64(&_qoz_sb_4597_21, e->match_counter); _qoz_bv_304 = qoz_strings_sb_finish(&_qoz_sb_4597_21);
    }
    qoz_string res_tmp = _qoz_bv_304; qoz_string _qoz_bv_305;
    {
        qoz_Strbuf _qoz_sb_4598_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4598_21); qoz_strings_sb_append(&_qoz_sb_4598_21, QOZ_STR_LIT("_qoz_mm_")); qoz_strings_sb_append_i64(&_qoz_sb_4598_21, e->match_counter); _qoz_bv_305 = qoz_strings_sb_finish(&_qoz_sb_4598_21);
    }
    qoz_string mflag = _qoz_bv_305; qoz_string res_ctype = qoz_emit_match_result_ctype_with_hint(e, enum_name, arms); bool is_void = qoz_string_eq(res_ctype, QOZ_STR_LIT("void")); int64_t start = qoz_strings_sb_len(&e->out); if (is_enum_match) { qoz_string _qoz_bv_306;
    {
        qoz_Strbuf _qoz_sb_4603_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4603_17); qoz_strings_sb_append(&_qoz_sb_4603_17, QOZ_STR_LIT("qoz_")); qoz_strings_sb_append(&_qoz_sb_4603_17, enum_name); qoz_strings_sb_append(&_qoz_sb_4603_17, QOZ_STR_LIT("* ")); qoz_strings_sb_append(&_qoz_sb_4603_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4603_17, QOZ_STR_LIT(" = ")); _qoz_bv_306 = qoz_strings_sb_finish(&_qoz_sb_4603_17);
    }
    qoz_emit_push(e, _qoz_bv_306); }  else { qoz_string _qoz_bv_307;
    {
        qoz_Strbuf _qoz_sb_4605_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4605_17); qoz_strings_sb_append(&_qoz_sb_4605_17, scrut_ctype); qoz_strings_sb_append(&_qoz_sb_4605_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4605_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4605_17, QOZ_STR_LIT(" = ")); _qoz_bv_307 = qoz_strings_sb_finish(&_qoz_sb_4605_17);
    }
    qoz_emit_push(e, _qoz_bv_307); } qoz_emit_emit_expr(e, scrut); qoz_emit_push(e, QOZ_STR_LIT("; ")); if (!is_void) { qoz_string dv = qoz_emit_default_value_for(res_ctype); qoz_string _qoz_bv_308;
    {
        qoz_Strbuf _qoz_sb_4611_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4611_17); qoz_strings_sb_append(&_qoz_sb_4611_17, res_ctype); qoz_strings_sb_append(&_qoz_sb_4611_17, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4611_17, res_tmp); qoz_strings_sb_append(&_qoz_sb_4611_17, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4611_17, dv); qoz_strings_sb_append(&_qoz_sb_4611_17, QOZ_STR_LIT("; ")); _qoz_bv_308 = qoz_strings_sb_finish(&_qoz_sb_4611_17);
    }
    qoz_emit_push(e, _qoz_bv_308); } qoz_string _qoz_bv_309;
    {
        qoz_Strbuf _qoz_sb_4613_13 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4613_13); qoz_strings_sb_append(&_qoz_sb_4613_13, QOZ_STR_LIT("bool ")); qoz_strings_sb_append(&_qoz_sb_4613_13, mflag); qoz_strings_sb_append(&_qoz_sb_4613_13, QOZ_STR_LIT(" = false; ")); _qoz_bv_309 = qoz_strings_sb_finish(&_qoz_sb_4613_13);
    }
    qoz_emit_push(e, _qoz_bv_309); { qoz_Vec__qoz_MatchArm __col = arms; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_MatchArm arm = __col.data[__i]; (void)arm; qoz_emit_emit_arm_in_chain_with_te(e, enum_name, scrut_tmp, scrut_te, res_tmp, mflag, arm, is_void); } }qoz_emit_hoist_to_prologue(e, start); if (is_void) { qoz_emit_push(e, QOZ_STR_LIT("0")); }  else { qoz_emit_push(e, res_tmp); } 
    return;
}
...
void qoz_emit_emit_arm_in_chain_with_te(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_TypeExpr* scrut_te, qoz_string res_tmp, qoz_string mflag, qoz_MatchArm arm, bool is_void) {
    ...
    qoz_TypeExpr* body_hint = qoz_emit_match_body_hint(e, enum_name, arm.body); qoz_gc_push_root(&body_hint); bool is_enum_match = !qoz_string_eq(enum_name, QOZ_STR_LIT("")); qoz_emit_push(e, QOZ_STR_LIT("if (!")); qoz_emit_push(e, mflag); qoz_Pattern* _qoz_ms_328 = arm.pat; switch (_qoz_ms_328->tag) { case qoz_Pattern_PatWild: { qoz_emit_push(e, QOZ_STR_LIT(") { "));  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_328->payload.PatBind.f1; if (is_enum_match) { qoz_Option__qoz_string* _qoz_ms_329 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_329->tag) { case qoz_Option__qoz_string_Some: { qoz_string _qoz_bv_310;
    {
        qoz_Strbuf _qoz_sb_4635_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4635_25); qoz_strings_sb_append(&_qoz_sb_4635_25, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4635_25, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4635_25, QOZ_STR_LIT("->tag == qoz_")); qoz_strings_sb_append(&_qoz_sb_4635_25, enum_name); qoz_strings_sb_append(&_qoz_sb_4635_25, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4635_25, name); qoz_strings_sb_append(&_qoz_sb_4635_25, QOZ_STR_LIT(") { ")); _qoz_bv_310 = qoz_strings_sb_finish(&_qoz_sb_4635_25);
    }
    qoz_emit_push(e, _qoz_bv_310);  break; } default: { qoz_string _qoz_bv_311;
    {
        qoz_Strbuf _qoz_sb_4637_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4637_25); qoz_strings_sb_append(&_qoz_sb_4637_25, QOZ_STR_LIT(") { int64_t ")); qoz_strings_sb_append(&_qoz_sb_4637_25, name); qoz_strings_sb_append(&_qoz_sb_4637_25, QOZ_STR_LIT(" = 0; (void)")); qoz_strings_sb_append(&_qoz_sb_4637_25, name); qoz_strings_sb_append(&_qoz_sb_4637_25, QOZ_STR_LIT("; ")); _qoz_bv_311 = qoz_strings_sb_finish(&_qoz_sb_4637_25);
    }
    qoz_emit_push(e, _qoz_bv_311);  break; } } 0; }  else { qoz_string sc = qoz_emit_c_type_for(e, scrut_te); qoz_string _qoz_bv_312;
    {
        qoz_Strbuf _qoz_sb_4641_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4641_21); qoz_strings_sb_append(&_qoz_sb_4641_21, QOZ_STR_LIT(") { ")); qoz_strings_sb_append(&_qoz_sb_4641_21, sc); qoz_strings_sb_append(&_qoz_sb_4641_21, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4641_21, name); qoz_strings_sb_append(&_qoz_sb_4641_21, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4641_21, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4641_21, QOZ_STR_LIT("; (void)")); qoz_strings_sb_append(&_qoz_sb_4641_21, name); qoz_strings_sb_append(&_qoz_sb_4641_21, QOZ_STR_LIT("; ")); _qoz_bv_312 = qoz_strings_sb_finish(&_qoz_sb_4641_21);
    }
    qoz_emit_push(e, _qoz_bv_312); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, name, scrut_te); } 0;  break; } case qoz_Pattern_PatLitInt: { qoz_string text = _qoz_ms_328->payload.PatLitInt.f1; {
        qoz_string tn = qoz_emit_strip_numeric_underscores(text); qoz_string _qoz_bv_313;
    {
        qoz_Strbuf _qoz_sb_4647_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4647_17); qoz_strings_sb_append(&_qoz_sb_4647_17, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4647_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4647_17, QOZ_STR_LIT(" == ")); qoz_strings_sb_append(&_qoz_sb_4647_17, tn); qoz_strings_sb_append(&_qoz_sb_4647_17, QOZ_STR_LIT(") { ")); _qoz_bv_313 = qoz_strings_sb_finish(&_qoz_sb_4647_17);
    }
    qoz_emit_push(e, _qoz_bv_313); 
    }
    0;  break; } case qoz_Pattern_PatLitBool: { bool b = _qoz_ms_328->payload.PatLitBool.f1; if (b) { qoz_string _qoz_bv_314;
    {
        qoz_Strbuf _qoz_sb_4650_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4650_24); qoz_strings_sb_append(&_qoz_sb_4650_24, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4650_24, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4650_24, QOZ_STR_LIT(" == true) { ")); _qoz_bv_314 = qoz_strings_sb_finish(&_qoz_sb_4650_24);
    }
    qoz_emit_push(e, _qoz_bv_314); }  else { qoz_string _qoz_bv_315;
    {
        qoz_Strbuf _qoz_sb_4651_24 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4651_24); qoz_strings_sb_append(&_qoz_sb_4651_24, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4651_24, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4651_24, QOZ_STR_LIT(" == false) { ")); _qoz_bv_315 = qoz_strings_sb_finish(&_qoz_sb_4651_24);
    }
    qoz_emit_push(e, _qoz_bv_315); } 0;  break; } case qoz_Pattern_PatLitString: { qoz_string text = _qoz_ms_328->payload.PatLitString.f1; qoz_string _qoz_bv_316;
    {
        qoz_Strbuf _qoz_sb_4654_17 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4654_17); qoz_strings_sb_append(&_qoz_sb_4654_17, QOZ_STR_LIT(" && qoz_string_eq(")); qoz_strings_sb_append(&_qoz_sb_4654_17, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4654_17, QOZ_STR_LIT(", QOZ_STR_LIT(")); qoz_strings_sb_append(&_qoz_sb_4654_17, text); qoz_strings_sb_append(&_qoz_sb_4654_17, QOZ_STR_LIT("))) { ")); _qoz_bv_316 = qoz_strings_sb_finish(&_qoz_sb_4654_17);
    }
    qoz_emit_push(e, _qoz_bv_316);  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_328->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_328->payload.PatVariant.f2; if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_317;
    {
        qoz_Strbuf _qoz_sb_4659_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4659_21); qoz_strings_sb_append(&_qoz_sb_4659_21, QOZ_STR_LIT(" && ")); qoz_strings_sb_append(&_qoz_sb_4659_21, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4659_21, QOZ_STR_LIT("->tag == qoz_")); qoz_strings_sb_append(&_qoz_sb_4659_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4659_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4659_21, vname); qoz_strings_sb_append(&_qoz_sb_4659_21, QOZ_STR_LIT(") { ")); _qoz_bv_317 = qoz_strings_sb_finish(&_qoz_sb_4659_21);
    }
    qoz_emit_push(e, _qoz_bv_317); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_330 = sp; switch (_qoz_ms_330->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_330->payload.PatBind.f1; {
        qoz_string pc = qoz_emit_variant_payload_ctype(e, enum_name, vname, i); qoz_string is = qoz_emit_int_to_string(i); qoz_string _qoz_bv_318;
    {
        qoz_Strbuf _qoz_sb_4666_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4666_29); qoz_strings_sb_append(&_qoz_sb_4666_29, pc); qoz_strings_sb_append(&_qoz_sb_4666_29, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4666_29, bname); qoz_strings_sb_append(&_qoz_sb_4666_29, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4666_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4666_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4666_29, vname); qoz_strings_sb_append(&_qoz_sb_4666_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4666_29, is); qoz_strings_sb_append(&_qoz_sb_4666_29, QOZ_STR_LIT("; ")); _qoz_bv_318 = qoz_strings_sb_finish(&_qoz_sb_4666_29);
    }
    qoz_emit_push(e, _qoz_bv_318); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, qoz_emit_variant_payload_typeexpr(e, enum_name, vname, i)); 
    }
    0;  break; } default: { NULL;  break; } } 0; i = i + 1; } }}  else { qoz_emit_push(e, QOZ_STR_LIT(") { ")); } 0;  break; } default: { qoz_emit_push(e, QOZ_STR_LIT(") { "));  break; } } 0; if (arm.has_guard) { qoz_emit_push(e, QOZ_STR_LIT("if (")); qoz_emit_emit_expr(e, arm.guard); qoz_emit_push(e, QOZ_STR_LIT(") { ")); } if (is_void) { qoz_emit_emit_stmt_expr(e, arm.body); }  else { qoz_emit_push(e, res_tmp); qoz_emit_push(e, QOZ_STR_LIT(" = (")); qoz_emit_emit_value_with_hint(e, arm.body, body_hint); qoz_emit_push(e, QOZ_STR_LIT("); ")); } qoz_emit_push(e, mflag); qoz_emit_push(e, QOZ_STR_LIT(" = true; ")); if (arm.has_guard) { qoz_emit_push(e, QOZ_STR_LIT("} ")); } qoz_emit_push(e, QOZ_STR_LIT("} ")); 
    return;
}
...
void qoz_emit_emit_match_arm_with_kind(qoz_Emitter* e, qoz_string enum_name, qoz_string scrut_tmp, qoz_string res_tmp, qoz_MatchArm arm, bool is_void) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_TypeExpr* body_hint = qoz_emit_match_body_hint(e, enum_name, arm.body); qoz_gc_push_root(&body_hint); qoz_Pattern* _qoz_ms_331 = arm.pat; switch (_qoz_ms_331->tag) { case qoz_Pattern_PatWild: { {
    ...
    0;  break; } case qoz_Pattern_PatBind: { qoz_string name = _qoz_ms_331->payload.PatBind.f1; qoz_Option__qoz_string* _qoz_ms_332 = qoz_map_get__qoz_string__qoz_string(&e->variant_of, name); switch (_qoz_ms_332->tag) { case qoz_Option__qoz_string_Some: { {
        qoz_string _qoz_bv_319;
    {
        qoz_Strbuf _qoz_sb_4729_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4729_21); qoz_strings_sb_append(&_qoz_sb_4729_21, QOZ_STR_LIT("case qoz_")); qoz_strings_sb_append(&_qoz_sb_4729_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4729_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4729_21, name); qoz_strings_sb_append(&_qoz_sb_4729_21, QOZ_STR_LIT(": { ")); _qoz_bv_319 = qoz_strings_sb_finish(&_qoz_sb_4729_21);
    }
    qoz_emit_push(e, _qoz_bv_319); if (arm.has_guard) { qoz_emit_push(e, QOZ_STR_LIT("if (")); qoz_emit_emit_expr(e, arm.guard); qoz_emit_push(e, QOZ_STR_LIT(") { ")); qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); qoz_emit_push(e, QOZ_STR_LIT("} ")); }  else { qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); } qoz_emit_push(e, QOZ_STR_LIT(" break; } ")); 
    }
    0;  break; } case qoz_Option__qoz_string_None: { {
        if (is_void) { qoz_emit_push(e, QOZ_STR_LIT("default: { ")); }  else { qoz_string _qoz_bv_320;
    {
        qoz_Strbuf _qoz_sb_4745_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4745_25); qoz_strings_sb_append(&_qoz_sb_4745_25, QOZ_STR_LIT("default: { int64_t ")); qoz_strings_sb_append(&_qoz_sb_4745_25, name); qoz_strings_sb_append(&_qoz_sb_4745_25, QOZ_STR_LIT(" = 0; (void)")); qoz_strings_sb_append(&_qoz_sb_4745_25, name); qoz_strings_sb_append(&_qoz_sb_4745_25, QOZ_STR_LIT("; ")); _qoz_bv_320 = qoz_strings_sb_finish(&_qoz_sb_4745_25);
    }
    qoz_emit_push(e, _qoz_bv_320); } if (arm.has_guard) { qoz_emit_push(e, QOZ_STR_LIT("if (")); qoz_emit_emit_expr(e, arm.guard); qoz_emit_push(e, QOZ_STR_LIT(") { ")); qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); qoz_emit_push(e, QOZ_STR_LIT("} ")); }  else { qoz_emit_emit_arm_body_kind(e, is_void, res_tmp, arm.body, body_hint); } qoz_emit_push(e, QOZ_STR_LIT(" break; } ")); 
    }
    0;  break; } } 0;  break; } case qoz_Pattern_PatVariant: { qoz_Vec__qoz_string path = _qoz_ms_331->payload.PatVariant.f1; qoz_Vec__qoz_Pattern sub_pats = _qoz_ms_331->payload.PatVariant.f2; if ((path.len) > 0) { qoz_string vname = path.data[(path.len) - 1]; qoz_string _qoz_bv_321;
    {
        qoz_Strbuf _qoz_sb_4763_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4763_21); qoz_strings_sb_append(&_qoz_sb_4763_21, QOZ_STR_LIT("case qoz_")); qoz_strings_sb_append(&_qoz_sb_4763_21, enum_name); qoz_strings_sb_append(&_qoz_sb_4763_21, QOZ_STR_LIT("_")); qoz_strings_sb_append(&_qoz_sb_4763_21, vname); qoz_strings_sb_append(&_qoz_sb_4763_21, QOZ_STR_LIT(": { ")); _qoz_bv_321 = qoz_strings_sb_finish(&_qoz_sb_4763_21);
    }
    qoz_emit_push(e, _qoz_bv_321); int64_t i = 0; { qoz_Vec__qoz_Pattern __col = sub_pats; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Pattern* sp = __col.data[__i]; (void)sp; qoz_Pattern* _qoz_ms_333 = sp; switch (_qoz_ms_333->tag) { case qoz_Pattern_PatBind: { qoz_string bname = _qoz_ms_333->payload.PatBind.f1; {
        qoz_string pc = qoz_emit_variant_payload_ctype(e, enum_name, vname, i); qoz_string is = qoz_emit_int_to_string(i); qoz_string _qoz_bv_322;
    {
        qoz_Strbuf _qoz_sb_4770_29 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_4770_29); qoz_strings_sb_append(&_qoz_sb_4770_29, pc); qoz_strings_sb_append(&_qoz_sb_4770_29, QOZ_STR_LIT(" ")); qoz_strings_sb_append(&_qoz_sb_4770_29, bname); qoz_strings_sb_append(&_qoz_sb_4770_29, QOZ_STR_LIT(" = ")); qoz_strings_sb_append(&_qoz_sb_4770_29, scrut_tmp); qoz_strings_sb_append(&_qoz_sb_4770_29, QOZ_STR_LIT("->payload.")); qoz_strings_sb_append(&_qoz_sb_4770_29, vname); qoz_strings_sb_append(&_qoz_sb_4770_29, QOZ_STR_LIT(".f")); qoz_strings_sb_append(&_qoz_sb_4770_29, is); qoz_strings_sb_append(&_qoz_sb_4770_29, QOZ_STR_LIT("; ")); _qoz_bv_322 = qoz_strings_sb_finish(&_qoz_sb_4770_29);
    }
    qoz_emit_push(e, _qoz_bv_322); qoz_map_set__qoz_string__qoz_TypeExpr(&e->locals, bname, qoz_emit_variant_payload_typeexpr(e, enum_name, vname, i)); 
    }
...
qoz_string qoz_emit_enum_name_from_type(qoz_Emitter* e, qoz_TypeExpr* te, qoz_string bare_enum) {
    ...
    qoz_gc_push_root(&e);
    qoz_gc_push_root(&te);
    qoz_TypeExpr* _qoz_ms_334 = te; qoz_string _qoz_mv_334 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_334->tag) { case qoz_TypeExpr_TENamed: { qoz_Vec__qoz_string path = _qoz_ms_334->payload.TENamed.f1; qoz_Vec__qoz_TypeExpr args = _qoz_ms_334->payload.TENamed.f2; qoz_string _qoz_bv_323;
    {
        if (((args.len) > 0) && ((path.len) >= 1)) { qoz_string last = path.data[(path.len) - 1]; if (qoz_string_eq(last, bare_enum)) { return qoz_emit_mangle_inst(e, bare_enum, args);} } _qoz_bv_323 = bare_enum;
    }
    _qoz_mv_334 = (_qoz_bv_323);  break; } default: { _qoz_mv_334 = (bare_enum);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_334;
}

qoz_Vec__qoz_TypeExpr qoz_emit_variant_inst_args(qoz_Emitter* e, qoz_string enum_name, qoz_string bare) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    { qoz_Vec__qoz_Instantiation __col = e->enum_insts; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Instantiation inst = __col.data[__i]; (void)inst; if (qoz_string_eq(inst.mangled, enum_name)) { return inst.args;} } }qoz_gc_shadow_set_top(_qoz_shadow_guard); return qoz_emit_mangled_args(e, enum_name, bare);
}

qoz_TypeExpr* qoz_emit_variant_payload_typeexpr(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, int64_t pos) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string bare = qoz_emit_strip_mangled(enum_name); qoz_Span unit_sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_Option__qoz_Decl* _qoz_ms_335 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, bare); qoz_TypeExpr* _qoz_mv_335 = NULL; switch (_qoz_ms_335->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_335 = (qoz_make_TypeExpr_TEUnit(unit_sp));  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_335->payload.Some.f0; qoz_Decl* _qoz_ms_336 = d; qoz_TypeExpr* _qoz_mv_336 = NULL; switch (_qoz_ms_336->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_336->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_336->payload.DEnum.f3; qoz_TypeExpr* _qoz_bv_324;
    {
        qoz_Vec__qoz_TypeExpr inst_args = qoz_emit_variant_inst_args(e, enum_name, bare); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_string_eq(v.name, variant)) { if ((pos >= 0) && (pos < (v.pos.len))) { if (((tparams.len) > 0) && ((inst_args.len) == (tparams.len))) { return qoz_emit_substitute_type(e, v.pos.data[pos], tparams, inst_args);} return v.pos.data[pos];} } } }_qoz_bv_324 = qoz_make_TypeExpr_TEUnit(unit_sp);
    }
    _qoz_mv_336 = (_qoz_bv_324);  break; } default: { _qoz_mv_336 = (qoz_make_TypeExpr_TEUnit(unit_sp));  break; } } _qoz_mv_335 = (_qoz_mv_336);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_335;
}

qoz_string qoz_emit_variant_payload_ctype(qoz_Emitter* e, qoz_string enum_name, qoz_string variant, int64_t pos) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_string bare = qoz_emit_strip_mangled(enum_name); qoz_Option__qoz_Decl* _qoz_ms_337 = qoz_map_get__qoz_string__qoz_Decl(&e->enum_decls, bare); qoz_string _qoz_mv_337 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_337->tag) { case qoz_Option__qoz_Decl_None: { _qoz_mv_337 = (QOZ_STR_LIT("int64_t"));  break; } case qoz_Option__qoz_Decl_Some: { qoz_Decl* d = _qoz_ms_337->payload.Some.f0; qoz_Decl* _qoz_ms_338 = d; qoz_string _qoz_mv_338 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_338->tag) { case qoz_Decl_DEnum: { qoz_Vec__qoz_string tparams = _qoz_ms_338->payload.DEnum.f2; qoz_Vec__qoz_VariantDecl variants = _qoz_ms_338->payload.DEnum.f3; qoz_string _qoz_bv_325;
    {
        qoz_Vec__qoz_TypeExpr inst_args = qoz_emit_variant_inst_args(e, enum_name, bare); { qoz_Vec__qoz_VariantDecl __col = variants; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_VariantDecl v = __col.data[__i]; (void)v; if (qoz_string_eq(v.name, variant)) { if ((pos >= 0) && (pos < (v.pos.len))) { qoz_TypeExpr* subst = ((((tparams.len) > 0) && ((inst_args.len) == (tparams.len))) ? qoz_emit_substitute_type(e, v.pos.data[pos], tparams, inst_args) : v.pos.data[pos]); qoz_gc_push_root(&subst); return qoz_emit_c_type_for(e, subst);} } } }_qoz_bv_325 = QOZ_STR_LIT("int64_t");
    }
    _qoz_mv_338 = (_qoz_bv_325);  break; } default: { _qoz_mv_338 = (QOZ_STR_LIT("int64_t"));  break; } } _qoz_mv_337 = (_qoz_mv_338);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_337;
}
...
qoz_Vec__qoz_TypeExpr qoz_emit_mangled_args(qoz_Emitter* e, qoz_string mangled, qoz_string bare) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&e);
    qoz_Vec__qoz_TypeExpr out = qoz_vec_make__qoz_TypeExpr(); int64_t bn = (bare).len; int64_t mn = (mangled).len; if (mn <= bn + 2) { return out;} qoz_Span sp = ((qoz_Span){ .file = QOZ_STR_LIT(""), .line = 0, .col = 0 }); qoz_string tail = qoz_string_slice(mangled, bn + 2, mn); int64_t n = (tail).len; int64_t start = 0; int64_t i = 0; while (i + 1 < n) { if ((qoz_string_byte_at(tail, i) == 95) && (qoz_string_byte_at(tail, i + 1) == 95)) { qoz_vec_push__qoz_TypeExpr(&out, qoz_emit_type_expr_from_mangled_part(qoz_string_slice(tail, start, i), sp)); start = i + 2; i = i + 2; }  else { i = i + 1; } } if (start < n) { qoz_vec_push__qoz_TypeExpr(&out, qoz_emit_type_expr_from_mangled_part(qoz_string_slice(tail, start, n), sp)); } qoz_gc_shadow_set_top(_qoz_shadow_guard); return out;
}
...
void qoz_emit_emit_main(qoz_Emitter* e, qoz_TypeExpr* ret, qoz_Expr* body) {
    ...
    qoz_gc_push_root(&ret);
    qoz_gc_push_root(&body);
    qoz_MainRetKind* kind = qoz_emit_main_return_kind(ret); qoz_gc_push_root(&kind); qoz_emit_push(e, QOZ_STR_LIT("int main(int argc, char **argv) {\n    qoz_set_argv(argc, argv);\n    int qoz_stack_anchor;\n    qoz_init(&qoz_stack_anchor);\n    ")); qoz_Expr* _qoz_ms_340 = body; switch (_qoz_ms_340->tag) { case qoz_Expr_EBlock: { qoz_Vec__qoz_Stmt stmts = _qoz_ms_340->payload.EBlock.f1; qoz_Expr* tail = _qoz_ms_340->payload.EBlock.f2; {
...
qoz_MainRetKind* qoz_emit_main_return_kind(qoz_TypeExpr* ret) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&ret);
    qoz_TypeExpr* _qoz_ms_341 = ret; qoz_MainRetKind* _qoz_mv_341 = NULL; switch (_qoz_ms_341->tag) { case qoz_TypeExpr_TEUnit: { _qoz_mv_341 = (qoz_make_MainRetKind_MainRetUnit());  break; } case qoz_TypeExpr_TENamed: { qoz_Span sp = _qoz_ms_341->payload.TENamed.f0; qoz_Vec__qoz_string path = _qoz_ms_341->payload.TENamed.f1; qoz_MainRetKind* _qoz_bv_326;
    {
        if ((path.len) != 1) { qoz_string _qoz_bv_327;
    {
        qoz_Strbuf _qoz_sb_5013_25 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_5013_25); qoz_strings_sb_append(&_qoz_sb_5013_25, sp.file); qoz_strings_sb_append(&_qoz_sb_5013_25, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5013_25, sp.line); qoz_strings_sb_append(&_qoz_sb_5013_25, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5013_25, sp.col); qoz_strings_sb_append(&_qoz_sb_5013_25, QOZ_STR_LIT(": main return type must be a primitive integer or unit")); _qoz_bv_327 = qoz_strings_sb_finish(&_qoz_sb_5013_25);
    }
    qoz_fmt_println(_qoz_bv_327); return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));} qoz_string n = path.data[0]; if (qoz_string_eq(n, QOZ_STR_LIT("i8"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int8_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("i16"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int16_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("i32"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int32_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("i64"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u8"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint8_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u16"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint16_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u32"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint32_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("u64"))) { return qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("uint64_t"));} if (qoz_string_eq(n, QOZ_STR_LIT("unit"))) { return qoz_make_MainRetKind_MainRetUnit();} if (qoz_string_eq(n, QOZ_STR_LIT("void"))) { return qoz_make_MainRetKind_MainRetUnit();} qoz_string _qoz_bv_328;
    {
        qoz_Strbuf _qoz_sb_5027_21 = ((qoz_Strbuf){ .buf = ((uint8_t*)NULL), .len = 0, .cap = 0 }); qoz_strings_sb_init(&_qoz_sb_5027_21); qoz_strings_sb_append(&_qoz_sb_5027_21, sp.file); qoz_strings_sb_append(&_qoz_sb_5027_21, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5027_21, sp.line); qoz_strings_sb_append(&_qoz_sb_5027_21, QOZ_STR_LIT(":")); qoz_strings_sb_append_i64(&_qoz_sb_5027_21, sp.col); qoz_strings_sb_append(&_qoz_sb_5027_21, QOZ_STR_LIT(": main may return only integer types or unit, got `")); qoz_strings_sb_append(&_qoz_sb_5027_21, n); qoz_strings_sb_append(&_qoz_sb_5027_21, QOZ_STR_LIT("`")); _qoz_bv_328 = qoz_strings_sb_finish(&_qoz_sb_5027_21);
    }
    qoz_fmt_println(_qoz_bv_328); _qoz_bv_326 = qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));
    }
    _qoz_mv_341 = (_qoz_bv_326);  break; } default: { qoz_MainRetKind* _qoz_bv_329;
    {
        qoz_fmt_println(QOZ_STR_LIT("main return type must be a primitive integer or unit")); _qoz_bv_329 = qoz_make_MainRetKind_MainRetInt(QOZ_STR_LIT("int64_t"));
    }
    _qoz_mv_341 = (_qoz_bv_329);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_341;
}
...
void qoz_emit_emit_main_tail(qoz_Emitter* e, qoz_MainRetKind* kind, qoz_Expr* tail) {
    ...
    qoz_gc_push_root(&tail);
    qoz_MainRetKind* _qoz_ms_342 = kind; switch (_qoz_ms_342->tag) { case qoz_MainRetKind_MainRetUnit: { {
        qoz_Expr* _qoz_ms_343 = tail; bool _qoz_mv_343 = false; switch (_qoz_ms_343->tag) { case qoz_Expr_EIf: { qoz_Expr* f = _qoz_ms_343->payload.EIf.f3; _qoz_mv_343 = (qoz_emit_is_nil_expr(f) || qoz_emit_is_unit_typeexpr(qoz_emit_infer_value_te(e, tail)));  break; } default: { _qoz_mv_343 = (false);  break; } } bool is_unit_if = _qoz_mv_343; qoz_Expr* _qoz_ms_344 = tail; switch (_qoz_ms_344->tag) { case qoz_Expr_EFor: { {
    ...
    0;  break; } case qoz_MainRetKind_MainRetInt: { qoz_string ctype = _qoz_ms_342->payload.MainRetInt.f0; {
...
bool qoz_ty_ty_eq(qoz_Ty* a, qoz_Ty* b) {
    ...
    qoz_gc_push_root(&a);
    qoz_gc_push_root(&b);
    qoz_Ty* _qoz_ms_345 = a; bool _qoz_mv_345 = false; switch (_qoz_ms_345->tag) { case qoz_Ty_TyInt: { qoz_IntInfo ai = _qoz_ms_345->payload.TyInt.f0; qoz_Ty* _qoz_ms_346 = b; bool _qoz_mv_346 = false; switch (_qoz_ms_346->tag) { case qoz_Ty_TyInt: { qoz_IntInfo bi = _qoz_ms_346->payload.TyInt.f0; _qoz_mv_346 = (((ai.width == bi.width) && (ai.is_signed == bi.is_signed)) && (ai.untyped == bi.untyped));  break; } default: { _qoz_mv_346 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_346);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo af = _qoz_ms_345->payload.TyFloat.f0; qoz_Ty* _qoz_ms_347 = b; bool _qoz_mv_347 = false; switch (_qoz_ms_347->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo bf = _qoz_ms_347->payload.TyFloat.f0; _qoz_mv_347 = ((af.width == bf.width) && (af.untyped == bf.untyped));  break; } default: { _qoz_mv_347 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_347);  break; } case qoz_Ty_TyBool: { qoz_Ty* _qoz_ms_348 = b; bool _qoz_mv_348 = false; switch (_qoz_ms_348->tag) { case qoz_Ty_TyBool: { _qoz_mv_348 = (true);  break; } default: { _qoz_mv_348 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_348);  break; } case qoz_Ty_TyChar: { qoz_Ty* _qoz_ms_349 = b; bool _qoz_mv_349 = false; switch (_qoz_ms_349->tag) { case qoz_Ty_TyChar: { _qoz_mv_349 = (true);  break; } default: { _qoz_mv_349 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_349);  break; } case qoz_Ty_TyString: { qoz_Ty* _qoz_ms_350 = b; bool _qoz_mv_350 = false; switch (_qoz_ms_350->tag) { case qoz_Ty_TyString: { _qoz_mv_350 = (true);  break; } default: { _qoz_mv_350 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_350);  break; } case qoz_Ty_TyCstring: { qoz_Ty* _qoz_ms_351 = b; bool _qoz_mv_351 = false; switch (_qoz_ms_351->tag) { case qoz_Ty_TyCstring: { _qoz_mv_351 = (true);  break; } default: { _qoz_mv_351 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_351);  break; } case qoz_Ty_TyUnit: { qoz_Ty* _qoz_ms_352 = b; bool _qoz_mv_352 = false; switch (_qoz_ms_352->tag) { case qoz_Ty_TyUnit: { _qoz_mv_352 = (true);  break; } default: { _qoz_mv_352 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_352);  break; } case qoz_Ty_TyNil: { qoz_Ty* _qoz_ms_353 = b; bool _qoz_mv_353 = false; switch (_qoz_ms_353->tag) { case qoz_Ty_TyNil: { _qoz_mv_353 = (true);  break; } default: { _qoz_mv_353 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_353);  break; } case qoz_Ty_TyError: { qoz_Ty* _qoz_ms_354 = b; bool _qoz_mv_354 = false; switch (_qoz_ms_354->tag) { case qoz_Ty_TyError: { _qoz_mv_354 = (true);  break; } default: { _qoz_mv_354 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_354);  break; } case qoz_Ty_TyPtr: { qoz_Ty* ai = _qoz_ms_345->payload.TyPtr.f0; qoz_Ty* _qoz_ms_355 = b; bool _qoz_mv_355 = false; switch (_qoz_ms_355->tag) { case qoz_Ty_TyPtr: { qoz_Ty* bi = _qoz_ms_355->payload.TyPtr.f0; _qoz_mv_355 = (qoz_ty_ty_eq(ai, bi));  break; } default: { _qoz_mv_355 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_355);  break; } case qoz_Ty_TyAdt: { qoz_string an = _qoz_ms_345->payload.TyAdt.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_345->payload.TyAdt.f1; qoz_Ty* _qoz_ms_356 = b; bool _qoz_mv_356 = false; switch (_qoz_ms_356->tag) { case qoz_Ty_TyAdt: { qoz_string bn = _qoz_ms_356->payload.TyAdt.f0; qoz_Vec__qoz_Ty ba = _qoz_ms_356->payload.TyAdt.f1; _qoz_mv_356 = (qoz_string_eq(an, bn) && qoz_ty_ty_args_eq(aa, ba));  break; } default: { _qoz_mv_356 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_356);  break; } case qoz_Ty_TyRecord: { qoz_string an = _qoz_ms_345->payload.TyRecord.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_345->payload.TyRecord.f1; qoz_Ty* _qoz_ms_357 = b; bool _qoz_mv_357 = false; switch (_qoz_ms_357->tag) { case qoz_Ty_TyRecord: { qoz_string bn = _qoz_ms_357->payload.TyRecord.f0; qoz_Vec__qoz_Ty ba = _qoz_ms_357->payload.TyRecord.f1; _qoz_mv_357 = (qoz_string_eq(an, bn) && qoz_ty_ty_args_eq(aa, ba));  break; } default: { _qoz_mv_357 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_357);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty ap = _qoz_ms_345->payload.TyFn.f0; qoz_Ty* ar = _qoz_ms_345->payload.TyFn.f1; qoz_Ty* _qoz_ms_358 = b; bool _qoz_mv_358 = false; switch (_qoz_ms_358->tag) { case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty bp = _qoz_ms_358->payload.TyFn.f0; qoz_Ty* br = _qoz_ms_358->payload.TyFn.f1; _qoz_mv_358 = (qoz_ty_ty_args_eq(ap, bp) && qoz_ty_ty_eq(ar, br));  break; } default: { _qoz_mv_358 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_358);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty ae = _qoz_ms_345->payload.TyTuple.f0; qoz_Ty* _qoz_ms_359 = b; bool _qoz_mv_359 = false; switch (_qoz_ms_359->tag) { case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty be = _qoz_ms_359->payload.TyTuple.f0; _qoz_mv_359 = (qoz_ty_ty_args_eq(ae, be));  break; } default: { _qoz_mv_359 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_359);  break; } case qoz_Ty_TyVar: { qoz_string an = _qoz_ms_345->payload.TyVar.f1; qoz_Ty* _qoz_ms_360 = b; bool _qoz_mv_360 = false; switch (_qoz_ms_360->tag) { case qoz_Ty_TyVar: { qoz_string bn = _qoz_ms_360->payload.TyVar.f1; _qoz_mv_360 = (qoz_string_eq(an, bn));  break; } default: { _qoz_mv_360 = (false);  break; } } _qoz_mv_345 = (_qoz_mv_360);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_345;
}

qoz_TypeExpr* qoz_ty_ty_to_type_expr_at(qoz_Ty* t, qoz_Span sp) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_361 = t; qoz_TypeExpr* _qoz_mv_361 = NULL; switch (_qoz_ms_361->tag) { case qoz_Ty_TyInt: { qoz_IntInfo info = _qoz_ms_361->payload.TyInt.f0; _qoz_mv_361 = (qoz_make_TypeExpr_TENamed(sp, qoz_ty_ints_to_path(info.width, info.is_signed), qoz_vec_make__qoz_TypeExpr()));  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo info = _qoz_ms_361->payload.TyFloat.f0; qoz_TypeExpr* _qoz_bv_330;
    {
        qoz_Vec__qoz_string path = qoz_vec_make__qoz_string(); if (info.width == 32) { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f32")); }  else { qoz_vec_push__qoz_string(&path, QOZ_STR_LIT("f64")); } _qoz_bv_330 = qoz_make_TypeExpr_TENamed(sp, path, qoz_vec_make__qoz_TypeExpr());
    }
    _qoz_mv_361 = (_qoz_bv_330);  break; } case qoz_Ty_TyBool: { _qoz_mv_361 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("bool")));  break; } case qoz_Ty_TyChar: { _qoz_mv_361 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("char")));  break; } case qoz_Ty_TyString: { _qoz_mv_361 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("string")));  break; } case qoz_Ty_TyCstring: { _qoz_mv_361 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("cstring")));  break; } case qoz_Ty_TyUnit: { _qoz_mv_361 = (qoz_make_TypeExpr_TEUnit(sp));  break; } case qoz_Ty_TyNil: { _qoz_mv_361 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("nil")));  break; } case qoz_Ty_TyError: { _qoz_mv_361 = (qoz_ty_single_path_te(sp, QOZ_STR_LIT("?")));  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_361->payload.TyPtr.f0; _qoz_mv_361 = (qoz_make_TypeExpr_TEPtr(sp, qoz_ty_ty_to_type_expr_at(inner, sp)));  break; } case qoz_Ty_TyAdt: { qoz_string name = _qoz_ms_361->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_361->payload.TyAdt.f1; _qoz_mv_361 = (qoz_ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyRecord: { qoz_string name = _qoz_ms_361->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_361->payload.TyRecord.f1; _qoz_mv_361 = (qoz_ty_named_with_args(sp, name, args));  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty fparams = _qoz_ms_361->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_361->payload.TyFn.f1; qoz_TypeExpr* _qoz_bv_331;
    {
        qoz_Vec__qoz_TypeExpr pte = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = fparams; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; qoz_vec_push__qoz_TypeExpr(&pte, qoz_ty_ty_to_type_expr_at(p, sp)); } }_qoz_bv_331 = qoz_make_TypeExpr_TEFn(sp, pte, qoz_ty_ty_to_type_expr_at(ret, sp));
    }
    _qoz_mv_361 = (_qoz_bv_331);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_361->payload.TyTuple.f0; qoz_TypeExpr* _qoz_bv_332;
    {
        qoz_Vec__qoz_TypeExpr ete = qoz_vec_make__qoz_TypeExpr(); { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* el = __col.data[__i]; (void)el; qoz_vec_push__qoz_TypeExpr(&ete, qoz_ty_ty_to_type_expr_at(el, sp)); } }_qoz_bv_332 = qoz_make_TypeExpr_TETuple(sp, ete);
    }
    _qoz_mv_361 = (_qoz_bv_332);  break; } case qoz_Ty_TyVar: { qoz_string name = _qoz_ms_361->payload.TyVar.f1; _qoz_mv_361 = (qoz_ty_single_path_te(sp, name));  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_361;
}
...
qoz_string qoz_ty_ty_show(qoz_Ty* t) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&t);
    qoz_Ty* _qoz_ms_362 = t; qoz_string _qoz_mv_362 = ((qoz_string){ NULL, 0 }); switch (_qoz_ms_362->tag) { case qoz_Ty_TyInt: { qoz_IntInfo i = _qoz_ms_362->payload.TyInt.f0; qoz_string _qoz_bv_333;
    {
        qoz_string prefix = ((i.is_signed) ? QOZ_STR_LIT("i") : QOZ_STR_LIT("u")); qoz_string w = ((i.width == 8) ? QOZ_STR_LIT("8") : ((i.width == 16) ? QOZ_STR_LIT("16") : ((i.width == 32) ? QOZ_STR_LIT("32") : QOZ_STR_LIT("64")))); _qoz_bv_333 = qoz_string_cat(prefix, w);
    }
    _qoz_mv_362 = (_qoz_bv_333);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo f = _qoz_ms_362->payload.TyFloat.f0; _qoz_mv_362 = (((f.width == 32) ? QOZ_STR_LIT("f32") : QOZ_STR_LIT("f64")));  break; } case qoz_Ty_TyBool: { _qoz_mv_362 = (QOZ_STR_LIT("bool"));  break; } case qoz_Ty_TyChar: { _qoz_mv_362 = (QOZ_STR_LIT("char"));  break; } case qoz_Ty_TyString: { _qoz_mv_362 = (QOZ_STR_LIT("string"));  break; } case qoz_Ty_TyCstring: { _qoz_mv_362 = (QOZ_STR_LIT("cstring"));  break; } case qoz_Ty_TyUnit: { _qoz_mv_362 = (QOZ_STR_LIT("unit"));  break; } case qoz_Ty_TyNil: { _qoz_mv_362 = (QOZ_STR_LIT("nil"));  break; } case qoz_Ty_TyError: { _qoz_mv_362 = (QOZ_STR_LIT("<error>"));  break; } case qoz_Ty_TyVar: { qoz_string n = _qoz_ms_362->payload.TyVar.f1; _qoz_mv_362 = (n);  break; } case qoz_Ty_TyPtr: { qoz_Ty* inner = _qoz_ms_362->payload.TyPtr.f0; _qoz_mv_362 = (qoz_string_cat(QOZ_STR_LIT("*"), qoz_ty_ty_show(inner)));  break; } case qoz_Ty_TyAdt: { qoz_string n = _qoz_ms_362->payload.TyAdt.f0; qoz_Vec__qoz_Ty args = _qoz_ms_362->payload.TyAdt.f1; qoz_string _qoz_bv_334;
    {
        if ((args.len) == 0) { return n;} qoz_string out = qoz_string_cat(n, QOZ_STR_LIT("<")); int64_t i = 0; { qoz_Vec__qoz_Ty __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; if (i > 0) { out = qoz_string_cat(out, QOZ_STR_LIT(", ")); } out = qoz_string_cat(out, qoz_ty_ty_show(a)); i = i + 1; } }_qoz_bv_334 = qoz_string_cat(out, QOZ_STR_LIT(">"));
    }
    _qoz_mv_362 = (_qoz_bv_334);  break; } case qoz_Ty_TyRecord: { qoz_string n = _qoz_ms_362->payload.TyRecord.f0; qoz_Vec__qoz_Ty args = _qoz_ms_362->payload.TyRecord.f1; qoz_string _qoz_bv_335;
    {
        if ((args.len) == 0) { return n;} qoz_string out = qoz_string_cat(n, QOZ_STR_LIT("<")); int64_t i = 0; { qoz_Vec__qoz_Ty __col = args; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* a = __col.data[__i]; (void)a; if (i > 0) { out = qoz_string_cat(out, QOZ_STR_LIT(", ")); } out = qoz_string_cat(out, qoz_ty_ty_show(a)); i = i + 1; } }_qoz_bv_335 = qoz_string_cat(out, QOZ_STR_LIT(">"));
    }
    _qoz_mv_362 = (_qoz_bv_335);  break; } case qoz_Ty_TyFn: { qoz_Vec__qoz_Ty params = _qoz_ms_362->payload.TyFn.f0; qoz_Ty* ret = _qoz_ms_362->payload.TyFn.f1; qoz_string _qoz_bv_336;
    {
        qoz_string out = QOZ_STR_LIT("fn("); int64_t i = 0; { qoz_Vec__qoz_Ty __col = params; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* p = __col.data[__i]; (void)p; if (i > 0) { out = qoz_string_cat(out, QOZ_STR_LIT(", ")); } out = qoz_string_cat(out, qoz_ty_ty_show(p)); i = i + 1; } }out = qoz_string_cat(out, QOZ_STR_LIT(") -> ")); _qoz_bv_336 = qoz_string_cat(out, qoz_ty_ty_show(ret));
    }
    _qoz_mv_362 = (_qoz_bv_336);  break; } case qoz_Ty_TyTuple: { qoz_Vec__qoz_Ty elems = _qoz_ms_362->payload.TyTuple.f0; qoz_string _qoz_bv_337;
    {
        qoz_string out = QOZ_STR_LIT("("); int64_t i = 0; { qoz_Vec__qoz_Ty __col = elems; for (int64_t __i = 0; __i < __col.len; __i++) { qoz_Ty* e = __col.data[__i]; (void)e; if (i > 0) { out = qoz_string_cat(out, QOZ_STR_LIT(", ")); } out = qoz_string_cat(out, qoz_ty_ty_show(e)); i = i + 1; } }_qoz_bv_337 = qoz_string_cat(out, QOZ_STR_LIT(")"));
    }
    _qoz_mv_362 = (_qoz_bv_337);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_362;
}

bool qoz_ty_arg_is_nil_accepted_by(qoz_Ty* param) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&param);
    qoz_Ty* _qoz_ms_363 = param; bool _qoz_mv_363 = false; switch (_qoz_ms_363->tag) { case qoz_Ty_TyPtr: { _qoz_mv_363 = (true);  break; } default: { _qoz_mv_363 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_363;
}

bool qoz_ty_untyped_int_fits(qoz_Ty* param) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&param);
    qoz_Ty* _qoz_ms_364 = param; bool _qoz_mv_364 = false; switch (_qoz_ms_364->tag) { case qoz_Ty_TyInt: { _qoz_mv_364 = (true);  break; } default: { _qoz_mv_364 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_364;
}

bool qoz_ty_untyped_float_fits(qoz_Ty* param) {
    int64_t _qoz_shadow_guard = qoz_gc_shadow_top();
    qoz_gc_push_root(&param);
    qoz_Ty* _qoz_ms_365 = param; bool _qoz_mv_365 = false; switch (_qoz_ms_365->tag) { case qoz_Ty_TyFloat: { _qoz_mv_365 = (true);  break; } default: { _qoz_mv_365 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_365;
}
...
bool qoz_ty_arg_passes_to_param(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    qoz_Ty* _qoz_ms_366 = arg; bool _qoz_mv_366 = false; switch (_qoz_ms_366->tag) { case qoz_Ty_TyError: { _qoz_mv_366 = (true);  break; } case qoz_Ty_TyNil: { _qoz_mv_366 = (qoz_ty_arg_is_nil_accepted_by(param));  break; } case qoz_Ty_TyInt: { qoz_IntInfo ai = _qoz_ms_366->payload.TyInt.f0; bool _qoz_bv_338;
    {
        if (ai.untyped && qoz_ty_untyped_int_fits(param)) { return true;} qoz_Ty* _qoz_ms_367 = param; bool _qoz_mv_367 = false; switch (_qoz_ms_367->tag) { case qoz_Ty_TyInt: { qoz_IntInfo pi = _qoz_ms_367->payload.TyInt.f0; _qoz_mv_367 = (qoz_ty_int_widens_to(pi, ai));  break; } default: { _qoz_mv_367 = (false);  break; } } _qoz_bv_338 = _qoz_mv_367;
    }
    _qoz_mv_366 = (_qoz_bv_338);  break; } case qoz_Ty_TyFloat: { qoz_FloatInfo af = _qoz_ms_366->payload.TyFloat.f0; bool _qoz_bv_339;
    {
        if (af.untyped && qoz_ty_untyped_float_fits(param)) { return true;} qoz_Ty* _qoz_ms_368 = param; bool _qoz_mv_368 = false; switch (_qoz_ms_368->tag) { case qoz_Ty_TyFloat: { qoz_FloatInfo pf = _qoz_ms_368->payload.TyFloat.f0; _qoz_mv_368 = (pf.width >= af.width);  break; } default: { _qoz_mv_368 = (false);  break; } } _qoz_bv_339 = _qoz_mv_368;
    }
    _qoz_mv_366 = (_qoz_bv_339);  break; } default: { _qoz_mv_366 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_366;
}
...
bool qoz_ty_same_constructor_assignable(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    qoz_Ty* _qoz_ms_369 = param; bool _qoz_mv_369 = false; switch (_qoz_ms_369->tag) { case qoz_Ty_TyAdt: { qoz_string pn = _qoz_ms_369->payload.TyAdt.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_369->payload.TyAdt.f1; qoz_Ty* _qoz_ms_370 = arg; bool _qoz_mv_370 = false; switch (_qoz_ms_370->tag) { case qoz_Ty_TyAdt: { qoz_string an = _qoz_ms_370->payload.TyAdt.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_370->payload.TyAdt.f1; bool _qoz_bv_340;
    {
        if (!qoz_string_eq(pn, an)) { return false;} if ((pa.len) != (aa.len)) { return false;} int64_t i = 0; while (i < (pa.len)) { if (!qoz_ty_ty_assignable(pa.data[i], aa.data[i])) { return false;} i = i + 1; } _qoz_bv_340 = true;
    }
    _qoz_mv_370 = (_qoz_bv_340);  break; } default: { _qoz_mv_370 = (false);  break; } } _qoz_mv_369 = (_qoz_mv_370);  break; } case qoz_Ty_TyRecord: { qoz_string pn = _qoz_ms_369->payload.TyRecord.f0; qoz_Vec__qoz_Ty pa = _qoz_ms_369->payload.TyRecord.f1; qoz_Ty* _qoz_ms_371 = arg; bool _qoz_mv_371 = false; switch (_qoz_ms_371->tag) { case qoz_Ty_TyRecord: { qoz_string an = _qoz_ms_371->payload.TyRecord.f0; qoz_Vec__qoz_Ty aa = _qoz_ms_371->payload.TyRecord.f1; bool _qoz_bv_341;
    {
        if (!qoz_string_eq(pn, an)) { return false;} if ((pa.len) != (aa.len)) { return false;} int64_t i = 0; while (i < (pa.len)) { if (!qoz_ty_ty_assignable(pa.data[i], aa.data[i])) { return false;} i = i + 1; } _qoz_bv_341 = true;
    }
    _qoz_mv_371 = (_qoz_bv_341);  break; } default: { _qoz_mv_371 = (false);  break; } } _qoz_mv_369 = (_qoz_mv_371);  break; } case qoz_Ty_TyPtr: { qoz_Ty* pi = _qoz_ms_369->payload.TyPtr.f0; qoz_Ty* _qoz_ms_372 = arg; bool _qoz_mv_372 = false; switch (_qoz_ms_372->tag) { case qoz_Ty_TyPtr: { qoz_Ty* ai = _qoz_ms_372->payload.TyPtr.f0; _qoz_mv_372 = (qoz_ty_ty_assignable(pi, ai));  break; } default: { _qoz_mv_372 = (false);  break; } } _qoz_mv_369 = (_qoz_mv_372);  break; } default: { _qoz_mv_369 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_369;
}
...
bool qoz_ty_ty_assignable(qoz_Ty* param, qoz_Ty* arg) {
    ...
    qoz_gc_push_root(&param);
    qoz_gc_push_root(&arg);
    if (qoz_ty_ty_eq(param, arg)) { return true;} if (qoz_ty_arg_passes_to_param(param, arg)) { return true;} qoz_Ty* _qoz_ms_373 = arg; switch (_qoz_ms_373->tag) { case qoz_Ty_TyVar: { return true; break; } default: { NULL;  break; } } 0; qoz_Ty* _qoz_ms_374 = param; switch (_qoz_ms_374->tag) { case qoz_Ty_TyVar: { return true; break; } default: { NULL;  break; } } 0; if (qoz_ty_same_constructor_assignable(param, arg)) { return true;} qoz_Ty* _qoz_ms_375 = param; bool _qoz_mv_375 = false; switch (_qoz_ms_375->tag) { case qoz_Ty_TyError: { _qoz_mv_375 = (true);  break; } case qoz_Ty_TyVar: { _qoz_mv_375 = (true);  break; } default: { _qoz_mv_375 = (false);  break; } } qoz_gc_shadow_set_top(_qoz_shadow_guard); return _qoz_mv_375;
}
